...
/*<115>*/ 			printf("\x0E\x01\x09\x04\x07\xA00Chissà se riesci a ottenere\npiù di <r<600 punti>>! Vediamo\nse ce la fai!")
          			goto flw_91
          		  case 3:
...
/*<114>*/ 			printf("\x0E\x01\x09\x04\x01\x200Se ti dovessi dimenticare i comandi,\nprova a <g<premere>> <g<(2)>>.\x0E\x01\x11\x02\x5CD\n\n\nTi verranno mostrati tutti i comandi\nche puoi usare in quel momento.\nÈ comodissimo!")
          		  case 1:
/*< 33>*/ 			printf("\x0E\x01\x09\x04\x00\x03Ehi, Link!\nMi puoi dare una mano?\n[1]Sì[2-]Ho da fare!")
/*< 34>*/ 			switch (choice(2)) {
          			  case 0:
/*< 35>*/ 				printf("\x0E\x01\x09\x04\x00\xA0BGrazie!\nAllora...")
/*<  9>*/ 				printf("\x0E\x01\x09\x04\x07\x203Puoi portare una <r<botte >>alla cuoca?\nAfferra la botte con (A) e <g<posala a\nterra>> premendo di nuovo (A).\n\n\x0E\x01\x09\x04\x01\x200Quando la botte è sollevata, se <g<punti\nil telecomando verso l'alto e lo scuoti>>,\nla puoi <g<lanciare>>.\n\nPuoi <g<far rotolare >>oggetti piccoli come\nle giare, <g<puntando il telecomando\nverso il basso e scuotendolo>>.\n\n\x0E\x01\x09\x04\xC07\x200Ma se si rompono è un guaio, quindi fai\nattenzione!")
/*<113>*/ 				printf("\x0E\x01\x09\x04\x01\x200Se ti dovessi dimenticare i comandi,\nprova a <g<premere>> <g<(2)>>.\x0E\x01\x11\x02\x5CD\n\n\nTi verranno mostrati tutti i comandi\nche puoi usare in quel momento.\nÈ comodissimo!")
/*<  8>*/ 				zone_temp_flags[11 /* 0x0 08 */] = true;
          			  case 1:
/*< 36>*/ 				printf("\x0E\x01\x09\x04\x00\x19Ah\x0E\x01\x06\x02\xFBCD... \x0E\x01\x06\x02Ídimenticavo... oggi è il\ngiorno del tuo battesimo del \nvolo, vero?\n\nAllora lascia perdere.")
          			}
          		}
          	}
          }
...
/*< 20>*/ 	printf("\x0E\x01\x09\x04\x07\x1800Quell'uniforme verde... ti sta\nbenissimo! Sembri un vero\ncavaliere!")
/*<111>*/ 	set_camera(2, 0)
