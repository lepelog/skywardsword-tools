          void entrypoint_006_600() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0, line: 0 */ "Bersaglio inquadrato: <color blue<prociatto\n(giorno)>coloroff>.<color blue<<entrypoint_6_601>>coloroff>")
/*<  3>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 21, 'param4': 2, 'param5': 0}) {
          	  case 0:
/*<  2>*/ 		printf(/* textboxtype: 2, unk: 1, line: 185 */ "Avete sconfitto <numeric arg0 1> di questi nemici.\nLe mie analisi rivelano un grado di \nabilità <string arg0>\ncontro questo tipo di avversari.")
          	  case 1:
          	}
          }
...
/*< 97>*/ 	start()
/*< 99>*/ 	printf(/* textboxtype: 2, unk: 0, line: 100 */ "Non possiedo dati sufficienti su questo\nmostro.\n\n\nConfermo la comparsa di arti superiori\ne un aumento del potere demoniaco del\nmostro. [1-]Dimmi\ndi più[2]Capito")
/*<100>*/ 	switch (choice(2)) {
          	  case 0:
          		flw_240:
...
/*<257>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_98
          			  case 1:
/*<101>*/ 				printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          			}
          		}
          	  case 1:
          	}
...
/*<241>*/ 		switch (story_flags[786 /* us: 805A9B2C 0x04, jp: 805ACDAC 0x04 */]) {
          		  case 0:
          			flw_107:
/*<107>*/ 			printf(/* textboxtype: 2, unk: 0, line: 106 */ "Posso confermare che la tecnica\nd'attacco del mostro è la stessa\ndell'ultimo incontro.\n\nNon serviranno misure speciali per\ndistruggere le dita dei piedi e delle\nmani e non importa l'ordine in cui\nvengono distrutte.[1-]Dimmi\ndi più[2]Mi basta")
/*<111>*/ 			switch (choice(2)) {
          			  case 0:
/*<112>*/ 				printf(/* textboxtype: 2, unk: 0, line: 107 */ "Una volta atterrato il mostro, la sua\nmole potrebbe impedirvi di\nraggiungere il <color red<pilastro di pietra\n>coloroff>sulla sua testa.\nIn questo caso, vi converrebbe\nscendere al livello inferiore e\nutilizzare i getti d'aria per\nraggiungere il mostro.[1-]Dimmi\ndi più[2]Mi basta")
/*<113>*/ 				switch (choice(2)) {
          				  case 0:
...
/*<258>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_107
          			  case 1:
/*<110>*/ 				printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          			}
          		}
          	  case 1:
          	}
...
/*<254>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_125
          			  case 1:
/*<128>*/ 				printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          			}
          		}
          	  case 1:
          	}
...
/*<260>*/ 				switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          				  case 0:
          					flw_151:
/*<151>*/ 					printf(/* textboxtype: 2, unk: 0, line: 112 */ "Non vi sono probabilità che i vostri\nattacchi convenzionali colpiscano\nMortipher, <0x10012:0x00000002>mio signore.\n\nDovrete eseguire attacchi che superino\nle difese del nemico, come <color red<<color red<ripetuti\n<color red<colpi portati da angolature diverse>coloroff>.\n[1-]Dimmi\ndi più[2]Mi basta")
/*<152>*/ 					switch (choice(2)) {
          					  case 0:
/*<153>*/ 						printf(/* textboxtype: 2, unk: 0, line: 113 */ "I risultati della mia analisi confermano\nche potrete colpire Mortipher quando\neleva la sua spada verso l'alto.\nTuttavia, dovrete restare all'erta.\n<pause 15>Probabilità che ogni attacco sferrato\nnelle vicinanze della spada di\nMortipher venga bloccato: 100%.")
          					  case 1:
          					}
          				  case 1:
/*<149>*/ 					printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          				}
          			  case 1:
          				flw_147:
...
/*<255>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_137
          			  case 1:
/*<136>*/ 				printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          			}
          		}
          	  case 1:
          	}
...
/*<161>*/ 	start()
/*<163>*/ 	printf(/* textboxtype: 2, unk: 0, line: 110 */ "Essere imperituro dei tempi remoti.\nÈ la fonte di tutti i mostri.\n\n\nDa sempre si racconta che appaia a\nciascuno in una forma diversa e che\nsia cambiato nel corso del tempo.[1-]Dimmi\ndi più[2]Capito")
/*<162>*/ 	switch (choice(2)) {
          	  case 0:
/*<236>*/ 		printf(/* textboxtype: 2, unk: 0, line: 124 */ "Ormai è chiaro che qui non potete\nusare il <color red<potere celeste>coloroff>, poiché questo\nluogo è sotto l'influsso magico di\nMortipher.\nNon potete eseguire attacchi basati sul\n<color red<potere celeste>coloroff>.[1-]Dimmi\ndi più[2]Mi basta")
...
/*< 12>*/ 					printf(/* textboxtype: 2, unk: 0, line: 12 */ "La direzione del colpo di spada è\nmolto importante quando respingete\ni proiettili di Drosera.\n\nColpite con la spada verso destra o\nverso sinistra per respingere i\nproiettili nella rispettiva direzione.\n\n<pause 15>Colpite verso l'alto o verso il basso per\nuna traiettoria rettilinea.")
          		  ...
          		  case 1:
/*<  7>*/ 			printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          		}
          	  case 1:
          	}
          }
...
/*<164>*/ 	start()
/*<165>*/ 	printf(/* textboxtype: 2, unk: 0, line: 187 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nMentre premete (Z) per inquadrare il\nbersaglio, premete (v) per evocarmi.\nVi riferirò quanto ho scoperto.<0x10011:0x07cd><0x10011:0x09cd> Volete\nsaperlo adesso? [1-]Sì[2]No")
...
/*<141>*/ 					switch (choice(2)) {
          					  case 0:
/*< 57>*/ 						printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          					  case 1:
          					}
          				}
          			  case 1:
...
/*<285>*/ 					switch (choice(2)) {
          					  case 0:
/*< 64>*/ 						printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          					  case 1:
          					}
          				}
          			  case 1:
...
/*<169>*/ 	start()
/*<170>*/ 	printf(/* textboxtype: 2, unk: 0, line: 187 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nMentre premete (Z) per inquadrare il\nbersaglio, premete (v) per evocarmi.\nVi riferirò quanto ho scoperto.<0x10011:0x07cd><0x10011:0x09cd> Volete\nsaperlo adesso? [1-]Sì[2]No")
...
/*<247>*/ 			switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          			  case 0:
          				goto flw_34
          			  case 1:
/*< 37>*/ 				printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          			}
          		}
          	  case 1:
...
/*<174>*/ 	start()
/*<175>*/ 	printf(/* textboxtype: 2, unk: 0, line: 187 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nMentre premete (Z) per inquadrare il\nbersaglio, premete (v) per evocarmi.\nVi riferirò quanto ho scoperto.<0x10011:0x07cd><0x10011:0x09cd> Volete\nsaperlo adesso? [1-]Sì[2]No")
...
/*< 22>*/ 						printf(/* textboxtype: 2, unk: 0, line: 27 */ "La mia analisi rivela che il suo <color red<occhio\ncentrale>coloroff> verrà esposto dopo aver\ndistrutto le chele.\n\nProbabilità che sia quello il suo vero\npunto debole: 100%.\n\n\nTuttavia, a giudicare dal carapace che\ncirconda l'<color red<occhio centrale>coloroff>, desumo che\nattacchi orizzontali, verticali e\ndiagonali siano inefficaci.")
          			  ...
          			  case 1:
/*< 18>*/ 				printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          			}
          		  case 1:
          			goto flw_14
          		  case 2:
...
/*<267>*/ 							printf(/* textboxtype: 2, unk: 0, line: 156 */ "Dai tentacoli recisi potreste ottenere\n<color red<cuori >coloroff>e <color red<frecce>coloroff>.\n\n\nSe la vostra energia è ridotta o non\navete abbastanza frecce, consiglierei\ndi evitare la fuga e concentrare gli\nattacchi sui tentacoli.")
          				  ...
          				  case 1:
/*<263>*/ 					printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          				}
          			  case 1:
          				goto flw_261
          			  case 2:
...
/*< 51>*/ 							printf(/* textboxtype: 2, unk: 0, line: 153 */ "Per colpire il suo occhio, l'<color red<arco >coloroff>è l'arma\npiù efficace.\n\n\nPotete muovervi inclinando (ControlStick2) mentre\ntendete l'<color red<arco>coloroff>. Consiglierei di scoccare\nla freccia dopo l'attacco di Meduclope.")
          				  ...
          				  case 1:
/*< 47>*/ 					printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          				}
          			  case 1:
          				goto flw_43
          			  case 2:
...
/*<179>*/ 	start()
/*<180>*/ 	printf(/* textboxtype: 2, unk: 0, line: 188 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nVolete conoscerne i risultati? [1-]Sì[2]No")
...
/*< 28>*/ 				printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          	  ...
          	  case 1:
/*<183>*/ 		printf(/* textboxtype: 2, unk: 0, line: 190 */ "Sì, mio signore. Se desiderate ascoltare\nla mia analisi, premete (v) per\nevocarmi mentre inquadrate un nemico\ntenendo premuto (Z).<0x10011:0x07cd><0x10011:0x09cd>")
          	}
          }

          void entrypoint_006_661() {
/*<184>*/ 	start()
/*<185>*/ 	printf(/* textboxtype: 2, unk: 0, line: 188 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nVolete conoscerne i risultati? [1-]Sì[2]No")
/*<186>*/ 	story_flags[776 /* us: 805A9B2D 0x01, jp: 805ACDAD 0x01 */] = true;
/*<187>*/ 	switch (choice(2)) {
          	  case 0:
          		goto flw_268
          	  case 1:
/*<188>*/ 		printf(/* textboxtype: 2, unk: 0, line: 190 */ "Sì, mio signore. Se desiderate ascoltare\nla mia analisi, premete (v) per\nevocarmi mentre inquadrate un nemico\ntenendo premuto (Z).<0x10011:0x07cd><0x10011:0x09cd>")
          	}
          }
...
/*<189>*/ 	start()
/*<190>*/ 	printf(/* textboxtype: 2, unk: 0, line: 188 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nVolete conoscerne i risultati? [1-]Sì[2]No")
...
/*<143>*/ 					switch (choice(2)) {
          					  case 0:
/*< 75>*/ 						printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          					  case 1:
          					}
          				}
          			  case 1:
...
/*< 82>*/ 					printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          	  ...
          	  case 1:
/*<193>*/ 		printf(/* textboxtype: 2, unk: 0, line: 190 */ "Sì, mio signore. Se desiderate ascoltare\nla mia analisi, premete (v) per\nevocarmi mentre inquadrate un nemico\ntenendo premuto (Z).<0x10011:0x07cd><0x10011:0x09cd>")
          	}
          }

          void entrypoint_006_663() {
/*<194>*/ 	start()
/*<195>*/ 	printf(/* textboxtype: 2, unk: 0, line: 188 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nVolete conoscerne i risultati? [1-]Sì[2]No")
/*<196>*/ 	story_flags[778 /* us: 805A9B2D 0x04, jp: 805ACDAD 0x04 */] = true;
/*<197>*/ 	switch (choice(2)) {
          	  case 0:
          		goto flw_239
          	  case 1:
/*<198>*/ 		printf(/* textboxtype: 2, unk: 0, line: 190 */ "Sì, mio signore. Se desiderate ascoltare\nla mia analisi, premete (v) per\nevocarmi mentre inquadrate un nemico\ntenendo premuto (Z).<0x10011:0x07cd><0x10011:0x09cd>")
          	}
          }

          void entrypoint_006_664() {
/*<199>*/ 	start()
/*<200>*/ 	printf(/* textboxtype: 2, unk: 0, line: 188 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nVolete conoscerne i risultati? [1-]Sì[2]No")
/*<201>*/ 	story_flags[779 /* us: 805A9B2D 0x08, jp: 805ACDAD 0x08 */] = true;
/*<202>*/ 	switch (choice(2)) {
          	  case 0:
          		goto flw_240
          	  case 1:
/*<203>*/ 		printf(/* textboxtype: 2, unk: 0, line: 190 */ "Sì, mio signore. Se desiderate ascoltare\nla mia analisi, premete (v) per\nevocarmi mentre inquadrate un nemico\ntenendo premuto (Z).<0x10011:0x07cd><0x10011:0x09cd>")
          	}
          }
...
/*< 23>*/ 	start()
/*< 25>*/ 	printf(/* textboxtype: 2, unk: 1, line: 66 */ "Sembra estremamente potente grazie\nalla malefica energia conferitagli da\nGhiraim.\n\nCerca in ogni modo di mantenere la sua\nattuale forma grazie ai <color red<nuclei sferici\nrossi >coloroff>nel suo busto e nelle braccia.[1-]Dimmi\ndi più[2]Capito")
/*< 26>*/ 	switch (choice(2)) {
          	  case 0:
          		goto flw_27
          	  case 1:
...
/*<204>*/ 	start()
/*<205>*/ 	printf(/* textboxtype: 2, unk: 0, line: 188 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nVolete conoscerne i risultati? [1-]Sì[2]No")
/*<206>*/ 	story_flags[780 /* us: 805A9B2D 0x10, jp: 805ACDAD 0x10 */] = true;
/*<207>*/ 	switch (choice(2)) {
          	  case 0:
          		goto flw_241
          	  case 1:
/*<208>*/ 		printf(/* textboxtype: 2, unk: 0, line: 190 */ "Sì, mio signore. Se desiderate ascoltare\nla mia analisi, premete (v) per\nevocarmi mentre inquadrate un nemico\ntenendo premuto (Z).<0x10011:0x07cd><0x10011:0x09cd>")
          	}
          }

          void entrypoint_006_667() {
/*<209>*/ 	start()
/*<210>*/ 	printf(/* textboxtype: 2, unk: 0, line: 188 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nVolete conoscerne i risultati? [1-]Sì[2]No")
/*<211>*/ 	story_flags[781 /* us: 805A9B2D 0x20, jp: 805ACDAD 0x20 */] = true;
/*<212>*/ 	switch (choice(2)) {
          	  case 0:
          		goto flw_242
          	  case 1:
/*<213>*/ 		printf(/* textboxtype: 2, unk: 0, line: 190 */ "Sì, mio signore. Se desiderate ascoltare\nla mia analisi, premete (v) per\nevocarmi mentre inquadrate un nemico\ntenendo premuto (Z).<0x10011:0x07cd><0x10011:0x09cd>")
          	}
          }

          void entrypoint_006_650() {
/*< 70>*/ 	start()
/*< 72>*/ 	printf(/* textboxtype: 2, unk: 0, line: 80 */ "È il signore dei mostri, il <color blue<patriarca dei\nmaghi>coloroff>. Posso confermarne la \nsuperiorità fisica e mentale e una\nnotevole maestria nell'usare la magia.\nSebbene abbia i modi di un gentiluomo,\nse adirato cambierà completamente\natteggiamento.[1-]Dimmi\ndi più[2]Capito")
/*< 73>*/ 	switch (choice(2)) {
          	  case 0:
          		goto flw_87
          	  case 1:
...
/*<214>*/ 	start()
/*<215>*/ 	printf(/* textboxtype: 2, unk: 0, line: 188 */ "Ho qualcosa da segnalarvi, <0x10012:0x0000000b>mio signore\n<heroname>. Ho completato\nla mia analisi sui movimenti del\nvostro avversario.\nVolete conoscerne i risultati? [1-]Sì[2]No")
...
/*<120>*/ 			switch (choice(2)) {
          			  case 0:
/*<121>*/ 				printf(/* textboxtype: 2, unk: 0, line: 91 */ "I dati dimostrano che i vostri attacchi\ncon la spada <color red<possono far >coloroff><color red<indietreggiare>coloroff>\nlievemente Ghiraim. [1-]Dimmi\ndi più[2]Mi basta")
/*<122>*/ 				switch (choice(2)) {
          				  case 0:
/*<123>*/ 					printf(/* textboxtype: 2, unk: 0, line: 92 */ "Confermo che il comportamento di\nGhiraim fa supporre che intenda\nentrare nella stessa area in cui vi\ntrovate voi,<0x10012:0x00000002> mio signore.\nProbabilità che questo comportamento\nsia imputabile al fatto che teme di\ncadere: 85%. [1-]Dimmi\ndi più[2]Mi basta")
/*<286>*/ 					switch (choice(2)) {
          					  case 0:
...
/*<289>*/ 				switch (choice(2)) {
          				  case 0:
/*<290>*/ 					printf(/* textboxtype: 2, unk: 0, line: 91 */ "I dati dimostrano che i vostri attacchi\ncon la spada <color red<possono far >coloroff><color red<indietreggiare>coloroff>\nlievemente Ghiraim. [1-]Dimmi\ndi più[2]Mi basta")
/*<291>*/ 					switch (choice(2)) {
          					  case 0:
/*<292>*/ 						printf(/* textboxtype: 2, unk: 0, line: 92 */ "Confermo che il comportamento di\nGhiraim fa supporre che intenda\nentrare nella stessa area in cui vi\ntrovate voi,<0x10012:0x00000002> mio signore.\nProbabilità che questo comportamento\nsia imputabile al fatto che teme di\ncadere: 85%. [1-]Dimmi\ndi più[2]Mi basta")
/*<293>*/ 						switch (choice(2)) {
          						  case 0:
/*<119>*/ 							printf(/* textboxtype: 2, unk: 0, line: 13 */ "Al momento non possiedo altre\ninformazioni in merito.\n\n\nQuando ho informazioni da\ncomunicarvi, <0x10012:0x00000002>mio signore, la spada\nlampeggia. Premete (v) per evocarmi.<0x10011:0x09cd>\n\nInoltre, se desiderate informazioni\nsull'equipaggiamento o sul luogo in\ncui vi trovate, selezionate <color red<Analisi\ndella situazione>coloroff>.")
          						  case 1:
          						}
          					  case 1:
          					}
...
/*<219>*/ 	start()
/*<220>*/ 	printf(/* textboxtype: 2, unk: 0, line: 191 */ "Ho condotto nuove analisi su\nMortipher, <0x10012:0x0000000b>mio signore. Volete\nconoscerne i risultati?[1-]Sì[2]No")
/*<221>*/ 	story_flags[783 /* us: 805A9B2D 0x80, jp: 805ACDAD 0x80 */] = true;
/*<222>*/ 	switch (choice(2)) {
          	  case 0:
/*<232>*/ 		printf(/* textboxtype: 2, unk: 0, line: 124 */ "Ormai è chiaro che qui non potete\nusare il <color red<potere celeste>coloroff>, poiché questo\nluogo è sotto l'influsso magico di\nMortipher.\nNon potete eseguire attacchi basati sul\n<color red<potere celeste>coloroff>.[1-]Dimmi\ndi più[2]Mi basta")
/*<233>*/ 		switch (choice(2)) {
          		  case 0:
...
/*<229>*/ 						printf(/* textboxtype: 2, unk: 0, line: 123 */ "Avrò bisogno di più tempo per una\nanalisi più accurata.\n\n\nIn futuro, premete (Z) per inquadrare\nMortipher e (v) per evocarmi. Vi\nriferirò quanto ho scoperto.<0x10011:0x07cd><0x10011:0x09cd>")
          	  ...
          	  case 1:
/*<223>*/ 		printf(/* textboxtype: 2, unk: 0, line: 190 */ "Sì, mio signore. Se desiderate ascoltare\nla mia analisi, premete (v) per\nevocarmi mentre inquadrate un nemico\ntenendo premuto (Z).<0x10011:0x07cd><0x10011:0x09cd>")
          	}
          }
