...
/*< 35>*/ 	start()
/*< 36>*/ 	printf("Levati dai piedi! Bzzz!\nSta per passare il\ncarrello! Bzzz!")
...
/*<  6>*/ 			switch (context_related2(0)) {
          			  case 0:
/*<277>*/ 				printf("\x0E\x01\x09\x04\x1303\x00Grazie! Bzzz!")
...
/*<105>*/ 			switch (story_flags[525 /* us: 805A9B14 0x04, jp: 805ACD94 0x04 */]) {
          			  case 0:
/*<275>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD02Ehi, Link!")
/*<276>*/ 				set_camera(5, 0)
...
/*<110>*/ 				scene_flags[7 'Lanayru Desert'][75 /* 0x8 08 */] = true;
          				goto flw_149
          			  case 1:
/*<273>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD02Ehi, Link!")
/*<274>*/ 				set_camera(5, 0)
/*<211>*/ 				printf("E invece la <b<fiamma sacra >>di cui\nmi parlavi... Come è andata a finire? \nL'hai trovata?\n\nDa quando me lo hai detto non ho\nfatto che pensarci...\nRacconta!\n\n\x0E\x01\x09\x04\x2F08\x407.<pause14>.<pause14>.<pause14> Ah... dopo una serie di avventure\nsei riuscito a trovarla!\n\n\nSei davvero una roccia,\nLink!")
/*<359>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD0AAnch'io ho scoperto qualcosa sulla\nleggenda dei tre draghi.<pause0F>\n\n\nSì, è vero, nel deserto esiste\nun luogo nascosto!\n\n\nHo trovato un<r< piccolo passaggio>><pling>,\ncosì piccolo che non ci entro!\n\n\n\x0E\x01\x09\x04\x2F00\xD00Secondo me conduce alla terra\ndove viveva il <r<drago del fulmine>>,\nuno dei tre draghi della leggenda.\n\n\x0E\x01\x09\x04\x2F00\x800Scommetto che anche\ni robot c'entrano qualcosa...<pause0F>\n\n\n<r<\x0E\x01\x09\x04\x2F01\x807\x0E\x01\x06\x02\xFFCD>><r<Drago del fulmine>>, robot e\npietre del tempo<pause14>.<pause14>.<pause14>.<pause14>\n\n\n\x0E\x01\x09\x04\x2F08\x708\x0E\x01\x08\x02\x2CD\x0E\x01\x08\x02\x2CDUn vero e proprio\nromanzo di avventure!")
          				goto flw_285
          			}
          		}
          	}
...
/*<318>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_66:
/*< 66>*/ 				printf("Il Santuario del Tempo\nè sempre più bello! Bzzz!")
          			  case 1:
/*<319>*/ 				printf("Stai cercando un drago? Bzzz?\nSe si tratta del <b<<b<\x0E\x01\x09\x04\x1303\x00<b<drago del fulmine>>, \npotresti trovarlo a sud delle <b<grotte di\nRanel>>. \nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*< 85>*/ 						scene_flags[7 'Lanayru Desert'][35 /* 0x5 08 */] = true;
          				  ...
          				  case 1:
/*<325>*/ 					printf("Stai cercando un drago? Bzzz?\nSe si tratta del <b<<b<\x0E\x01\x09\x04\x1303\x00<b<drago del fulmine>>, \npotresti trovarlo a sud delle <b<grotte di\nRanel>>. \nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*<130>*/ 	start()
/*<131>*/ 	printf("\x0E\x01\x05\x04Z\x00Da centinaia di anni, il deserto\navanza in questa zona.\nÈ un'area molto arida.")
          }
...
/*<132>*/ 	start()
/*<133>*/ 	printf("\x0E\x01\x05\x04Z\x00Si presume che <b<Zelda>>\nsi sia diretta più avanti.")
...
/*<187>*/ 				printf("Hai scoperto la combinazione? Bzzz!\nSei in gamba! Bzzz!")
          			  case 1:
/*<331>*/ 				printf("Stai cercando un drago? Bzzz?\nSe si tratta del <b<<b<\x0E\x01\x09\x04\x1303\x00<b<drago del fulmine>>, \npotresti trovarlo a sud delle <b<grotte di\nRanel>>. \nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*<295>*/ 	start()
/*<296>*/ 	printf("Siamo arrivati al <b<Santuario del Tempo>>.\n\n\n\nÈ possibile individuare con il\nrilevatore il portale della prova,\nnecessario per ottenere\nla fiamma sacra.")
...
/*<189>*/ 				printf("Hai scoperto la combinazione? Bzzz!\nSei in gamba! Bzzz!")
          			  case 1:
/*<337>*/ 				printf("Stai cercando un drago? Bzzz?\nSe si tratta del <b<<b<\x0E\x01\x09\x04\x1303\x00<b<drago del fulmine>>, \npotresti trovarlo a sud delle <b<grotte di\nRanel>>. \nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*<191>*/ 				printf("Hai scoperto la combinazione? Bzzz!\nSei in gamba! Bzzz!")
          			  case 1:
/*<343>*/ 				printf("Stai cercando un drago? Bzzz?\nSe si tratta del <b<<b<\x0E\x01\x09\x04\x1303\x00<b<drago del fulmine>>, \npotresti trovarlo a sud delle <b<grotte di\nRanel>>. \nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*<212>*/ 	printf("Vi suggerirei di utilizzare\n<b<diversi>><pling> fari celesti. ")
