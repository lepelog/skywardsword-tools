...
/*< 24>*/ 				switch (zone_temp_flags[1 /* 0x1 02 */]) {
          				  case 0:
/*< 32>*/ 					printf("Vuoi riprovare l'ebbrezza delle\nMontagne russe? Un giro costa\n20 rupie!\n[1]Sì[2-]No")
          					flw_2:
/*<  2>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_8:
...
/*< 40>*/ 							printf("Non hai abbastanza soldi?\nChe peccato!\n\n\nTorna qui appena ne avrai\nracimolati un po'.")
          						}
          					  case 1:
...
/*< 38>*/ 						printf("Lo scopo è arrivare alla fine del\npercorso nel minor tempo possibile.\n\n\nInclina il telecomando Wii per\nbilanciare il carrello.\n\n\nCol tempismo giusto, acquisterai\nvelocità mentre sei in curva!\n\n\nAttento però: la minima distrazione\ne deraglierai!")
...
/*< 36>*/ 						printf("Lasciarmi spiegare le regole\nnon ti costerà nulla...")
...
/*< 79>*/ 									story_flags[667 /* us: 805A9B1E 0x02, jp: 805ACD9E 0x02 */] = true;
          							  ...
          							  case 1:
/*<123>*/ 								printf("Eccoti una rupia che custodivo\ncon cura!")
...
/*< 49>*/ 			printf("Accidenti! Non è andata bene!\nPuoi sempre tornare e riprovare\nquando vuoi!")
...
/*< 99>*/ 			printf("Tempo scaduto! Riprova la\nprossima volta!")
...
/*< 96>*/ 		printf("Quello è il mio sedile, per tutti\ni porfidi!")
          		goto flw_98
          	}
          }
