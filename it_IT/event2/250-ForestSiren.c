...
/*< 89>*/ 	start()
          	flw_67:
/*< 67>*/ 	set_camera(6, 0)
/*< 65>*/ 	printf(/* textboxtype: 2, unk: 2, line: 9 */ "Appena farete un passo fuori\nda quella zona, verrete\ninseguito dai <color red<guardiani>coloroff>.")
/*< 68>*/ 	set_camera(4, 0)
/*< 66>*/ 	printf(/* textboxtype: 2, unk: 2, line: 10 */ "Se verrete colpito anche solo una volta\nda uno dei <color red<guardiani>coloroff>, il vostro spirito\nandrà in frantumi e fallirete la prova.")
/*< 69>*/ 	set_camera(5, 0)
/*< 70>*/ 	printf(/* textboxtype: 2, unk: 2, line: 11 */ "Raccogliete le <color yellow<lacrime >coloroff>e \nriempite il<color yellow< ricettacolo dello spirito>coloroff>\nsenza farvi colpire.")
          	flw_74:
/*< 74>*/ 	set_camera(1, 0)
/*< 75>*/ 	printf(/* textboxtype: 2, unk: 2, line: 13 */ "Avete bisogno che ripeta le\nistruzioni, <0x10012:0x00000002>mio signore?\n[1-]Sì[2]No")
/*< 76>*/ 	switch (choice(2)) {
          	  case 0:
/*< 77>*/ 		printf(/* textboxtype: 2, unk: 2, line: 14 */ "Cosa preferite che vi spieghi?\n\n[1-]Il ricettacolo\ndello spirito[2-]I guardiani[3-]Oltremondo[4]Niente")
/*< 92>*/ 		switch (choice(4)) {
          		  case 0:
...
/*< 15>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 16>*/ 		printf(/* textboxtype: 1, unk: 2, line: 28 */ "<heroname>!\nImpegnati al massimo!")
/*< 18>*/ 		set_camera(10, 0)
...
/*< 12>*/ 			set_camera(3, 0)
/*< 13>*/ 			printf(/* textboxtype: 2, unk: 2, line: 7 */ "Ecco una <color yellow<lacrima di Farore>coloroff>.\nDovrete raccoglierne <color red<15>coloroff>.")
