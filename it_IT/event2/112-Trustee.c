...
/*< 91>*/ 						switch (is_item_check_full()) {
          						  case 0:
/*< 93>*/ 							printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00000015>Guarda, non mi pesa custodire\nle tue cose, però qui è pieno di\nroba tua!\n\nPer favore, <color red<getta via >coloroff>quello che\nnon ti serve più...")
          							goto flw_5
          						  case 1:
/*< 92>*/ 							printf(/* textboxtype: 1, unk: 0, line: 2 */ "<0x10009:0x00000015>Fai come preferisci...")
          							goto flw_5
          						}
          					  case 1:
/*< 27>*/ 						switch (is_item_check_full()) {
          						  case 0:
/*< 28>*/ 							printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x00000004>Guarda, non mi pesa custodire\nle tue cose, però qui è pieno di\nroba tua!\n\nPer favore, <color red<getta via >coloroff>quello che\nnon ti serve più...")
          							goto flw_5
          						  case 1:
/*<  2>*/ 							printf(/* textboxtype: 1, unk: 0, line: 1 */ "<0x10009:0x00000003>Prego!")
          							goto flw_5
          						}
          					}
          				}
...
/*< 60>*/ 						switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          						  case 0:
          							flw_52:
/*< 52>*/ 							printf(/* textboxtype: 1, unk: 0, line: 32 */ "<0x10009:0x0000000a>Oh, caro, non hai niente\ncon te.\n\n\nNon ti preoccupare, sono\nsicura che presto avrai\ntante belle cose da\ndepositare.")
          						  case 1:
/*< 55>*/ 							printf(/* textboxtype: 1, unk: 0, line: 33 */ "<0x10009:0x00000004>Oh. Non hai niente!\n\n\n\nTorna a trovarmi quando avrai\nqualcosa da depositare.")
          				  ...
          				  case 1:
/*< 17>*/ 					printf(/* textboxtype: 1, unk: 0, line: 31 */ "<0x10009:0x00000004>Oh! Ma non hai niente...\n\n\n\nTorna da me quando avrai davvero\nqualcosa da depositare.")
          				}
          			}
          		  case 1:
...
/*< 57>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_47:
/*< 47>*/ 						printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x000e150c>Ehi! Basta! Mi stai prendendo\nin giro!")
          					  case 1:
...
/*< 49>*/ 				switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          				  case 0:
/*< 46>*/ 					printf(/* textboxtype: 1, unk: 0, line: 7 */ "<0x10009:0x00000017>Ehi, ma che problema hai!\nSe non vuoi niente, smettila\ndi importunarmi!")
          				  case 1:
/*< 48>*/ 					switch (story_flags[628 /* us: 805A9B1B 0x80, jp: 805ACD9B 0x80 */]) {
          					  case 0:
/*< 87>*/ 						printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10009:0x00000002>Ehi, ma che problema hai?\nSe non vuoi niente, smettila\ndi importunarmi!")
          					  case 1:
/*<  3>*/ 						printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x00000002>Va bene, questa volta ti perdono\nper avermi fatto perdere del tempo.")
          					}
          				}
          			}
          		}
...
/*< 94>*/ 			switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          			  case 0:
/*< 95>*/ 				printf(/* textboxtype: 1, unk: 0, line: 20 */ "<0x10009:0x00000015>Hai troppa roba in deposito!\n\n\n\nNon so più dove metterla. Per\nfavore, <color red<getta via >coloroff>le cose che\nnon ti servono.")
          			  case 1:
/*< 26>*/ 				printf(/* textboxtype: 1, unk: 0, line: 19 */ "<0x10009:0x00000004>Tutto il deposito è pieno\ndi roba tua!\n\n\nNon c'è più spazio... per favore,\n<color red<getta via >coloroff>quello che non ti \nserve più, te ne prego.")
          			}
          		  case 1:
/*< 88>*/ 			switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          			  case 0:
/*< 89>*/ 				printf(/* textboxtype: 1, unk: 0, line: 16 */ "<0x10009:0x00000006>Grazie tante...")
          			  case 1:
...
/*< 36>*/ 	switch (story_flags[630 /* us: 805A9B1A 0x02, jp: 805ACD9A 0x02 */]) {
          	  case 0:
/*< 35>*/ 		printf(/* textboxtype: 1, unk: 0, line: 24 */ "Fanno <color red<<color red<<numeric arg0 0><color red< rupie\n>coloroff>per il deposito.\n\n\nSei sicuro?\n[1-]Sì[2]No")
          		flw_11:
/*< 11>*/ 		switch (choice(2)) {
          		  case 0:
...
/*< 78>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_40:
/*< 40>*/ 						printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00000008>Grazie! Forse hai qualcos'altro\nda mettere in deposito. Puoi stare qui\ntutto il tempo che vuoi a guardarmi!")
          						flw_53:
...
/*< 79>*/ 						printf(/* textboxtype: 1, unk: 0, line: 27 */ "<0x10009:0x00000003>Grazie!\nC'è qualcos'altro?")
          			  ...
          			  case 1:
/*< 10>*/ 				printf(/* textboxtype: 1, unk: 0, line: 25 */ "<0x10009:0x00000003>Grazie.\nPosso fare qualcos'altro per te?")
          				goto flw_53
          			}
          		  case 1:
...
/*< 75>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_38:
/*< 38>*/ 						printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x00000012>Oh! Non vuoi?\nMa certo! Non ne vale la pena.\nChe furbo che sei, caro mio!")
          						goto flw_53
          					  case 1:
/*< 76>*/ 						printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10009:0x00000014>Eh? Cambiato idea? Beh,\ncambiare idea è normale.\nProprio come hai cambiato\nidea anche su di me...")
          						goto flw_53
          					}
          				  case 1:
          					goto flw_38
          			  ...
          			  case 1:
/*< 13>*/ 				printf(/* textboxtype: 1, unk: 0, line: 28 */ "Oh? Hai cambiato idea?\nChe peccato.")
          				goto flw_53
          			}
          		}
          	  case 1:
/*<  9>*/ 		printf(/* textboxtype: 1, unk: 0, line: 23 */ "Mmmh... sono disposta a pagare\n<color red<<color red<<numeric arg0 0><color red< rupie>coloroff>.\n\n\nChe mi dici, affare fatto?\n[1-]Sì[2]No")
          		goto flw_11
          	}
          }
...
/*< 81>*/ 			switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          			  case 0:
          				flw_82:
/*< 82>*/ 				printf(/* textboxtype: 1, unk: 0, line: 32 */ "<0x10009:0x0000000a>Oh, caro, non hai niente\ncon te.\n\n\nNon ti preoccupare, sono\nsicura che presto avrai\ntante belle cose da\ndepositare.")
          			  case 1:
/*< 83>*/ 				printf(/* textboxtype: 1, unk: 0, line: 33 */ "<0x10009:0x00000004>Oh. Non hai niente!\n\n\n\nTorna a trovarmi quando avrai\nqualcosa da depositare.")
          	  ...
          	  case 1:
/*< 15>*/ 		printf(/* textboxtype: 1, unk: 0, line: 31 */ "<0x10009:0x00000004>Oh! Ma non hai niente...\n\n\n\nTorna da me quando avrai davvero\nqualcosa da depositare.")
          	}
          }
