...
/*< 29>*/ 	start()
/*< 28>*/ 	printf(/* textboxtype: 1, unk: 0, line: 16 */ "Otterrai un tesoro raro se troverai\ntutte le rupie partecipando a\n<color blue<Stana la rupia>coloroff>.")
          }
...
/*< 58>*/ 	switch (story_flags[19 /* us: 805A9ADB 0x08, jp: 805ACD5B 0x08 */]) {
          	  case 0:
/*< 56>*/ 		printf(/* textboxtype: 1, unk: 1, line: 17 */ "Nel cuore di questo vulcano incontrerai\ni <color blue<Mogma>coloroff>, amanti di tesori. Anche se si\ndice che di recente se la stiano\nprendendo piuttosto comoda.")
          	  case 1:
          		flw_59:
/*< 59>*/ 		printf(/* textboxtype: 1, unk: 1, line: 19 */ "Si dice che un <color red<drago >coloroff>viva sulla <color red<vetta\n>coloroff>del vulcano.\n\n\nPerò questa non sembra affatto\nla vetta...")
/*< 60>*/ 		printf(/* textboxtype: 1, unk: 1, line: 18 */ "Vuoi ascoltare di nuovo?\n[1-]Sì[2]No")
/*< 62>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_59
          		  case 1:
/*< 61>*/ 			printf(/* textboxtype: 1, unk: 1, line: 20 */ "Non sei dell'umore giusto?<pause 15>\nCapisco...")
          		}
          	}
          }
...
/*< 13>*/ 		switch (is_item_check_full()) {
          		  case 0:
/*< 11>*/ 			printf(/* textboxtype: 5, unk: 1, line: 9 */ "La tua borsa è piena e\nnon c'è più spazio al <color red<deposito>coloroff>...\n\n\nL'oggetto è stato riposto\nnello scrigno.")
          		  case 1:
/*< 10>*/ 			printf(/* textboxtype: 5, unk: 1, line: 8 */ "La tua borsa è piena e l'oggetto\nè stato inviato al <color red<deposito>coloroff>!")
          		}
          	  case 1:
          	}
          }
...
/*< 30>*/ 		printf(/* textboxtype: 1, unk: 0, line: 21 */ "Il <color red<drago >coloroff>che vive sulla vetta del vulcano\nadora conversare.\n\n\nNon la smetterà più di parlarti delle\naltre terre.")
          	  case 1:
          		flw_52:
/*< 52>*/ 		printf(/* textboxtype: 1, unk: 0, line: 22 */ "Si dice che sulla vetta del vulcano viva\nun <color red<drago >coloroff>avvolto dalle fiamme.\n\n\nIn un <color red<luogo dalle temperature\naltissime>coloroff>, inaccessibile ai più.")
/*< 53>*/ 		printf(/* textboxtype: 1, unk: 1, line: 18 */ "Vuoi ascoltare di nuovo?\n[1-]Sì[2]No")
/*< 55>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_52
          		  case 1:
/*< 54>*/ 			printf(/* textboxtype: 1, unk: 1, line: 20 */ "Non sei dell'umore giusto?<pause 15>\nCapisco...")
          		}
          	}
          }
...
/*< 65>*/ 	start()
/*< 66>*/ 	printf(/* textboxtype: 2, unk: 1, line: 35 */ "Volete scendere qui?\n[1-]Sì[2]No")
/*< 67>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
...
/*<  1>*/ 	start()
/*<  3>*/ 	printf(/* textboxtype: 9, unk: 0, line: 2 */ "<0x1000F:0x>Il cartello è in frantumi.\nNon è possibile leggerlo.")
          }

          void entrypoint_004_113() {
/*< 41>*/ 	start()
/*< 40>*/ 	printf(/* textboxtype: 1, unk: 0, line: 27 */ "Sembra che, disegnando del denaro sui\nmuri misteriosi, appaia del denaro\nvero.\n")
          }
...
/*< 46>*/ 	start()
/*< 47>*/ 	printf(/* textboxtype: 9, unk: 0, line: 1 */ "<0x1000F:0x>La porta è sigillata.")
          }

          void entrypoint_004_116() {
/*< 63>*/ 	start()
/*< 64>*/ 	printf(/* textboxtype: 1, unk: 0, line: 30 */ "Sembra che, disegnando tre triangoli\nsui muri misteriosi, possano apparire\ndelle <color yellow<fate>coloroff>.")
          }

          void entrypoint_004_117() {
/*< 75>*/ 	start()
/*< 76>*/ 	printf(/* textboxtype: 1, unk: 1, line: 31 */ "Sembra che da queste parti sia\nnascosto un <color yellow<frammento di cuore>coloroff>.")
/*< 77>*/ 	switch (scene_flags[104 /* 0xC 01 */]) {
          	  case 0:
/*< 78>*/ 		printf(/* textboxtype: 1, unk: 1, line: 33 */ "Mi sa che l'hai già preso...\nMmh...")
          	  case 1:
/*< 79>*/ 		printf(/* textboxtype: 1, unk: 1, line: 32 */ "Però, per poterlo ottenere, si deve\nsaper scavare come un vero <color blue<Mogma>coloroff>.")
          	}
          }

          void entrypoint_004_100() {
/*< 17>*/ 	start()
/*< 16>*/ 	printf(/* textboxtype: 1, unk: 0, line: 10 */ "BOOON‐jour!")
          }

          void entrypoint_004_008() {
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 2, unk: 2, line: 4 */ "Volete lasciare questo mondo?\n[1-]Sì[2]No")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
...
/*< 19>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 0, line: 11 */ "Se in <color blue<Affetta il bambù>coloroff> riesci a\neffettuare <color red<più di>coloroff> <color red<28 tagli>coloroff>\notterrai un tesoro.\n\nIl record attuale è di 43 tagli.\nO almeno così dicono...")
          }

          void entrypoint_004_102() {
/*< 21>*/ 	start()
/*< 20>*/ 	printf(/* textboxtype: 1, unk: 0, line: 12 */ "Otterrai degli insetti rari e difficili da\ncatturare se completerai il livello\navanzato di <color blue<Insettopoli >coloroff><color red<in meno\ndi 2 minuti>coloroff>.")
          }

          void entrypoint_004_103() {
/*< 23>*/ 	start()
/*< 22>*/ 	printf(/* textboxtype: 1, unk: 0, line: 13 */ "Noi <color blue<statue chiacchierone >coloroff>attiriamo\nmolte <color red<farfalle>coloroff>.\n\n\nSe una <color red<dolce melodia >coloroff>viene suonata\ndove si radunano, noi facciamo\nBOOON‐jour!")
          }
...
/*< 27>*/ 	start()
/*< 42>*/ 	printf(/* textboxtype: 1, unk: 0, line: 28 */ "Sembra che, disegnando la forma\ndell'amore sui muri misteriosi ci si\npossa sentire subito meglio.")
          }
