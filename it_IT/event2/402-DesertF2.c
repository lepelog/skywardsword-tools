...
/*<267>*/ 						changeScene(2, 0) // 
          					  case 1:
/*<265>*/ 						printf("\x0E\x01\x09\x04\x07\x00Ti accompagno fino\nalla mia nave! Bzzz!")
/*<266>*/ 						changeScene(4, 0) // 
          					  case 2:
...
/*<150>*/ 				switch (story_flags[272 /* us: 805A9AF8 0x04, jp: 805ACD78 0x04 */]) {
          				  case 0:
/*< 27>*/ 					printf("\x0E\x01\x09\x04\x07\x00Salpiamo? Bzzz?\nDove mi dirigo?\n[1]Mare... [2]Galeone\ndelle sabbie[3-]Resta qui")
/*< 28>*/ 					switch (choice(3)) {
          					  case 0:
/*< 29>*/ 						printf("\x0E\x01\x09\x04\x07\x00Allora salpiamo! Bzzz!")
/*< 33>*/ 						changeScene(2, 0) // 
          					  case 1:
/*< 31>*/ 						printf("\x0E\x01\x09\x04\x07\x00Ti accompagno fino\nalla mia nave! Bzzz!")
/*< 32>*/ 						changeScene(0, 0) // 
          					  case 2:
...
/*<213>*/ 			set_camera(14, 0)
/*<211>*/ 			printf("\x0E\x01\x09\x04\x07\x00Per fortuna la corrente\nmi trasportò fino al porto<pause05>.<pause05>.<pause05>.\n")
/*<269>*/ 			set_camera(17, 0)
...
/*<214>*/ 				set_camera(15, 0)
/*<207>*/ 				printf("Se mi aiuti, ti faccio salire\nsulla barca con me. Che fai? Bzzz.\n[1]Ti aiuto[2-]Non mi va")
/*<215>*/ 				set_camera(-1, 0)
          				goto flw_134
          			  case 1:
          				goto flw_209
...
/*<145>*/ 	start()
/*<146>*/ 	printf("Per saltare gli ostacoli,\nscuoti il telecomando\nverso l'alto.")
          }
...
/*< 94>*/ 	start()
/*< 97>*/ 	printf("Bene! Apriamo la <y<carta\nnautica >>che hai portato!")
...
/*<109>*/ 		printf("\x0E\x01\x09\x04\x07\x00Forza!\nDecidiamoci e partiamo!")
...
/*<169>*/ 	start()
/*<170>*/ 	printf("\x0E\x01\x12\x04\x00\x01Mio signore.\nGuardate!")
/*<178>*/ 	set_camera(8, 0)
...
/*<126>*/ 	start()
/*<129>*/ 	printf("\x0E\x01\x05\x04Z\x00Ora si è completamente\nprosciugato e si è trasformato\nin un mare di sabbia.")
          }
...
/*<127>*/ 	start()
/*<130>*/ 	printf("\x0E\x01\x05\x04Z\x00Questo probabilmente\ndoveva essere un porto per\nlo sbocco sul mare.")
          }
...
/*<228>*/ 	set_camera(16, 0)
/*<227>*/ 	printf("Rilevo la presenza di\ninsetti nella parte superiore\ndella casa.")
...
/*<289>*/ 				switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          				  case 0:
          					flw_277:
/*<277>*/ 					printf("Ancora sogno quel giorno\nin cui fummo attaccati dai\npirati! Bzzz!\nChe paura.<pause05>.<pause05>.<pause05>!\n")
          					flw_56:
...
/*<158>*/ 	set_camera(1, 0)
/*<156>*/ 	printf("La mia casa è proprio\nsulla cima! Bzzz!\nDa vero capitano!")
/*<159>*/ 	set_camera(2, 0)
...
/*<166>*/ 	set_camera(5, 0)
/*<138>*/ 	printf("Però l'ingresso è chiuso e\nnon possiamo entrare.")
/*<162>*/ 	set_camera(6, 0)
/*<139>*/ 	printf("\x0E\x01\x09\x04\x07\x00Gli edifici dell'isola\nsono collegati tra di loro\ndai binari del carrello!")
/*<164>*/ 	printf("\x0E\x01\x09\x04\x07\x00Usando il carrello forse\nriuscirai a entrare nel cantiere\ndall'entrata posteriore! Bzzz!")
