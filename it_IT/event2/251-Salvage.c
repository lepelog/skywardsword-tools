...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0, line: 3 */ "<0x10012:0x00000064>Adorata Faih!\nAccorro! Eccomi! Bzzz!\n\n\nVuoi che trasporti qualcosa?\nCerto! Bzzz!")
          }

          void entrypoint_251_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 1, unk: 0, line: 4 */ "Ecco qui! Ti aspetto in volo, nel cielo,\nraggiungimi presto!!! Bzzz!!!")
          }

          void entrypoint_251_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 2, unk: 0, line: 5 */ "<0x10012:0x00000001>Signore, suggerirei di tornare nel\nCielo e portare subito il Kyuri nella\nterra designata.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10012:0x00000064>Ehi, togliti di mezzo! Bzzz!\nNon farmi ripetere sempre le\nstesse cose! Sgrunt!")
          }
...
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf(/* textboxtype: 2, unk: 0, line: 2 */ "<0x10012:0x00000005>Bene, signore. Proverò\na chiamare il robot telepaticamente.")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 2, unk: 0, line: 1 */ "<0x10012:0x00000005>Bene, signore,\nse volete trasportarla\nesaminatela di nuovo.")
          	}
          }
...
/*< 40>*/ 						story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */] = true;
          				  ...
          				  case 1:
/*< 18>*/ 					printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x00090013>Ma ci sono ancora\nun sacco di cattivi in giro...\n\n\n<0x10009:0x00070004>Noi Kyuri saremo\ncondannati a passare la\nnostra vita così?!")
          					goto flw_19
          				}
          			  case 1:
