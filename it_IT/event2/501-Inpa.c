...
/*<165>*/ 		set_camera(22, 0)
/*<164>*/ 		printf("\x0E\x01\x09\x04\xE10\x1600Ehi, Link!\nDevi imprigionare di nuovo la \ncreatura oscura.")
...
/*<474>*/ 		switch (story_flags[175 /* us: 805A9AE2 0x40, jp: 805ACD62 0x40 */]) {
          		  case 0:
/*<475>*/ 			printf("\x0E\x01\x09\x04\x00\x05Cerchi i tre draghi?\nIl drago del fulmine dovrebbe\nessere nel deserto...")
          		  case 1:
...
/*<353>*/ 	printf("\x0E\x01\x09\x04\xE00\x04Aspetta, Link!\nNon è là che si verificano gli \nstrani fenomeni!")
/*<354>*/ 	set_camera(62, 0)
...
/*< 78>*/ 	printf("\x0E\x01\x09\x04\xE01\x07... Bene!\nVai, Link!")
/*<306>*/ 	set_camera(53, 0)
...
/*<228>*/ 					switch (scene_flags[98 /* 0xD 04 */]) {
          					  case 0:
/*<231>*/ 						printf("\x0E\x01\x09\x04\x00\x03<b<Bado >>ti sta aspettando.\nVai alla <r<catapulta>>!\nDovresti trovarlo là.")
          					  case 1:
...
/*<230>*/ 						scene_flags[10 'Sealed Grounds'][98 /* 0xD 04 */] = true;
          			  ...
          			  case 1:
/*<233>*/ 				printf("\x0E\x01\x09\x04\x00\x07Se penso a quello che è accaduto\nalla foresta...\nPer fortuna tutto è tornato alla\nnormalità!")
...
/*<224>*/ 			printf("\x0E\x01\x09\x04\x00\nTu continua pure a cercare di\nricomporre la <r<Melodia dell'impavido>>.\nNon ci resta molto tempo!")
          		  case 1:
/*<221>*/ 			printf("\x0E\x01\x09\x04\x00\x07Se penso a quello che è accaduto\nalla foresta...\nPer fortuna tutto è tornato alla\nnormalità!")
...
/*<255>*/ 						printf("\x0E\x01\x09\x04\x00\x02Link! Ti affido <b<Zelda>>!\n\n\n\nA proposito, visto che ho deciso di\n<r<far nascere>> qui un grande albero,\nnon è che per caso hai un seme da\ndarmi?")
          		  ...
          		  case 1:
/*<252>*/ 			printf("\x0E\x01\x09\x04\x0C\x206Al di là della porta\nti starà aspettando <b<Zelda>>!\nPresto, vai Link!")
          		}
          	  case 1:
...
/*< 12>*/ 	set_camera(10, 0)
/*< 13>*/ 	printf("\x0E\x01\x09\x04\x400\x02Mi prendi in giro!\nProva a dirlo di nuovo!")
...
/*<317>*/ 	printf("\x0E\x01\x09\x04\x401\xFF04\x0E\x01\x08\x02\x1CDEhi!\nAspetta un attimo!")
...
/*<278>*/ 		set_camera(49, 0)
/*<209>*/ 		printf("\x0E\x01\x09\x04\x00\x1303Prima o poi la verità ti si\nrivelerà... \nProsegui senza timore,\nLink!")
...
/*<323>*/ 	printf("\x0E\x01\x09\x04\xE08\xFF00Allora, Link!\nBuon viaggio!")
/*<423>*/ 	set_camera(1, 0)
