...
/*< 77>*/ 	switch (story_flags[798 /* us: 805A9B2F 0x40, jp: 805ACDAF 0x40 */]) {
          	  case 0:
/*< 76>*/ 		printf(/* textboxtype: 1, unk: 0, line: 22 */ "Devi sconfiggere Mortipher!\n<0x10009:0x00000003>Ora tutto è nelle tue mani,\n<heroname>!")
          	  case 1:
...
/*< 79>*/ 	start()
/*< 86>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "<heroname>, <0x10012:0x00000004>mio signore,\nsiete pronto per la battaglia?\n[1-]Pronto![2]Non ancora")
/*< 87>*/ 	switch (choice(2)) {
          	  case 0:
/*< 88>*/ 		printf(/* textboxtype: 2, unk: 0, line: 30 */ "Certamente, <0x10012:0x00000005>mio signore.\nAndiamo!")
/*< 90>*/ 		changeScene(11, 0) // 
          	  case 1:
/*< 89>*/ 		printf(/* textboxtype: 2, unk: 0, line: 31 */ "Certamente, <0x10012:0x00000005>mio signore.\nQuando avrete terminato con\ni preparativi, tornate qui.")
          	}
          }

          void entrypoint_502_09() {
/*< 80>*/ 	start()
/*< 81>*/ 	printf(/* textboxtype: 2, unk: 0, line: 26 */ "<heroname>, <0x10012:0x00000004>mio signore,\ndesiderate tornare indietro e\nprepararvi prima della battaglia?\n[1-]Buona idea![2]Non serve")
/*< 82>*/ 	switch (choice(2)) {
          	  case 0:
/*< 83>*/ 		printf(/* textboxtype: 2, unk: 0, line: 27 */ "Certamente, <0x10012:0x00000005>mio signore.\nQuando avrete terminato con\ni preparativi, tornate qui.")
/*< 85>*/ 		changeScene(10, 0) // 
          	  case 1:
/*< 84>*/ 		printf(/* textboxtype: 2, unk: 0, line: 28 */ "<0x10012:0x00000005>Sì, mio signore...")
          	}
          }
...
/*< 48>*/ 					switch (scene_flags[103 /* 0xD 80 */]) {
          					  case 0:
/*< 50>*/ 						printf(/* textboxtype: 1, unk: 0, line: 14 */ "<0x10009:0x00000003>Già si sente la sua forza vitale!\nSi trasformerà in un albero la cui\nbellezza risplenderà nel futuro.")
          					  case 1:
/*< 47>*/ 						printf(/* textboxtype: 1, unk: 0, line: 13 */ "<0x10009:0x0000000b>Oh! Hai piantato il germoglio!\n\n\n\nGià si sente la sua forza vitale!\nSi trasformerà in un albero la cui\nbellezza risplenderà nel futuro.")
...
/*< 35>*/ 						switch (choice(2)) {
          						  case 0:
/*< 36>*/ 							printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x00000703>Uhmm...\nNon è nulla di importante...")
...
/*< 25>*/ 		printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10009:0x00000012>È scappato dalla <color red<porta anteriore>coloroff>...\nPresto! Insegui <color blue<Ghiraim>coloroff>!")
          	  case 1:
/*< 22>*/ 		printf(/* textboxtype: 1, unk: 0, line: 16 */ "<0x10009:0x00000012>Argh?! Sei tu, <heroname>?\nGhiraim mi ha sconfitta...\n\n\nNon preoccuparti per me...\nVai a inseguirlo!")
/*< 20>*/ 		set_camera(4, 0)
/*< 23>*/ 		printf(/* textboxtype: 1, unk: 0, line: 17 */ "È scappato dalla <color red<porta anteriore>coloroff>...\nPuoi ancora farcela... Sbrigati!")
...
/*< 62>*/ 	start()
/*< 64>*/ 	printf(/* textboxtype: 2, unk: 1, line: 23 */ "<0x10012:0x0000000b><heroname>, mio signore, Faih a\nrapporto. Probabilità di non fare\nritorno se non sconfiggerete il vostro\navversario: 100%.\nSiete pronto?\n[1-]Sì[2]No")
/*< 63>*/ 	switch (choice(2)) {
          	  case 0:
/*< 65>*/ 		printf(/* textboxtype: 2, unk: 0, line: 25 */ "<0x10012:0x00000005>Certamente, mio signore.<pause 15> La vostra\nservitrice Faih è sempre pronta a\neseguire gli ordini del <0x10012:0x00000002>suo signore...\n<pause 30>Che la fortuna sia con voi!")
          	  case 1:
/*< 66>*/ 		printf(/* textboxtype: 2, unk: 0, line: 24 */ "<0x10012:0x00000005>Certamente, mio signore. Quando\nsarete pronto tornate pure qui.")
          	}
          }

          void entrypoint_502_05() {
/*< 67>*/ 	start()
/*< 68>*/ 	printf(/* textboxtype: 3, unk: 0, line: 32 */ "<0x10005:0x002d0000><0x10008:0x02cd>Pivello!")
          }
