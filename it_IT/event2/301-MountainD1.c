...
/*<107>*/ 	start()
/*<108>*/ 	printf(/* textboxtype: 2, unk: 0, line: 21 */ "Zelda ha trovato un modo per\nlasciare questo luogo. Suggerirei\ndi proseguire velocemente.\n\nUna volta inquadrato il nemico con (Z),\npotrete chiamarmi con (v) e vi\nillustrerò tutte le informazioni utili al\nriguardo in mio possesso.<0x10011:0x07cd><0x10011:0x09cd>")
          }
...
/*<  3>*/ 	printf(/* textboxtype: 1, unk: 0, line: 2 */ "Acciderbola! Non lo trovo più...\ndev'essermi caduto da qualche parte!")
...
/*<102>*/ 	set_camera(16, 0)
/*<101>*/ 	printf(/* textboxtype: 1, unk: 1, line: 4 */ "Stavo cercando tesori quando a un\ntratto sono sbucati dei mostri da lì\ndietro...<pause 15> Me la sono data a gambe,\nma <0x10009:0x0013100d>mi deve essere caduto!")
/*<104>*/ 	set_camera(-1, 0)
/*<103>*/ 	printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x000908ff>È un oggetto in cui <color red<puoi riporre i fiori\nbomba e usarli quando vuoi>coloroff>!\nÈ utilissimo, se lo saranno fregato i\nmostri!<pause 10>\n<0x10009:0x00110dff>Vammi a recuperare il\n<color yellow<portabombe>coloroff>, per favore!")
          }
...
/*< 14>*/ 	start()
/*< 15>*/ 	printf(/* textboxtype: 20, unk: 0, line: 31 */ "Santuario\ndella Terra")
          }
...
/*< 70>*/ 	wait_frames(10)
/*< 51>*/ 	set_camera(2, 0)
/*< 40>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x0d0805ff>A‐ha! Ci incontriamo ancora!")
/*< 79>*/ 	set_camera(10, 0)
/*< 78>*/ 	printf(/* textboxtype: 1, unk: 0, line: 23 */ "<0x10009:0x0d0005ff>Ah<pause 1>.<pause 1>.<pause 1>.<pause 1> \n<pause 8>Perdonami, ma...<pause 20>\nMi ripeteresti il tuo nome?\n\n<0x10009:0x0d0a05ff>Anche se, ripensandoci...\nnon mi importa granché,\nvisto che ora subirai la mia ira!")
...
/*< 67>*/ 	set_camera(3, 0)
/*< 61>*/ 	printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x0d0a05ff>In effetti, non c'è ragione di farlo!\n<pause 20>Anzi...<pause 20>\nLascerò esplodere...<pause 20>")
/*< 71>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3335, 'param2': 1535, 'next': 68, 'param3': 13}
/*< 68>*/ 	set_camera(4, 0)
/*< 62>*/ 	printf(/* textboxtype: 1, unk: 0, line: 30 */ "... questa mia collera inaudita!")
...
/*< 41>*/ 	start()
/*< 42>*/ 	printf(/* textboxtype: 2, unk: 0, line: 18 */ "<0x10012:0x0000000b>Signore, Faih a rapporto.\nIn questa zona avverto l'aura di Zelda.")
/*< 44>*/ 	set_camera(1, 0)
/*< 43>*/ 	printf(/* textboxtype: 2, unk: 0, line: 19 */ "In particolar modo questa catena...\nProbabilità che Zelda vi sia entrata\nin contatto: 95%.")
/*< 45>*/ 	set_camera(-1, 0)
/*< 46>*/ 	printf(/* textboxtype: 2, unk: 0, line: 20 */ "Apparentemente ha trovato un\nmodo per fuggire. Suggerirei\ndi proseguire velocemente.")
          }
