...
/*< 26>*/ 	switch (story_flags[64 /* us: 805A9ADF 0x08, jp: 805ACD5F 0x08 */]) {
          	  case 0:
/*< 24>*/ 		printf("Probabilità che questa sia\nla stessa acqua dell'orcio del\ndrago d'acqua: 95%.\nTorniamo da lei.")
...
/*< 46>*/ 		printf("Accidenti... con tutta la fatica\nfatta per fregare la chiave a\nquei mostri!")
...
/*<100>*/ 		printf("Comunque, visto che sono\nqui, mi metto a caccia di\ntesori!")
...
/*< 67>*/ 	printf("Accidenti... sono venuto\nfin qua per niente.")
...
/*<117>*/ 		printf("Ehi ehi! Non vorrai mica\nandare da solo?!")
...
/*<121>*/ 		printf("Ti sei fatto fregare da\nquel grosso masso parlante!")
...
/*<176>*/ 			printf("Ah, ottimo! Hai trovato\nquella chiave, bene, grazie!")
          			goto flw_182
          		}
          	  case 1:
...
/*<190>*/ 			printf("Uff! Ma dov'era? Forse non in\nquesta stanza... Mmh... C'hai\nmica una mappa?!")
          			goto flw_256
          		  case 1:
...
/*<235>*/ 	printf("Accidenti... con tutta la fatica\nfatta per fregare la chiave a\nquei mostri!")
