...
/*< 67>*/ 	start()
/*< 68>*/ 	printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x00000005>È difficile credere a quello che mi\ncapita davanti agli occhi...\n\n\nMi chiedo cosa potrà mai accadere se\nfai quello che ti ha detto lei!?")
          }
...
/*< 82>*/ 		switch (zone_temp_flags[19 /* 0x3 08 */]) {
          		  case 0:
          			flw_84:
/*< 84>*/ 			printf(/* textboxtype: 1, unk: 0, line: 28 */ "<0x10009:0x00000004>Io credo che tu incontrerai di\nnuovo Zelda!\n\n\nConto su di te, <heroname>!")
/*< 83>*/ 			zone_temp_flags[19 /* 0x3 08 */] = true;
          		  case 1:
/*< 64>*/ 			printf(/* textboxtype: 1, unk: 0, line: 25 */ "<0x10009:0x00000002>Ehi, <heroname>!\n\n\n\nMa che succede?!<pause 30>\nLa Dea... L'Isola della Dea...\nÈ... scomparsa?!\n[1-]Veramente...[2-]Ehm...")
/*< 66>*/ 			switch (choice(2)) {
          			  case 0:
          				flw_65:
/*< 65>*/ 				printf(/* textboxtype: 1, unk: 0, line: 26 */ "Non dire nulla, <heroname>!\n\n\n<color yellow white<\nAllorché la sciagura sarà evitata,\nsulla Terra la Dea sarà ritornata...\n\n>coloroff>\nQueste sono le ultime parole di ciò\nche viene tramandato per <color red<tradizione\norale>coloroff>...<pause 20> Adesso ne colgo il senso,\nera questo dunque...\nCiò significa anche che tutto è\ncompiuto?<pause 20> Che mia figlia...<pause 10> Zelda è\nsana e salva?!\n[1-]Mi dispiace[2-]No")
/*< 98>*/ 				switch (choice(2)) {
          				  case 0:
          					flw_99:
...
/*< 85>*/ 							switch (story_flags[327 /* us: 805A9AFF 0x20, jp: 805ACD7F 0x20 */]) {
          							  case 0:
/*< 86>*/ 								printf(/* textboxtype: 1, unk: 0, line: 23 */ "<0x10009:0x00000002>Mi chiedo se esista qualcuno capace di\ndirci qualcosa di più sulla Triforza...\n\n\nBeh, in ogni caso, non credo\nche si trovi a Oltrenuvola...\nUhm...")
          							  case 1:
...
/*< 29>*/ 	printf(/* textboxtype: 1, unk: 0, line: 34 */ "Ho un indizio...\n\n\n\nCome sai, qui a Oltrenuvola,\nsin dall'antichità risiede <color blue<Narisha>coloroff>,\nil <color red<grande spirito celeste>coloroff>.\n\n<0x1000A:0x000200cd>Narisha protegge il cielo\nsin dalla notte dei tempi e sa\nqualunque cosa.\n\nPotresti chiedere a lui\ninformazioni sulla <color yellow white<Triforza>coloroff>...\n\n[1-]Dov'è?[2-]Sa tutto?")
/*< 38>*/ 	switch (choice(2)) {
          	  case 0:
/*< 39>*/ 		printf(/* textboxtype: 1, unk: 0, line: 35 */ "Uhm... bella domanda...")
          		flw_45:
/*< 45>*/ 		set_camera(3, 0)
/*< 30>*/ 		printf(/* textboxtype: 1, unk: 0, line: 37 */ "Avrai notato che di recente\nsi è formata quella nuvola\nenorme... il <color red<Cumulonembo>coloroff>.\n\nBeh, si dice che Narisha\nsia rimasto intrappolato\ndentro quella nuvola...")
/*< 46>*/ 		set_camera(4, 0)
/*< 41>*/ 		printf(/* textboxtype: 1, unk: 0, line: 38 */ "Per verificare la veridicità delle voci,\nho chiesto al maestro <color blue<Asio Otus>coloroff> di\ncondurre delle ricerche riguardo a\nCumulonembo.\nPoi però è scomparsa Zelda e sono stato\ncosì preso dalla vicenda che non ho più\navuto il tempo di informarmi sui suoi\nprogressi in merito...\nMeglio che tu vada subito dal\nmaestro <color blue<Asio Otus >coloroff>a chiedergli\ndi Narisha.")
