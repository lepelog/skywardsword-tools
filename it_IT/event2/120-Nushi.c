...
/*< 17>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 0, line: 13 */ "La zuppa di zucca la lascio\nqui. Bzzz...\n\n\nCerto il luogo non è dei più\ntranquilli...")
          }

          void entrypoint_120_21() {
/*< 19>*/ 	start()
/*< 20>*/ 	printf(/* textboxtype: 1, unk: 0, line: 14 */ "Allora addio! Bzzz...<0x10005:0x00280000>")
...
/*< 31>*/ 		switch (story_flags[22 /* us: 805A9ADB 0x40, jp: 805ACD5B 0x40 */]) {
          		  case 0:
/*< 33>*/ 			printf(/* textboxtype: 1, unk: 0, line: 10 */ "Ohohoh... \nHai trovato l'ubicazione della Triforza!\nOttimo lavoro!")
          			goto flw_35
          		  case 1:
