...
/*< 25>*/ 	start()
/*< 26>*/ 	printf("\x0E\x01\x12\x04\x00\x01Signore, suggerisco di partire anche\nnoi alla volta del cielo e portare il\nMogma nel luogo di destinazione.")
...
/*< 30>*/ 	start()
/*< 31>*/ 	printf("\x0E\x01\x12\x04\x00d... ... ... Non farti ripetere le cose\nmille volte!!! Bzzz!")
          }

          void entrypoint_351_01() {
          	start()
/*<  1>*/ 	printf("Confermo il ritrovamento di un\nminerale estremamente simile alla\nsfera di cristallo dell'indovino e\nutilizzabile allo stesso modo.\nVolete che chiami il robot\nper trasportarlo?\n[1]Sì[2-]No")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf("\x0E\x01\x12\x04\x00\x05Bene, signore. Proverò a chiamare\nil robot tramite telepatia.")
          	  case 1:
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x05Bene, mio signore. Esaminatelo\nnuovamente se volete trasportarlo.")
          	}
          }

          void entrypoint_351_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf("\x0E\x01\x12\x04\x00dOh, Faih adorata! Bzzz! Eccomi di\nnuovo qui!\nVuoi che trasporti questo? Bzzz!")
          }

          void entrypoint_351_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf("Bene, lo porto su in cielo. Bzzz!\nNon fatemi aspettare troppo!")
          }

          void entrypoint_351_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf("\x0E\x01\x12\x04\x00\x01Signore, suggerisco di dirigerci anche\nnoi alla volta del Cielo e portare il\nminerale a destinazione.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf("\x0E\x01\x12\x04\x00dSignor Verdino, ti tieni sempre la\nparte piacevole del lavoro, tu! Bzzz!\nPfui!")
          }
