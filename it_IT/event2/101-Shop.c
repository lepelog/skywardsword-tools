...
/*< 25>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 6}) {
          	  case 0:
/*< 28>*/ 		printf(/* textboxtype: 1, unk: 0, line: 28 */ "<0x10009:0x00000002><color yellow<10 frecce>coloroff> sono sempre un ottimo\nacquisto, secondo me! E sono anche un\nottimo corredo per la divisa di un\navventuriero.\nTuttavia, stia ben attento a non\nscagliarle per sbaglio contro la gente.\nFanno <color red<20 rupie>coloroff>.\n[1-]Le compro[2]Non\nle compro")
/*< 21>*/ 		switch (choice(2)) {
          		  case 0:
...
/*< 31>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 8}) {
          	  case 0:
/*< 37>*/ 		printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10009:0x00000002>Aaah! Vedo che ha messo gli occhi su\n<color yellow<10 bombe>coloroff>. Con queste armi nel suo\narsenale il signore sarà davvero\ntemibile!\nSono ottime per abbattere intere\npareti con una sola esplosione.\n\n\nCostano <color red<20 rupie>coloroff>.\nChe cosa ne dice?\n[1-]Le compro[2]Non\nle compro")
          		flw_33:
/*< 33>*/ 		switch (choice(2)) {
          		  case 0:
...
/*< 52>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 16}) {
          	  case 0:
/*< 55>*/ 		printf(/* textboxtype: 1, unk: 0, line: 35 */ "<0x10009:0x00000002>Vedo che lei è interessato a questi\n<color yellow<10 semi Deku>coloroff>! Sono il proiettile\npreferito da ogni maestro di fionda.\n\nSe posso raccomandarglieli, sono\nprecisi e affidabili. Costano <color red<20 rupie>coloroff>.\n[1-]Li compro[2]Non\nli compro")
          		goto flw_33
          	  case 1:
...
/*< 80>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 20}) {
          	  case 0:
/*< 73>*/ 		printf(/* textboxtype: 1, unk: 0, line: 37 */ "<0x10009:0x00000002>Questo è un <color yellow<sacco per semi piccolo>coloroff>!\nLe basta alloggiarlo all'interno della\nsua borsa per poter trasportare 10 semi\nin più.\nÈ un accessorio fondamentale per\ntutti gli amanti della fionda!\nCosta <color red<100 rupie>coloroff>.\n\nChe ne dice, signore?\n[1-]Lo compro[2]Non\nlo compro")
          		goto flw_33
          	  case 1:
...
/*< 84>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 22}) {
          	  case 0:
/*< 76>*/ 		printf(/* textboxtype: 1, unk: 0, line: 38 */ "<0x10009:0x00000002>Questa è una <color yellow<faretra piccola>coloroff>!\nLe basta alloggiarla nella sua borsa per\npoter trasportare ben 5 frecce in più.\n\nÈ un acquisto obbligato per\nogni arciere che si rispetti!\n\n\nLe viene a costare <color red<150 rupie>coloroff>.\nLa vuole acquistare?\n[1-]La compro[2]Non\nla compro")
          		goto flw_33
          	  case 1:
/*< 85>*/ 		printf(/* textboxtype: 1, unk: 0, line: 29 */ "Mi scusi, signore. Purtroppo non posso\nvenderle questo articolo dal momento\nche lei non possiede ancora un arco.\nTemo che queste siano le regole.")
          	}
          }
...
/*< 79>*/ 		printf(/* textboxtype: 1, unk: 0, line: 39 */ "<0x10009:0x00000002>Questo è un <color yellow<portabombe piccolo>coloroff>!\nLe basta alloggiarlo nella sua borsa per\npoter trasportare ben 5 bombe in più.\n\nSe si trova spesso a corto di bombe,\ndeve assolutamente prenderlo!\n\n\nLe costa <color red<150 rupie>coloroff>.\nChe dice, lo compra?\n[1-]Lo compro[2]Non\nlo compro")
          		goto flw_33
          	  case 1:
/*< 88>*/ 		printf(/* textboxtype: 1, unk: 0, line: 31 */ "Mi scusi, signore. Purtroppo non posso\nvenderle questo articolo perché lei non\npossiede ancora un portabombe.\n\nLa prego di accettare le mie scuse,\nsignore.")
          	}
          }

          void entrypoint_101_05() {
/*< 15>*/ 	start()
/*< 16>*/ 	printf(/* textboxtype: 1, unk: 0, line: 16 */ "La prego di perdonarmi, signore.\nTemo che lei abbia già la massima\nquantità consentita per questo\nprodotto.\nSe vuole però, può sempre valutare\nqualche altra mercanzia.")
...
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 0, line: 17 */ "<0x10009:0x00000008>Ehm...<0x10005:0x000a0000>")
...
/*< 43>*/ 	switch (random(2)) {
          	  case 0:
/*< 20>*/ 		printf(/* textboxtype: 1, unk: 0, line: 19 */ "<0x10009:0x00000007>Aaah, la ringrazio.\nLei qui è sempre il benvenuto!")
          		flw_144:
...
/*<133>*/ 						story_flags[809 /* us: 805A9B31 0x02, jp: 805ACDB1 0x02 */] = true;
          			  ...
          			  case 1:
/*< 89>*/ 				printf(/* textboxtype: 1, unk: 0, line: 22 */ "Signore, se non le dispiace mi prendo la\nlibertà di riporre l'acquisto nella sua\nborsa. \n\nPer aprire la borsa tenga premuto (-)<0x10011:0x02cd>,\n<color green<punti >coloroff>il telecomando Wii verso lo\nschermo e muova il cursore <color green<compiendo\nun cerchio>coloroff>.\nQuando avrà scelto l'oggetto che\nintende utilizzare, <color green<rilasci >coloroff>(-) per\nequipaggiarlo.<0x10011:0x02cd>\n\nIn questo modo le sarà possibile\nusare oggetti quali gli\nscudi senza difficoltà!")
...
/*<136>*/ 				zone_temp_flags[5 /* 0x1 20 */] = false;
          	  ...
          	  case 1:
/*< 42>*/ 		printf(/* textboxtype: 1, unk: 0, line: 20 */ "<0x10009:0x00000007>Aaah. Il cliente ha sempre ragione!")
          		goto flw_144
          	}
          }
