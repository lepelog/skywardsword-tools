...
/*<287>*/ 					switch (story_flags[47 /* us: 805A9AE6 0x01, jp: 805ACD66 0x01 */]) {
          					  case 0:
/*<288>*/ 						printf("\x0E\x01\x09\x04\x00\x1504Ma sì, la storia della bambina\nscomparsa!")
          					  case 1:
...
/*<339>*/ 								scene_flags[0 'Skyloft'][31 /* 0x2 80 */] = true;
          						  ...
          						  case 1:
/*<307>*/ 							printf("\x0E\x01\x09\x04\x00\x01Di certo tu sarai in grado\ndi trovare Zelda!")
          							goto flw_332
          						}
          					  case 1:
...
/*< 82>*/ 	switch (story_flags[323 /* us: 805A9AFF 0x02, jp: 805ACD7F 0x02 */]) {
          	  case 0:
/*< 83>*/ 		printf("... Sì che mi piace! Bzzz!\nPer la mia adorata Faih farei\nqualsiasi cosa... bzzz...")
          	  case 1:
...
/*< 92>*/ 	start()
/*< 93>*/ 	printf("Si avverte una presenza\ninquietante dietro la porta.")
          }
...
/*<102>*/ 	switch (story_flags[373 /* us: 805A9B02 0x08, jp: 805ACD82 0x08 */]) {
          	  case 0:
/*<107>*/ 		printf("\x0E\x01\x09\x04\x01\x701Quando hai tempo, torna pure\nal bazar!\n\n\nTi leggerò il futuro a un prezzo\nspeciale!")
          	  case 1:
...
/*<137>*/ 	start()
/*<164>*/ 	printf("Sono qui per consegnare\nl'<r<elica del mulino>>! Bzzz!")
...
/*<140>*/ 	start()
/*<125>*/ 	printf("Sono qui per consegnare\nuna scintillante sfera\ndi cristallo! Bzzz!")
