...
/*< 78>*/ 		printf("Ich spüre noch mehr bösartige Wesen\nan diesem Ort als bei deinem ersten\nBesuch. Sei äußerst vorsichtig.")
          	  case 1:
/*< 76>*/ 		printf("Ich spüre noch mehr bösartige Wesen\nan diesem Ort als bei deinem ersten\nBesuch. Sei äußerst vorsichtig.")
          	}
          }
...
/*< 81>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 15, 'next': -1, 'param3': 6}
          	  case 1:
/*<  8>*/ 		printf("Im Wald gibt es sicher einen Weg,\nzum Wolkenmeer zurückzukehren.")
          		goto flw_79
          	}
          }
...
/*< 45>*/ 			printf("Egal, der Schatz, hinter dem ich her\nbin, ist mehr wert als irgend so ein\nSchlüssel!")
...
/*<100>*/ 		printf("Aber wenn ich schon mal hier bin,\nsuche ich noch ein bisschen nach\nSchätzen!")
...
/*<121>*/ 		printf("Der Felstyp hat Unsinn geredet,\neindeutig.")
...
/*<178>*/ 			printf("Aber wenn ich so darüber nachdenke,\nbrauchen wir Mogma ja eigentlich\nkeine Schlüssel...")
...
/*<176>*/ 			printf("Oh! Du hast meinen Schlüssel\ngefunden?")
          			goto flw_182
          		}
          	  case 1:
...
/*<190>*/ 			printf("Wo war das nur? In diesem Raum wohl\nnicht... Hast du vielleicht eine Karte?")
          			goto flw_256
          		  case 1:
...
/*< 17>*/ 	start()
/*< 18>*/ 	printf("Es scheint, als wäre der Mechanismus\nzum Öffnen der Tür deaktiviert\nworden.")
