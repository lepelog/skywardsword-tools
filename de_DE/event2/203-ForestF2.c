...
/*<181>*/ 			switch (scene_flags[127 /* 0xE 80 */]) {
          			  case 0:
/*<182>*/ 				printf("\x0E\x01\x12\x04\x00\x01Gebieter...<pause0F> Mit Verlaub, du darfst dich\nnicht von deinen Gefühlen beeinflussen\nlassen. Ich rufe ihn.")
          			  case 1:
/*<154>*/ 				printf("\x0E\x01\x12\x04\x00\x01Gebieter...<pause0F> Mit Verlaub, du darfst dich\nnicht von deinen Gefühlen beeinflussen\nlassen. Ich rufe ihn.")
          			}
          		}
          	  case 1:
/*<155>*/ 		printf("Soll ich den Roboter rufen, um den\n<r<Wasserbehälter>> zu transportieren?\n[1]Ja, bitte![2]Den kann ich\nnicht leiden...")
          		goto flw_153
          	}
          }
...
/*<165>*/ 	start()
/*<164>*/ 	printf("Ich warte damit dann wie immer\nam Himmel!")
...
/*<443>*/ 		printf("\x0E\x01\x09\x04\x00\x04Manchmal meditiert <b<Senbuli>> beim\nVerstecken.\n\n\n\x0E\x01\x09\x04\x00\x01Sich kurz hinzusetzen entspannt Geist\nund Körper...")
...
/*< 11>*/ 					switch (scene_flags[19 /* 0x3 08 */]) {
          					  case 0:
/*<  8>*/ 						printf("\x0E\x01\x09\x04\x00\x0EWie? Du warst im Inneren des\nBaumes?")
...
/*< 61>*/ 				entrypoint_203_52();
          			  case 1:
/*< 59>*/ 				printf("\x0E\x01\x09\x04\x09\x704Du bist letzten Endes eben doch nur ein\nMensch...")
...
/*<466>*/ 							temp_flags[3 /* 0x1 08 */] = true;
          							goto flw_61
          						  case 1:
/*<286>*/ 							printf("\x0E\x01\x09\x04\x09\x704Du bist letzten Endes eben doch nur ein\nMensch...")
...
/*<156>*/ 	start()
/*<157>*/ 	printf("\x0E\x01\x12\x04\x00\x01Gebieter, lass uns ins Wolkenmeer\nzurückkehren und von dort zum Vulkan\nfliegen.")
...
/*<168>*/ 				switch (story_flags[11 /* us: 805A9AD8 0x10, jp: 805ACD58 0x10 */]) {
          				  case 0:
/*< 86>*/ 					printf("\x0E\x01\x09\x04\x07\x702Du solltest dich bemühen, die Kraft,\ndie deinem Schwert innewohnt, zu\nmeistern.")
          				  case 1:
...
/*<208>*/ 	printf("\x0E\x01\x09\x04\x07\x702Ich sehe, dein Schwert ist nun stärker\ndenn je.")
...
/*<520>*/ 	switch (story_flags[481 /* us: 805A9B11 0x20, jp: 805ACD91 0x20 */]) {
          	  case 0:
/*<523>*/ 		printf("\x0E\x01\x09\x04\x00\x08Wie geht es Kombu in seinem neuen\nZuhause? Ich hoffe doch gut!")
          	  case 1:
/*<521>*/ 		switch (story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */]) {
          		  case 0:
/*<522>*/ 			printf("\x0E\x01\x09\x04\x00\x08Kombu scheint den Wald verlassen zu\nwollen. Ich wünsche ihm alles Gute.")
          		  case 1:
          		}
          	}
          }
...
/*<124>*/ 					switch (temp_flags[13 /* 0x0 20 */]) {
          					  case 0:
/*<125>*/ 						printf("Wenn es nicht weitergeht, versuche, zu\nspringen!")
...
/*<323>*/ 		switch (story_flags[200 /* us: 805A9AEF 0x04, jp: 805ACD6F 0x04 */]) {
          		  case 0:
/*<324>*/ 			printf("Der Wasserdrache ist nach draußen\ngegangen.")
/*<561>*/ 			set_camera(34, 0)
...
/*<343>*/ 	start()
/*<344>*/ 	printf("\x0E\x01\x09\x04\x07\x704Jedoch sollte das für einen von der\nGöttin Auserwählten kein Hindernis\nsein.\n\nIch bin sicher, dass wir beide uns\nwiedersehen werden, aber sei bitte\ndennoch vorsichtig.\n\n\x0E\x01\x09\x04\x07\x703Bis bald.")
...
/*<137>*/ 		printf("Hier! Hier! Schnell!\n\n\n\n...Was? Du kannst nicht weiter? Ihr\nMenschen seid ja wirklich unpraktisch\ngebaut. Kommst du nicht oben drüber?")
          	  case 1:
/*<135>*/ 		printf("Puh... Du bist ganz schön weit\ngekommen, aber hier schaffst du es\nsicher nicht hindurch!\n\nDu siehst das anders? Dann versuch\ndoch, mich zu fangen!")
          	}
          }
...
/*<251>*/ 				printf("Das Wasser ist gesunken.\nSchade...")
          			  case 1:
/*<250>*/ 				printf("Zum Glück ist der Wasserdrache\nwieder gesund. Ich danke dir!")
          			}
          		  case 1:
...
/*<252>*/ 		switch (scene_flags[19 /* 0x3 08 */]) {
          		  case 0:
/*<247>*/ 			printf("Der Wasserdrache ist eigentlich\ngutmütig, aber wehe, wenn man ihn\nwütend macht...")
...
/*<238>*/ 					printf("Den Wasserdrachen findest du dort\nentlang. Markiere dir diese Stelle\nirgendwie.")
...
/*<571>*/ 					switch (choice(2)) {
          					  case 0:
/*<575>*/ 						set_camera(18, 0)
/*<574>*/ 						printf("\x0E\x01\x09\x04\x00\x07Ah, du spielst im <r<Helden-Modus>>. Na,\ndann kennst du dich sicher schon aus...\n[1]Natürlich...[2]Vergessen...")
/*<576>*/ 						switch (choice(2)) {
          						  case 0:
...
/*<365>*/ 								set_camera(21, 0)
/*<366>*/ 								printf("\x0E\x01\x09\x04\x00\x02Sie vertraute die Flamme dem\n<b<Wasserdrachen>> an, der hier im <b<Wald\nvon Phirone>> lebt.")
/*<367>*/ 								set_camera(22, 0)
...
/*<185>*/ 				entrypoint_203_91();
          		  ...
          		  case 1:
/*< 67>*/ 			printf("Ich habe das verbliebene Wasser\nanalysiert\x0E\x01\x06\x02\xFCCD...<pause0F>\n\x0E\x01\x06\x02Í<pling>Es kann nun mit der <r<Aurasuche\n>>aufgespürt werden.")
...
/*<294>*/ 				set_camera(12, 0)
/*<293>*/ 				printf("\x0E\x01\x09\x04\x00\x05Folge diesem Weg in den Wald von\nPhirone.")
...
/*<472>*/ 					set_camera(27, 0)
          			  ...
          			  case 1:
/*<229>*/ 				printf("\x0E\x01\x12\x04\x00\x01Gebieter, du besitzt keine Möglichkeit,\ndas Wasser zu transportieren.\nWir benötigen ein Gefäß.")
          				goto flw_66
          			}
          		}
          	  case 1:
...
/*<545>*/ 	switch (temp_flags[2 /* 0x1 04 */]) {
          	  case 0:
/*<546>*/ 		printf("\x0E\x01\x09\x04\x09\x700Du hast mir das <b<heilige Wasser\n>>gebracht, Menschenkind.\n\n\nMir scheint, es war nicht nur Zufall,\ndass du dir die <b<Wasserdrachenschuppe\n>>verdient und die Prüfung der Göttin\nbestanden hast.")
          	  case 1:
/*<547>*/ 		printf("\x0E\x01\x09\x04\x09\x700Du hast mir das <b<heilige Wasser\n>>gebracht, Menschenkind.\n\n\nMir scheint, es war nicht nur Zufall,\ndass du dir die <b<Wasserdrachenschuppe\n>>verdient und die Prüfung der Göttin\nbestanden hast.")
          	}
          }

          void entrypoint_203_54() {
/*< 76>*/ 	start()
/*< 77>*/ 	printf("Die Wahrscheinlichkeit, dass dies\ndas Symbol ist, von dem der Einsiedler\nsprach, beträgt 80 %.")
/*<232>*/ 	set_camera(26, 0)
/*<437>*/ 	printf("Ich schlage vor, dass du dir dieses\nSymbol gut einprägst.")
