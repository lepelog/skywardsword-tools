...
/*<138>*/ 				switch (story_flags[79 /* us: 805A9AEB 0x01, jp: 805ACD6B 0x01 */]) {
          				  case 0:
          					flw_141:
/*<141>*/ 					printf("Die Melodinen sind gern zusammen\nund halten sich oft <r<bei kleinen Fischen\n>>auf.")
          				  case 1:
...
/*<170>*/ 	start()
/*<171>*/ 	printf("Die Ungeheuer verschwinden aus dem\nWald!")
          }
...
/*< 22>*/ 		switch (story_flags[18 /* us: 805A9AD9 0x08, jp: 805ACD59 0x08 */]) {
          		  case 0:
/*< 23>*/ 			printf("\x0E\x01\x09\x04\x00\x07Der Wald ist überschwemmt, aber\ndas wird schon. Grüß mir den\n<b<Wasserdrachen>>!")
          		  case 1:
...
/*<125>*/ 				switch (scene_flags[26 /* 0x2 04 */]) {
          				  case 0:
/*<137>*/ 					printf("\x0E\x01\x09\x04\x09\x0CNutze die Aurasuche oder was immer\nnötig ist, aber finde nur schnell diese\nMelodinen!")
          				  case 1:
...
/*<  4>*/ 		printf("\x0E\x01\x09\x04\x09\x0CEs ist aus! Was wird nur aus unserem\nWald?")
          	}
          }
...
/*< 26>*/ 		switch (story_flags[18 /* us: 805A9AD9 0x08, jp: 805ACD59 0x08 */]) {
          		  case 0:
/*< 27>*/ 			printf("\x0E\x01\x09\x04\x00\x07Der Wald ist überschwemmt, aber\ndas wird schon. Grüß mir den\n<b<Wasserdrachen>>!")
          		  case 1:
...
/*<180>*/ 						printf("\x0E\x01\x09\x04\x0C\x01Na, diese Wesen im Wasser mit den\nspitzen Mündern!")
          						flw_179:
/*<179>*/ 						printf("\x0E\x01\x09\x04\x0B\x05Sprich mit ihnen, wenn du im Wasser\nbist.")
          					  case 1:
          						goto flw_179
          					}
          				  case 1:
...
/*< 28>*/ 		switch (story_flags[18 /* us: 805A9AD9 0x08, jp: 805ACD59 0x08 */]) {
          		  case 0:
/*< 29>*/ 			printf("\x0E\x01\x09\x04\x00\x14Kehre schnell zum <b<Wasserdrachen\n>>zurück!")
          		  case 1:
/*<132>*/ 			switch (scene_flags[25 /* 0x2 02 */]) {
          			  case 0:
/*<133>*/ 				switch (scene_flags[26 /* 0x2 04 */]) {
          				  case 0:
/*<136>*/ 					printf("\x0E\x01\x09\x04\x00\x14Versuche, die Melodinen mit der\n Aurasuche zu finden.")
          				  case 1:
/*<134>*/ 					printf("\x0E\x01\x09\x04\x00\x07Der Häuptling verlangt nach dir!\nDu solltest mit ihm reden.")
          				}
          			  case 1:
/*<135>*/ 				printf("\x0E\x01\x09\x04\x00\x14Wenn du die Melodinen fängst, werden\nsie zu Noten einer Melodie.")
          			}
          		}
          	  case 1:
...
/*< 18>*/ 		switch (story_flags[18 /* us: 805A9AD9 0x08, jp: 805ACD59 0x08 */]) {
          		  case 0:
/*< 33>*/ 			printf("\x0E\x01\x09\x04\x00\x0EKehre schnell zum <b<Wasserdrachen\n>>zurück!")
          		  case 1:
