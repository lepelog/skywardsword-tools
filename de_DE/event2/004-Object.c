...
/*< 58>*/ 	switch (story_flags[19 /* us: 805A9ADB 0x08, jp: 805ACD5B 0x08 */]) {
          	  case 0:
/*< 56>*/ 		printf(/* textboxtype: 1, unk: 1, line: 17 */ "Tief unterhalb dieses Vulkans leben\ndie Schätze hortenden <color blue<Mogma>coloroff>.\n\n\nWie ich hörte, sollen sie heutzutage\nin ihren unterirdischen Höhlen eine\nruhige Kugel schieben.")
          	  case 1:
          		flw_59:
/*< 59>*/ 		printf(/* textboxtype: 1, unk: 1, line: 19 */ "Angeblich lebt auf dem <color red<Gipfel >coloroff>dieses\nVulkans ein <color red<Drache>coloroff>.\n\n\nNein, das hier ist ganz bestimmt nicht\nder Gipfel...")
/*< 60>*/ 		printf(/* textboxtype: 1, unk: 1, line: 18 */ "Soll ich das noch mal wiederholen?\n[1-]Ja[2]Nein")
/*< 62>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_59
          		  case 1:
/*< 61>*/ 			printf(/* textboxtype: 1, unk: 1, line: 20 */ "Hab schon verstanden...<pause 15>\nDu möchtest mir also nicht zuhören?")
          		}
          	}
          }
...
/*< 13>*/ 		switch (is_item_check_full()) {
          		  case 0:
/*< 11>*/ 			printf(/* textboxtype: 5, unk: 1, line: 9 */ "Deine Tasche ist voll! Das <color red<Item-Lager\n>coloroff>leider auch...\n\n\nDas Item wurde in die Schatztruhe\nzurückgelegt.")
          		  case 1:
/*< 10>*/ 			printf(/* textboxtype: 5, unk: 1, line: 8 */ "Deine Tasche ist voll! Das Item wurde im\n<color red<Item-Lager >coloroff>deponiert.")
          		}
          	  case 1:
          	}
          }
...
/*< 30>*/ 		printf(/* textboxtype: 1, unk: 0, line: 21 */ "Der <color red<Drache>coloroff>, der auf dem Gipfel des\nVulkans lebt, ist ziemlich gesprächig.\n\n\nPass bloß auf, dass er dir mit seinem\nGeschwätz kein Ohr abkaut.")
          	  case 1:
          		flw_52:
/*< 52>*/ 		printf(/* textboxtype: 1, unk: 0, line: 22 */ "Auf dem Gipfel dieses Vulkans soll\nein <color red<Drache>coloroff> leben, dessen Körper in\nFlammen gehüllt ist.\n\nEr lebt an einem <color red<sengend heißen Ort>coloroff>,\nden die meisten Leute nicht betreten\nkönnen.")
/*< 53>*/ 		printf(/* textboxtype: 1, unk: 1, line: 18 */ "Soll ich das noch mal wiederholen?\n[1-]Ja[2]Nein")
/*< 55>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_52
          		  case 1:
/*< 54>*/ 			printf(/* textboxtype: 1, unk: 1, line: 20 */ "Hab schon verstanden...<pause 15>\nDu möchtest mir also nicht zuhören?")
          		}
          	}
          }
...
/*< 14>*/ 	start()
/*< 15>*/ 	printf(/* textboxtype: 1, unk: 2, line: 5 */ "Hey! <heroname>!\nDu hast doch nicht etwa\nvor abzuhauen? Pah!\n\nEin Mann sollte zu Ende\nbringen, was er anfängt!")
          }

          void entrypoint_004_109() {
/*< 33>*/ 	start()
/*< 32>*/ 	printf(/* textboxtype: 1, unk: 0, line: 23 */ "Schneidest du beim <color blue<lustigen Loren-\nLenken>coloroff> gut ab, kannst du ein <color yellow<Herzteil\n>coloroff>erhalten.")
          }

          void entrypoint_004_016() {
/*< 48>*/ 	start()
/*< 49>*/ 	printf(/* textboxtype: 9, unk: 1, line: 34 */ "<0x1000F:0x>Bis wann möchtest du schlafen?\n[1-]Bis morgens[2-]Bis nachts[3]Gar nicht")
/*< 50>*/ 	switch (choice(3)) {
          	  case 0:
          	  case 1:
          	  case 2:
...
/*< 65>*/ 	start()
/*< 66>*/ 	printf(/* textboxtype: 2, unk: 1, line: 35 */ "Zu dieser Vogelstatue reisen?\n[1-]Ja[2]Nein")
/*< 67>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
...
/*<  1>*/ 	start()
/*<  3>*/ 	printf(/* textboxtype: 9, unk: 0, line: 2 */ "<0x1000F:0x>Das Schild ist kaputt.\nEs ist unmöglich zu lesen.")
          }

          void entrypoint_004_113() {
/*< 41>*/ 	start()
/*< 40>*/ 	printf(/* textboxtype: 1, unk: 0, line: 27 */ "Zeichnest du Rubine an eine der\nmysteriösen Wände, kannst du dir\neine goldene Nase verdienen.")
          }
...
/*< 46>*/ 	start()
/*< 47>*/ 	printf(/* textboxtype: 9, unk: 0, line: 1 */ "<0x1000F:0x>Die Tür ist versiegelt und lässt\nsich nicht öffnen.")
          }

          void entrypoint_004_116() {
/*< 63>*/ 	start()
/*< 64>*/ 	printf(/* textboxtype: 1, unk: 0, line: 30 */ "Zeichnest du drei Dreiecke an eine\nder mysteriösen Wände, werden dir\nvielleicht <color yellow<Feen>coloroff> erscheinen.")
          }

          void entrypoint_004_117() {
/*< 75>*/ 	start()
/*< 76>*/ 	printf(/* textboxtype: 1, unk: 1, line: 31 */ "In der Nähe scheint sich irgendwo ein\n<color yellow<Herzteil>coloroff> zu befinden.")
/*< 77>*/ 	switch (scene_flags[104 /* 0xC 01 */]) {
          	  case 0:
/*< 78>*/ 		printf(/* textboxtype: 1, unk: 1, line: 33 */ "Oh... Du hast es ja bereits gefunden.\nUnd warum sagst du das nicht gleich?")
          	  case 1:
/*< 79>*/ 		printf(/* textboxtype: 1, unk: 1, line: 32 */ "Um es zu finden, musst du dich jedoch\nwie ein <color blue<Mogma>coloroff> durch die Erde graben\nkönnen.")
          	}
          }
...
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 2, unk: 2, line: 4 */ "Möchtest du diese Sairen verlassen?\n[1-]Verlassen[2]Bleiben")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
...
/*< 19>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 0, line: 11 */ "Schneidest du beim <color blue<superschnellen\nBambusfäller >coloroff>den Bambus <color red<mehr als\n28-mal>coloroff>, erhältst du einen wertvollen\nSchatz.\nDer Betreiber, ein ehemaliges Model,\nhält laut eigenen Angaben den Rekord\nvon 43 Schnitten...")
          }

          void entrypoint_004_102() {
/*< 21>*/ 	start()
/*< 20>*/ 	printf(/* textboxtype: 1, unk: 0, line: 12 */ "Erweist du dich im <color blue<Insektenparadies >coloroff>in\nweniger als <color red<2 Minuten >coloroff>als Experte,\nerhältst du vielleicht seltene Insekten.")
          }

          void entrypoint_004_103() {
/*< 23>*/ 	start()
/*< 22>*/ 	printf(/* textboxtype: 1, unk: 0, line: 13 */ "Wir <color blue<Mythen-Steine>coloroff> ziehen\nSchmetterlinge magisch an.\n\n\nErtönt dort, wo <color red<Schmetterlinge\n>coloroff>fliegen, eine <color red<wundervolle Melodie>coloroff>,\ndann... Boing-oing!")
          }
...
/*< 27>*/ 	start()
/*< 42>*/ 	printf(/* textboxtype: 1, unk: 0, line: 28 */ "Zeichnest du ein Symbol der Liebe an\neine der mysteriösen Wände, wird es\ndir bestimmt besser gehen.")
          }
