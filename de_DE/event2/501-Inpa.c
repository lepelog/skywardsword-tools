...
/*<165>*/ 		set_camera(22, 0)
/*<164>*/ 		printf("\x0E\x01\x09\x04\xE10\x1600Link...\nDu musst diese Bestie ein weiteres\nMal bannen!")
...
/*<474>*/ 		switch (story_flags[175 /* us: 805A9AE2 0x40, jp: 805ACD62 0x40 */]) {
          		  case 0:
/*<475>*/ 			printf("\x0E\x01\x09\x04\x00\x05Du suchst die drei Drachen? Ich weiß,\ndass der Donnerdrache in der Wüste\ngelebt hat...")
          		  case 1:
...
/*< 71>*/ 	printf("\x0E\x01\x09\x04\xE08\xB0BDas hast ganz allein du selbst\ngeschafft.")
/*<410>*/ 	set_camera(27, 0)
...
/*< 76>*/ 	printf("\x0E\x01\x09\x04\x40D\x206Konzentriere die Force in deinem\nSchwert und <g<richte >>den Himmelsstrahl\nauf das Zeitportal!")
...
/*<231>*/ 						printf("\x0E\x01\x09\x04\x00\x03<b<Bado>> wartet auf dich.\nDu findest ihn sicher <r<bei seinem\nKatapult>>.")
          					  case 1:
/*<229>*/ 						printf("\x0E\x01\x09\x04\x00\x03Du kommst gerade richtig. Ich muss\nmit dir reden, Link.\n\n\n<b<Bado>> scheint etwas auf dem Herzen zu\nhaben.\n\n\nDu findest ihn sicher <r<bei seinem\nKatapult>>. Geh und rede mit ihm.")
...
/*< 41>*/ 	printf("\x0E\x01\x09\x04\xE00\x08Link...\nHast du <b<Zelda>> gefunden?")
/*< 42>*/ 	set_camera(16, 0)
...
/*<204>*/ 		set_camera(42, 0)
/*<206>*/ 		printf("Der Weg durch diese Tür führt dich\ndirekt zum Wald. Sei vorsichtig...")
...
/*<278>*/ 		set_camera(49, 0)
/*<209>*/ 		printf("\x0E\x01\x09\x04\x00\x1303Es wird mit Sicherheit bald alles klar\nwerden... Schreite ohne Furcht voran,\nLink!")
...
/*<369>*/ 		printf("Zeige auf \x0E\x02\x04\x02\x19CD und drücke(C), um dort\nein Signallicht zu setzen.\x0E\x01\x11\x02\x6CD")
...
/*<212>*/ 						printf("\x0E\x01\x09\x04\x00\nEr ist wieder erwacht.\n\n\n\nDu musst diese Bestie ein weiteres\nMal bannen, Link!")
          				  ...
          				  case 1:
/*<143>*/ 					printf("\x0E\x01\x09\x04\x00\x07Diese Kraft... Dein Schwert wurde\ndurch die <r<Force >>gestärkt. Triff nun das\nZeitportal mit dem <r<Himmelsstrahl>> und\nes wird sich sicher öffnen lassen.\nStelle dich auf diese Plattform und\n<g<lasse die Kraft des Schwertes in das\nZeitportal fließen>>!")
          				}
          			  case 1:
          				goto flw_134
          			}
