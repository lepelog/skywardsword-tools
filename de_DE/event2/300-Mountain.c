...
/*<221>*/ 	switch (scene_flags[73 /* 0x8 02 */]) {
          	  case 0:
/*<223>*/ 		printf("Deine Freundin wartet bestimmt auf\ndich, also darfst du nicht aufgeben!")
          	  case 1:
...
/*<238>*/ 			switch (scene_flags[75 /* 0x8 08 */]) {
          			  case 0:
          				flw_236:
/*<236>*/ 				printf("\x0E\x01\x09\x04\x09\x8FFSolche Wände kannst du nicht nur\nunter der Erde finden. Ich bin sicher,\ndu findest sie.")
          			  case 1:
...
/*<243>*/ 			switch (scene_flags[76 /* 0x8 10 */]) {
          			  case 0:
/*<242>*/ 				printf("Es gibt hier dünne Wände, die du\nzerstören kannst. Dahinter verbergen\nsich oft Schätze.")
          			  case 1:
...
/*<240>*/ 		switch (scene_flags[74 /* 0x8 04 */]) {
          		  case 0:
/*<239>*/ 			printf("\x0E\x01\x09\x04\x15\x80CHier in der Nähe muss auch so eine\nStelle sein, das sagt mir mein\nSchatzsucher-Instinkt.")
          		  case 1:
...
/*<267>*/ 	start()
/*<266>*/ 	printf("\x0E\x01\x05\x04Z\x00Dieses Gebiet besteht zu 65 % aus Lava\nund ist voller Kreaturen, die sich an\ndas Feuer gewöhnt haben.")
          }
...
/*<269>*/ 	start()
/*<268>*/ 	printf("\x0E\x01\x05\x04Z\x00Ich empfehle, auf <r<Gegenstände aus\nHolz>> sowie <r<deine Kleidung>> besonders\nachtzugeben.")
          }
...
/*< 72>*/ 	switch (scene_flags[22 /* 0x3 40 */]) {
          	  case 0:
/*< 71>*/ 		printf("Die Kleidung war schwarz, mehr weiß\nich nicht.")
          	  case 1:
...
/*<271>*/ 	start()
/*<270>*/ 	printf("\x0E\x01\x05\x04K\x00Falls du in Brand gerätst, würde <g<eine\nRolle oder eine Wirbelattacke>> das\nFeuer vermutlich löschen.")
          }
...
/*<108>*/ 	printf("Unglaublich, die machen hier, was sie\nwollen! In unserem Revier!!!")
...
/*<109>*/ 			set_camera(-1, 0)
          			flw_137:
/*<137>*/ 			printf("Ich hoffe, deine Freundin ist nicht\nden roten Kerlen in die Hände\ngefallen...")
