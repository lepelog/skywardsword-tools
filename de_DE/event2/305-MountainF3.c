...
/*< 46>*/ 		switch (zone_temp_flags[0 /* 0x1 01 */]) {
          		  case 0:
/*< 49>*/ 			printf("\x0E\x01\x09\x04\x00\x700Willst du vielleicht noch etwas\nanderes wissen?\n[1]<b<Wasserdrache>>[2]<b<Donnerdrache>>[3]Vulkan[4-]Nein")
          			flw_42:
/*< 42>*/ 			switch (choice(4)) {
          			  case 0:
...
/*< 33>*/ 				changeScene(4, 0) // 
          			  case 1:
          				flw_57:
/*< 57>*/ 				set_camera(5, 0)
/*< 27>*/ 				printf("Der Ausbruch des Vulkans war das\nWerk meines Zorns. Und du bist\nhineingeraten...\n\nVerzeih mir!\nSchon bald werden sich Erde und\nHimmel in ein freundlicheres Licht\nfärben... Jetzt kannst du aufbrechen!")
