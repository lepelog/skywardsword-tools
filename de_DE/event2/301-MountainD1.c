...
/*<  3>*/ 	printf(/* textboxtype: 1, unk: 0, line: 2 */ "Verflucht, sie ist nicht da...\nIch hab sie bestimmt vorhin verloren...")
...
/*< 29>*/ 	printf(/* textboxtype: 1, unk: 0, line: 3 */ "Oh! Du kommst genau richtig!\nIch bin's, <color blue<Ferri>coloroff>!\n\n\n<0x10009:0x00ffffff>Gut, dass ich dich hier treffe. Könntest\ndu mir einen Gefallen tun und nach\nmeiner <color yellow<Bombentasche>coloroff> suchen?")
/*<102>*/ 	set_camera(16, 0)
/*<101>*/ 	printf(/* textboxtype: 1, unk: 1, line: 4 */ "Ich war auf der anderen Seite dieser\nFelsen, als plötzlich diese Monster\nauftauchten...<pause 15> Da bin ich abgehauen\nund muss sie dabei <0x10009:0x0013100d>verloren haben.")
/*<104>*/ 	set_camera(-1, 0)
/*<103>*/ 	printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x000908ff>In der Tasche kann man <color red<Donnerblumen\nmitnehmen und jederzeit einsetzen>coloroff>.\nOhne diese Tasche bin ich komplett\naufgeschmissen...\nBestimmt haben die Monster sie...<pause 10>\n<0x10009:0x00110dff>Bring mir bitte meine <color yellow<Bombentasche\n>coloroff>wieder!")
          }
...
/*< 95>*/ 	set_camera(15, 0)
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 1, line: 9 */ "<0x10009:0x00110d08>Meine <color yellow<Bombentasche>coloroff>!\n\n\n\n<0x10009:0x00ff08ff>Vielen, vielen Dank!\nDann gib sie mal her...<pause 20>\n\n\n<0x10009:0x00110d0e>Moment, ich soll sie dir leihen, damit\ndu tiefer in den Vulkan gehen kannst?\n\n\n<0x10009:0x00ffffff>Hm, immerhin hast du dich auf der\nSuche nach deiner Freundin bis hierhin\ngewagt...\n\n<0x10009:0x00150d11>Da fällt mir ein...<pause 15>\nHast du meinen Kumpel gesehen?\n[1-]Er ist nach\nHause gegangen.[2-]Er macht sich\nSorgen um dich.[3-]Weiß nicht.")
/*< 34>*/ 	switch (choice(3)) {
          	  case 0:
/*< 35>*/ 		printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x00131007>Auf den ist wirklich kein Verlass...\n\n\n\n<0x10009:0x00ff08ff>Du dagegen hast dich für deine\nFreundin an diesen gefährlichen Ort\ngewagt...\n\n<0x10009:0x00141209>Also gut, hier hast du sie.\nViel Spaß damit!")
          		flw_105:
...
/*< 18>*/ 		printf(/* textboxtype: 1, unk: 0, line: 13 */ "Ich gebe dir meine <color yellow<Bombentasche>coloroff>,\ndamit du deine Freundin findest.")
/*<106>*/ 		{'type': 'type3', 'subType': 1, 'param1': 3, 'param2': -1, 'next': -1, 'param3': 42}
          	  case 1:
/*< 36>*/ 		printf(/* textboxtype: 1, unk: 0, line: 11 */ "<0x10009:0x00001004>Er hat sich also Sorgen um mich\ngemacht...<pause 15> Das tut mir leid.\n\n\n<0x10009:0x00ff08ff>Du machst dir bestimmt auch Sorgen\num deine Freundin, was?\n\n\n<0x10009:0x00141209>Also gut, hier hast du sie.\nViel Spaß damit!")
          		goto flw_105
          	  case 2:
/*< 37>*/ 		printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00000804>Hm...<pause 15>\nOb es ihm gut geht?\nHier sind so viele Monster...\n\n<0x10009:0x000008ff>Du hast sicher auch Angst um deine\nFreundin...\n\n\n<0x10009:0x00141209>Also gut, hier hast du sie.")
          		goto flw_105
          	}
          }
...
/*<  8>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 0}) {
          	  case 0:
/*< 12>*/ 		printf(/* textboxtype: 1, unk: 0, line: 16 */ "<0x10009:0x00110d00>Hast du schon mal gegen ein Monster\ngekämpft und bist dabei in Brand\ngeraten?\n\n<0x10009:0x000908ff>Du solltest die Flammen schnellstens\nlöschen, aber vor allem solltest du\nniemals, wirklich niemals, <color yellow<Bomben\n>coloroff>einsetzen, wenn du in Flammen stehst!")
          	  case 1:
/*< 99>*/ 		switch (scene_flags[1 /* 0x1 02 */]) {
          		  case 0:
/*<100>*/ 			printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x00150809>Nicht schlecht!\nNetter Trick, die <color yellow<Donnerblume>coloroff> durch\nden Spalt zu rollen!\n\n<0x10009:0x00110800>Jetzt kannst du dich auf die Suche nach\nmeiner <color yellow<Bombentasche>coloroff> machen!")
          		  case 1:
/*< 96>*/ 			switch (temp_flags[57 /* 0x6 02 */]) {
          			  case 0:
/*< 13>*/ 				printf(/* textboxtype: 1, unk: 0, line: 7 */ "Diese Felsen müssen doch kaputt zu\nkriegen sein. Versuch's mal mit einer\n<color yellow<Donnerblume>coloroff>.")
          			  case 1:
/*< 97>*/ 				printf(/* textboxtype: 1, unk: 0, line: 6 */ "Oh...<pause 15> Tja, wenn du nicht graben\nkannst, kommst du nicht auf die andere\nSeite...\n\n<0x10009:0x0015120c>Aber Felsen wie diese kriegst du mit\n<color yellow<Donnerblumen>coloroff> klein.\n\n\n<0x10009:0x0009ff00>Sieh dich doch mal um, ob du hier\nin der Nähe nicht irgendwo\n<color yellow<Donnerblumen>coloroff> findest.")
...
/*< 14>*/ 	start()
/*< 15>*/ 	printf(/* textboxtype: 20, unk: 0, line: 31 */ "Tempel des\nErdlandes")
          }
...
/*< 70>*/ 	wait_frames(10)
/*< 51>*/ 	set_camera(2, 0)
/*< 40>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x0d0805ff>So trifft man sich wieder...")
/*< 79>*/ 	set_camera(10, 0)
/*< 78>*/ 	printf(/* textboxtype: 1, unk: 0, line: 23 */ "<0x10009:0x0d0005ff>Oh<pause 1>.<pause 1>.<pause 1>.<pause 1> \n<pause 8>Nein, wie unhöflich...<pause 20>\nIch habe deinen Namen vergessen...\n\n<0x10009:0x0d0a05ff>Na, ist auch unwichtig.\nHör mir nur kurz zu, ja?")
/*< 73>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3339, 'param2': 3327, 'next': 72, 'param3': 13}
/*< 72>*/ 	set_camera(6, 0)
/*< 58>*/ 	printf(/* textboxtype: 1, unk: 0, line: 24 */ "<0x10009:0x0d000900>Da sagen mir meine unfähigen\nHandlanger, dass sie die heilige Maid\ngefangen haben... Ich eile herbei, und\nwas muss ich sehen?\n<0x10009:0x0d000cff>Diese lästige Marionette der Göttin\nkommt mir zuvor...")
/*< 74>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3340, 'param2': 3327, 'next': 65, 'param3': 13}
/*< 65>*/ 	printf(/* textboxtype: 1, unk: 0, line: 25 */ "<0x10008:0xfecd><0x1000A:0x000c00cd>Diese...\n\n\n\n<0x10009:0x0d000cff><0x10008:0xfecd><pause 15><0x1000A:0x000d00cd>Sie hat...")
/*< 75>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3341, 'param2': 3583, 'next': 66, 'param3': 13}
/*< 66>*/ 	printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10005:0x002d0000><0x10008:0x02cd>Dieses Schoßhündchen der\nGöttin...<0x1000A:0x000b00cd> Sie hat sie einfach\nmitgenommen!")
/*< 81>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3342, 'param2': 3583, 'next': 63, 'param3': 13}
/*< 63>*/ 	printf(/* textboxtype: 1, unk: 0, line: 27 */ "<0x10008:0x01cd>Dabei brauche ich sie doch, um\nmeinen König zu befreien!")
/*< 77>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3335, 'param2': 1535, 'next': 76, 'param3': 13}
/*< 76>*/ 	set_camera(9, 0)
/*< 64>*/ 	printf(/* textboxtype: 1, unk: 0, line: 28 */ "<pause 5>.<pause 5>.<pause 5>.<pause 5>\n<pause 10>Ich entschuldige mich.\n\n\n<0x10009:0x0d0805ff>Aber jetzt verstehst du sicher, warum\nich etwas ungehalten bin.")
/*< 67>*/ 	set_camera(3, 0)
/*< 61>*/ 	printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x0d0a05ff>Ach, was soll die Zurückhaltung.\n<pause 20>Ich habe es nicht eilig...<pause 20>\nEs ist genug Zeit...<pause 20>")
/*< 71>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3335, 'param2': 1535, 'next': 68, 'param3': 13}
/*< 68>*/ 	set_camera(4, 0)
/*< 62>*/ 	printf(/* textboxtype: 1, unk: 0, line: 30 */ "So spüre die Flammen meines Zorns!")
...
/*< 41>*/ 	start()
/*< 42>*/ 	printf(/* textboxtype: 2, unk: 0, line: 18 */ "<0x10012:0x0000000b>Gebieter, ich habe dir etwas zu\nberichten. Ich spüre Zeldas Aura in der\nNähe.")
/*< 44>*/ 	set_camera(1, 0)
/*< 43>*/ 	printf(/* textboxtype: 2, unk: 0, line: 19 */ "Besonders von dieser Kette gehen\nstarke Schwingungen aus. Die\nWahrscheinlichkeit, dass Zelda mit ihr\ngefesselt wurde, liegt bei 95 %.")
/*< 45>*/ 	set_camera(-1, 0)
/*< 46>*/ 	printf(/* textboxtype: 2, unk: 0, line: 20 */ "Ich vermute, dass Zelda irgendwie\nentkommen konnte. Ich rate zur Eile.")
          }
