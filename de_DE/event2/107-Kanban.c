...
/*<152>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 26}) {
          	  case 0:
/*<112>*/ 		printf("\x0E\x01\x12\x04\x00\x0BGebieter, ich habe dir etwas\nzu berichten.\n\n\nDein Schwert hat an Macht gewonnen,\nweshalb du nun die <r<Aurasuche>><g< >>nutzen\nkannst, um nach den <y<Juwelen der Güte>>\nzu suchen.\nDie <y<Juwelen der Güte >>wurden der\n<r<Aurasuche>> als neues Ziel hinzugefügt.<pling>")
/*<159>*/ 		open_dowsing_wheel(19)
/*<160>*/ 		printf("Wie ich sehe, hast du bereits alle\nJuwelen der Güte gesammelt.\nDu bist sehr umsichtig, \x0E\x01\x12\x04\x00\x02Gebieter.")
          	  case 1:
/*< 64>*/ 		printf("\x0E\x01\x12\x04\x00\x0BGebieter, ich habe dir etwas\nzu berichten.\n\n\nDein Schwert hat an Macht gewonnen,\nweshalb du nun die <r<Aurasuche>><g< >>nutzen\nkannst, um nach den <y<Juwelen der Güte>>\nzu suchen.\nDie <y<Juwelen der Güte >>wurden der\n<r<Aurasuche>> als neues Ziel hinzugefügt.<pling>\nMache von dieser Option Gebrauch,\nwie es dir beliebt.")
...
/*< 79>*/ 	start()
/*< 81>*/ 	printf("\x0E\x01\x12\x04\x00\x0BGebieter, ich habe dir etwas\nzu berichten.\n\n\nAuf einer der Inseln im Wolkenmeer\nfindest du den <r<Eingang zur Sairen>>,\nder sich mit dem Heldenlied öffnen\nlässt. Finde ihn mit der <r<Aurasuche>>.")
...
/*<121>*/ 	set_camera(6, 0)
/*<119>*/ 	printf("Es gibt noch ein weiteres <r<Insigne der\nReife >>außer dem, das du besitzt.\n\n\nIch stelle fest,\x0E\x01\x12\x04\x00\x02 dass sich auf dieser Insel\nein Objekt befindet, das dem gleicht,\nwelches du bei dir trägst.\n\nFindest du es und fügst du beide\nzusammen, öffnet sich dir der\nWeg zum <y+<Triforce>>.\n\n\x0E\x01\n\x04\xFFFFÍIch empfehle dir, nach diesem\nObjekt zu suchen.")
...
/*<155>*/ 	start()
/*<157>*/ 	printf("\x0E\x01\x12\x04\x00\x0BGebieter, ich stelle fest, dass sich in\nsüdwestlicher Richtung ein weiteres\nLoch in den Wolken aufgetan hat.\n\nEs führt dich an einen neuen Ort. Ich\nempfehle dir, diesen Ort aufzusuchen,\nsobald du dich auf die Reise vorbereitet\nhast.")
          }

          void entrypoint_107_45() {
/*<182>*/ 	start()
/*<183>*/ 	printf("Brave Kinder waschen sich\nstets die Hände!")
          }
...
/*<174>*/ 	switch (story_flags[649 /* us: 805A9B1C 0x04, jp: 805ACD9C 0x04 */]) {
          	  case 0:
/*<176>*/ 		printf("\x0E\x01\x12\x04\x00\x0BGebieter Link...\n\n\n\n\x0E\x01\n\x04\x0DÍDiese Schatztruhe hat die Göttin einst\nfür den auserwählten Helden hier\nhinterlassen.")
/*<178>*/ 		set_camera(-1, 0)
/*<177>*/ 		printf("Ich vermute, dass die Energie der\n<r<Artefakte der Göttin>> die Schatztruhen\nöffnen kann.\n\nSende die Artefakte der Göttin aus\ndem Erdland zum Himmel und ihre\nEnergie wird die Truhen öffnen.\nSo kannst du an ihren Inhalt gelangen.")
          	  case 1:
/*<173>*/ 		printf("\x0E\x01\x12\x04\x00\x0BGebieter Link...\n\n\n\n\x0E\x01\n\x04\x0DÍDiese Schatztruhe hat die Göttin einst\nfür den auserwählten Helden hier\nhinterlassen.")
/*<179>*/ 		set_camera(-1, 0)
/*<175>*/ 		printf("Leider habe ich keine Daten darüber,\nwie man sie öffnen kann.")
          	}
          }

          void entrypoint_107_47() {
/*<186>*/ 	start()
/*<187>*/ 	printf("Ich bin geschäftlich unterwegs\nund komme abends zurück.\n\x0E\x01\x06\x02\x5CDTerri")
          }
...
/*< 18>*/ 	start()
/*< 16>*/ 	printf("\x0E\x01\x12\x04\x00\x01Gebieter, von hier aus kannst\ndu die Lichtsäule erblicken.")
/*< 75>*/ 	set_camera(2, 0)
/*< 74>*/ 	printf("Springe nun in diese Richtung ab\nund rufe deinen Wolkenvogel.")
/*< 77>*/ 	set_camera(-1, 0)
/*< 76>*/ 	printf("Bitte mache dich nun auf die Suche\nnach Zelda. Drücke (v), um deinen\nWolkenvogel zu rufen, nachdem du\nabgesprungen bist.\x0E\x01\x11\x02\x9CD")
          }
...
/*<188>*/ 	switch (scene_flags[25 /* 0x2 02 */]) {
          	  case 0:
/*<189>*/ 		printf("\x0E\x01\x12\x04\x00\x04Gebieter, setze die <r<Steintafel>>, die ich\ndir gab, in das Podest ein.")
          	  case 1:
/*< 68>*/ 		switch (story_flags[38 /* us: 805A9AE5 0x10, jp: 805ACD65 0x10 */]) {
          		  case 0:
/*< 44>*/ 			printf("\x0E\x01\x12\x04\x00\x04Gebieter, triff das Symbol mit dem\n<r<Himmelsstrahl >>und setze die Steintafel\nein, die ich dir vorhin gab.\n\n<g<Hebe dein Schwert gen Himmel,>> um es\nmit heiliger Energie aufzuladen und\nfeuere dann den <r<Himmelsstrahl >>ab. ")
          		  case 1:
/*< 69>*/ 			printf("Mein Name ist <b<Phai>>...\nStelle dich vor das Podest und\nziehe das Schwert heraus.")
          		}
          	}
          }
