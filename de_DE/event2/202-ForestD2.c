...
/*<  9>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 2, unk: 0, line: 11 */ "<0x10012:0x0000000b>Gebieter, ich habe dir etwas zu\nberichten. In der Nähe befindet sich\neine große Schatztruhe.\n\nDie Wahrscheinlichkeit, dass sich darin\nder <color yellow<Schlüssel >coloroff>befindet, der das Tor\nim oberen Teil der Steinstatue öffnet,\nbeträgt 85 %.")
          }
...
/*< 15>*/ 	printf(/* textboxtype: 1, unk: 0, line: 17 */ "Du bist ziemlich hartnäckig.<pause 5>.<pause 5>.")
/*< 19>*/ 	set_camera(3, 0)
/*< 16>*/ 	printf(/* textboxtype: 1, unk: 0, line: 18 */ "Ich benötige meine kostbare Zeit, um\neinen Weg für die Rückkehr des\nDämonenkönigs zu finden.<pause 5>.<pause 5>.")
/*< 20>*/ 	set_camera(4, 0)
/*< 30>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3334, 'param2': 512, 'next': 23, 'param3': 13}
/*< 23>*/ 	wait_frames(30)
/*< 22>*/ 	printf(/* textboxtype: 1, unk: 0, line: 19 */ "Zu allem Überfluss stört mich dann\nauch noch so lästiges Getier wie du.\nDas schlägt mir doch ein wenig\nauf die Stimmung.")
...
/*< 13>*/ 	printf(/* textboxtype: 2, unk: 0, line: 12 */ "<0x10012:0x00000001>Gebieter, meine Analyse hat ergeben,\ndass sich im oberen Bereich ein großes\nTor befindet.")
/*< 43>*/ 	scene_flags[12 'Faron: Ancient Cistern'][107 /* 0xC 08 */] = true;
          }

          void entrypoint_202_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 7, unk: 0, line: 1 */ "Triff die <color red<4 Steine>coloroff>, wie es die\n<color red<Sitten>coloroff> dieses Landes verlangen,\nund der Weg öffnet sich.")
          }
...
/*<  4>*/ 	start()
/*<  5>*/ 	printf(/* textboxtype: 7, unk: 0, line: 4 */ "Suche den <color yellow<Schlüssel>coloroff>\nin der Tiefe.")
          }
