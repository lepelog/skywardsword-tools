...
/*< 22>*/ 		switch (choice(2)) {
          		  case 0:
/*< 24>*/ 			printf("\x0E\x01\x12\x04\x00\x05Sehr wohl, Gebieter. Ich werde den\nRoboter unverzüglich rufen.")
          		  case 1:
/*< 23>*/ 			printf("\x0E\x01\x12\x04\x00\x05Sehr wohl, Gebieter. Solltest du deine\nMeinung ändern, untersuche das eben\nausgewählte Ziel erneut.")
          		}
          	  case 1:
...
/*< 25>*/ 	start()
/*< 26>*/ 	printf("\x0E\x01\x12\x04\x00\x01Ich schlage vor, dass du zurück ins\nWolkenmeer reist und den Mogma\nan seinen Zielort bringst.")
...
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf("\x0E\x01\x12\x04\x00\x05Sehr wohl, Gebieter. Ich werde den\nRoboter unverzüglich rufen.")
          	  case 1:
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x05Sehr wohl, Gebieter. Solltest du deine\nMeinung ändern, untersuche das eben\nausgewählte Ziel erneut.")
          	}
          }
