...
/*<111>*/ 				switch (scene_flags[23 /* 0x3 80 */]) {
          				  case 0:
/*<113>*/ 					printf(/* textboxtype: 1, unk: 0, line: 17 */ "<0x10009:0x00030c00>Dieser Keimling wird im <color blue<Land\nRanelle >coloroff>nicht wachsen, bzzz!\n<0x10009:0x00000900>Lass dir was einfallen!\n\n<0x10009:0x00030900>Mit der <color red<Frucht des Lebensbaums\n>coloroff>wird der Donnerdrache wieder gesund\nwerden!<pause 30>")
          				  case 1:
/*< 70>*/ 					{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 32, 'param3': 31}
/*< 32>*/ 					printf(/* textboxtype: 1, unk: 0, line: 14 */ "<0x10009:0x00030900>Was willst du damit?<pause 30>\nDer <color blue<Donnerdrache >coloroff>braucht unbedingt\neine <color red<Lebensbaumfrucht>coloroff>!\n\n<0x10009:0x00030900>Du willst ihm doch helfen, oder?\n[1-]Klar![2-]Eigentlich...")
/*<131>*/ 					switch (choice(2)) {
          					  case 0:
...
/*<112>*/ 						scene_flags[9 'Lanayru Gorge'][23 /* 0x3 80 */] = true;
          					  case 1:
/*<133>*/ 						printf(/* textboxtype: 1, unk: 0, line: 16 */ "<0x10009:0x00030900>Eigentlich ja? Das höre ich gern!\nDu solltest ihn allerdings woanders\neinpflanzen.\n\n<0x10009:0x00030900>Und zwar <color red<nicht in Ranelle>coloroff>!<sound 4> Bzzz!")
          						goto flw_72
          					}
          				}
          			  case 1:
/*<  4>*/ 				printf(/* textboxtype: 1, unk: 0, line: 13 */ "<0x10009:0x00030c00>Dem <color blue<Donnerdrachen>coloroff> geht es schlecht,<pause 15>\nund hier will kein Baum so recht\nwachsen...<pause 30>\n<0x10009:0x00010c00>Wir haben keine Zeit mehr...")
          			}
          		}
          	}
          }
...
/*<148>*/ 				scene_flags[9 'Lanayru Gorge'][35 /* 0x5 08 */] = true;
          				goto flw_154
          			  case 1:
/*<157>*/ 				printf(/* textboxtype: 1, unk: 0, line: 52 */ "<0x10009:0x2f080d02>Hey, <heroname>!\n\n\n\nHast du die <color blue<heilige Flamme>coloroff>, von der\ndu erzähltest, mittlerweile gefunden?\n\n\nSeit ich davon gehört habe, konnte ich\nkaum an etwas anderes denken. Du\nmusst mir alles erzählen!\n\n<0x10009:0x2f080407>.<pause 20>.<pause 20>.<pause 20>\nWas für ein Abenteuer! Ich bin wirklich\nbeeindruckt.\n\nDu bist ein echter Held,\n<heroname>!")
/*<171>*/ 				printf(/* textboxtype: 1, unk: 0, line: 53 */ "<0x10009:0x2f080d0a>Ich kann dir etwas von der Legende der\ndrei Drachen erzählen.<pause 15>\n\n\nHier in der Nähe scheint es eine\nverborgene Gegend zu geben!\n\n\nIch habe einen <color red<kleinen Gang>coloroff><sound 4> gefunden!\nLeider passe ich da nicht durch...\n\n\n<0x10009:0x2f000d00>Meiner Ansicht nach haust dort\nder <color red<Donnerdrache>coloroff>, einer der drei\nlegendären Drachen...\n\n<0x10009:0x2f000800>Ich bin mir zudem sicher, dass auch\ndie Roboter etwas mit der Sache zu\ntun haben!<pause 15>\n\n<0x10009:0x2f010807><0x10006:0xffcd>Der <color red<Donnerdrache>coloroff>, die Roboter, die\nSteine der Zeit<pause 20>.<pause 20>.<pause 20>.<pause 20>\n\n\n<0x10009:0x2f080708><0x10008:0x02cd><0x10008:0x02cd>Was für ein Mysterium!")
          				goto flw_148
          			}
          		}
          	}
...
/*<135>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 46>*/ 			printf(/* textboxtype: 1, unk: 0, line: 24 */ "Vielen Dank, dass du dem \nDonnerdrachen geholfen hast!")
          		  case 1:
/*<136>*/ 			printf(/* textboxtype: 1, unk: 0, line: 26 */ "Warst du beim Donnerdrachen?")
          		}
          	  case 1:
/*< 53>*/ 		check_item_flag(198, 1)
/*< 54>*/ 		switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 26}) {
          		  case 0:
/*< 55>*/ 			printf(/* textboxtype: 1, unk: 0, line: 25 */ "Wenn der Donnerdrache die\n<color red<Lebensbaumfrucht>coloroff> isst, sollte er\ndadurch genesen.")
          		  case 1:
/*< 35>*/ 			check_item_flag(497, 1)
/*< 36>*/ 			switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 14}) {
          			  case 0:
/*< 38>*/ 				printf(/* textboxtype: 1, unk: 0, line: 23 */ "<0x10009:0x00030c00>In dieser Hitze will nichts so recht\ngedeihen...<pause 30> <0x10009:0x00010c00>Wenn das so weitergeht...\n<0x10006:0xfecd>Der Donnerdrache...")
          			  case 1:
/*< 33>*/ 				switch (story_flags[524 /* us: 805A9B14 0x02, jp: 805ACD94 0x02 */]) {
          				  case 0:
/*<168>*/ 					switch (scene_flags[23 /* 0x3 80 */]) {
          					  case 0:
/*<169>*/ 						printf(/* textboxtype: 1, unk: 0, line: 27 */ "<0x10009:0x00000000>Ich mache mir sorgen um den\nDonnerdrachen. Bitte finde eine\n<color red<Lebensbaumfrucht>coloroff> für ihn, bzzz.")
          					  case 1:
/*< 37>*/ 						printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00030900>Um den Donnerdrachen zu kurieren,\nhaben wir einen <color red<Lebensbaumkeimling\n>coloroff>eingepflanzt.")
          					}
          				  case 1:
...
/*< 24>*/ 	switch (temp_flags[0 /* 0x1 01 */]) {
          	  case 0:
/*< 25>*/ 		printf(/* textboxtype: 1, unk: 0, line: 31 */ "Wenn du dich nicht beeilst, muss ich\nihn ablegen!")
          	  case 1:
/*< 71>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 12, 'param3': 31}
/*< 12>*/ 		printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x00030900>Hier gibt es viele große Steine der Zeit.<pause 30>\n<0x10009:0x00000900>Hast du auch die Erlaubnis des\n<color blue<Donnerdrachen>coloroff> eingeholt?\n\n<0x10009:0x00010900>Ich wollte dieses Exemplar hier\ngerade zu ihm bringen!")
...
/*<134>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 48>*/ 			printf(/* textboxtype: 1, unk: 0, line: 37 */ "Dem Donnerdrachen geht es blendend!")
          		  case 1:
...
/*< 57>*/ 		switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 28}) {
          		  case 0:
/*< 58>*/ 			printf(/* textboxtype: 1, unk: 0, line: 38 */ "Was hast du mit der Frucht gemacht?<pause 45>\nHast du sie denn bereits dem\n<color blue<Donnerdrachen>coloroff> gebracht?")
          		  case 1:
/*< 27>*/ 			check_item_flag(197, 1)
/*< 28>*/ 			switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 8}) {
          			  case 0:
/*< 39>*/ 				printf(/* textboxtype: 1, unk: 0, line: 36 */ "<0x10009:0x00030c00>In <color blue<Ranelle>coloroff> wird dieser Baum\nwohl niemals Früchte tragen.<pause 30>\n<0x10009:0x00030900>Es bräuchte einfach eine\nfruchtbarere Gegend...")
          			  case 1:
/*< 26>*/ 				switch (story_flags[524 /* us: 805A9B14 0x02, jp: 805ACD94 0x02 */]) {
          				  case 0:
/*< 29>*/ 					printf(/* textboxtype: 1, unk: 0, line: 35 */ "Auf der anderen Seite der Brücke\nhaben wir den <color red<Lebensbaumkeimling>coloroff>,\ndessen Früchte alle Krankheiten\nheilen, eingepflanzt.<pause 30>\n<0x10009:0x00000c00>Leider sind unsere Bemühungen\nin dieser Umgebung fruchtlos\ngeblieben...")
          				  case 1:
/*< 16>*/ 					printf(/* textboxtype: 1, unk: 0, line: 34 */ "<0x10009:0x00030900>Der <color blue<Donnerdrache>coloroff> hat mir erlaubt,\nhier nach <color blue<Steinen der Zeit>coloroff> zu graben.\n\n\n<pause 30><0x10009:0x00030c00>Im Augenblick geht es ihm jedoch\nziemlich mies...<pause 15> Ich mache mir wirklich\nSorgen!<pause 30> <0x10009:0x00010c00>Wenn das so weitergeht...")
          				}
          			}
          		}
          	}
...
/*< 81>*/ 	printf(/* textboxtype: 2, unk: 0, line: 61 */ "<0x10005:0x004b0000>Dies ist die <color blue<Ranelle-Schlucht>coloroff>.\nDen alten Legenden zufolge lebt hier\nein Drache, der der Göttin dient.")
          }

          void entrypoint_404_32() {
/*< 82>*/ 	start()
/*< 83>*/ 	printf(/* textboxtype: 2, unk: 0, line: 62 */ "<0x10005:0x005a0000>Da sich hier viele Steine der Zeit\nfinden, hat eine alte Kultur hier wohl\nein Steinwerk errichtet.")
          }
...
/*< 84>*/ 	start()
/*< 85>*/ 	printf(/* textboxtype: 2, unk: 0, line: 63 */ "<0x10005:0x005a0000>Noch heute zeugen die Loren\nund Schienen hier überall von ihren\nBemühungen.")
          }

          void entrypoint_404_51() {
/*< 73>*/ 	start()
/*< 74>*/ 	printf(/* textboxtype: 8, unk: 0, line: 65 */ "Ranelle-Sandmeer voraus\nEin Meer aus Sand\nViele Spuren alter Kulturen")
          }

          void entrypoint_404_34() {
/*<166>*/ 	start()
/*<167>*/ 	printf(/* textboxtype: 2, unk: 0, line: 64 */ "Manchmal trägt ein Bobklin ein\nMonsterhorn an seiner Hüfte.\n\n\nNutze die <color red<Peitsche>coloroff>, um es ihm zu\n<color red<entreißen>coloroff>.")
          }

          void entrypoint_404_52() {
/*< 75>*/ 	start()
/*< 76>*/ 	printf(/* textboxtype: 8, unk: 0, line: 66 */ "Wüste Ranelle voraus\nVersuche, das Rätsel des alten\nBergwerks zu lösen.")
          }
...
/*< 77>*/ 	start()
/*< 78>*/ 	printf(/* textboxtype: 8, unk: 0, line: 67 */ "Ranelle-Mine voraus\nDas Rätsel des Steins der Zeit")
          }
...
/*< 92>*/ 	start()
/*< 93>*/ 	printf(/* textboxtype: 7, unk: 0, line: 68 */ "Betreten nur mit Erlaubnis des\n<color blue<Donnerdrachen Ranelle>coloroff>!")
          }
