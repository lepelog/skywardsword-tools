...
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf("Sehr wohl, \x0E\x01\x12\x04\x00\x05Gebieter. Ich werde den\nRoboter nun rufen.")
          	  case 1:
/*<  3>*/ 		printf("Sehr wohl, \x0E\x01\x12\x04\x00\x05Gebieter. Solltest du deine\nMeinung ändern, untersuche dieses\nWesen ein weiteres Mal.")
          	}
          }
