...
/*< 58>*/ 	start()
/*< 59>*/ 	printf("\x0E\x01\x0B\x04\x00rAah, ich werde getroffen!\nTu doch was, bzzz!")
          }
...
/*< 97>*/ 	start()
/*< 98>*/ 	printf("\x0E\x01\x05\x04K\x00\x0E\x01\x12\x04\x00\x0BGebieter, ich habe dir etwas\nzu berichten.\n\n\nWir befinden uns nahe des Kraters am\nGipfel des <b<Vulkans Eldin>>.")
          }
...
/*<253>*/ 			printf("\x0E\x01\x09\x04ÿ\xFF09Selbst-<pause0A>ver-<pause0A>ständ-<pause0A>lich<pause0A> \nist diese Information nicht kostenlos.\n<r<30 Rubine>>. Was meinst du? [1]Ja[2-]Nein")
          			flw_225:
/*<225>*/ 			switch (choice(2)) {
          			  case 0:
...
/*<278>*/ 					zone_temp_flags[7 /* 0x1 80 */] = true;
          			  ...
          			  case 1:
/*<226>*/ 				printf("\x0E\x01\x09\x04\x14\x1215Was, du willst meinen Rat nicht\nannehmen? Machst hier wegen\n<r<30 Rubinen >>rum? Pah!\n\n\x0E\x01\x09\x04ÿ\xFF00Nun gut, dann komm eben wieder,\nwenn du es dir anders überlegt hast.")
...
/*<257>*/ 		printf("\x0E\x01\x09\x04ÿ\xFF09Selbst-<pause0A>ver-<pause0A>ständ-<pause0A>lich<pause0A> \ngibt es diese Information nicht gratis.\n<r<30 Rubine>>. Was meinst du? [1]Ja[2-]Nein")
...
/*<101>*/ 	start()
/*<102>*/ 	printf("\x0E\x01\x05\x04Z\x00Es besteht eine Wahrscheinlichkeit von\n90 %, dass sich die letzte <r<heilige\nFlamme >>hier befindet. Ich empfehle,\nsie zu suchen.")
          }

          void entrypoint_303_16() {
/*< 66>*/ 	start()
/*< 67>*/ 	printf("\x0E\x01\x0B\x04\x00rHey, du kannst mich hier\ndoch nicht alleine lassen!")
          }
...
/*<196>*/ 	switch (random(3)) {
          	  case 0:
/*< 71>*/ 		printf("\x0E\x01\x0B\x04\x00rAaah! Was sind denn das für fiese\nGestalten? Mach etwas, schnell!")
          	  case 1:
...
/*<  6>*/ 	switch (story_flags[110 /* us: 805A9AE1 0x08, jp: 805ACD61 0x08 */]) {
          	  case 0:
/*<  8>*/ 		printf("Auf diesem Berg scheint es noch\n<y<Artefakte der Göttin>> zu geben... Willst\ndu sie nicht suchen?")
          	  case 1:
...
/*<115>*/ 		set_camera(3, 0)
/*<112>*/ 		printf("\x0E\x01\x12\x04\x00dNicht, dass ich etwa vor Monstern\nAngst hätte... Aber im Augenblick\ntrage ich ja noch diesen schweren\nBehälter...")
...
/*< 10>*/ 	start()
/*< 11>*/ 	printf("Lindere meinen Durst,\nund ich gebe den Weg\nfrei...")
          }
...
/*< 21>*/ 	switch (scene_flags[106 /* 0xC 04 */]) {
          	  case 0:
/*< 22>*/ 		printf("\x0E\x01\x09\x04\x18\x1700Wenn du hier raus gehst und am Ende\nrechts abbiegst, findest du eine <r<Quelle>>!\nVielleicht hilft dir das ja weiter...")
          	  case 1:
...
/*< 81>*/ 	start()
/*< 82>*/ 	printf("\x0E\x01\x0B\x04\x00rSchluss jetzt! Wenn du so\nweitermachst, breche ich noch\nauseinander!")
          }
...
/*< 83>*/ 	start()
/*< 84>*/ 	printf("\x0E\x01\x12\x04\x00\x0BGebieter, der Roboter wartet am\nVulkan auf dich. Ich empfehle dir,\nschnell zu ihm zu gehen.")
          }
...
/*<176>*/ 				switch (zone_temp_flags[4 /* 0x1 10 */]) {
          				  case 0:
/*<177>*/ 					printf("\x0E\x01\x09\x04\x1B\x2207Ein toller Hecht, unser Boss! Immer\nunterwegs zwischen den Wolken und\nKellergewölben!")
          				  case 1:
...
/*< 52>*/ 		switch (scene_flags[111 /* 0xC 80 */]) {
          		  case 0:
/*< 53>*/ 			printf("Ich werde mich noch woanders\numsehen... Bis dann!")
          		  case 1:
/*< 46>*/ 			printf("\x0E\x01\x09\x04\x18\x1702Und, was hast du da drinnen\ngefunden?\n[1]Viele Fallen[2]Viele Monster")
/*< 47>*/ 			switch (choice(2)) {
          			  case 0:
          				flw_49:
...
/*< 89>*/ 	start()
/*< 90>*/ 	printf("Da soll ich Wasser drauf spritzen?\nNa, dann sieh zu und lerne!")
          }
