...
/*<164>*/ 	start()
/*<165>*/ 	printf("Wir sind in der <b<Wüste Ranelle\n>>angekommen.\n\n\nSuche mit der Aurasuche nach dem\nEingang zur Prüfung, die du bestehen\nmusst, um die heilige Flamme zu\nerhalten.")
...
/*<  5>*/ 		switch (story_flags[90 /* us: 805A9AEF 0x80, jp: 805ACD6F 0x80 */]) {
          		  case 0:
          			flw_10:
/*< 10>*/ 			printf("Jetzt kannst du mit dem Käfer\nObjekte <r<greifen und festhalten>>!\n\n\nPass auf dich auf!")
...
/*<  6>*/ 			switch (context_related2(0)) {
          			  case 0:
/*<277>*/ 				printf("\x0E\x01\x09\x04\x1303\x00Du hast mich gerettet, bzzz!")
...
/*<209>*/ 	start()
/*<210>*/ 	printf("Angeplante Fördermenge: \n150 Kisten\n\x09Die Bauleitung")
          }
...
/*<105>*/ 			switch (story_flags[525 /* us: 805A9B14 0x04, jp: 805ACD94 0x04 */]) {
          			  case 0:
/*<275>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD02Ohoho, Link!")
/*<276>*/ 				set_camera(5, 0)
...
/*<110>*/ 				scene_flags[7 'Lanayru Desert'][75 /* 0x8 08 */] = true;
          				goto flw_149
          			  case 1:
/*<273>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD02Ohoho, Link!")
/*<274>*/ 				set_camera(5, 0)
/*<211>*/ 				printf("Was ist mit der <b<heiligen Flamme>>, von\nder du erzählt hast? Hast du sie denn\ngefunden?\n\nIch bin so neugierig! Erzähle mir doch\nbitte, was dir widerfahren ist!\n\n\n\x0E\x01\x09\x04\x2F08\x407Hmmm.<pause14>.<pause14>.<pause14> Eine steinharte Geschichte,\ndie du mir da erzählst!\n\n\nDu bist wirklich beeindruckend,\nLink!")
/*<359>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD0AIch kann dir etwas von der Legende der\ndrei Drachen erzählen.<pause0F>\n\n\nEs gibt tatsächlich einen verborgenen\nOrt in der Wüste vor uns!\n\n\nIch habe nämlich einen <r<kleinen Gang>><pling>\ngefunden!\n\n\n\x0E\x01\x09\x04\x2F00\xD00Ich glaube, dass der <r<Donnerdrache>>,\neiner der drei mystischen Drachen der\nLegende, dort sein Zuhause hat.\n\n\x0E\x01\x09\x04\x2F00\x800Ich bin mir ziemlich sicher, dass eine\nVerbindung zwischen ihm und den\nRobotern hier besteht!<pause0F>\n\n\x0E\x01\x09\x04\x2F01\x807\x0E\x01\x06\x02\xFFCDDer <r<Donnerdrache>>, die Roboter,\ndie Steine der Zeit<pause14>.<pause14>.<pause14>.<pause14>\n\n\n\x0E\x01\x09\x04\x2F08\x708\x0E\x01\x08\x02\x2CDWas für ein Mysterium!")
          				goto flw_285
          			}
          		}
          	}
...
/*< 66>*/ 				printf("Der Tempel der Zeit ist wirklich\nwunderschön. Ich könnte jedes Mal\nbzzzen, wenn ich ihn sehe...")
          			  case 1:
/*<319>*/ 				printf("Du suchst einen Drachen?\n\n\n\n<b<\x0E\x01\x09\x04\x1303\x00>>Der <b<Donnerdrache>> lebt südlich der\n<b<Ranelle-Höhle>>. Über einen anderen\nDrachen kann ich dir nichts sagen...")
...
/*< 97>*/ 			printf("Nanu? Diese Karte hat Fehler. Ich\nrepariere sie.")
...
/*<102>*/ 	start()
/*<286>*/ 	printf("\x0E\x01\x12\x04\x00\x01Gebieter, ich habe dir etwas zu\nberichten. Ich spüre <b<Zeldas>> Aura\nnicht mehr.")
/*<287>*/ 	set_camera(7, 0)
/*<288>*/ 	printf("Als dieses Portal zerstört wurde, habe\nich Zeldas Aura plötzlich verloren.\n<pling><r<Du kannst sie mit der Aurasuche nicht\nmehr aufspüren>>.")
/*<289>*/ 	set_camera(-1, 0)
...
/*< 85>*/ 						scene_flags[7 'Lanayru Desert'][35 /* 0x5 08 */] = true;
          				  ...
          				  case 1:
/*<325>*/ 					printf("Du suchst einen Drachen?\n\n\n\n<b<\x0E\x01\x09\x04\x1303\x00>>Der <b<Donnerdrache>> lebt südlich der\n<b<Ranelle-Höhle>>. Über einen anderen\nDrachen kann ich dir nichts sagen...")
...
/*<132>*/ 	start()
/*<133>*/ 	printf("\x0E\x01\x05\x04Z\x00Ich schätze, dass <b<Zelda>> hierher\ngekommen und bereits vorausgeeilt ist.")
...
/*<187>*/ 				printf("Du hast die Kombination gefunden?\nNicht zu fassen!")
          			  case 1:
/*<331>*/ 				printf("Du suchst einen Drachen?\n\n\n\n<b<\x0E\x01\x09\x04\x1303\x00>>Der <b<Donnerdrache>> lebt südlich der\n<b<Ranelle-Höhle>>. Über einen anderen\nDrachen kann ich dir nichts sagen...")
...
/*<135>*/ 	printf("\x0E\x01\x05\x04Z\x00Wir sind in der <b<Wüste >><b<Ranelle\n>>angekommen. Eine große Dürre hat\nden gesamten Landstrich vollkommen\nverändert.")
          }

          void entrypoint_400_76() {
/*<295>*/ 	start()
/*<296>*/ 	printf("Wir sind am <b<Tempel der Zeit\n>>angekommen.\n\n\nSuche mit der Aurasuche nach dem\nEingang zur Prüfung, die du bestehen\nmusst, um die heilige Flamme zu\nerhalten.")
...
/*<336>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_189:
/*<189>*/ 				printf("Du hast die Kombination\nherausbekommen? Nicht zu fassen!")
          			  case 1:
/*<337>*/ 				printf("Du suchst einen Drachen?\n\n\n\n<b<\x0E\x01\x09\x04\x1303\x00>>Der <b<Donnerdrache>> lebt südlich der\n<b<Ranelle-Höhle>>. Über einen anderen\nDrachen kann ich dir nichts sagen...")
...
/*<303>*/ 	start()
/*<304>*/ 	printf("\x0E\x01\x12\x04\x00\x0BGebieter, ich habe dir etwas zu\nberichten. Ich schätze, dass es\nnotwendig ist, dieses <r<Gerät>> mit\nStrom zu versorgen.")
          }
...
/*<342>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_191:
/*<191>*/ 				printf("Du hast die Kombination\nherausbekommen?\nNicht zu fassen!")
          			  case 1:
/*<343>*/ 				printf("Du suchst einen Drachen?\n\n\n\n<b<\x0E\x01\x09\x04\x1303\x00>>Der <b<Donnerdrache>> lebt südlich der\n<b<Ranelle-Höhle>>. Über einen anderen\nDrachen kann ich dir nichts sagen...")
