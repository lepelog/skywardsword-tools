...
/*<179>*/ 	start()
/*<182>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Eldin-Erz>>, um\ndieses Item zu verbessern.\n\nIn den Büchern meines Opas steht, dass\nman dieses Zeug in einem in Flammen\ngehüllten Berg abbauen kann.")
/*<187>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*< 34>*/ 							switch (context_related2(1)) {
          							  case 0:
/*< 35>*/ 								printf("\x0E\x01\x09\x04\x0E\xE0CWas \x0E\x01\x06\x02\xFDCDsoll\x0E\x01\x06\x02Í denn das, Freundchen? Erst\nsagst du, dass du so eine Blume hast,\nund dann stimmt das gar nicht! Ich bin\nwirklich entsetzt!")
...
/*<189>*/ 	start()
/*<192>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Bernsteinhalb-\nmonde>>, um dieses Item zu verbessern.\n\nIn den Büchern meines Opas steht, dass\ndiese Dinger an unterschiedlichen\nOrten einfach so herumliegen...")
/*<193>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<  6>*/ 	start()
/*<  7>*/ 	printf("\x0E\x01\x09\x04\x08\x806Jawoll! Aber vergiss nicht, eine\nVerbesserung kann nicht mehr\nrückgängig gemacht werden!\n[1]Kein Problem![2-]Dann nicht.")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
...
/*< 26>*/ 		zone_temp_flags[4 /* 0x1 10 */] = true;
          	  case 1:
/*< 11>*/ 		printf("\x0E\x01\x09\x04\x0E\xE05Willst du mich auf deinen schmächtigen\nArm nehmen, Freundchen?\n\n\nSuch doch was anderes aus!")
...
/*<194>*/ 	start()
/*<197>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Finsterhalbmonde>>,\num dieses Item zu verbessern.\n\nIn den Büchern meines Opas steht, dass\nman diese Dinger in einer Welt finden\nkann, die in unserer Seele existiert.\nWas soll das denn bitte heißen?")
/*<198>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<199>*/ 	start()
/*<202>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Glibber>>, um dieses\nItem zu verbessern.\n\nIn den Büchern meines Opas steht, dass\nman dieses Zeug finden kann, wenn\nman schleimige Monster besiegt.")
/*<207>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<156>*/ 	printf("Er ist jedoch zu schwer, um ihn in der\nTasche hierher tragen zu können.")
/*<125>*/ 	set_camera(11, 0)
...
/*<126>*/ 	set_camera(10, 0)
/*<129>*/ 	printf("\x0E\x01\x09\x04\x160E\x200P-P-Phai? Die... Phai? Oh, verehrte\nPhai, wie kann ich Euch dienen?")
...
/*<203>*/ 	start()
/*<206>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Monsterklauen>>,\num dieses Item zu verbessern.\n\nIn den Büchern meines Opas steht, dass\nman diese Dinger finden kann, wenn\nman fliegende Monster besiegt. Hier\nschwirren ja nachts auch welche rum...")
/*<239>*/ 	switch (story_flags[360 /* us: 805A9B00 0x40, jp: 805ACD80 0x40 */]) {
          	  case 0:
/*<240>*/ 		printf("\x0E\x01\x09\x04\x10\xE11Obwohl... Ich habe schon länger keine\nmehr hier gesehen. Warum es wohl so\nruhig geworden ist?")
          		flw_208:
/*<208>*/ 		printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<209>*/ 	start()
/*<212>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Monsterhörner>>,\num dieses Item zu verbessern.\n\nIn den Büchern meines Opas steht, dass\nman diese Dinger finden kann, wenn\nman Monster besiegt, die mit einem\nSignalhorn ihre Handlanger rufen...")
/*<213>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*< 29>*/ 	start()
/*< 30>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, Freundchen! Du hast kein Item,\ndas ich verbessern könnte... Was für\nein Jammer!\n\nWie wär's, wenn du dir drüben beim\nItem-Laden etwas kaufst?")
          }

          void entrypoint_113_41() {
/*<214>*/ 	start()
/*<217>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Schmuckschädel>>,\num dieses Item zu verbessern.\n\nIn den Büchern meines Opas steht, dass\nman diese Dinger finden kann, wenn\nman Monster besiegt, die mit Knüppeln\noder anderen Waffen kämpfen.")
/*<218>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<219>*/ 	start()
/*<222>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Schattenkristalle>>,\num dieses Item zu verbessern.\n\nIn den Büchern meines Opas steht,\ndass man diese Dinger finden kann,\nwenn man finstere Monster besiegt...")
/*<227>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<107>*/ 	switch (context_related2(2)) {
          	  case 0:
/*<108>*/ 		printf("\x0E\x01\x09\x04\x08\x800Hey! Soll ich noch einen anderen Schild\nfür dich reparieren?")
/*<110>*/ 		make_actor_do_something(10, 0)
          	  case 1:
/*<109>*/ 		printf("\x0E\x01\x09\x04\x08\x800Hey, Freundchen! Du hast keinen\nSchild mehr, den ich reparieren\nkönnte. Komm ein andermal wieder!")
          	}
          }

          void entrypoint_113_43() {
/*<223>*/ 	start()
/*<226>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<blaue Vogelfedern>>,\num dieses Item zu verbessern.\n\nIn den Büchern meines Opas steht,\ndass man sie finden kann, wenn man\nirgendwelche Vögel an einem grünen\nOrt mit einem Netz fängt...")
/*<228>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<229>*/ 	start()
/*<232>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<goldene Schmuck-\nschädel>>, um dieses Item zu verbessern.\n\nIn den Büchern meines Opas steht,\ndass diese Dinger herrlich glänzen und\nsehr selten sind.")
/*<233>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<234>*/ 	start()
/*<237>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Geschenke der\nGöttin>>, um dieses Item zu verbessern.\n\nIn den Büchern meines Opas steht,\ndass diese Dinger furchtbar selten\nund unheimlich wertvoll sind.")
/*<238>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<159>*/ 	start()
/*<162>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Bienenlarven>>, um\ndieses Item zu verbessern.\n\nIn den Büchern meines Opas steht, dass\nman diese Dinger finden kann, wenn\nman sich an Bienenstöcken in irgend-\neinem Wald zu schaffen macht...")
/*<167>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<163>*/ 	start()
/*<166>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Vogelfedern>>, um\ndieses Item zu verbessern.\n\nIn den Büchern meines Opas steht,\ndass man diese Dinger finden kann,\nwenn man Vögel an einem Ort voller\nGrün mit einem Netz fängt...")
/*<168>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
...
/*<169>*/ 	start()
/*<172>*/ 	printf("\x0E\x01\x09\x04\x0E\xE0CHey, das tut mir wirklich leid, aber ich\nbrauche noch mehr <y<Wüstengras>>, um\ndieses Item zu verbessern.\n\nIn den Büchern meines Opas steht,\ndass man dieses Zeug mit einem Netz\neinfangen kann, wenn es durch die\nWüste rollt...")
/*<173>*/ 	printf("\x0E\x01\x09\x04\x07\x700Gibt es irgendein anderes Item, das\nich verbessern soll?")
