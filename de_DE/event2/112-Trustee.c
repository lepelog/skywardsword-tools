...
/*< 55>*/ 							printf("\x0E\x01\x09\x04\x00\x04Oh, du hast ja gar nichts.\n\n\n\nNa ja, komm einfach wieder, wenn du\netwas lagern möchtest.")
          				  ...
          				  case 1:
/*< 17>*/ 					printf("\x0E\x01\x09\x04\x00\x04Du hast doch gar nichts, das ich für\ndich aufbewahren könnte...\n\n\nNa ja, komm einfach wieder, wenn du\netwas lagern möchtest.")
          				}
          			}
          		  case 1:
...
/*< 57>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_47:
/*< 47>*/ 						printf("\x0E\x01\x09\x04\x0E\x150CWas soll das, mein Schatz? Machst du\ndas etwa mit Absicht?")
          					  case 1:
/*< 58>*/ 						printf("\x0E\x01\x09\x04\x00\x13Kommst du etwa nur, um mich zu\nsehen? Weil ich von Tag zu Tag\nschöner werde? Und du ohne mich\nnicht leben kannst? Ja?")
          					}
          				  case 1:
          					goto flw_47
          				}
...
/*< 49>*/ 				switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          				  case 0:
/*< 46>*/ 					printf("\x0E\x01\x09\x04\x00\x17Also wirklich! Wieso sprichst du mich\ndenn an, wenn du hier doch gar nichts\nzu tun hast?")
          				  case 1:
/*< 48>*/ 					switch (story_flags[628 /* us: 805A9B1B 0x80, jp: 805ACD9B 0x80 */]) {
          					  case 0:
/*< 87>*/ 						printf("\x0E\x01\x09\x04\x00\x02Also wirklich! Wieso sprichst du mich\nan, wenn du hier doch gar nichts zu tun\nhast? Ach...")
          					  case 1:
/*<  3>*/ 						printf("\x0E\x01\x09\x04\x00\x02Aha... Soll mir recht sein. Aber das\nnächste Mal kommst du nur, wenn du\nhier auch etwas zu erledigen hast, ja?")
          					}
          				}
          			}
          		}
...
/*< 78>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_40:
/*< 40>*/ 						printf("\x0E\x01\x09\x04\x00\x08Danke schön! Du hast doch sicher noch\nmehr, oder? Bleib doch einfach den\nganzen Tag über hier, wenn du willst.")
          						flw_53:
...
/*< 79>*/ 						printf("\x0E\x01\x09\x04\x00\x03Danke schön. Hast du sonst noch was?")
          			  ...
          			  case 1:
/*< 10>*/ 				printf("\x0E\x01\x09\x04\x00\x03Danke schön. Hast du sonst noch\nirgendwas?")
          				goto flw_53
          			}
          		  case 1:
...
/*< 75>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_38:
/*< 38>*/ 						printf("\x0E\x01\x09\x04\x00\x12Wirklich? Ach, du hast Recht. Du bist\nja so klug, mein Schatz!")
          						goto flw_53
          					  case 1:
/*< 76>*/ 						printf("\x0E\x01\x09\x04\x00\x14Nun, dieses Item hat es auch nicht\nverdient, entsorgt zu werden. So wie\nich anscheinend deine Liebe nicht\nverdient habe...")
          						goto flw_53
          					}
          				  case 1:
          					goto flw_38
...
/*< 83>*/ 				printf("\x0E\x01\x09\x04\x00\x04Oh, du hast ja gar nichts.\n\n\n\nNa ja, komm einfach wieder, wenn du\netwas lagern möchtest.")
          	  ...
          	  case 1:
/*< 15>*/ 		printf("\x0E\x01\x09\x04\x00\x04Du hast doch gar nichts, das ich für\ndich aufbewahren könnte...\n\n\nNa ja, komm einfach wieder, wenn du\netwas lagern möchtest.")
          	}
          }
