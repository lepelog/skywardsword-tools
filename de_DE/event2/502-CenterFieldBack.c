...
/*< 79>*/ 	start()
/*< 86>*/ 	printf("\x0E\x01\x12\x04\x00\x04Gebieter, bist du nun bereit für\nden Kampf?\n[1]Bereit![2-]Warte!")
/*< 87>*/ 	switch (choice(2)) {
          	  case 0:
/*< 88>*/ 		printf("Sehr wohl, \x0E\x01\x12\x04\x00\x05Gebieter.\nDann brechen wir auf!")
/*< 90>*/ 		changeScene(11, 0) // 
          	  case 1:
/*< 89>*/ 		printf("Sehr wohl, \x0E\x01\x12\x04\x00\x05Gebieter.\nBereite dich nur gut vor.")
          	}
          }

          void entrypoint_502_09() {
/*< 80>*/ 	start()
/*< 81>*/ 	printf("\x0E\x01\x12\x04\x00\x04Gebieter, willst du dich noch einmal\nzurückziehen, um dich auf diesen\nKampf vorzubereiten?\n[1]Ja[2-]Nein")
/*< 82>*/ 	switch (choice(2)) {
          	  case 0:
/*< 83>*/ 		printf("Sehr wohl, \x0E\x01\x12\x04\x00\x05Gebieter.\nKehre zurück, wenn du deine\nVorbereitungen abgeschlossen hast.")
/*< 85>*/ 		changeScene(10, 0) // 
          	  case 1:
...
/*< 31>*/ 			switch (story_flags[21 /* us: 805A9ADB 0x20, jp: 805ACD5B 0x20 */]) {
          			  case 0:
/*< 51>*/ 				printf("\x0E\x01\x09\x04\x00\x01Noch hast du deine Aufgabe\nnicht erfüllt...\n\n\nTu, was dir aufgetragen wurde...\nTu es für <b<Zelda>>!\n")
          			  case 1:
...
/*< 33>*/ 					switch (scene_flags[102 /* 0xD 40 */]) {
          					  case 0:
/*< 46>*/ 						printf("\x0E\x01\x09\x04\x00\x03Ein Baum, der etliche Generationen\nübersteht... Ob es irgendwo einen\n<r<Keimling >>für solch einen Baum gibt?")
          					  case 1:
...
/*< 15>*/ 			set_camera(3, 0)
/*< 14>*/ 			printf("Dort erwartet dich jene Person, für\ndie du all diese Strapazen auf dich\ngenommen hast.")
...
/*< 65>*/ 		printf("\x0E\x01\x12\x04\x00\x05Gebieter,<pause0F> ich bin immer bei dir...\n\n\n\n\x0E\x01\x12\x04\x00\x01Gebieter...<pause1E> Viel Glück.")
          	  case 1:
/*< 66>*/ 		printf("\x0E\x01\x12\x04\x00\x05Gebieter, komm hierhin zurück, wenn\ndeine Vorbereitungen abgeschlossen\nsind.")
          	}
          }
