...
/*< 89>*/ 	start()
          	flw_67:
/*< 67>*/ 	set_camera(6, 0)
/*< 65>*/ 	printf(/* textboxtype: 2, unk: 2, line: 9 */ "Solltest du auch nur einen Schritt vom\nrechten Weg abkommen, werden dich\ndie <color red<Hüter>coloroff> verfolgen, <0x10012:0x00000002>Gebieter.")
/*< 68>*/ 	set_camera(4, 0)
/*< 66>*/ 	printf(/* textboxtype: 2, unk: 2, line: 10 */ "Ein einziger Treffer der <color red<Hüter>coloroff> wird\ndeine Seele aus der Fassung bringen,\nund deine Prüfung wird zu Ende sein,\n<0x10012:0x00000002>Gebieter.")
/*< 69>*/ 	set_camera(5, 0)
/*< 70>*/ 	printf(/* textboxtype: 2, unk: 2, line: 11 */ "Sammle die <color yellow<Tränen>coloroff> daher, ohne dich\nangreifen zu lassen, und fülle das\n<color yellow<Seelengefäß>coloroff>.")
          	flw_74:
/*< 74>*/ 	set_camera(1, 0)
/*< 75>*/ 	printf(/* textboxtype: 2, unk: 2, line: 13 */ "Hast du mich verstanden, <0x10012:0x00000002>Gebieter?\nSoll ich es noch einmal erklären?\n[1-]Ja[2]Nein")
/*< 76>*/ 	switch (choice(2)) {
          	  case 0:
/*< 77>*/ 		printf(/* textboxtype: 2, unk: 2, line: 14 */ "Welche Erklärung möchtest du hören?\n\n\n[1-]Seelengefäß[2-]Hüter[3-]Sairen[4]Keine")
/*< 92>*/ 		switch (choice(4)) {
          		  case 0:
...
/*< 95>*/ 			set_camera(12, 0)
/*< 94>*/ 			printf(/* textboxtype: 2, unk: 2, line: 16 */ "Nur Auserwählten gewährt die Göttin\nZutritt zur <color blue<Sairen>coloroff>, der <color red<Welt der Seele>coloroff>.\n\n\nDu musst deinen Körper zurücklassen\nund dich der Prüfung nur mit deinem\nGeist stellen, <0x10012:0x00000001>Gebieter.\n\nMeistere die <color blue<Sairen>coloroff> und beweise, dass\ndeine Seele stark genug ist.")
/*< 97>*/ 			entrypoint_250_04();
          		  case 3:
          			flw_83:
/*< 83>*/ 			set_camera(10, 0)
/*< 78>*/ 			printf(/* textboxtype: 2, unk: 2, line: 12 */ "<0x10012:0x00000005>Gebieter.\n\n\n\nIch werde hier auf deine Rückkehr\nwarten.\n\n\nAuf dass die Göttin dich beschützen\nmöge, <0x10012:0x00000001>Gebieter.\n")
...
/*< 15>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 16>*/ 		printf(/* textboxtype: 1, unk: 2, line: 28 */ "Da sind wir, <heroname>!\nAlso los, auf geht's!")
/*< 18>*/ 		set_camera(10, 0)
...
/*<  3>*/ 			printf(/* textboxtype: 2, unk: 2, line: 4 */ "Dies ist das <color yellow<Seelengefäß>coloroff>.\n\n\n\nBringe es zurück, wenn es gefüllt ist,\nund deine Prüfung gilt als bestanden.\nNur dann wird deine Seele wachsen,\n<0x10012:0x00000002>Gebieter.\nAls Lohn wird dich die Göttin mit\n<color red<neuer Kraft>coloroff> beschenken.")
          			flw_6:
/*<  6>*/ 			printf(/* textboxtype: 2, unk: 2, line: 5 */ "Fülle das <color yellow<Seelengefäß>coloroff>, indem du\n<color yellow<Farores Tränen >coloroff>aufsammelst.")
/*<  7>*/ 			set_camera(2, 0)
...
/*< 12>*/ 			set_camera(3, 0)
/*< 13>*/ 			printf(/* textboxtype: 2, unk: 2, line: 7 */ "Dies ist eine von <color yellow<Farores Tränen>coloroff>.\nSammle <color red<15>coloroff> von ihnen.")
...
/*< 71>*/ 			switch (zone_temp_flags[10 /* 0x0 04 */]) {
          			  ...
          			  case 1:
/*< 73>*/ 				set_camera(1, 0)
/*< 72>*/ 				printf(/* textboxtype: 2, unk: 2, line: 8 */ "Aber es genügt nicht, sie nur zu\nsammeln. Du bist nicht alleine bei\ndieser <color red<Prüfung>coloroff>.")
          				goto flw_67
          			}
          		}
          	}
...
/*< 57>*/ 	start()
/*< 58>*/ 	printf(/* textboxtype: 2, unk: 2, line: 1 */ "<0x10012:0x00000004>Gebieter, <heroname>.")
/*< 59>*/ 	{'type': 'type3', 'subType': 1, 'param1': 31, 'param2': 1, 'next': 61, 'param3': 40}
/*< 61>*/ 	wait_frames(30)
/*< 62>*/ 	set_camera(11, 0)
/*< 60>*/ 	printf(/* textboxtype: 2, unk: 2, line: 27 */ "Diese glitzernden Flächen heißen\n<color red<Alatraumata >coloroff>und haben eine besondere\nBewandtnis...\n\nTrittst du auf sie, <0x10012:0x00000002>Gebieter, so <color red<werden\ndich die Hüter sofort entdecken>coloroff>.\n\n\nSie sind über die ganze Gegend\nverstreut. Pass also auf, wohin du deine\nSchritte setzt.")
