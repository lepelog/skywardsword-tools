...
/*< 17>*/ 			printf(/* textboxtype: 2, unk: 0, line: 0 */ "Gebieter, deine Herzen haben sich\ndramatisch verringert. Ich rate dir,\ndringend Heilungsmaßnahmen zu\nergreifen.<entrypoint_6_402>")
          		  case 1:
/*<  3>*/ 			printf(/* textboxtype: 2, unk: 0, line: 5 */ "Gebieter, deine Herzen haben sich\ndramatisch verringert. Ich rate dir,\ndringend, Heilungsmaßnahmen zu\nergreifen.\nUm dich zu unterstützen, habe ich der\n<color green<Aurasuche >coloroff>das Ziel <color yellow<Herz >coloroff>hinzugefügt.<sound 4>")
/*<  6>*/ 			story_flags[108 /* us: 805A9AE1 0x02, jp: 805ACD61 0x02 */] = true;
/*<  7>*/ 			open_dowsing_wheel(11)
/*<  8>*/ 			printf(/* textboxtype: 2, unk: 0, line: 6 */ "Halte (C) gedrückt und wähle im\nAuswahlmenü <color yellow<Herz >coloroff>aus, um das\nZiel der Aurasuche zu ändern.<0x10011:0x06cd>\n\nIch hoffe, diese Funktion ist nützlich\nfür dich, Gebieter.")
/*< 12>*/ 			switch (story_flags[226 /* us: 805A9AF2 0x08, jp: 805ACD72 0x08 */]) {
          			  case 0:
/*< 13>*/ 				printf(/* textboxtype: 2, unk: 0, line: 7 */ "Da du das Spiel im <color red<Helden-Modus>coloroff>\nspielst, erscheinen keine Herzen\noder Herz-Blumen.\n\nSolltest du jedoch eine <color yellow<Herz-Medaille>coloroff>\ntragen, <color red<besteht eine geringe Chance>coloroff>,\ndass dennoch <sound 4>Herzen oder Herzblumen\nerscheinen.")
          			  case 1:
          			}
          		}
          	  case 1:
...
/*< 14>*/ 			switch (adventure_pouch_has(8 0x0008)) {
          			  ...
          			  case 1:
          				flw_11:
/*< 11>*/ 				printf(/* textboxtype: 2, unk: 0, line: 1 */ "Da du das Spiel im <color red<Helden-Modus>coloroff>\nspielst, erscheinen keine Herzen\noder Herz-Blumen.\n\nDu musst Herztränke nutzen, um deine\nHerzen wieder aufzufüllen.")
          			}
          		  case 1:
          			goto flw_11
          		}
