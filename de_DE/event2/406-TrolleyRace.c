...
/*< 59>*/ 								printf("Die Strecke für Experten?\nWie du willst. Viel Glück!")
...
/*< 21>*/ 				switch (zone_temp_flags[0 /* 0x1 01 */]) {
          				  case 0:
/*< 30>*/ 					printf("Na, habe ich dich etwa neugierig\ngemacht?\n[1]Sicher![2-]Nicht\nwirklich...")
          					flw_19:
/*< 19>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_110:
/*<110>*/ 						{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3332, 'next': 38, 'param3': 13}
/*< 38>*/ 						printf("Versuche so schnell wie möglich\nzur Ziellinie zu gelangen. Neige\ndie Wii-Fernbedienung, um die\nBalance deiner Lore zu halten.\nNeigst du deine Lore in Kurven, nimmt\ndeine Geschwindigkeit zu! Pass aber\nauf, dass deine Lore nicht entgleist!")
...
/*< 36>*/ 						printf("Ich versteh dich nicht. Es kann doch\nnicht schaden, wenn ich dir die Regeln\nerkläre!")
...
/*< 50>*/ 								printf("Schau jederzeit wieder vorbei, wenn du\neine wilde Fahrt in einer Lore erleben\nmöchtest!")
...
/*< 78>*/ 								switch (story_flags[667 /* us: 805A9B1E 0x02, jp: 805ACD9E 0x02 */]) {
          								  case 0:
/*<122>*/ 									printf("Ich habe einen ganz besonderen Preis\nfür dich!")
/*< 76>*/ 									give_item(64 0x40);
          									goto flw_68
          								  case 1:
/*<121>*/ 									printf("Für dich habe ich etwas ganz\nBesonderes! Einen Schatz,\nder von dieser Insel stammt!")
...
/*< 28>*/ 			printf("In den Loren zu fahren macht so viel\nSpaß! Eines Tages will ich das auch\nmal machen!")
          		  case 1:
