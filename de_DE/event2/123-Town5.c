...
/*< 62>*/ 				switch (choice(2)) {
          				  case 0:
/*< 64>*/ 					printf("\x0E\x01\x09\x04\x0D\xF0ASchau... Schau mich nicht so an,\n<r<Schatz>>! Du machst mich ja ganz\nverlegen...")
          					flw_66:
...
/*< 69>*/ 						printf("\x0E\x01\x09\x04\x0F\xF0DAch, sag es nicht so laut!\nDu machst mich ja ganz wild!")
          				  ...
          				  case 1:
/*< 65>*/ 					printf("\x0E\x01\x09\x04\x0D\xF0AAh, ich bin so glücklich, wenn du bei\nmir bist!")
          					goto flw_66
          				}
          			}
          		  case 1:
...
/*<110>*/ 								switch (choice(3)) {
          								  case 0:
/*<111>*/ 									printf("\x0E\x01\x09\x04\x08\x08Auch ich habe dir viel zu sagen,\naber im Augenblick ist es wirklich\netwas ungünstig...\nKomm demnächst wieder!")
          								  case 1:
/*<112>*/ 									printf("\x0E\x01\x09\x04\x08\xA00Du klingst ja schon fast wie\nein Ehemann! Fang bitte nicht so an,\nSchatz, das ist unromantisch!")
          								  case 2:
...
/*<335>*/ 										{'type': 'type3', 'subType': 1, 'param1': 3, 'param2': -1, 'next': -1, 'param3': 42}
          									  case 1:
          										flw_310:
/*<310>*/ 										printf("\x0E\x01\x09\x04\x0F\x1214Nun gut! Das denkst du also, ja?\nIch verstehe...\n\n\nTut mir leid, dass ich dich derart\nbelästigt habe.")
...
/*<399>*/ 	start()
/*<381>*/ 	printf("\x0E\x01\x09\x04\x1F0A\x309Das war ganz besonders teuer! Etwa\n<r<30 Rubine>> wirst du mir dafür wohl\ngeben müssen. Tja, das hast du nun\ndavon, du Rabauke!")
/*<382>*/ 	switch (random(4)) {
          	  case 0:
...
/*<  8>*/ 						switch (zone_temp_flags[1 /* 0x1 02 */]) {
          						  case 0:
/*< 15>*/ 							printf("\x0E\x01\x09\x04\x08\xD01Willst du mir nicht ein wenig\nbeim Putzen helfen? Du weißt doch,\nwie ungern ich das mache...\n\n\x0E\x01\x09\x04\n\x900Ich gebe dir auch ein schönes\nTaschengeld... Da kannst du nicht\nablehnen, oder?\n\n[1]Ist gut...[2-]Doch!")
          							flw_2:
/*<  2>*/ 							switch (choice(2)) {
          							  case 0:
...
/*< 23>*/ 	printf("Wie oft habe ich dir das schon gesagt,\nMutter?")
/*<180>*/ 	set_camera(7, 0)
...
/*< 25>*/ 	printf("Jetzt reg dich doch nicht so auf, mein\nkleiner Schatz!")
...
/*<427>*/ 				zone_temp_flags[2 /* 0x1 04 */] = true;
          		  ...
          		  case 1:
/*<421>*/ 			printf("Wie, du hast überhaupt keine\nRubine?!?\n\n\nMachst hier alles kaputt und kannst\nmich nicht mal dafür entschädigen?\nVerschwinde, aber dalli!")
