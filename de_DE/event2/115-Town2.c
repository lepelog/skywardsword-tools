...
/*<574>*/ 								{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': -1, 'next': -1, 'param3': 42}
          							  case 1:
          								flw_410:
/*<410>*/ 								printf("\x0E\x01\x09\x04\x0F\x0CNa gut. Komm wieder, wenn du es dir\nanders überlegt hast.")
          							}
          						  case 1:
...
/*<441>*/ 		switch (choice(2)) {
          		  case 0:
/*<440>*/ 			printf("\x0E\x01\x09\x04\x0F\x409So, du möchtest also einkaufen.\nWürde es dir etwas ausmachen, dazu\nmorgen in meinen Laden zu kommen?")
          		  case 1:
/*<439>*/ 			printf("\x0E\x01\x09\x04\x13\x609\x201EÄh\x201C bedeutet, dass du eigentlich gar \nkeinen Grund hast, hier zu sein, oder?")
...
/*<428>*/ 				story_flags[297 /* us: 805A9AFD 0x08, jp: 805ACD7D 0x08 */] = true;
          				goto flw_495
          			  case 1:
/*<435>*/ 				printf("\x0E\x01\x09\x04\x0F\x409Das hättest du ja auch gleich am\nAnfang sagen können.")
          				goto flw_434
          			}
          		}
          	}
...
/*<450>*/ 											printf("\x0E\x01\x09\x04\x03\xFF04Ich freue mich ja so! Es kribbelt, als\nhätte ich Ameisen in der Hose!\n\n\nDanke, Link!\nBitte weiter so!")
          										  case 1:
          											flw_473:
...
/*<722>*/ 				printf("Und, welche Insekten möchtest du mir\ndenn heute verkaufen?")
...
/*< 16>*/ 						story_flags[386 /* us: 805A9B0D 0x10, jp: 805ACD8D 0x10 */] = true;
          					  case 1:
/*< 14>*/ 						printf("\x0E\x01\x09\x04\x10\xF04Ah, du weißt Bescheid. Genau, die\n<y<Rassel>>.")
          						goto flw_15
          					}
          				  case 1:
/*< 25>*/ 					printf("\x0E\x01\x09\x04\x10\xF07Das hört man doch, oder?")
          		  ...
          		  case 1:
          			flw_9:
/*<  9>*/ 			printf("\x0E\x01\x09\x04\x00\x03Uhuhuhu, dieses Kind will\neinfach nicht schlafen...\nWas mache ich nur...\n[1]Schlimm...[2]Und die Mama?")
/*<127>*/ 			switch (choice(2)) {
          			  case 0:
...
/*<256>*/ 		switch (story_flags[389 /* us: 805A9B0D 0x80, jp: 805ACD8D 0x80 */]) {
          		  case 0:
/*<257>*/ 			printf("\x0E\x01\x09\x04\x07\x1602Ich werde alles geben, um stärker zu\nwerden! Komm bald mal wieder und\nsieh dir an, was ich erreicht habe!")
          		  case 1:
...
/*< 59>*/ 			printf("\x0E\x01\x09\x04\x00\x02Link!\nHast du ihr meinen Brief gegeben...\n[1]Ja, also...[2]Na ja...")
/*< 60>*/ 			switch (choice(2)) {
          			  case 0:
...
/*<812>*/ 						printf("\x0E\x01\x09\x04\x0B\x400Ich bin sicher, dass du irgendwie\nVerwendung dafür finden wirst.\nNoch mal vielen Dank!")
...
/*<836>*/ 				printf("\x0E\x01\x09\x04\x0D\x400Mein Schwesterchen wollte sich diese\n<b<bunte, runde Insel>> ansehen. Das heißt,\nsie müsste irgendwo im <r<Südwesten>> sein.")
/*<837>*/ 				{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': 100, 'next': 838, 'param3': 17}
/*<838>*/ 				printf("\x0E\x01\x09\x04\x01\x400Bitte such mein Schwesterchen für\nmich, Link!")
          			}
          		  case 1:
...
/*<219>*/ 					story_flags[380 /* us: 805A9B0A 0x40, jp: 805ACD8A 0x40 */] = true;
          					goto flw_199
          				  case 1:
/*<197>*/ 					printf("\x0E\x01\x09\x04\x00\x411Link, kannst du vielleicht\nnach ihr suchen?")
/*<831>*/ 					make_actor_do_something(0, 0)
/*<832>*/ 					printf("\x0E\x01\x09\x04\x0D\x400Sie hat gesagt, dass diese <b<bunte runde\nInsel >>sie interessiert, also ist sie wohl\nnach <r<Südwesten >>geflogen.\n")
...
/*<765>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*<766>*/ 		printf("\x0E\x01\x09\x04\x0B\x409Es heißt, die Insel der Göttin sei\nverschwunden! Wie entsetzlich!\n\n\n\x0E\x01\x09\x04\n\x400Das bedeutet nichts Gutes!")
          		flw_790:
...
/*<810>*/ 		switch (story_flags[22 /* us: 805A9ADB 0x40, jp: 805ACD5B 0x40 */]) {
          		  case 0:
/*<811>*/ 			printf("\x0E\x01\x09\x04\x00\x01Es hat sich angehört, als hätte sich die\nErde bewegt... Was das nur war?")
          			goto flw_790
          		  case 1:
/*<774>*/ 			switch (story_flags[209 /* us: 805A9AF0 0x20, jp: 805ACD70 0x20 */]) {
          			  case 0:
/*<775>*/ 				printf("\x0E\x01\x09\x04\x00\x01Was hast du auf dem Marktplatz\ngemacht? Es ist plötzlich so dunkel\ngeworden.")
          				goto flw_790
          			  case 1:
...
/*<208>*/ 				switch (choice(2)) {
          				  case 0:
          					flw_210:
/*<210>*/ 					printf("\x0E\x01\x09\x04\x0B\x409Danke! Damit kann ich meinen Vogel\nversorgen!")
...
/*<805>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*<806>*/ 		printf("\x0E\x01\x09\x04\x0C\x456Von draußen war ein Riesenlärm zu\nhören, da muss wohl irgendwas\npassiert sein...")
          	  case 1:
...
/*<748>*/ 							switch (story_flags[194 /* us: 805A9AEC 0x10, jp: 805ACD6C 0x10 */]) {
          							  case 0:
/*<756>*/ 								printf("\x0E\x01\x09\x04\x00\x13Was war denn da eben los? Der ganze\nHimmel wurde einen Augenblick lang\nkomplett in Dunkelheit gehüllt...")
          							  case 1:
...
/*<168>*/ 			printf("Ich vertraue dir meinen Brief an. Und\nwehe, du liest auch nur ein Wort!")
...
/*< 47>*/ 		switch (choice(2)) {
          		  case 0:
/*< 49>*/ 			printf("\x0E\x01\x09\x04\x0B\x04Oh...\nPapier? Für mich?\nIch bin so glücklich...")
...
/*<363>*/ 	printf("Du hast mir diesen Brief geschrieben,\noder?")
