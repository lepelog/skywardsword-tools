...
/*<132>*/ 				switch (story_flags[371 /* us: 805A9B02 0x02, jp: 805ACD82 0x02 */]) {
          				  case 0:
/*<193>*/ 					printf(/* textboxtype: 1, unk: 0, line: 8 */ "Tja...")
/*<194>*/ 					printf(/* textboxtype: 1, unk: 0, line: 7 */ "Also hat sich unser lieber Wahrsager\ntatsächlich in seinem Haus verkrochen.\n\n\nWenn doch nur jemand für ihn eine\nneue Kristallkugel auftreiben würde...")
          					flw_129:
/*<129>*/ 					story_flags[834 /* us: 805A9B32 0x04, jp: 805ACDB2 0x04 */] = true;
          				  case 1:
/*<131>*/ 					printf(/* textboxtype: 1, unk: 0, line: 5 */ "Wie wäre es, wenn du mal nach dem\nWahrsager siehst?\n\n\nSein Haus liegt <color red<im östlichen Teil des\nWolkenhorts>coloroff>.")
          					goto flw_129
          				}
          			}
          		  case 1:
...
/*<114>*/ 	set_camera(7, 0)
/*<113>*/ 	printf(/* textboxtype: 1, unk: 0, line: 61 */ "<0x10009:0x22000002>Das ist es doch, was du denkst, oder\netwa nicht, <heroname>?")
          }
...
/*<164>*/ 					printf(/* textboxtype: 1, unk: 0, line: 11 */ "Ich habe da so ein Gerücht gehört.\n<color red<Nachts>coloroff> erklingt beim <color red<Wohnheim >coloroff>der\nRitterschule die Stimme einer Frau!\n\nIch mag zwar aussehen wie ein starker\nKerl, aber solche Geschichten treiben\nmir den Angstschweiß auf die Stirn!")
          				}
          			}
          		  case 1:
          			flw_137:
...
/*< 64>*/ 	printf(/* textboxtype: 1, unk: 0, line: 62 */ "<0x10009:0x12110016>Bis<pause 15> zum nächsten Mal!")
...
/*< 19>*/ 	switch (choice(2)) {
          	  case 0:
/*< 20>*/ 		printf(/* textboxtype: 1, unk: 0, line: 22 */ "Der Schmutzfink, der sich tagtäglich in\nder Werkstatt die Kleidung schmutzig\nmacht! Du kennst ihn doch?")
          		goto flw_85
          	  case 1:
/*< 21>*/ 		printf(/* textboxtype: 1, unk: 0, line: 23 */ "Dieser Junge bringt mich noch um den\nVerstand! So ein Dreckspatz!")
          		goto flw_85
          	}
          }
...
/*< 95>*/ 		switch (scene_flags[45 /* 0x4 20 */]) {
          		  case 0:
/*< 94>*/ 			printf(/* textboxtype: 1, unk: 0, line: 71 */ "<0x10009:0x00001101>Solltest du dich nicht auf die Socken\nmachen und schleunigst deinen roten\nWolkenvogel suchen?")
          		  case 1:
/*< 93>*/ 			printf(/* textboxtype: 1, unk: 0, line: 70 */ "<0x10009:0x00001104>Was war das denn eben für ein Streit\ndort drüben? Das schien ja eine recht\nernste Sache zu sein...")
          		}
          	  case 1:
...
/*< 60>*/ 		printf(/* textboxtype: 1, unk: 0, line: 36 */ "<0x10009:0x00000012>Oh nein, ich konnte Kuki immer noch\nnicht finden!\n\n\nIch bitte dich, finde meine kleine Kuki\nso schnell du nur kannst!")
          	  case 1:
/*< 32>*/ 		printf(/* textboxtype: 1, unk: 0, line: 35 */ "<0x10009:0x00000001>Huch! Was kann ich so spät abends für\ndich tun?")
          	}
          }
...
/*<107>*/ 	start()
/*<110>*/ 	set_camera(6, 0)
/*<108>*/ 	printf(/* textboxtype: 1, unk: 0, line: 74 */ "Es tut mir leid, aber die Essenszeit ist\nschon vorüber. Du musst wohl bis zum\nMittagessen warten.")
          }
...
/*<184>*/ 	set_camera(9, 0)
/*<181>*/ 	printf(/* textboxtype: 1, unk: 0, line: 76 */ "<0x10009:0x070a0c12>Hmmm... <0x10008:0xfecd>Wo ist sie bloß hin...")
          }
...
/*<152>*/ 	switch (temp_flags[52 /* 0x7 10 */]) {
          	  case 0:
/*<153>*/ 		printf(/* textboxtype: 1, unk: 0, line: 54 */ "Es würde mich freuen, wenn du mir\nwieder einmal Gesellschaft leisten\nwürdest.")
          	  case 1:
/*<141>*/ 		printf(/* textboxtype: 1, unk: 0, line: 50 */ "Hi hi hi hi... Na, kleiner Mann? Du\nscheinst dich ja mächtig ins Zeug zu\nlegen. Soll ich dich auf ein Getränk\neinladen?\n[1-]Gerne![2]Nein, danke.")
/*<142>*/ 		switch (choice(2)) {
          		  case 0:
/*<144>*/ 			printf(/* textboxtype: 1, unk: 0, line: 52 */ "<0x10009:0x00010700>Das wollte ich hören! Also dann, hoch\ndie Tassen, Jungspund!")
