...
/*<183>*/ 	start()
/*<184>*/ 	printf("Wenn du auf deinem Wolkenvogel reitest,\ndrücke jederzeit \x0E\x02\x04\x02\x13CD, um dir die <r<Steuerung\n>>anzeigen zu lassen.\x0E\x01\x11\x02\xBCD\n\nAußerdem kannst du <g<angreifen>>, wodurch du\nauch <r<kurz beschleunigst>>. <r<Langsamer werden\n>>kannst du natürlich auch. Probier alles\neinfach mal aus!")
...
/*<223>*/ 	start()
/*<224>*/ 	printf("\x0E\x03\x01\x00Link!\nFalls du <r<schneller fliegen >>möchtest...\n\n\nGewinne erst etwas an Höhe, und wenn du\n<r<hoch >>genug bist, geh in den Sturzflug!\nAufsteigen und dann in den Sturzflug!\nSo gewinnt man Tempo!")
          }

          void entrypoint_102_01() {
          	start()
/*<199>*/ 	{'type': 'type3', 'subType': 4, 'param1': 0, 'param2': 26, 'next': 1, 'param3': 13}
/*<  1>*/ 	printf("Ich komme, sobald sich mein Vogel ein\nwenig ausgeruht hat, Link.\n\n\n\x0E\x01\x09\x04\x00\x500Frag doch mal die anderen, ob sie nicht\netwas über deinen Wolkenvogel wissen.")
          }
...
/*<  3>*/ 	printf("Da bist du ja, Link...\n\n\n\n\x0E\x01\n\x04\x17ÍIch habe gehört, dass du auf dem Weg\nzum Wasserfall bist, und dich von der\nLuft aus gesucht.\n\nUnd? Hast du deinen Wolkenvogel gefunden?")
/*< 76>*/ 	printf("\x0E\x01\x09\x04\x100\x514Hm...\n\n\n\n\x0E\x01\x09\x04\x100\xC00Bado und seine Kumpels sollen sich oft\ndort hinten herumtreiben. Gehen wir!")
/*<138>*/ 	set_camera(22, 0)
...
/*<170>*/ 	set_camera(25, 0)
/*<171>*/ 	printf("\x0E\x01\x09\x04\x100\x1500Wer...?\n\n\n\n\x0E\x01\x09\x04\x100\x1500Wer ruft da?")
/*<139>*/ 	set_camera(24, 0)
/*<141>*/ 	{'type': 'type3', 'subType': 4, 'param1': 268, 'param2': 5376, 'next': 136, 'param3': 13}
/*<136>*/ 	printf("Oh... Tut mir leid... Ich war kurz abgelenkt...\nGehen wir!")
...
/*<  5>*/ 	printf("Da ist er ja!")
/*< 21>*/ 	set_camera(2, 0)
/*< 14>*/ 	printf("\x0E\x01\x09\x04\x09\x500\x0E\x01\x08\x02\x1CDDein Wolkenvogel!")
...
/*< 73>*/ 	switch (scene_flags[3 /* 0x1 08 */]) {
          	  case 0:
/*< 74>*/ 		printf("\x0E\x01\x09\x04\x00\x1514Das ging wohl daneben...\n\n\n\n\x0E\x01\x09\x04\x00\xC00<g<Neige>> im <r<Flug>> deinen Körper, um deinen Fall\nauszubalancieren und die Richtung\nzu bestimmen.\n\nVersuchen wir es noch einmal!\nDiesmal schubse ich dich nicht, also nimm all\ndeinen Mut zusammen und spring!\n\n<g<Sprinte>> über die Plattform, um abzuspringen.\nUnd vergiss nicht, vor der Landung \x0E\x02\x04\x02\x29CD\ngedrückt zu halten!\x0E\x01\x11\x02\xFCD\n\nVersuche, genau in der <r<Mitte des runden\nReliefs >>zu landen!")
...
/*< 10>*/ 		switch (story_flags[39 /* us: 805A9AE5 0x20, jp: 805ACD65 0x20 */]) {
          		  case 0:
/*<173>*/ 			printf("\x0E\x01\x09\x04\x00\x04Dann versuchen wir es noch einmal!\nDiesmal schubse ich dich nicht, also nimm all\ndeinen Mut zusammen und spring!\n\n<g<Sprinte>> über die Plattform, um abzuspringen.\n\n\n\nVergiss nicht, vor der Landung \x0E\x02\x04\x02\x29CD zu drücken,\num den Paraschal zu öffnen!\x0E\x01\x11\x02\xFCD Und versuche,\ngenau in der <r<Mitte des runden Reliefs\n>>zu landen!")
          		  case 1:
/*<  8>*/ 			switch (story_flags[26 /* us: 805A9ADA 0x04, jp: 805ACD5A 0x04 */]) {
          			  case 0:
/*<  9>*/ 				printf("\x0E\x01\x09\x04\x0F\x513Wie schrecklich...\n\n\n\n\x0E\x03\x01\x00Link!\nKannst du diese Bretter vor der Höhle nicht\nirgendwie entfernen?")
          			  case 1:
/*<  7>*/ 				printf("\x0E\x01\x09\x04\x00\x06Worauf wartest du, Link?\nSchnell!")
          			}
          		}
          	}
          }
...
/*< 23>*/ 	printf("\x0E\x01\x09\x04\x0C\xE09Dein Wolkenvogel ist einfach unglaublich,\nund das nach all dem, was er heute schon\ndurchmachen musste!\n\n\x0E\x01\x09\x04\x00\xC00Ich werde nun meinem Vater berichten.")
/*< 64>*/ 	set_camera(10, 0)
...
/*< 24>*/ 	printf("\x0E\x01\x09\x04\x400\x04Hey! \x0E\x03\x01\x00Link!")
/*<146>*/ 	set_camera(9, 0)
/*< 94>*/ 	{'type': 'type3', 'subType': 4, 'param1': 1038, 'param2': 11776, 'next': 145, 'param3': 13}
/*<145>*/ 	printf("\x0E\x01\x09\x04\x400\x00Ach, du hast dein Federvieh gefunden?\n\n\n\n\x0E\x01\n\x04\x0BÍWir haben hier seit dem Morgen geübt.\nWarum kriegt ein Nichtskönner wie du\neigentlich immer eine Extrawurst, hä?")
/*< 95>*/ 	set_camera(12, 0)
/*< 96>*/ 	{'type': 'type3', 'subType': 4, 'param1': 1035, 'param2': 12606, 'next': 25, 'param3': 13}
/*< 25>*/ 	printf("Und jetzt tauchst du hier auch noch mit\nZelda auf...\n\n\nAllein traust du dich wohl nicht, was?\n\n\n\n\x201EUuuh, Zeldalein und ich sind schon seit\nunserer Kindheit gute Freunde...\x201C\n\n\n\x0E\x01\x06\x02\xFCCD...\x0E\x01\x06\x02Í\x0E\x01\x09\x04\x400\x17Da bildest du dir mächtig was drauf ein,\nstimmt's?<pause3C> \x0E\x01\x09\x04\x40B\xAFFSo ist es doch, oder?")
/*< 65>*/ 	set_camera(13, 0)
/*< 46>*/ 	{'type': 'type3', 'subType': 1, 'param1': 5, 'param2': 6, 'next': 48, 'param3': 16}
/*< 48>*/ 	{'type': 'type3', 'subType': 1, 'param1': 6, 'param2': 5, 'next': 26, 'param3': 17}
/*< 26>*/ 	printf("\x0E\x01\x09\x04\x500\x0EBado redet die ganze Zeit davon, dass er Zelda\nheiraten wird und sie dann für immer\nzusammen sind...")
/*< 47>*/ 	{'type': 'type3', 'subType': 1, 'param1': 6, 'param2': 5, 'next': 27, 'param3': 16}
/*< 27>*/ 	printf("\x0E\x01\x09\x04\x600\x14Hihihi...")
/*< 50>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': 100, 'next': 66, 'param3': 17}
/*< 66>*/ 	set_camera(12, 0)
/*< 49>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': -1, 'next': 28, 'param3': 16}
/*< 28>*/ 	printf("\x0E\x01\x09\x04\x40D\xB00Ha!\n\n\n\n\x0E\x01\x09\x04\x400\xB00Der Sieger der Zeremonie, und das werde\nnatürlich ich sein, erhält von der Vertreterin\nder Göttin, also Zelda, den <y<Paraschal>>!\n\nUnd niemals werde ich zulassen, dass jemand\nanderes mir dieses Geschenk wegschnappt.\nEs ist von ihr selbst gemacht!!!")
/*< 63>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': 5, 'next': 29, 'param3': 17}
/*< 29>*/ 	printf("\x0E\x01\x09\x04\x404\x1700Den Paraschal, den sie selbst getragen hat...\nin meiner Hand... er riecht bestimmt toll...\nHach...\n\nUnd dann noch die Zeremonie für den Sieger\nauf der Statue der Göttin...\n\n\nNur wir beide...\nUngestört...\nZelda und ich, ganz allein da oben...")
/*<107>*/ 	set_camera(17, 0)
/*<108>*/ 	{'type': 'type3', 'subType': 4, 'param1': 1048, 'param2': 5644, 'next': 109, 'param3': 13}
/*<109>*/ 	printf("He... Hehehe...\n\n\n\nTihihihi...")
...
/*< 90>*/ 	set_camera(19, 0)
/*< 33>*/ 	printf("Wir beide, wie? \x201EGanz allein\x201C, ja?")
/*< 68>*/ 	set_camera(15, 0)
/*< 55>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': 100, 'next': 34, 'param3': 16}
/*< 34>*/ 	printf("\x0E\x01\x09\x04\x4FF\xFF0DÖh... Äh... Ja...\n\n\n\n\x0E\x01\x09\x04\x400\x00Ja, also, Link!\nGut, dass du deinen Vogel gefunden hast!\nDas wird ein guter, ehrlicher Wettkampf!")
/*< 87>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': 0, 'next': 86, 'param3': 17}
/*< 86>*/ 	printf("\x0E\x01\x09\x04\x400\x00Bis dann, Zelda!\nUnd bei der Zeremonie immer schön auf mich\nschauen, ja? Ich bin der, der fliegen kann...")
...
/*< 98>*/ 	set_camera(18, 0)
/*< 35>*/ 	printf("\x0E\x01\x09\x04\x505\x13\x0E\x01\x09\x04\x607\x00Hey, Bado!\nWarte auf uns!\x0E\x01\x05\x04\x14\x00")
...
/*< 69>*/ 	set_camera(16, 0)
/*< 36>*/ 	printf("\x0E\x01\x09\x04\x09\x1014\x201EEin guter, ehrlicher Wettkampf\x201C?\nDa hätte ich einiges dazu zu sagen!\n\n\n\x0E\x01\x09\x04\x00\xFF00\x0E\x03\x01\x00Link, kümmer dich nicht darum,\nwas sie sagen. Gib heute dein Bestes, ich glaube\nan dich! Versprichst du mir, zu gewinnen?\n[1]Klar![2]Öhm...[3]Nur wir zwei?")
/*< 57>*/ 	switch (choice(3)) {
          	  case 0:
/*< 37>*/ 		printf("\x0E\x01\x09\x04\x0C\xE00Genau!\nMit dieser Einstellung kannst du nur\ngewinnen, Link!")
          		flw_101:
...
/*< 40>*/ 		printf("Die Vogelreiter-Zeremonie beginnt!\nDie auserwählten Schüler bitte zum Start!")
/*< 59>*/ 		{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': 100, 'next': 41, 'param3': 16}
/*< 41>*/ 		printf("Also dann, Link!\nBis gleich!")
/*< 70>*/ 		changeScene(18, 0) // 
          	  case 1:
/*< 38>*/ 		printf("\x0E\x01\x09\x04\x0C\x1500Streng dich an, dann wird das schon.\nHab ein wenig Selbstvertrauen!")
          		goto flw_101
          	  case 2:
/*< 39>*/ 		printf("\x0E\x01\x09\x04\x10\xE04Bitte?!? Das hätte ich nicht von dir\ngedacht, Link!")
          		goto flw_101
          	}
          }
...
/*< 82>*/ 	start()
/*< 83>*/ 	printf("Nach der ganzen Aufregung sollten wir noch\neinmal alles durchgehen. Fühlst du dich bereit\nzu fliegen, Link?")
/*< 84>*/ 	printf("Du kannst deinen Wolkenvogel frei bewegen,\nbeachte jedoch, dass er langsamer wird, wenn\ndu ihn nach oben lenkst.\n\nFalls du <r<schneller fliegen >>möchtest, musst du\nihn dennoch nach oben steuern, um <r<Höhe>> zu\ngewinnen, nur um danach in den Sturzflug\nüberzugehen!\nBeständig an Höhe gewinnen und dann in den\nSturzflug gehen! Das ist die Grundlage für\nschnelles Fliegen.")
/*< 85>*/ 	printf("Und? Ist mit deinem Wolkenvogel alles\nin Ordnung?")
...
/*< 88>*/ 	start()
/*< 89>*/ 	printf("\x0E\x03\x01\x00Link, ich hatte schon das\nSchlimmste befürchtet, aber dein Wolkenvogel\nscheint in Ordnung zu sein!\n\nVater und die anderen warten sicher schon,\nbeeilen wir uns!")
          }
...
/*<180>*/ 	start()
/*<204>*/ 	set_camera(30, 0)
/*<189>*/ 	printf("Zeldas Tagebuch...\nMöchtest du es lesen?\n[1]Ja[2-]Nein")
/*<190>*/ 	switch (choice(2)) {
          	  case 0:
/*<187>*/ 		printf("Morgen ist die <r<Vogelreiter-Zeremonie>>!\nEin weiterer Schritt auf dem Weg zum Ritter\nfür Link.\n\nIch kann es nicht erwarten, ihn endlich als\nRitter zu sehen.\n\n\nAber in letzter Zeit hat er gar nicht\nmehr geübt...\n\n\nIch werde morgen sehr früh aufstehen und\nihn zum Üben zwingen!\n\n\nEr muss unbedingt gewinnen, ich will die\nSiegeszeremonie nur mit ihm feiern!")
          	  case 1:
/*<188>*/ 		printf("Du liest das Tagebuch nicht.")
          	}
          }
