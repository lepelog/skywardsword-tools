...
/*< 13>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 12>*/ 		printf(/* textboxtype: 2, unk: 4, line: 26 */ "Da sind wir, <heroname>!\nAlso los, auf geht's!")
/*< 15>*/ 		set_camera(10, 0)
...
/*< 18>*/ 				printf(/* textboxtype: 4, unk: 2, line: 16 */ "Wenn du das <color yellow<Seelengefäß>coloroff> mit 15 <color yellow<Tränen\n>coloroff>gefüllt hast, <0x10012:0x00000002>Gebieter, wird deine Seele\nwachsen, und die Göttin wird dich stärken.\n\nIch werde in der äußeren Welt auf dich\nwarten, <0x10012:0x00000002>Gebieter.")
...
/*<  6>*/ 			printf(/* textboxtype: 2, unk: 4, line: 2 */ "Bringe das <color yellow<Seelengefäß>coloroff> zurück, wenn es\ngefüllt ist, und deine Seele wird wachsen,\n<0x10012:0x00000002>Gebieter. Als Lohn wird dich die Göttin\nmit <color red<neuer Kraft>coloroff> beschenken.\nHast du noch Fragen an mich?\n[1-]Ja![2]Nein, ich\nbin bereit.")
/*< 10>*/ 			switch (choice(2)) {
          			  case 0:
...
/*< 51>*/ 				switch (choice(4)) {
          				  case 0:
/*< 52>*/ 					printf(/* textboxtype: 4, unk: 2, line: 7 */ "<0x10012:0x00000005>Gebieter, höre meine Antwort...\n\n\n\nFülle das <color yellow<Seelengefäß>coloroff>, indem du <color yellow<Dins Tränen\n>coloroff>aufsammelst.")
/*< 59>*/ 					set_camera(2, 0)
/*< 58>*/ 					{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': 0, 'next': 56, 'param3': 40}
/*< 56>*/ 					printf(/* textboxtype: 2, unk: 4, line: 8 */ "Was dort funkelt...")
/*< 55>*/ 					set_camera(3, 0)
...
/*< 64>*/ 					set_camera(6, 0)
/*< 66>*/ 					printf(/* textboxtype: 2, unk: 4, line: 11 */ "Solltest du auch nur einen Schritt vom rechten Weg\nabkommen, werden dich die <color red<Hüter>coloroff> verfolgen,\n<0x10012:0x00000002>Gebieter.")
/*< 63>*/ 					set_camera(4, 0)
/*< 65>*/ 					printf(/* textboxtype: 2, unk: 2, line: 12 */ "Ein einziger Treffer der <color red<Hüter>coloroff> wird deine Seele aus\nder Fassung bringen, und deine Prüfung wird zu Ende\nsein, <0x10012:0x00000002>Gebieter.")
/*< 62>*/ 					set_camera(5, 0)
/*< 61>*/ 					printf(/* textboxtype: 4, unk: 2, line: 13 */ "Sammle die <color yellow<Tränen>coloroff>, ohne dich angreifen zu lassen,\nund fülle das <color yellow<Seelengefäß>coloroff>.")
          					goto flw_77
          				  case 2:
...
/*< 69>*/ 					printf(/* textboxtype: 2, unk: 4, line: 14 */ "Über die ganze Gegend sind glitzernde Flächen\nverstreut, die <color red<Alatraumata >coloroff>genannt werden...\n\n\nTrittst du auf sie, so <color red<werden dich die Hüter\nsofort entdecken>coloroff>.\n\n\nPass also auf, wohin du deine Schritte setzt.")
          				  ...
          				  case 3:
          					flw_70:
/*< 70>*/ 					printf(/* textboxtype: 2, unk: 4, line: 5 */ "Sehr wohl, <0x10012:0x00000005>Gebieter.")
/*< 71>*/ 					set_camera(10, 0)
