...
/*< 25>*/ 	start()
/*< 26>*/ 	printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10012:0x00000001>Ich schlage vor, dass du zurück ins Wolkenmeer reist\nund den Mogma an seinen Zielort bringst.")
...
/*< 30>*/ 	start()
/*< 31>*/ 	printf(/* textboxtype: 0, unk: 1, line: 13 */ "<0x10012:0x00000064>Du hast ja gehört, was die verehrte\nPhai gesagt hat...")
          }

          void entrypoint_351_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0, line: 0 */ "Du hast einen Kristall gefunden, der\ndem des Wahrsagers ähnelt. Er scheint\nsich als Kristallkugel verwenden zu\nlassen.\nSoll ich den Roboter rufen, um ihn\nabzutransportieren?\n[1-]Ja[2]Nein")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x10012:0x00000005>Sehr wohl, Gebieter. Ich werde den Roboter\nunverzüglich rufen.")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 0, unk: 2, line: 1 */ "<0x10012:0x00000005>Sehr wohl, Gebieter. Solltest du deine Meinung\nändern, untersuche das eben ausgewählte Ziel erneut.")
          	}
          }

          void entrypoint_351_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x00000064>Verehrte Phai! Ihr habt mich gerufen?\n\n\n\nDas hier soll ich abtransportieren?")
          }

          void entrypoint_351_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "Verstanden! Ich warte dann oben auf\neuch beide! Bis später!")
          }

          void entrypoint_351_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "Ich schlage vor, dass du zurück ins Wolkenmeer reist\nund den Kristall zum Wahrsager bringst, <0x10012:0x00000001>Gebieter.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10012:0x00000064>Hey, du grüner Wicht! Du machst es dir\nmal wieder leicht, während ich hier\nalles schleppen muss. Pah!")
          }
