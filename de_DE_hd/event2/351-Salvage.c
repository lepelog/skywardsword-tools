...
/*< 25>*/ 	start()
/*< 26>*/ 	printf("\x0E\x01\x12\x04\x00\x01Ich schlage vor, dass du zurück ins Wolkenmeer reist\nund den Mogma an seinen Zielort bringst.")
...
/*< 30>*/ 	start()
/*< 31>*/ 	printf("\x0E\x01\x12\x04\x00dDu hast ja gehört, was die verehrte\nPhai gesagt hat...")
          }

          void entrypoint_351_01() {
          	start()
/*<  1>*/ 	printf("Du hast einen Kristall gefunden, der\ndem des Wahrsagers ähnelt. Er scheint\nsich als Kristallkugel verwenden zu\nlassen.\nSoll ich den Roboter rufen, um ihn\nabzutransportieren?\n[1]Ja[2-]Nein")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf("\x0E\x01\x12\x04\x00\x05Sehr wohl, Gebieter. Ich werde den Roboter\nunverzüglich rufen.")
          	  case 1:
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x05Sehr wohl, Gebieter. Solltest du deine Meinung\nändern, untersuche das eben ausgewählte Ziel erneut.")
          	}
          }

          void entrypoint_351_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf("\x0E\x01\x12\x04\x00dVerehrte Phai! Ihr habt mich gerufen?\n\n\n\nDas hier soll ich abtransportieren?")
          }

          void entrypoint_351_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf("Verstanden! Ich warte dann oben auf\neuch beide! Bis später!")
          }

          void entrypoint_351_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf("Ich schlage vor, dass du zurück ins Wolkenmeer reist\nund den Kristall zum Wahrsager bringst, \x0E\x01\x12\x04\x00\x01Gebieter.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf("\x0E\x01\x12\x04\x00dHey, du grüner Wicht! Du machst es dir\nmal wieder leicht, während ich hier\nalles schleppen muss. Pah!")
          }
