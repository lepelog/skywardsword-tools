...
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10012:0x00000001>Ich schlage vor, dass du zurück ins Wolkenmeer reist\nund den Kyu zu jener Person bringst, die dich mit der\nSuche beauftragt hat.")
...
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf(/* textboxtype: 0, unk: 0, line: 2 */ "Sehr wohl, <0x10012:0x00000005>Gebieter. Ich werde den Roboter\nnun rufen.")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 0, unk: 2, line: 1 */ "Sehr wohl, <0x10012:0x00000005>Gebieter. Solltest du deine Meinung\nändern, untersuche dieses Wesen ein weiteres Mal.")
          	}
          }
...
/*< 20>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_21:
/*< 21>*/ 						printf(/* textboxtype: 0, unk: 1, line: 13 */ "<0x10009:0x00060007>Das ist ja wundertoll! Nimm <color blue<Kombu>coloroff>\nmit, sofort!")
...
/*< 40>*/ 						story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */] = true;
          				  ...
          				  case 1:
/*< 18>*/ 					printf(/* textboxtype: 0, unk: 1, line: 10 */ "<0x10009:0x00090013>Es gibt bestimmt immer noch viele\nFieslinge überall.\n\n\n<0x10009:0x00070004>Das Leben der Kyu ist ein Leben in\nAngst. Das wird sich niemals ändern.")
          					goto flw_19
          				}
          			  case 1:
