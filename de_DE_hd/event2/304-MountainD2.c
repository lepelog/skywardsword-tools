...
/*< 58>*/ 	switch (scene_flags[107 /* 0xC 08 */]) {
          	  case 0:
/*< 63>*/ 		printf("\x0E\x01\x09\x04\x0C\xE09Dies ist die Legende der Ruine, die man sich\nunter uns Mogma erzählt...\n\n\n\x201EAm Eingang zum Schatz des Königs\n<r<betrachten sich zwei Statuen>>...\x201C\n\n\n\x201E<r<Spring in den Mund der schlafenden Statue>>,\nbeweise deinen Mut, und der Weg wird\nsich öffnen.\x201C\n\n\x0E\x01\x09\x04\x09\x908Ich weiß nicht, ob man dieser alten Legende\ntrauen kann, aber ich werde das prüfen!")
          	  case 1:
/*< 98>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 99, 'param3': 49}
/*< 99>*/ 		printf("\x0E\x01\x0B\x04\x00\x3F4\x0E\x01\x09\x04ÿ\xFF02Uhuhu...\nEndlich draußen!")
...
/*< 82>*/ 	switch (zone_temp_flags[0 /* 0x1 01 */]) {
          	  case 0:
/*< 85>*/ 		printf("\x0E\x01\x09\x04\x1B\xA02Die Klauen, die ich dir gegeben habe,\nwaren ein echtes Glanzstück in\nmeiner Sammlung!")
          	  case 1:
/*< 83>*/ 		printf("\x0E\x01\x09\x04\x1B\xA01Hey, Kleiner!\nWie findest du die Klauen, die ich dir\ngegeben habe?\n\nWenn du unter der Erde bist, kannst du\n(Z) drücken, um die Oberfläche zu sehen.\x0E\x01\x11\x02\x7CD\n\n\nÜber der Erde ist es nämlich auch\nganz interessant!")
...
/*< 92>*/ 	switch (zone_temp_flags[2 /* 0x1 04 */]) {
          	  case 0:
/*< 90>*/ 		printf("\x0E\x01\x09\x04\x0F\xF09Ich werde mich hier zurückziehen,\nbis all die Ungeheuer weg sind!")
          	  case 1:
/*< 91>*/ 		printf("\x0E\x01\x09\x04\x0F\xF0BAch, du bist's!\nAlles in Ordnung?\n\n\nAn dem Ort, den ich vorhin abgesucht habe,\ngab es eine Menge Ungeheuer.\n\n\n\x0E\x01\x09\x04\x0E\xE0AIrgendwas scheinen die da gesucht zu haben...")
...
/*< 12>*/ 			printf("\x0E\x01\x09\x04\x13\x1317Ah! Ah!\n\n\n\nHey! Du sollst mir nicht zuschauen!\nGeh weg, mach schon!")
          		}
          	  case 1:
...
/*< 70>*/ 	start()
/*< 71>*/ 	printf("\x0E\x01\x06\x02\xFDCDDu kleiner Narr...\nIch bin Ghirahim, der Dunkelfürst!")
          }
...
/*< 31>*/ 	switch (scene_flags[101 /* 0xD 20 */]) {
          	  case 0:
/*< 32>*/ 		printf("\x0E\x01\x09\x04\x331B\xA05So, da wären wir!\n\n\n\nKeine Sorge, die sind nicht schmutzig!\nWaren ja auch die ganze Zeit in einer Truhe...\n\n\nDie sind was ganz Besonderes, pass also gut\nauf sie auf!")
/*< 81>*/ 		printf("\x0E\x01\x09\x04\x331B\x502Zeit zu gehen... Man sieht sich!")
          	  case 1:
/*< 15>*/ 		printf("\x0E\x01\x09\x04\x330B\x208Juchhu! Endlich in Freiheit!\n\n\n\n\x0E\x01\x09\x04\x08\xAFFIch weiß nicht, wer du bist, aber ich danke dir!\n\n\n\nUnd jetzt sag bloß, du bist ebenfalls ein\nSchatzsucher...\n[1]Klar![2]Schätze?")
/*< 16>*/ 		switch (choice(2)) {
          		  case 0:
/*<119>*/ 			printf("\x0E\x01\x09\x04\x08\x509Wusste ich's doch! Was solltest du auch\nsonst hier?")
          			flw_17:
/*< 17>*/ 			printf("Die Legende der <r<schlafenden Statuen>>...\n\n\n\nAber... Was trägst du denn da für alte\nund unansehnliche <y<Klauen>>?\n\n\nWarte mal...\n\n\n\n\x0E\x01\x09\x04\x3308\x90BGut! Als Zeichen meiner Dankbarkeit\nwerde ich für dich einen Griff in meine\ntolle Sammlung tun!\n\nWarte mal kurz!")
/*< 29>*/ 			scene_flags[15 'Eldin: Fire Sanctuary'][101 /* 0xD 20 */] = true;
          		  case 1:
/*<120>*/ 			printf("\x0E\x01\x09\x04\x08\x509Du musst dich nicht rausreden!\nEs gibt nur einen Grund, hierherzukommen...")
          			goto flw_17
          		}
          	}
          }
...
/*< 72>*/ 	start()
/*< 73>*/ 	printf("Auch mit deinem ach so legendären\nSchwert bleibst du bloß ein Kind...<pause14>\nUnd dennoch wagst du es!")
          }
...
/*<156>*/ 	set_camera(4, 0)
/*<154>*/ 	printf("\x0E\x01\x09\x04\x3311\x1208Hey!\n\n\n\nIch habe gesehen, wie du die\nUngeheuer eben fertiggemacht hast.\nDas war wirklich erste Sahne, Kleiner!\n\n\x0E\x01\x09\x04\x3311\x1213Jetzt solltest du noch was Tolles tun\nund mich hier runterholen!")
...
/*<106>*/ 	start()
/*<107>*/ 	printf("Brücke der Entscheidung\nGlaube an dich, sei mutig\nund schreite voran!")
          }
...
/*<143>*/ 			switch (choice(2)) {
          			  case 0:
/*<147>*/ 				printf("\x0E\x01\x09\x04\x331B\x2200Gut! Vergiss meine Worte nicht,\nwenn du das hier öffnest!\n")
          				flw_123:
...
/*<173>*/ 				scene_flags[15 'Eldin: Fire Sanctuary'][99 /* 0xD 08 */] = true;
          			  case 1:
/*<148>*/ 				printf("\x0E\x01\x09\x04\x3300\x100DUnmensch, du!")
          				goto flw_123
          			}
          		  case 1:
