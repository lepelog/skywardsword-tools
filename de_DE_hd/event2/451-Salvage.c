          void entrypoint_451_01() {
          	start()
/*<  1>*/ 	printf("Du hast das Objekt gefunden, das der Betreiber der\nRoulette-Insel verloren hat.\n\n\nEs ist möglich, den Roboter aus der Werkstatt zu\nrufen und es von ihm abtransportieren zu lassen.\nSoll ich den Roboter jetzt rufen?\n[1]Ja[2-]Nein")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x05Sehr wohl, Gebieter. Ich werde den Roboter\nunverzüglich rufen.")
          	  case 1:
/*<  4>*/ 		printf("\x0E\x01\x12\x04\x00\x05Sehr wohl, Gebieter. Solltest du deine Meinung\nändern, untersuche dieses Objekt ein weiteres Mal.")
          	}
          }
