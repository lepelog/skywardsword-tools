...
/*<155>*/ 	switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          	  case 0:
/*<156>*/ 		printf("\x0E\x01\x09\x04\x2F08\x709\x0E\x03\x01\x00Link!\nDu warst im Reich des Donnerdrachen!<pause54>\n\n\n\x0E\x01\x09\x04\x2F01\x805\x0E\x01\x08\x02\x2CDWie ärgerlich!<pause5A>\n\n\n\n\x0E\x01\x09\x04\x2F0F\x706\x0E\x01\x08\x02\x2CDJetzt bin ich doch nicht der\nErste, der es geschafft hat!")
          		flw_154:
/*<154>*/ 		scene_flags[9 'Lanayru Gorge'][36 /* 0x5 10 */] = true;
          	  case 1:
/*<147>*/ 		switch (scene_flags[35 /* 0x5 08 */]) {
          		  case 0:
/*<149>*/ 			printf("\x0E\x01\x09\x04\x2F08\xD0ADies ist der Weg zum Reich\ndes <r<Donnerdrachen>>...<pause2D>\n\n\n\x0E\x01\x06\x02\xFFCD\x0E\x01\x09\x04\x2F0D\x800Leider ist er zu eng für mich...\n\x0E\x01\x06\x02\xFFCD\x0E\x01\x09\x04\x2F08\x700Was könnte man da bloß tun?")
          			goto flw_154
          		  case 1:
...
/*<144>*/ 			switch (story_flags[525 /* us: 805A9B14 0x04, jp: 805ACD94 0x04 */]) {
          			  case 0:
/*<158>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD02Hey, Link!\n\n\n\nHast du die <b<heilige Flamme>>, von der\ndu erzähltest, mittlerweile gefunden?\n\n\nSeit ich davon gehört habe, konnte ich kaum\nan etwas anderes denken. Du musst mir\nalles erzählen!\n\n\x0E\x01\x09\x04\x2F08\x407.<pause14>.<pause14>.<pause14>\nWas für ein Abenteuer! Ich bin wirklich\nbeeindruckt.\n\nDu bist ein echter Held, Link!")
/*<170>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD0AIch kann dir etwas von der Legende der\ndrei Drachen erzählen.<pause0F>\n\n\nHier in der Nähe scheint es eine verborgene\nGegend zu geben!\n\n\nIch habe einen <r<kleinen Gang>><pling> gefunden!\nLeider passe ich da nicht durch...\n\n\n\x0E\x01\x09\x04\x2F00\xD00Meiner Ansicht nach haust dort der\n<r<Donnerdrache>>, einer der drei\nlegendären Drachen...\n\n\x0E\x01\x09\x04\x2F00\x800Ich bin mir zudem sicher, dass auch die\nRoboter etwas mit der Sache zu tun haben!<pause0F>\n\n\n\x0E\x01\x09\x04\x2F01\x807\x0E\x01\x06\x02\xFFCDDer <r<Donnerdrache>>, die Roboter, die Steine\nder Zeit<pause14>.<pause14>.<pause14>.<pause14>\n\n\n\x0E\x01\x09\x04\x2F08\x708\x0E\x01\x08\x02\x2CD\x0E\x01\x08\x02\x2CDWas für ein Mysterium!")
/*<146>*/ 				printf("\x0E\x01\x09\x04\x08\xD00Hör mal, Link!\nDu hast doch einmal für meine\nAusgrabungen gespendet...<pause14>\n\nDank dir habe ich ganz viele Steine\nder Zeit entdeckt!\n\x0E\x01\x09\x04\x2F00\xD01Ich werde dir das Zehnfache deiner\nSpende zurückzahlen!")
/*<145>*/ 				rupees += 100;
          				flw_148:
/*<148>*/ 				scene_flags[9 'Lanayru Gorge'][35 /* 0x5 08 */] = true;
          				goto flw_154
          			  case 1:
/*<157>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD02Hey, Link!\n\n\n\nHast du die <b<heilige Flamme>>, von der\ndu erzähltest, mittlerweile gefunden?\n\n\nSeit ich davon gehört habe, konnte ich kaum\nan etwas anderes denken. Du musst mir\nalles erzählen!\n\n\x0E\x01\x09\x04\x2F08\x407.<pause14>.<pause14>.<pause14>\nWas für ein Abenteuer! Ich bin wirklich\nbeeindruckt.\n\nDu bist ein echter Held, Link!")
/*<171>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD0AIch kann dir etwas von der Legende der\ndrei Drachen erzählen.<pause0F>\n\n\nHier in der Nähe scheint es eine verborgene\nGegend zu geben!\n\n\nIch habe einen <r<kleinen Gang>><pling> gefunden!\nLeider passe ich da nicht durch...\n\n\n\x0E\x01\x09\x04\x2F00\xD00Meiner Ansicht nach haust dort der\n<r<Donnerdrache>>, einer der drei\nlegendären Drachen...\n\n\x0E\x01\x09\x04\x2F00\x800Ich bin mir zudem sicher, dass auch die\nRoboter etwas mit der Sache zu tun haben!<pause0F>\n\n\n\x0E\x01\x09\x04\x2F01\x807\x0E\x01\x06\x02\xFFCDDer <r<Donnerdrache>>, die Roboter, die Steine\nder Zeit<pause14>.<pause14>.<pause14>.<pause14>\n\n\n\x0E\x01\x09\x04\x2F08\x708\x0E\x01\x08\x02\x2CD\x0E\x01\x08\x02\x2CDWas für ein Mysterium!")
          				goto flw_148
          			}
          		}
          	}
...
/*<135>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 46>*/ 			printf("Vielen Dank, dass du dem Donnerdrachen\ngeholfen hast!")
          		  case 1:
/*<136>*/ 			printf("Warst du beim Donnerdrachen?")
          		}
          	  case 1:
/*< 53>*/ 		check_item_flag(198, 1)
/*< 54>*/ 		switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 26}) {
          		  case 0:
/*< 55>*/ 			printf("Wenn der Donnerdrache die <r<Lebensbaumfrucht\n>>isst, sollte er dadurch genesen.")
          		  case 1:
/*< 35>*/ 			check_item_flag(497, 1)
/*< 36>*/ 			switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 14}) {
          			  case 0:
/*< 38>*/ 				printf("\x0E\x01\x09\x04\x03\xC00In dieser Hitze will nichts so recht gedeihen...<pause1E>\n\x0E\x01\x09\x04\x01\xC00Wenn das so weitergeht... \x0E\x01\x06\x02\xFECDDer Donnerdrache...")
          			  case 1:
/*< 33>*/ 				switch (story_flags[524 /* us: 805A9B14 0x02, jp: 805ACD94 0x02 */]) {
          				  case 0:
/*<168>*/ 					switch (scene_flags[23 /* 0x3 80 */]) {
          					  case 0:
/*<169>*/ 						printf("\x0E\x01\x09\x04\x00\x00Ich mache mir Sorgen um den Donnerdrachen.\nBitte finde eine <r<Lebensbaumfrucht>> für ihn,\nbzzz.")
          					  case 1:
/*< 37>*/ 						printf("\x0E\x01\x09\x04\x03\x900Um den Donnerdrachen zu kurieren, haben wir\neinen <r<Lebensbaumkeimling >>eingepflanzt.")
          					}
          				  case 1:
/*<  8>*/ 					printf("\x0E\x01\x09\x04\x03\xC00Der <b<Donnerdrache>> ist krank.<pause0F>\n\n\n\n\x0E\x01\x09\x04\x03\xC00Wenn du diesen Stein der Zeit willst,\nbrauchst du seine Erlaubnis.<pause1E> \x0E\x01\x09\x04\x01\xC00Aber jetzt\nhast du wohl andere Sorgen, oder?")
          				}
          			}
          		}
          	}
...
/*<151>*/ 	start()
/*<152>*/ 	printf("\x0E\x01\x09\x04\x2F0C\xD01\x0E\x01\x06\x02\xFFCD\x0E\x01\x08\x02\x1CD\x0E\x01\x09\x04\x2F00\x01Hey, du da!\nBist du nicht Link?\n\n\n\x0E\x01\x06\x02\xFFCD\x0E\x01\x08\x02\x1CDWas für ein Zufall!<pause0F>\nDich wollte ich sehen!<pause0F>\n\n\n\x0E\x01\x06\x02\x2CD\x0E\x01\x08\x02\x1CDKomm mal her zu mir, ja?")
...
/*< 24>*/ 	switch (temp_flags[0 /* 0x1 01 */]) {
          	  case 0:
/*< 25>*/ 		printf("Wenn du dich nicht beeilst, muss ich\nihn ablegen!")
          	  case 1:
/*< 71>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 12, 'param3': 31}
/*< 12>*/ 		printf("\x0E\x01\x09\x04\x03\x900Hier gibt es viele große Steine der Zeit.<pause1E>\n\x0E\x01\x09\x04\x00\x900Hast du auch die Erlaubnis des\n<b<Donnerdrachen>> eingeholt?\n\n\x0E\x01\x09\x04\x01\x900Ich wollte dieses Exemplar hier gerade zu\nihm bringen!")
/*< 18>*/ 		temp_flags[0 /* 0x1 01 */] = true;
/*< 87>*/ 		set_camera(1, 0)
/*< 86>*/ 		printf("\x0E\x01\x05\x04(\x00Hier sind viele Ungeheuer.<pause0F> \x0E\x01\x09\x04\x03\xC00Sei...")
          	}
          }
...
/*<134>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 48>*/ 			printf("Dem Donnerdrachen geht es blendend!")
          		  case 1:
/*<137>*/ 			printf("Der Donnerdrache ist wieder gesund!")
          		}
          	  case 1:
/*< 56>*/ 		check_item_flag(198, 1)
/*< 57>*/ 		switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 28}) {
          		  case 0:
/*< 58>*/ 			printf("Was hast du mit der Frucht gemacht?<pause2D>\nHast du sie denn bereits dem\n<b<Donnerdrachen>> gebracht?")
          		  case 1:
/*< 27>*/ 			check_item_flag(197, 1)
/*< 28>*/ 			switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 8}) {
          			  case 0:
/*< 39>*/ 				printf("\x0E\x01\x09\x04\x03\xC00In <b<Ranelle>> wird dieser Baum wohl niemals\nFrüchte tragen.<pause1E> \x0E\x01\x09\x04\x03\x900Es bräuchte einfach eine\nfruchtbarere Gegend...")
          			  case 1:
/*< 26>*/ 				switch (story_flags[524 /* us: 805A9B14 0x02, jp: 805ACD94 0x02 */]) {
          				  case 0:
/*< 29>*/ 					printf("Auf der anderen Seite der Brücke haben wir\nden <r<Lebensbaumkeimling>>, dessen Früchte alle\nKrankheiten heilen, eingepflanzt.<pause1E>\n\n\x0E\x01\x09\x04\x00\xC00Leider sind unsere Bemühungen in dieser\nUmgebung fruchtlos geblieben...")
          				  case 1:
/*< 16>*/ 					printf("\x0E\x01\x09\x04\x03\x900Der <b<Donnerdrache>> hat mir erlaubt,\nhier nach <b<Steinen der Zeit>> zu graben.\n\n\n<pause1E>\x0E\x01\x09\x04\x03\xC00Im Augenblick geht es ihm jedoch\nziemlich mies...<pause0F> Ich mache mir wirklich\nSorgen!<pause1E> \x0E\x01\x09\x04\x01\xC00Wenn das so weitergeht...")
          				}
          			}
          		}
          	}
...
/*< 81>*/ 	printf("\x0E\x01\x05\x04K\x00Dies ist die <b<Ranelle-Schlucht>>. Den alten Legenden\nzufolge lebt hier ein Drache, der der Göttin dient.")
          }

          void entrypoint_404_32() {
/*< 82>*/ 	start()
/*< 83>*/ 	printf("\x0E\x01\x05\x04Z\x00Da sich hier viele Steine der Zeit finden, hat eine alte\nKultur hier wohl ein Steinwerk errichtet.")
          }
...
/*< 84>*/ 	start()
/*< 85>*/ 	printf("\x0E\x01\x05\x04Z\x00Noch heute zeugen die Loren und Schienen hier\nüberall von ihren Bemühungen.")
          }

          void entrypoint_404_51() {
/*< 73>*/ 	start()
/*< 74>*/ 	printf("Ranelle-Sandmeer voraus\nEin Meer aus Sand\nViele Spuren alter Kulturen")
          }

          void entrypoint_404_34() {
/*<166>*/ 	start()
/*<167>*/ 	printf("Manchmal trägt ein Bokblin ein Monsterhorn an\nseiner Hüfte.\n\n\nNutze die <r<Peitsche>>, um es ihm zu <r<entreißen>>.")
          }

          void entrypoint_404_52() {
/*< 75>*/ 	start()
/*< 76>*/ 	printf("Wüste Ranelle voraus\nVersuche, das Rätsel des alten\nBergwerks zu lösen.")
          }
...
/*< 92>*/ 	start()
/*< 93>*/ 	printf("Betreten nur mit Erlaubnis des\n<b<Donnerdrachen Ranelle>>!")
          }
