...
/*< 17>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 0, unk: 1, line: 13 */ "Ich stelle die Kürbissuppe hier ab,\nin Ordnung?\n\n\nDas ist ein komischer Ort. Ich habe das\nGefühl, dass hier gleich irgendetwas\nganz Großes erscheint.")
          }

          void entrypoint_120_21() {
/*< 19>*/ 	start()
/*< 20>*/ 	printf(/* textboxtype: 0, unk: 92, line: 14 */ "Ich mache mich dann mal vom Acker!<0x10005:0x00280000>")
...
/*< 32>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*< 34>*/ 		printf(/* textboxtype: 0, unk: 92, line: 11 */ "Oho! Ich bin stolz auf dich. Du hast es\ngeschafft, das Triforce zu finden!")
          		flw_35:
...
/*< 31>*/ 		switch (story_flags[22 /* us: 805A9ADB 0x40, jp: 805ACD5B 0x40 */]) {
          		  case 0:
/*< 33>*/ 			printf(/* textboxtype: 92, unk: 1, line: 10 */ "Oho! Ich bin stolz auf dich. Du hast\nherausgefunden, wo sich das Triforce\nbefindet.")
          			goto flw_35
          		  case 1:
