...
/*< 46>*/ 		switch (zone_temp_flags[0 /* 0x1 01 */]) {
          		  case 0:
/*< 49>*/ 			printf(/* textboxtype: 0, unk: 1, line: 7 */ "<0x10009:0x00000700>Willst du vielleicht noch etwas anderes wissen?\n[1-]<color blue<Wasserdrache>coloroff>[2-]<color blue<Donnerdrache>coloroff>[3-]Vulkan[4]Nein")
          			flw_42:
/*< 42>*/ 			switch (choice(4)) {
          			  case 0:
...
/*< 33>*/ 				changeScene(4, 0) // 
          			  case 1:
          				flw_57:
/*< 57>*/ 				set_camera(5, 0)
/*< 27>*/ 				printf(/* textboxtype: 0, unk: 1, line: 1 */ "Der Ausbruch des Vulkans war das Werk\nmeines Zorns. Und du bist hineingeraten...\n\n\nVerzeih mir!\nSchon bald werden sich Erde und Himmel\nin ein freundlicheres Licht färben...\nJetzt kannst du aufbrechen!")
...
/*<  8>*/ 		printf(/* textboxtype: 0, unk: 0, line: 14 */ "<0x10009:0x0011110b>Ich mache mich jetzt schon mal auf.\nHab's schließlich eilig...\n\n\n<0x10009:0x000f0e00>Bis dann!")
...
/*< 69>*/ 	switch (scene_flags[121 /* 0xE 02 */]) {
          	  case 0:
/*< 71>*/ 		printf(/* textboxtype: 0, unk: 1, line: 25 */ "Hallöchen! Neue Visionen gefällig?\nNa, was meinst du?\n[1-]Gerne![2]Nein,\ndanke.")
          		flw_66:
/*< 66>*/ 		switch (choice(2)) {
          		  case 0:
/*< 68>*/ 			changeScene(2, 0) // 
...
/*< 75>*/ 				printf(/* textboxtype: 1, unk: 0, line: 27 */ "Ach so? Na, auf jeden Fall wünsche\nich dir das Beste!")
          		  ...
          		  case 1:
/*< 80>*/ 			printf(/* textboxtype: 0, unk: 0, line: 26 */ "Na, wie geht's denn so?<pause 10> Neue Visionen\nhabe ich keine für dich, aber du kannst\ndir die alten Visionen ansehen. Na, was\nmeinst du?\n[1-]Gerne![2]Nein,\ndanke.")
          			goto flw_74
          		}
          	  case 1:
