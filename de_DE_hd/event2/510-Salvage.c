          void entrypoint_510_01() {
          	start()
/*<  1>*/ 	printf("Dieses Objekt scheint der gesuchte <r<Windrad-Propeller\n>>zu sein.\n\n\nEs ist möglich, den Roboter zu rufen, um ihn\nabtransportieren zu lassen. Soll ich den Roboter\nnun rufen?\n[1]Ja[2-]Nein")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf("Sehr wohl, \x0E\x01\x12\x04\x00\x05Gebieter. Ich werde den Roboter wie\ngewünscht rufen.<pling>")
          	  case 1:
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf("\x0E\x01\x12\x04\x00dDu stehst im Weg, grüner Wicht!\nMach gefälligst Platz!")
          }
