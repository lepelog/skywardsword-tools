...
/*<170>*/ 	switch (story_flags[84 /* us: 805A9AE8 0x01, jp: 805ACD68 0x01 */]) {
          	  case 0:
/*<171>*/ 		printf("\x0E\x01\x09\x04\x1B\xA0DAh nooon! J'me suis encore planté!\nOn dirait que je ne suis pas capable\nde faire comme il faut!")
          	  case 1:
/*< 87>*/ 		switch (zone_temp_flags[1 /* 0x1 02 */]) {
          		  case 0:
/*< 86>*/ 			printf("\x0E\x01\x09\x04\x1B\xA0ET'as vraiment découvert où était\nle trésor sur la carte?")
          		  case 1:
/*< 88>*/ 			printf("\x0E\x01\x09\x04\x1B\xB12Ah! Mais je t'ai donné une carte au\ntrésor exprès!\n\n\n\x0E\x01\x09\x04\x1B\xA0DOuais... Ça fait un peu aventurier\namateur, ça...")
...
/*< 92>*/ 	switch (zone_temp_flags[2 /* 0x1 04 */]) {
          	  case 0:
/*< 90>*/ 		printf("\x0E\x01\x09\x04\x0F\xF09Tant qu'y a plein de monstres qui\ntraînent ici, on devrait déguerpir.")
          	  case 1:
...
/*<111>*/ 		set_camera(3, 0)
/*< 11>*/ 		printf("\x0E\x01\x09\x04\x3313\x1917Ouf! Ç'a l'air chaud! On dit que c'est\nbon pour les courbatures, ça!")
/*<112>*/ 		set_camera(4, 0)
...
/*< 81>*/ 		printf("\x0E\x01\x09\x04\x331B\x502Parfait. Dans ce cas-là, je me pousse.\nAdios!")
          	  case 1:
...
/*< 29>*/ 			scene_flags[15 'Eldin: Fire Sanctuary'][101 /* 0xD 20 */] = true;
          		  case 1:
/*<120>*/ 			printf("\x0E\x01\x09\x04\x08\x509Finalement, on sait très bien tous les\ndeux pourquoi t'es venu jusqu'ici!")
          			goto flw_17
          		}
          	}
          }
...
/*< 72>*/ 	start()
/*< 73>*/ 	printf("Peu importe l'épée que tu brandis, tu\nn'en demeures pas moins un\nvulgaire humain...<pause14>\nUn moins que rien!")
          }
...
/*<143>*/ 			switch (choice(2)) {
          			  case 0:
/*<147>*/ 				printf("\x0E\x01\x09\x04\x331B\x2200Super! Tu te souviendras de ta\npromesse, j'espère!")
          				flw_123:
...
/*< 54>*/ 			switch (choice(2)) {
          			  case 0:
/*< 55>*/ 				printf("\x0E\x01\x09\x04\x331B\x2200Super! Tu te souviendras de ta\npromesse, j'espère!\n\n\nBon, bien. À plus! Euh, salut là!")
          				flw_131:
/*<131>*/ 				printf("\x0E\x01\x08\x02\x2CDOh\x2010ho!")
          				goto flw_123
          			  case 1:
/*< 56>*/ 				printf("\x0E\x01\x09\x04\x3300\x100DAh t'as pas de classe! Et moi qui \nvoulais te rendre service...")
          				goto flw_131
          			}
          		}
          	  case 1:
...
/*< 48>*/ 		switch (choice(2)) {
          		  case 0:
          			flw_51:
/*< 51>*/ 			printf("\x0E\x01\x09\x04\x3325\x1A00Attends! J'voudrais te donner\nquelque chose...\n\n\n\x0E\x01\x09\x04\x00\x500J'vais le chercher, bouge pas!")
