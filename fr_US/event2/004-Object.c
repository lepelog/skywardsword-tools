...
/*< 60>*/ 		printf(/* textboxtype: 1, unk: 1, line: 18 */ "Voulez-vous que je répète tout ça?\n[1-]Oui[2]Non")
/*< 62>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_59
          		  case 1:
/*< 61>*/ 			printf(/* textboxtype: 1, unk: 1, line: 20 */ "Ça ne vous intéresse pas, ce que je\nraconte?<pause 15> Je vois...")
          		}
          	}
          }
...
/*< 53>*/ 		printf(/* textboxtype: 1, unk: 1, line: 18 */ "Voulez-vous que je répète tout ça?\n[1-]Oui[2]Non")
/*< 55>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_52
          		  case 1:
/*< 54>*/ 			printf(/* textboxtype: 1, unk: 1, line: 20 */ "Ça ne vous intéresse pas, ce que je\nraconte?<pause 15> Je vois...")
          		}
          	}
          }
...
/*< 63>*/ 	start()
/*< 64>*/ 	printf(/* textboxtype: 1, unk: 0, line: 30 */ "On raconte que si l'on dessine trois\ntriangles sur les murs mystérieux,\nça donne naissance à une <color yellow<fée>coloroff>.")
          }

          void entrypoint_004_117() {
/*< 75>*/ 	start()
/*< 76>*/ 	printf(/* textboxtype: 1, unk: 1, line: 31 */ "On raconte qu'un <color yellow<quart de cœur\n>coloroff>est caché par ici.")
/*< 77>*/ 	switch (scene_flags[104 /* 0xC 01 */]) {
          	  case 0:
/*< 78>*/ 		printf(/* textboxtype: 1, unk: 1, line: 33 */ "Mais on raconte aussi que vous l'avez\n déjà trouvé... Hmm...")
          	  case 1:
...
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 2, unk: 2, line: 4 */ "Voulez‐vous quitter cet Hypnéa?\n[1-]Quitter[2]Rester")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
