...
/*< 43>*/ 							switch (is_item_check_full()) {
          							  case 0:
/*< 44>*/ 								printf(/* textboxtype: 1, unk: 0, line: 13 */ "<0x10009:0x0000000b>Mon pauvre pit. Ça fait déjà beaucoup\nde choses que tu me laisses à surveiller.\n\n\nMa consigne est comme mon cœur,\nprête à exploser!\n\n\nIl faut que tu te débarrasses de\nquelques affaires pour faire de la\nplace. Tu pourrais en <color red<échanger>coloroff>,\npeut-être?")
          								flw_5:
...
/*< 63>*/ 							switch (is_item_check_full()) {
          							  case 0:
/*< 64>*/ 								printf(/* textboxtype: 1, unk: 0, line: 14 */ "<0x10009:0x00000017>C'est confirmé : je n'ai plus\nde place pour tes affaires!\n\n\nTu veux pas me confier ton cœur,\nmais pour ce qui est de me refiler\ntes cossins, pas de problème!\nQue tu es romantique, va!\nBon, je plaisante, mais il faut\ndébarrasser un peu. Tu sais,\ntu pourrais <color red<échanger>coloroff> quelques\nobjets pour faire de la place...")
          								goto flw_5
          							  case 1:
/*< 65>*/ 								printf(/* textboxtype: 1, unk: 0, line: 4 */ "<0x10009:0x00000013>Allez. Donne.")
          								goto flw_5
          							}
          						}
          					  case 1:
...
/*< 91>*/ 						switch (is_item_check_full()) {
          						  case 0:
/*< 93>*/ 							printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00000015>Écoute. Je veux bien garder de tes\naffaires, mais trop c'est trop.\nJe manque d'espace, c'est clair!\n\nPourquoi t'<color red<échangerais>coloroff> pas quelques\nobjets pour faire de la place...")
          							goto flw_5
          						  case 1:
/*< 92>*/ 							printf(/* textboxtype: 1, unk: 0, line: 2 */ "<0x10009:0x00000015>Parfait. C'est quoi?")
          							goto flw_5
          						}
          					  case 1:
/*< 27>*/ 						switch (is_item_check_full()) {
          						  case 0:
/*< 28>*/ 							printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x00000004>Je voudrais bien prendre encore de\ntes choses, mais là, tu exagères. Je\nn'ai plus de place!\n\nTu pourrais toujours <color red<échanger\n>coloroff>quelques objets pour faire de la\nplace... C'est juste une idée.")
          							goto flw_5
          						  case 1:
/*<  2>*/ 							printf(/* textboxtype: 1, unk: 0, line: 1 */ "<0x10009:0x00000003>Eh bien, vas‐y.")
          							goto flw_5
          						}
          					}
          				}
...
/*< 60>*/ 						switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          						  case 0:
          							flw_52:
/*< 52>*/ 							printf(/* textboxtype: 1, unk: 0, line: 32 */ "<0x10009:0x0000000a>Oh, mais tu n'as rien dans ta\nsacoche, mon beau pit!\n\n\nNe t'inquiète pas, je suis sûre que\ntu reviendras les bras chargés la\nprochaine fois!")
          						  case 1:
/*< 55>*/ 							printf(/* textboxtype: 1, unk: 0, line: 33 */ "<0x10009:0x00000004>On dirait bien que tu n'as\nrien sur toi.\n\n\nReviens me voir quand tu auras des\nchoses pour moi. Beuh bye.")
          						}
          					  case 1:
          						goto flw_52
          					}
          				  case 1:
/*< 17>*/ 					printf(/* textboxtype: 1, unk: 0, line: 31 */ "<0x10009:0x00000004>Oh, bien on dirait que tu n'as rien\nà me donner...\n\n\nReviens quand tu auras des\naffaires à me confier pour vrai.")
          				}
          			}
          		  case 1:
...
/*< 57>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_47:
/*< 47>*/ 						printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x000e150c>Eh, mon pit. Ça suffit comme ça!\nVu?")
          					  case 1:
/*< 58>*/ 						printf(/* textboxtype: 1, unk: 0, line: 9 */ "<0x10009:0x00000013>Tu es venu juste pour me voir?\nC'est vrai que j'embellis de jour en\njour. Tu n'arrêtes pas de penser à\nmoi, c'est ça, hein?")
          					}
          				  case 1:
          					goto flw_47
          				}
...
/*< 49>*/ 				switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          				  case 0:
/*< 46>*/ 					printf(/* textboxtype: 1, unk: 0, line: 7 */ "<0x10009:0x00000017>Hé oh! Arrête de me déranger\nsi tu n'as rien à me donner.\nCompris?")
          				  case 1:
/*< 48>*/ 					switch (story_flags[628 /* us: 805A9B1B 0x80, jp: 805ACD9B 0x80 */]) {
          					  case 0:
/*< 87>*/ 						printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10009:0x00000002>Hé! Ne viens pas me voir si\ntu n'as rien à me donner?\nEntendu?")
          					  case 1:
/*<  3>*/ 						printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x00000002>Ah, bon. C'est beau. Remarque que\nje n'aime pas perdre mon temps. OK?")
          					}
          				}
          			}
          		}
...
/*< 66>*/ 				switch (is_item_check_full()) {
          				  case 0:
/*< 67>*/ 					printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x00000007>Impossible, mon pit d'amour!\n\n\n\nLa consigne est pleine de tes affaires...\nJe t'en prie, veux-tu bien <color red<échanger>coloroff>\ncertaines de tes babioles? Aide-moi\nun peu, quand même!")
          				  case 1:
/*< 68>*/ 					printf(/* textboxtype: 1, unk: 0, line: 17 */ "<0x10009:0x000b1709>J'attends ta prochaine visite!")
          				}
          			  case 1:
/*< 71>*/ 				switch (is_item_check_full()) {
          				  case 0:
/*< 72>*/ 					printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00000004>Tu veux rire? J'ai de la misère\nà bouger ici, tellement c'est\nrempli de tes affaires.\n\nJe n'ai plus de place. C'est clair.\nTu vas devoir <color red<échanger >coloroff>des choses\nou t'en débarrasser. Un des deux.")
          				  case 1:
/*< 73>*/ 					printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10009:0x00000015>N'hésite pas à revenir, ma beauté\nt'éblouira un peu plus à chaque fois!")
          				}
          			}
          		  case 1:
          			goto flw_66
...
/*< 94>*/ 			switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          			  case 0:
/*< 95>*/ 				printf(/* textboxtype: 1, unk: 0, line: 20 */ "<0x10009:0x00000015>Tu as déjà déposé trop d'objets!\n\n\n\nJe n'ai plus de place, désolée. \n<color red<Échange >coloroff>donc quelques affaires\npour faire de la place.")
          			  case 1:
/*< 26>*/ 				printf(/* textboxtype: 1, unk: 0, line: 19 */ "<0x10009:0x00000004>Je n'ai plus de place, tu as rempli\nla consigne à toi tout seul!\n\n\nDésolée, va falloir faire du ménage. \nJe te demande juste d'<color red<échanger>coloroff> \nce dont tu n'as plus besoin... Ce\nn'est pourtant pas compliqué.")
          			}
          		  case 1:
/*< 88>*/ 			switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          			  case 0:
/*< 89>*/ 				printf(/* textboxtype: 1, unk: 0, line: 16 */ "<0x10009:0x00000006>Merci bien...")
          			  case 1:
...
/*< 79>*/ 						printf(/* textboxtype: 1, unk: 0, line: 27 */ "<0x10009:0x00000003>Merci.\nAutre chose?")
          			  ...
          			  case 1:
/*< 10>*/ 				printf(/* textboxtype: 1, unk: 0, line: 25 */ "<0x10009:0x00000003>Merci bien.\nJe peux faire autre chose pour toi?")
          				goto flw_53
          			}
          		  case 1:
...
/*< 75>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_38:
/*< 38>*/ 						printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x00000012>Quoi? Tu ne veux plus? \nAh, ça! Tu fais bien de t'en\ndéfaire, mon beau pit vert!")
          						goto flw_53
          					  case 1:
/*< 76>*/ 						printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10009:0x00000014>Tiens donc, tu veux plus?\nJe vois, t'as changé d'idée, on dirait.\nJe devrais pas être surprise, ce n'est\npas la première fois, ça m'a l'air.")
          						goto flw_53
          					}
          				  case 1:
          					goto flw_38
          			  ...
          			  case 1:
/*< 13>*/ 				printf(/* textboxtype: 1, unk: 0, line: 28 */ "Ah? Tu as changé d'idée?\nC'est comme tu veux...")
          				goto flw_53
          			}
          		}
          	  case 1:
/*<  9>*/ 		printf(/* textboxtype: 1, unk: 0, line: 23 */ "Hmm, pour ça, je te donne <color red<<color red<<numeric arg0 0><color red< rubis>coloroff>.\n\n\n\nÇa te va?\n[1-]Tout à fait[2]Euh, bien...")
          		goto flw_11
          	}
          }
...
/*< 81>*/ 			switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          			  case 0:
          				flw_82:
/*< 82>*/ 				printf(/* textboxtype: 1, unk: 0, line: 32 */ "<0x10009:0x0000000a>Oh, mais tu n'as rien dans ta\nsacoche, mon beau pit!\n\n\nNe t'inquiète pas, je suis sûre que\ntu reviendras les bras chargés la\nprochaine fois!")
          			  case 1:
/*< 83>*/ 				printf(/* textboxtype: 1, unk: 0, line: 33 */ "<0x10009:0x00000004>On dirait bien que tu n'as\nrien sur toi.\n\n\nReviens me voir quand tu auras des\nchoses pour moi. Beuh bye.")
          			}
          		  case 1:
          			goto flw_82
          		}
          	  case 1:
/*< 15>*/ 		printf(/* textboxtype: 1, unk: 0, line: 31 */ "<0x10009:0x00000004>Oh, bien on dirait que tu n'as rien\nà me donner...\n\n\nReviens quand tu auras des\naffaires à me confier pour vrai.")
          	}
          }
...
/*< 86>*/ 				printf(/* textboxtype: 1, unk: 0, line: 36 */ "<0x10009:0x00000004>Oh, tu veux faire un peu\nde tri...\n\n\nSélectionne l'icône « Trier » si tu veux\nréorganiser le classement de tes objets.\n\n\nCela rangera par exemple toutes tes\nflèches dans le même carquois.")
          	  ...
          	  case 1:
/*< 22>*/ 		printf(/* textboxtype: 1, unk: 0, line: 34 */ "<0x10009:0x00000004>Oh, tu veux organiser tes affaires,\nc'est ça?\n\n\nSélectionne l'icône « Trier » si tu veux\nréorganiser le classement de tes objets.\n\n\nCela rangera par exemple toutes tes\nflèches dans le même carquois.")
          		goto flw_23
          	}
          }
