...
/*<225>*/ 	switch (story_flags[200 /* us: 805A9AEF 0x04, jp: 805ACD6F 0x04 */]) {
          	  case 0:
/*<226>*/ 		printf(/* textboxtype: 1, unk: 0, line: 105 */ "<0x10009:0x00000001>Et puis, <heroname>? Tout se\npasse bien pour toi?\n\n\nSi tu as un problème, n'hésite pas à\nm'en parler!")
          	  case 1:
...
/*<122>*/ 			switch (story_flags[643 /* us: 805A9B1D 0x10, jp: 805ACD9D 0x10 */]) {
          			  case 0:
/*<102>*/ 				printf(/* textboxtype: 1, unk: 0, line: 77 */ "<0x10009:0x00000001>Qu'est-ce qui se passe? Plonge donc!\nOu bien souhaites‐tu t'arrêter là?\n[1-]Je continue[2]J'arrête")
/*<117>*/ 				switch (choice(2)) {
          				  case 0:
...
/*<146>*/ 	start()
/*<149>*/ 	printf(/* textboxtype: 1, unk: 0, line: 112 */ "C'est ça. Vas-y maintenant.")
          }
...
/*<155>*/ 				set_camera(20, 0)
/*< 52>*/ 				printf(/* textboxtype: 1, unk: 0, line: 15 */ "Rends‐toi à la <color red<statue de la déesse\n>coloroff>et dis au directeur que nous l'avons\nretrouvée.")
/*<241>*/ 				set_camera(21, 0)
...
/*< 46>*/ 			switch (temp_flags[2 /* 0x1 04 */]) {
          			  case 0:
/*< 47>*/ 				printf(/* textboxtype: 1, unk: 0, line: 11 */ "<0x10009:0x00000006>Qu'est-ce qu'il y a, <heroname>?")
/*< 61>*/ 				set_camera(14, 0)
