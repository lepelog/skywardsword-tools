...
/*<225>*/ 	switch (story_flags[200 /* us: 805A9AEF 0x04, jp: 805ACD6F 0x04 */]) {
          	  case 0:
/*<226>*/ 		printf("\x0E\x01\x09\x04\x00\x01Et puis, Link? Tout se\npasse bien pour toi?\n\n\nSi tu as un problème, n'hésite pas à\nm'en parler!")
          	  case 1:
...
/*<122>*/ 			switch (story_flags[643 /* us: 805A9B1D 0x10, jp: 805ACD9D 0x10 */]) {
          			  case 0:
/*<102>*/ 				printf("\x0E\x01\x09\x04\x00\x01Qu'est-ce qui se passe? Plonge donc!\nOu bien souhaites\x2010tu t'arrêter là?\n[1]Je continue[2-]J'arrête")
/*<117>*/ 				switch (choice(2)) {
          				  case 0:
...
/*<146>*/ 	start()
/*<149>*/ 	printf("C'est ça. Vas-y maintenant.")
          }
...
/*<155>*/ 				set_camera(20, 0)
/*< 52>*/ 				printf("Rends\x2010toi à la <r<statue de la déesse\n>>et dis au directeur que nous l'avons\nretrouvée.")
/*<241>*/ 				set_camera(21, 0)
