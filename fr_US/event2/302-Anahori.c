...
/*< 16>*/ 		switch (story_flags[180 /* us: 805A9AE6 0x08, jp: 805ACD66 0x08 */]) {
          		  case 0:
/*< 14>*/ 			printf(/* textboxtype: 1, unk: 0, line: 4 */ "Bienvenue, l'ami!")
...
/*< 54>*/ 				printf(/* textboxtype: 1, unk: 0, line: 7 */ "Voici. Le jeu consiste à creuser\npour trouver plein de rubis sans\ntrouver de bombes. Tu veux jouer\nau <color blue<Fouille‐rub>coloroff>...\n<0x10009:0x00141614>Ouf... Ça va pas fort, fort, toi!\nReviens me voir quand tu auras\nrepris des forces. Vu?")
/*<118>*/ 				set_camera(5, 0)
/*<119>*/ 				printf(/* textboxtype: 1, unk: 0, line: 8 */ "Tu peux t'asseoir juste là, si tu veux.")
          			  case 1:
/*< 83>*/ 				{'type': 'type3', 'subType': 4, 'param1': 0, 'param2': 6, 'next': 1, 'param3': 13}
/*<  1>*/ 				printf(/* textboxtype: 1, unk: 1, line: 0 */ "Des rubis en masse! Des explosions\nsurprises! C'est ce qui t'attend chez\nle bon Radigume! Veux‐tu jouer au\n<color blue<Fouille‐rubis>coloroff>? Hm? Hm?\n[1-]Débutant[2-]Intermédiaire[3-]Expert[4]Non merci")
          				flw_85:
...
/*< 59>*/ 						printf(/* textboxtype: 1, unk: 1, line: 10 */ "C'est <color red<30 rubis >coloroff>la partie.\nVeux‐tu jouer? Hm? Hm?\n\n[1-]Absolument[2]Non merci")
...
/*< 35>*/ 								printf(/* textboxtype: 1, unk: 0, line: 3 */ "Tu n'as pas assez d'argent, ma foi!\nReviens me voir quand tu seras\ncapable de payer! Vu?")
          							}
          						  case 1:
...
/*< 22>*/ 						printf(/* textboxtype: 1, unk: 1, line: 12 */ "C'est <color red<50 rubis>coloroff> la partie.\nVeux‐tu jouer? Hm? Hm?\n[1-]Absolument[2]Non merci")
...
/*< 29>*/ 								printf(/* textboxtype: 1, unk: 0, line: 3 */ "Tu n'as pas assez d'argent, ma foi!\nReviens me voir quand tu seras\ncapable de payer! Vu?")
          							}
          						  case 1:
...
/*< 23>*/ 						printf(/* textboxtype: 1, unk: 1, line: 14 */ "C'est <color red<70 rubis>coloroff> la partie.\nVeux‐tu jouer? Hm? Hm?\n[1-]Absolument[2]Non merci")
...
/*< 13>*/ 								printf(/* textboxtype: 1, unk: 0, line: 3 */ "Tu n'as pas assez d'argent, ma foi!\nReviens me voir quand tu seras\ncapable de payer! Vu?")
          							}
          						  case 1:
...
/*<  5>*/ 					printf(/* textboxtype: 1, unk: 0, line: 2 */ "À la prochaine chicane!")
          				}
          			}
          		  case 1:
/*< 17>*/ 			printf(/* textboxtype: 1, unk: 2, line: 5 */ "Ma foi, c'est ton baptême de\nFouille‐rubis! J'en suis très honoré!")
/*<155>*/ 			{'type': 'type3', 'subType': 4, 'param1': 255, 'param2': -1, 'next': 154, 'param3': 13}
/*<154>*/ 			printf(/* textboxtype: 1, unk: 0, line: 6 */ "Je m'appelle <color blue<Radigume>coloroff>. Enchanté de\nfaire ta connaissance, petit! C'est moi\nle responsable de <color red<Fouille‐rubis>coloroff>.")
...
/*< 20>*/ 		printf(/* textboxtype: 1, unk: 0, line: 24 */ "Tu as déterré <color red<<color red<<numeric arg0 0><color red< rubis>coloroff>.")
...
/*<107>*/ 				{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 55, 'param3': 45}
          		  ...
          		  case 1:
/*<  9>*/ 			printf(/* textboxtype: 1, unk: 0, line: 20 */ "Tu n'as rien perdu, mais rien gagné\nnon plus. Kif-kif, comme on dit. Hm?")
          			goto flw_102
          		  case 2:
...
/*< 40>*/ 				printf(/* textboxtype: 1, unk: 0, line: 22 */ "Tu as déterré toute une cagnotte!\nFélicitations!")
          				goto flw_102
          			}
          		}
          	  case 2:
...
/*<130>*/ 			switch (zone_temp_flags[1 /* 0x1 02 */]) {
          			  case 0:
/*<131>*/ 				printf(/* textboxtype: 1, unk: 0, line: 44 */ "<0x10009:0x00080a05>Non, je ne flotte pas. Quelle idée!\nJe suis assis sur ma queue pour que\nles clients admirent mes <color red<papattes>coloroff>.")
          				goto flw_128
          			  case 1:
/*<151>*/ 				set_camera(1, 0)
/*<148>*/ 				printf(/* textboxtype: 1, unk: 0, line: 41 */ "<0x10009:0x00141605>Ha! Ha! Non, je ne flotte pas.\nQuelle drôle d'idée... Je suis\nassis sur ma queue.")
/*<152>*/ 				set_camera(2, 0)
/*<149>*/ 				printf(/* textboxtype: 1, unk: 0, line: 42 */ "<0x10009:0x0000000a>En fait, je suis très fier de mes\nbelles <color red<papattes>coloroff>!")
/*<153>*/ 				set_camera(-1, 0)
/*<150>*/ 				printf(/* textboxtype: 1, unk: 0, line: 43 */ "<0x10009:0x00080aff>C'est pour ça que je m'assois sur ma\nqueue. Comme ça, mes clients peuvent\nles admirer! Ça mousse les ventes, c'est\npas possible!")
...
/*<133>*/ 			switch (zone_temp_flags[2 /* 0x1 04 */]) {
          			  case 0:
/*<135>*/ 				printf(/* textboxtype: 1, unk: 0, line: 40 */ "<0x10009:0x00080a09>Non, je ne suis pas ébloui. Je suis\nsimplement à la pointe de la mode.")
          				goto flw_128
          			  case 1:
/*<145>*/ 				set_camera(3, 0)
...
/*<146>*/ 				set_camera(4, 0)
/*<143>*/ 				printf(/* textboxtype: 1, unk: 0, line: 38 */ "<0x10009:0x00140e0b>Et ma <color red<moustache>coloroff>, pas mal, hm?\nElle a une belle ligne, je trouve.\nJe la peigne tous les matins.")
/*<147>*/ 				set_camera(-1, 0)
