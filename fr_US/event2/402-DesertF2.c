...
/*< 74>*/ 	start()
/*<147>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance\nde ces informations pertinentes :\nRegardez par ici.")
/*<167>*/ 	set_camera(3, 0)
/*<148>*/ 	printf("La probabilité que les voiles et les mâts\nqui se trouvent ici proviennent du\nnavire protecteur de la <r<flamme de\nNayru>> est de 60 %.")
/*<168>*/ 	set_camera(-1, 0)
...
/*<117>*/ 	start()
/*<123>*/ 	printf("Approchez\x2010vous,\npuis montez avec (A).")
          }
...
/*<283>*/ 				switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          				  case 0:
          					flw_44:
/*< 44>*/ 					printf("Cette maison est remplie de souvenirs\nde ma famille... Vrrrm.\n\n\nEst\x2010ce que je pourrai un jour y vivre\nà nouveau? Ma famille me manque\ntellement.<pause05>.<pause05>. Vrm.")
          					flw_46:
...
/*<125>*/ 	start()
/*<128>*/ 	printf("\x0E\x01\x05\x04\x0F\x00\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance\nde ces informations pertinentes :\n\n\n\x0E\x01\x05\x04<\x00Voici la <b<mer de sable de Lanelle>>.\nAutrefois, l'eau s'y étendait à perte\nde vue.")
          }

          void entrypoint_402_43() {
/*<182>*/ 	start()
/*<183>*/ 	printf("\x0E\x01\x12\x04\x00\x01Maître, nous sommes arrivés dans la\npartie centrale du chantier naval.")
/*<188>*/ 	set_camera(11, 0)
/*<184>*/ 	printf("Avec le temps, les installations ont été\nrecouvertes de sable.")
/*<189>*/ 	set_camera(-1, 0)
/*<185>*/ 	printf("Je vous recommande de fouiller dans\nle sable pour trouver des indices sur\nle navire.")
          }

          void entrypoint_402_61() {
/*<126>*/ 	start()
/*<129>*/ 	printf("\x0E\x01\x05\x04Z\x00Mais elle s'est asséchée et s'est\ntransformée en mer de sable.")
          }
...
/*<232>*/ 	set_camera(-1, 0)
/*<229>*/ 	printf("\x0E\x01\x12\x04\x00\x01Maître, veuillez prendre connaissance\nde ces informations pertinentes :\nAtteignons notre objectif avant de\nprendre une pause.\nAllons d'abord chercher la carte\nmarine.")
...
/*<127>*/ 	start()
/*<130>*/ 	printf("\x0E\x01\x05\x04Z\x00Nous nous trouvons à l'emplacement\nd'un ancien port.")
          }

          void entrypoint_402_45() {
/*<225>*/ 	start()
/*<231>*/ 	{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': 0, 'next': 226, 'param3': 51}
/*<226>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance\nde ces informations pertinentes :")
/*<228>*/ 	set_camera(16, 0)
/*<227>*/ 	printf("Je détecte la présence d'insectes\nau\x2010dessus de la maison.")
...
/*<289>*/ 				switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          				  case 0:
          					flw_277:
/*<277>*/ 					printf("Je me souviens de ce jour où nous avons\nété attaqués par les pirates... J'en fais\nencore des cauchemars. Brrrzt!\nQuelle frayeur.<pause05>.<pause05>.")
          					flw_56:
...
/*<160>*/ 	set_camera(4, 0)
/*<165>*/ 	printf("Ce bâtiment là\x2010bas, c'est le chantier\nnaval! Vrrm!")
/*<166>*/ 	set_camera(5, 0)
/*<138>*/ 	printf("Mais on ne peut plus y accéder, car\nl'entrée est bloquée. Brrtzt.")
/*<162>*/ 	set_camera(6, 0)
/*<139>*/ 	printf("\x0E\x01\x09\x04\x07\x00On peut se déplacer sur cette île à\nl'aide d'un réseau de wagonnets. Bz.")
/*<164>*/ 	printf("\x0E\x01\x09\x04\x07\x00Vrrm. Si tu empruntes le réseau de\nwagonnets, tu trouveras peut\x2010être\nl'entrée arrière du chantier naval!")
...
/*<163>*/ 	set_camera(6, 0)
/*<141>*/ 	printf("\x0E\x01\x09\x04\x07\x00Commence par t'y rendre,\nje t'attends ici! Brrrzt.")
