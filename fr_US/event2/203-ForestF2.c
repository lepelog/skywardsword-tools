...
/*<426>*/ 			switch (story_flags[55 /* us: 805A9ADC 0x04, jp: 805ACD5C 0x04 */]) {
          			  case 0:
/*<427>*/ 				printf("\x0E\x01\x09\x04\x00\x13Avec toi, c'est même pas drôle de se\ncacher! Tu me trouves toujours tout\nde suite.")
          			  case 1:
...
/*<429>*/ 				printf("\x0E\x01\x09\x04\x00\x14Chut, c'est un secret! Ne le dis à\npersonne!")
/*<431>*/ 				story_flags[55 /* us: 805A9ADC 0x04, jp: 805ACD5C 0x04 */] = true;
          			}
          		  case 1:
/*<425>*/ 			printf("\x0E\x01\x09\x04\x00\x07C'est ici que nous avons élu domicile.\nIl y a assez de nourriture pour tout\nle monde. On y est bien, finalement!")
          		}
          	}
          }
...
/*<432>*/ 		switch (story_flags[16 /* us: 805A9ADB 0x02, jp: 805ACD5B 0x02 */]) {
          		  case 0:
/*<433>*/ 			printf("\x0E\x01\x09\x04\x00\x02C'est un peu dommage que l'eau ait\nà nouveau baissé... La natation me\nremettait en forme!")
...
/*<225>*/ 		switch (story_flags[64 /* us: 805A9ADF 0x08, jp: 805ACD5F 0x08 */]) {
          		  case 0:
/*<226>*/ 			printf("\x0E\x01\x09\x04\x00\x0ETu as rencontré madame le dragon\nd'eau? Oh, si tu savais comme je\nt'envie!")
...
/*< 17>*/ 							temp_flags[5 /* 0x1 20 */] = true;
          					  ...
          					  case 1:
/*< 12>*/ 						printf("\x0E\x01\x09\x04\x00\x0EHein? Tu es allé jusqu'au sommet\nde l'arbre?\n\n\n\x0E\x01\x09\x04\x00\x08Et tu y as trouvé quelqu'un? Il faut\nque j'aille voir ça!")
...
/*< 80>*/ 						printf("\x0E\x01\x09\x04\x00\x02Si tu arrives à monter jusqu'à son\nsommet, tu trouveras peut\x2010être\nquelque chose... Et la vue doit être\nsuperbe!")
...
/*<521>*/ 		switch (story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */]) {
          		  case 0:
/*<522>*/ 			printf("\x0E\x01\x09\x04\x00\x08En passant, il paraît que Kamom\nsouhaite quitter la forêt? Quel\nbrave petit Kikwi!")
          		  case 1:
          		}
          	}
          }
...
/*< 46>*/ 			printf("\x0E\x01\x09\x04\x00\x13Moi, je retourne à la sieste.")
          		  case 1:
/*< 47>*/ 			printf("\x0E\x01\x09\x04\x03\x07Fais bien attention à toi, ne\ncherche pas trop les pépins.")
...
/*<142>*/ 							temp_flags[15 /* 0x0 80 */] = true;
          					  ...
          					  case 1:
/*<141>*/ 						printf("Wow, glou! Tu es bien le messager\nde la Déesse, glou! Ça paraît, glou!")
...
/*<127>*/ 						temp_flags[13 /* 0x0 20 */] = true;
          				  ...
          				  case 1:
/*<126>*/ 					printf("Oh! Super, glou! Madame le dragon\nd'eau est par là, glou. Suis\x2010moi, glou!")
...
/*<323>*/ 		switch (story_flags[200 /* us: 805A9AEF 0x04, jp: 805ACD6F 0x04 */]) {
          		  case 0:
/*<324>*/ 			printf("Madame le dragon d'eau est sortie,\nglou.")
/*<561>*/ 			set_camera(34, 0)
...
/*< 93>*/ 				switch (random(2)) {
          				  case 0:
/*< 95>*/ 					printf("S'il te plaît, aide madame le dragon\nd'eau, glou...")
/*<558>*/ 					set_camera(34, 0)
...
/*<137>*/ 		printf("Par ici, glou, par ici, glou!\nVite, glou, vite, glou!\n\n\nGlou? Tu ne peux pas passer, glou?\nÊtre humain, c'est pas pratique, glou!\nEssaie de passer par\x2010dessus, glou!")
          	  case 1:
/*<135>*/ 		printf("Ha, ha, glou! Beuh, bye! Tu ne pourras\npas entrer ici, glou!\n\n\nViens me chercher, si t'es capable,\nglou!")
          	}
          }
...
/*<250>*/ 				printf("Madame le dragon d'eau se porte bien\nmaintenant, glou. Mille mercis, glou!")
          		  ...
          		  case 1:
/*<249>*/ 			printf("Madame le dragon d'eau ne va pas\ntrès bien. Fais quelque chose, glou!")
          		}
          	  case 1:
...
/*< 39>*/ 				switch (story_flags[61 /* us: 805A9ADF 0x01, jp: 805ACD5F 0x01 */]) {
          				  case 0:
/*< 40>*/ 					printf("\x0E\x01\x09\x04\x01\x04Kwaa! Encore toi? Tu as quelque\nrose à me dire, par tous les sapins?\n[1]Oui[2-]Non")
/*< 41>*/ 					switch (choice(2)) {
          					  case 0:
...
/*< 43>*/ 						printf("\x0E\x01\x09\x04\x00\x13Moi, je retourne à la sieste.")
          			  ...
          			  case 1:
/*<356>*/ 				printf("\x0E\x01\x09\x04\x00\x14Kiwi se permet de déranger\nmon sommeil?")
/*<375>*/ 				set_camera(20, 0)
...
/*<578>*/ 							entrypoint_203_10();
          						  case 1:
/*<577>*/ 							printf("\x0E\x01\x09\x04\x00\x03Par tous les artichauts, on dirait bien\nque tu as perdu la ciboulette...")
          							flw_378:
/*<378>*/ 							set_camera(20, 0)
          							flw_379:
...
/*<414>*/ 		printf("\x0E\x01\x09\x04\x00\x07Les méchants intrus ont disparu!\nEnfin! Nous avons retrouvé la\npaix et l'harmonie!\n\n\x0E\x01\x09\x04\x00\x04J'aimerais que tu puisses aussi vivre\ndans la paix et l'harmonie avec ton\namie créature!")
          	  case 1:
/*<415>*/ 		printf("\x0E\x01\x09\x04\x00\x01Hé! Ho! C'est moi! Tu as retrouvé\nla fille que tu recherchais?\n[1]Qui es\x2010tu?[2]Pas encore")
/*<533>*/ 		switch (choice(2)) {
          		  case 0:
/*<534>*/ 			printf("\x0E\x01\x09\x04\x11\x13Tu ne te souviens pas de moi?<pause1E>\nTu me déçois!\n\n\n\x0E\x01\x09\x04\x0B\x04Pour nous différencier, nous, les\nKikwis, tu n'as qu'à ouvrir ta carte!\nNotre nom apparaît si tu pointes\nle curseur sur nous.")
          		  case 1:
/*<535>*/ 			printf("\x0E\x01\x09\x04\x11\x13C'est dommage... Ce serait bien que\nvous soyez réunis, comme les Kikwis!")
          		}
          	}
          }
