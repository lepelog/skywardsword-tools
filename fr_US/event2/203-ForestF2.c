...
/*<163>*/ 	start()
/*<162>*/ 	printf(/* textboxtype: 1, unk: 1, line: 191 */ "Eh, le maître en vert. Regarde le pro!\nC'est de ça que ç'a l'air, un vrai héros,\nvrrrrt!")
          }
...
/*<421>*/ 	switch (story_flags[16 /* us: 805A9ADB 0x02, jp: 805ACD5B 0x02 */]) {
          	  case 0:
/*<422>*/ 		printf(/* textboxtype: 1, unk: 2, line: 49 */ "<0x10009:0x00000004>C'est bien beau, la paix... Mais, c'est\nun peu ennuyant, par bouts.\n\n\n<0x10009:0x00110005>Bon. En fin de compte, j'ai pas\ngrand-chose à me plaindre.")
          	  case 1:
/*<423>*/ 		printf(/* textboxtype: 1, unk: 2, line: 50 */ "<0x10009:0x00000014>Au cas où tu n'avais pas remarqué, on\nessaie de se cacher. Tu ferais mieux\nde partir, tu risques de nous attirer\ndes monstres!")
          	}
          }
...
/*<426>*/ 			switch (story_flags[55 /* us: 805A9ADC 0x04, jp: 805ACD5C 0x04 */]) {
          			  case 0:
/*<427>*/ 				printf(/* textboxtype: 1, unk: 2, line: 53 */ "<0x10009:0x00000013>Avec toi, c'est même pas drôle de se\ncacher! Tu me trouves toujours tout\nde suite.")
          			  case 1:
...
/*<429>*/ 				printf(/* textboxtype: 1, unk: 2, line: 52 */ "<0x10009:0x00000014>Chut, c'est un secret! Ne le dis à\npersonne!")
/*<431>*/ 				story_flags[55 /* us: 805A9ADC 0x04, jp: 805ACD5C 0x04 */] = true;
          			}
          		  case 1:
/*<425>*/ 			printf(/* textboxtype: 1, unk: 2, line: 48 */ "<0x10009:0x00000007>C'est ici que nous avons élu domicile.\nIl y a assez de nourriture pour tout\nle monde. On y est bien, finalement!")
          		}
          	}
          }
...
/*<432>*/ 		switch (story_flags[16 /* us: 805A9ADB 0x02, jp: 805ACD5B 0x02 */]) {
          		  case 0:
/*<433>*/ 			printf(/* textboxtype: 1, unk: 1, line: 67 */ "<0x10009:0x00000002>C'est un peu dommage que l'eau ait\nà nouveau baissé... La natation me\nremettait en forme!")
...
/*<225>*/ 		switch (story_flags[64 /* us: 805A9ADF 0x08, jp: 805ACD5F 0x08 */]) {
          		  case 0:
/*<226>*/ 			printf(/* textboxtype: 1, unk: 1, line: 65 */ "<0x10009:0x0000000e>Tu as rencontré madame le dragon\nd'eau? Oh, si tu savais comme je\nt'envie!")
...
/*< 15>*/ 						switch (temp_flags[5 /* 0x1 20 */]) {
          						  case 0:
          							flw_16:
/*< 16>*/ 							printf(/* textboxtype: 1, unk: 1, line: 64 */ "<0x10009:0x00000002>Le monde ne cesse de me surprendre.\nJ'aimerais aussi rencontrer cet ermite.")
...
/*< 17>*/ 							temp_flags[5 /* 0x1 20 */] = true;
          					  ...
          					  case 1:
/*< 12>*/ 						printf(/* textboxtype: 1, unk: 1, line: 62 */ "<0x10009:0x0000000e>Hein? Tu es allé jusqu'au sommet\nde l'arbre?\n\n\n<0x10009:0x00000008>Et tu y as trouvé quelqu'un? Il faut\nque j'aille voir ça!")
...
/*< 80>*/ 						printf(/* textboxtype: 1, unk: 1, line: 61 */ "<0x10009:0x00000002>Si tu arrives à monter jusqu'à son\nsommet, tu trouveras peut‐être\nquelque chose... Et la vue doit être\nsuperbe!")
...
/*<390>*/ 	start()
/*<391>*/ 	printf(/* textboxtype: 1, unk: 2, line: 36 */ "<0x10009:0x0001000b><0x10005:0x003c0000><0x10008:0x02cd>Minute, mon poivron!")
          }
...
/*<520>*/ 	switch (story_flags[481 /* us: 805A9B11 0x20, jp: 805ACD91 0x20 */]) {
          	  case 0:
/*<523>*/ 		printf(/* textboxtype: 1, unk: 1, line: 68 */ "<0x10009:0x00000008>Et sinon, comment va Kamom dans son\nnouveau chez‐lui?")
          	  case 1:
/*<521>*/ 		switch (story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */]) {
          		  case 0:
/*<522>*/ 			printf(/* textboxtype: 1, unk: 1, line: 69 */ "<0x10009:0x00000008>En passant, il paraît que Kamom\nsouhaite quitter la forêt? Quel\nbrave petit Kikwi!")
          		  case 1:
          		}
          	}
          }
...
/*< 46>*/ 			printf(/* textboxtype: 1, unk: 1, line: 33 */ "<0x10009:0x00000013>Moi, je retourne à la sieste.")
          		  case 1:
/*< 47>*/ 			printf(/* textboxtype: 1, unk: 1, line: 32 */ "<0x10009:0x00030007>Fais bien attention à toi, ne\ncherche pas trop les pépins.")
...
/*<263>*/ 								printf(/* textboxtype: 1, unk: 0, line: 160 */ "Par ici, glou!")
          							  case 1:
/*<261>*/ 								printf(/* textboxtype: 1, unk: 0, line: 159 */ "Madame le dragon d'eau se\ntrouve par ici, glou. Attends\nune petite minute, glou.")
/*<264>*/ 								temp_flags[16 /* 0x3 01 */] = true;
          							}
          						  case 1:
/*<139>*/ 							printf(/* textboxtype: 1, unk: 0, line: 158 */ "Enfin arrivés, glou!")
/*<142>*/ 							temp_flags[15 /* 0x0 80 */] = true;
          						}
          					  case 1:
/*<141>*/ 						printf(/* textboxtype: 1, unk: 0, line: 157 */ "Wow, glou! Tu es bien le messager\nde la Déesse, glou! Ça paraît, glou!")
...
/*<127>*/ 						temp_flags[13 /* 0x0 20 */] = true;
          				  ...
          				  case 1:
/*<126>*/ 					printf(/* textboxtype: 1, unk: 0, line: 151 */ "Oh! Super, glou! Madame le dragon\nd'eau est par là, glou. Suis‐moi, glou!")
...
/*<115>*/ 				switch (temp_flags[12 /* 0x0 10 */]) {
          				  case 0:
/*<116>*/ 					printf(/* textboxtype: 1, unk: 0, line: 150 */ "T'as juste à faire un <color red<tourbillon\n>coloroff>en <color green<secouant ton Nunchuk >coloroff>pour\nte débarrasser de ces monstres\npiquants, glou!")
          				  case 1:
...
/*<102>*/ 		printf(/* textboxtype: 1, unk: 2, line: 171 */ "De la peine, glou!\nDe la peine, glou!")
          		flw_563:
/*<563>*/ 		{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': -1, 'next': -1, 'param3': 42}
          	  case 1:
/*<323>*/ 		switch (story_flags[200 /* us: 805A9AEF 0x04, jp: 805ACD6F 0x04 */]) {
          		  case 0:
/*<324>*/ 			printf(/* textboxtype: 1, unk: 0, line: 168 */ "Madame le dragon d'eau est sortie,\nglou.")
/*<561>*/ 			set_camera(34, 0)
/*<326>*/ 			make_actor_do_something(0, 0)
/*<325>*/ 			printf(/* textboxtype: 1, unk: 2, line: 169 */ "Sortie, glou, sortie, glou!")
          			goto flw_563
          		  case 1:
...
/*< 93>*/ 				switch (random(2)) {
          				  case 0:
/*< 95>*/ 					printf(/* textboxtype: 1, unk: 0, line: 164 */ "S'il te plaît, aide madame le dragon\nd'eau, glou...")
/*<558>*/ 					set_camera(34, 0)
/*< 97>*/ 					make_actor_do_something(0, 0)
/*< 96>*/ 					printf(/* textboxtype: 1, unk: 2, line: 165 */ "Aide‐la, glou! Aide‐la, glou!")
          					goto flw_563
          				  case 1:
...
/*<137>*/ 		printf(/* textboxtype: 1, unk: 0, line: 152 */ "Par ici, glou, par ici, glou!\nVite, glou, vite, glou!\n\n\nGlou? Tu ne peux pas passer, glou?\nÊtre humain, c'est pas pratique, glou!\nEssaie de passer par‐dessus, glou!")
          	  case 1:
/*<135>*/ 		printf(/* textboxtype: 1, unk: 0, line: 145 */ "Ha, ha, glou! Beuh, bye! Tu ne pourras\npas entrer ici, glou!\n\n\nViens me chercher, si t'es capable,\nglou!")
          	}
          }
...
/*<251>*/ 				printf(/* textboxtype: 1, unk: 0, line: 181 */ "Dommage que le niveau de l'eau ait à\nnouveau baissé, glou.")
          			  case 1:
/*<250>*/ 				printf(/* textboxtype: 1, unk: 0, line: 180 */ "Madame le dragon d'eau se porte bien\nmaintenant, glou. Mille mercis, glou!")
          			}
          		  case 1:
/*<249>*/ 			printf(/* textboxtype: 1, unk: 0, line: 179 */ "Madame le dragon d'eau ne va pas\ntrès bien. Fais quelque chose, glou!")
          		}
          	  case 1:
...
/*< 39>*/ 				switch (story_flags[61 /* us: 805A9ADF 0x01, jp: 805ACD5F 0x01 */]) {
          				  case 0:
/*< 40>*/ 					printf(/* textboxtype: 1, unk: 1, line: 5 */ "<0x10009:0x00010004>Kwaa! Encore toi? Tu as quelque\nrose à me dire, par tous les sapins?\n[1-]Oui[2]Non")
/*< 41>*/ 					switch (choice(2)) {
          					  case 0:
...
/*< 43>*/ 						printf(/* textboxtype: 1, unk: 1, line: 33 */ "<0x10009:0x00000013>Moi, je retourne à la sieste.")
          			  ...
          			  case 1:
/*<356>*/ 				printf(/* textboxtype: 1, unk: 1, line: 3 */ "<0x10009:0x00000014>Kiwi se permet de déranger\nmon sommeil?")
/*<375>*/ 				set_camera(20, 0)
...
/*<578>*/ 							entrypoint_203_10();
          						  case 1:
/*<577>*/ 							printf(/* textboxtype: 1, unk: 1, line: 9 */ "<0x10009:0x00000003>Par tous les artichauts, on dirait bien\nque tu as perdu la ciboulette...")
          							flw_378:
/*<378>*/ 							set_camera(20, 0)
          							flw_379:
...
/*<414>*/ 		printf(/* textboxtype: 1, unk: 2, line: 45 */ "<0x10009:0x00000007>Les méchants intrus ont disparu!\nEnfin! Nous avons retrouvé la\npaix et l'harmonie!\n\n<0x10009:0x00000004>J'aimerais que tu puisses aussi vivre\ndans la paix et l'harmonie avec ton\namie créature!")
          	  case 1:
/*<415>*/ 		printf(/* textboxtype: 1, unk: 2, line: 42 */ "<0x10009:0x00000001>Hé! Ho! C'est moi! Tu as retrouvé\nla fille que tu recherchais?\n[1-]Qui es‐tu?[2-]Pas encore")
/*<533>*/ 		switch (choice(2)) {
          		  case 0:
/*<534>*/ 			printf(/* textboxtype: 1, unk: 2, line: 43 */ "<0x10009:0x00110013>Tu ne te souviens pas de moi?<pause 30>\nTu me déçois!\n\n\n<0x10009:0x000b0004>Pour nous différencier, nous, les\nKikwis, tu n'as qu'à ouvrir ta carte!\nNotre nom apparaît si tu pointes\nle curseur sur nous.")
          		  case 1:
/*<535>*/ 			printf(/* textboxtype: 1, unk: 2, line: 44 */ "<0x10009:0x00110013>C'est dommage... Ce serait bien que\nvous soyez réunis, comme les Kikwis!")
          		}
          	}
          }
...
/*<159>*/ 	start()
/*<158>*/ 	printf(/* textboxtype: 1, unk: 1, line: 188 */ "Mam'selle Fay! Bzzzt! Désolé de t'avoir\nfait attendre!")
          }
...
/*<179>*/ 	switch (scene_flags[127 /* 0xE 80 */]) {
          	  case 0:
/*<180>*/ 		printf(/* textboxtype: 1, unk: 1, line: 190 */ "Han, vvrrrroup! Encore cette <color red<cuvette>coloroff>?<pause 15>\nEuh, pas de problème. Euh, c'est beau,\nlaissez‐moi faire! Vrrrm!")
          	  case 1:
