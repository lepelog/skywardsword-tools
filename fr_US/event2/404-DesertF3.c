...
/*< 51>*/ 		switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 24}) {
          		  case 0:
/*< 52>*/ 			printf(/* textboxtype: 1, unk: 0, line: 19 */ "Brrm, brrzt! Mais c'est...<pause 30> Va tout de\nsuite l'apporter au <color blue<dragon de foudre>coloroff>!")
          		  case 1:
...
/*< 37>*/ 						printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00030900>On a planté une <color red<pousse de l'arbre de vie\n>coloroff>là‐bas, pour que le dragon de foudre\npuisse guérir grâce à son fruit... Vrrm.")
          				  ...
          				  case 1:
/*<  8>*/ 					printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x00030c00>C'est terrible! Brrztz! Le <color blue<dragon\nde foudre >coloroff>est malade...<pause 15>Vrrrrm...\n\n\n<0x10009:0x00030c00>Pour utiliser les chronolithes du coin,\nil faut l'autorisation du dragon...<pause 30> Vrm.\n<0x10009:0x00010c00>Mais ce n'est pas vraiment ça\nle problème le plus urgent!")
          				}
          			}
          		}
          	}
...
/*<134>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 48>*/ 			printf(/* textboxtype: 1, unk: 0, line: 37 */ "Le dragon de foudre est de très bonne\nhumeur. Brzzzrt!")
          		  case 1:
...
/*< 63>*/ 			switch (has_rupees(10)) {
          			  case 0:
/*< 64>*/ 				rupees += -10;
/*< 66>*/ 				printf(/* textboxtype: 1, unk: 0, line: 44 */ "<0x10009:0x2f020208>Merci! Tu verras, tu ne le regretteras\npas, c'est certain!")
