...
/*< 57>*/ 		switch (story_flags[304 /* us: 805A9AFC 0x04, jp: 805ACD7C 0x04 */]) {
          		  case 0:
/*< 58>*/ 			printf(/* textboxtype: 1, unk: 0, line: 63 */ "<0x10009:0x00090257>C'est vrai.<pause 10>.<pause 10>.?\nTu as retrouvé la fillette qui\navait disparu?\n\nAlors, en fin de compte, elle\nn'avait pas été enlevée?\nTant mieux!\n\n<0x10009:0x00000609>Quoi qu'il en soit, c'est une\naffaire de réglée! Beau travail,\nchevalier!")
          		  case 1:
/*<398>*/ 			switch (story_flags[825 /* us: 805A9B33 0x02, jp: 805ACDB3 0x02 */]) {
          			  case 0:
/*<399>*/ 				switch (zone_temp_flags[11 /* 0x0 08 */]) {
          				  case 0:
/*<403>*/ 					printf(/* textboxtype: 1, unk: 0, line: 68 */ "<0x10009:0x00001557>Il t'a raconté que si l'on <color green<frappe>coloroff> la\n<color red<tombe la plus proche de l'arbre\n>coloroff>puis qu'on la <color green<déplace>coloroff>, le démon\napparaîtrait?\n<0x10009:0x00001513>En tous cas, si j'étais toi, je n'irais pas\nme promener dans le cimetière en\npleine nuit, ça c'est sûr!")
          				  case 1:
...
/*<288>*/ 						printf(/* textboxtype: 1, unk: 0, line: 66 */ "<0x10009:0x00001504>On raconte qu'une fillette\naurait disparu!")
          					  case 1:
/*< 52>*/ 						printf(/* textboxtype: 1, unk: 0, line: 62 */ "<0x10009:0x00000501>Oh! Comme ça, tu as remporté la\nchevauchée céleste et tu es passé\nà la classe élite!\n\n<0x10009:0x000c0200>Je vois ça à ton élégant uniforme de\nchevalier! Il te va très bien, tu sais!\n\n\nTe voilà encore plus près de devenir un\nvrai chevalier!")
          					}
          				}
          			}
          		}
...
/*<259>*/ 	wait_frames(15)
/*<198>*/ 	set_camera(10, 0)
/*< 78>*/ 	printf(/* textboxtype: 1, unk: 0, line: 88 */ "<0x10009:0x000c0800>Pardon? Si tu me ramènes l'hélice,\nest‐ce que je pourrais réparer\nle moulin?\n\nBien, je devrais pouvoir remettre\nl'hélice en place, mais...")
/*<199>*/ 	set_camera(12, 0)
...
/*<447>*/ 					switch (zone_temp_flags[8 /* 0x0 01 */]) {
          					  case 0:
/*<406>*/ 						printf(/* textboxtype: 1, unk: 0, line: 74 */ "<0x10009:0x00000001>Moi aussi j'irai à la boutique de Beedle\nacheter le filet!\n\n\nEt je le ferai agrandir à l'atelier\nde rénovation, ouais!")
          					  case 1:
...
/*<144>*/ 				give_gratitude_crystals();
          			  case 1:
/*<143>*/ 				printf(/* textboxtype: 1, unk: 0, line: 14 */ "<0x10009:0x000c0e13>Comment? Tu as retrouvé Picalia?\n\n\n\n<0x10009:0x000f0e00>Hm. Au moins elle est chez quelqu'un\nde bien qui va veiller sur elle. Mais je\nveux quand même vite la revoir!")
          			}
          		  case 1:
...
/*< 21>*/ 			printf(/* textboxtype: 1, unk: 0, line: 9 */ "<0x10009:0x150f0d00>Elle a disparu! Tu ne voudrais\npas m'aider à la retrouver,\n<heroname>? \n\n<0x10009:0x15090d00>J'ai demandé à plusieurs personnes.\nCertaines m'ont dit qu'elles l'avaient\naperçue avec un sinistre individu...\n\n<0x10009:0x150b0d00>D'autres m'ont dit qu'elle avait été\nattaquée par un monstre. Qu'est‐ce\nque je vais faire?\n\nUn enlèvement! <0x10009:0x150e0d00>Elle s'est fait enlever! \nMa petite Picalia est si adorable\nqu'elle s'est fait enlever!")
          			flw_22:
/*< 22>*/ 			printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x15090d00>Il faut sauver ma petite Picalia!\n\n\n\n<0x10009:0x150f0d00>Je t'en supplie, <heroname>!\n[1-]Je m'en\noccupe[2]Impossible")
/*< 23>*/ 			switch (choice(2)) {
          			  case 0:
...
/*< 24>*/ 				printf(/* textboxtype: 1, unk: 0, line: 11 */ "<0x10009:0x15090d12>Et tu te prétends élève de l'école\nde chevalerie?\n\n\nLa mission des chevaliers n'est‐elle pas\nde veiller à la sécurité des habitants\ndu bourg?!")
          		  ...
          		  case 1:
/*< 20>*/ 			printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x15090d12>C'est ma fille! Elle n'a que cinq ans!")
          			goto flw_21
          		}
          	  case 1:
...
/*<350>*/ 	printf(/* textboxtype: 1, unk: 0, line: 0 */ "<0x10009:0x15090d11>Picalia! Picalia!\nMais où est‐ce qu'elle est passée?")
...
/*<418>*/ 						switch (story_flags[836 /* us: 805A9B32 0x10, jp: 805ACDB2 0x10 */]) {
          						  case 0:
/*<419>*/ 							printf(/* textboxtype: 1, unk: 0, line: 39 */ "<0x10009:0x00000005>La nuit, je m'entraîne fort pour\ndevenir aussi fort que toi!")
          							flw_332:
...
/*<310>*/ 						printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x0000000a>Va vite voir sa mère! Elle habite dans\nune maison au bord de la rivière.\nElle doit t'attendre!")
          					  case 1:
/*<309>*/ 						printf(/* textboxtype: 1, unk: 0, line: 27 */ "<0x10009:0x00000012><0x30001:0x><heroname>! Je n'ai encore\ntrouvé aucune trace de Picalia.\n\n\n<0x10009:0x00000e10>Est-ce que tu fais des efforts pour\nla trouver?\n\n\n<0x10009:0x00000c00>Quoi? Tu l'as retrouvée?\n\n\n\n<0x10009:0x00070a0b>Ah, quel soulagement!\nEt c'est grâce à toi, <heroname>!\nJe savais qu'on pouvait compter\nsur toi!")
...
/*<453>*/ 							switch (story_flags[7 /* us: 805A9AD8 0x01, jp: 805ACD58 0x01 */]) {
          							  case 0:
          								goto flw_454
          							  case 1:
/*<452>*/ 								printf(/* textboxtype: 1, unk: 0, line: 74 */ "<0x10009:0x00000001>Moi aussi j'irai à la boutique de Beedle\nacheter le filet!\n\n\nEt je le ferai agrandir à l'atelier\nde rénovation, ouais!")
          							}
          						}
          					}
          				}
...
/*<182>*/ 		set_camera(6, 0)
/*< 88>*/ 		printf(/* textboxtype: 1, unk: 0, line: 94 */ "Bon, ça, je le mets là. Et je fais\ntourner ça, comme ça...")
...
/*< 91>*/ 			printf(/* textboxtype: 1, unk: 0, line: 100 */ "<0x10009:0x000c0c00>Eh bien, <heroname>, à plus!")
          			flw_192:
...
/*< 82>*/ 	switch (story_flags[323 /* us: 805A9AFF 0x02, jp: 805ACD7F 0x02 */]) {
          	  case 0:
/*< 83>*/ 		printf(/* textboxtype: 1, unk: 0, line: 117 */ "Dzzat! Elle est si belle!\nJe ferais n'importe quoi pour\nmam'selle Fay... bzzrt.")
          	  case 1:
...
/*<103>*/ 					printf(/* textboxtype: 1, unk: 0, line: 129 */ "Mais qu'est‐ce que tu fais? Pars vite\nà la recherche de ma nouvelle\nboule de cristal!")
          				  case 1:
/*<214>*/ 					{'type': 'type3', 'subType': 4, 'param1': 1, 'param2': 1799, 'next': 213, 'param3': 13}
/*<213>*/ 					printf(/* textboxtype: 1, unk: 0, line: 129 */ "Mais qu'est‐ce que tu fais? Pars vite\nà la recherche de ma nouvelle\nboule de cristal!")
...
/*<131>*/ 							printf(/* textboxtype: 1, unk: 0, line: 135 */ "Non, je t'en parlerai une autre fois!\nLa mère de Picalia m'a demandé de\nchercher sa fille disparue.\n\nSi tu as un peu de temps, toi aussi,\ncherche‐la.")
          						  case 1:
/*<130>*/ 							printf(/* textboxtype: 1, unk: 0, line: 134 */ "<0x10009:0x00000009>Hahaha! Non mais, tu pourrais quand\nmême écouter ce que j'ai à te dire,\npour une fois!")
          						}
          					  case 1:
...
/*<485>*/ 							printf(/* textboxtype: 1, unk: 0, line: 150 */ "La statue de la Déesse qui disparaît...\nC'est vraiment impensable...\n\n\nJamais je n'aurais cru voir ça\nun jour!\n\n\nMais le directeur m'a expliqué que\nc'était un mal nécessaire pour que\ntu puisses sauver Zelda.\n\nSon sort repose entre tes mains!")
          						  case 1:
/*<316>*/ 							printf(/* textboxtype: 1, unk: 0, line: 136 */ "<0x10009:0x00000001>Tiens, <heroname>! Comment ça\ns'est passé? As‐tu pu parler avec le\ngrand Narisha?\n\nJe vois... J'avais raison. Tu as vraiment\nquelque chose de différent des autres.\nToi et ton célestrier vermeil, vous\nallez sûrement vous en sortir.\nLe chemin sera encore long et semé\nd'embûches, mais tu ne dois pas baisser\nles bras!")
...
/*<  9>*/ 	printf(/* textboxtype: 1, unk: 0, line: 0 */ "<0x10009:0x15090d11>Picalia! Picalia!\nMais où est‐ce qu'elle est passée?")
/*<  8>*/ 	set_camera(2, 0)
...
/*<150>*/ 		printf(/* textboxtype: 1, unk: 0, line: 123 */ "Zzzz-TING! Si t'as encore besoin de\nmoi, n'hésite pas à m'appeler! Dzzzrp!")
          	  case 1:
/*<149>*/ 		printf(/* textboxtype: 1, unk: 0, line: 122 */ "Et voilà! Le drôle de Kikwi est arrivé\nà destination! Fzzzrt!")
