...
/*<  8>*/ 						switch (has_rupees(20)) {
          						  case 0:
/*<  9>*/ 							rupees += -20;
/*< 56>*/ 							printf("Sur quel parcours veux\x2010tu risquer\nta vie?\n[1]Débutant[2]Expert")
/*< 57>*/ 							switch (choice(2)) {
          							  case 0:
...
/*< 40>*/ 							printf("T'as pas assez de rubis?\nPas drôle, ça!\n\n\nVa donc te remplir les poches, et\nreviens me voir!")
          						}
          					  case 1:
