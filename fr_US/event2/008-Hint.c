...
/*<  5>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 1, unk: 0, line: 5 */ "Hé, p'tit gars! Pssst!\nViens donc voir par ici!")
          }
...
/*< 19>*/ 		printf(/* textboxtype: 1, unk: 0, line: 4 */ "Salut, p'tit gars!<pause 10>\nPour l'instant, j'ai rien à te raconter.\n\n\nReviens donc me voir plus tard quand\ntu seras mal pris!")
          ...
          void entrypoint_008_005() {
          	start()
/*<  3>*/ 	printf(/* textboxtype: 1, unk: 0, line: 0 */ "Hé! Ça roule? J'ai un nouvel\nindice pour toi!\nTu veux y jeter un coup d'œil?[1-]Oui[2]Non merci")
/*<  1>*/ 	switch (choice(2)) {
          	  case 0:
/*<  2>*/ 		changeScene(62, 0) // {'name': 'F000', 'room': 0, 'layer': 22, 'entrance': 96, 'byte4': 2, 'byte5': 0, 'flag6': 0, 'zero': 0, 'flag8': 0}
          	  case 1:
/*<  4>*/ 		printf(/* textboxtype: 1, unk: 0, line: 3 */ "D'accord. Eh bien, bonne chance!")
          	}
          }
