...
/*< 33>*/ 			printf(/* textboxtype: 2, unk: 2, line: 1 */ "Vous vous trouvez dans le monde de\nla dernière épreuve, l'<color blue<Hypnéa de la\nDéesse>coloroff>.")
/*< 37>*/ 			set_camera(9, 0)
