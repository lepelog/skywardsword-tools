...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0, line: 3 */ "<0x10012:0x00000064>Mam'selle Fay! J'arrive!\nBzzzzat! J'accours!\n\n\nOh, c'est ça qu'il faut\ntransporter, zrrbt?")
          }
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10012:0x00000064>Hé! Pousse‐toi de là! Zrrppt!\nJ'aime pas avoir à répéter tout\nle temps la même chose! Brrzt!")
          }
...
/*< 40>*/ 						story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */] = true;
          				  ...
          				  case 1:
/*< 18>*/ 					printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x00090013>Mais il y a encore plein de vilains\nméchants qui traînent par ici. Kwii!\n\n\n<0x10009:0x00070004>La vie est dure pour nous, les Kikwis.\nNous passons notre temps à nous cacher\njuste pour survivre! Kwaa!")
          					goto flw_19
          				}
          			  case 1:
/*< 17>*/ 				printf(/* textboxtype: 1, unk: 0, line: 9 */ "<0x10009:0x00070011>Ben oui! Peux‐tu imaginer ce que c'est\nque de passer ses journées à attendre\nque le danger s'éloigne? Kwii!")
          				goto flw_38
          			}
          		}
          	}
