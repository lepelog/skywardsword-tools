...
/*<446>*/ 	printf("\x0E\x01\x07\x04\x2800\x0FHéhéhé, attends de voir ça...\nTu n'en croiras pas tes yeux!\nVoici l'ultime arme super secrète\ndu grand Hergo!")
/*<455>*/ 	set_camera(56, 0)
...
/*<254>*/ 	printf("\x0E\x01\x09\x04\x2800\x4000On dirait que le sceau va lâcher d'un\nmoment à l'autre...\x0E\x01\x05\x04\x1E\x00")
...
/*<475>*/ 	start()
/*<481>*/ 	printf("Maître, veuillez prendre connaissance\nde ces informations pertinentes :")
...
/*<507>*/ 	start()
/*<508>*/ 	printf("\x0E\x01\x09\x04>\x4026\x0E\x03\x01\x00Link! <r<Ramène\x2010toi par ici>>,\net que ça saute! Il y a un passage \nprès du temple, sur le côté!")
          }

          void entrypoint_500_09() {
/*< 12>*/ 	start()
/*< 13>*/ 	printf("\x0E\x01\x09\x04 \x403CÇa y est. Es\x2010tu en place? Vise bien\nle pilier de pierre sur son museau!")
          }
...
/*<223>*/ 	printf("\x0E\x01\x07\x04\x2800\x0FHéhéhé, attends de voir ça...\nTu n'en croiras pas tes yeux!\nVoici l'ultime arme super secrète\ndu grand Hergo!")
/*<230>*/ 	set_camera(32, 0)
...
/*<225>*/ 	printf("\x0E\x01\x09\x04\x2800\x18Tu en es bouche bée, et c'est bien\nnormal! Tu serais surpris de savoir\ncombien d'efforts j'ai dû mettre\npour construire ce chef\x2010d'\x153uvre!")
/*<361>*/ 	printf("Regarde\x2010moi ça!")
/*<232>*/ 	set_camera(33, 0)
/*<362>*/ 	printf("\x0E\x01\x09\x04\x2840\x4300J'ai déblayé la zone entière pour\npouvoir installer le rail qui permet\nde déplacer mon bidule. Et j'ai tout\nfait tout seul!\nHa! Je m'épate moi\x2010même...<pause1E>\nTout ce talent qui ne demandait\nqu'à s'exprimer!\n\n\x0E\x01\x09\x04\x2841\x4000Il ne reste plus qu'à utiliser\ncette machine de rêve pour lui\nfaire avaler sa soupe, à ce démon!")
/*<233>*/ 	set_camera(32, 0)
/*<226>*/ 	printf("\x0E\x01\x09\x04\x2804\x4000Une seule de mes bombes devrait\nsuffire pour calmer les nerfs de\nnotre gros\x2010méchant\x2010pas\x2010beau!")
/*<368>*/ 	{'type': 'type3', 'subType': 4, 'param1': 10304, 'param2': 16896, 'next': 227, 'param3': 13}
/*<227>*/ 	printf("Oupelaye... Ce monstre est arrivé\njuste un peu trop tôt.")
/*<228>*/ 	printf("\x0E\x01\x09\x04\x2841\x4000La machine a encore besoin de\nquelques ajustements avant\nde fonctionner parfaitement.\n\nJe t'avertirai quand tout sera prêt.\nOccupe\x2010toi de lui en attendant!")
/*<296>*/ 	set_camera(45, 0)
...
/*<247>*/ 	printf("\x0E\x01\x07\x04\x2800\x0FHéhéhé, attends de voir ça...\nTu n'en croiras pas tes yeux!\nVoici l'ultime arme super secrète\ndu grand Hergo!")
/*<299>*/ 	set_camera(46, 0)
...
/*<249>*/ 	printf("\x0E\x01\x09\x04\x2800\x18Tu en es bouche bée, et c'est bien\nnormal! Tu serais surpris de savoir\ncombien d'efforts j'ai dû mettre\npour construire ce chef\x2010d'\x153uvre!")
/*<363>*/ 	printf("Regarde\x2010moi ça!")
/*<301>*/ 	set_camera(47, 0)
/*<364>*/ 	printf("\x0E\x01\x09\x04\x2840\x4300J'ai déblayé la zone entière pour\npouvoir installer le rail qui permet\nde déplacer mon bidule. Et j'ai tout\nfait tout seul!\nHa! Je m'épate moi\x2010même...<pause1E>\nTout ce talent qui ne demandait\nqu'à s'exprimer!\n\n\x0E\x01\x09\x04\x2841\x4000Il ne reste plus qu'à utiliser\ncette machine de rêve pour lui\nfaire avaler sa soupe, à ce démon!")
/*<367>*/ 	set_camera(32, 0)
/*<250>*/ 	printf("\x0E\x01\x09\x04\x2804\x4000Une seule de mes bombes devrait\nsuffire pour calmer les nerfs de\nnotre gros\x2010méchant\x2010pas\x2010beau!")
/*<348>*/ 	{'type': 'type3', 'subType': 4, 'param1': 10304, 'param2': 16896, 'next': 251, 'param3': 13}
/*<251>*/ 	printf("Oupelaye... Ce monstre est arrivé\njuste un peu trop tôt.")
/*<252>*/ 	printf("\x0E\x01\x09\x04\x2841\x4000La machine a encore besoin de\nquelques ajustements avant\nde fonctionner parfaitement.\n\nJe t'avertirai quand tout sera prêt.\nOccupe\x2010toi de lui en attendant!")
/*<302>*/ 	set_camera(50, 0)
...
/*<553>*/ 	switch (story_flags[704 /* us: 805A9B22 0x10, jp: 805ACDA2 0x10 */]) {
          	  case 0:
/*<554>*/ 		printf("\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance\nde ces informations pertinentes :\nLe démon s'est à nouveau réveillé.\nVous ne pouvez pas fuir maintenant.")
          	  case 1:
/*<161>*/ 		switch (scene_flags[18 /* 0x3 04 */]) {
          		  case 0:
/*<162>*/ 			printf("\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance\nde ces informations pertinentes :\nVous devez à nouveau refermer\nle sceau qui emprisonne le démon.\nVous ne pouvez pas fuir\nmaintenant, \x0E\x01\x12\x04\x00\x02Maître.")
          		  case 1:
/*<163>*/ 			printf("\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance\nde ces informations pertinentes :\nLe démon s'est à nouveau réveillé.\nVous ne pouvez pas fuir maintenant.")
          		}
          	}
          }
...
/*<235>*/ 	printf("\x0E\x01\x09\x04\x2800\x4000On dirait que le sceau va lâcher d'un\nmoment à l'autre...\x0E\x01\x05\x04\x1E\x00")
/*<241>*/ 	set_camera(32, 0)
...
/*<242>*/ 	printf("\x0E\x01\x09\x04\x2800\x200Bon. OK, Link!\nEssaie quand même de ne pas\ntrop te mettre dans mes jambes\npendant que je sauve le monde!")
/*<309>*/ 	set_camera(45, 0)
...
/*<536>*/ 				switch (zone_temp_flags[11 /* 0x0 08 */]) {
          				  case 0:
/*<537>*/ 					printf("\x0E\x01\x09\x04\x00&La <r<mégatapulte>> est prête\nà livrer bataille!\n\n\nAppuie sur (^) pour te préparer à tirer\nsur cette vermine!\x0E\x01\x11\x02\x8CD\n\n\nTu peux déplacer la machine avec \x0E\x02\x04\x02\xECD\net viser avec la <r<manette Wii Remote>>.\nEnsuite, tire\x2010lui dessus, et BOUM!")
          				  case 1:
...
/*<564>*/ 							switch (story_flags[799 /* us: 805A9B2F 0x80, jp: 805ACDAF 0x80 */]) {
          							  case 0:
          								flw_194:
/*<194>*/ 								printf("\x0E\x01\x09\x04\x00&Dis\x2010moi donc... Où est\x2010ce que\nje t'envoie cette fois?\n\n\n[1]Jeux dans\nle ciel[2]Jeux sur\nterre[3-]Nulle part")
/*<195>*/ 								switch (choice(3)) {
          								  case 0:
...
/*<187>*/ 						switch (story_flags[133 /* us: 805A9AE4 0x08, jp: 805ACD64 0x08 */]) {
          						  case 0:
          							flw_190:
/*<190>*/ 							printf("\x0E\x01\x09\x04\x00&Encore une fois, le grand Hergo t'a\npermis d'aller refermer le sceau.\nGrouille\x2010toi, maintenant!")
          						  case 1:
...
/*<320>*/ 								switch (scene_flags[43 /* 0x4 08 */]) {
          								  case 0:
/*<324>*/ 									printf("\x0E\x01\x09\x04\x00\x4026\x0E\x03\x01\x00Link! Je peux plus\natteindre ma réserve de bombes\npour recharger la machine!\n\n\x0E\x01\x09\x04 \x4000Bon. Tu vas monter dans la machine\net je vais te catapulter sur sa tête!\nTiens bien ta tuque!")
          								  case 1:
/*<322>*/ 									switch (zone_temp_flags[11 /* 0x0 08 */]) {
          									  case 0:
/*<323>*/ 										printf("\x0E\x01\x09\x04\x00&La <r<mégatapulte>> est prête\nà livrer bataille!\n\n\nAppuie sur (^) pour te préparer à tirer\nsur cette vermine!\x0E\x01\x11\x02\x8CD\n\n\nTu peux déplacer la machine avec \x0E\x02\x04\x02\xECD\net viser avec la <r<manette Wii Remote>>.\nEnsuite, tire\x2010lui dessus, et BOUM!")
          									  case 1:
...
/*<318>*/ 								switch (zone_temp_flags[11 /* 0x0 08 */]) {
          								  case 0:
/*<319>*/ 									printf("\x0E\x01\x09\x04\x00&La <r<mégatapulte>> est prête\nà livrer bataille!\n\n\nAppuie sur (^) pour te préparer à tirer\nsur cette vermine!\x0E\x01\x11\x02\x8CD\n\n\nTu peux déplacer la machine avec \x0E\x02\x04\x02\xECD\net viser avec la <r<manette Wii Remote>>.\nEnsuite, tire\x2010lui dessus, et BOUM!")
          								  case 1:
...
/*<540>*/ 		printf("\x0E\x03\x01\x00Link! Le <r<pilier de pierre>>\ndoit se trouver sur le front du démon.\n\n\n\x0E\x01\x09\x04\xE00\x13Si tu parviens à enfoncer ce pilier\navec ton épée, tu devrais pouvoir\nvaincre ce monstre.")
          	  case 1:
...
/*<158>*/ 				printf("\x0E\x03\x01\x00Link! Le <r<pilier de pierre>>\ndoit se trouver sur le front du démon.\n\n\n\x0E\x01\x09\x04\xE00\x13Si tu parviens à enfoncer ce pilier\navec ton épée, tu devrais pouvoir\nvaincre ce monstre.")
          			}
          		  case 1:
...
/*<545>*/ 		printf("\x0E\x03\x01\x00Link! Le <r<pilier de pierre>>\ndoit se trouver sur le front du démon.\n\n\n\x0E\x01\x09\x04\xE00\x13Si tu parviens à enfoncer ce pilier\navec ton épée, tu devrais pouvoir\nvaincre ce monstre.")
          	  case 1:
...
/*<147>*/ 				printf("\x0E\x03\x01\x00Link! Le <r<pilier de pierre>>\ndoit se trouver sur le front du démon.\n\n\n\x0E\x01\x09\x04\xE00\x13Si tu parviens à enfoncer ce pilier\navec ton épée, tu devrais pouvoir\nvaincre ce monstre.")
          			}
          		  case 1:
...
/*<173>*/ 		switch (scene_flags[19 /* 0x3 08 */]) {
          		  case 0:
/*<174>*/ 			printf("\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance\nde ces informations pertinentes :\nVous devez à nouveau refermer\nle sceau qui emprisonne le démon.\nVous ne pouvez pas fuir\nmaintenant, \x0E\x01\x12\x04\x00\x02Maître.")
          		  case 1:
