          void entrypoint_451_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0, line: 0 */ "Cet objet pourrait être celui qu'a\nperdu l'homme de l'île fortune.\n\n\nJe peux appeler le robot de l'atelier\nde rénovation pour qu'il vienne le\nrécupérer. Dois‐je appeler le robot?\n[1-]S'il te plaît[2]Non merci")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  3>*/ 		printf(/* textboxtype: 2, unk: 0, line: 2 */ "<0x10012:0x00000005>Très bien, Maître.\nJ'appelle le robot par transmission\ntélépathique.")
          	  case 1:
/*<  4>*/ 		printf(/* textboxtype: 2, unk: 0, line: 1 */ "<0x10012:0x00000005>Très bien, Maître.\nSi vous voulez le récupérer,\nexaminez‐le à nouveau.")
          	}
          }

          void entrypoint_451_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0, line: 3 */ "<0x10012:0x00000064>Mam'selle Fay! zrrpt!\nTu m'as appelé?\n\n\nC'est bizarre, zrrft... cet endroit me\nrend tout nostalgique... brrzrrt...\n\n\nBzzzt... Cette fois, c'est ça qu'il faut\ntransporter?")
          }

          void entrypoint_451_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 1, unk: 0, line: 4 */ "<0x10012:0x00000064>Très bien, j'apporte ça dans le ciel.\nRejoignez‐moi vite! vrrt!!")
          }

          void entrypoint_451_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 2, unk: 0, line: 5 */ "<0x10012:0x00000001>Maître, je vous conseille de regagner le\nciel pour remettre la roue de fortune à\nson propriétaire au plus vite.")
