...
/*<  9>*/ 	start()
/*< 10>*/ 	printf("\x0E\x01\x12\x04\x00\x01Maître, je vous conseille de regagner le\nciel pour remettre la roue de fortune à\nson propriétaire au plus vite.")
