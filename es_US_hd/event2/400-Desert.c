...
/*<170>*/ 	start()
/*<172>*/ 	set_camera(-1, 0)
/*<171>*/ 	printf(/* textboxtype: 1, unk: 0, line: 87 */ "Felicidades, <0x10012:0x00000004>amo <heroname>.")
...
/*<150>*/ 		switch (scene_flags[73 /* 0x8 02 */]) {
          		  case 0:
/*<152>*/ 			printf(/* textboxtype: 2, unk: 0, line: 105 */ "<0x10009:0x00162007>¡Sabe Goron que me muero por saber\nqué hay ahí dentro!... Ah, ¿no habrá\nningún otro camino por el que entrar?")
          		  case 1:
...
/*<356>*/ 				printf(/* textboxtype: 2, unk: 0, line: 99 */ "<0x10009:0x2f080d0a>Bueno, ya es hora de que te cuente lo\nque he descubierto sobre la leyenda de\nlos tres dragones.<pause 15>\n\n¡Hay muchos secretos escondidos bajo\nlas arenas de este desierto!\n\n\nComo por ejemplo ese <color red<pasadizo tan\nestrecho>coloroff><sound 4> por el que no quepo.\n\n\n<0x10009:0x2f000d00>Sospecho que lleva hasta el lugar donde\nmora el <color red<dragón del trueno>coloroff>.\n\n\n<0x10009:0x2f000800>Estoy seguro de que todo esto guarda\nrelación con esos robots que hay por\naquí.<pause 15>\n\n<0x10009:0x2f010807><0x10006:0xffcd>El <color red<dragón del trueno>coloroff>, robots,\ncronolitos<pause 20>.<pause 20>.<pause 20>.<pause 20>\n\n\n<0x10009:0x2f080708><0x10008:0x02cd><0x10008:0x02cd>¡Qué aventura!")
          				goto flw_282
          			}
          		}
          	}
...
/*< 99>*/ 			wait_frames(30)
/*< 97>*/ 			printf(/* textboxtype: 0, unk: 0, line: 29 */ "¿Eh? Este mapa es un poco raro...\nEspera, voy a corregirlo.")
...
/*<102>*/ 	start()
/*<283>*/ 	printf(/* textboxtype: 0, unk: 1, line: 70 */ "<0x10012:0x00000001>Amo, aviso importante: ha dejado\nde percibirse la presencia de <color blue<Zelda>coloroff>.")
/*<284>*/ 	set_camera(7, 0)
...
/*<225>*/ 	switch (scene_flags[29 /* 0x2 20 */]) {
          	  case 0:
/*<226>*/ 		printf(/* textboxtype: 0, unk: 1, line: 10 */ "No toques las rocas azuladas.\n¡Son demasiado peligrosas!\n¡Y hazte a un lado, que estamos\ntrabajando!")
          	  case 1:
...
/*<117>*/ 		switch (scene_flags[102 /* 0xD 40 */]) {
          		  case 0:
/*<118>*/ 			printf(/* textboxtype: 1, unk: 0, line: 42 */ "¡Aaah! ¡¿Pero qué haces?!\n\n\n\n<0x10009:0x13030000>Te informo que las claves por sí solas\nno sirven de nada. Solo con saberlas\nno basta para abrir la puerta a la\nrefinería.")
          			flw_153:
...
/*<138>*/ 	start()
/*<139>*/ 	printf(/* textboxtype: 1, unk: 0, line: 75 */ "<0x10005:0x005a0000>Sugiero consultar el mapa con (-) <color red<<sound 4> para\ncomprobar el terreno >coloroff>y minimizar los\nriesgos.<0x10011:0x02cd>")
          }
...
/*< 31>*/ 	start()
/*< 32>*/ 	printf(/* textboxtype: 0, unk: 0, line: 14 */ "¡No tengo ganas de charlar!\nEste es un trabajo muy duro.\nHaz el favor de no molestar.")
