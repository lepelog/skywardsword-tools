...
/*< 18>*/ 				printf(/* textboxtype: 4, unk: 2, line: 16 */ "Cuando el <0x10012:0x00000002>amo complete la <color yellow<orquídea del\nespíritu >coloroff>con las 15 <color yellow<lágrimas>coloroff>, reforzará su\nespíritu y la Diosa le otorgará un poder.\n\nEsperaré el regreso del <0x10012:0x00000002>amo en el\nmundo exterior.")
...
/*< 61>*/ 					set_camera(6, 0)
/*< 64>*/ 					printf(/* textboxtype: 2, unk: 4, line: 11 */ "Nada más poner un pie fuera de este\ncírculo, los llamados <color red<guardianes\n>coloroff>perseguirán al <0x10012:0x00000002>amo.")
/*< 62>*/ 					set_camera(4, 0)
