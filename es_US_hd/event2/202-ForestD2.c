...
/*< 44>*/ 	start()
/*< 45>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "Si golpeas la piedra que el ojo\noculta, se cerrará la boca y\ndetendrás el flujo.")
          }

          void entrypoint_202_05() {
/*< 46>*/ 	start()
/*< 47>*/ 	printf(/* textboxtype: 0, unk: 0, line: 2 */ "El símbolo de la gratitud que\nadorna al <color red<gigante de piedra\n>coloroff>muestra el <color red<ciclo de la vida >coloroff>que\ndomina esta tierra.\nLa <color red<espalda>coloroff> primero, después\nel <color red<trasero>coloroff>, luego el <color red<dorso de la\nmano derecha>coloroff> y después <color red<el de\nla izquierda>coloroff>.")
/*< 48>*/ 	story_flags[1195 /* us: 805A9B61 0x02, jp: 805ACDE1 0x02 */] = true;
          }

          void entrypoint_202_11() {
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 2, unk: 0, line: 9 */ "El análisis de la información disponible\nsugiere que la <color yellow<llave >coloroff>de la que se habla\nen la litografía es la que activa el\nmecanismo que hay más adelante.")
          }
...
/*< 15>*/ 	printf(/* textboxtype: 0, unk: 0, line: 17 */ "Veo que eres muy persistente.<pause 5>.<pause 5>.")
/*< 19>*/ 	set_camera(3, 0)
/*< 16>*/ 	printf(/* textboxtype: 2, unk: 0, line: 18 */ "Pero estoy bastante ocupado, ¿sabes?\nTengo que hallar el modo de resucitar\nal Señor del Mal.")
/*< 20>*/ 	set_camera(4, 0)
/*< 30>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3334, 'param2': 512, 'next': 23, 'param3': 13}
/*< 23>*/ 	wait_frames(30)
/*< 22>*/ 	printf(/* textboxtype: 0, unk: 2, line: 19 */ "Y, sinceramente, me molesta que\nalguien se entrometa cuando tengo\ntanto que hacer. ¡Me estoy empezando\na hartar, mocoso!")
