...
/*<165>*/ 	start()
/*<164>*/ 	printf("¡Bueno, esperaré en el cielo,\ncomo siempre!")
...
/*<426>*/ 			switch (story_flags[55 /* us: 805A9ADC 0x04, jp: 805ACD5C 0x04 */]) {
          			  case 0:
/*<427>*/ 				printf("\x0E\x01\x09\x04\x00\x13Intentar esconderse de ti ya no es\ndivertido... ¡Siempre me encuentras!")
          			  case 1:
/*<428>*/ 				printf("\x0E\x01\x09\x04\x11\x13Has vuelto a encontrarme. Veo que es\nimposible esconderse de ti...\n\n\n\x0E\x01\x09\x04\x0B\x07Como premio, te doy esto que encontré\npor ahí mientras me escondía.")
/*<430>*/ 				give_item(176 0xB0);
/*<429>*/ 				printf("\x0E\x01\x09\x04\x00\x14¡Pero no se lo digas a nadie!")
...
/*<532>*/ 			entrypoint_203_09();
          		  case 1:
/*<434>*/ 			printf("\x0E\x01\x09\x04\x00\x0E¡¿Que la dragona del agua te ha\naceptado?! ¡Eso sí que es una\nsorpresa!")
...
/*<529>*/ 							entrypoint_203_09();
          						  case 1:
/*< 14>*/ 							printf("\x0E\x01\x09\x04\x00\x0E¿Dices que has encontrado a\nun ermitaño? ¡Y yo que pensaba\nque solo quedábamos cinco kyus!")
...
/*<525>*/ 					entrypoint_203_09();
          				  case 1:
/*<435>*/ 					printf("\x0E\x01\x09\x04\x00\x03Vaya, es una lástima que no encontraras\na tu amiga en las profundidades del\nbosque.\n\n\x0E\x01\x09\x04\x00\x02¡Pero no te desanimes! Igual que yo\nme he reunido con mis compañeros,\n¡sé que tú también encontrarás a tu\namiga!")
...
/*<318>*/ 				printf("\x0E\x01\x09\x04\x07\x709Increíble... ¡Es auténtica <b<agua sagrada>>!\n¡Lo has logrado!\n\n\n¡Date prisa y viértela en la marmita!")
          				goto flw_351
          			}
          		  case 1:
...
/*< 52>*/ 				printf("\x0E\x01\x09\x04\x00\x01\x0E\x01\x08\x02\x2CD¿Oh?\n\n\n\n¡¿Qué haces aquí, mortal?!")
...
/*<156>*/ 	start()
/*<157>*/ 	printf("\x0E\x01\x12\x04\x00\x01Amo, sugiero regresar al cielo\nde inmediato y dirigirnos al volcán.")
...
/*<446>*/ 	set_camera(20, 0)
/*<387>*/ 	printf("\x0E\x01\x09\x04\x00\x13Bueno, creo que voy a descansar\nun rato. Ya nos veremos.")
...
/*<479>*/ 	printf("\x0E\x01\x09\x04\x07\x700Buena suerte, muchacho.")
...
/*<520>*/ 	switch (story_flags[481 /* us: 805A9B11 0x20, jp: 805ACD91 0x20 */]) {
          	  case 0:
/*<523>*/ 		printf("\x0E\x01\x09\x04\x00\x08Por cierto, estaba acordándome de\nPoli. Me pregunto qué tal le irá\nen su nuevo hogar.")
          	  case 1:
/*<521>*/ 		switch (story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */]) {
          		  case 0:
/*<522>*/ 			printf("\x0E\x01\x09\x04\x00\x08¿Ya habrá abandonado Poli el bosque?\nLa verdad es que le deseo lo mejor.")
          		  case 1:
          		}
          	}
          }
...
/*<504>*/ 	start()
/*<505>*/ 	printf("¡Argh, humano en agua!<pause14> ¡Raro, raro!")
          }
...
/*<584>*/ 	printf("\x0E\x01\x09\x04\x00\x09Vamos, coloca una baliza para señalar\nla ubicación de \x0E\x02\x04\x02\x19CD.")
/*<585>*/ 	set_camera(18, 0)
          	flw_406:
/*<406>*/ 	{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 35, 'param3': 34}
/*< 35>*/ 	printf("\x0E\x01\x09\x04\x01\x06Bueno, ¿has tomado buena nota de\nla ubicación del símbolo?\n[1]Así es[2-]Aún no")
/*< 36>*/ 	switch (choice(2)) {
          	  case 0:
/*< 45>*/ 		switch (story_flags[63 /* us: 805A9ADC 0x40, jp: 805ACD5C 0x40 */]) {
          		  case 0:
/*< 46>*/ 			printf("\x0E\x01\x09\x04\x00\x13Bueno, creo que voy a descansar\nun rato. Ya nos veremos.")
          		  case 1:
/*< 47>*/ 			printf("\x0E\x01\x09\x04\x03\x07Muy bien, ve con cuidado.")
/*< 48>*/ 			story_flags[61 /* us: 805A9ADF 0x01, jp: 805ACD5F 0x01 */] = true;
          		}
          	  case 1:
/*< 38>*/ 		printf("\x0E\x01\x09\x04\x00\x03Bueno, vamos a intentarlo otra vez...")
          		flw_37:
/*< 37>*/ 		{'type': 'type3', 'subType': 4, 'param1': 0, 'param2': 0, 'next': 32, 'param3': 30}
/*< 32>*/ 		switch (story_flags[62 /* us: 805A9ADF 0x02, jp: 805ACD5F 0x02 */]) {
          		  case 0:
/*< 33>*/ 			printf("\x0E\x01\x09\x04\x00\x09Vamos, coloca una baliza para señalar\nla ubicación de \x0E\x02\x04\x02\x19CD.")
          			goto flw_406
          		  case 1:
...
/*<142>*/ 							temp_flags[15 /* 0x0 80 */] = true;
          					  ...
          					  case 1:
/*<141>*/ 						printf("¡Bien, bien! ¡Tú elegido de la Diosa,\nqueda demostrado! ¡Vamos, adelante!")
...
/*<127>*/ 						temp_flags[13 /* 0x0 20 */] = true;
          				  ...
          				  case 1:
/*<126>*/ 					printf("¡Uaaah! ¡Increíble, increíble! ¡Vamos,\ntú sigue a mí; dragona del agua no muy\nlejos!")
...
/*<137>*/ 		printf("¡Aquí, aquí, aquí! ¡Rápido, rápido!\n\n\n\n¡¿Tú no puede pasar?! Especie rara,\nla tuya. ¿Y por arriba? ¿Por qué tú\nno pruebas?")
          	  case 1:
/*<135>*/ 		printf("¡Jua, jua, adiós, adiosito! No sé\ncómo haces para bucear tan bien,\npero de aquí no pasas tú ya...\n\n¡Intenta atraparme si tú puedes!")
          	}
          }
...
/*<  4>*/ 	start()
/*<255>*/ 	set_camera(-1, 0)
/*<254>*/ 	printf("Felicidades, \x0E\x01\x12\x04\x00\x04amo Link.")
...
/*< 42>*/ 						printf("\x0E\x01\x09\x04\x00\x03Debes valerte del poder de la Diosa\npara completar el símbolo que hay\nen la puerta del sur del bosque.")
          						goto flw_37
          					  case 1:
/*< 43>*/ 						printf("\x0E\x01\x09\x04\x00\x13Bueno, creo que voy a descansar\nun rato. Ya nos veremos.")
          					}
          				  case 1:
          					goto flw_37
          				}
...
/*<569>*/ 				switch (story_flags[226 /* us: 805A9AF2 0x08, jp: 805ACD72 0x08 */]) {
          				  case 0:
/*<570>*/ 					printf("\x0E\x01\x09\x04\x01\x01\x0E\x01\x06\x02\xFCCD¿Eh? <pause0F>\x0E\x01\x06\x02Í¿Nos conocemos?\n[1]Claro...[2]No")
/*<571>*/ 					switch (choice(2)) {
          					  case 0:
/*<575>*/ 						set_camera(18, 0)
/*<574>*/ 						printf("\x0E\x01\x09\x04\x00\x07Ahhh, ya veo... ¡Estás jugando en el\nmodo Héroe! En ese caso, supongo\nque sabes perfectamente lo que tienes\nque hacer...\n[1]Claro[2]Lo olvidé")
/*<576>*/ 						switch (choice(2)) {
          						  case 0:
...
/*<367>*/ 								set_camera(22, 0)
/*<368>*/ 								printf("\x0E\x01\x09\x04\x00\x04Cuenta la leyenda que lo hizo con la\ncondición de que la dragona se la\nentregara a su vez al \"<b<viajero caído\ndel cielo>>\"...")
/*<369>*/ 								set_camera(20, 0)
...
/*<573>*/ 						set_camera(18, 0)
          						flw_363:
/*<363>*/ 						printf("\x0E\x01\x09\x04\x03\x06Pero bueno...<pause0F> ¿qué te trae por estas\ntierras?\n[1]La llama[2]Nada")
/*<360>*/ 						switch (choice(2)) {
          						  case 0:
...
/*< 84>*/ 		switch (adventure_pouch_has(7 0x0007)) {
          		  case 0:
/*< 85>*/ 			printf("Análisis del agua de la marmita\nen curso\x0E\x01\x06\x02\xFCCD...<pause0F> \x0E\x01\x06\x02ÍConfirmo que su\n<pling><r<composición es idéntica >>a la del\nmanantial de la contemplación.")
...
/*<294>*/ 				set_camera(12, 0)
/*<293>*/ 				printf("\x0E\x01\x09\x04\x00\x05Si continúas por esa senda, llegarás\nal bosque de Farone.")
/*<471>*/ 				switch (temp_flags[0 /* 0x1 01 */]) {
          				  case 0:
/*<295>*/ 					set_camera(-1, 0)
          					flw_184:
/*<184>*/ 					printf("\x0E\x01\x09\x04\x09\x706Bien, ¡en marcha!\n¡No me hagas esperar!")
