...
/*< 26>*/ 			switch (temp_flags[1 /* 0x1 02 */]) {
          			  case 0:
/*< 38>*/ 				printf("\x0E\x01\x12\x04\x00\x04Amo Link, la recolección\nde <y<lágrimas >>ha fracasado.")
...
/*<  3>*/ 			printf("Esa es la <y<orquídea del espíritu>>.\n\n\n\nCuando la complete, el \x0E\x01\x12\x04\x00\x02amo habrá\nsuperado el juicio y verá fortalecido\nsu espíritu.\n\nEsto permitirá que la Diosa le conceda\nun <r<nuevo poder>>.")
          			flw_6:
/*<  6>*/ 			printf("Para completar la <y<orquídea del espíritu>>,\nes necesario encontrar las <y<lágrimas de\nFarore >>que hay esparcidas por este\nmundo.")
/*<  7>*/ 			set_camera(2, 0)
/*<  8>*/ 			{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': 0, 'next': 11, 'param3': 40}
/*< 11>*/ 			printf("\x0E\x01\x12\x04\x00\x02Amo, aquel objeto brillante de allí...")
/*< 12>*/ 			set_camera(3, 0)
/*< 13>*/ 			printf("Es una de las <y<lágrimas de Farore>>.\nEl \x0E\x01\x12\x04\x00\x01amo deberá reunir las <r<15\n>>para superar el juicio.")
