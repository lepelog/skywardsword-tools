...
/*<  3>*/ 	printf(/* textboxtype: 0, unk: 0, line: 2 */ "No está por ninguna parte...\nSeguro que se me ha caído por aquí.")
...
/*< 29>*/ 	printf(/* textboxtype: 1, unk: 0, line: 3 */ "¡Hola, muchacho! ¡Qué oportuno!\n¡Soy yo, tu gran amigo <color blue<Jerry>coloroff>!\n\n\n<0x10009:0x00ffffff>¡El destino ha hecho que volvamos\na encontrarnos aquí! ¿Vienes a\nayudarme a buscar mi <color yellow<saco de bombas>coloroff>?")
/*<102>*/ 	set_camera(16, 0)
/*<101>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "Estaba buscando tesoros al otro lado\nde esas rocas cuando, de repente,\nme atacaron unos monstruos.<pause 15> Al huir\nse me debió de caer. <0x10009:0x0013100d>Estoy seguro...")
/*<104>*/ 	set_camera(-1, 0)
/*<103>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10009:0x000908ff>El saco es un objeto muy práctico...\nTe permite <color red<guardar flores bomba\ny usarlas cuando quieras>coloroff>. Seguro\nque lo tienen esos tipos...\n¡No sabes la rabia que me da!<pause 10>\n<0x10009:0x00110dff>¡Te lo suplico! ¡Tienes que ayudarme\na recuperar mi <color yellow<saco de bombas>coloroff>!")
          }
...
/*< 95>*/ 	set_camera(15, 0)
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0, line: 9 */ "<0x10009:0x00110d08>¡Mi <color yellow<saco de bombas>coloroff>! ¡Me lo has traído!\n\n\n\n<0x10009:0x00ff08ff>¡Eres el mejor, chico!\nVamos, vamos, dámelo...<pause 20>\n\n\n<0x10009:0x00110d0e>¿Cómo? ¿Dices que quieres que te lo\npreste para poder seguir adelante?\n\n\n<0x10009:0x00ffffff>Ah, claro, ya me había olvidado de que\nhas venido aquí en busca de tu amiga.\n\n\n<0x10009:0x00150d11>Por cierto...<pause 15> ¿cómo estará mi amigo?\n[1-]Se ha ido[2-]Preocupado[3-]No sé")
/*< 34>*/ 	switch (choice(3)) {
          	  case 0:
/*< 35>*/ 		printf(/* textboxtype: 0, unk: 1, line: 10 */ "<0x10009:0x00131007>¿En serio? Ya sabía yo que no\nse podía confiar en él...\n\n\n<0x10009:0x00ff08ff>Ojalá se pareciera más a ti. Hay que\ntener valor para venir solo a un sitio\ncomo este...\n\n<0x10009:0x00141209>Pero bueno, no se puede hacer nada.\nY en cuanto a prestarte mi saco,\nni lo sueñes. Mejor te lo regalo.\nYa está, es todo tuyo.")
          		flw_105:
...
/*<  8>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 0}) {
          	  case 0:
/*< 12>*/ 		printf(/* textboxtype: 0, unk: 1, line: 16 */ "<0x10009:0x00110d00>Por cierto, chico. ¿Alguna vez\nte has visto envuelto en llamas\ncuando luchabas con los monstruos?\n\n<0x10009:0x000908ff>Cuando te vuelvas a ver en esa\nsituación, apaga las llamas cuanto\nantes, porque si sacas una <color yellow<bomba\n>coloroff>en ese momento...")
          	  case 1:
/*< 99>*/ 		switch (scene_flags[1 /* 0x1 02 */]) {
          		  case 0:
/*<100>*/ 			printf(/* textboxtype: 0, unk: 0, line: 8 */ "<0x10009:0x00150809>Je, je, ¡buen trabajo, muchacho!\nTu técnica de lanzar rodando\nlas <color yellow<flores bomba >coloroff>es muy buena.\n\n<0x10009:0x00110800>¡Ya estás preparado para recuperar\nmi <color yellow<saco de bombas >coloroff>y traérmelo!\n¡¿Qué esperas?!")
          		  case 1:
/*< 96>*/ 			switch (temp_flags[57 /* 0x6 02 */]) {
          			  case 0:
/*< 13>*/ 				printf(/* textboxtype: 0, unk: 1, line: 7 */ "Con una buena explosión, ese tipo de\nrocas revienta con facilidad. ¿Qué tal\nsi buscas alguna <color yellow<flor bomba >coloroff>y lo\nintentas?")
          			  case 1:
/*< 97>*/ 				printf(/* textboxtype: 1, unk: 1, line: 6 */ "Ah, claro...<pause 15> Tú no sabes excavar,\nasí que no sé cómo vas a llegar\nal otro lado.\n\n<0x10009:0x0015120c>Mmm... Creo que tengo una idea.\nEsa roca de ahí parece bastante\nfrágil. Quizá puedas reventarla\ncon una <color yellow<flor bomba>coloroff>.\n<0x10009:0x0009ff00>¿Por qué no intentas encontrar una\npor los alrededores?")
...
/*< 14>*/ 	start()
/*< 15>*/ 	printf(/* textboxtype: 0, unk: 2, line: 31 */ "Templo terrenal")
          }
...
/*< 70>*/ 	wait_frames(10)
/*< 51>*/ 	set_camera(2, 0)
/*< 40>*/ 	printf(/* textboxtype: 0, unk: 1, line: 22 */ "<0x10009:0x0d0805ff>Vaya, si eres tú otra vez.")
/*< 79>*/ 	set_camera(10, 0)
/*< 78>*/ 	printf(/* textboxtype: 0, unk: 0, line: 23 */ "<0x10009:0x0d0005ff>Este<pause 1>.<pause 1>.<pause 1>.<pause 1> <pause 8>Qué memoria la mía.<pause 20>\nDisculpa, pero creo que he olvidado\ncómo te llamabas.\n\n<0x10009:0x0d0a05ff>No es que importe mucho, claro.\nNecesito que alguien escuche mis\nquejas y tendré que conformarme\ncontigo.")
/*< 73>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3339, 'param2': 3327, 'next': 72, 'param3': 13}
/*< 72>*/ 	set_camera(6, 0)
/*< 58>*/ 	printf(/* textboxtype: 1, unk: 0, line: 24 */ "<0x10009:0x0d000900>Vine corriendo hasta aquí porque\nlos inútiles de mis esbirros dijeron\nque teníamos a la sacerdotisa...\n¿Y con qué me encuentro?\n<0x10009:0x0d000cff>Con que esa sierva de la diosa...")
/*< 74>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3340, 'param2': 3327, 'next': 65, 'param3': 13}
/*< 65>*/ 	printf(/* textboxtype: 0, unk: 2, line: 25 */ "<0x10008:0xfecd><0x1000A:0x000c00cd>Lo había vuelto a hacer...\n\n\n\n<0x10009:0x0d000cff><0x10008:0xfecd><pause 15><0x1000A:0x000d00cd>Lo que quiero decir es que...")
/*< 75>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3341, 'param2': 3583, 'next': 66, 'param3': 13}
/*< 66>*/ 	printf(/* textboxtype: 0, unk: 0, line: 26 */ "<0x10005:0x002d0000><0x10008:0x02cd>¡Esa repugnante sierva\nde la Diosa<0x1000A:0x000b00cd> se la llevó!")
/*< 81>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3342, 'param2': 3583, 'next': 63, 'param3': 13}
/*< 63>*/ 	printf(/* textboxtype: 2, unk: 0, line: 27 */ "<0x10008:0x01cd>¡Y necesito a la sacerdotisa\npara resucitar a nuestro rey!\n¡LA NECESITO!")
/*< 77>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3335, 'param2': 1535, 'next': 76, 'param3': 13}
/*< 76>*/ 	set_camera(9, 0)
/*< 64>*/ 	printf(/* textboxtype: 0, unk: 2, line: 28 */ "<pause 5>.<pause 5>.<pause 5>.<pause 5><pause 10>Te pido disculpas otra vez.\n\n\n\n<0x10009:0x0d0805ff>Comprenderás que, dadas las\ncircunstancias, necesitaba desahogarme,\n¿verdad?")
/*< 67>*/ 	set_camera(3, 0)
/*< 61>*/ 	printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10009:0x0d0a05ff>Llega un punto en el que uno\nno sabe cómo descargar su ira.\n<pause 20>Y, ya que estás aquí...<pause 20> me temo\nque te va a tocar a ti...<pause 20>")
/*< 71>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3335, 'param2': 1535, 'next': 68, 'param3': 13}
/*< 68>*/ 	set_camera(4, 0)
/*< 62>*/ 	printf(/* textboxtype: 2, unk: 0, line: 30 */ "¡sufrir mi cólera desatada!")
...
/*< 41>*/ 	start()
/*< 42>*/ 	printf(/* textboxtype: 1, unk: 0, line: 18 */ "Tengo información importante, <0x10012:0x0000000b>amo:\nHe detectado el aura de Zelda\nen las cercanías.")
/*< 44>*/ 	set_camera(1, 0)
/*< 43>*/ 	printf(/* textboxtype: 0, unk: 1, line: 19 */ "Esta cadena emite una señal muy\nfuerte. La probabilidad de que Zelda\nhaya estado sujeta a ella es del 95%.")
/*< 45>*/ 	set_camera(-1, 0)
/*< 46>*/ 	printf(/* textboxtype: 0, unk: 0, line: 20 */ "Desconozco cómo, pero deduzco\nque Zelda consiguió escapar de\neste lugar. Recomiendo proseguir\nla marcha cuanto antes.")
          }
