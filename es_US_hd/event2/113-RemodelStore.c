...
/*< 92>*/ 	switch (story_flags[325 /* us: 805A9AFF 0x08, jp: 805ACD7F 0x08 */]) {
          	  case 0:
/*< 93>*/ 		printf(/* textboxtype: 18, unk: 0, line: 114 */ "<0x10009:0x00000003>¡Eh, chico! ¿Te está tratando bien\nel Serbot? ¿Necesitas que te haga\nalgún arreglo?\n[1-]Mejorar[2-]Escudo[3]Nada")
          		flw_4:
/*<  4>*/ 		switch (choice(3)) {
          		  case 0:
/*< 31>*/ 			switch (context_related2(0)) {
          			  case 0:
/*<  2>*/ 				printf(/* textboxtype: 0, unk: 1, line: 1 */ "<0x10009:0x00000009>¡Hecho! Estos son los objetos\nque pueden mejorarse por ahora.")
...
/*< 70>*/ 				printf(/* textboxtype: 0, unk: 1, line: 4 */ "<0x10009:0x000e0e0c>Pero... ¡si no tienes ningún escudo\nque arreglar!\n\n\n¿No te da vergüenza burlarte así\nde un honrado trabajador, chico?")
          		  ...
          		  case 2:
/*<  3>*/ 			printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x10009:0x000e0e0c>¿Eh? Pues entonces, ¿qué haces aquí?")
          		}
          	  case 1:
...
/*< 84>*/ 						switch (choice(2)) {
          						  case 0:
/*< 85>*/ 							printf(/* textboxtype: 19, unk: 0, line: 102 */ "<0x10009:0x00070717>¿Eh? ¿Dices que tú tienes una?\n¡Chico, eso es increíble!")
...
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10009:0x00080806>Bien, ¡manos a la obra! Pero debes\nsaber que los cambios que haga son\npermanentes, ¿eh?\n[1-]Adelante[2]Déjalo")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
...
/*< 26>*/ 		zone_temp_flags[4 /* 0x1 10 */] = true;
          	  case 1:
/*< 11>*/ 		printf(/* textboxtype: 0, unk: 1, line: 7 */ "<0x10009:0x000e0e05>¡Pero...! ¿Qué, te divierte reírte\nde los pobres trabajadores, chico?\n\n\n¡Anda, ve a burlarte de otro,\ngraciosillo!")
...
/*< 27>*/ 	switch (zone_temp_flags[4 /* 0x1 10 */]) {
          	  case 0:
/*< 28>*/ 		printf(/* textboxtype: 0, unk: 1, line: 10 */ "<0x10009:0x00080800>¡Muchas gracias! Es un placer hacer\nnegocios contigo.<0x10009:0x00000002>")
...
/*< 49>*/ 	printf(/* textboxtype: 19, unk: 0, line: 120 */ "<0x10009:0x161a0200>Oooh... ¿Quién...?\n<0x10009:0x160e0200>¿Quién es esta... preciosidad?")
/*<126>*/ 	set_camera(10, 0)
/*<129>*/ 	printf(/* textboxtype: 0, unk: 17, line: 121 */ "<0x10009:0x160e0200>Te... ¿te llamas Fay? ¿Sí? Oye, ¿qué\ndecías que buscabas exactamente?")
...
/*< 73>*/ 	printf(/* textboxtype: 0, unk: 1, line: 16 */ "<0x10009:0x00080800>Arreglar este escudo te costará\n<color red<10 rupias>coloroff>. ¿De acuerdo?\n[1-]Sí[2]Déjalo")
/*< 74>*/ 	switch (choice(2)) {
          	  case 0:
...
/*< 82>*/ 			printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10009:0x000e0e0c>Chico, te faltan rupias...\nSerá mejor que vuelvas cuando \nhayas ahorrado un poco.")
          	  ...
          	  case 1:
/*< 75>*/ 		printf(/* textboxtype: 0, unk: 0, line: 17 */ "Muy bien, entonces lo dejamos.\n¿Tienes otro escudo que quieras\narreglar?")
