...
/*< 47>*/ 				printf(/* textboxtype: 1, unk: 1, line: 6 */ "<0x10009:0x00000702>Mmm, ¿seguro? Bien, la senda\nde tu destino se abre ante ti; solo\ntienes que recorrerla. ¡Adelante!")
          		  ...
          		  case 1:
/*< 41>*/ 			printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x10009:0x00000701>Vaya... ¡mira quién está aquí!\n\n\n\n<0x10009:0x00000700>Joven elegido, ¿acaso tienes\nalgo que preguntarme?\n[1-]<color blue<Dragona agua>coloroff>[2-]<color blue<Dragón trueno>coloroff>[3-]Volcán[4]Olvídalo")
          			goto flw_42
          		}
          	  case 1:
...
/*< 33>*/ 				changeScene(4, 0) // 
          			  case 1:
          				flw_57:
/*< 57>*/ 				set_camera(5, 0)
/*< 27>*/ 				printf(/* textboxtype: 0, unk: 1, line: 1 */ "Me temo que te has visto atrapado\nen la erupción del volcán que se\nprodujo tras el estallido de mi poder.\nTe pido disculpas...\nEn cualquier caso, creo que el cielo\nestará despejado muy pronto.\n\n\nPuedes marcharte cuando lo desees.")
...
/*< 22>*/ 			printf(/* textboxtype: 0, unk: 0, line: 20 */ "<0x10009:0x000e0e0b>Muy bien, ¡yo sigo con mi búsqueda\nde tesoros!\n\n\n¡Hasta pronto, chico!")
...
/*< 24>*/ 			{'type': 'type3', 'subType': 4, 'param1': 18, 'param2': -1, 'next': -1, 'param3': 13}
          	  ...
          	  case 1:
/*< 10>*/ 		printf(/* textboxtype: 1, unk: 0, line: 15 */ "<0x10009:0x00000001>¡Chico!")
/*< 18>*/ 		printf(/* textboxtype: 0, unk: 1, line: 16 */ "<0x10009:0x000f0e00>¡¿Qué estás haciendo?!\n¿Cómo se te ocurre venir\nhasta aquí desarmado?\n\n¡¿No te he dicho que esto está lleno\nde monstruos?!\n\n\n<0x10009:0x000e0e03>¡Vigila bien tus pasos!")
          	}
          }
...
/*< 69>*/ 	switch (scene_flags[121 /* 0xE 02 */]) {
          	  case 0:
/*< 71>*/ 		printf(/* textboxtype: 0, unk: 1, line: 25 */ "¡Eh, tú! Tengo información fresquita\npara ti. ¿Te interesa?\n[1-]Claro que sí[2]No hace falta")
          		flw_66:
/*< 66>*/ 		switch (choice(2)) {
          		  case 0:
/*< 68>*/ 			changeScene(2, 0) // 
          		  case 1:
/*< 67>*/ 			printf(/* textboxtype: 1, unk: 0, line: 27 */ "Muy bien. Entonces, ¡buena suerte!")
          		}
          	  case 1:
/*< 65>*/ 		printf(/* textboxtype: 1, unk: 0, line: 24 */ "¡Eh! Tengo nuevas visiones para ti.\n¿Quieres verlas?[1-]Claro que sí[2]No hace falta")
...
/*< 79>*/ 		switch (story_flags[226 /* us: 805A9AF2 0x08, jp: 805ACD72 0x08 */]) {
          		  case 0:
/*< 81>*/ 			printf(/* textboxtype: 1, unk: 0, line: 24 */ "¡Eh! Tengo nuevas visiones para ti.\n¿Quieres verlas?[1-]Claro que sí[2]No hace falta")
          			flw_74:
/*< 74>*/ 			switch (choice(2)) {
          			  case 0:
/*< 76>*/ 				changeScene(2, 0) // 
          			  case 1:
/*< 75>*/ 				printf(/* textboxtype: 1, unk: 0, line: 27 */ "Muy bien. Entonces, ¡buena suerte!")
          			}
          		  case 1:
/*< 80>*/ 			printf(/* textboxtype: 0, unk: 0, line: 26 */ "¡Eh! <pause 10>No tengo nada nuevo para ti,\npero puedes ver todo lo que hay\ndisponible hasta el momento.\n\n¿Quieres ver algo?\n[1-]Claro que sí[2]No hace falta")
          			goto flw_74
          		}
          	  case 1:
/*< 73>*/ 		printf(/* textboxtype: 1, unk: 0, line: 24 */ "¡Eh! Tengo nuevas visiones para ti.\n¿Quieres verlas?[1-]Claro que sí[2]No hace falta")
