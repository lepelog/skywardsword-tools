          void entrypoint_451_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0, line: 0 */ "Con toda probabilidad, el objeto\ndescubierto es el artículo perdido\ndel sujeto de la isla Fortuna.\n\nRecomiendo llamar al robot de\nla chatarrería para que venga\na recogerlo.\n[1-]Adelante[2]Dejémoslo")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  3>*/ 		printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x10012:0x00000005>Sí, amo. Avisaré al robot telepáticamente.")
          	  case 1:
/*<  4>*/ 		printf(/* textboxtype: 0, unk: 2, line: 1 */ "<0x10012:0x00000005>Está bien, amo. En caso de cambiar\nde opinión, sugiero volver a examinar\nel objeto.")
          	}
          }

          void entrypoint_451_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x00000064>Fay, preciosa, ¿me llamabas?\n\n\n\nMmm, este lugar me resulta\nextrañamente familiar...\n\n\nBueno, no importa, estamos aquí\npara trabajar. Esto es lo que quieres\nque me lleve, ¿verdad?")
          }

          void entrypoint_451_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "<0x10012:0x00000064>Muy bien, me lo llevo volando. Te espero\nsurcando los cielos, linda. ¡Ven pronto!")
          }

          void entrypoint_451_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10012:0x00000001>Amo, sugiero que nosotros también\nnos pongamos en camino hacia la\nisla Fortuna.")
