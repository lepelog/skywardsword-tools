...
/*< 11>*/ 			printf(/* textboxtype: 9, unk: 2, line: 9 */ "En la alforja no te cabe nada más y\nla <color red<consigna >coloroff>también está llena.\n\n\nEl objeto tiene que quedarse en el cofre.")
          		  case 1:
/*< 10>*/ 			printf(/* textboxtype: 2, unk: 0, line: 8 */ "¡La alforja está llena, así que te guardarán\neste objeto en la <color red<consigna>coloroff>!")
          		}
          	  case 1:
          	}
          }
...
/*< 41>*/ 	start()
/*< 40>*/ 	printf(/* textboxtype: 1, unk: 1, line: 27 */ "Dicen que si dibujas dinero en los\nmuros misteriosos, puedes llevarte\nmuchas rupias fácilmente.")
          }
