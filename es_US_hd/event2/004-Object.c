...
/*< 33>*/ 	start()
/*< 32>*/ 	printf("Me han dicho que si logras una\npuntuación alta en <b<La vertiginosa\nmontaña rusa>>, te dan una <y<pieza\nde corazón>>.")
          }

          void entrypoint_004_016() {
/*< 48>*/ 	start()
/*< 49>*/ 	printf("\x0E\x01\x0F\x00¿Hasta cuándo quieres dormir?\x0F\x01\x0F\n\n[1]Hasta la\nmañana[2]Hasta la\nnoche[3-]Mejor no")
/*< 50>*/ 	switch (choice(3)) {
          	  case 0:
          	  case 1:
          	  case 2:
...
/*<  6>*/ 	start()
/*<  7>*/ 	printf("¿Quiere el \x0E\x01\x12\x04\x00\x01amo salir de Hypnea?\n[1]Sí[2-]No")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
