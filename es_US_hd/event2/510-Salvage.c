          void entrypoint_510_01() {
          	start()
/*<  1>*/ 	printf("Confirmo que este es el <r<rotor del molino\n>>que buscábamos.\n\n\nEl robot ya está disponible para recogerlo\ny transportarlo.\n\n\n¿Desea el \x0E\x01\x12\x04\x00\x01amo que lo llame?\n[1]Adelante[2-]No")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf("\x0E\x01\x12\x04\x00\x05Muy bien, amo. Avisaré al robot\ntelepáticamente.<pling>")
          	  case 1:
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x05Está bien, amo. Le recuerdo que basta con\nexaminar de nuevo el rotor en caso de\ncambiar de opinión.")
          	}
          }

          void entrypoint_510_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf("\x0E\x01\x12\x04\x00d¡Mi Fay querida!\n¡Lamento la tardanza!\n\n\nEs esto, ¿no? ¡Perfecto, yo me encargo\nde todo!")
          }

          void entrypoint_510_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf("\x0E\x01\x12\x04\x00dMuy bien, ¡me voy volando!\n¡Espero verte pronto, preciosa!")
          }
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf("\x0E\x01\x12\x04\x00d¡Oye, amo verdoso! ¿Por qué no te haces\na un lado para que pueda pasar?")
          }
