...
/*< 81>*/ 		printf(/* textboxtype: 0, unk: 0, line: 23 */ "<0x10009:0x331b0502>Bueno, chico, yo me largo. ¡Adiós!")
          	  case 1:
...
/*< 16>*/ 		switch (choice(2)) {
          		  case 0:
/*<119>*/ 			printf(/* textboxtype: 0, unk: 1, line: 25 */ "<0x10009:0x00080509>¡Ja, ja! ¡Te han engañado, amigo!")
          			flw_17:
...
/*< 29>*/ 			scene_flags[15 'Eldin: Fire Sanctuary'][101 /* 0xD 20 */] = true;
          		  case 1:
/*<120>*/ 			printf(/* textboxtype: 0, unk: 62, line: 26 */ "<0x10009:0x00080509>¡No te molestes en disimular! ¡Solo puede\nhaber una razón por la que estés aquí,\nchico!")
          			goto flw_17
          		}
          	}
          }
...
/*<132>*/ 		switch (scene_flags[119 /* 0xF 80 */]) {
          		  case 0:
/*<133>*/ 			printf(/* textboxtype: 0, unk: 0, line: 35 */ "<0x10009:0x001b1a15>Eres de armas tomar, chico...\n¡Has reventado el muro!")
          		  case 1:
...
/*< 39>*/ 	switch (scene_flags[105 /* 0xC 02 */]) {
          	  case 0:
/*<151>*/ 		set_camera(2, 0)
/*<149>*/ 		printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10009:0x00111213>¡Oye, oye! ¡Te lo ruego, chico!\n¡Tienes que liberarme como sea!\n\n\n<0x10009:0x00161614>¡Te aseguro que tengo información\nmuy útil! ¡En serio!")
...
/*<143>*/ 			switch (choice(2)) {
          			  case 0:
/*<147>*/ 				printf(/* textboxtype: 0, unk: 1, line: 10 */ "<0x10009:0x331b2200>Ya sabes, a buscar la puerta...\nPero acuérdate de lo que hemos\nacordado, ¿entendido?")
          				flw_123:
