...
/*< 68>*/ 					switch (choice(2)) {
          					  case 0:
/*< 67>*/ 						printf("\x0E\x01\x09\x04\x0F\x120EVeo que hoy tienes ganas de jugar\nbromas, ¿no? Ya está bien, guapetón.")
          						flw_70:
...
/*<379>*/ 	start()
/*<361>*/ 	printf("\x0E\x01\x09\x04\x1F0A\x309Me debes <r<unas 10 rupias>>, niño, ¡esas\npiezas eran muy caras! ¡Y no me\nvengas con excusas!")
/*<362>*/ 	switch (random(4)) {
          	  case 0:
