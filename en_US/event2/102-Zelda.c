...
/*<183>*/ 	start()
/*<184>*/ 	printf(/* textboxtype: 1, unk: 0, line: 45 */ "While riding your Loftwing, you\ncan press (2) at any time to go over\nthe basic controls again.<0x10011:0x05cd>\n\nYou can also press (A) to <color green<charge>coloroff>, which\nis an attack that also gives you a <color red<burst\nof speed>coloroff>. Press (B) to <color red<slow down>coloroff>. Try all\nthese moves and see how they feel!<0x10011:0x01cd>")
          }

          void entrypoint_102_16() {
/*<223>*/ 	start()
/*<224>*/ 	printf(/* textboxtype: 1, unk: 0, line: 46 */ "Here's a tip for how to really <color red<build up\nsome speed >coloroff>on your bird,\n<heroname>!\n\n<color green<Swing>coloroff><color green<<color green< <color green<the Wii Remote up and down>coloroff>,\nand when you are <color red<high>coloroff> enough, <color green<tilt the\nWii Remote downward >coloroff>to go into a\ndescent that increases your speed.\nSwing up and down, then tilt down.\nGot it? That's how you increase\nyour speed!")
          }

          void entrypoint_102_01() {
          	start()
/*<199>*/ 	{'type': 'type3', 'subType': 4, 'param1': 0, 'param2': 26, 'next': 1, 'param3': 13}
/*<  1>*/ 	printf(/* textboxtype: 1, unk: 0, line: 0 */ "<0x30001:0x><heroname>, I'm going to tend to\nmy bird and make sure he's not hurt.\nI'll catch up with you later.\n\n<0x10009:0x00000500>Go and see if anyone in town knows\nwhat happened to your Loftwing.")
          }
...
/*<  3>*/ 	printf(/* textboxtype: 1, unk: 0, line: 1 */ "Hey, <heroname>, I was hoping\nI'd find you here.\n\n\n<0x1000A:0x001700cd>I heard you'd gone searching for your\nbird around the waterfall, so I thought\nI'd fly around and help you look.\n\nHow's your search going? Any sign of\nyour Loftwing?")
/*< 76>*/ 	printf(/* textboxtype: 1, unk: 0, line: 2 */ "<0x10009:0x01000514>Oh no...\n\n\n\n<0x10009:0x01000c00>Well, let's not lose hope yet. There's a\nplace up ahead that Groose and his\ngang are always hanging around.\nMaybe we'll find something there!")
/*<138>*/ 	set_camera(22, 0)
...
/*<135>*/ 	printf(/* textboxtype: 1, unk: 0, line: 7 */ "<0x10006:0xfccd>Huh...?<0x10006:0x00cd>")
/*<170>*/ 	set_camera(25, 0)
/*<171>*/ 	printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x01001500>Who... Who's that?\n\n\n\n<0x10009:0x01001500>Who's calling for me?")
/*<139>*/ 	set_camera(24, 0)
/*<141>*/ 	{'type': 'type3', 'subType': 4, 'param1': 268, 'param2': 5376, 'next': 136, 'param3': 13}
/*<136>*/ 	printf(/* textboxtype: 1, unk: 0, line: 6 */ "Oh<pause 20>, sorry, <heroname>. I got\ndistracted for a moment. Let's go!")
...
/*<  5>*/ 	printf(/* textboxtype: 1, unk: 0, line: 9 */ "Look! There he is!")
/*< 21>*/ 	set_camera(2, 0)
/*< 14>*/ 	printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x00090500><0x10008:0x01cd>No doubt about it. That's your\nLoftwing, <heroname>!")
...
/*< 73>*/ 	switch (scene_flags[3 /* 0x1 08 */]) {
          	  case 0:
/*< 74>*/ 		printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10009:0x00001514>Oh boy, I see you messed up your\nlanding.\n\n\n<0x10009:0x00000c00>Remember, <color red<once you dive >coloroff>off the edge,\nyou can control the angle of your fall\nby <color green<tilting >coloroff>the Wii Remote. I bet you're\nready to try again, aren't you?\nI won't push you this time, so take\nthe leap when you're ready! \n\n\nJust <color green<dash >coloroff>off the edge to jump into a\ndive. Then, just before you hit the\nground, press and hold (B)!<0x10011:0x01cd>\n\nOh, and don't forget that you've got to\nland in the <color red<middle of that round design\nin that courtyard below>coloroff>.")
...
/*< 10>*/ 		switch (story_flags[39 /* us: 805A9AE5 0x20, jp: 805ACD65 0x20 */]) {
          		  case 0:
/*<173>*/ 			printf(/* textboxtype: 1, unk: 0, line: 17 */ "<0x10009:0x00000004>OK, let's try this again, shall we?\nThis time you won't have me to push\nyou over the edge, so gather up some\ncourage and JUMP!\nJust <color green<dash >coloroff>off the edge to leap into\na dive.\n\n\nOh, and just before you land, be sure\nyou press (B) to open up your\nSailcloth and slow your fall, or it's\ngoing to be an ugly landing...<0x10011:0x01cd>\nAnd don't forget that you've got to\nland in the <color red<middle of that round\ndesign in the courtyard below>coloroff>!")
          		  case 1:
/*<  8>*/ 			switch (story_flags[26 /* us: 805A9ADA 0x04, jp: 805ACD5A 0x04 */]) {
          			  case 0:
/*<  9>*/ 				printf(/* textboxtype: 1, unk: 0, line: 13 */ "<0x10009:0x000f0513>That's so cruel! They've boarded him\nup in there!\n\n\n<0x30001:0x><heroname>, can you do\nsomething to get all those planks out of\nthe way?")
          			  case 1:
/*<  7>*/ 				printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00000006>What're you waiting around for,\n<heroname>? Let's go get\nyour Loftwing!")
          			}
          		}
          	}
          }
...
/*< 23>*/ 	printf(/* textboxtype: 1, unk: 1, line: 19 */ "<0x10009:0x000c0e09>Your Loftwing really is amazing.\nEspecially considering everything the\npoor guy has been through this\nmorning.\n<0x10009:0x00000c00>I'm going to fly back and tell Father\nwhat happened.")
/*< 64>*/ 	set_camera(10, 0)
...
/*< 67>*/ 	set_camera(18, 0)
/*< 30>*/ 	printf(/* textboxtype: 1, unk: 2, line: 28 */ "Groose! Pssst, Groose!\n<pause 30>Behind you!<pause 30> Right behind you!")
/*< 52>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': 5, 'next': 31, 'param3': 16}
/*< 31>*/ 	printf(/* textboxtype: 1, unk: 1, line: 29 */ "<0x10009:0x04000000><0x1000A:0x000b00cd>WHAT?! Can't you two see I'm in the\nmiddle of--")
...
/*< 32>*/ 	printf(/* textboxtype: 1, unk: 1, line: 30 */ "<0x10009:0x04191715>GAH!")
...
/*< 98>*/ 	set_camera(18, 0)
/*< 35>*/ 	printf(/* textboxtype: 1, unk: 1, line: 34 */ "<0x10009:0x05050013><0x10009:0x06070000>Hey, Groose!<0x10005:0x00140000> Wait up!")
...
/*<206>*/ 	wait_frames(5)
/*< 69>*/ 	set_camera(16, 0)
/*< 36>*/ 	printf(/* textboxtype: 1, unk: 1, line: 35 */ "<0x10009:0x00091014>Did you hear that guy? A fair race? \nYeah, the chances of that happening\nare just about less than zero.\n\n<0x10009:0x0000ff00>Either way, don't let those fools get\nyou down, <heroname>! Just get\nout there and fly the best you can!\n\nI know you've got these guys beat, and\ndeep down I think you do too.\n[1-]Yeah![2-]I dunno...[3-]Us? Alone?")
/*< 57>*/ 	switch (choice(3)) {
          	  case 0:
/*< 37>*/ 		printf(/* textboxtype: 1, unk: 1, line: 36 */ "<0x10009:0x000c0e00>That's the spirit, <heroname>!\nTrust me--you can win this.")
          		flw_101:
...
/*< 40>*/ 		printf(/* textboxtype: 1, unk: 2, line: 39 */ "The Wing Ceremony will now begin!\nParticipating students, please\nassemble!")
/*< 59>*/ 		{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': 100, 'next': 41, 'param3': 16}
/*< 41>*/ 		printf(/* textboxtype: 1, unk: 1, line: 40 */ "Looks like it's race time. Good luck,\n<heroname>!")
/*< 70>*/ 		changeScene(18, 0) // 
          	  case 1:
/*< 38>*/ 		printf(/* textboxtype: 1, unk: 1, line: 37 */ "<0x10009:0x000c1500>Aww, don't be nervous. You can do this!")
          		goto flw_101
          	  case 2:
/*< 39>*/ 		printf(/* textboxtype: 1, unk: 1, line: 38 */ "<0x10009:0x00100e04>Come on, <heroname>! Try to \nfocus for once.")
          		goto flw_101
          	}
          }
...
/*< 82>*/ 	start()
/*< 83>*/ 	printf(/* textboxtype: 1, unk: 0, line: 42 */ "<0x30001:0x><heroname>, let's run your bird\nthrough the basics just to\nmake sure he's not hurt.")
/*< 84>*/ 	printf(/* textboxtype: 1, unk: 0, line: 43 */ "You can change the direction your bird\nis flying by <color green<tilting >coloroff>the Wii Remote to\nthe <color green<left and right>coloroff>.\n\nWhen you want to <color red<speed up>coloroff>...\n\n\n\n<color green<Swing the Wii Remote up>coloroff> to gain some\n<color red<altitude>coloroff>, then <color green<point the Wii Remote\ndown >coloroff>to drop into a fast dive!\n\nSo, again, <color green<tilt the Wii Remote up>coloroff>,\nthen <color green<point the Wii Remote down>coloroff> to\nspeed up! Those are the basics of\ngetting your bird up to top speed.")
/*< 85>*/ 	printf(/* textboxtype: 1, unk: 0, line: 44 */ "So how's he handling? Do you think\nhe's flying all right?")
          }

          void entrypoint_102_09() {
/*< 88>*/ 	start()
/*< 89>*/ 	printf(/* textboxtype: 1, unk: 0, line: 47 */ "Well, that's a huge relief! I don't know\nabout you, <heroname>, but your\nLoftwing looks like he's flying great.\n\nMy father and the others are probably\nworried about your bird, so let's go\ngive them the good news!")
          }
