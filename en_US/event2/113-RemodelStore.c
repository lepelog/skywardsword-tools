...
/*<174>*/ 	start()
/*<177>*/ 	printf(/* textboxtype: 1, unk: 0, line: 25 */ "<0x10009:0x000e0e0c>Hey, kid! You're a little short on\nmaterials. You don't have enough\n<color yellow<<item 164>s>coloroff>.\n\nMy grandpa's notes say you can get\nthese from monsters that look like\nlizards.")
/*<178>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<179>*/ 	start()
/*<182>*/ 	printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x000e0e0c>Looks like you're coming up short on\nmaterials, kid. Yep, you don't have\nenough <color yellow<<item 165>>coloroff>.\n\nMy grandpa's notes say you can find\nthat stuff buried within fiery\nmountains.")
/*<187>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*< 92>*/ 	switch (story_flags[325 /* us: 805A9AFF 0x08, jp: 805ACD7F 0x08 */]) {
          	  case 0:
/*< 93>*/ 		printf(/* textboxtype: 1, unk: 1, line: 114 */ "<0x10009:0x00000003>Hey, kid! How's <color blue<Scrapper>coloroff> treating\nyou? Anything to upgrade today?\n[1-]Upgrade.[2-]Repair shield.[3]No, thanks.")
          		flw_4:
/*<  4>*/ 		switch (choice(3)) {
          		  case 0:
/*< 31>*/ 			switch (context_related2(0)) {
          			  case 0:
/*<  2>*/ 				printf(/* textboxtype: 1, unk: 0, line: 1 */ "<0x10009:0x00000009>You got it! These are all the items you\nhave that I can upgrade right now.")
...
/*<189>*/ 	start()
/*<192>*/ 	printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x000e0e0c>Hey, kid! Looks like you're a bit\nshort on materials. You don't have\nenough <color yellow<<item 167>s>coloroff>.\n\nMy grandpa's notes say you can find\n<color yellow<<item 167>s>coloroff> on the common in lots of\ndifferent places. Seems like it's one\ntreasure that's not so hard to find.")
/*<193>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x00080806>All right. You want to upgrade this?\nThere's no going back, y'hear?\n[1-]Go for it![2]Never mind.")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
...
/*< 14>*/ 		printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x00080809>All done! Here you go!")
/*< 26>*/ 		zone_temp_flags[4 /* 0x1 10 */] = true;
          	  case 1:
/*< 11>*/ 		printf(/* textboxtype: 1, unk: 0, line: 7 */ "<0x10009:0x000e0e05>Make up your mind, little buddy!\nTry picking something else.")
...
/*<198>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*< 27>*/ 	switch (zone_temp_flags[4 /* 0x1 10 */]) {
          	  case 0:
/*< 28>*/ 		printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x00080800>Oh, thanks! Come again soon, y'hear!<0x10009:0x00000002>")
...
/*< 58>*/ 	start()
/*< 60>*/ 	printf(/* textboxtype: 1, unk: 0, line: 113 */ "<0x10012:0x00000065><0x10009:0x0000000f>Phew<0x10006:0xfccd>...<0x10006:0x00cd> There you go!<0x10005:0x001e0000>")
          }

          void entrypoint_113_38() {
/*<199>*/ 	start()
/*<202>*/ 	printf(/* textboxtype: 1, unk: 0, line: 31 */ "<0x10009:0x000e0e0c>Hey, kid! Looks like you're a bit\nshort on materials. You don't have\nenough <color yellow<<item 169>s>coloroff>.\n\nMy grandpa's notes say you can get\nthat disgusting stuff from soft,\nsquishy monsters.")
/*<207>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<152>*/ 	switch (context_related2(0)) {
          	  case 0:
/*< 16>*/ 		printf(/* textboxtype: 1, unk: 0, line: 11 */ "If you've got anything else you want\nme to tinker around with, you just let\nme know!")
...
/*<156>*/ 	printf(/* textboxtype: 2, unk: 0, line: 126 */ "However, it will not be possible to\ncarry the item in your pouch and\nreturn to the sky.")
/*<125>*/ 	set_camera(11, 0)
...
/*< 49>*/ 	printf(/* textboxtype: 1, unk: 0, line: 120 */ "<0x10009:0x161a0200>Who are you?!\n<0x10009:0x160e0200>ZRRPT-FOOOSH!")
/*<126>*/ 	set_camera(10, 0)
/*<129>*/ 	printf(/* textboxtype: 1, unk: 0, line: 121 */ "<0x10009:0x160e0200>Your name is...Fi? Dzzt! Should I call\nyou Mistress Fi? Are you looking for\nsomething, Mistress Fi?")
/*<116>*/ 	printf(/* textboxtype: 1, unk: 0, line: 122 */ "<0x10009:0x160c0200>I... <pause 20>I understand, vrrt!\n\n\n\n<0x10009:0x160e0200>At your request, I will carry anything,\nregardless of weight or destination...\nwhizzt!")
...
/*<240>*/ 		printf(/* textboxtype: 1, unk: 0, line: 33 */ "<0x10009:0x00100e11>Hmm...though now that I think of it,\nnights around here have been strangely\nmonster free lately!")
          		flw_208:
/*<208>*/ 		printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<209>*/ 	start()
/*<212>*/ 	printf(/* textboxtype: 1, unk: 0, line: 34 */ "<0x10009:0x000e0e0c>Hey, kid! Looks like you're a bit\nshort on materials. You don't have\nenough <color yellow<<item 171>s>coloroff>.\n\nGrandpa's notes say you can get 'em\nfrom monsters that use them to call\ntheir buddies, but you'd need to pull\n'em out of their hands using something.")
/*<213>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<214>*/ 	start()
/*<217>*/ 	printf(/* textboxtype: 1, unk: 0, line: 35 */ "<0x10009:0x000e0e0c>Looks like you're coming up short on\nmaterials, kid. Yep, you don't have\nenough <color yellow<<item 172>s>coloroff>.\n\nAccording to my grandpa's notes,\nyou can sometimes get these from\nmonsters that carry clubs...")
/*<218>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*< 73>*/ 	printf(/* textboxtype: 1, unk: 0, line: 16 */ "<0x10009:0x00080800>OK. One shield in need of patching up.\nThat'll be <color red<10 rupees>coloroff>.\n[1-]OK![2]No, thanks.")
/*< 74>*/ 	switch (choice(2)) {
          	  case 0:
...
/*< 80>*/ 			printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x00080809>All done! Here you go!")
          		  case 1:
/*< 82>*/ 			printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10009:0x000e0e0c>Hey, kid! You don't have enough\nRupees! Go find some and come back!")
          		}
          	  case 1:
/*< 75>*/ 		printf(/* textboxtype: 1, unk: 0, line: 17 */ "Not interested, huh? Do you need me\nto fix anything else?")
...
/*<227>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<107>*/ 	switch (context_related2(2)) {
          	  case 0:
/*<108>*/ 		printf(/* textboxtype: 1, unk: 0, line: 19 */ "<0x10009:0x00080800>Hey, kid! You want me to fix any of\nyour other shields?")
/*<110>*/ 		make_actor_do_something(10, 0)
          	  case 1:
/*<109>*/ 		printf(/* textboxtype: 1, unk: 0, line: 20 */ "<0x10009:0x00080800>Hey, kid! Looks like you're out of\nshields that need repairing.\nSee you later!")
          	}
          }

          void entrypoint_113_43() {
/*<223>*/ 	start()
/*<226>*/ 	printf(/* textboxtype: 1, unk: 0, line: 37 */ "<0x10009:0x000e0e0c>Hey, kid! Looks like you're a bit\nshort on materials. You don't have\nenough <color yellow<<item 174>s>coloroff>.\n\nMy grandpa's notes say you can get\nthese feathers from the rare little\nblue birds living in wooded areas.\nYou'll need a Bug Net, though!")
/*<228>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<229>*/ 	start()
/*<232>*/ 	printf(/* textboxtype: 1, unk: 0, line: 38 */ "<0x10009:0x000e0e0c>Hey, kid! Looks like you're a bit\nshort on materials. You don't have\nenough <color yellow<<item 175>s>coloroff>.\n\n<color yellow<<0x30001:0x><item 175>s>coloroff> are <item 172>s\nthat shine bright like gold. Seems like\nthey are crazy rare!")
/*<233>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<238>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<167>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<163>*/ 	start()
/*<166>*/ 	printf(/* textboxtype: 1, unk: 0, line: 23 */ "<0x10009:0x000e0e0c>Hey, kid! It looks like you're a bit short\non materials. You don't have enough\n<color yellow<<item 162>s>coloroff>.\n\nMy grandpa's notes say you can find\nthese feathers on little birds living in\nwooded areas. If you find one, you'll\nneed to use your Bug Net to catch it.")
/*<168>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
...
/*<173>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00070700>So, is there anything else you want to\nupgrade?")
