...
/*<  9>*/ 	start()
/*< 10>*/ 	printf("\x0E\x01\x06\x02\xFECDYou...<pause0F>do know what happens at the\nend, right?<pause1E> \n\n\n[1]Nope.[2]Uh-oh...[3]Sort of...")
