...
/*<481>*/ 				switch (context_related2(1)) {
          				  case 0:
/*<489>*/ 					printf("\x0E\x01\x09\x04\x12\x600Hmmm, how many Rupees can I offer\nfor each <y<<string arg0>>>... \nDoes <numeric arg0> seem fair?")
          					flw_656:
/*<656>*/ 					{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 412, 'param3': 12}
/*<412>*/ 					printf("\x0E\x01\x09\x04\x10\x600I see that you're carrying <numeric arg4> of those.\nHow many will you sell me?\n[1]1.[2]5.[3]All of them![4-]No deal.")
/*<411>*/ 					switch (choice(4)) {
          					  case 0:
...
/*<497>*/ 						switch (context_related2(0)) {
          						  case 0:
/*<409>*/ 							printf("<y<\x0E\x01\x09\x04\x12\x900>>Ah, the old <y<<string arg0>>> deal, eh?\nAnd you've got <numeric arg0> of 'em?\nLet's see, how many Rupees is that\nworth...  Let's say <numeric arg1>?\n[1]It's a deal![2-]Never mind.")
/*<408>*/ 							switch (choice(2)) {
          							  case 0:
/*<430>*/ 								printf("\x0E\x01\x09\x04\x10\x80AAll right. Here's your money.")
...
/*<574>*/ 								{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': -1, 'next': -1, 'param3': 42}
          							  case 1:
          								flw_410:
/*<410>*/ 								printf("\x0E\x01\x09\x04\x0F\x0COh. Really? OK, well, hopefully you'll\ncome back again sometime.")
          							}
          						  case 1:
/*<431>*/ 							printf("\x0E\x01\x09\x04\x0F\x409You don't even have that many!\nQuit wasting my time.")
          							goto flw_656
          						}
          					  case 1:
...
/*<482>*/ 				switch (context_related2(1)) {
          				  case 0:
/*<490>*/ 					printf("\x0E\x01\x09\x04\x12\x600Hmmm, how many Rupees can I offer\nfor each <y<<string arg1>>>... \nDoes <numeric arg1> seem fair?")
          					goto flw_656
          				  case 1:
          					goto flw_494
          				}
...
/*<483>*/ 				switch (context_related2(1)) {
          				  case 0:
/*<491>*/ 					printf("\x0E\x01\x09\x04\x12\x600Hmmm, how many Rupees can I offer\nfor each <y<<string arg2>>>... \nDoes <numeric arg2> seem fair?")
          					goto flw_656
          				  case 1:
          					goto flw_494
          				}
...
/*<484>*/ 				switch (context_related2(1)) {
          				  case 0:
/*<492>*/ 					printf("\x0E\x01\x09\x04\x12\x600Hmmm, how many Rupees can I offer\nfor each <y<<string arg3>>>... \nDoes <numeric arg3> seem fair?")
          					goto flw_656
          				  case 1:
          					goto flw_494
          				}
...
/*<441>*/ 		switch (choice(2)) {
          		  case 0:
/*<440>*/ 			printf("\x0E\x01\x09\x04\x0F\x409You want to do some shopping? Just\ncome back to the shop tomorrow.")
          		  case 1:
/*<439>*/ 			printf("\x0E\x01\x09\x04\x13\x609So when you say \x201Cum\"...that means\nyou don't have a good reason to be\nhere, huh?")
...
/*< 57>*/ 		printf("\x0E\x01\x09\x04\x00TUgh... Nngh...nngh...\nH-help...")
...
/*<536>*/ 		printf("\x0E\x01\x09\x04\x00\x17Ugh... Stupid <b<Pipit>>... So much hate\nfor you... For crying out loud...")
          	}
          }
...
/*<452>*/ 									switch (context_related2(0)) {
          									  case 0:
/*<456>*/ 										printf("\x0E\x01\x09\x04\x03\x14I love a good <y<<string arg0>>>...\nAnd you're selling <numeric arg0> of 'em, eh?\nHow many Rupees should I throw your\nway... I'm gonna say <numeric arg1>.\n[1]OK![2-]Never mind.")
/*<449>*/ 										switch (choice(2)) {
          										  case 0:
...
/*<450>*/ 											printf("\x0E\x01\x09\x04\x03\xFF04Thanks, mantis face!\n\n\n\nI mean that in a good way! I love\nmantises. Well, I'm looking forward\nto seeing more of your bugs,\nLink.")
          										  case 1:
          											flw_473:
/*<473>*/ 											printf("\x0E\x01\x09\x04\x01\xFF13Well, that's too bad...\n\x0E\x01\x09\x04\x00\x500I guess I'll \x201Cbee\" seeing you...")
          										}
          									  case 1:
/*<459>*/ 										printf("\x0E\x01\x09\x04\x12\x100You don't have that many... So I'll ask\nyou again...")
          										goto flw_657
          									}
          								  case 1:
...
/*<462>*/ 							switch (context_related2(1)) {
          							  case 0:
/*<468>*/ 								printf("<y<<string arg1>>>, hmm?\nFor one of those, how many Rupees\nshould I part with? Hmmmm...\nHow about <numeric arg1>?")
          								goto flw_657
          							  case 1:
          								goto flw_470
          							}
...
/*<463>*/ 							switch (context_related2(1)) {
          							  case 0:
/*<469>*/ 								printf("<y<<string arg2>>>, hmm?\nFor one of those, how many Rupees\nshould I part with? Hmmmm...\nHow about <numeric arg2>?")
          								goto flw_657
          							  case 1:
          								goto flw_470
          							}
...
/*<419>*/ 			story_flags[298 /* us: 805A9AFD 0x10, jp: 805ACD7D 0x10 */] = true;
          			goto flw_476
          		  case 1:
/*<421>*/ 			printf("\x0E\x01\x09\x04\x01\xFF05What? I was sure you'd go for that...\nDon't make me sic Groose on you...")
          			goto flw_420
          		}
          	}
          }
...
/*<  5>*/ 	start()
/*<  6>*/ 	printf("\x0E\x01\x09\x04\x00\x00Nnngghh snrrrk...\nSNNNNRRRKK...")
          }
...
/*< 73>*/ 				printf("\x0E\x01\x09\x04\x00\x14Sigh... Oh, <b<Pipit>>... How can I get you to\nnotice me?")
...
/*< 75>*/ 				switch (choice(2)) {
          				  case 0:
/*< 77>*/ 					printf("\x0E\x01\x09\x04\x08\x906Huh? A letter? For me<pause0A>.<pause0A>.<pause0A>.<pause0A>?\nCould it be from <b<Pipit>>?!\n[1]Here you go![2]Never mind.")
/*< 78>*/ 					switch (choice(2)) {
          					  case 0:
/*< 80>*/ 						printf("\x0E\x01\x09\x04\x0E\x90AOh... Thank you. I'll just take that.")
...
/*<591>*/ 						printf("\x0E\x01\x09\x04\x10\x400I wonder who it's from?!")
/*<594>*/ 						{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 30, 'next': 81, 'param3': 6}
/*< 81>*/ 						printf("\x0E\x01\x09\x04\x10\xD00Whoa...<pause14> \x0E\x01\x06\x02\xFECDThat's some really terrible\nhandwriting...\x0E\x01\x06\x02Í\n\n\n\x0E\x01\x09\x04\x10\x400Anyway, never mind that... Let's see\nwhat it says...")
...
/*< 82>*/ 						printf("\x0E\x01\x09\x04\x00\x09So, yeah... I have to say, he really put\nhis heart into it and everything...\n\n\nI don't know... Maybe I should consider\ngoing out with <b<Cawlin>>.\n\n\n\x0E\x01\x09\x04\x08\x900...Hah! As if!\n\n\n\n\x0E\x01\x09\x04\x01\xD14Sigh... I wonder what <b<Pipit>> would think\nif he knew about this...")
/*< 83>*/ 						story_flags[555 /* us: 805A9B16 0x10, jp: 805ACD96 0x10 */] = true;
          					  case 1:
/*< 79>*/ 						printf("\x0E\x01\x09\x04\x08\x912What kind of a trick is that?\nStop messing around!")
          					}
          				  case 1:
/*< 76>*/ 					printf("\x0E\x01\x09\x04\x01\x406Huh? You're a strange one, aren't you,\nLink?")
          				}
          			}
          		}
          	  case 1:
...
/*<105>*/ 						printf("\x0E\x01\x09\x04\x00\xE08Finally, I can sleep! Thank you!")
          					  case 1:
/*<580>*/ 						{'type': 'type3', 'subType': 4, 'param1': 16, 'param2': 3584, 'next': 23, 'param3': 13}
/*< 23>*/ 						printf("\x0E\x01\x09\x04\x00\x08Oh, thank you, thank you! I appreciate\neverything you've done.")
          					}
          				  case 1:
...
/*< 19>*/ 						printf("\x0E\x01\x09\x04\x00\xE0DIs that...? The baby's <y<<itemA0>>>!\nYou found it!")
...
/*< 11>*/ 				printf("\x0E\x01\x06\x02\xFCCD...<pause2D>\x0E\x01\x06\x02Í\x0E\x01\x09\x04\x0D\x00Sigh...\x0E\x01\x05\x04A\x00")
/*<563>*/ 				set_camera(-1, 0)
...
/*<256>*/ 		switch (story_flags[389 /* us: 805A9B0D 0x80, jp: 805ACD8D 0x80 */]) {
          		  case 0:
/*<257>*/ 			printf("\x0E\x01\x09\x04\x07\x1602I'll do my best! And someday I'll be\nstrong. Come back soon so I can show\nyou the new me!")
          		  case 1:
...
/*<260>*/ 				printf("\x0E\x01\x09\x04\x00\x11I just...whoo...need a breather...\n\x0E\x03\x01\x00Link, what have you got\nthere? Is that... a <y<Stamina Potion>>?\n\nI don't suppose you'd...let me have\nthat, would you?\n[1]Take it![2-]Sorry...")
          				flw_261:
/*<261>*/ 				switch (choice(2)) {
          				  case 0:
/*<263>*/ 					printf("\x0E\x01\x09\x04\x00\x0BReally?! Thank you! I owe you one!")
...
/*<285>*/ 			printf("\x0E\x01\x09\x04\x00\x03...Fat chance, right? I suppose I'll have\nto just put my nose to the grindstone...\nYep, just buckle down my bootstraps\nand all that... Right?\nAnyway, I'll just keep working on this\nfor as long as I can! All on my own,\nI guess... Sigh...")
          		}
          	}
          }
...
/*<302>*/ 		switch (story_flags[392 /* us: 805A9B0C 0x04, jp: 805ACD8C 0x04 */]) {
          		  case 0:
/*<304>*/ 			printf("\x0E\x01\x09\x04\x00\x02\x0E\x03\x01\x00Link! You're going to be\nshocked by how strong I am!\nCome back and see me soon!")
          		  case 1:
...
/*<305>*/ 				printf("\x0E\x01\x09\x04\x00\x10Whoo... I can't seem to catch my\nbreath...\n\n\nHey, Link, I wonder...\nWould you mind sharing some \n<y<Stamina Potion>> with me?\n[1]Take some![2-]Sorry.")
          				flw_306:
/*<306>*/ 				switch (choice(2)) {
          				  case 0:
/*<308>*/ 					printf("\x0E\x01\x09\x04\x00\x0BReally? Wow, thanks! I'll gladly take\nit, then.")
...
/*<303>*/ 				printf("\x0E\x01\x09\x04\x00\x11Whew...whoo... It's no good...\n\n\n\nIf only I had <r<a potion that would give\nme stamina>>, then maybe I could reach\ndown deep for that 110%...")
/*<342>*/ 				{'type': 'type3', 'subType': 4, 'param1': 3079, 'param2': -256, 'next': 341, 'param3': 13}
/*<341>*/ 				printf("\x0E\x01\x09\x04\x00\x03No, no... I can't keep asking you for\nfavors like that! I'll just keep working\nat it on my own.")
          			}
          		}
          	  case 1:
...
/*<339>*/ 			printf("\x0E\x01\x09\x04\x00\x03No, no... I can't keep asking you for\nfavors like that! I'll just keep working\nat it on my own.")
          		}
          	}
          }
...
/*<691>*/ 				printf("\x0E\x01\x09\x04\x00\x1F18Uwahhhhh!!!")
...
/*<789>*/ 			switch (temp_flags[11 /* 0x0 08 */]) {
          			  case 0:
/*<790>*/ 				printf("\x0E\x01\x09\x04\x0B\xE09Hey, Link, thanks for\ntaking care of my sister like that.\nI won't forget what you did.")
          			  case 1:
...
/*<813>*/ 						printf("\x0E\x01\x09\x04\x0B\x400It may not look like much, but believe\nme, there's a dozen uses for a fine\nbottle like that. Thanks again!")
...
/*<186>*/ 	switch (story_flags[381 /* us: 805A9B0A 0x80, jp: 805ACD8A 0x80 */]) {
          	  case 0:
/*<226>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 1, 'next': 206, 'param3': 31}
/*<206>*/ 		switch (adventure_pouch_has(5 0x0005)) {
          		  case 0:
/*<195>*/ 			switch (story_flags[382 /* us: 805A9B0D 0x01, jp: 805ACD8D 0x01 */]) {
          			  case 0:
/*<207>*/ 				printf("\x0E\x01\x09\x04\x00\x0B...Oh, <y<<item37>>>! What a relief!\nYou brought the medicine!\n[1]Here, take it![2-]Sorry, no.")
          				flw_208:
/*<208>*/ 				switch (choice(2)) {
          				  case 0:
          					flw_210:
/*<210>*/ 					printf("\x0E\x01\x09\x04\x0B\x409Thank you! Now I can heal my bird's\ninjury.")
...
/*<233>*/ 					printf("\x0E\x01\x09\x04\x00\x04Now my poor bird should be healthy\nagain in no time!")
...
/*<222>*/ 					printf("\x0E\x01\x09\x04\x00\x09I was beginning to think we were\ndoomed...\n\n\nYou've saved my life...and my bird's!\nWe both owe you a big thanks!")
/*<225>*/ 					give_gratitude_crystals();
/*<223>*/ 					printf("\x0E\x01\x09\x04\x00\x04Here we go! See you back in town!")
...
/*<218>*/ 											printf("\x0E\x01\x09\x04\x00\x0BOh, Link. Thanks for all \nyour help!\n\n\n\x0E\x01\x09\x04\x00\x400My bird is back to full health.\nThank you so much.")
          	  ...
          	  case 1:
/*<761>*/ 		printf("\x0E\x01\x09\x04\x00\x0BOh, Link. Thanks for all \nyour help!\n\n\n\x0E\x01\x09\x04\x00\x400My bird is back to full health.\nThank you so much.")
...
/*<506>*/ 			printf("\x0E\x01\x09\x04\x00\x01Please forget about the paper...\nGood-bye...")
...
/*<108>*/ 				printf("\x0E\x01\x09\x04\x00\x08Huh...? What's your problem? Why are\nyou looking at the restroom?")
...
/*< 42>*/ 		printf("\x0E\x01\x09\x04\x00\x01Please forget about the paper...\nGood-bye...")
...
/*<117>*/ 	switch (story_flags[555 /* us: 805A9B16 0x10, jp: 805ACD96 0x10 */]) {
          	  case 0:
/*< 44>*/ 		printf("\x0E\x01\x09\x04\x00\x01Please forget about the paper...\nGood-bye...")
...
/*< 47>*/ 		switch (choice(2)) {
          		  case 0:
/*< 49>*/ 			printf("\x0E\x01\x09\x04\x0B\x04Huh? You're giving me paper?\nI'm so happy...")
...
/*<153>*/ 				printf("\x0E\x01\x09\x04\x00\x02Thank you... I will use it with care...\n\n\n\nBut I'm shy, so don't ask me what I\nwant the paper for...\n\n\nMay we meet again...\nYou kind soul...")
...
/*<515>*/ 				{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': -1, 'next': -1, 'param3': 42}
          			  case 1:
          				flw_48:
/*< 48>*/ 				printf("\x0E\x01\x09\x04\x05\x03Ooooh... Somebody... Paper...")
          			}
          		  case 1:
          			goto flw_48
          		}
...
/*<149>*/ 		printf("\x0E\x01\x09\x04\x00\x02Ahh... My love... I will always be by\nyour side... Tee hee...")
          	  case 1:
/*<825>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 527, 'param3': 31}
...
/*<519>*/ 		printf("\x0E\x01\x09\x04\x00\x02Ahh... My love... I will always be by\nyour side... Tee hee...")
...
/*<360>*/ 	{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 20, 'next': 827, 'param3': 32}
/*<827>*/ 	{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': 30, 'next': 823, 'param3': 47}
/*<823>*/ 	make_actor_do_something(3, 5)
/*<621>*/ 	{'type': 'type3', 'subType': 4, 'param1': 5121, 'param2': -256, 'next': 361, 'param3': 13}
/*<361>*/ 	{'type': 'type3', 'subType': 1, 'param1': 20, 'param2': 5, 'next': 829, 'param3': 16}
/*<829>*/ 	set_camera(31, 0)
/*<828>*/ 	{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': 30, 'next': 362, 'param3': 48}
/*<362>*/ 	set_camera(11, 0)
...
/*<368>*/ 	printf("\x0E\x01\x09\x04\x1400\x09Tee hee. It was a wonderful love letter.\nThank you!")
/*<370>*/ 	{'type': 'type3', 'subType': 1, 'param1': 5, 'param2': 20, 'next': 369, 'param3': 16}
/*<369>*/ 	printf("\x0E\x01\x09\x04\x500\x11It wasn't...that...great...")
/*<371>*/ 	set_camera(12, 0)
...
/*<372>*/ 	printf("\x0E\x01\x09\x04\x1400\x12My answer? Ah...my answer...")
/*<377>*/ 	set_camera(13, 0)
...
/*<378>*/ 	printf("\x0E\x01\x09\x04\x500\x2519Oh, please! Please go out...with me!")
...
/*<390>*/ 	printf("\x0E\x01\x09\x04\x500\x1B09What...? Hey, hold on there!\nWhat are you trying to pull all\nof a sudden?")
...
/*<398>*/ 	printf("\x0E\x01\x09\x04\x1201\xFF00Truly? You choose me?")
...
/*<400>*/ 	printf("Yes! \x0E\x01\x09\x04\x1400\x900I'm so happy. Thank you...")
/*<632>*/ 	set_camera(16, 0)
...
/*<631>*/ 	printf("\x0E\x01\x09\x04\x500\x1D17This can't be happening...")
...
/*<406>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': -1, 'next': 794, 'param3': 42}
/*<794>*/ 	zone_temp_flags[20 /* 0x3 10 */] = true;
          }
