...
/*<  8>*/ 		printf(/* textboxtype: 1, unk: 0, line: 8 */ "Truly?! You'll help me?")
...
/*<  6>*/ 		printf(/* textboxtype: 1, unk: 0, line: 7 */ "Please, gentle sir! I beg you. Do not\nmake me bend my wings and grovel.\n[1-]OK, fine.[2]No chance!")
/*<  7>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_82
          		  case 1:
...
/*<154>*/ 		switch (choice(2)) {
          		  case 0:
/*<155>*/ 			printf(/* textboxtype: 1, unk: 0, line: 49 */ "<0x10009:0x00000856>Goodness, I suppose you are right...")
          			flw_157:
...
/*<160>*/ 			story_flags[1091 /* us: 805A9B52 0x02, jp: 805ACDD2 0x02 */] = true;
          		  case 1:
/*<156>*/ 			printf(/* textboxtype: 1, unk: 0, line: 50 */ "<0x10009:0x00000814>Please, there's no reason to hide your\ndoubts from me.")
          			goto flw_157
          		}
          	}
          }
...
/*< 51>*/ 									printf(/* textboxtype: 1, unk: 0, line: 23 */ "You have made such magnificent\nprogress gathering <color yellow<Gratitude Crystals>coloroff>.\n\n\nPlease just continue helping me a bit\nlonger...")
/*< 53>*/ 									scene_flags[0 'Skyloft'][73 /* 0x8 02 */] = true;
/*<139>*/ 									switch (context_related2(4)) {
          									  case 0:
/*<140>*/ 										printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00090d0b>Oh gracious me! That is a prodigious\nquantity of <color yellow<Gratitude Crystals>coloroff> you've\nbrought for me!\n\n<0x10009:0x00070807>This is such an appallingly insufficient\nreward that my cheeks burn hot with\nembarrassment, but please...take this!")
          										goto flw_165
          									  case 1:
/*<145>*/ 										scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          									}
          								  case 1:
/*< 48>*/ 									printf(/* textboxtype: 1, unk: 0, line: 17 */ "<0x10009:0x00000005>Oh, I want to be a human so badly it\npains me! Please hurry and gather\nmore <color yellow<Gratitude Crystals>coloroff>!\n\nNext, come and see me when you've\ngathered <color red<40 >coloroff>of them!")
          								}
          							}
          						  case 1:
...
/*< 26>*/ 								printf(/* textboxtype: 1, unk: 0, line: 23 */ "You have made such magnificent\nprogress gathering <color yellow<Gratitude Crystals>coloroff>.\n\n\nPlease just continue helping me a bit\nlonger...")
/*< 47>*/ 								scene_flags[0 'Skyloft'][72 /* 0x8 01 */] = true;
/*<137>*/ 								switch (context_related2(3)) {
          								  case 0:
/*<138>*/ 									printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00090d0b>Oh gracious me! That is a prodigious\nquantity of <color yellow<Gratitude Crystals>coloroff> you've\nbrought for me!\n\n<0x10009:0x00070807>This is such an appallingly insufficient\nreward that my cheeks burn hot with\nembarrassment, but please...take this!")
          									goto flw_164
          								  case 1:
/*< 99>*/ 									scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          								}
          							  case 1:
/*< 64>*/ 								printf(/* textboxtype: 1, unk: 0, line: 16 */ "<0x10009:0x00000005>Oh, I want to be a human so badly it\npains me! Please hurry and gather\nmore <color yellow<Gratitude Crystals>coloroff>!\n\nNext, come and see me when you've\ngathered <color red<30 >coloroff>of them!")
          							}
          						}
          					  case 1:
...
/*< 44>*/ 							printf(/* textboxtype: 1, unk: 0, line: 22 */ "I'm still going to need more <color yellow<Gratitude\nCrystals>coloroff> to become a human.\n\n\nPlease, won't you aid a poor,\nunfortunate demon in need?")
/*< 45>*/ 							scene_flags[0 'Skyloft'][71 /* 0x9 80 */] = true;
/*<135>*/ 							switch (context_related2(2)) {
          							  case 0:
/*<136>*/ 								printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00090d0b>Oh gracious me! That is a prodigious\nquantity of <color yellow<Gratitude Crystals>coloroff> you've\nbrought for me!\n\n<0x10009:0x00070807>This is such an appallingly insufficient\nreward that my cheeks burn hot with\nembarrassment, but please...take this!")
          								goto flw_24
          							  case 1:
          							}
          						  case 1:
...
/*< 23>*/ 						printf(/* textboxtype: 1, unk: 0, line: 22 */ "I'm still going to need more <color yellow<Gratitude\nCrystals>coloroff> to become a human.\n\n\nPlease, won't you aid a poor,\nunfortunate demon in need?")
/*< 38>*/ 						scene_flags[0 'Skyloft'][70 /* 0x9 40 */] = true;
/*<133>*/ 						switch (context_related2(1)) {
          						  case 0:
/*<134>*/ 							printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00090d0b>Oh gracious me! That is a prodigious\nquantity of <color yellow<Gratitude Crystals>coloroff> you've\nbrought for me!\n\n<0x10009:0x00070807>This is such an appallingly insufficient\nreward that my cheeks burn hot with\nembarrassment, but please...take this!")
          							goto flw_42
          						  case 1:
          						}
          					  case 1:
...
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 1, line: 30 */ "<0x10009:0x0000000b>It's...aghh!<0x10005:0x003c0000>")
/*< 67>*/ 	make_actor_do_something(0, 0)
/*<119>*/ 	wait_frames(40)
/*< 68>*/ 	printf(/* textboxtype: 1, unk: 1, line: 31 */ "<0x10009:0x00000004><0x10008:0x02cd>Graaauuugh!<0x10005:0x001e0000>")
...
/*< 89>*/ 	printf(/* textboxtype: 1, unk: 0, line: 32 */ "<0x10006:0xfccd>...<0x10006:0x00cd><0x10009:0x00000007>Well? How do I look, my dear\nfriend <heroname>?")
