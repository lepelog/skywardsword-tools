...
/*<  7>*/ 	switch (story_flags[530 /* us: 805A9B14 0x80, jp: 805ACD94 0x80 */]) {
          	  case 0:
/*<  8>*/ 		printf(/* textboxtype: 2, unk: 0, line: 134 */ "I cannot offer my usual analysis\nbecause you are currently engaged in\na challenge created by the Thunder\nDragon Lanayru.")
          	  case 1:
...
/*<  5>*/ 		printf(/* textboxtype: 2, unk: 0, line: 158 */ "<0x10012:0x00000001>Master, your current selection of\npouch items is <string arg0>.")
