...
/*< 17>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 0, line: 13 */ "I'm unloading this cargo of pumpkin\nsoup here.\n\n\nYou've picked an odd place for\nsoup delivery. Feels dangerous.\nSomething could jump out at us at any\nmoment, hungry for soup...or robot.")
          }

          void entrypoint_120_21() {
/*< 19>*/ 	start()
/*< 20>*/ 	printf(/* textboxtype: 1, unk: 0, line: 14 */ "I'm out of here! See you around, zzzrt!<0x10005:0x00280000>")
...
/*< 32>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*< 34>*/ 		printf(/* textboxtype: 1, unk: 0, line: 11 */ "Ho hoho! So you now hold the\nTriforce, do you? Astonishing!")
          		flw_35:
...
/*< 31>*/ 		switch (story_flags[22 /* us: 805A9ADB 0x40, jp: 805ACD5B 0x40 */]) {
          		  case 0:
/*< 33>*/ 			printf(/* textboxtype: 1, unk: 0, line: 10 */ "Ho ho! Astonishing. I see you've finally\nfound the location of the Triforce!")
          			goto flw_35
          		  case 1:
...
/*< 37>*/ 							story_flags[781 /* us: 805A9B2D 0x20, jp: 805ACDAD 0x20 */] = true;
          						  case 1:
/*<  3>*/ 							printf(/* textboxtype: 1, unk: 0, line: 2 */ "Do I know? You do realize you are \nspeaking to the great sky spirit,\ndo you not? <pause 20>Bahhh. No matter.")
          							goto flw_4
          						}
          					}
          				}
