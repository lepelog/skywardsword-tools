...
/*< 46>*/ 		switch (zone_temp_flags[0 /* 0x1 01 */]) {
          		  case 0:
/*< 49>*/ 			printf("\x0E\x01\x09\x04\x00\x700Y a\x2010t\x2010il autre chose dont tu veux que je te\nparle ?\n[1]Le <b<dragon\nd'eau>>[2]Le <b<dragon\nde foudre>>[3]Le volcan[4-]Non")
          			flw_42:
/*< 42>*/ 			switch (choice(4)) {
          			  case 0:
...
/*<  8>*/ 		printf("\x0E\x01\x09\x04\x11\x110BBon, c'est pas tout ça, mais j'ai d'autres chats\nà fouetter ! Je te laisse !\n\n\n\x0E\x01\x09\x04\x0F\xE00À la prochaine !")
...
/*< 21>*/ 		printf("\x0E\x01\x09\x04\x00\nSurtout, il faut pas qu'ils te trouvent, hein !\n\n\n\n\x0E\x01\x09\x04\x0F\xE00Sinon, tu vas passer un sale quart d'heure !\nAlors sois discret !\n\n\nTu m'as bien compris ?\n[1]Oui, oui[2]...")
/*< 51>*/ 		switch (choice(2)) {
          		  case 0:
          			flw_52:
/*< 52>*/ 			printf("......\n\n\n\n\x0E\x01\x09\x04\x0F\xE06Haa... Tu sais, je me fais du souci pour toi,\nfrangin...\n\n\n\x0E\x01\x09\x04\x0E\xE00OK ! Je vais te montrer quelque chose !\nSors ta carte !")
/*< 12>*/ 			{'type': 'type3', 'subType': 4, 'param1': 0, 'param2': 0, 'next': 19, 'param3': 30}
/*< 19>*/ 			printf("\x0E\x01\x09\x04\x11\x110BBon, aujourd'hui, c'est mon jour de bonté, je vais\nte dire ce qu'il y a dans les coffres !\n\n\n... Et voilà !")
/*< 13>*/ 			story_flags[168 /* us: 805A9AE3 0x80, jp: 805ACD63 0x80 */] = true;
/*< 14>*/ 			{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 20, 'param3': 34}
/*< 20>*/ 			printf("\x0E\x01\x09\x04\x0E\xE09Enfin, rien de tout ça m'intéresse...\n\n\n\n\x0E\x01\x09\x04\x0F\xE00S'il y a des trucs qu'étaient à toi là\x2010dedans,\ntu devrais aller les récupérer.")
/*< 22>*/ 			printf("\x0E\x01\x09\x04\x0E\xE0BBien ! Moi, je retourne à la chasse aux trésors !\n\n\n\nÀ plus !")
...
/*< 68>*/ 			changeScene(2, 0) // 
          		  case 1:
/*< 67>*/ 			printf("Je vois... Dans ce cas, bon courage !")
          		}
          	  case 1:
...
/*< 76>*/ 				changeScene(2, 0) // 
          			  case 1:
/*< 75>*/ 				printf("Je vois... Dans ce cas, bon courage !")
          			}
          		  case 1:
/*< 80>*/ 			printf("Salut !<pause0A> J'ai rien de neuf en réserve mais je peux\nte montrer les anciennes visions. Ça te dit ?\n[1]Oui[2-]Non merci")
          			goto flw_74
          		}
          	  case 1:
