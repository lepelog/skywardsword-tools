...
/*<  8>*/ 		printf(/* textboxtype: 0, unk: 0, line: 14 */ "<0x10009:0x0011110b>Bon, c'est pas tout ça, mais j'ai d'autres chats\nà fouetter ! Je te laisse !\n\n\n<0x10009:0x000f0e00>À la prochaine !")
...
/*< 21>*/ 		printf(/* textboxtype: 0, unk: 1, line: 19 */ "<0x10009:0x0000000a>Surtout, il faut pas qu'ils te trouvent, hein !\n\n\n\n<0x10009:0x000f0e00>Sinon, tu vas passer un sale quart d'heure !\nAlors sois discret !\n\n\nTu m'as bien compris ?\n[1-]Oui, oui[2-]...")
/*< 51>*/ 		switch (choice(2)) {
          		  case 0:
          			flw_52:
/*< 52>*/ 			printf(/* textboxtype: 1, unk: 0, line: 21 */ "......\n\n\n\n<0x10009:0x000f0e06>Haa... Tu sais, je me fais du souci pour toi,\nfrangin...\n\n\n<0x10009:0x000e0e00>OK ! Je vais te montrer quelque chose !\nSors ta carte !")
/*< 12>*/ 			{'type': 'type3', 'subType': 4, 'param1': 0, 'param2': 0, 'next': 19, 'param3': 30}
/*< 19>*/ 			printf(/* textboxtype: 0, unk: 0, line: 17 */ "<0x10009:0x0011110b>Bon, aujourd'hui, c'est mon jour de bonté, je vais\nte dire ce qu'il y a dans les coffres !\n\n\n... Et voilà !")
/*< 13>*/ 			story_flags[168 /* us: 805A9AE3 0x80, jp: 805ACD63 0x80 */] = true;
/*< 14>*/ 			{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 20, 'param3': 34}
/*< 20>*/ 			printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10009:0x000e0e09>Enfin, rien de tout ça m'intéresse...\n\n\n\n<0x10009:0x000f0e00>S'il y a des trucs qu'étaient à toi là‐dedans,\ntu devrais aller les récupérer.")
/*< 22>*/ 			printf(/* textboxtype: 0, unk: 0, line: 20 */ "<0x10009:0x000e0e0b>Bien ! Moi, je retourne à la chasse aux trésors !\n\n\n\nÀ plus !")
...
/*< 18>*/ 		printf(/* textboxtype: 0, unk: 1, line: 16 */ "<0x10009:0x000f0e00>Ça va pas bien dans ta tête ? Te balader comme\nça alors que t'es pas armé...\n\n\nJe t'ai pourtant dit qu'il y avait plein de\nméchants dans le coin !\n\n\n<0x10009:0x000e0e03>Regarde bien autour de toi !")
          	}
          }
...
/*< 75>*/ 				printf(/* textboxtype: 1, unk: 0, line: 27 */ "Je vois... Dans ce cas, bon courage !")
          		  ...
          		  case 1:
/*< 80>*/ 			printf(/* textboxtype: 0, unk: 0, line: 26 */ "Salut !<pause 10> J'ai rien de neuf en réserve mais je peux\nte montrer les anciennes visions. Ça te dit ?\n[1-]Oui[2]Non merci")
          			goto flw_74
          		}
          	  case 1:
