...
/*<210>*/ 		printf("\x0E\x01\x09\x04\x00\x01Nous commencerons la cérémonie quand tu\nauras retrouvé ton célestrier.\n\n\nNe t'inquiète pas et pars à sa recherche !")
          	  case 1:
/*<211>*/ 		printf("\x0E\x01\x09\x04\x00\x01La chevauchée céleste a été reportée pour que\ntu puisses retrouver ton oiseau.\n\n\nTout va bien.")
          	}
          }
...
/*<224>*/ 	switch (story_flags[200 /* us: 805A9AEF 0x04, jp: 805ACD6F 0x04 */]) {
          	  case 0:
/*<225>*/ 		printf("\x0E\x01\x09\x04\x00\x01Alors, Link ? Tout se passe bien\npour toi ?\n\n\nSi tu as un problème, n'hésite pas à m'en\nparler !")
          	  case 1:
...
/*<259>*/ 	set_camera(-1, 0)
/*<257>*/ 	printf("\x0E\x01\x09\x04\x00\x04Commence par plonger et monter sur\nton oiseau !")
...
/*<164>*/ 				printf("Le bouclier en bois est léger et facile à utiliser,\nmais c'est le moins solide d'entre tous, et il est\nvulnérable au feu.\n\nSi jamais il se brise, tu peux en racheter un au\nmarché.\n\n\nPour équiper ton bouclier, <g<maintiens \x0E\x02\x04\x02\x28CD\nenfoncé>>, choisis le bouclier que tu veux puis\nrelâche \x0E\x02\x04\x02\x28CD.\x0E\x01\x11\x02\xECD")
          				goto flw_172
          			}
          		}
          	}
...
/*<102>*/ 	switch (story_flags[642 /* us: 805A9B1D 0x08, jp: 805ACD9D 0x08 */]) {
          	  case 0:
/*<103>*/ 		printf("\x0E\x01\x09\x04\x00\x01La Citrouille perchée est un bar se trouvant au\n<r<sud\x2010est >>de Célesbourg, sur une petite île.\n\n\nIl y a là\x2010bas <b<Tironne>>, une jeune fille à la voix\nmagnifique... <pause1E>À vrai dire\x0E\x01\x06\x02\xFECD...\x0E\x01\x06\x02Í je suis un fan.\n\n\nSurtout, ne le dis à personne !")
          	  case 1:
/*<105>*/ 		switch (scene_flags[77 /* 0x8 20 */]) {
          		  case 0:
          			flw_107:
/*<107>*/ 			printf("\x0E\x01\x09\x04\x00\x01Bien, Link ! Souhaites\x2010tu passer\nle test de l'attaque tornade ?\n[1]Oui[2-]Plus tard")
/*<108>*/ 			switch (choice(2)) {
          			  case 0:
/*<109>*/ 				printf("\x0E\x01\x09\x04\x00\x03Bonne réponse ! Bien, commençons ! Tu peux\nplonger dans le ciel.")
...
/*<121>*/ 			switch (story_flags[643 /* us: 805A9B1D 0x10, jp: 805ACD9D 0x10 */]) {
          			  case 0:
/*<101>*/ 				printf("\x0E\x01\x09\x04\x00\x01Que t'arrive\x2010t\x2010il ? Plonge donc ! Ou bien\nsouhaites\x2010tu t'arrêter là ?\n[1]Je continue[2-]J'arrête")
/*<116>*/ 				switch (choice(2)) {
          				  case 0:
/*<120>*/ 					printf("\x0E\x01\x09\x04\x00\x03C'est la réponse que j'attendais ! Bien, envole\x2010toi\ndans le ciel.")
...
/*<141>*/ 	start()
/*<142>*/ 	printf("Bien, Link !\n\n\n\nJ'ai appris à ton célestrier à <g<tournoyer >>lorsque\ntu appuies sur \x0E\x02\x04\x02\x1ECD.")
          }
...
/*<145>*/ 	start()
/*<148>*/ 	printf("Bien, c'est parti !")
          }

          void entrypoint_108_17() {
/*<132>*/ 	start()
/*<133>*/ 	printf("\x0E\x01\x09\x04\x00\x02Hé, Link ! Où tu vas, comme ça ?\n\n\n\nDépêche\x2010toi de plonger et d'appeler ton\ncélestrier !")
          }

          void entrypoint_108_18() {
/*<134>*/ 	start()
/*<135>*/ 	printf("\x0E\x01\x09\x04\x00\x02Oh, Link ! Tu veux un cours\nà cette heure\x2010ci ?\n[1]Oui[2-]Non...")
/*<136>*/ 	switch (choice(2)) {
          	  case 0:
...
/*< 13>*/ 					printf("\x0E\x01\x09\x04\x00\x16Lorsque la nuit tombe sur Célesbourg, un\nétrange pouvoir maléfique s'empare des\npetits animaux comme les Lemlys.\n\nLes monstres d'ordinaire tapis dans des grottes\nou des endroits sombres sortent également de\nleur tanière la nuit.\n\nC'est pour cela que personne ici ne sort à la\nnuit tombée, sauf en cas d'absolue nécessité.\n\n\nPour ceux comme toi qui aspirent à être\nchevaliers et sont entraînés à se battre,\nça va encore...\n\nMais reste tout de même prudent !")
          			  ...
          			  case 1:
/*< 92>*/ 				set_camera(17, 0)
/*< 49>*/ 				printf("\x0E\x01\x09\x04\x0F\x40DOh, tu l'as ramenée saine et sauve ! <pause23>\x0E\x01\x09\x04\x09\x400Merci pour\nton aide, Link.\n\n\nBien, je vais nourrir la petite Miou, à présent.")
/*<154>*/ 				set_camera(20, 0)
/*< 52>*/ 				printf("Rends\x2010toi sur la <r<place du temple >>et dis au\ndirecteur que nous l'avons retrouvée.")
/*<240>*/ 				set_camera(21, 0)
/*<241>*/ 				printf("Zelda doit être avec lui. Va vite les prévenir !\n\n\n\nMais avant, j'ai une récompense pour toi... Ce\nn'est pas grand\x2010chose, mais c'est de bon c\x153ur !\nÇa reste entre nous, d'accord ?")
...
/*<264>*/ 								printf("\x0E\x01\x09\x04\x0B\xA0DParfait ! Garde toujours en tête que tu peux\n<g<cibler >>quelqu'un pour engager une conversation\nplus facilement.\n\n\x0E\x01\x09\x04\x00\xC04Oh ?<pause0F> Ne prends pas cet air blasé. Tu penses\npeut\x2010être que je radote, mais il ne faut pas\nnégliger les bases !\n\n\x0E\x01\x09\x04\x00\xA00En <r<mode héroïque>>,<pause1E> le nombre de c\x153urs que tu\nperds en subissant des dégâts est <pling><r<doublé>> ! Il\ndevient donc encore plus important de <g<cibler>>.\n\nMais nous sommes un peu éloignés. Monte donc\njusqu'ici pour poursuivre cette conversation.")
          								flw_58:
/*< 58>*/ 								set_camera(10, 0)
/*< 41>*/ 								printf("\x0E\x01\x09\x04\x0B\xA00Tu dois pouvoir monter sur cette caisse en\nbois si tu <g<fonces>> dessus.\n\n\nTu verras, tu peux le faire ! Allez, monte\njusqu'ici.")
