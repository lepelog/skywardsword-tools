...
/*<288>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*<289>*/ 		printf(/* textboxtype: 0, unk: 0, line: 98 */ "<0x10009:0x00000001>Certes, la statue de la Déesse a disparu, mais la\nDéesse, elle, restera toujours en chacun d'entre\nnous !\n\nTu ne crois pas, <heroname> ?")
          	  case 1:
/*<281>*/ 		switch (story_flags[642 /* us: 805A9B1D 0x08, jp: 805ACD9D 0x08 */]) {
          		  case 0:
/*<282>*/ 			printf(/* textboxtype: 0, unk: 1, line: 97 */ "<0x10009:0x00000001>Tu as l'air d'avoir beaucoup mûri. Continue\ncomme ça !")
          		  case 1:
/*<277>*/ 			switch (story_flags[328 /* us: 805A9AFF 0x40, jp: 805ACD7F 0x40 */]) {
          			  case 0:
/*<280>*/ 				printf(/* textboxtype: 1, unk: 0, line: 96 */ "<0x10009:0x00000001>Comment ? Le grand Narisha ?!<pause 40> Oui, j'en ai\nentendu parler, mais...\n\n\nJe ne sais pas grand‐chose à son sujet, désolé.\n\n\n\nPour ce genre de chose, tu devrais t'adresser\nà <color blue<maître Arfan>coloroff>, ton professeur de travaux\npratiques !")
          			  case 1:
...
/*<210>*/ 		printf(/* textboxtype: 1, unk: 0, line: 99 */ "<0x10009:0x00000001>Nous commencerons la cérémonie quand tu\nauras retrouvé ton célestrier.\n\n\nNe t'inquiète pas et pars à sa recherche !")
          	  case 1:
/*<211>*/ 		printf(/* textboxtype: 0, unk: 1, line: 100 */ "<0x10009:0x00000001>La chevauchée céleste a été reportée pour que\ntu puisses retrouver ton oiseau.\n\n\nTout va bien.")
          	}
          }
...
/*<224>*/ 	switch (story_flags[200 /* us: 805A9AEF 0x04, jp: 805ACD6F 0x04 */]) {
          	  case 0:
/*<225>*/ 		printf(/* textboxtype: 1, unk: 0, line: 105 */ "<0x10009:0x00000001>Alors, <heroname> ? Tout se passe bien\npour toi ?\n\n\nSi tu as un problème, n'hésite pas à m'en\nparler !")
          	  case 1:
...
/*<219>*/ 			switch (story_flags[328 /* us: 805A9AFF 0x40, jp: 805ACD7F 0x40 */]) {
          			  case 0:
/*<222>*/ 				printf(/* textboxtype: 0, unk: 1, line: 103 */ "<0x10009:0x00000005>Que fais‐tu dehors à cette heure,\n<heroname> ?\n\n\nComment ? Le grand Narisha ? Ce n'est pas\nle moment d'en parler, il est bien tard...\n\n\nReviens plutôt demain, et je te raconterai ce\nque je sais.")
          			  case 1:
...
/*< 76>*/ 			printf(/* textboxtype: 0, unk: 0, line: 50 */ "<0x10009:0x00000001>Oh, <heroname>. Comment se passe la\nrecherche de Zelda ? Tu l'as trouvée ?\n\n\n<0x10009:0x00000005>Quoi ? <pause 40>Le grand Narisha ? C'est le directeur\nqui t'en a parlé ?\n\n\nOui, il se trouve bien à l'intérieur du\ncumulonimbus.\n\n\nMais<0x10006:0xfecd>...<0x10006:0x00cd><pause 25> il ne s'agit plus du Narisha que nous\nconnaissions... <0x10006:0xfecd>C'est...<pause 40><0x10006:0x01cd> un <color red<monstre >coloroff>!\n\n\n<0x10009:0x0000000f>Il a la même apparence qu'auparavant, mais\nlorsque j'ai essayé de l'approcher, il m'a\nattaqué !\n\nJ'ai lu dans ses yeux qu'il me vouait une haine\nprofonde... Est‐ce qu'il a réellement changé...\n\n\n<0x10006:0xfecd>Ou bien...<0x10006:0x00cd><pause 25> Est‐il possédé ? <pause 25>Oui, j'ai eu cette\nimpression.")
/*<202>*/ 			wait_frames(40)
/*< 77>*/ 			printf(/* textboxtype: 1, unk: 0, line: 51 */ "<0x10009:0x00000005>Quoi ? <pause 40>Tu voudrais lui parler ?\n\n\n\n<0x10006:0xfecd>C'est...<0x10006:0x00cd> impossible. Il n'est plus en mesure\nde comprendre le langage des humains.\n\n\n<0x10006:0xfecd>De plus...<0x10006:0x00cd> la dernière fois que j'ai tenté de\nl'approcher pour lui parler, j'ai failli me\nfaire dévorer.")
/*<203>*/ 			wait_frames(40)
/*<200>*/ 			printf(/* textboxtype: 0, unk: 0, line: 53 */ "<0x10009:0x00000052>Quoi ?<pause 40> Tu souhaites le rencontrer quand\nmême ?\n\n\n<0x10006:0xfecd>Je vois...<0x10006:0x00cd> Tu penses qu'il pourrait t'aider à\nretrouver Zelda ?\n\n\nJe comprends.<pause 30> Il ne m'appartient donc pas de\ntenter de t'arrêter.")
/*<204>*/ 			wait_frames(30)
...
/*<275>*/ 			switch (story_flags[146 /* us: 805A9AEE 0x10, jp: 805ACD6E 0x10 */]) {
          			  case 0:
/*<276>*/ 				printf(/* textboxtype: 0, unk: 1, line: 55 */ "<0x10009:0x00000001>Tiens, <heroname> ! <pause 30>Comment ?\nLa Triforce ?\n\n\nDésolé, je ne peux pas t'aider. Si tu allais\ndemander au directeur ?")
          			  case 1:
/*< 83>*/ 				printf(/* textboxtype: 0, unk: 1, line: 52 */ "<0x10009:0x00000001>Oh, <heroname> ! Comment se passe la\nrecherche de Zelda ?\n\n\nCela me chagrine que tu doives accomplir cette\ntâche seul... Mais tu dois la retrouver !")
          			}
          		}
          	}
          }
...
/*<259>*/ 	set_camera(-1, 0)
/*<257>*/ 	printf(/* textboxtype: 0, unk: 1, line: 58 */ "<0x10009:0x00000004>Commence par plonger et monter sur\nton oiseau !")
...
/*<196>*/ 			switch (scene_flags[91 /* 0xA 08 */]) {
          			  case 0:
/*<198>*/ 				printf(/* textboxtype: 2, unk: 0, line: 62 */ "<0x10009:0x00000001>Laisse‐nous nous occuper de la cérémonie, et va\nplutôt chercher ton oiseau !")
          			  case 1:
/*<126>*/ 				printf(/* textboxtype: 1, unk: 0, line: 60 */ "<0x10009:0x0000000f>Que t'arrive‐t‐il, <heroname> ?<pause 30> Ton\noiseau ne répond plus à ton appel ?\n\n\nÉtrange, en temps normal un célestrier répond\ntoujours à l'appel de son maître<0x10006:0xfecd>...\n\n\nTu en as déjà parlé à maître <color blue<Hulul>coloroff>, le\nresponsable de la chevauchée d'aujourd'hui ?\n\n\nAh, le directeur est déjà au courant ! Tout\ndevrait bien se passer, dans ce cas.\n\n\nQuant à toi, dépêche‐toi de trouver ton oiseau !")
/*<199>*/ 				scene_flags[0 'Skyloft'][91 /* 0xA 08 */] = true;
          			}
          		  case 1:
/*<194>*/ 			switch (scene_flags[90 /* 0xA 04 */]) {
          			  case 0:
/*<195>*/ 				printf(/* textboxtype: 1, unk: 2, line: 63 */ "<0x10009:0x00000001>Au fait, c'est toi qui nous confonds souvent,\nnon ? Maître <color blue<Hulul>coloroff>, le professeur qui s'occupe\ndes cours théoriques, a les cheveux bruns... \n\nEt moi qui ai les cheveux blancs, je suis maître\n<color blue<Arfan>coloroff>, ton professeur de pratique. Ne l'oublie\npas !")
          			  case 1:
...
/*<272>*/ 		switch (story_flags[7 /* us: 805A9AD8 0x01, jp: 805ACD58 0x01 */]) {
          		  case 0:
/*<274>*/ 			printf(/* textboxtype: 0, unk: 1, line: 70 */ "<0x10009:0x00000001>Existe‐t‐il vraiment un monde appelé la terre ?\n\n\n\nEt même s'il existe, j'imagine que contrairement\nà ici, où la végétation est luxuriante, ce ne doit\nêtre qu'une terre désolée...")
          		  case 1:
...
/*<164>*/ 				printf(/* textboxtype: 0, unk: 1, line: 67 */ "Le bouclier en bois est léger et facile à utiliser,\nmais c'est le moins solide d'entre tous, et il est\nvulnérable au feu.\n\nSi jamais il se brise, tu peux en racheter un au\nmarché.\n\n\nPour équiper ton bouclier, <color green<maintiens <icon 40>\nenfoncé>coloroff>, choisis le bouclier que tu veux puis\nrelâche <icon 40>.<0x10011:0x0ecd>")
          				goto flw_172
          			}
          		}
          	}
...
/*<102>*/ 	switch (story_flags[642 /* us: 805A9B1D 0x08, jp: 805ACD9D 0x08 */]) {
          	  case 0:
/*<103>*/ 		printf(/* textboxtype: 1, unk: 0, line: 78 */ "<0x10009:0x00000001>La Citrouille perchée est un bar se trouvant au\n<color red<sud‐est >coloroff>de Célesbourg, sur une petite île.\n\n\nIl y a là‐bas <color blue<Tironne>coloroff>, une jeune fille à la voix\nmagnifique... <pause 30>À vrai dire<0x10006:0xfecd>...<0x10006:0x00cd> je suis un fan.\n\n\nSurtout, ne le dis à personne !")
          	  case 1:
/*<105>*/ 		switch (scene_flags[77 /* 0x8 20 */]) {
          		  case 0:
          			flw_107:
/*<107>*/ 			printf(/* textboxtype: 0, unk: 1, line: 79 */ "<0x10009:0x00000001>Bien, <heroname> ! Souhaites‐tu passer\nle test de l'attaque tornade ?\n[1-]Oui[2]Plus tard")
/*<108>*/ 			switch (choice(2)) {
          			  case 0:
/*<109>*/ 				printf(/* textboxtype: 0, unk: 0, line: 80 */ "<0x10009:0x00000003>Bonne réponse ! Bien, commençons ! Tu peux\nplonger dans le ciel.")
...
/*<121>*/ 			switch (story_flags[643 /* us: 805A9B1D 0x10, jp: 805ACD9D 0x10 */]) {
          			  case 0:
/*<101>*/ 				printf(/* textboxtype: 0, unk: 0, line: 77 */ "<0x10009:0x00000001>Que t'arrive‐t‐il ? Plonge donc ! Ou bien\nsouhaites‐tu t'arrêter là ?\n[1-]Je continue[2]J'arrête")
/*<116>*/ 				switch (choice(2)) {
          				  case 0:
/*<120>*/ 					printf(/* textboxtype: 0, unk: 1, line: 82 */ "<0x10009:0x00000003>C'est la réponse que j'attendais ! Bien, envole‐toi\ndans le ciel.")
...
/*<141>*/ 	start()
/*<142>*/ 	printf(/* textboxtype: 0, unk: 1, line: 109 */ "Bien, <heroname> !\n\n\n\nJ'ai appris à ton célestrier à <color green<tournoyer >coloroff>lorsque\ntu appuies sur <icon 30>.")
          }
...
/*< 72>*/ 				scene_flags[0 'Skyloft'][41 /* 0x4 02 */] = true;
          			  case 1:
/*<161>*/ 				printf(/* textboxtype: 0, unk: 0, line: 20 */ "Hum, c'est peut‐être parce que tu n'as pas\nécouté ma requête qu'il t'arrive malheur...\n\n\nBah, oublie ça. Tu dis que le directeur\nm'appelle ?\n\n\nTrès bien, ne t'inquiète pas pour la cérémonie\net file chercher ton célestrier.")
...
/*<236>*/ 						set_camera(12, 0)
/*<235>*/ 						printf(/* textboxtype: 0, unk: 0, line: 2 */ "Regarde un peu où elle est allée se fourrer !<0x1000A:0x001000cd>\n\n\n\n<0x1000A:0xffff00cd>Zelda et son père ne peuvent pas s'occuper\nd'elle aujourd'hui, ils doivent se consacrer aux\npréparatifs de la cérémonie...\n\nIls m'ont donc chargé de la nourrir, mais la\ncérémonie va bientôt commencer et je ne peux\naller la chercher dans cette tenue...\n\n<0x10007:0xff000000>Tu ne voudrais pas me la ramener ?\n[1-]D'accord[2-]Pas le temps")
/*<  4>*/ 						switch (choice(2)) {
          						  case 0:
/*< 54>*/ 							set_camera(-1, 0)
          							goto flw_2
...
/*<264>*/ 								printf(/* textboxtype: 1, unk: 0, line: 42 */ "<0x10009:0x000b0a0d>Parfait ! Garde toujours en tête que tu peux\n<color green<cibler >coloroff>quelqu'un pour engager une conversation\nplus facilement.\n\n<0x10009:0x00000c04>Oh ?<pause 15> Ne prends pas cet air blasé. Tu penses\npeut‐être que je radote, mais il ne faut pas\nnégliger les bases !\n\n<0x10009:0x00000a00>En <color red<mode héroïque>coloroff>,<pause 30> le nombre de cœurs que tu\nperds en subissant des dégâts est <sound 4><color red<doublé>coloroff> ! Il\ndevient donc encore plus important de <color green<cibler>coloroff>.\n\nMais nous sommes un peu éloignés. Monte donc\njusqu'ici pour poursuivre cette conversation.")
          								flw_58:
/*< 58>*/ 								set_camera(10, 0)
/*< 41>*/ 								printf(/* textboxtype: 0, unk: 0, line: 38 */ "<0x10009:0x000b0a00>Tu dois pouvoir monter sur cette caisse en\nbois si tu <color green<fonces>coloroff> dessus.\n\n\nTu verras, tu peux le faire ! Allez, monte\njusqu'ici.")
...
/*< 31>*/ 			set_camera(2, 0)
/*< 20>*/ 			printf(/* textboxtype: 0, unk: 1, line: 31 */ "C'est le moment pour chacun d'entre vous\nde prouver que votre entraînement a porté\nses fruits !\n\nEt attention, le lancer d'objets et les charges\nintempestives sont interdits.")
/*<178>*/ 			set_camera(6, 0)
