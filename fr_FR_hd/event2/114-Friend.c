...
/*< 84>*/ 				switch (temp_flags[6 /* 0x1 40 */]) {
          				  case 0:
/*< 85>*/ 					printf(/* textboxtype: 0, unk: 1, line: 34 */ "<0x10009:0x00000002>Tu veux encore faire du tir à la citrouille ?\nÇa te coûtera<color red< 20 rubis>coloroff>.\n[1-]D'accord ![2-]C'est quoi,\nles règles ?[3]Non merci")
          					flw_74:
/*< 74>*/ 					switch (choice(3)) {
          					  case 0:
          						flw_67:
/*< 67>*/ 						switch (has_rupees(20)) {
          						  case 0:
/*< 68>*/ 							rupees += -20;
/*< 70>*/ 							printf(/* textboxtype: 0, unk: 0, line: 32 */ "<0x10009:0x00070a0a>Alors, c'est parti !\nCourage, <heroname> !")
...
/*< 66>*/ 							printf(/* textboxtype: 0, unk: 1, line: 31 */ "<0x10009:0x00010811>Je vois, tu as des problèmes d'argent...\nPauvre <heroname>...")
          					  ...
          					  case 1:
          						flw_63:
/*< 63>*/ 						printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10009:0x00070200>Pendant <color red<90 secondes>coloroff>, je vais jeter des\ncitrouilles. Chaque fois que tu en toucheras\nune, tu gagneras 10 points...\n\n<0x10009:0x00000a00>Mais si tu en touches plusieurs à la suite, tu\ngagneras plus de points, alors fais de ton\nmieux !")
/*< 69>*/ 						{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 64, 'param3': 12}
/*< 64>*/ 						printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10009:0x00070200>Ah, mais je devrai te demander 20 rubis à\nchaque essai.\n\n\n<0x10009:0x00080a00>Si tu le faisais gratuitement, il n'y aurait pas\nd'enjeu. Alors, <color red<20 rubis >coloroff>pour du tir à la\ncitrouille, ça te dit ?\n[1-]Avec plaisir[2]Non merci")
/*< 65>*/ 						switch (choice(2)) {
          						  case 0:
          							goto flw_67
          						  case 1:
...
/*< 58>*/ 				switch (choice(2)) {
          				  case 0:
/*< 57>*/ 					printf(/* textboxtype: 0, unk: 1, line: 25 */ "<0x10009:0x00070aff>Je le savais, <heroname> !\n\n\n\n<0x10009:0x00010200>Même si maintenant je suis assez fort pour\nfaire 3 000 pompes, je ne t'arrive pas encore\nà la cheville...")
          					flw_59:
/*< 59>*/ 					printf(/* textboxtype: 1, unk: 0, line: 27 */ "<0x10009:0x00070a00>J'ai une idée ! Si tu me montrais tes talents\nd'archer ?\n\n\nJe vais jeter des citrouilles en l'air.\n\n\n\n<0x10009:0x00000200>Essaie de les transpercer avec tes flèches !\n\n\n\n<0x10009:0x00070a00>Et puis, jeter des citrouilles, ça me fera un bon\nexercice. Comme ça, on fera d'une pierre deux\ncoups !\n\n[1-]D'accord ![2]Une autre\nfois")
/*< 61>*/ 					switch (choice(2)) {
          					  case 0:
          						goto flw_63
          					  case 1:
/*< 62>*/ 						printf(/* textboxtype: 0, unk: 1, line: 28 */ "<0x10009:0x00070811>Je vois... Tu as autre chose à faire,\n<heroname>...\n\n\nTu as pour mission de sauver Zelda !<pause 10> Désolé de\nt'avoir ennuyé.")
          				  ...
          				  case 1:
/*< 60>*/ 					printf(/* textboxtype: 0, unk: 0, line: 26 */ "<0x10009:0x00000a09>Ne sois pas modeste ! Je ne fais que dire la\nvérité !")
          					goto flw_59
          				}
          			}
          		  case 1:
...
/*<115>*/ 			printf(/* textboxtype: 0, unk: 0, line: 38 */ "<0x10009:0x00070a00>Tu crois que tu arriverais à marquer au moins\n<color red<600 points>coloroff> ? J'aimerais beaucoup voir ça !")
          			goto flw_91
          		  case 3:
...
/*<113>*/ 				printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00010200>Si tu veux en savoir plus sur les commandes, tu\npeux <color green<appuyer sur <icon 19>>coloroff> pour les consulter.<0x10011:0x0bcd>\n\n\nLes actions que tu peux réaliser selon la\nsituation y sont décrites. C'est très pratique.")
