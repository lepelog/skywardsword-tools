...
/*< 18>*/ 										printf("\x0E\x03\x01\x00Link ! Je ne peux compter que\nsur toi...\n\n\nVa, pars secourir Zelda au plus vite !")
          									  case 1:
