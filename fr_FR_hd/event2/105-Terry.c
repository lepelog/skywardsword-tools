...
/*<165>*/ 				printf(/* textboxtype: 0, unk: 1, line: 7 */ "Wouahou ! Bienv'nue à la boutique de Terry,\nm'sieur client !\n\n\nÉcoute ma supplique ! Va, cours, vole, sauve\nmon petit <color blue<Golofa Demonicus Rex>coloroff> !\n\n\nPlus rarissime, y a pas ! Je m'en remettrai\njamais...")
          			  case 1:
...
/*<195>*/ 					switch (zone_temp_flags[13 /* 0x0 20 */]) {
          					  case 0:
          						flw_1:
/*<  1>*/ 						printf(/* textboxtype: 1, unk: 0, line: 0 */ "Hein ? Tu veux savoir pourquoi j'pédale toute\nla journée ?\n[1-]Oui ![2]Ça m'est\négal")
/*< 25>*/ 						switch (choice(2)) {
          						  case 0:
/*< 26>*/ 							printf(/* textboxtype: 0, unk: 1, line: 1 */ "<0x10007:0x00000015>Wouahou ! Mais quel esprit vif et curieux,\nm'sieur client ! J'adooore !\n\n\nJ'pédale pour créer de l'électricité et faire\navancer ma maison. C'est <color blue<écologistique>coloroff>, et\nbon pour ma santé !\n\nEt avec toi à bord, m'sieur client, j'dois pédaler\ndeux fois plus dur... Je sens que ça fait du bien\ndans mon corps !")
          							flw_27:
/*< 27>*/ 							printf(/* textboxtype: 1, unk: 0, line: 3 */ "Euh<0x10006:0xfecd>...<0x10006:0x00cd> Pardon ! Enfin, jette un œil à ma\nmarchandise, c'est pas d'la camelote ! J'ai\ndes trucs super cool !")
...
/*< 28>*/ 							printf(/* textboxtype: 0, unk: 0, line: 2 */ "Wouahou ! Ben pourquoi tu m'déranges, alors ?\n\n\n\nEn plus, avec toi à bord, j'dois pédaler deux fois\nplus dur...")
...
/*<188>*/ 								switch (zone_temp_flags[12 /* 0x0 10 */]) {
          								  case 0:
/*<190>*/ 									printf(/* textboxtype: 1, unk: 0, line: 9 */ "Wouahou ! On en reparle cette nuit, OK ?\nTu peux piquer un somme sur le lit, juste là.")
          								  case 1:
/*<186>*/ 									{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 187, 'param3': 31}
/*<187>*/ 									printf(/* textboxtype: 0, unk: 0, line: 8 */ "<0x10009:0x00000b00>Wouahou<pause 10>.<pause 10>.<pause 10>.<pause 10>! Bienvenue,<pause 20> m'sieur client<pause 10>.<pause 10>.<pause 10>.<pause 10>\n\n\n\nHein ?<pause 20> Tu trouves que j'ai mauvaise mine ?\n\n\n\nJ'peux vraiment rien t'cacher, à toi !\n\n\n\nMais comme tu vois, j'suis bien trop occupé,\nlà, alors on en reparle cette nuit, d'accord ?\nTu peux roupiller sur le lit, juste là !")
...
/*<180>*/ 		switch (story_flags[477 /* us: 805A9B11 0x02, jp: 805ACD91 0x02 */]) {
          		  case 0:
/*<183>*/ 			printf(/* textboxtype: 0, unk: 1, line: 34 */ "Ça, c'est une <color yellow<médaille insecte>coloroff>. Avec cette\nmédaille, les endroits où trouver des insectes\nsont indiqués sur ta carte.\n\nC'est super pratique ! C'est un peu chéros,\nmais si t'aimes les insectes, ça vaut l'coup.\n\n\nNormalement, c'est <color red<1 000 rubis>coloroff>, mais j'te la\nfais à moitié prix ! <color red<500 rubis>coloroff> ! T'en dis quoi ?\n[1-]J'achète[2]Non merci")
          			goto flw_13
          		  case 1:
          			goto flw_182
          		}
...
/*< 35>*/ 	switch (story_flags[1089 /* us: 805A9B53 0x80, jp: 805ACDD3 0x80 */]) {
          	  case 0:
          		flw_5:
/*<  5>*/ 		printf(/* textboxtype: 1, unk: 0, line: 12 */ "Wouahou ! T'as pas un rond ! Le dernier qui\nm'a fait cette blague avait deux ans et demi !\nHaaan...")
...
/*<156>*/ 		entrypoint_105_11();
          	  case 1:
/*<  9>*/ 		printf(/* textboxtype: 0, unk: 0, line: 14 */ "Génial ! Tu vas voir, tu l'regretteras pas !")
          		goto flw_33
          	}
          }
...
/*< 37>*/ 	switch (story_flags[1089 /* us: 805A9B53 0x80, jp: 805ACDD3 0x80 */]) {
          	  case 0:
          		flw_11:
/*< 11>*/ 		printf(/* textboxtype: 1, unk: 0, line: 15 */ "Wouahou ! Attends, r'garde un peu le reste de\nma marchandise !")
...
/*< 79>*/ 	switch (story_flags[478 /* us: 805A9B11 0x04, jp: 805ACD91 0x04 */]) {
          	  case 0:
          		flw_22:
/*< 22>*/ 		printf(/* textboxtype: 0, unk: 0, line: 23 */ "Ça, c'est une <color yellow<bourse annexe>coloroff>. C'est super utile !\n\n\n\nAvec elle, tu pourras transporter 300 rubis\nsupplémentaires dans ta bourse.\n\n\nAu revoir, les tragédies du genre : « Oh non,\nma bourse est pleine et j'peux pas ramasser\nce rubis doré ! ». Ciao ! Fini ! Terminé !\n\n<color red<100 rubis>coloroff> et elle est à toi. Tu verras, ça change\nla vie !\n[1-]J'achète[2]Non merci")
          		goto flw_13
          	  case 1:
/*< 78>*/ 		switch (story_flags[477 /* us: 805A9B11 0x02, jp: 805ACD91 0x02 */]) {
          		  case 0:
/*< 80>*/ 			printf(/* textboxtype: 1, unk: 0, line: 24 */ "Ça, c'est une <color yellow<bourse annexe>coloroff>. C'est super utile !\n\n\n\nAvec elle, tu pourras transporter 300 rubis\nsupplémentaires dans ta bourse.\n\n\nAu revoir, les tragédies du genre : « Oh non,\nma bourse est pleine et j'peux pas ramasser\nce rubis doré ! ». Ciao ! Fini ! Terminé !\n\nD'habitude, c'est <color red<100 rubis>coloroff>. Mais pour toi,\nce sera seulement <color red<50 rubis>coloroff>.\n[1-]J'achète[2]Non merci")
          			goto flw_13
          		  case 1:
          			goto flw_22
          		}
...
/*<108>*/ 				printf(/* textboxtype: 0, unk: 1, line: 43 */ "Qu'y a‐t‐il ? Tu veux me montrer quelque\nchose ?")
/*<128>*/ 				set_camera(2, 0)
/*<118>*/ 				printf(/* textboxtype: 0, unk: 0, line: 44 */ "<0x10009:0x001a0815>Wouahou ! Je n'en crois pas mes yeux !!!\nMon <color blue<Golofa Demonicus Rex>coloroff> !!!")
...
/*<110>*/ 								zone_temp_flags[4 /* 0x1 10 */] = true;
          							  case 1:
/*< 59>*/ 								printf(/* textboxtype: 1, unk: 0, line: 39 */ "<0x10009:0x00010021>C'est facile à dire ! Je n'y arrive pas du tout !")
...
/*<126>*/ 							switch (story_flags[201 /* us: 805A9AEF 0x08, jp: 805ACD6F 0x08 */]) {
          							  case 0:
/*<125>*/ 								printf(/* textboxtype: 0, unk: 0, line: 53 */ "<0x10009:0x0000001e>Si tu veux retourner à Célesbourg, tu n'as qu'à\nt'allonger sur mon lit.")
          								flw_98:
...
/*< 53>*/ 							printf(/* textboxtype: 0, unk: 0, line: 35 */ "<0x10009:0x0000021e>Ah, tu es debout ?\n\n\n\nTu dormais comme un loir alors je n'ai pas osé\nte réveiller.\n\n\n<0x10009:0x00000500>Du coup, j'ai dû pédaler comme un véritable\nforcené... Pfiou !\n[1-]Terry ?[2-]Où suis‐je ?")
/*< 51>*/ 							switch (choice(2)) {
          							  case 0:
/*< 52>*/ 								printf(/* textboxtype: 1, unk: 0, line: 36 */ "Comment ? Je m'exprime différemment,\ndis‐tu ?\n\n\n<0x10009:0x00001000><0x10006:0xfbcd>...<0x10006:0x00cd><0x10009:0x00000200> Je ne trouve pas...<pause 30> Mais ce détail n'a que peu\nd'importance maintenant, n'est‐ce pas ?")
...
/*<104>*/ 								printf(/* textboxtype: 1, unk: 0, line: 36 */ "Comment ? Je m'exprime différemment,\ndis‐tu ?\n\n\n<0x10009:0x00001000><0x10006:0xfbcd>...<0x10006:0x00cd><0x10009:0x00000200> Je ne trouve pas...<pause 30> Mais ce détail n'a que peu\nd'importance maintenant, n'est‐ce pas ?")
          								goto flw_97
          							}
          						  case 1:
          							goto flw_116
...
/*< 82>*/ 	switch (story_flags[478 /* us: 805A9B11 0x04, jp: 805ACD91 0x04 */]) {
          	  case 0:
          		flw_42:
/*< 42>*/ 		printf(/* textboxtype: 0, unk: 1, line: 25 */ "Ça, c'est un <color yellow<filet à papillons>coloroff>. Ça sert à attraper\nles insectes !\n\n\nY en a pas beaucoup dans le coin, mais j'suis\nsûr que ça te sera super utile ailleurs !\n\n\nUne super affaire ! <color red<50 rubis >coloroff>! T'en dis quoi ?\n[1-]J'achète[2]Non merci")
          		goto flw_13
          	  case 1:
