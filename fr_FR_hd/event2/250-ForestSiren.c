...
/*< 69>*/ 	set_camera(5, 0)
/*< 70>*/ 	printf("Rassemblez les <y<larmes>> sans subir une seule attaque\npour remplir le <y<réceptacle spirituel>>.")
          	flw_74:
/*< 74>*/ 	set_camera(1, 0)
...
/*< 95>*/ 			set_camera(12, 0)
/*< 94>*/ 			printf("Vous êtes dans un <r<monde spirituel >>où seul l'élu de la\nDéesse peut entrer, la <b<Psysalis>>.\n\n\nVous avez temporairement quitté votre corps pour\nn'être plus que pur esprit.\n\n\nLa <b<Psysalis>> va ainsi mettre votre force d'âme à\nl'épreuve.")
...
/*< 15>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 16>*/ 		printf("Tu y es, Link ! Mets\x2010y tout ton\nc\x153ur !")
/*< 18>*/ 		set_camera(10, 0)
...
/*< 12>*/ 			set_camera(3, 0)
/*< 13>*/ 			printf("Il s'agit d'une <y<larme de Farore>>. Vous devez en\nrecueillir <r<15>>.")
