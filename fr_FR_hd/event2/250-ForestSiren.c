...
/*< 69>*/ 	set_camera(5, 0)
/*< 70>*/ 	printf(/* textboxtype: 2, unk: 4, line: 11 */ "Rassemblez les <color yellow<larmes>coloroff> sans subir une seule attaque\npour remplir le <color yellow<réceptacle spirituel>coloroff>.")
          	flw_74:
/*< 74>*/ 	set_camera(1, 0)
...
/*< 95>*/ 			set_camera(12, 0)
/*< 94>*/ 			printf(/* textboxtype: 4, unk: 2, line: 16 */ "Vous êtes dans un <color red<monde spirituel >coloroff>où seul l'élu de la\nDéesse peut entrer, la <color blue<Psysalis>coloroff>.\n\n\nVous avez temporairement quitté votre corps pour\nn'être plus que pur esprit.\n\n\nLa <color blue<Psysalis>coloroff> va ainsi mettre votre force d'âme à\nl'épreuve.")
...
/*< 15>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 16>*/ 		printf(/* textboxtype: 4, unk: 2, line: 28 */ "Tu y es, <heroname> ! Mets‐y tout ton\ncœur !")
/*< 18>*/ 		set_camera(10, 0)
...
/*< 42>*/ 									switch (temp_flags[7 /* 0x1 80 */]) {
          									  case 0:
/*< 46>*/ 										printf(/* textboxtype: 2, unk: 4, line: 26 */ "Les <color red<Gardiens>coloroff> qui vous attaquent et les <color red<Veilleurs>coloroff> qui\ntraquent les intrus peuvent être de deux types,\n<color red<terrestre ou céleste>coloroff>.\n\nChacun a un comportement différent, faites‐y très\nattention.")
...
/*< 12>*/ 			set_camera(3, 0)
/*< 13>*/ 			printf(/* textboxtype: 4, unk: 2, line: 7 */ "Il s'agit d'une <color yellow<larme de Farore>coloroff>. Vous devez en\nrecueillir <color red<15>coloroff>.")
