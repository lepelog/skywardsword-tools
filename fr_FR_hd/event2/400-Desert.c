...
/*<238>*/ 	start()
/*<239>*/ 	printf(/* textboxtype: 0, unk: 0, line: 53 */ "Ces derniers temps, des individus étranges nous\nattaquent. Nous ne sommes pas armés, alors s'ils\ns'en prennent à nous, on est finis !")
...
/*<  5>*/ 		switch (story_flags[90 /* us: 805A9AEF 0x80, jp: 805ACD6F 0x80 */]) {
          		  case 0:
          			flw_10:
/*< 10>*/ 			printf(/* textboxtype: 0, unk: 0, line: 20 */ "Maintenant, il peut <color red<transporter des objets dans\nses mandibules>coloroff>.\n\n\nSois prudent !")
...
/*<  6>*/ 			switch (context_related2(0)) {
          			  case 0:
/*<274>*/ 				printf(/* textboxtype: 0, unk: 1, line: 22 */ "<0x10009:0x13030000>Merci de m'avoir aidé !")
...
/*< 59>*/ 	printf(/* textboxtype: 1, unk: 0, line: 63 */ "<0x10005:0x005a0000><0x10012:0x0000000b>Maître <heroname>, Fay au rapport. Nous\nsommes arrivés dans les <color blue<mines de Lanelle>coloroff>.")
          }
...
/*<109>*/ 		switch (scene_flags[75 /* 0x8 08 */]) {
          		  case 0:
/*<111>*/ 			printf(/* textboxtype: 0, unk: 2, line: 100 */ "<0x10009:0x2f080d0a>J'ai trouvé le passage qui mène au domaine du\n<color red<dragon de foudre>coloroff>...<pause 45>\n\n\n<0x10006:0xffcd><0x10009:0x2f0d0800>Mais il est trop étroit, je peux pas passer.\n<0x10006:0xffcd><0x10009:0x2f080700>Comment faire...?")
          			goto flw_149
          		  case 1:
...
/*<273>*/ 				set_camera(5, 0)
/*<108>*/ 				printf(/* textboxtype: 0, unk: 0, line: 98 */ "Alors, cette <color blue<flamme sacrée >coloroff>dont tu parlais, tu\nl'as trouvée ?\n\n\nJ'arrête pas d'y penser. Raconte‐moi tout !\n\n\n\n<0x10009:0x2f080407>.<pause 20>.<pause 20>.<pause 20> Il a fallu que tu fasses tout ça pour la\ntrouver ?!\n\n\nT'es vraiment impressionnant,\n<heroname>.")
/*<355>*/ 				printf(/* textboxtype: 2, unk: 0, line: 99 */ "<0x10009:0x2f080d0a>Bon, je vais te dire ce que j'ai découvert à\npropos de la légende des trois dragons.<pause 15>\n\n\nPlus loin dans le désert, il y a bien un domaine\ncaché !\n\n\nJ'ai trouvé un <color red<passage étroit<sound 4> >coloroff>dans lequel je peux\npas passer !\n\n\n<0x10009:0x2f000d00>Si mon intuition me fait pas défaut, ça doit être\nle domaine d'un des trois dragons, le <color red<dragon de\nfoudre>coloroff> !\n\n<0x10009:0x2f000800>Je suis sûr que ça a un rapport avec les robots\nqui vivent ici.<pause 15>\n\n\n<0x10009:0x2f010807><0x10006:0xffcd>Le <color red<dragon de foudre>coloroff>, les robots, les\nchronolithes<pause 20>.<pause 20>.<pause 20>.<pause 20>\n\n\n<0x10009:0x2f080708><0x10008:0x02cd><0x10008:0x02cd>Quelle aventure !")
/*<107>*/ 				printf(/* textboxtype: 0, unk: 2, line: 97 */ "<0x10009:0x00080d00>Au fait, <heroname>, l'investissement que\ntu as fait dans mes fouilles a enfin porté ses\nfruits !<pause 20>\n\nJ'ai trouvé tout un tas de chronolithes là‐bas !\n<0x10009:0x2f000d01>Je peux te rendre dix fois ce que tu m'as prêté !")
/*<106>*/ 				rupees += 100;
          				flw_282:
...
/*<271>*/ 				set_camera(5, 0)
/*<211>*/ 				printf(/* textboxtype: 0, unk: 0, line: 98 */ "Alors, cette <color blue<flamme sacrée >coloroff>dont tu parlais, tu\nl'as trouvée ?\n\n\nJ'arrête pas d'y penser. Raconte‐moi tout !\n\n\n\n<0x10009:0x2f080407>.<pause 20>.<pause 20>.<pause 20> Il a fallu que tu fasses tout ça pour la\ntrouver ?!\n\n\nT'es vraiment impressionnant,\n<heroname>.")
/*<356>*/ 				printf(/* textboxtype: 2, unk: 0, line: 99 */ "<0x10009:0x2f080d0a>Bon, je vais te dire ce que j'ai découvert à\npropos de la légende des trois dragons.<pause 15>\n\n\nPlus loin dans le désert, il y a bien un domaine\ncaché !\n\n\nJ'ai trouvé un <color red<passage étroit<sound 4> >coloroff>dans lequel je peux\npas passer !\n\n\n<0x10009:0x2f000d00>Si mon intuition me fait pas défaut, ça doit être\nle domaine d'un des trois dragons, le <color red<dragon de\nfoudre>coloroff> !\n\n<0x10009:0x2f000800>Je suis sûr que ça a un rapport avec les robots\nqui vivent ici.<pause 15>\n\n\n<0x10009:0x2f010807><0x10006:0xffcd>Le <color red<dragon de foudre>coloroff>, les robots, les\nchronolithes<pause 20>.<pause 20>.<pause 20>.<pause 20>\n\n\n<0x10009:0x2f080708><0x10008:0x02cd><0x10008:0x02cd>Quelle aventure !")
          				goto flw_282
          			}
          		}
          	}
...
/*<213>*/ 	start()
/*<214>*/ 	printf(/* textboxtype: 0, unk: 1, line: 91 */ "<0x10012:0x0000000b>Maître <heroname>, Fay au rapport.")
...
/*<315>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_66:
/*< 66>*/ 				printf(/* textboxtype: 0, unk: 0, line: 26 */ "Je ne me lasserai jamais d'admirer le temple\ndu temps !")
          			  case 1:
/*<316>*/ 				printf(/* textboxtype: 0, unk: 0, line: 62 */ "Tu cherches les trois dragons ?\n\n\n\n<0x10009:0x13030000>Le <color blue<dragon de foudre>coloroff> se trouve au sud de la\n<color blue<grotte de Lanelle>coloroff> ! Pour les autres, je sais pas.")
...
/*< 99>*/ 			wait_frames(30)
/*< 97>*/ 			printf(/* textboxtype: 0, unk: 0, line: 29 */ "Tiens ? Ta carte... Elle est bizarre. Attends, je\nvais corriger ça.")
...
/*<102>*/ 	start()
/*<283>*/ 	printf(/* textboxtype: 0, unk: 1, line: 70 */ "<0x10012:0x00000001>Maître, Fay au rapport. Je ne ressens plus l'aura de\ndame <color blue<Zelda>coloroff>.")
/*<284>*/ 	set_camera(7, 0)
...
/*<253>*/ 	start()
/*<254>*/ 	printf(/* textboxtype: 0, unk: 0, line: 59 */ "Ce n'est pas courant de voir des humains par\nici. Tu t'intéresses aux chronolithes ?")
...
/*< 81>*/ 					switch (scene_flags[8 /* 0x0 01 */]) {
          					  case 0:
/*< 83>*/ 						printf(/* textboxtype: 0, unk: 1, line: 34 */ "Voici la <color blue<raffinerie de Lanelle >coloroff>! C'est ici qu'on\ntravaille les chronolithes.\n\n\n<0x10009:0x13030000>Elle est toujours aussi impressionnante !")
          					  case 1:
/*< 82>*/ 						printf(/* textboxtype: 1, unk: 0, line: 33 */ "Tu as réussi à déchiffrer la combinaison ?\nJe suis impressionné.\n\n\n<0x10009:0x13030000>Voici la <color blue<raffinerie de Lanelle >coloroff>! C'est ici qu'on\ntravaille les chronolithes.\n\n\n<0x10009:0x13030000>Elle est toujours aussi impressionnante !")
/*< 84>*/ 						scene_flags[7 'Lanayru Desert'][8 /* 0x0 01 */] = true;
          						flw_85:
/*< 85>*/ 						scene_flags[7 'Lanayru Desert'][35 /* 0x5 08 */] = true;
          					}
          				  case 1:
/*<322>*/ 					printf(/* textboxtype: 0, unk: 0, line: 62 */ "Tu cherches les trois dragons ?\n\n\n\n<0x10009:0x13030000>Le <color blue<dragon de foudre>coloroff> se trouve au sud de la\n<color blue<grotte de Lanelle>coloroff> ! Pour les autres, je sais pas.")
...
/*< 80>*/ 			printf(/* textboxtype: 0, unk: 0, line: 32 */ "Tu as trouvé les trois symboles de la\ncombinaison ? Mais il ne suffit pas de les\navoir trouvés pour ouvrir la raffinerie.")
          	  ...
          	  case 1:
/*< 49>*/ 		printf(/* textboxtype: 0, unk: 1, line: 31 */ "Qui es‐tu ?\n\n\n\n<0x10009:0x13030000>Ceci est le générateur qui contrôle l'entrée de\nla raffinerie de Lanelle !\n\n\n<0x10009:0x13030000>Il est impossible d'ouvrir la raffinerie sans la\n<color red<combinaison composée de trois symboles>coloroff>.")
...
/*<130>*/ 	start()
/*<131>*/ 	printf(/* textboxtype: 0, unk: 1, line: 64 */ "<0x10005:0x005a0000>C'est une terre aride qui s'est changée en désert en\nseulement quelques siècles.")
          }
...
/*<257>*/ 	start()
/*<258>*/ 	printf(/* textboxtype: 0, unk: 1, line: 61 */ "Un de nos compagnons s'est fait enlever ! On\nraconte qu'il risque de se faire déconnecter.")
...
/*<327>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_187:
/*<187>*/ 				printf(/* textboxtype: 1, unk: 0, line: 39 */ "Tu as réussi à déchiffrer la combinaison ?\nImpressionnant.")
          			  case 1:
/*<328>*/ 				printf(/* textboxtype: 0, unk: 0, line: 62 */ "Tu cherches les trois dragons ?\n\n\n\n<0x10009:0x13030000>Le <color blue<dragon de foudre>coloroff> se trouve au sud de la\n<color blue<grotte de Lanelle>coloroff> ! Pour les autres, je sais pas.")
...
/*<115>*/ 		switch (scene_flags[100 /* 0xD 10 */]) {
          		  case 0:
/*<116>*/ 			printf(/* textboxtype: 0, unk: 1, line: 37 */ "Ouah ! Mais qu'est‐ce que tu fais ?!\n\n\n\n<0x10009:0x13030000>Même si tu as trouvé les symboles, ça ne suffira\npas à ouvrir la raffinerie.")
          			flw_155:
...
/*<180>*/ 			switch (scene_flags[34 /* 0x5 04 */]) {
          			  case 0:
/*< 53>*/ 				printf(/* textboxtype: 1, unk: 0, line: 36 */ "Tu cherches la combinaison pour entrer dans\nla raffinerie de Lanelle ?\n\n\n<0x10009:0x13030000>Tu as l'air très bizarre. Je ne donnerai jamais\nla combinaison à un individu aussi suspect.\n\n\n<0x10009:0x13030000>Surtout, ne touche pas au générateur et ne\nt'amuse pas à y planter cette épée !")
          				goto flw_155
          			  case 1:
/*<181>*/ 				printf(/* textboxtype: 0, unk: 0, line: 38 */ "Ton accoutrement est très étrange. Tu es très\nsuspect !\n\n\n<0x10009:0x13030000>Ne va pas toucher au générateur et ne t'amuse\npas à y planter ton épée !")
          				goto flw_155
          			}
          		}
          	}
...
/*<135>*/ 	printf(/* textboxtype: 0, unk: 1, line: 73 */ "<0x10005:0x005a0000>Nous sommes arrivés au <color blue<désert de Lanelle>coloroff>. Une\nbrusque désertification a grandement modifié la\nnature de ces terres.")
          }
...
/*<225>*/ 	switch (scene_flags[29 /* 0x2 20 */]) {
          	  case 0:
/*<226>*/ 		printf(/* textboxtype: 0, unk: 1, line: 10 */ "C'est dangereux pour les humains. Il ne faut\npas toucher cette pierre bleue ! Évite de nous\ngêner dans notre travail.")
          	  case 1:
/*< 24>*/ 		printf(/* textboxtype: 1, unk: 0, line: 9 */ "Par où es‐tu arrivé ? Ici, nous extrayons des\nchronolithes pour les transporter jusqu'à la\n<color blue<raffinerie de Lanelle>coloroff>.\n\n<0x10009:0x13030000>C'est dangereux pour les humains. Évite de\ntoucher cette pierre bleue !")
...
/*<298>*/ 	start()
/*<299>*/ 	printf(/* textboxtype: 1, unk: 0, line: 93 */ "<0x10012:0x0000000b>Maître <heroname>, Fay au rapport. Vous avez\ndécouvert les trois symboles.\n\n\nRetournez au <color red<générateur>coloroff> qui se trouve devant la\n<color blue<raffinerie de Lanelle>coloroff>.")
          }
...
/*<333>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_189:
/*<189>*/ 				printf(/* textboxtype: 0, unk: 0, line: 44 */ "Tu as réussi à déchiffrer la combinaison ?\nImpressionnant.")
          			  case 1:
/*<334>*/ 				printf(/* textboxtype: 0, unk: 0, line: 62 */ "Tu cherches les trois dragons ?\n\n\n\n<0x10009:0x13030000>Le <color blue<dragon de foudre>coloroff> se trouve au sud de la\n<color blue<grotte de Lanelle>coloroff> ! Pour les autres, je sais pas.")
...
/*<182>*/ 			switch (scene_flags[34 /* 0x5 04 */]) {
          			  case 0:
/*< 57>*/ 				printf(/* textboxtype: 0, unk: 0, line: 41 */ "Tu cherches la combinaison pour entrer dans\nla raffinerie de Lanelle ?\n\n\n<0x10009:0x13030000>Ton accoutrement est très étrange. Je ne\ndonnerai jamais la combinaison à un\nindividu aussi suspect.\n\n<0x10009:0x13030000>Ne t'amuse pas à toucher au générateur et\nsurtout ne va pas y planter cette épée !")
          				goto flw_153
          			  case 1:
/*<183>*/ 				printf(/* textboxtype: 0, unk: 1, line: 43 */ "Ton accoutrement est très étrange. Tu es très\nsuspect !\n\n\n<0x10009:0x13030000>Ne va pas toucher au générateur et ne t'amuse\npas à y planter ton épée !")
          				goto flw_153
          			}
          		}
          	}
...
/*<300>*/ 	start()
/*<301>*/ 	printf(/* textboxtype: 0, unk: 2, line: 94 */ "<0x10012:0x0000000b>Maître <heroname>, Fay au rapport. Mon\nanalyse indique qu'il est possible d'actionner\nce <color red<générateur >coloroff>en lui fournissant une source\nd'électricité.")
          }
...
/*<339>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_191:
/*<191>*/ 				printf(/* textboxtype: 0, unk: 1, line: 49 */ "Tu as réussi à déchiffrer la combinaison ?\nImpressionnant.")
          			  case 1:
/*<340>*/ 				printf(/* textboxtype: 0, unk: 0, line: 62 */ "Tu cherches les trois dragons ?\n\n\n\n<0x10009:0x13030000>Le <color blue<dragon de foudre>coloroff> se trouve au sud de la\n<color blue<grotte de Lanelle>coloroff> ! Pour les autres, je sais pas.")
...
/*<123>*/ 		switch (scene_flags[101 /* 0xD 20 */]) {
          		  case 0:
/*<124>*/ 			printf(/* textboxtype: 0, unk: 0, line: 47 */ "Ouah ! Mais qu'est‐ce que tu fais ?!\n\n\n\n<0x10009:0x13030000>Même si tu as trouvé les symboles, ça ne suffira\npas à ouvrir la raffinerie.")
          			flw_154:
...
/*<122>*/ 				printf(/* textboxtype: 0, unk: 1, line: 46 */ "Tu cherches la combinaison pour entrer dans\nla raffinerie de Lanelle ?\n\n\n<0x10009:0x13030000>Ton accoutrement est très étrange. Je ne\ndonnerai jamais la combinaison à un\nindividu aussi suspect.\n\n<0x10009:0x13030000>Ne t'amuse pas à toucher au générateur et\nsurtout ne va pas y planter cette épée !")
          				goto flw_154
          			  case 1:
/*<185>*/ 				printf(/* textboxtype: 1, unk: 0, line: 48 */ "Ton accoutrement est très étrange. Tu es très\nsuspect !\n\n\n<0x10009:0x13030000>Ne va pas toucher au générateur et ne t'amuse\npas à y planter ton épée !")
          				goto flw_154
          			}
          		}
          	}
