...
/*< 36>*/ 	set_camera(2, 0)
/*< 23>*/ 	printf("Pour arriver jusqu'à cet emblème, je vous recommande\nde franchir cette porte.")
/*< 54>*/ 	set_camera(-1, 0)
          }
...
/*< 33>*/ 	switch (scene_flags[122 /* 0xE 04 */]) {
          	  case 0:
/*< 21>*/ 		printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Nous sommes revenus dans\nla salle où se trouve l'<r<emblème de Din>>.")
          		flw_39:
/*< 39>*/ 		set_camera(6, 0)
/*< 34>*/ 		printf("La probabilité que vous trouviez la force sacrée au\nbout de ce parcours de lave est de 60 %.")
/*< 41>*/ 		set_camera(-1, 0)
/*< 40>*/ 		printf("Je vous recommande d'avancer avec détermination.")
          	  case 1:
/*< 35>*/ 		printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Je détecte la présence d'une\nforce sacrée dans cette salle.")
          		goto flw_39
          	}
          }
...
/*< 44>*/ 	start()
/*< 49>*/ 	set_camera(7, 0)
/*< 43>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, Fay au rapport. Vous êtes\narrivé jusqu'à l'emblème. Plantez\x2010y votre épée.\n\n\nVous devriez alors être conduit vers la <y+<Triforce>>.")
          }

          void entrypoint_125_12() {
/*< 46>*/ 	start()
/*< 50>*/ 	set_camera(8, 0)
/*< 45>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, Fay au rapport. Vous êtes\narrivé jusqu'à l'emblème. Plantez\x2010y votre épée.\n\n\nVous devriez alors être conduit vers la <y+<Triforce>>.")
          }

          void entrypoint_125_13() {
/*< 48>*/ 	start()
/*< 51>*/ 	set_camera(9, 0)
/*< 47>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, Fay au rapport. Vous êtes\narrivé jusqu'à l'emblème. Plantez\x2010y votre épée.\n\n\nVous devriez alors être conduit vers la <y+<Triforce>>.")
          }
...
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Ces secousses semblent être\nla manifestation d'un <r<<pling>changement de structure >>du\nbâtiment.")
/*<  4>*/ 		{'type': 'type3', 'subType': 4, 'param1': 0, 'param2': 0, 'next': 55, 'param3': 30}
/*< 55>*/ 		switch (scene_flags[13 /* 0x0 20 */]) {
          		  case 0:
/*< 10>*/ 			printf("Ce changement va vous permettre d'entrer dans la\nsalle voisine.")
          			flw_5:
