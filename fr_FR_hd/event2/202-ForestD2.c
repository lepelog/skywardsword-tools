...
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 2, unk: 0, line: 9 */ "Si j'en crois nos expériences passées, la <color yellow<clé >coloroff>dont il\nest fait mention ici est celle qui ouvre le mécanisme\ndevant nous.")
          }
...
/*< 19>*/ 	set_camera(3, 0)
/*< 16>*/ 	printf(/* textboxtype: 2, unk: 0, line: 18 */ "J'ai besoin de temps pour trouver le moyen de\nrappeler mon maître à la vie.<pause 5>.<pause 5>.")
/*< 20>*/ 	set_camera(4, 0)
/*< 30>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3334, 'param2': 512, 'next': 23, 'param3': 13}
/*< 23>*/ 	wait_frames(30)
/*< 22>*/ 	printf(/* textboxtype: 0, unk: 2, line: 19 */ "Pourquoi faut‐il toujours que des gêneurs\ncomme toi viennent se mettre dans mes pattes ?")
