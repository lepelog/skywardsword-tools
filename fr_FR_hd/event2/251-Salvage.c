...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x00000064>Fay de mon cœur ! J'arrive ! J'accours !\n\n\n\nOh, c'est ça qu'il faut transporter ?")
          }
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10012:0x00000064>Allez, pousse‐toi de là ! J'aime pas avoir\nà répéter tout le temps la même chose !")
          }
...
/*< 31>*/ 	switch (story_flags[673 /* us: 805A9B20 0x04, jp: 805ACDA0 0x04 */]) {
          	  case 0:
/*< 33>*/ 		printf(/* textboxtype: 0, unk: 0, line: 14 */ "<0x10009:0x00070014>Dis donc ! Ça se fait pas de donner de faux\nespoirs aux gens comme ça !\n\n\n<0x10009:0x00090013>Je pensais que je pourrais plus jamais aller dans\nce havre de paix, alors j'étais tout déprimé !")
...
/*< 15>*/ 			switch (choice(2)) {
          			  case 0:
/*< 16>*/ 				printf(/* textboxtype: 0, unk: 0, line: 8 */ "<0x10009:0x00090014>Je ne te permets pas ! D'accord, elles sont super\ntombantes, mais j'ai des épaules quand même !\n\n\n<0x10009:0x00070011>Enfin, je commence à être fatigué de passer\nmes journées à attendre que le danger s'éloigne.")
          				flw_38:
...
/*< 20>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_21:
/*< 21>*/ 						printf(/* textboxtype: 0, unk: 1, line: 13 */ "<0x10009:0x00060007>Ouah ! Ça a l'air fantastique ! Amène‐moi vite\nlà‐bas !")
...
/*< 40>*/ 						story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */] = true;
          				  ...
          				  case 1:
/*< 18>*/ 					printf(/* textboxtype: 0, unk: 1, line: 10 */ "<0x10009:0x00090013>Mais il y a encore plein de vilains pas beaux\nqui traînent par ici.\n\n\n<0x10009:0x00070004>Est‐ce que nous autres, les Tikwis, sommes\ncondamnés à nous cacher toute notre vie ?")
          					goto flw_19
          				}
          			  case 1:
/*< 17>*/ 				printf(/* textboxtype: 1, unk: 0, line: 9 */ "<0x10009:0x00070011>Ben oui ! Est‐ce que tu imagines ce que c'est\nque de passer ses journées à attendre que le\ndanger s'éloigne ?")
          				goto flw_38
          			}
          		}
          	}
