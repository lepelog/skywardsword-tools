...
/*< 38>*/ 	start()
/*<560>*/ 	printf("\x0E\x01\x09\x04\x17\x1909Oui ! C'est ça ! C'est une des <r<pierres qui\nparlent >>dont il est question dans les écrits\nanciens !")
...
/*< 66>*/ 	switch (scene_flags[64 /* 0x9 01 */]) {
          	  case 0:
/*< 68>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il faut que je\nvoie des <y<bombes >>apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		flw_67:
/*< 67>*/ 		switch (choice(2)) {
          		  case 0:
...
/*<509>*/ 			story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          		  case 1:
/*< 70>*/ 			printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ? <pause1E>Dans ce cas, je compte sur toi !")
          			goto flw_137
          		}
          	  case 1:
...
/*<507>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 58>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ? <pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_135
          	}
          }
...
/*< 72>*/ 	switch (scene_flags[65 /* 0x9 02 */]) {
          	  case 0:
/*< 74>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il faut que je\nvoie des <y<flèches >>apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		flw_73:
/*< 73>*/ 		switch (choice(2)) {
          		  case 0:
...
/*<510>*/ 			story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          		  case 1:
/*< 76>*/ 			printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ? <pause1E>Dans ce cas, je compte sur toi !")
          			goto flw_138
          		}
          	  case 1:
...
/*<508>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 64>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ? <pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_136
          	}
          }
...
/*<171>*/ 			switch (scene_flags[61 /* 0x6 20 */]) {
          			  case 0:
/*<172>*/ 				printf("\x0E\x01\x09\x04\x1817\x1909Oh ! Merci ! Merci ! T'es un sacré bonhomme,\ntoi !")
          				flw_195:
/*<195>*/ 				entrypoint_503_17();
          			  case 1:
/*<173>*/ 				printf("\x0E\x01\x09\x04\x1817\x1908Ouah ! J'en crois pas mes yeux !\n\n\n\nAlors c'était ça la fortune dont parlaient les\nécrits anciens !")
/*<174>*/ 				scene_flags[10 'Sealed Grounds'][61 /* 0x6 20 */] = true;
          				goto flw_195
          			}
          		  case 1:
/*<582>*/ 			scene_flags[10 'Sealed Grounds'][61 /* 0x6 20 */] = true;
/*<562>*/ 			printf("\x0E\x01\x09\x04\x1817\x1908Ouah ! J'en crois pas mes yeux !\n\n\n\nAlors c'était ça la fortune dont parlaient les\nécrits anciens !")
...
/*<427>*/ 	switch (scene_flags[63 /* 0x6 80 */]) {
          	  case 0:
/*<429>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il faut que je\nvoie une <y<fée>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		flw_428:
/*<428>*/ 		switch (choice(2)) {
          		  case 0:
/*<430>*/ 			printf("\x0E\x01\x09\x04\x00\x07« ... trois... iangl... Tri... ce... »")
/*<434>*/ 			printf("\x0E\x01\x09\x04\x17\x1700À partir de là, les pages sont déchirées et je\nn'arrive pas à les déchiffrer...\n\n\nÇa m'intrigue vraiment...")
          			flw_438:
...
/*<506>*/ 			story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          		  case 1:
/*<431>*/ 			printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ? <pause1E>Dans ce cas, je compte sur toi !")
          			goto flw_438
          		}
          	  case 1:
/*<432>*/ 		printf("\x0E\x01\x09\x04\x00\x07« ... trois... iangl... Tri... ce... »")
/*<433>*/ 		printf("\x0E\x01\x09\x04\x17\x1700À partir de là, les pages sont déchirées et je\nn'arrive pas à les déchiffrer...\n\n\nÇa m'intrigue vraiment...")
          		goto flw_438
          	}
          }
...
/*<185>*/ 	switch (scene_flags[63 /* 0x6 80 */]) {
          	  case 0:
/*<177>*/ 		printf("\x0E\x01\x09\x04\x1817\x1909Oh ! Merci ! Merci ! T'es un sacré bonhomme,\ntoi !")
...
/*<511>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 82>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ? <pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_139
          	}
          }
...
/*<187>*/ 			switch (scene_flags[64 /* 0x9 01 */]) {
          			  case 0:
/*<179>*/ 				printf("\x0E\x01\x09\x04\x1817\x1909Oh ! Merci ! Merci ! T'es un sacré bonhomme,\ntoi !")
          				flw_192:
...
/*<512>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 88>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ? <pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_140
          	}
          }
...
/*<513>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 94>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ? <pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_141
          	}
          }
...
/*<452>*/ 							entrypoint_503_58();
          						  case 1:
/*<522>*/ 							printf("\x0E\x01\x09\x04\x00\x1B05On peut vraiment obtenir une grande fortune\navec ces murs ?\n\n\n\x0E\x01\x09\x04\x08\xB00Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n\n\n[1]S'il te plaît ![2-]Ça ira")
          							goto flw_452
          						}
          					  case 1:
...
/*<454>*/ 									entrypoint_503_60();
          								  case 1:
/*<524>*/ 									printf("\x0E\x01\x09\x04!\x1705Un cercle fermé ? Quelle forme ça \npeut avoir ?\n\n\n\x0E\x01\x09\x04\x16\x1E04Peut\x2010être qu'en fait... <pause0A>c'est juste un rond !\n\n\n\n\x0E\x01\x09\x04\x08\xB00Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n\n\n[1]S'il te plaît ![2-]Ça ira")
          									goto flw_454
          								}
          							  case 1:
...
/*<455>*/ 										entrypoint_503_61();
          									  case 1:
/*<525>*/ 										printf("\x0E\x01\x09\x04\x16\x2005« Transpercer une cible au loin » ? Est\x2010ce que\nça parle de ce que je pense ?\n\n\n\x0E\x01\x09\x04\x08\xB00Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n\n\n[1]S'il te plaît ![2-]Ça ira")
          										goto flw_455
          									}
          								  case 1:
...
/*<628>*/ 								scene_flags[10 'Sealed Grounds'][69 /* 0x9 20 */] = true;
          				  ...
          				  case 1:
/*< 44>*/ 					printf("\x0E\x01\x09\x04\x08\xB07Allons, fais pas ton timide ! Ça crève les yeux\nque tu meurs d'envie d'en savoir plus ! Je vais\nte raconter !")
          					goto flw_53
          				}
          			}
          		  case 1:
...
/*<160>*/ 					entrypoint_503_62();
          				  case 1:
/*<529>*/ 					printf("\x0E\x01\x09\x04\x00\x1B05On peut vraiment obtenir une grande fortune\navec ces murs ?\n\n\n\x0E\x01\x09\x04\x08\xB00Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n\n\n[1]S'il te plaît ![2-]Ça ira")
          					goto flw_160
          				}
          			  case 1:
...
/*<162>*/ 							entrypoint_503_64();
          						  case 1:
/*<531>*/ 							printf("\x0E\x01\x09\x04!\x1705Un cercle fermé ? Quelle forme ça \npeut avoir ?\n\n\n\x0E\x01\x09\x04\x16\x1E04Peut\x2010être qu'en fait... <pause0A>c'est juste un rond !\n\n\n\n\x0E\x01\x09\x04\x08\xB00Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n\n\n[1]S'il te plaît ![2-]Ça ira")
          							goto flw_162
          						}
          					  case 1:
...
/*< 78>*/ 	switch (scene_flags[61 /* 0x6 20 */]) {
          	  case 0:
/*< 80>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il faut que je\nvoie des <y<rubis>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_79
          	  case 1:
...
/*<351>*/ 	switch (scene_flags[110 /* 0xC 40 */]) {
          	  case 0:
          		flw_13:
/*< 13>*/ 		printf("\x0E\x01\x09\x04%\x1356Euh... En fait, je viens juste de commencer mes\nrecherches...\n\n\n\x0E\x01\x09\x04\x0E\x1300Si ça t'intéresse, reviens me voir plus tard !\n\n\n\n\x0E\x01\x09\x04\x00\x1300Je vais faire de mon mieux pour mener mes\nrecherches à bien !")
          	  case 1:
/*<352>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 5, 'param3': 31}
/*<  5>*/ 		printf("\x0E\x01\x09\x04\x00\x01Tiens, comme on se retrouve ! Toujours\ndébordé, à ce que je vois...\n\n\n\x0E\x01\x09\x04\x1B\x1300Moi aussi, depuis la dernière fois, j'ai passé mon\ntemps à étudier les mystères de ce monde...\n\n\n\x0E\x01\x09\x04\x0E\x1300Tu veux que je te fasse part des conclusions de\nmes recherches ?\n[1]Oh oui ![2-]Euh, non\nmerci...")
/*<  9>*/ 		switch (choice(2)) {
          		  case 0:
/*< 10>*/ 			printf("\x0E\x01\x07\x04\x0E\x1908Tu vas pas être déçu ! En fait, au cours de mes\nrecherches, j'ai découvert quelque chose.\n\n\nDans ce monde, \x0E\x01\x07\x04\x00\x1300il existe des <r<murs>> et des <r<pierres\n>>qui réagissent aux <r<belles mélodies>> !\n\n\n\x0E\x01\x07\x04\x0E\x1300Tu veux en savoir plus ?\n[1]Bien sûr ![2-]Ça ira...")
/*< 12>*/ 			switch (choice(2)) {
          			  case 0:
/*<353>*/ 				scene_flags[10 'Sealed Grounds'][110 /* 0xC 40 */] = true;
          			  ...
          			  case 1:
          				flw_11:
/*< 11>*/ 				printf("\x0E\x01\x09\x04%\xE05Aaah... Dommage... Si tu changes d'avis, reviens\nme voir...")
          			}
          		  case 1:
          			goto flw_11
          		}
...
/*<198>*/ 			switch (random(4)) {
          			  case 0:
/*<409>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
...
/*<597>*/ 					{'type': 'type3', 'subType': 2, 'param1': 22, 'param2': 280, 'next': 501, 'param3': 15}
          			  ...
          			  case 1:
/*<410>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<401>*/ 				give_item(4 0x04);
/*<616>*/ 				{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 554, 'param3': 12}
          				goto flw_554
          			  case 2:
/*<212>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<213>*/ 				give_item(62 0x3E);
          				goto flw_554
          			  case 3:
/*<214>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
...
/*<199>*/ 			switch (random(4)) {
          			  case 0:
/*<411>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<402>*/ 				give_item(63 0x3F);
          				goto flw_554
          			  case 1:
/*<412>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<403>*/ 				give_item(4 0x04);
/*<617>*/ 				{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 554, 'param3': 12}
          				goto flw_554
          			  case 2:
/*<204>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<205>*/ 				give_item(62 0x3E);
          				goto flw_554
          			  case 3:
/*<206>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
...
/*<200>*/ 			switch (random(4)) {
          			  case 0:
/*<413>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<404>*/ 				give_item(63 0x3F);
          				goto flw_554
          			  case 1:
/*<414>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<405>*/ 				give_item(4 0x04);
/*<618>*/ 				{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 554, 'param3': 12}
          				goto flw_554
          			  case 2:
/*<208>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<209>*/ 				give_item(64 0x40);
          				goto flw_554
          			  case 3:
/*<210>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
...
/*<201>*/ 			switch (random(4)) {
          			  case 0:
/*<415>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<406>*/ 				give_item(64 0x40);
          				goto flw_554
          			  case 1:
/*<416>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<407>*/ 				give_item(4 0x04);
/*<619>*/ 				{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 554, 'param3': 12}
          				goto flw_554
          			  case 2:
/*<202>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
/*<203>*/ 				give_item(32 0x20);
/*<629>*/ 				{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 554, 'param3': 12}
          				goto flw_554
          			  case 3:
/*<417>*/ 				printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
...
/*<632>*/ 		printf("\x0E\x01\x09\x04\x1808\xB02Tiens, je te donne ça pour te remercier de\nm'avoir aidé dans mes recherches !")
...
/*< 84>*/ 	switch (scene_flags[62 /* 0x6 40 */]) {
          	  case 0:
/*< 86>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il faut que je\nvoie des <y<c\x153urs>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_85
          	  case 1:
...
/*<505>*/ 						printf("\x0E\x01\x09\x04\x00\x04En ce moment, je concentre tous mes efforts\npour découvrir où se trouvent les <r<pierres qui\nparlent >>!")
          			  ...
          			  case 1:
          				flw_16:
/*< 16>*/ 				printf("\x0E\x01\x09\x04%\xE05Aaah... Dommage... Si tu changes d'avis, reviens\nme voir...")
          			}
          		  case 1:
/*<355>*/ 			{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 6, 'param3': 31}
/*<  6>*/ 			printf("\x0E\x01\x09\x04\x00\x01Tiens, comme on se retrouve ! Toujours\ndébordé, à ce que je vois...\n\n\n\x0E\x01\x09\x04\x1B\x1300Moi aussi, depuis la dernière fois, j'ai passé mon\ntemps à étudier les mystères de ce monde...\n\n\n\x0E\x01\x09\x04\x0E\x1300Tu veux que je te fasse part des conclusions de\nmes recherches ?\n[1]Oh oui ![2-]Euh, non\nmerci...")
/*< 14>*/ 			switch (choice(2)) {
          			  case 0:
/*< 15>*/ 				printf("\x0E\x01\x07\x04\x0E\x1908Tu vas pas être déçu ! En fait, au cours de mes\nrecherches, j'ai découvert quelque chose.\n\n\nDans ce monde, \x0E\x01\x07\x04\x00\x1300il existe des <r<murs>> et des <r<pierres\n>>qui réagissent aux <r<belles mélodies>> !\n\n\n\x0E\x01\x07\x04\x0E\x1300Tu veux en savoir plus ?\n[1]Bien sûr ![2-]Ça ira...")
/*< 17>*/ 				switch (choice(2)) {
          				  case 0:
/*< 18>*/ 					printf("\x0E\x01\x09\x04\x0E\x1904Oui ! Oui ! Oui ! J'aime les jeunes gens\nenthousiastes comme toi !\n\n\n\x0E\x01\x09\x04\x00\x1900Avant de te parler des <r<murs>> et des <r<pierres>>, je\ndois te poser une question.\n\n\n\x0E\x01\x09\x04\x0E\xB00Est\x2010ce que tu sais ce que c'est qu'un <b<papillon\nazur >>? \n[1]J'en ai déjà\nvu, oui[2-]Aucune\nidée")
/*< 19>*/ 					switch (choice(2)) {
          					  case 0:
/*< 20>*/ 						printf("Très bien, tu m'épargnes des explications.")
          						goto flw_22
          					  case 1:
...
/*<600>*/ 			printf("\x0E\x01\x09\x04\x08\xB08Oh ?! Ça y est, j'ai trouvé !")
...
/*< 90>*/ 	switch (scene_flags[64 /* 0x9 01 */]) {
          	  case 0:
/*< 92>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il faut que je\nvoie des <y<bombes >>apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_91
          	  case 1:
...
/*<546>*/ 				printf("\x0E\x01\x09\x04\x13\xB04Tu sais quoi ? J'ai aperçu des <b<papillons azur\n>>pas loin d'ici !\n\n\n\x0E\x01\x09\x04\x16\x1E0BDommage que j'y connaisse rien en musique...\n\n\n\nSi seulement je savais jouer d'un instrument...")
          		  ...
          		  case 1:
/*<539>*/ 			printf("\x0E\x01\x09\x04\x13\x1953Voilà que ça recommence ! <pause1E>Mais qu'est\x2010ce qui\npeut bien se passer ?!\n\n\n\x0E\x01\x09\x04\x16\x1E00Peu importe ! Je dois poursuivre mes\nrecherches quoi qu'il arrive !")
          			goto flw_545
          		}
          	  case 1:
...
/*<540>*/ 				switch (story_flags[401 /* us: 805A9B05 0x04, jp: 805ACD85 0x04 */]) {
          				  case 0:
/*<537>*/ 					printf("\x0E\x01\x09\x04\x00\x140A<pause1E>... Tiens ?<pause1E> \x0E\x01\x09\x04\x0E\x1300C'est moi, ou ton épée a changé\ndepuis la dernière fois ?\n\n\nTu voudrais pas t'en servir pour chasser ces\ntypes en bas comme l'autre fois ?")
          					flw_601:
/*<601>*/ 					switch (story_flags[431 /* us: 805A9B09 0x01, jp: 805ACD89 0x01 */]) {
          					  case 0:
/*<604>*/ 						switch (story_flags[401 /* us: 805A9B05 0x04, jp: 805ACD85 0x04 */]) {
          						  case 0:
/*<606>*/ 							printf("\x0E\x01\x09\x04\x00\x05En tout cas... quoi qu'il arrive, je dois\npoursuivre mes recherches !")
          							flw_603:
/*<603>*/ 							entrypoint_503_66();
          						  case 1:
/*<605>*/ 							printf("\x0E\x01\x09\x04\x00\x05En tout cas... quoi qu'il arrive, je dois\npoursuivre mes recherches !")
          							goto flw_603
          						}
          					  case 1:
/*<602>*/ 						printf("\x0E\x01\x09\x04\x13\xB04Tu sais quoi ? J'ai aperçu des <b<papillons azur\n>>pas loin d'ici !\n\n\n\x0E\x01\x09\x04\x16\x1E0BDommage que j'y connaisse rien en musique...\n\n\n\nSi seulement je savais jouer d'un instrument...")
          				  ...
          				  case 1:
/*<541>*/ 					printf("\x0E\x01\x09\x04\x00\xB0A<pause1E>... Tiens ?<pause1E> \x0E\x01\x09\x04\x08\xB00C'est moi, ou ton épée a changé\ndepuis la dernière fois ?\n\n\nTu voudrais pas t'en servir pour chasser ces\ntypes en bas comme l'autre fois ?")
          					goto flw_601
          				}
          			  case 1:
/*<542>*/ 				switch (story_flags[401 /* us: 805A9B05 0x04, jp: 805ACD85 0x04 */]) {
          				  case 0:
/*<543>*/ 					printf("\x0E\x01\x09\x04\x0E\x1301Oh ! Te revoilà ! <pause1E>Il y a plein de types bizarres\nqui rôdent là en bas !\n\n\n\x0E\x01\x09\x04\x00\x02Tu voudrais pas les chasser comme la dernière\nfois ?")
          					goto flw_601
          				  case 1:
/*<  8>*/ 					printf("\x0E\x01\x09\x04\x08\xB01Oh ! Te revoilà ! <pause1E>Il y a plein de types bizarres\nqui rôdent là en bas !\n\n\n\x0E\x01\x09\x04\x18\x1802Tu voudrais pas les chasser comme la dernière\nfois ?")
          					goto flw_601
          				}
          			}
          		}
...
/*< 48>*/ 	printf("\x0E\x01\x09\x04\x1817\x1B09Oh ! Ça pour une surprise !\n\n\n\n\x0E\x01\x09\x04\x1800\x1900Quelle trouvaille ! C'est la découverte du\nsiècle !")
...
/*< 54>*/ 	switch (scene_flags[61 /* 0x6 20 */]) {
          	  case 0:
/*< 56>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il faut que je\nvoie des <y<rubis>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_55
          	  case 1:
...
/*<558>*/ 	set_camera(6, 0)
/*<488>*/ 	printf("\x0E\x01\x09\x04\x1808\xB02Tiens, prends ça. C'est pour te remercier de\nm'avoir aidé dans mes recherches !")
...
/*<493>*/ 		printf("\x0E\x01\x09\x04\x1817\x1700À partir de là, les pages sont déchirées et je\nn'arrive pas à les déchiffrer...\n\n\nÇa m'intrigue vraiment...")
/*<495>*/ 		printf("\x0E\x01\x09\x04\x1808\x1300Il faut attendre un peu avant que les murs de la\nDéesse <r<se régénèrent>> !\n\n\n\x0E\x01\x09\x04\x1818\x1700Il faudra alors que tu essaies plein de trucs\npour percer le dernier mystère !")
...
/*< 60>*/ 	switch (scene_flags[62 /* 0x6 40 */]) {
          	  case 0:
/*< 62>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il faut que je\nvoie des <y<c\x153urs>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que disent les\nécrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_61
          	  case 1:
...
/*<551>*/ 				printf("\x0E\x01\x09\x04\x13\xB04Tu sais quoi ? J'ai aperçu des <b<papillons azur\n>>pas loin d'ici !\n\n\n\x0E\x01\x09\x04\x16\x1E0BDommage que j'y connaisse rien en musique...\n\n\n\nSi seulement je savais jouer d'un instrument...")
          		  ...
          		  case 1:
/*<548>*/ 			printf("\x0E\x01\x09\x04\x13\x1953Voilà que ça recommence ! <pause1E>Mais qu'est\x2010ce qui\npeut bien se passer ?!\n\n\n\x0E\x01\x09\x04\x16\x1E00Peu importe ! Je dois poursuivre mes\nrecherches quoi qu'il arrive !")
          			goto flw_550
          		}
          	  case 1:
          		goto flw_550
