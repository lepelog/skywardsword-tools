...
/*<163>*/ 	start()
/*<162>*/ 	printf("Eh, le maître en vert, prends\x2010en de la graine !")
          }
...
/*<422>*/ 		printf("\x0E\x01\x09\x04\x00\x04La paix, c'est le pied ! Mais bon, y a pas\ngrand\x2010chose à faire, du coup...\n\n\n\x0E\x01\x09\x04\x11\x05J'ai des soucis de luxe, on dirait...")
          	  case 1:
/*<423>*/ 		printf("\x0E\x01\x09\x04\x00\x14Nous nous sommes réfugiés ici. Tu ferais\nmieux de partir, tu risques de nous attirer\ndes monstres !")
          	}
          }
...
/*<426>*/ 			switch (story_flags[55 /* us: 805A9ADC 0x04, jp: 805ACD5C 0x04 */]) {
          			  case 0:
/*<427>*/ 				printf("\x0E\x01\x09\x04\x00\x13Tu me trouves tout de suite, c'est même pas\ndrôle de se cacher !")
          			  case 1:
/*<428>*/ 				printf("\x0E\x01\x09\x04\x11\x13Tu m'as encore trouvé, tu es vraiment trop\nfort !\n\n\n\x0E\x01\x09\x04\x0B\x07En récompense, je vais te donner quelque\nchose que j'ai trouvé pendant mes parties\nde cache\x2010cache.")
...
/*<431>*/ 				story_flags[55 /* us: 805A9ADC 0x04, jp: 805ACD5C 0x04 */] = true;
          		  ...
          		  case 1:
/*<425>*/ 			printf("\x0E\x01\x09\x04\x00\x07Nous vivons ici. Il y a à manger, c'est bien\nagréable !")
          		}
          	}
          }
...
/*<532>*/ 			entrypoint_203_09();
          		  case 1:
/*<434>*/ 			printf("\x0E\x01\x09\x04\x00\x0ELe dragon d'eau a reconnu ta valeur ? Ça, par\nexemple !")
/*<531>*/ 			entrypoint_203_09();
          		}
          	  case 1:
/*<225>*/ 		switch (story_flags[64 /* us: 805A9ADF 0x08, jp: 805ACD5F 0x08 */]) {
          		  case 0:
/*<226>*/ 			printf("\x0E\x01\x09\x04\x00\x0ETu as rencontré le dragon d'eau ? Oh, comme\nje t'envie !")
...
/*< 17>*/ 							temp_flags[5 /* 0x1 20 */] = true;
          					  ...
          					  case 1:
/*< 12>*/ 						printf("\x0E\x01\x09\x04\x00\x0EComment ? Tu es allé jusqu'au sommet de\nl'arbre ?\n\n\n\x0E\x01\x09\x04\x00\x08Et tu y as trouvé quelqu'un ? Il faut que j'aille\nvoir ça !")
...
/*< 80>*/ 						printf("\x0E\x01\x09\x04\x00\x02Si tu parviens à monter jusqu'à son sommet, tu\ntrouveras peut\x2010être quelque chose... Et la vue\ndoit être belle !")
...
/*<  7>*/ 					printf("\x0E\x01\x09\x04\x00\x03Il y a sûrement des endroits dans cette forêt où\ntu n'es jamais allé, n'est\x2010ce pas ?\n\n\n\x0E\x01\x09\x04\x00\x08Mets donc l'écaille à profit pour faire un brin\nd'exploration !")
...
/*<525>*/ 					entrypoint_203_09();
          				  case 1:
/*<435>*/ 					printf("\x0E\x01\x09\x04\x00\x03Oh, tu n'as donc pas trouvé ton amie dans les\nprofondeurs de la forêt...\n\n\n\x0E\x01\x09\x04\x00\x02Ne te décourage pas et tu la retrouveras, tout\ncomme nous, les Tikwis, nous sommes retrouvés.")
...
/*<156>*/ 	start()
/*<157>*/ 	printf("\x0E\x01\x12\x04\x00\x01Maître, retournons dans le ciel et dirigeons\x2010nous vers\nle volcan.")
...
/*<476>*/ 	start()
/*<477>*/ 	printf("Le niveau de l'eau a baissé. La forêt est revenue à son\nétat originel.")
...
/*<500>*/ 	start()
/*<501>*/ 	printf("Glou ! C'est étonnant qu'un humain puisse\nvenir jusqu'ici, glou. C'est très profond, glou !\n\n\nTu n'aurais pas un peu fait des <r<tourbillons>>, par\nhasard, glou ?")
          }
...
/*<520>*/ 	switch (story_flags[481 /* us: 805A9B11 0x20, jp: 805ACD91 0x20 */]) {
          	  case 0:
/*<523>*/ 		printf("\x0E\x01\x09\x04\x00\x08Et sinon, comment va Romar dans son nouveau\nchez\x2010lui ?")
          	  case 1:
/*<521>*/ 		switch (story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */]) {
          		  case 0:
/*<522>*/ 			printf("\x0E\x01\x09\x04\x00\x08Sinon, il paraît que Romar souhaite quitter la\nforêt ? Bah, pourquoi pas !")
          		  case 1:
          		}
          	}
          }
...
/*< 46>*/ 			printf("\x0E\x01\x09\x04\x00\x13Moi, je retourne à la sieste.")
          		  case 1:
/*< 47>*/ 			printf("\x0E\x01\x09\x04\x03\x07Allez, fais bien attention à toi, ne cherche pas\ntrop les pépins.")
...
/*<142>*/ 							temp_flags[15 /* 0x0 80 */] = true;
          					  ...
          					  case 1:
/*<141>*/ 						printf("Waouh, glou ! Tu es bien le messager de la\nDéesse, glou ! ")
...
/*< 93>*/ 				switch (random(2)) {
          				  case 0:
/*< 95>*/ 					printf("S'il te plaît, aide le dragon d'eau, glou...")
/*<558>*/ 					set_camera(34, 0)
/*< 97>*/ 					make_actor_do_something(0, 0)
/*< 96>*/ 					printf("Aide\x2010le, glou ! Aide\x2010le, glou !")
          					goto flw_563
          				  case 1:
/*< 91>*/ 					printf("Le dragon d'eau t'attend, glou. Va lui parler,\nglou !")
/*<559>*/ 					set_camera(34, 0)
...
/*<136>*/ 	switch (random(2)) {
          	  case 0:
/*<137>*/ 		printf("Par ici, glou, par ici, glou ! Vite, glou, vite,\nglou !\n\n\nGlou ? Tu ne peux pas passer, glou ? Être\nhumain, c'est pas pratique, glou ! Essaie de\npasser par\x2010dessus, glou !")
          	  case 1:
/*<135>*/ 		printf("Ah, glou ! Tu ne pourras pas entrer ici, glou !\n\n\n\nViens me chercher, si tu y arrives, glou !")
          	}
          }

          void entrypoint_203_65() {
/*<513>*/ 	start()
/*<514>*/ 	printf("Belle maison, n'est\x2010ce pas, glou ? Pas si facile\nd'accès, mais bon, glou...")
          }
...
/*<251>*/ 				printf("Dommage que le niveau de l'eau ait à nouveau\nbaissé, glou.")
          			  case 1:
/*<250>*/ 				printf("Le dragon d'eau se porte bien maintenant, glou.\nMerci de l'avoir aidée, glou !")
          			}
          		  case 1:
/*<249>*/ 			printf("Le dragon d'eau ne va pas très bien. Fais\nquelque chose, glou !")
          		}
          	  case 1:
...
/*<564>*/ 	start()
/*<565>*/ 	printf("Écoutez bien, \x0E\x01\x12\x04\x00\x01Maître. Entendez\x2010vous quelque chose ?")
          }
...
/*<350>*/ 	printf("Vous êtes à la cime de l'arbre.\n\n\n\nObservez les environs, vous découvrirez peut\x2010être des\nendroits inexplorés.")
...
/*< 39>*/ 				switch (story_flags[61 /* us: 805A9ADF 0x01, jp: 805ACD5F 0x01 */]) {
          				  case 0:
/*< 40>*/ 					printf("\x0E\x01\x09\x04\x01\x04Noix, encore toi ? Tu as quelque rose à me dire,\npar tous les sapins ?\n[1]Oui[2-]Non")
/*< 41>*/ 					switch (choice(2)) {
          					  case 0:
...
/*< 43>*/ 						printf("\x0E\x01\x09\x04\x00\x13Moi, je retourne à la sieste.")
          			  ...
          			  case 1:
/*<356>*/ 				printf("\x0E\x01\x09\x04\x00\x14Kiwi me carambole dans mon sommeil ?")
/*<375>*/ 				set_camera(20, 0)
...
/*<578>*/ 							entrypoint_203_10();
          						  case 1:
/*<577>*/ 							printf("\x0E\x01\x09\x04\x00\x03Par tous les salsifis, on dirait bien que tu as\nperdu la ciboule...")
          							flw_378:
/*<378>*/ 							set_camera(20, 0)
          							flw_379:
...
/*<354>*/ 								printf("\x0E\x01\x09\x04\x03\x08Très bien, petit pin, je vais tout te dire.\nEt souviens\x2010toi, c'est un secret !")
          								flw_355:
/*<355>*/ 								set_camera(18, 0)
/*<364>*/ 								printf("\x0E\x01\x09\x04\x03\x04La flamme que tu cherches...<pause0F> s'appelle la\n<b<<pling>flamme de Farore>>.\n\n\n\x0E\x01\x09\x04\x01\x00Son histoire remonte au temps radis, euh, jadis,\nquand la Déesse était parmi nous...")
/*<365>*/ 								set_camera(21, 0)
/*<366>*/ 								printf("\x0E\x01\x09\x04\x00\x02Elle fut confiée au grand esprit qui règne sur\nla <b<forêt de Firone>>, le <b<dragon d'eau>>.")
/*<367>*/ 								set_camera(22, 0)
...
/*<369>*/ 								set_camera(20, 0)
/*<370>*/ 								printf("Et ça pourrait bien être toi, petit pois...\n\n\n\n\x0E\x01\x09\x04\x03\x09Le temps est venu pour toi de rencontrer le\ndragon d'eau.")
/*<371>*/ 								set_camera(23, 0)
...
/*< 84>*/ 		switch (adventure_pouch_has(7 0x0007)) {
          		  case 0:
/*< 85>*/ 			printf("Analyse de l'eau de la bassine\x0E\x01\x06\x02\xFCCD...<pause0F> \x0E\x01\x06\x02ÍSa <pling><r<composition est\nidentique >>à celle de la source de la contemplation,\n\x0E\x01\x12\x04\x00\x01Maître.")
...
/*<185>*/ 				entrypoint_203_91();
          		  ...
          		  case 1:
/*< 67>*/ 			printf("Analyse de l'eau de la bassine\x0E\x01\x06\x02\xFCCD...<pause0F> \x0E\x01\x06\x02Í<pling>Ajout à la <r<fonction\ndétection>> opéré. Vous pouvez à présent rechercher\nl'eau sacrée.")
...
/*<413>*/ 	switch (story_flags[16 /* us: 805A9ADB 0x02, jp: 805ACD5B 0x02 */]) {
          	  case 0:
/*<414>*/ 		printf("\x0E\x01\x09\x04\x00\x07Les méchants intrus ont disparu, c'est la\npatate ! Je revis dans la paix et l'harmonie !\n\n\n\x0E\x01\x09\x04\x00\x04J'aimerais que tu puisses aussi vivre dans la\npaix et l'harmonie avec ton amie comme toi !")
          	  case 1:
/*<415>*/ 		printf("\x0E\x01\x09\x04\x00\x01Hé ! C'est moi ! Tu as retrouvé ton amie\ncomme toi ?\n[1]Qui es\x2010tu ?[2]Pas encore")
/*<533>*/ 		switch (choice(2)) {
          		  case 0:
/*<534>*/ 			printf("\x0E\x01\x09\x04\x11\x13Tu te souviens pas de moi ?<pause1E> Il serait peut\x2010être\ntemps !\n\n\n\x0E\x01\x09\x04\x0B\x04Pour nous différencier, nous, les Tikwis, t'as\nqu'à ouvrir ta carte ! Notre nom apparaît si\ntu nous pointes avec le curseur.")
          		  case 1:
/*<535>*/ 			printf("\x0E\x01\x09\x04\x11\x13C'est dommage... Ce serait tellement bien que\nvous soyez réunis, comme nous, les Tikwis !")
          		}
          	}
          }
...
/*<179>*/ 	switch (scene_flags[127 /* 0xE 80 */]) {
          	  case 0:
/*<180>*/ 		printf("Han, encore cette <r<bassine>> ?<pause0F> Euh, pas de\nproblème, laissez\x2010moi faire !")
          	  case 1:
/*<160>*/ 		printf("Ouh, en voilà un gros truc lourd...<pause0F> Mais pour\nmoi, rien de plus facile !")
          	}
          }
...
/*<417>*/ 	switch (story_flags[16 /* us: 805A9ADB 0x02, jp: 805ACD5B 0x02 */]) {
          	  case 0:
/*<418>*/ 		printf("\x0E\x01\x09\x04\x09\x0CTout le monde dit que la paix est revenue dans\nla forêt, mais j'en crois pas un mot !\n\n\n\x0E\x01\x09\x04\x07\x13N'y a\x2010t\x2010il pas un endroit sûr, où nous pourrions\nnous tenir droits et fiers, comme des carottes ?")
          	  case 1:
/*<419>*/ 		printf("\x0E\x01\x09\x04\x09\x0CJusqu'à quand serons\x2010nous obligés de vivre ainsi\ndans la peur ?\n\n\n\x0E\x01\x09\x04\x07\x13N'y a\x2010t\x2010il pas un endroit sûr, où nous pourrions\nnous tenir droits et fiers, comme des carottes ?")
          	}
          }
