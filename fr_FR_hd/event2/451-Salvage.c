          void entrypoint_451_01() {
          	start()
/*<  1>*/ 	printf("Cet objet pourrait être celui qu'a perdu l'homme de\nl'île roulette.\n\n\nJe peux appeler le robot de l'atelier de rénovation\npour qu'il vienne le récupérer. Dois\x2010je appeler le\nrobot ?\n[1]S'il te plaît[2-]Non merci")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x05Très bien, Maître. J'appelle le robot par ondes\npsychiques.")
          	  case 1:
