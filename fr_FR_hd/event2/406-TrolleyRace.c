...
/*< 58>*/ 								printf("C'est parti pour le parcours débutant. Bonne\nchance !")
...
/*< 14>*/ 											switch (story_flags[500 /* us: 805A9B12 0x04, jp: 805ACD92 0x04 */]) {
          											  case 0:
/*< 43>*/ 												printf("Pour l'instant, ton meilleur temps est de\n\x0E\x02\x03\x06\x00\x00\x2CD min <numeric arg1(2)> s <numeric arg2(2)> !")
          												goto flw_101
          											  case 1:
          												goto flw_101
          											}
...
/*< 38>*/ 						printf("Tu dois atteindre la ligne d'arrivée le plus vite\npossible.\n\n\nIncline ton corps pour faire pencher le\nwagonnet.\n\n\nPenche\x2010le au bon moment pour accélérer !\n\n\n\nReste bien concentré, sinon tu risques de\ndérailler !")
...
/*< 20>*/ 						zone_temp_flags[0 /* 0x1 01 */] = true;
          				  ...
          				  case 1:
/*< 31>*/ 					printf("Hé, toi ! Qu'est\x2010ce que tu fais ici ?\n\n\n\nBon, peu importe, t'es là maintenant, alors\nautant s'amuser un peu, non ?\n[1]S'amuser ?[2-]Euh, non")
/*< 45>*/ 					switch (choice(2)) {
          					  case 0:
/*< 35>*/ 						printf("Je savais bien que tu serais intéressé ! Je vais\nt'expliquer comment ça marche.")
          						goto flw_110
          					  case 1:
/*< 46>*/ 						printf("Dis donc, rabat\x2010joie, tu perds rien à m'écouter,\nau moins !\n[1]D'accord[2-]Non merci !")
          						goto flw_19
          					}
          				}
          			}
...
/*< 74>*/ 							switch (story_flags[529 /* us: 805A9B14 0x40, jp: 805ACD94 0x40 */]) {
          							  case 0:
/*< 53>*/ 								printf("C'est pas mal du tout. Mais je suis toujours bien\nplus rapide !\n\n\nTiens, voilà pour toi.")
/*<  6>*/ 								give_item(63 0x3F);
          								goto flw_68
          							  case 1:
...
/*< 54>*/ 							printf("Waouh ! Impressionnant, extraordinaire !\nMême moi, je vais pas aussi vite !")
...
/*< 49>*/ 			printf("Oups, raté ! Il te reste qu'à retenter ta chance !")
...
/*< 99>*/ 			printf("Le temps est écoulé ! Faudra faire mieux la\nprochaine fois.")
