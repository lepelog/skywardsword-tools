...
/*<  2>*/ 	start()
/*<  3>*/ 	printf("\x0E\x01\x09\x04C\x4500Oups, raté ! Hmm, ça n'a vraiment servi à\nrien...\n\n\n\x0E\x01\x09\x04A\x4000Bon, je recharge la machine, alors tiens bon\njusqu'à mon prochain signal !")
          }
...
/*<210>*/ 	start()
/*<211>*/ 	printf("\x0E\x01\x05\x04K\x00Voici la <b<terre>> dont parlent les légendes de Célesbourg.")
          }
...
/*<214>*/ 	start()
/*<212>*/ 	printf("\x0E\x01\x05\x04K\x00Cet endroit s'appelle le <b<vallon du sceau>>.")
          }

          void entrypoint_500_73() {
/*<479>*/ 	start()
/*<477>*/ 	printf("\x0E\x01\x06\x02\xFDCDToi...\n\n\n\n\x0E\x01\x06\x02\xFDCDToi, fils du destin, qui descends du ciel...")
          }
...
/*<485>*/ 	set_camera(52, 0)
/*<376>*/ 	printf("\x0E\x01\x09\x04\x2800SWaouh !\x0E\x01\x05\x04\x1E\x00")
/*<254>*/ 	printf("\x0E\x01\x09\x04\x2800\x4000On dirait que les gros ennuis vont commencer...\x0E\x01\x05\x04\x1E\x00")
/*<255>*/ 	printf("\x0E\x01\x09\x04\x283E\x400FMais rassure\x2010toi !\n\n\n\n\x0E\x01\x09\x04\x2841\x00Tu commences à connaître l'efficacité de ma\n<r<mégatapulte>>, non ?")
/*<256>*/ 	printf("\x0E\x01\x09\x04\x2800\x00Tant qu'elle sera là, le mot « défaite » ne\nfigurera pas dans mon dictionnaire !\n\n\n\x0E\x01\x09\x04\x2800\x200J'ai une mission à remplir...")
/*<257>*/ 	printf("\x0E\x01\x09\x04\x2800\x200Alors essaie de ne pas trop me gêner pendant\nque je sauve le monde, Link !")
...
/*<475>*/ 	start()
/*<481>*/ 	printf("\x0E\x01\x12\x04\x00\x01Maître, Fay au rapport.")
...
/*<547>*/ 	switch (story_flags[703 /* us: 805A9B22 0x08, jp: 805ACDA2 0x08 */]) {
          	  case 0:
/*<548>*/ 		printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Le <r<pilier du sceau >>est planté\ndans le front de la bête.\n\n\nVous ne devez pas fuir sans avoir refermé le sceau.")
          	  case 1:
/*<139>*/ 		switch (story_flags[136 /* us: 805A9AE4 0x40, jp: 805ACD64 0x40 */]) {
          		  case 0:
/*<140>*/ 			switch (scene_flags[17 /* 0x3 02 */]) {
          			  case 0:
/*<141>*/ 				printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Vous devez refermer le sceau\nqui emprisonne le démon.\n\n\nVous ne pouvez pas fuir maintenant, \x0E\x01\x12\x04\x00\x02Maître.")
          			  case 1:
/*<142>*/ 				printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Le <r<pilier du sceau >>est planté\ndans le front de la bête.\n\n\nVous ne devez pas fuir sans avoir refermé le sceau.")
          			}
          		  case 1:
/*<138>*/ 			printf("")
          		}
...
/*<217>*/ 	start()
/*<218>*/ 	printf("\x0E\x01\x09\x04>\x4515\x0E\x01\x08\x02\x1CDGaaah !\n\n\n\n\x0E\x01\x09\x04\x00\x4000Avec tous ces tremblements, les murs se sont\nécroulés et les bombes ne sont plus accessibles !\n\n\nÇa, c'est rude ! Qu'est\x2010ce qu'on va faire ?\n\n\n\n\x0E\x01\x08\x02\x1CD!!!")
          }

          void entrypoint_500_76() {
/*<506>*/ 	start()
/*<466>*/ 	printf("\x0E\x01\x09\x04\x13\x1907Mais comment as\x2010tu fait ça ? C'est un tour\nde magie ?\n\n\n\x0E\x01\x09\x04\x17\x1B08La statue a réagi quand tu t'es approché !\nQuel talent !")
          }

          void entrypoint_500_08() {
/*< 10>*/ 	start()
/*< 11>*/ 	printf("\x0E\x01\x09\x04D\x4300Je l'ai touché, mais on dirait que c'était pas le\nbon moment ! Un peu trop tard, peut\x2010être...\n\n\n\x0E\x01\x09\x04\x00\x4000Bon, je recharge la bête, alors tiens bon jusqu'à\nmon prochain signal !")
          }
...
/*<132>*/ 	printf("\x0E\x03\x01\x00Link ! On dirait bien que le gros\nvilain pas beau refait des siennes !")
...
/*<223>*/ 	printf("\x0E\x01\x07\x04\x2800\x0FHéhéhé, sous tes yeux ébahis... Voici l'ultime\narme super secrète du grand Hergo !")
/*<230>*/ 	set_camera(32, 0)
/*<344>*/ 	{'type': 'type3', 'subType': 4, 'param1': 10304, 'param2': 16896, 'next': 224, 'param3': 13}
/*<224>*/ 	printf("Son petit nom, c'est... la <r<mégatapulte>> !")
/*<345>*/ 	{'type': 'type3', 'subType': 4, 'param1': 10302, 'param2': 512, 'next': 225, 'param3': 13}
/*<225>*/ 	printf("\x0E\x01\x09\x04\x2800\x18J'vois que t'en restes coi, et c'est bien normal !\nCe n'est qu'au bout d'incroyables efforts que j'ai\nréussi à construire ce chef\x2010d'\x153uvre !")
/*<361>*/ 	printf("Regarde un peu ça !")
/*<232>*/ 	set_camera(33, 0)
/*<362>*/ 	printf("\x0E\x01\x09\x04\x2840\x4300J'ai déblayé la zone entière pour pouvoir\ninstaller le rail qui permet de déplacer\ncet engin. Et j'ai tout fait tout seul !\n\nHa, je m'étonne moi\x2010même...<pause1E> Tout ce talent qui\nne demandait qu'à s'exprimer !\n\n\n\x0E\x01\x09\x04\x2841\x4000Il ne reste plus qu'à utiliser cette machine\nde rêve pour lui faire la tête au carré, à ce\ndémon !")
/*<233>*/ 	set_camera(32, 0)
/*<226>*/ 	printf("\x0E\x01\x09\x04\x2804\x4000Une seule de mes petites bombes dans ce gros\ntas, ça devrait le calmer un petit moment !")
/*<368>*/ 	{'type': 'type3', 'subType': 4, 'param1': 10304, 'param2': 16896, 'next': 227, 'param3': 13}
/*<227>*/ 	printf("Enfin, c'est bien joli, mais ce démon arrive un\npoil trop tôt.")
...
/*<580>*/ 	start()
/*<581>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Vous devez refermer le sceau\nqui emprisonne le démon.\n\n\nVous ne pouvez pas fuir maintenant, \x0E\x01\x12\x04\x00\x02Maître.")
          }
...
/*<247>*/ 	printf("\x0E\x01\x07\x04\x2800\x0FHéhéhé, sous tes yeux ébahis... Voici l'ultime\narme super secrète du grand Hergo !")
/*<299>*/ 	set_camera(46, 0)
...
/*<248>*/ 	printf("Son petit nom, c'est... la <r<mégatapulte>> !")
...
/*<249>*/ 	printf("\x0E\x01\x09\x04\x2800\x18J'vois que t'en restes coi, et c'est bien normal !\nCe n'est qu'au bout d'incroyables efforts que j'ai\nréussi à construire ce chef\x2010d'\x153uvre !")
/*<363>*/ 	printf("Regarde un peu ça !")
/*<301>*/ 	set_camera(47, 0)
/*<364>*/ 	printf("\x0E\x01\x09\x04\x2840\x4300J'ai déblayé la zone entière pour pouvoir\ninstaller le rail qui permet de déplacer\ncet engin. Et j'ai tout fait tout seul !\n\nHa, je m'étonne moi\x2010même...<pause1E> Tout ce talent qui\nne demandait qu'à s'exprimer !\n\n\n\x0E\x01\x09\x04\x2841\x4000Il ne reste plus qu'à utiliser cette machine\nde rêve pour lui faire la tête au carré, à ce\ndémon !")
/*<367>*/ 	set_camera(32, 0)
/*<250>*/ 	printf("\x0E\x01\x09\x04\x2804\x4000Une seule de mes petites bombes dans ce gros\ntas, ça devrait le calmer un petit moment !")
/*<348>*/ 	{'type': 'type3', 'subType': 4, 'param1': 10304, 'param2': 16896, 'next': 251, 'param3': 13}
/*<251>*/ 	printf("Enfin, c'est bien joli, mais ce démon arrive un\npoil trop tôt.")
...
/*< 89>*/ 	start()
/*< 88>*/ 	printf("\x0E\x01\x09\x04\x00&Hoho, on dirait qu'il s'est acheté une paire de\nbras ! Très bien !\n\n\nC'est pile le moment de montrer ce que ma\nmégatapulte a dans le ventre !\n\n\n\x0E\x01\x09\x04B\x4000Je te ferai signe dès que je serai prêt, alors\ntiens bon en attendant !")
          }
...
/*<553>*/ 	switch (story_flags[704 /* us: 805A9B22 0x10, jp: 805ACDA2 0x10 */]) {
          	  case 0:
/*<554>*/ 		printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Le démon s'est à nouveau\nréveillé. Vous ne pouvez pas fuir maintenant.")
          	  case 1:
/*<161>*/ 		switch (scene_flags[18 /* 0x3 04 */]) {
          		  case 0:
/*<162>*/ 			printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Vous devez à nouveau\nrefermer le sceau qui emprisonne le démon.\n\n\nVous ne pouvez pas fuir maintenant, \x0E\x01\x12\x04\x00\x02Maître.")
          		  case 1:
/*<163>*/ 			printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Le démon s'est à nouveau\nréveillé. Vous ne pouvez pas fuir maintenant.")
          		}
          	}
          }
...
/*<235>*/ 	printf("\x0E\x01\x09\x04\x2800\x4000On dirait que les gros ennuis vont commencer...\x0E\x01\x05\x04\x1E\x00")
/*<241>*/ 	set_camera(32, 0)
/*<351>*/ 	{'type': 'type3', 'subType': 4, 'param1': 10304, 'param2': 16896, 'next': 236, 'param3': 13}
/*<236>*/ 	printf("\x0E\x01\x09\x04\x283E\x400FMais rassure\x2010toi !\n\n\n\n\x0E\x01\x09\x04\x2841\x00Tu commences à connaître l'efficacité de ma\n<r<mégatapulte>>, non ?")
/*<237>*/ 	printf("\x0E\x01\x09\x04\x2800\x00Tant qu'elle sera là, le mot « défaite » ne\nfigurera pas dans mon dictionnaire !\n\n\n\x0E\x01\x09\x04\x2800\x200J'ai une mission à remplir...")
/*<352>*/ 	{'type': 'type3', 'subType': 4, 'param1': 10305, 'param2': 17152, 'next': 242, 'param3': 13}
/*<242>*/ 	printf("\x0E\x01\x09\x04\x2800\x200Alors essaie de ne pas trop me gêner pendant\nque je sauve le monde, Link !")
/*<309>*/ 	set_camera(45, 0)
...
/*<530>*/ 			switch (scene_flags[43 /* 0x4 08 */]) {
          			  case 0:
/*<534>*/ 				printf("\x0E\x01\x09\x04\x00\x4026\x0E\x03\x01\x00Link ! Je peux plus accéder à la\nréserve de bombes pour recharger la machine !\n\n\n\x0E\x01\x09\x04 \x4000Alors monte dans la machine, je vais t'envoyer\ndirectement sur sa tête !")
          			  case 1:
/*<532>*/ 				switch (zone_temp_flags[11 /* 0x0 08 */]) {
          				  case 0:
/*<533>*/ 					printf("\x0E\x01\x09\x04\x00&Tu peux utiliser la <r<mégatapulte>> !\n\n\n\nAppuie sur \x0E\x02\x04\x02\x1ECD pour te préparer à tirer sur\ncette vermine !\x0E\x01\x11\x02\x10CD\n\n\nTu peux déplacer la machine avec \x0E\x02\x04\x02\xECD et viser\navec le curseur. Ensuite, tire\x2010lui dessus, et\nboum !")
          				  case 1:
/*<531>*/ 					printf("\x0E\x01\x09\x04\x00\x4226Une fois de plus, le grand Hergo et sa\n<r<mégatapulte>> entrent en jeu !\n\n\nDès que je serai prêt, je te ferai signe en\napparaissant sur \x0E\x02\x04\x02\x1ECD ! Tu devrais avoir\nl'habitude, maintenant !\x0E\x01\x11\x02\x10CD\n\n\x0E\x01\x09\x04B\x4000Allez, il est temps de lui botter le derrière avec\nnotre super attaque combinée de la mort !")
          				}
          			}
          		  case 1:
...
/*<564>*/ 							switch (story_flags[799 /* us: 805A9B2F 0x80, jp: 805ACDAF 0x80 */]) {
          							  case 0:
          								flw_194:
/*<194>*/ 								printf("\x0E\x01\x09\x04\x00&Alors, où est\x2010ce que je te jette ?\n\n\n\n[1]Jeux dans\nle ciel[2]Jeux sur\nterre[3-]Nulle part")
/*<195>*/ 								switch (choice(3)) {
          								  case 0:
/*<586>*/ 									switch (story_flags[394 /* us: 805A9B0C 0x10, jp: 805ACD8C 0x10 */]) {
          									  case 0:
/*<196>*/ 										printf("Les jeux du ciel, hein ? Compris ! Où veux\x2010tu\naller, exactement ?\n\n\n[1]Roulette[2]Île aux\ninsectes[3]Autre part")
/*<571>*/ 										switch (choice(3)) {
          										  case 0:
          											flw_209:
...
/*<199>*/ 											printf("\x0E\x01\x09\x04B\x342C'est parti, accroche\x2010toi bien !")
          										  case 1:
          											flw_202:
...
/*<200>*/ 												printf("Reviens me voir si tu veux que je t'envoie\nquelque part !")
          									  ...
          									  case 1:
/*<585>*/ 										printf("Les jeux du ciel, hein ? Compris ! Où veux\x2010tu\naller, exactement ?\n[1]Roulette[2]Île aux\ninsectes[3]Tranche\x2010bambou[4-]Nulle part")
/*<587>*/ 										switch (choice(4)) {
          										  case 0:
          											goto flw_209
          										  case 1:
...
/*<577>*/ 								switch (story_flags[824 /* us: 805A9B33 0x01, jp: 805ACDB3 0x01 */]) {
          								  case 0:
          									goto flw_194
          								  case 1:
/*<578>*/ 									printf("Hé, je peux t'envoyer à un nouvel endroit avec\nma super machine !")
          									flw_575:
/*<575>*/ 									printf("Je peux t'envoyer là où ça te chante !\n\n\n\nEnfin, si tu y es jamais allé, pense bien à\nfouiller un peu partout !")
...
/*<574>*/ 								printf("\x0E\x01\x09\x04\x00\x04Salut, Link ! Hé, je peux t'envoyer\nà un nouvel endroit avec ma super machine !")
          					  ...
          					  case 1:
/*< 79>*/ 						printf("\x0E\x01\x09\x04\x00\x03Tu veux aller à la forêt de Firone ?\n\n\n\nOK, je t'envoie là\x2010bas en un coup de cuillère à\npot, euh, de <r<mégatapulte>> !\n[1]OK[2-]Non merci")
/*< 93>*/ 						switch (choice(2)) {
          						  case 0:
/*< 95>*/ 							printf("\x0E\x01\x09\x04\x00BHaha ! Laisse\x2010moi te montrer ce que je sais\nfaire !")
/*< 92>*/ 							zone_temp_flags[0 /* 0x1 01 */] = true;
/*< 96>*/ 							{'type': 'type3', 'subType': 1, 'param1': 3, 'param2': -1, 'next': -1, 'param3': 42}
          						  case 1:
/*< 94>*/ 							printf("Reviens me parler si t'as envie d'y aller !")
          						}
          					}
          				  case 1:
...
/*<187>*/ 						switch (story_flags[133 /* us: 805A9AE4 0x08, jp: 805ACD64 0x08 */]) {
          						  case 0:
          							flw_190:
/*<190>*/ 							printf("\x0E\x01\x09\x04\x00&Tu peux remercier le grand Hergo, une fois\nde plus ! Allez, va refermer le sceau !\nGrouille\x2010toi !")
          						  case 1:
...
/*<320>*/ 								switch (scene_flags[43 /* 0x4 08 */]) {
          								  case 0:
/*<324>*/ 									printf("\x0E\x01\x09\x04\x00\x4026\x0E\x03\x01\x00Link ! Je peux plus accéder à la\nréserve de bombes pour recharger la machine !\n\n\n\x0E\x01\x09\x04 \x4000Alors monte dans la machine, je vais t'envoyer\ndirectement sur sa tête !")
          								  case 1:
/*<322>*/ 									switch (zone_temp_flags[11 /* 0x0 08 */]) {
          									  case 0:
/*<323>*/ 										printf("\x0E\x01\x09\x04\x00&Tu peux utiliser la <r<mégatapulte>> !\n\n\n\nAppuie sur \x0E\x02\x04\x02\x1ECD pour te préparer à tirer sur\ncette vermine !\x0E\x01\x11\x02\x10CD\n\n\nTu peux déplacer la machine avec \x0E\x02\x04\x02\xECD et viser\navec le curseur. Ensuite, tire\x2010lui dessus, et\nboum !")
          									  case 1:
...
/*<318>*/ 								switch (zone_temp_flags[11 /* 0x0 08 */]) {
          								  case 0:
/*<319>*/ 									printf("\x0E\x01\x09\x04\x00&Tu peux utiliser la <r<mégatapulte>> !\n\n\n\nAppuie sur \x0E\x02\x04\x02\x1ECD pour te préparer à tirer sur\ncette vermine !\x0E\x01\x11\x02\x10CD\n\n\nTu peux déplacer la machine avec \x0E\x02\x04\x02\xECD et viser\navec le curseur. Ensuite, tire\x2010lui dessus, et\nboum !")
          								  case 1:
/*< 73>*/ 									printf("\x0E\x01\x09\x04\x04\x4100C'est le moment idéal pour que la <r<mégatapulte>>,\nma super arme secrète, entre en jeu !\n\n\n\x0E\x01\x09\x04\x00\x300J'te ferai signe quand je serai prêt, tu pourras\nappuyer sur \x0E\x02\x04\x02\x1ECD pour tirer ! \x0E\x01\x09\x04\x00\x4000En attendant,\ndébrouille\x2010toi avec ton épée !\x0E\x01\x11\x02\x10CD")
          								}
          							}
          						}
          					}
...
/*<379>*/ 	printf("\x0E\x03\x01\x00Link ! On dirait bien que le gros\nvilain pas beau refait des siennes !")
...
/*<540>*/ 		printf("\x0E\x03\x01\x00Link ! Le <r<pilier du sceau >>doit se\ntrouver sur le front du démon.\n\n\n\x0E\x01\x09\x04\xE00\x13Si tu parviens à enfoncer ce pilier avec ton\népée, tu devrais pouvoir vaincre ce monstre.")
          	  case 1:
...
/*<158>*/ 				printf("\x0E\x03\x01\x00Link ! Le <r<pilier du sceau >>doit se\ntrouver sur le front du démon.\n\n\n\x0E\x01\x09\x04\xE00\x13Si tu parviens à enfoncer ce pilier avec ton\népée, tu devrais pouvoir vaincre ce monstre.")
          			}
          		  case 1:
/*<155>*/ 			printf("\x0E\x01\x09\x04\x08\x170F\x0E\x03\x01\x00Link ! Rends\x2010toi vite au <r<pilier du\nsceau >>au centre du vallon.\n\n\n\x0E\x01\x09\x04\x14\xB00Il est fort inhabituel que la terre tremble ainsi...\nIl faut aller s'assurer que le démon n'est pas en\ntrain de se réveiller.")
          		}
          	}
          }
...
/*<267>*/ 	printf("\x0E\x01\x09\x04\x4000Que... Qu'est\x2010ce que c'est que ça ?")
/*<291>*/ 	set_camera(24, 0)
/*<287>*/ 	{'type': 'type3', 'subType': 4, 'param1': 1079, 'param2': 14592, 'next': 283, 'param3': 13}
/*<283>*/ 	printf("\x0E\x01\x09\x04\x4001La terre tremble sous nos pieds ! J'y crois pas !")
...
/*<499>*/ 	set_camera(43, 0)
/*<266>*/ 	printf("\x0E\x01\x09\x04\xE00\x10\x0E\x03\x01\x00Link ! Va vite examiner le <r<pilier\nde pierre>> au fond du vallon !")
...
/*<165>*/ 		switch (scene_flags[18 /* 0x3 04 */]) {
          		  case 0:
/*<167>*/ 			printf("\x0E\x01\x09\x04\x10\x180DTu sais comment refermer le sceau, n'est\x2010ce\npas ?\n\n\nRends\x2010toi au pilier de pierre, et frappe\x2010le de ton\n<r<éclat céleste>>.<pause1E> Je sais que tu en es capable.")
          		  case 1:
...
/*<328>*/ 	start()
/*<330>*/ 	printf("\x0E\x01\x09\x04C\x4553\x0E\x01\x08\x02\x1CDGaaah ! <pause0A>Il vole !\n\n\n\n\x0E\x01\x09\x04B\x4026Il croit peut\x2010être qu'il va pouvoir\ntranquillement planer jusqu'au temple,\nmais c'est sans compter sur le grand\nHergo ! <pause08>Zou, tir au pigeon !")
          }

          void entrypoint_500_13() {
/*<476>*/ 	start()
/*<491>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, Fay au rapport. Je constate\nque l'éclat céleste a provoqué un changement dans\nla zone.")
/*<495>*/ 	printf("Je détecte également dans le périmètre une aura\nsimilaire à celle de votre parachâle, \x0E\x01\x12\x04\x00\x02Maître. Il est\ntrès probable qu'il s'agisse de dame Zelda.\n\nGrâce à mon pouvoir de <pling><r<détection>>, je peux vous guider\ndans sa direction.\n\n\nSouhaitez\x2010vous des informations complémentaires à ce\nsujet ?\n[1]Oui[2-]Non")
...
/*<545>*/ 		printf("\x0E\x03\x01\x00Link ! Le <r<pilier du sceau >>doit se\ntrouver sur le front du démon.\n\n\n\x0E\x01\x09\x04\xE00\x13Si tu parviens à enfoncer ce pilier avec ton\népée, tu devrais pouvoir vaincre ce monstre.")
          	  case 1:
...
/*<147>*/ 				printf("\x0E\x03\x01\x00Link ! Le <r<pilier du sceau >>doit se\ntrouver sur le front du démon.\n\n\n\x0E\x01\x09\x04\xE00\x13Si tu parviens à enfoncer ce pilier avec ton\népée, tu devrais pouvoir vaincre ce monstre.")
          			}
          		  case 1:
/*<144>*/ 			printf("\x0E\x01\x09\x04\x08\x170F\x0E\x03\x01\x00Link ! Rends\x2010toi vite au <r<pilier du\nsceau >>au centre du vallon.\n\n\n\x0E\x01\x09\x04\x14\xB00Il est fort inhabituel que la terre tremble ainsi...\nIl faut aller s'assurer que le démon n'est pas en\ntrain de se réveiller.")
          		}
          	}
          }
...
/*<329>*/ 	start()
/*<331>*/ 	printf("\x0E\x01\x09\x04A\x4043Ha, il m'a bien fait peur, mais heureusement,\nma super machine est fidèle au poste. Une seule\nbombe, et il tombe comme une mouche !\n\nÀ toi de jouer, maintenant ! Vite, avant qu'il se\nrelève !")
          }

          void entrypoint_500_14() {
/*<440>*/ 	start()
/*<441>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport.\n\n\n\nJe peux vous apporter des informations sur ce que\nvous <g<ciblez >>avec (Z).\x0E\x01\x11\x02\x7CD\n\n\nAppuyez sur (v) <r<lorsque vous ciblez >>avec (Z) pour\nm'appeler.\x0E\x01\x11\x02\x7CD\x0E\x01\x11\x02\x9CD")
          }
...
/*<332>*/ 	start()
/*<333>*/ 	printf("\x0E\x01\x09\x04\x00&Yoho, Link ! Mon engin est fin\nprêt !\n\n\nAppuie sur \x0E\x02\x04\x02\x1ECD quand tu as besoin de moi et de\nma machine.\x0E\x01\x11\x02\x10CD")
          }
...
/*<173>*/ 		switch (scene_flags[19 /* 0x3 08 */]) {
          		  case 0:
/*<174>*/ 			printf("\x0E\x01\x12\x04\x00\x0BMaître, Fay au rapport. Vous devez à nouveau\nrefermer le sceau qui emprisonne le démon.\n\n\nVous ne pouvez pas fuir maintenant, \x0E\x01\x12\x04\x00\x02Maître.")
          		  case 1:
...
/*<386>*/ 	printf("\x0E\x03\x01\x00Link ! On dirait bien que le gros\nvilain pas beau refait des siennes !")
...
/*<409>*/ 	start()
/*<410>*/ 	printf("Ouais ! À moi de jouer !")
/*<411>*/ 	printf("Déplace la machine avec \x0E\x02\x04\x02\xECD, et vise bien...\n\n\n\nEnsuite, tire une bombe avec \x0E\x02\x04\x02\x29CD, et profite de\nce que le démon soit sonné !")
...
/*< 17>*/ 	printf("Alors, Link...\n\n\n\nTu dis que la vieille qui se trouve dans le\n<r<temple >>au bout de ce chemin sait où est <b<Zelda>> ?")
/*< 20>*/ 	set_camera(17, 0)
/*<104>*/ 	printf("OK ! Merci pour l'info ! Tu peux aller jouer\nailleurs, maintenant.\n\n\n\x0E\x01\x09\x04\x0D\xB41Le grand Hergo se charge d'aller retrouver\n<b<Zelda>> !")
/*<103>*/ 	{'type': 'type3', 'subType': 4, 'param1': 24, 'param2': 5632, 'next': 18, 'param3': 13}
/*< 18>*/ 	printf("Je vais la sauver, et puis on rentrera tous les\ndeux au bercail...<pause1E>")
/*<106>*/ 	set_camera(18, 0)
/*<107>*/ 	printf("\x0E\x01\x09\x04\x00\x0CEt je la demanderai en mariage, et elle dira oui,\net puis on vivra heureux pour toujours !")
/*<108>*/ 	set_camera(19, 0)
...
/*<105>*/ 	printf("Bon allez, je file chez la vieille.")
...
/*< 24>*/ 	printf("\x0E\x01\x09\x04\x4000Que... Qu'est\x2010ce que c'est que ça ?")
...
/*<119>*/ 	set_camera(24, 0)
/*<118>*/ 	printf("\x0E\x01\x09\x04\x4001La terre tremble sous nos pieds ! J'y crois pas !")
/*< 45>*/ 	set_camera(27, 0)
...
/*< 23>*/ 	printf("\x0E\x01\x09\x04\xE00\x10\x0E\x03\x01\x00Link ! Va vite examiner le <r<pilier\nde pierre>> au fond du vallon !")
...
/*<127>*/ 	{'type': 'type3', 'subType': 1, 'param1': 3, 'param2': -1, 'next': -1, 'param3': 42}
          ...
          void entrypoint_500_01() {
          	start()
/*<  1>*/ 	printf("\x0E\x01\x09\x04B\x4300Alors, qu'est\x2010ce que tu dis de la puissance de\nmon engin ? Ça t'en bouche un coin, hein ?\n\n\n\x0E\x01\x09\x04>\x4000Bon, je recharge la bête, alors tiens bon jusqu'à\nmon prochain signal !")
          }
...
/*<184>*/ 	start()
/*<185>*/ 	printf("\x0E\x01\x09\x04\x00&Hé, Link ! Mon engin est fin\nprêt !\n\n\nTirons sur ce monstre pour l'empêcher\nd'escalader le mur !\n\n\nAppuie sur \x0E\x02\x04\x02\x1ECD quand tu as besoin de moi et de\nma machine.\x0E\x01\x11\x02\x10CD")
          }
