...
/*< 65>*/ 					switch (choice(2)) {
          					  case 0:
/*< 66>*/ 						printf(/* textboxtype: 0, unk: 2, line: 73 */ "Si Ghirahim se saisit de votre épée, dégagez‐la en la\nlevant <color red<du côté de l'ouverture laissée par ses doigts>coloroff>.\n[1-]Plus de\ndétails[2]Ne me dis\npas tout !")
/*< 67>*/ 						switch (choice(2)) {
          						  case 0:
