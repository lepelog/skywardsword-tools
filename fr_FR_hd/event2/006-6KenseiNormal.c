...
/*< 65>*/ 					switch (choice(2)) {
          					  case 0:
/*< 66>*/ 						printf("Si Ghirahim se saisit de votre épée, dégagez\x2010la en la\nlevant <r<du côté de l'ouverture laissée par ses doigts>>.\n[1]Plus de\ndétails[2-]Ne me dis\npas tout !")
/*< 67>*/ 						switch (choice(2)) {
          						  case 0:
