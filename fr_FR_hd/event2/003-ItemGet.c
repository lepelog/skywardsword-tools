...
/*<563>*/ 		printf("Votre bouclier est réparé ! Il est comme neuf.")
          	  case 1:
/*<268>*/ 		printf("Votre bouclier a été amélioré en <y<bouclier en fer\nrenforcé >>! C'est le plus robuste des boucliers en\nfer.")
          	}
          }
...
/*<191>*/ 	start()
/*<172>*/ 	printf("Vous avez obtenu une <y<potion de soin \x2605\x2605 >>!\nUn flacon contient <r<deux doses >>de ce précieux\nbreuvage qui <r<vous restaure tous vos c\x153urs>>.")
          }
...
/*<382>*/ 	start()
/*<380>*/ 	printf("Vous avez obtenu la <y<cage à insecte >>!\nL'insecte bien\x2010aimé de Terry se trouve à\nl'intérieur ! Hâtez\x2010vous de le lui rapporter !")
          }
...
/*<510>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 1, 'next': -1, 'param3': 34}
          	  case 1:
/*<513>*/ 		printf("L'emplacement des coffres est également indiqué.\nPrenez le temps d'y jeter un \x153il !")
...
/*< 87>*/ 		printf("Il n'y a rien d'intéressant là\x2010dedans !")
          	  case 1:
/*<596>*/ 		printf("Ça ne se fait pas de fouiller dans les affaires\ndes gens...")
          	}
          }
...
/*<390>*/ 	start()
/*<388>*/ 	printf("Vous avez obtenu le <y<sceau des épreuves >>!\nCette pierre mènera le héros à l'endroit où repose\nla Triforce.")
...
/*<144>*/ 	start()
/*< 85>*/ 	printf("Vous avez obtenu un <g+<rubis vert >>!\nSa valeur est de <r<1 rubis>>. C'est le début de\nla fortune !")
          }
...
/*<506>*/ 	switch (has_empty_bottle()) {
          	  case 0:
/*<507>*/ 		printf("Vous avez attrapé une <y<fée >>!\nCette créature bienveillante vous rendra\n<r<six >>c\x153urs !\n\n\nMalheureusement, vous n'avez pas de <y<flacon vide>>.\nVous allez devoir la laisser partir.")
          	  case 1:
...
/*<106>*/ 	start()
/*< 48>*/ 	printf("Vous avez obtenu <y<cinq bombes >>!\nVous pouvez les jeter ou les faire rouler pour\ndétruire des matériaux résistants. Ravitaillez\x2010vous\ndès que possible !")
          }
...
/*<138>*/ 	start()
/*< 79>*/ 	printf("Vous avez obtenu <y<dix flèches >>!\nVous pourrez les tirer avec votre arc. Leur\nnombre est limité, utilisez\x2010les avec parcimonie !")
          }
...
/*<199>*/ 			switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 10}) {
          			  case 0:
/*<208>*/ 				printf("Vous avez obtenu un <y<fragment de c\x153ur >>!\nIl vous en faut quatre pour augmenter votre\nénergie vitale maximale d'un c\x153ur. Plus qu'<r<un >>!")
          			  case 1:
/*<200>*/ 				printf("Vous avez obtenu un <y<fragment de c\x153ur >>!\nIl vous en faut quatre pour augmenter votre\nénergie vitale maximale d'un c\x153ur. Plus que\n<r<deux >>!")
          			}
          		  case 1:
/*<203>*/ 			printf("Vous avez obtenu un <y<fragment de c\x153ur >>!\nIl vous en faut quatre pour augmenter votre\nénergie vitale maximale d'un c\x153ur. Plus que\n<r<trois >>!")
          		}
          	  case 1:
/*<207>*/ 		printf("Vous avez obtenu un <y<fragment de c\x153ur >>!\nVous avez formé un nouveau réceptacle de\nc\x153ur. Votre énergie vitale maximale augmente\nd'un c\x153ur !")
          	}
          }
...
/*< 91>*/ 	start()
/*< 34>*/ 	printf("Vous avez obtenu <y<dix graines mojo >>!\nVous pouvez lancer ces petites graines avec votre\nlance\x2010pierre. Gardez un \x153il sur vos réserves !")
          }
...
/*<194>*/ 	start()
/*<175>*/ 	printf("Vous avez obtenu une <y<potion de soin >>!\nLorsque vous la buvez, vous récupérez\n<r<huit c\x153urs>> !")
          }
...
/*<561>*/ 		printf("Votre bouclier est réparé ! Il est comme neuf.")
          	  case 1:
/*<269>*/ 		printf("Votre bouclier a été amélioré en <y<bouclier en fer\nsolide >>! Il est plus résistant qu'un bouclier en fer\nclassique.")
          	}
          }
