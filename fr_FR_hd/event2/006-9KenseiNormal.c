...
/*< 51>*/ 	switch (story_flags[89 /* us: 805A9AEC 0x08, jp: 805ACD6C 0x08 */]) {
          	  case 0:
/*< 52>*/ 		printf("Je dispose d'une information fiable qui pourrait\nvous être utile, \x0E\x01\x12\x04\x00\x01Maître.\n\n\nL'énergie des <r<cubes de la Déesse >>retourne dans le ciel\nlorsqu'elle est libérée.\n\n\nJe peux détecter l'endroit vers lequel elle s'est dirigée\net vous le signaler sur la carte, \x0E\x01\x12\x04\x00\x02Maître.")
          	  case 1:
