...
/*<  7>*/ 			printf(/* textboxtype: 0, unk: 0, line: 8 */ "C'est un parc d'attractions où l'on peut gagner des\nsommes de rubis considérables.\n\n\nVeillez bien à avoir suffisamment de place dans votre\nbourse pour stocker les rubis gagnés.")
          		  case 1:
/*<  9>*/ 			printf(/* textboxtype: 2, unk: 0, line: 9 */ "C'est un parc d'attraction où l'on peut gagner de\ngrandes sommes de rubis.\n\n\nMais il est probable qu'une mise de départ soit\nnécessaire.")
          		}
          	  case 1:
...
/*< 51>*/ 	switch (story_flags[89 /* us: 805A9AEC 0x08, jp: 805ACD6C 0x08 */]) {
          	  case 0:
/*< 52>*/ 		printf(/* textboxtype: 0, unk: 2, line: 58 */ "Je dispose d'une information fiable qui pourrait\nvous être utile, <0x10012:0x00000001>Maître.\n\n\nL'énergie des <color red<cubes de la Déesse >coloroff>retourne dans le ciel\nlorsqu'elle est libérée.\n\n\nJe peux détecter l'endroit vers lequel elle s'est dirigée\net vous le signaler sur la carte, <0x10012:0x00000002>Maître.")
          	  case 1:
