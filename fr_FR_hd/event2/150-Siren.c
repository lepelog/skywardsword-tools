...
/*< 28>*/ 		printf("Tu es arrivé, Link ! Donne tout\nce que tu as !")
/*< 31>*/ 		set_camera(10, 0)
...
/*<  9>*/ 						temp_flags[3 /* 0x1 08 */] = true;
          				  ...
          				  case 1:
/*<  5>*/ 					printf("Tant que votre volonté ne plie pas, vous pouvez\nretenter l'épreuve de la Déesse indéfiniment.\n\n\nÉvitez de recueillir les <y<larmes>> faciles à atteindre\ntout de suite. <r<Conservez\x2010les>> plutôt pour le cas où\nvous seriez découvert.\n\nRassemblez les 15 <y<larmes>> et rejoignez\x2010moi dans le\nmonde extérieur.")
...
/*< 20>*/ 					set_camera(3, 0)
/*< 19>*/ 					printf("C'est une <y<larme de la Déesse>>. Il vous faudra en\nrassembler <r<15>>.")
