...
/*< 28>*/ 		printf(/* textboxtype: 2, unk: 4, line: 26 */ "Tu es arrivé, <heroname> ! Donne tout\nce que tu as !")
/*< 31>*/ 		set_camera(10, 0)
...
/*< 20>*/ 					set_camera(3, 0)
/*< 19>*/ 					printf(/* textboxtype: 2, unk: 2, line: 9 */ "C'est une <color yellow<larme de la Déesse>coloroff>. Il vous faudra en\nrassembler <color red<15>coloroff>.")
