...
/*< 77>*/ 	switch (story_flags[798 /* us: 805A9B2F 0x40, jp: 805ACDAF 0x40 */]) {
          	  case 0:
/*< 76>*/ 		printf(/* textboxtype: 0, unk: 1, line: 22 */ "Va donc m'attraper cet <color blue<Avatar >coloroff>de je‐ne‐sais‐quoi\net qu'on en finisse une bonne fois pour toutes !\n\n\n<0x10009:0x00000003>À toi de jouer, <heroname> !")
          	  case 1:
/*< 75>*/ 		printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x000e020d>Pfiouu...! C'est pas passé loin !\n\n\n\n<0x10009:0x00000200>Heureusement que j'ai mis le turbo, sinon la\nfête était finie !\n\n\n<0x10009:0x00000200>Tant que je suis là, t'as pas de bile à te faire\npour <color blue<Zelda>coloroff> !\n\n\nMaintenant va donc m'attraper cet <color blue<Avatar >coloroff>de\nje‐ne‐sais‐quoi et qu'on en finisse une bonne\nfois pour toutes !\n\n<0x10009:0x00000203>Tout dépend de toi maintenant,\n<heroname> !")
...
/*< 79>*/ 	start()
/*< 86>*/ 	printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10012:0x00000004>Maître <heroname>, êtes‐vous prêt pour le\ncombat final ?\n[1-]Prêt ![2]Pas encore")
/*< 87>*/ 	switch (choice(2)) {
          	  case 0:
/*< 88>*/ 		printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10012:0x00000005>Très bien, Maître. Partons au combat.")
/*< 90>*/ 		changeScene(11, 0) // 
          	  case 1:
/*< 89>*/ 		printf(/* textboxtype: 0, unk: 1, line: 31 */ "<0x10012:0x00000005>Très bien, Maître. Revenez lorsque vous serez bien\npréparé.")
          	}
          }
...
/*< 33>*/ 					switch (scene_flags[102 /* 0xD 40 */]) {
          					  case 0:
/*< 46>*/ 						printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00000003>Un arbre qui fleurisse à travers les\nmillénaires... Où trouver la <color red<pousse\n>coloroff>qui lui donnera vie ?")
          					  case 1:
...
/*< 62>*/ 	start()
/*< 64>*/ 	printf(/* textboxtype: 0, unk: 0, line: 23 */ "<0x10012:0x0000000b>Maître, Fay au rapport. La probabilité qu'il vous soit\nimpossible de quitter le combat avant d'avoir vaincu\nvotre adversaire est de 100 %.\n\nDésirez‐vous engager le combat ?\n[1-]Et comment ![2]Pas pour\nl'instant...")
/*< 63>*/ 	switch (choice(2)) {
          	  case 0:
/*< 65>*/ 		printf(/* textboxtype: 0, unk: 1, line: 25 */ "Bien, <0x10012:0x00000005>Maître <heroname>.<pause 15> Je suis de tout cœur\navec vous.<pause 30>\n\n\nBonne chance, <0x10012:0x00000001>Maître...")
          	  case 1:
/*< 66>*/ 		printf(/* textboxtype: 1, unk: 0, line: 24 */ "Bien, <0x10012:0x00000005>Maître. Veuillez revenir en ce lieu lorsque vous\nserez prêt pour l'affrontement.")
          	}
          }

          void entrypoint_502_05() {
/*< 67>*/ 	start()
/*< 68>*/ 	printf(/* textboxtype: 0, unk: 0, line: 32 */ "<0x10005:0x002d0000><0x10008:0x02cd>S‐Sale petit morveux !")
          }
