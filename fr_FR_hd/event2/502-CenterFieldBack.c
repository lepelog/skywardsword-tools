...
/*< 77>*/ 	switch (story_flags[798 /* us: 805A9B2F 0x40, jp: 805ACDAF 0x40 */]) {
          	  case 0:
/*< 76>*/ 		printf("Va donc m'attraper cet <b<Avatar >>de je\x2010ne\x2010sais\x2010quoi\net qu'on en finisse une bonne fois pour toutes !\n\n\n\x0E\x01\x09\x04\x00\x03À toi de jouer, Link !")
          	  case 1:
/*< 75>*/ 		printf("\x0E\x01\x09\x04\x0E\x20DPfiouu...! C'est pas passé loin !\n\n\n\n\x0E\x01\x09\x04\x00\x200Heureusement que j'ai mis le turbo, sinon la\nfête était finie !\n\n\n\x0E\x01\x09\x04\x00\x200Tant que je suis là, t'as pas de bile à te faire\npour <b<Zelda>> !\n\n\nMaintenant va donc m'attraper cet <b<Avatar >>de\nje\x2010ne\x2010sais\x2010quoi et qu'on en finisse une bonne\nfois pour toutes !\n\n\x0E\x01\x09\x04\x00\x203Tout dépend de toi maintenant,\nLink !")
...
/*< 79>*/ 	start()
/*< 86>*/ 	printf("\x0E\x01\x12\x04\x00\x04Maître Link, êtes\x2010vous prêt pour le\ncombat final ?\n[1]Prêt ![2-]Pas encore")
/*< 87>*/ 	switch (choice(2)) {
          	  case 0:
/*< 88>*/ 		printf("\x0E\x01\x12\x04\x00\x05Très bien, Maître. Partons au combat.")
/*< 90>*/ 		changeScene(11, 0) // 
          	  case 1:
/*< 89>*/ 		printf("\x0E\x01\x12\x04\x00\x05Très bien, Maître. Revenez lorsque vous serez bien\npréparé.")
          	}
          }
...
/*< 65>*/ 		printf("Bien, \x0E\x01\x12\x04\x00\x05Maître Link.<pause0F> Je suis de tout c\x153ur\navec vous.<pause1E>\n\n\nBonne chance, \x0E\x01\x12\x04\x00\x01Maître...")
          	  case 1:
/*< 66>*/ 		printf("Bien, \x0E\x01\x12\x04\x00\x05Maître. Veuillez revenir en ce lieu lorsque vous\nserez prêt pour l'affrontement.")
          	}
          }
