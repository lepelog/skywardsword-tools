...
/*<  5>*/ 		switch (story_flags[108 /* us: 805A9AE1 0x02, jp: 805ACD61 0x02 */]) {
          		  case 0:
/*< 17>*/ 			printf("Votre énergie vitale est faible. Je vous suggère de\nvous soigner au plus vite.<entrypoint_402>")
          		  case 1:
/*<  3>*/ 			printf("Votre énergie vitale diminue. Je vous suggère de vous\nsoigner dès que vous le pourrez.\n\n\nAfin que vous puissiez récupérer plus facilement,\nj'ai ajouté les <pling><y<c\x153urs>> aux cibles localisables grâce à\nla <g<fonction détection>>.")
...
/*< 13>*/ 				printf("Puisque vous êtes en <r<mode héroïque>>, vous ne trouverez\nni c\x153urs, ni fl\x153urs.\n\n\nToutefois, vous aurez <r<une chance >>d'en voir apparaître\nsi vous portez une <pling><y<médaille c\x153ur>>.")
          	  ...
          	  case 1:
/*< 16>*/ 		printf("Votre énergie vitale est faible. Je vous suggère de\nvous soigner au plus vite.<entrypoint_402>")
          	}
          }

          void entrypoint_006_401() {
/*<  2>*/ 	start()
/*<  1>*/ 	printf("Votre énergie vitale est faible. Je vous suggère de\nvous soigner au plus vite.<entrypoint_402>")
          }
