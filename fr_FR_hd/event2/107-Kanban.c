...
/*<160>*/ 		printf(/* textboxtype: 0, unk: 1, line: 73 */ "Je vois que vous avez collecté tous les cristaux de\ngratitude, <0x10012:0x00000002>Maître. Félicitations.")
          	  case 1:
/*< 64>*/ 		printf(/* textboxtype: 0, unk: 0, line: 71 */ "<0x10012:0x0000000b>Maître, Fay au rapport.\n\n\n\nGrâce à l'amélioration de votre épée, vous pouvez\ndésormais <color red<détecter >coloroff>les <color yellow<cristaux de gratitude>coloroff>.\n\n\nJ'ai ajouté les <color yellow<cristaux de gratitude >coloroff>à la liste des\ncibles à <color red<détecter>coloroff>. <sound 4>Faites‐en bon usage.")
...
/*< 84>*/ 	switch (story_flags[712 /* us: 805A9B25 0x04, jp: 805ACDA5 0x04 */]) {
          	  case 0:
/*< 83>*/ 		printf(/* textboxtype: 0, unk: 0, line: 23 */ "<0x10008:0x00cd>Maison de Pavelle\n<0x10008:0xffcd>Gérante de la consigne")
          	  case 1:
          	}
          }
...
/*< 51>*/ 	start()
/*< 52>*/ 	printf(/* textboxtype: 6, unk: 0, line: 6 */ "Interdiction de courir\ndans les couloirs.")
          }
...
/*< 86>*/ 	switch (story_flags[713 /* us: 805A9B25 0x08, jp: 805ACDA5 0x08 */]) {
          	  case 0:
/*< 87>*/ 		printf(/* textboxtype: 22, unk: 0, line: 24 */ "Maison de Jona")
          	  case 1:
          	}
          }
...
/*<121>*/ 	set_camera(6, 0)
/*<119>*/ 	printf(/* textboxtype: 2, unk: 0, line: 77 */ "Le <color red<sceau des épreuves >coloroff>que vous venez d'obtenir est\nen fait un élément d'une paire.\n\n\nQuelque part sur cette île se trouve un sceau identique\nau vôtre, <0x10012:0x00000002>Maître.\n\n\nEn plaçant votre sceau à l'endroit où la paire sera\ncomplétée, vous pourrez ouvrir le chemin vers la\n<color yellow white<Triforce>coloroff>.\n\n<0x1000A:0xffff00cd>Je vous conseille de chercher le deuxième sceau.")
...
/*< 89>*/ 	switch (story_flags[714 /* us: 805A9B25 0x10, jp: 805ACDA5 0x10 */]) {
          	  case 0:
/*< 90>*/ 		printf(/* textboxtype: 0, unk: 22, line: 25 */ "Maison de Nacia")
          	  case 1:
          	}
          }
...
/*< 92>*/ 	switch (story_flags[715 /* us: 805A9B25 0x20, jp: 805ACDA5 0x20 */]) {
          	  case 0:
/*< 93>*/ 		printf(/* textboxtype: 0, unk: 0, line: 26 */ "Maison d'Hiron et Kinaé")
          	  case 1:
          	}
          }
...
/*< 95>*/ 	switch (story_flags[716 /* us: 805A9B25 0x40, jp: 805ACDA5 0x40 */]) {
          	  case 0:
/*< 96>*/ 		printf(/* textboxtype: 8, unk: 0, line: 27 */ "<0x10008:0x00cd>Maison d'Arpigon\n<0x10008:0xffcd>Armurier")
          	  case 1:
          	}
          }
...
/*<101>*/ 	switch (story_flags[718 /* us: 805A9B24 0x01, jp: 805ACDA4 0x01 */]) {
          	  case 0:
/*<102>*/ 		printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10008:0x00cd>Maison de Petronus\n<0x10008:0xffcd>Diseur de bonne aventure")
          	  case 1:
          	}
          }
...
/*< 22>*/ 	start()
/*< 29>*/ 	printf(/* textboxtype: 0, unk: 0, line: 11 */ "Chambre d'Orbo et Latruche")
          }
...
/*<184>*/ 	start()
/*<185>*/ 	printf(/* textboxtype: 22, unk: 0, line: 48 */ "Je suis au travail.\nSi vous voulez me parler,\nvenez la nuit.\n<0x10006:0x05cd>                                      Terry")
          }

          void entrypoint_107_13() {
/*< 23>*/ 	start()
/*< 30>*/ 	printf(/* textboxtype: 8, unk: 0, line: 12 */ "Chambre de Célestin")
          }
...
/*<104>*/ 	switch (story_flags[719 /* us: 805A9B24 0x02, jp: 805ACDA4 0x02 */]) {
          	  case 0:
/*<105>*/ 		printf(/* textboxtype: 0, unk: 22, line: 31 */ "<0x10008:0x00cd>Maison de Dorco\n<0x10008:0xffcd>Rénovateur")
          	  case 1:
          	}
          }
...
/*<110>*/ 	switch (story_flags[304 /* us: 805A9AFC 0x04, jp: 805ACD7C 0x04 */]) {
          	  case 0:
/*<111>*/ 		printf(/* textboxtype: 22, unk: 0, line: 33 */ "Maison de Morcego")
          	  case 1:
          	}
          }
...
/*<186>*/ 	switch (scene_flags[25 /* 0x2 02 */]) {
          	  case 0:
/*<187>*/ 		printf(/* textboxtype: 0, unk: 8, line: 61 */ "<0x10012:0x00000004>Maître <heroname>, veuillez placer la <color red<stèle >coloroff>que\nje vous ai remise dans le piédestal.")
          	  case 1:
/*< 68>*/ 		switch (story_flags[38 /* us: 805A9AE5 0x10, jp: 805ACD65 0x10 */]) {
          		  case 0:
/*< 44>*/ 			printf(/* textboxtype: 0, unk: 0, line: 59 */ "<0x10012:0x00000004>Maître <heroname>, frappez cet emblème avec\nl'<color red<éclat céleste >coloroff>puis placez‐y la stèle que je vous\nai remise.\n\nPour invoquer l'<color red<éclat céleste>coloroff>, <color green<brandissez votre épée\nvers le ciel >coloroff>afin d'invoquer le pouvoir des cieux.")
          		  case 1:
...
/*<  4>*/ 	start()
/*<  5>*/ 	printf(/* textboxtype: 0, unk: 0, line: 2 */ "<icon 20> Marché couvert")
          }
...
/*< 60>*/ 	start()
/*< 61>*/ 	printf(/* textboxtype: 0, unk: 9, line: 70 */ "Cette pousse mettrait des années à grandir ici. Je vous\nconseille de la planter ailleurs.")
          }
