...
/*< 77>*/ 	set_camera(-1, 0)
/*< 76>*/ 	printf("Veuillez partir à la recherche de dame Zelda. Appuyez\nsur (v) en chute libre pour siffler votre célestrier.\x0E\x01\x11\x02\x9CD")
          }
...
/*<186>*/ 	switch (scene_flags[25 /* 0x2 02 */]) {
          	  case 0:
/*<187>*/ 		printf("\x0E\x01\x12\x04\x00\x04Maître Link, veuillez placer la <r<stèle >>que\nje vous ai remise dans le piédestal.")
          	  case 1:
/*< 68>*/ 		switch (story_flags[38 /* us: 805A9AE5 0x10, jp: 805ACD65 0x10 */]) {
          		  case 0:
/*< 44>*/ 			printf("\x0E\x01\x12\x04\x00\x04Maître Link, frappez cet emblème avec\nl'<r<éclat céleste >>puis placez\x2010y la stèle que je vous\nai remise.\n\nPour invoquer l'<r<éclat céleste>>, <g<brandissez votre épée\nvers le ciel >>afin d'invoquer le pouvoir des cieux.")
          		  case 1:
...
/*< 60>*/ 	start()
/*< 61>*/ 	printf("Cette pousse mettrait des années à grandir ici. Je vous\nconseille de la planter ailleurs.")
          }
