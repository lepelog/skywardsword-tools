...
/*<136>*/ 	printf("Ah<pause14>... Excuse\x2010moi, Link. J'étais\nailleurs... Bien, allons\x2010y !")
...
/*< 21>*/ 	set_camera(2, 0)
/*< 14>*/ 	printf("\x0E\x01\x09\x04\x09\x500\x0E\x01\x08\x02\x1CDC'est ton célestrier,\nLink !")
...
/*< 10>*/ 		switch (story_flags[39 /* us: 805A9AE5 0x20, jp: 805ACD65 0x20 */]) {
          		  case 0:
/*<173>*/ 			printf("\x0E\x01\x09\x04\x00\x04Allez, essaie encore une fois ! Cette fois je ne\nte pousserai pas. Alors prends ton courage à\ndeux mains et saute !\n\n<g<Fonce >>vers le bord pour prendre de l'élan et\nsauter dans le vide !\n\n\nN'oublie pas d'ouvrir ton parachâle en appuyant\nsur \x0E\x02\x04\x02\x29CD avant d'atterrir !\x0E\x01\x11\x02\xFCD\n\n\nTu dois atterrir <r<au milieu du dallage circulaire\n>>en bas !")
          		  case 1:
/*<  8>*/ 			switch (story_flags[26 /* us: 805A9ADA 0x04, jp: 805ACD5A 0x04 */]) {
          			  case 0:
/*<  9>*/ 				printf("\x0E\x01\x09\x04\x0F\x513C'est vraiment horrible...\n\n\n\n\x0E\x03\x01\x00Link ! Il faut vite retirer cette\nbarrière qui le retient prisonnier !")
          			  case 1:
/*<  7>*/ 				printf("\x0E\x01\x09\x04\x00\x06Eh bien, Link !\nAllons vite l'aider !")
          			}
          		}
          	}
          }
...
/*< 67>*/ 	set_camera(18, 0)
/*< 30>*/ 	printf("B... Boss ! Boss ! <pause1E>Derrière vous !\n<pause1E>Derrière vous !")
...
/*< 32>*/ 	printf("\x0E\x01\x09\x04\x419\x1715Ouah !!!")
...
/*< 90>*/ 	set_camera(19, 0)
/*< 33>*/ 	printf("Je peux savoir ce qu'on fera exactement, toi\net moi, sans personne pour nous déranger ?")
/*< 68>*/ 	set_camera(15, 0)
...
/*< 86>*/ 	printf("\x0E\x01\x09\x04\x400\x00À tout à l'heure, Zelda ! Et surtout, regarde\x2010moi\nbien pendant la course ! J'espère que tu seras\npas trop impressionnée !")
...
/*< 98>*/ 	set_camera(18, 0)
/*< 35>*/ 	printf("\x0E\x01\x09\x04\x505\x13\x0E\x01\x09\x04\x607\x00Aah ! Boss ! Attendez !\x0E\x01\x05\x04\x14\x00")
...
/*< 69>*/ 	set_camera(16, 0)
/*< 36>*/ 	printf("\x0E\x01\x09\x04\x09\x1014« À la loyale » ? Venant de lui, ça me fait\nbien rire !\n\n\n\x0E\x01\x09\x04\x00\xFF00\x0E\x03\x01\x00Link ! Ne fais pas attention à\nce qu'ils racontent ! Tu dois donner tout\nce que tu as ! J'ai confiance en toi !\n\nTu me le promets ?\n[1]Oui ![2]J'ai des\ndoutes[3]Rien que toi\net moi...")
/*< 57>*/ 	switch (choice(3)) {
          	  case 0:
/*< 37>*/ 		printf("\x0E\x01\x09\x04\x0C\xE00C'est ce que je voulais entendre ! Je suis sûre\nque tu vas gagner, Link !")
          		flw_101:
...
/*< 41>*/ 		printf("Allez, Link ! Bon courage !")
/*< 70>*/ 		changeScene(18, 0) // 
          	  case 1:
/*< 38>*/ 		printf("\x0E\x01\x09\x04\x0C\x1500Pourquoi ? Si tu fais de ton mieux, tu peux\ny arriver ! Aie confiance en toi !")
          		goto flw_101
          	  case 2:
/*< 39>*/ 		printf("\x0E\x01\x09\x04\x10\xE04Ah, non ! Tu ne vas pas t'y mettre, toi aussi !")
          		goto flw_101
          	}
          }
...
/*< 82>*/ 	start()
/*< 83>*/ 	printf("\x0E\x03\x01\x00Link ! Je suis un peu inquiète !\nVoyons comment se porte ton célestrier !")
...
/*< 85>*/ 	printf("Alors ? Ton célestrier n'a pas trop souffert de\ncette mésaventure ?")
