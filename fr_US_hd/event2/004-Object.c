...
/*< 58>*/ 	switch (story_flags[19 /* us: 805A9ADB 0x08, jp: 805ACD5B 0x08 */]) {
          	  case 0:
/*< 56>*/ 		printf(/* textboxtype: 0, unk: 0, line: 17 */ "On raconte que sous ce volcan se terrent\nles <color blue<Mogmas>coloroff>, qui raffolent de trésors.\n\n\nOn raconte aussi que dernièrement, ils vivent\nplutôt tranquillement dans leur tanière.")
          	  case 1:
          		flw_59:
/*< 59>*/ 		printf(/* textboxtype: 0, unk: 1, line: 19 */ "On raconte qu'un <color red<dragon>coloroff> vit au <color red<sommet >coloroff>de\nce volcan.\n\n\nMais on raconte qu'ici, ce n'est pas le sommet...")
/*< 60>*/ 		printf(/* textboxtype: 1, unk: 0, line: 18 */ "Voulez-vous que je répète tout ça?\n[1-]Oui[2]Non")
/*< 62>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_59
          		  case 1:
/*< 61>*/ 			printf(/* textboxtype: 0, unk: 0, line: 20 */ "Ça ne vous intéresse pas, ce que je raconte?<pause 15>\nJe vois...")
          		}
          	}
          }
...
/*< 11>*/ 			printf(/* textboxtype: 9, unk: 2, line: 9 */ "Votre sacoche est pleine, ainsi que la <color red<consigne>coloroff>.\nVous avez remis l'objet dans son coffre.")
          		  case 1:
/*< 10>*/ 			printf(/* textboxtype: 2, unk: 0, line: 8 */ "Votre sacoche est pleine!\nL'objet a été envoyé à la <color red<consigne>coloroff>.")
          		}
          	  case 1:
          	}
          }
...
/*< 51>*/ 	switch (story_flags[19 /* us: 805A9ADB 0x08, jp: 805ACD5B 0x08 */]) {
          	  case 0:
/*< 30>*/ 		printf(/* textboxtype: 1, unk: 0, line: 21 */ "On raconte que le <color red<dragon >coloroff>qui vit au sommet\ndu volcan adore bavarder.\n\n\nOn raconte aussi qu'il peut vous parler des\nautres régions jusqu'à ce que vos oreilles en\ntombent.")
          	  case 1:
          		flw_52:
/*< 52>*/ 		printf(/* textboxtype: 0, unk: 1, line: 22 */ "On raconte qu'au sommet de ce volcan vit\nun <color red<dragon>coloroff> drapé de flammes.\n\n\nOn raconte aussi qu'il vit dans une <color red<fournaise\n>coloroff>où l'on peut difficilement pénétrer.")
/*< 53>*/ 		printf(/* textboxtype: 1, unk: 0, line: 18 */ "Voulez-vous que je répète tout ça?\n[1-]Oui[2]Non")
/*< 55>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_52
          		  case 1:
/*< 54>*/ 			printf(/* textboxtype: 0, unk: 0, line: 20 */ "Ça ne vous intéresse pas, ce que je raconte?<pause 15>\nJe vois...")
          		}
          	}
          }
...
/*< 14>*/ 	start()
/*< 15>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "Hé, <heroname>!\nVous n'allez pas laisser tomber maintenant!\n\n\nUn homme finit toujours ce qu'il a commencé!")
          }

          void entrypoint_004_109() {
/*< 33>*/ 	start()
/*< 32>*/ 	printf(/* textboxtype: 0, unk: 0, line: 23 */ "On raconte que celui qui réalise un bon temps\nau <color blue<Wagonnet du péril >coloroff>gagne un <color yellow<quart de cœur>coloroff>.")
          }
...
/*< 68>*/ 	start()
/*< 69>*/ 	printf(/* textboxtype: 1, unk: 0, line: 36 */ "<0x10012:0x0000000b>Maître, veuillez prendre connaissance de ces\ninformations pertinentes :\n\n\nUn <color red<phénomène anormal>coloroff> semble s'être produit dans\nla forêt de Firone. Vous ne pouvez pas y descendre\npour le moment.")
          }
...
/*< 39>*/ 	start()
/*< 24>*/ 	printf(/* textboxtype: 1, unk: 0, line: 14 */ "On raconte que dans les coffres des <color blue<cubes de\nla Déesse>coloroff> qui montent au ciel, on trouve aussi\ndes <color yellow<quarts de cœur>coloroff>.")
          }
...
/*< 71>*/ 	switch (story_flags[843 /* us: 805A9B35 0x04, jp: 805ACDB5 0x04 */]) {
          	  case 0:
/*< 72>*/ 		printf(/* textboxtype: 0, unk: 0, line: 38 */ "Pointez l'endroit où vous voulez descendre\navec (Hand) et confirmez avec (A).")
          	  case 1:
/*< 73>*/ 		printf(/* textboxtype: 0, unk: 1, line: 37 */ "<0x10012:0x0000000b>Maître, veuillez prendre connaissance de ces\ninformations pertinentes :\n\n\nVous pouvez m'indiquer <sound 4>l'endroit où vous désirez\natterrir parmi les <color blue<statues d'oiseau >coloroff>que j'ai mémorisées.\n\n\nPointez l'endroit où vous souhaitez atterrir\navec (Hand) et confirmez avec (A).")
...
/*< 75>*/ 	start()
/*< 76>*/ 	printf(/* textboxtype: 0, unk: 1, line: 31 */ "On raconte qu'un <color yellow<quart de cœur >coloroff>est caché\npar ici.")
/*< 77>*/ 	switch (scene_flags[104 /* 0xC 01 */]) {
          	  case 0:
/*< 78>*/ 		printf(/* textboxtype: 1, unk: 0, line: 33 */ "Mais on raconte aussi que vous l'avez déjà\ntrouvé... Hmm...")
          	  case 1:
/*< 79>*/ 		printf(/* textboxtype: 0, unk: 0, line: 32 */ "Mais on raconte aussi que pour l'atteindre, il\nfaut se terrer dans le sol comme un <color blue<Mogma>coloroff>.")
          	}
          }
...
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 0, unk: 9, line: 4 */ "Voulez‐vous quitter cet Hypnéa?\n[1-]Quitter[2]Rester")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
