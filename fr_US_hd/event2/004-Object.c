...
/*< 58>*/ 	switch (story_flags[19 /* us: 805A9ADB 0x08, jp: 805ACD5B 0x08 */]) {
          	  case 0:
/*< 56>*/ 		printf("On raconte que sous ce volcan se terrent\nles <b<Mogmas>>, qui raffolent de trésors.\n\n\nOn raconte aussi que dernièrement, ils vivent\nplutôt tranquillement dans leur tanière.")
          	  case 1:
          		flw_59:
/*< 59>*/ 		printf("On raconte qu'un <r<dragon>> vit au <r<sommet >>de\nce volcan.\n\n\nMais on raconte qu'ici, ce n'est pas le sommet...")
/*< 60>*/ 		printf("Voulez-vous que je répète tout ça?\n[1]Oui[2-]Non")
/*< 62>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_59
          		  case 1:
/*< 61>*/ 			printf("Ça ne vous intéresse pas, ce que je raconte?<pause0F>\nJe vois...")
          		}
          	}
          }
...
/*< 30>*/ 		printf("On raconte que le <r<dragon >>qui vit au sommet\ndu volcan adore bavarder.\n\n\nOn raconte aussi qu'il peut vous parler des\nautres régions jusqu'à ce que vos oreilles en\ntombent.")
          	  case 1:
          		flw_52:
/*< 52>*/ 		printf("On raconte qu'au sommet de ce volcan vit\nun <r<dragon>> drapé de flammes.\n\n\nOn raconte aussi qu'il vit dans une <r<fournaise\n>>où l'on peut difficilement pénétrer.")
/*< 53>*/ 		printf("Voulez-vous que je répète tout ça?\n[1]Oui[2-]Non")
/*< 55>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_52
          		  case 1:
/*< 54>*/ 			printf("Ça ne vous intéresse pas, ce que je raconte?<pause0F>\nJe vois...")
          		}
          	}
          }
...
/*< 68>*/ 	start()
/*< 69>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance de ces\ninformations pertinentes :\n\n\nUn <r<phénomène anormal>> semble s'être produit dans\nla forêt de Firone. Vous ne pouvez pas y descendre\npour le moment.")
          }
...
/*< 39>*/ 	start()
/*< 24>*/ 	printf("On raconte que dans les coffres des <b<cubes de\nla Déesse>> qui montent au ciel, on trouve aussi\ndes <y<quarts de c\x153ur>>.")
          }
...
/*< 71>*/ 	switch (story_flags[843 /* us: 805A9B35 0x04, jp: 805ACDB5 0x04 */]) {
          	  case 0:
/*< 72>*/ 		printf("Pointez l'endroit où vous voulez descendre\navec \x0E\x02\x04\x02\x18CD et confirmez avec (A).")
          	  case 1:
/*< 73>*/ 		printf("\x0E\x01\x12\x04\x00\x0BMaître, veuillez prendre connaissance de ces\ninformations pertinentes :\n\n\nVous pouvez m'indiquer <pling>l'endroit où vous désirez\natterrir parmi les <b<statues d'oiseau >>que j'ai mémorisées.\n\n\nPointez l'endroit où vous souhaitez atterrir\navec \x0E\x02\x04\x02\x18CD et confirmez avec (A).")
...
/*< 75>*/ 	start()
/*< 76>*/ 	printf("On raconte qu'un <y<quart de c\x153ur >>est caché\npar ici.")
/*< 77>*/ 	switch (scene_flags[104 /* 0xC 01 */]) {
          	  case 0:
/*< 78>*/ 		printf("Mais on raconte aussi que vous l'avez déjà\ntrouvé... Hmm...")
          	  case 1:
/*< 79>*/ 		printf("Mais on raconte aussi que pour l'atteindre, il\nfaut se terrer dans le sol comme un <b<Mogma>>.")
          	}
          }
