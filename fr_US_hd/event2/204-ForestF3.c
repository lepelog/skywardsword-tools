...
/*< 35>*/ 	start()
/*< 17>*/ 	printf("\x0E\x01\x09\x04\x00\x0EKwaaa, Link! On dirait que tu as\nrassemblé toutes les fironotes. Bon travail!\n\n\nMaintenant, retourne vite voir le <b<dragon d'eau>>.\nKwa.")
/*<195>*/ 	story_flags[818 /* us: 805A9B30 0x04, jp: 805ACDB0 0x04 */] = false;
          }

          void entrypoint_204_28() {
/*<168>*/ 	start()
/*<169>*/ 	printf("Le grand dragon d'eau est très fâché, glou!")
          }
...
/*< 42>*/ 	printf("Tout indique que le Vénérable fait référence\nà la <r<détection>>.\n\n\nSon conseil est pertinent, \x0E\x01\x12\x04\x00\x02Maître. J'ai en effet\npu analyser les caractéristiques des fironotes.")
/*<183>*/ 	story_flags[81 /* us: 805A9AEB 0x04, jp: 805ACD6B 0x04 */] = true;
/*<184>*/ 	open_dowsing_wheel(9)
/*< 53>*/ 	printf("J'ai configuré la <r<<pling>détection>> pour réagir\naux fironotes. Utilisez\x2010la pour vos recherches.\n\n\nToutefois, il est <r<impossible d'utiliser la détection\nsous l'eau>>. Soyez\x2010en conscient.")
...
/*<123>*/ 					printf("\x0E\x01\x09\x04\x00\x01Je vais te donner un conseil! Attaque les\npierres pour les faire rouler! Kwo-ko!")
          				  case 1:
/*<122>*/ 					printf("\x0E\x01\x09\x04\x00\x07Le Vénérable t'appelle! Kwii!\nVa écouter ce qu'il a à te dire!")
          				}
          			  case 1:
          				goto flw_123
          			}
...
/*<  1>*/ 		printf("\x0E\x01\x09\x04\x00\x04Koro-kwo! Il y a plein d'eau qui est sortie de\nla <r<base du grand arbre>><pling>. Ça nous a tous surpris!\n\n\nAvec toute cette eau, on peut plus se cacher\nnulle part. Kwa! \x0E\x01\x09\x04\x11\x05Est\x2010ce que la forêt pourrait\npas redevenir comme avant?")
          	}
          }
...
/*<125>*/ 				switch (scene_flags[26 /* 0x2 04 */]) {
          				  case 0:
/*<137>*/ 					printf("\x0E\x01\x09\x04\x09\x0CUtilise ta fonction détection, ou n'importe quoi...\nmais trouve vite ces fironotes! Kwo-ko!")
          				  case 1:
/*<126>*/ 					printf("\x0E\x01\x09\x04\x00\x07Le Vénérable t'appelle! Kwii!\nVa écouter ce qu'il a à te dire!")
          				}
          			  case 1:
...
/*<178>*/ 					switch (choice(2)) {
          					  case 0:
/*<180>*/ 						printf("\x0E\x01\x09\x04\x0C\x01Kwaa. C'est les créatures avec une bouche\ntoute longue qui se promènent dans l'eau!")
          						flw_179:
/*<179>*/ 						printf("\x0E\x01\x09\x04\x0B\x05Si tu en croises un dans l'eau, parle\x2010lui! Kwaa!")
          					  case 1:
          						goto flw_179
          					}
          				  case 1:
/*<130>*/ 					printf("\x0E\x01\x09\x04\x00\x07Le Vénérable t'appelle! Kwii!\nVa écouter ce qu'il a à te dire!")
          				}
          			  case 1:
          				goto flw_131
          			}
...
/*<  7>*/ 		printf("\x0E\x01\x09\x04\x00\x0FLe <b<dragon d'eau>> est arrivé! Si la forêt est dans\ncet état, c'est à cause d'elle, c'est clair! Kii-kwii!")
          	}
          }
...
/*<133>*/ 				switch (scene_flags[26 /* 0x2 04 */]) {
          				  case 0:
/*<136>*/ 					printf("\x0E\x01\x09\x04\x00\x14Essaie d'utiliser la détection. Tu trouveras\nles fironotes plus facilement! Kwa.")
          				  case 1:
/*<134>*/ 					printf("\x0E\x01\x09\x04\x00\x07Le Vénérable t'appelle! Kwii!\nVa écouter ce qu'il a à te dire!")
          				}
          			  case 1:
...
/*< 10>*/ 		printf("\x0E\x01\x09\x04\x00\x04Ka-kwa! J'ai vu le <b<dragon d'eau>>! Elle doit\nsûrement se cacher quelque part! Kwa.")
          	}
          }
...
/*<157>*/ 	printf("\x0E\x01\x09\x04\x00\x0EKwaa, Link!\nM'entends-tu?\n\n\nJe viens d'avoir une idée!\nViens me voir, que je t'explique!")
