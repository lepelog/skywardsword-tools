...
/*< 35>*/ 									switch (temp_flags[7 /* 0x1 80 */]) {
          									  case 0:
/*< 39>*/ 										printf("En plus des <r<Gardiens>> qui vous attaquent, il existe\ndeux types de <r<Veilleurs>> qui traquent les intrus sur\n<r<terre ou dans les airs>>.\n\nChacun a un comportement différent, faites\x2010y\ntrès attention.")
...
/*< 25>*/ 						temp_flags[3 /* 0x1 08 */] = true;
          				  ...
          				  case 1:
/*< 21>*/ 					printf("Vous pouvez répéter l'épreuve de la Déesse\nautant de fois que vous le souhaitez, \x0E\x01\x12\x04\x00\x02Maître.\n\n\nJe vous conseille de <r<ne pas prendre >>tout de suite\nles <y<larmes >>faciles à atteindre mais de les conserver\npour les moments où vous seriez découvert.\n\nCollectez les 15 <y<larmes>> et retrouvez\x2010moi\ndans le monde extérieur.")
...
/*< 14>*/ 			printf("Je ne peux toujours pas vous accompagner. L'épreuve\ns'adresse directement à votre esprit, \x0E\x01\x12\x04\x00\x02Maître.\n\n\nVous vous trouvez dans un <b<Hypnéa>>, un monde\nspirituel où seul l'élu de la Déesse peut pénétrer.\n\n\nCelui\x2010ci est le deuxième, l'<b<Hypnéa de Nayru>>, qui\nmettra à l'épreuve votre <r<sagesse>>.\n\n\nPour trouver la nouvelle flamme qui renforcera\nvotre épée, votre âme doit grandir encore davantage.")
/*< 17>*/ 			set_camera(9, 0)
