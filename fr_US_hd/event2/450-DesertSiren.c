...
/*<  9>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 10>*/ 		printf(/* textboxtype: 2, unk: 4, line: 26 */ "Tu es arrivé, <heroname>!\nDonne tout ce que tu as!")
/*< 12>*/ 		set_camera(10, 0)
...
/*< 25>*/ 						temp_flags[3 /* 0x1 08 */] = true;
          				  ...
          				  case 1:
/*< 21>*/ 					printf(/* textboxtype: 4, unk: 2, line: 19 */ "Vous pouvez répéter l'épreuve de la Déesse\nautant de fois que vous le souhaitez, <0x10012:0x00000002>Maître.\n\n\nJe vous conseille de <color red<ne pas prendre >coloroff>tout de suite\nles <color yellow<larmes >coloroff>faciles à atteindre mais de les conserver\npour les moments où vous seriez découvert.\n\nCollectez les 15 <color yellow<larmes>coloroff> et retrouvez‐moi\ndans le monde extérieur.")
...
/*< 14>*/ 			printf(/* textboxtype: 4, unk: 2, line: 1 */ "Je ne peux toujours pas vous accompagner. L'épreuve\ns'adresse directement à votre esprit, <0x10012:0x00000002>Maître.\n\n\nVous vous trouvez dans un <color blue<Hypnéa>coloroff>, un monde\nspirituel où seul l'élu de la Déesse peut pénétrer.\n\n\nCelui‐ci est le deuxième, l'<color blue<Hypnéa de Nayru>coloroff>, qui\nmettra à l'épreuve votre <color red<sagesse>coloroff>.\n\n\nPour trouver la nouvelle flamme qui renforcera\nvotre épée, votre âme doit grandir encore davantage.")
/*< 17>*/ 			set_camera(9, 0)
...
/*< 56>*/ 					set_camera(3, 0)
/*< 59>*/ 					printf(/* textboxtype: 2, unk: 2, line: 9 */ "C'est une <color yellow<larme de Nayru>coloroff>.\nIl vous faudra en rassembler <color red<15>coloroff>.")
