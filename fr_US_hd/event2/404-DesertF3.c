...
/*< 43>*/ 	switch (story_flags[21 /* us: 805A9ADB 0x20, jp: 805ACD5B 0x20 */]) {
          	  case 0:
/*< 44>*/ 		printf(/* textboxtype: 1, unk: 0, line: 18 */ "La vue est magnifique, ici! Vrrzt!")
          	  case 1:
/*< 50>*/ 		check_item_flag(198, 1)
/*< 51>*/ 		switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 24}) {
          		  case 0:
/*< 52>*/ 			printf(/* textboxtype: 0, unk: 1, line: 19 */ "Brrm, brrzt! Mais c'est...<pause 30> Va tout de suite\nl'apporter au <color blue<dragon de foudre>coloroff>!")
          		  case 1:
...
/*<155>*/ 	switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          	  case 0:
/*<156>*/ 		printf(/* textboxtype: 0, unk: 0, line: 56 */ "<0x10009:0x2f080709><0x30001:0x><heroname>! Tu es allé sur le territoire\ndu dragon?<pause 84>\n\n\n<0x10009:0x2f010805><0x10008:0x02cd>Je t'envie! J'aimerais tellement\ny aller!<pause 90>\n\n\n<0x10009:0x2f0f0706><0x10008:0x02cd>Tu m'as damé le pion!")
          		flw_154:
/*<154>*/ 		scene_flags[9 'Lanayru Gorge'][36 /* 0x5 10 */] = true;
          	  case 1:
/*<147>*/ 		switch (scene_flags[35 /* 0x5 08 */]) {
          		  case 0:
/*<149>*/ 			printf(/* textboxtype: 0, unk: 1, line: 55 */ "<color red<<0x10009:0x2f080d0a>>coloroff>En creusant, j'ai découvert la voie vers\nle <color red<dragon de foudre>coloroff>...<pause 45>\n\n\n<0x10006:0xffcd><0x10009:0x2f0d0800>Mais le passage est trop étroit pour moi et je\nn'ai pas pu passer. <0x10006:0xffcd><0x10009:0x2f080700>Je ne sais pas quoi faire...")
          			goto flw_154
          		  case 1:
...
/*<171>*/ 				printf(/* textboxtype: 0, unk: 0, line: 53 */ "<0x10009:0x2f080d0a>De mon côté, j'ai fait quelques découvertes\nsur les trois dragons. Laisse‐moi t'en parler.<pause 15>\n\n\nIl semblerait qu'il y ait une terre encore\ninexplorée un peu plus loin!\n\n\nJ'ai trouvé un <color red<passage étroit>coloroff><sound 4>, mais je\nsuis trop gros pour l'emprunter...\n\n\n<0x10009:0x2f000d00>Je pense qu'il s'agit de l'endroit où se cache\nle <color red<dragon de foudre>coloroff>, l'un des trois dragons\nde légende!\n\n<0x10009:0x2f000800>Les robots aux alentours doivent avoir\nun lien avec lui.<pause 15>\n\n\n<0x10009:0x2f010807><0x10006:0xffcd>Le <color red<dragon de foudre>coloroff>, les robots et les\nchronolithes<pause 20>.<pause 20>.<pause 20>.<pause 20>\n\n\n<0x10009:0x2f080708><0x10008:0x02cd><0x10008:0x02cd>Quelle aventure!")
          				goto flw_148
          			}
          		}
          	}
...
/*< 37>*/ 						printf(/* textboxtype: 0, unk: 1, line: 22 */ "<0x10009:0x00030900>On a planté une <color red<pousse de l'arbre de vie >coloroff>là‐bas,\npour que le dragon de foudre puisse guérir\ngrâce à son fruit... Vrrm.")
          				  ...
          				  case 1:
/*<  8>*/ 					printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x00030c00>C'est terrible! Brrztz! Le <color blue<dragon de foudre\n>coloroff>est malade...<pause 15>Vrrrrm...\n\n\n<0x10009:0x00030c00>Pour utiliser les chronolithes du coin, il faut\nl'autorisation du dragon...<pause 30> Vrm.\n<0x10009:0x00010c00>Mais ce n'est pas vraiment ça le problème\nle plus urgent!")
          				}
          			}
          		}
          	}
...
/*< 24>*/ 	switch (temp_flags[0 /* 0x1 01 */]) {
          	  case 0:
/*< 25>*/ 		printf(/* textboxtype: 0, unk: 1, line: 31 */ "Si tu ne te dépêches pas, tu n'y arriveras pas!\nVzrrt!")
          	  case 1:
/*< 71>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 12, 'param3': 31}
/*< 12>*/ 		printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10009:0x00030900>Ici, il y a plein de grands chronolithes.<pause 30>\n<0x10009:0x00000900>Toi aussi tu as reçu l'autorisation du <color blue<dragon\nde foudre>coloroff> pour venir ici? Vrm?\n\n<0x10009:0x00010900>J'étais justement en train de lui en apporter un.\nBzzrt.")
/*< 18>*/ 		temp_flags[0 /* 0x1 01 */] = true;
/*< 87>*/ 		set_camera(1, 0)
/*< 86>*/ 		printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10005:0x00280000>Ça grouille de monstres un peu plus loin!\nVrrrm!<pause 15> <0x10009:0x00030c00>Fais bien attenztzt...")
          	}
          }
...
/*<134>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 48>*/ 			printf(/* textboxtype: 0, unk: 1, line: 37 */ "Le dragon de foudre est de très bonne humeur.\nBrzzzrt!")
          		  case 1:
...
/*< 57>*/ 		switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 28}) {
          		  case 0:
/*< 58>*/ 			printf(/* textboxtype: 0, unk: 0, line: 38 */ "Brritzz! Que penses‐tu faire de ce beau fruit?<pause 45>\nTu vas l'apporter au <color blue<dragon de foudre>coloroff>? Vrrm?")
          		  case 1:
/*< 27>*/ 			check_item_flag(197, 1)
/*< 28>*/ 			switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 8}) {
          			  case 0:
/*< 39>*/ 				printf(/* textboxtype: 1, unk: 0, line: 36 */ "<0x10009:0x00030c00>Les arbres poussent très mal ici, dans les <color blue<terres\nde Lanelle>coloroff>... Vrrrm.<pause 30> <0x10009:0x00030900>Il doit bien exister\nun endroit où ils poussent plus vite... Bzzrt!")
          			  case 1:
/*< 26>*/ 				switch (story_flags[524 /* us: 805A9B14 0x02, jp: 805ACD94 0x02 */]) {
          				  case 0:
/*< 29>*/ 					printf(/* textboxtype: 0, unk: 0, line: 35 */ "De l'autre côté du pont, nous avons planté une\n<color red<pousse de l'arbre de vie>coloroff>, dont les fruits\nguérissent tous les maux. Vrrrrzt.<pause 30>\n\n<0x10009:0x00000c00>Mais les arbres poussent très mal ici... Vrrrm.")
          				  case 1:
/*< 16>*/ 					printf(/* textboxtype: 0, unk: 1, line: 34 */ "<0x10009:0x00030900>Avec l'autorisation du dragon de foudre, vrzt,\nnous creusons ici à la recherche de <color blue<chronolithes>coloroff>.\n\n\n<pause 30><0x10009:0x00030c00>Mais le <color blue<dragon >coloroff>est en mauvaise santé...<pause 15>\nNous sommes inquiets pour lui. Vrrm...<pause 30>\n<0x10009:0x00010c00>Sa vie est en danger... Brrzzt!")
          				}
          			}
          		}
          	}
...
/*< 81>*/ 	printf(/* textboxtype: 0, unk: 1, line: 61 */ "<0x10005:0x004b0000>Nous sommes dans les <color blue<gorges de Lanelle>coloroff>.\nUne ancienne légende dit que cet endroit était habité\npar l'un des dragons serviteurs de la Déesse.")
          }
...
/*< 62>*/ 		printf(/* textboxtype: 0, unk: 0, line: 41 */ "<0x10009:0x2f000d09>Les fouilles, ça t'intéresse?<pause 60> J'ai une proposition\nà te faire...<pause 60> Tu vas sauter sur l'occasion!\n\n\n<0x10009:0x2f000d07>Les recherches, ça demande de l'argent.\nÇa te dirait pas d'investir dans les miennes?\n10 rubis seulement!\n\n[1-]D'accord[2]Non merci")
/*< 59>*/ 		switch (choice(2)) {
          		  case 0:
/*< 63>*/ 			switch (has_rupees(10)) {
          			  case 0:
/*< 64>*/ 				rupees += -10;
/*< 66>*/ 				printf(/* textboxtype: 0, unk: 0, line: 44 */ "<0x10009:0x2f020208>Merci! Tu verras, tu ne le regretteras\npas, c'est certain!")
/*< 67>*/ 				story_flags[525 /* us: 805A9B14 0x04, jp: 805ACD94 0x04 */] = true;
          				flw_98:
/*< 98>*/ 				scene_flags[9 'Lanayru Gorge'][106 /* 0xC 04 */] = true;
          			  case 1:
/*< 65>*/ 				printf(/* textboxtype: 0, unk: 1, line: 43 */ "Oh, t'as pas d'argent? Reviens me voir\nquand tu seras prêt à investir!")
          				goto flw_98
          			}
          		  case 1:
/*< 60>*/ 			printf(/* textboxtype: 1, unk: 0, line: 42 */ "<0x10009:0x2f010805><0x10006:0xffcd>Oh, dommage.<pause 30> J'ai bien l'impression que\nles fouilles, ça n'intéresse plus personne...")
          			goto flw_98
          		}
          	}
          }
...
/*< 84>*/ 	start()
/*< 85>*/ 	printf(/* textboxtype: 1, unk: 0, line: 63 */ "<0x10005:0x005a0000>C'est pour cette raison qu'on y retrouve des traces\nde rails, de wagons et de minerais.")
          }
...
/*< 92>*/ 	start()
/*< 93>*/ 	printf(/* textboxtype: 0, unk: 0, line: 68 */ "Entrée strictement interdite sans\nautorisation de <color blue<Lanelle>coloroff>, le <color blue<dragon\nde foudre>coloroff>.")
          }
