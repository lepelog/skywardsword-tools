...
/*<  5>*/ 		switch (story_flags[108 /* us: 805A9AE1 0x02, jp: 805ACD61 0x02 */]) {
          		  case 0:
/*< 17>*/ 			printf(/* textboxtype: 2, unk: 0, line: 0 */ "Votre énergie vitale est faible. Je vous suggère\nde voir à votre santé au plus vite.<entrypoint_6_402>")
          		  case 1:
/*<  3>*/ 			printf(/* textboxtype: 0, unk: 0, line: 5 */ "Votre énergie vitale diminue. Voyez à votre\nsanté dès que vous le pourrez.\n\n\nAfin que vous puissiez récupérer plus facilement,\nj'ai ajouté les <sound 4><color yellow<cœurs>coloroff> aux cibles localisables grâce\nà la <color green<fonction détection>coloroff>.")
...
/*< 13>*/ 				printf(/* textboxtype: 0, unk: 2, line: 7 */ "Puisque vous êtes en <color red<mode héroïque>coloroff>, vous ne trouverez\nni cœurs, ni flœurs.\n\n\nToutefois, vous aurez <color red<une chance >coloroff>d'en voir apparaître\nsi vous portez une <sound 4><color yellow<médaille cœur>coloroff>.")
          	  ...
          	  case 1:
/*< 16>*/ 		printf(/* textboxtype: 2, unk: 0, line: 0 */ "Votre énergie vitale est faible. Je vous suggère\nde voir à votre santé au plus vite.<entrypoint_6_402>")
          	}
          }

          void entrypoint_006_401() {
/*<  2>*/ 	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0, line: 0 */ "Votre énergie vitale est faible. Je vous suggère\nde voir à votre santé au plus vite.<entrypoint_6_402>")
          }
