...
/*<309>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_12:
/*< 12>*/ 				printf("Tu es encore là? Vrrm? Sois prudent!")
          			  case 1:
/*<310>*/ 				printf("Tu cherches un dragon? Vrrrm?\n\n\n\n\x0E\x01\x09\x04\x1303\x00Le <b<dragon de foudre>> se trouve au sud de la\n<b<grotte de Lanelle>>! Brrrzt! C'est le seul dragon\nque je connaisse.")
...
/*<  5>*/ 		switch (story_flags[90 /* us: 805A9AEF 0x80, jp: 805ACD6F 0x80 */]) {
          		  case 0:
          			flw_10:
/*< 10>*/ 			printf("Maintenant, il peut <r<transporter des objets\ndans ses mandibules>>.\n\n\nSois prudent! Zrrrt!")
...
/*<  6>*/ 			switch (context_related2(0)) {
          			  case 0:
/*<274>*/ 				printf("\x0E\x01\x09\x04\x1303\x00Merci de m'avoir aidé! Dzzt!")
...
/*< 59>*/ 	printf("\x0E\x01\x05\x04Z\x00\x0E\x01\x12\x04\x00\x0BMaître Link, veuillez prendre\nconnaissance de ces informations pertinentes :\n\n\nNous sommes arrivés aux <b<mines de Lanelle>>.")
          }
...
/*<109>*/ 		switch (scene_flags[75 /* 0x8 08 */]) {
          		  case 0:
/*<111>*/ 			printf("\x0E\x01\x09\x04\x2F08\xD0AJ'ai trouvé le passage qui mène au domaine\ndu <r<dragon de foudre>>...<pause2D>\n\n\n\x0E\x01\x06\x02\xFFCD\x0E\x01\x09\x04\x2F0D\x800Mais il est trop étroit, je peux pas passer.\x0E\x01\x06\x02\xFFCD\n\x0E\x01\x09\x04\x2F08\x700Comment faire...?")
          			goto flw_149
          		  case 1:
...
/*<271>*/ 				set_camera(5, 0)
/*<211>*/ 				printf("Alors, cette <b<flamme sacrée >>dont tu parlais,\ntu l'as trouvée?\n\n\nJ'arrête pas d'y penser. Raconte\x2010moi tout!\n\n\n\n\x0E\x01\x09\x04\x2F08\x407.<pause14>.<pause14>.<pause14> Il a fallu que tu fasses tout ça pour\nla trouver?!\n\n\nT'es vraiment impressionnant,\nLink.")
/*<356>*/ 				printf("\x0E\x01\x09\x04\x2F08\xD0ABon, je vais te dire ce que j'ai découvert\nà propos de la légende des trois dragons.<pause0F>\n\n\nPlus loin dans le désert, il y a bien un domaine\ncaché!\n\n\nJ'ai trouvé un <r<passage étroit<pling> >>dans lequel\nje peux pas passer!\n\n\n\x0E\x01\x09\x04\x2F00\xD00Si mon intuition me fait pas défaut, ça doit\nêtre le domaine d'un des trois dragons,\nle <r<dragon de foudre>>!\n\n\x0E\x01\x09\x04\x2F00\x800Je suis sûr que ça a un rapport avec les robots\nqui vivent ici.<pause0F>\n\n\n\x0E\x01\x09\x04\x2F01\x807\x0E\x01\x06\x02\xFFCDLe <r<dragon de foudre>>, les robots,\nles chronolithes<pause14>.<pause14>.<pause14>.<pause14>\n\n\n\x0E\x01\x09\x04\x2F08\x708\x0E\x01\x08\x02\x2CD\x0E\x01\x08\x02\x2CDQuelle aventure!")
          				goto flw_282
          			}
          		}
          	}
...
/*<213>*/ 	start()
/*<214>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, veuillez prendre\nconnaissance de ces informations pertinentes :")
...
/*<315>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_66:
/*< 66>*/ 				printf("Mes circuits font bzzt-bzzt chaque fois que\nje vois le temple du temps! C'est tellement\nbeau! Bzzt!")
          			  case 1:
/*<316>*/ 				printf("Tu cherches un dragon? Vrrrm?\n\n\n\n\x0E\x01\x09\x04\x1303\x00Le <b<dragon de foudre>> se trouve au sud de la\n<b<grotte de Lanelle>>! Brrrzt! C'est le seul dragon\nque je connaisse.")
...
/*< 97>*/ 			printf("Tiens? Bzt. Ta carte... Elle est bizarre.\nAttends, je vais corriger ça. Vrrm.")
...
/*<102>*/ 	start()
/*<283>*/ 	printf("\x0E\x01\x12\x04\x00\x01Maître, Fay au rapport.\nJe ne ressens plus l'aura de dame <b<Zelda>>.")
/*<284>*/ 	set_camera(7, 0)
...
/*<253>*/ 	start()
/*<254>*/ 	printf("On ne voit pas des humains très souvent,\npar ici. Vrrt! Est-ce que tu t'intéresses\naux chronolithes?")
...
/*< 81>*/ 					switch (scene_flags[8 /* 0x0 01 */]) {
          					  case 0:
/*< 83>*/ 						printf("\x0E\x01\x09\x04\x1303\x00Voici la <b<raffinerie de Lanelle>>! Vrrrt!\nC'est ici qu'on travaille les chronolithes.\n\n\n\x0E\x01\x09\x04\x1303\x00Elle est toujours aussi fantastique! Quand je la\nvois, mes engrenages tournent plus rond.\nVrrrmm!")
          					  case 1:
/*< 82>*/ 						printf("Brrrt! Tu as réussi à déchiffrer la\ncombinaison? Pour un humain,\ntu m'impressionnes. Vrrm.\n\n\x0E\x01\x09\x04\x1303\x00Voici la <b<raffinerie de Lanelle>>! Vrrrt!\nC'est ici qu'on travaille les chronolithes.\n\n\n\x0E\x01\x09\x04\x1303\x00Elle est toujours aussi fantastique! Quand\nje la vois, mes engrenages tournent plus rond.\nVrrrmm!")
/*< 84>*/ 						scene_flags[7 'Lanayru Desert'][8 /* 0x0 01 */] = true;
          						flw_85:
/*< 85>*/ 						scene_flags[7 'Lanayru Desert'][35 /* 0x5 08 */] = true;
          					}
          				  case 1:
/*<322>*/ 					printf("Tu cherches un dragon? Vrrrm?\n\n\n\n\x0E\x01\x09\x04\x1303\x00Le <b<dragon de foudre>> se trouve au sud de la\n<b<grotte de Lanelle>>! Brrrzt! C'est le seul dragon\nque je connaisse.")
...
/*< 80>*/ 			printf("Tu as trouvé les trois symboles de la\ncombinaison? Brrt? Mais il ne faut pas juste\nles avoir trouvés pour ouvrir la raffinerie.\nVrrrm!")
          	  ...
          	  case 1:
/*< 49>*/ 		printf("Qui es\x2010tu? Je ne te retrouve pas dans ma\nbanque de mémoire. Brrrt.\n\n\n\x0E\x01\x09\x04\x1303\x00Ceci est le générateur qui contrôle l'entrée\nde la raffinerie de Lanelle!\n\n\n\x0E\x01\x09\x04\x1303\x00Il est impossible d'ouvrir la raffinerie sans\nla <r<combinaison composée de trois symboles>>.\nZrrpt.")
...
/*<130>*/ 	start()
/*<131>*/ 	printf("\x0E\x01\x05\x04Z\x00C'est une terre aride qui s'est changée en désert\nen seulement quelques siècles. ")
          }
...
/*<257>*/ 	start()
/*<258>*/ 	printf("Un de nos compagnons s'est fait enlever!\nZrrrit! On raconte qu'il risque de se faire\ndéconnecter.")
...
/*<327>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_187:
/*<187>*/ 				printf("Vrrt? Tu as réussi à déchiffrer la combinaison?\nImpressionnant... pour un humain. Brrrt!\nOn s'entend.")
          			  case 1:
/*<328>*/ 				printf("Tu cherches un dragon? Vrrrm?\n\n\n\n\x0E\x01\x09\x04\x1303\x00Le <b<dragon de foudre>> se trouve au sud de la\n<b<grotte de Lanelle>>! Brrrzt! C'est le seul dragon\nque je connaisse.")
...
/*<115>*/ 		switch (scene_flags[100 /* 0xD 10 */]) {
          		  case 0:
/*<116>*/ 			printf("Aaaah! Bzzrt! Qu'est\x2010ce que tu fais?\n\n\n\n\x0E\x01\x09\x04\x1303\x00Même si tu as trouvé les symboles, ce n'est\npas assez pour ouvrir la raffinerie. Bzzt.")
          			flw_155:
...
/*<180>*/ 			switch (scene_flags[34 /* 0x5 04 */]) {
          			  case 0:
/*< 53>*/ 				printf("Tu cherches la combinaison pour entrer dans\nla raffinerie de Lanelle? Vrrrt?\n\n\n\x0E\x01\x09\x04\x1303\x00Tu as l'air un peu bizarre. Je ne donnerai\njamais la combinaison à un individu aussi\nsuspect! Zrrpt.\n\n\x0E\x01\x09\x04\x1303\x00Et, vrrrt! Que je ne te voie pas toucher au\ngénérateur ou t'amuser à y planter cette épée!\nBzzt.")
          				goto flw_155
          			  case 1:
/*<181>*/ 				printf("Vrrt! Ton accoutrement est un peu étrange.\nTu es très suspect!\n\n\n\x0E\x01\x09\x04\x1303\x00Et, vrrrt! Que je ne te voie pas toucher au\ngénérateur ou t'amuser à y planter cette épée!\nBzzt.")
          				goto flw_155
          			}
          		}
          	}
...
/*<135>*/ 	printf("\x0E\x01\x05\x04Z\x00Nous sommes arrivés au <b<désert de Lanelle>>.\nUne brusque désertification a grandement\nmodifié la nature de ces terres.")
          }
...
/*<298>*/ 	start()
/*<299>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, veuillez prendre\nconnaissance de ces informations pertinentes :\n\n\nVous avez découvert les trois symboles. Retournez\nau <r<générateur>> qui se trouve devant la <b<raffinerie\nde Lanelle>>.")
          }
...
/*<333>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_189:
/*<189>*/ 				printf("Vrrt? Tu as réussi à déchiffrer la combinaison?\nImpressionnant... pour un humain. Brrrt!\nOn s'entend.")
          			  case 1:
/*<334>*/ 				printf("Tu cherches un dragon? Vrrrm?\n\n\n\n\x0E\x01\x09\x04\x1303\x00Le <b<dragon de foudre>> se trouve au sud de la\n<b<grotte de Lanelle>>! Brrrzt! C'est le seul dragon\nque je connaisse.")
...
/*<117>*/ 		switch (scene_flags[102 /* 0xD 40 */]) {
          		  case 0:
/*<118>*/ 			printf("Aaaah! Bzzrt! Qu'est\x2010ce que tu fais?\n\n\n\n\x0E\x01\x09\x04\x1303\x00Même si tu as trouvé les symboles, ce n'est pas\nassez pour ouvrir la raffinerie. Bzzt.")
          			flw_153:
...
/*<182>*/ 			switch (scene_flags[34 /* 0x5 04 */]) {
          			  case 0:
/*< 57>*/ 				printf("Tu cherches la combinaison pour entrer dans\nla raffinerie de Lanelle? Vrrrt?\n\n\n\x0E\x01\x09\x04\x1303\x00Tu as l'air un peu bizarre. Je ne donnerais\njamais la combinaison à un individu aussi\nsuspect! Zrrpt.\n\n\x0E\x01\x09\x04\x1303\x00Et, vrrrt! Que je ne te voie pas toucher au\ngénérateur ou t'amuser à y planter cette épée!\nBzzt.")
          				goto flw_153
          			  case 1:
/*<183>*/ 				printf("Vrrt! Ton accoutrement est un peu étrange.\nTu es très suspect!\n\n\n\x0E\x01\x09\x04\x1303\x00Et, vrrrt! Que je ne te voie pas toucher au\ngénérateur ou t'amuser à y planter cette épée!\nBzzt.")
          				goto flw_153
          			}
          		}
          	}
...
/*<300>*/ 	start()
/*<301>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, veuillez prendre\nconnaissance de ces informations pertinentes :\n\n\nMon analyse indique qu'il est possible d'actionner ce\n<r<générateur >>en lui fournissant une source d'électricité.")
          }
...
/*<339>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_191:
/*<191>*/ 				printf("Vrrt? Tu as réussi à déchiffrer la combinaison?\nImpressionnant... pour un humain. Brrrt!\nOn s'entend.")
          			  case 1:
/*<340>*/ 				printf("Tu cherches un dragon? Vrrrm?\n\n\n\n\x0E\x01\x09\x04\x1303\x00Le <b<dragon de foudre>> se trouve au sud de la\n<b<grotte de Lanelle>>! Brrrzt! C'est le seul dragon\nque je connaisse.")
...
/*<123>*/ 		switch (scene_flags[101 /* 0xD 20 */]) {
          		  case 0:
/*<124>*/ 			printf("Aaaah! Bzzrt! Qu'est\x2010ce que tu fais?\n\n\n\n\x0E\x01\x09\x04\x1303\x00Même si tu as trouvé les symboles, ce n'est\npas assez pour ouvrir la raffinerie. Bzzt.")
          			flw_154:
...
/*<122>*/ 				printf("Tu cherches la combinaison pour entrer dans\nla raffinerie de Lanelle? Vrrrt?\n\n\n\x0E\x01\x09\x04\x1303\x00Tu as l'air un peu bizarre. Je ne donnerais\njamais la combinaison à un individu aussi\nsuspect! Zrrpt.\n\n\x0E\x01\x09\x04\x1303\x00Et, vrrrt! Que je ne te voie pas toucher au\ngénérateur ou t'amuser à y planter cette épée!\nBzzt.")
          				goto flw_154
          			  case 1:
/*<185>*/ 				printf("Vrrt! Ton accoutrement est un peu étrange.\nTu es très suspect!\n\n\n\x0E\x01\x09\x04\x1303\x00Et, vrrrt! Que je ne te voie pas toucher au\ngénérateur ou t'amuser à y planter cette épée!\nBzzt.")
          				goto flw_154
          			}
          		}
          	}
