...
/*< 17>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 0, unk: 1, line: 13 */ "Bon, je dépose la soupe de citrouille juste ici.\n\n\n\nDrôle d'endroit pour livrer de la soupe. Et pas\ntrès rassurant non plus. On dirait qu'on\npourrait se faire attaquer à tout moment.")
          }

          void entrypoint_120_21() {
/*< 19>*/ 	start()
/*< 20>*/ 	printf(/* textboxtype: 0, unk: 92, line: 14 */ "Ça y est, j'ai fait ma part. Je me sauve!<0x10005:0x00280000>")
...
/*< 32>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*< 34>*/ 		printf(/* textboxtype: 0, unk: 92, line: 11 */ "Hoho! C'est extraordinaire. Tu as trouvé\nla Triforce!")
          		flw_35:
...
/*< 31>*/ 		switch (story_flags[22 /* us: 805A9ADB 0x40, jp: 805ACD5B 0x40 */]) {
          		  case 0:
/*< 33>*/ 			printf(/* textboxtype: 92, unk: 1, line: 10 */ "Hoho! Tu as trouvé le chemin vers la Triforce!\nC'est extraordinaire.")
          			goto flw_35
          		  case 1:
...
/*< 37>*/ 							story_flags[781 /* us: 805A9B2D 0x20, jp: 805ACDAD 0x20 */] = true;
          						  case 1:
/*<  3>*/ 							printf(/* textboxtype: 0, unk: 92, line: 2 */ "Si je connais? Tu sais que tu t'adresses au\ngrand esprit qui veille sur... <pause 20>Mais passons.")
          							goto flw_4
          						}
          					}
          				}
