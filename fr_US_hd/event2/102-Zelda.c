...
/*<183>*/ 	start()
/*<184>*/ 	printf("Tu peux consulter les <r<actions >>de ton célestrier\nen appuyant sur \x0E\x02\x04\x02\x13CD à tout moment lorsque tu\nle chevauches!\x0E\x01\x11\x02\xBCD\n\nTu peux <r<accélérer >>en <g<attaquant>>, ou encore\n<r<ralentir>>. Tu devrais essayer.")
...
/*<  5>*/ 	printf("Ah! Le voilà!")
/*< 21>*/ 	set_camera(2, 0)
/*< 14>*/ 	printf("\x0E\x01\x09\x04\x09\x500\x0E\x01\x08\x02\x1CDC'est lui! C'est ton célestrier,\nLink!")
...
/*< 73>*/ 	switch (scene_flags[3 /* 0x1 08 */]) {
          	  case 0:
/*< 74>*/ 		printf("\x0E\x01\x09\x04\x00\x1514Ah, tu as raté ton atterrissage.\n\n\n\n<r<\x0E\x01\x09\x04\x00\xC00En chute libre>>, dirige-toi en <g<inclinant >>ton corps.\n\n\n\nAllez, essaie encore une fois! Cette fois je ne te\npousserai pas. Alors, prends ton courage à deux\nmains et saute quand tu es prêt!\n\n<g<Fonce >>vers le bord pour prendre de l'élan et\nsauter dans le vide!\n\n\nN'oublie pas d'ouvrir ton parachâle en appuyant\nsur \x0E\x02\x04\x02\x29CD avant d'atterrir!\x0E\x01\x11\x02\xFCD\n\n\nTu dois atterrir <r<au milieu du dallage circulaire\n>>en bas!")
...
/*< 10>*/ 		switch (story_flags[39 /* us: 805A9AE5 0x20, jp: 805ACD65 0x20 */]) {
          		  case 0:
/*<173>*/ 			printf("\x0E\x01\x09\x04\x00\x04On essaie encore, d'accord? Cette fois je ne te\npousserai pas. Alors prends ton courage à deux\nmains et SAUTE!\n\n<g<Fonce >>vers le bord pour prendre de l'élan et\nsauter dans le vide!\n\n\nN'oublie pas d'ouvrir ton parachâle en\nappuyant sur \x0E\x02\x04\x02\x29CD avant d'atterrir!\x0E\x01\x11\x02\xFCD\n\n\nTu dois atterrir <r<au milieu du dallage circulaire\n>>en bas!")
          		  case 1:
/*<  8>*/ 			switch (story_flags[26 /* us: 805A9ADA 0x04, jp: 805ACD5A 0x04 */]) {
          			  case 0:
/*<  9>*/ 				printf("\x0E\x01\x09\x04\x0F\x513Que c'est cruel! Ils l'ont enfermé là-dedans!\n\n\n\n\x0E\x03\x01\x00Link! Fais vite, et retire\ncette barrière!")
          			  case 1:
/*<  7>*/ 				printf("\x0E\x01\x09\x04\x00\x06Ne reste pas là, Link!\nAllons vite aider ton célestrier!")
          			}
          		}
          	}
          }
...
/*< 67>*/ 	set_camera(18, 0)
/*< 30>*/ 	printf("Her... Pssst, Hergo! <pause1E>Derrière toi! <pause1E>Là, derrière!")
/*< 52>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': 5, 'next': 31, 'param3': 16}
/*< 31>*/ 	printf("\x0E\x01\x09\x04\x400\x00\x0E\x01\n\x04\x0BÍQuoi?! Tu ne vois pas que je suis en train de...\nTais-toi, donc!")
...
/*< 32>*/ 	printf("\x0E\x01\x09\x04\x419\x1715Oupelaye!!!")
...
/*< 90>*/ 	set_camera(19, 0)
/*< 33>*/ 	printf("Je peux savoir ce qu'on fera exactement, toi et\nmoi, sans personne pour nous déranger?")
/*< 68>*/ 	set_camera(15, 0)
/*< 55>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': 100, 'next': 34, 'param3': 16}
/*< 34>*/ 	printf("\x0E\x01\x09\x04\x4FF\xFF0DEuh... Héhé... N\x2010non, rien... Je disais ça\ncomme ça.\n\n\n\x0E\x01\x09\x04\x400\x00\x0E\x03\x01\x00Link! Je suis content que t'aies\nretrouvé ton oiseau! On va pouvoir jouer\nfranc-jeu!")
/*< 87>*/ 	{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': 0, 'next': 86, 'param3': 17}
/*< 86>*/ 	printf("\x0E\x01\x09\x04\x400\x00À tout à l'heure, Zelda! Et surtout, surveille\x2010moi\nbien pendant la course! Je vais y mettre\nle paquet!")
...
/*< 98>*/ 	set_camera(18, 0)
/*< 35>*/ 	printf("\x0E\x01\x09\x04\x505\x13\x0E\x01\x09\x04\x607\x00Heille! Hergo! Attends un peu!\x0E\x01\x05\x04\x14\x00")
...
/*<116>*/ 	{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 50, 'next': 205, 'param3': 6}
/*<205>*/ 	{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': 100, 'next': 206, 'param3': 16}
/*<206>*/ 	{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 5, 'next': 69, 'param3': 6}
/*< 69>*/ 	set_camera(16, 0)
/*< 36>*/ 	printf("\x0E\x01\x09\x04\x09\x1014« Jouer franc-jeu »? Venant de lui, ça me fait\nbien rire!\n\n\n\x0E\x01\x09\x04\x00\xFF00\x0E\x03\x01\x00Link! Ne fais pas attention à\nce qu'il raconte! Tu dois donner tout ce que\ntu as! J'ai confiance en toi!\n\nC'est promis?\n[1]Oui![2]J'ai des\ndoutes[3]Rien que toi\net moi...")
/*< 57>*/ 	switch (choice(3)) {
          	  case 0:
/*< 37>*/ 		printf("\x0E\x01\x09\x04\x0C\xE00Quelle bonne attitude! Je suis sûre que tu vas\ngagner, Link!")
          		flw_101:
...
/*< 40>*/ 		printf("La chevauchée céleste va commencer! Que les\nélèves participants se rassemblent ici!")
/*< 59>*/ 		{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': 100, 'next': 41, 'param3': 16}
/*< 41>*/ 		printf("Ça y est, Link! Bonne chance!")
/*< 70>*/ 		changeScene(18, 0) // 
          	  case 1:
/*< 38>*/ 		printf("\x0E\x01\x09\x04\x0C\x1500Mais, pourquoi? Fais de ton mieux, et tu y\narriveras! Aie confiance en toi!")
          		goto flw_101
          	  case 2:
/*< 39>*/ 		printf("\x0E\x01\x09\x04\x10\xE04Ah, non! Tu dois te concentrer!")
          		goto flw_101
          	}
          }
...
/*< 88>*/ 	start()
/*< 89>*/ 	printf("J'étais un peu inquiète mais ton oiseau est en\npleine forme, Link! Mon père\nnous attend. On devrait se  dépêcher!")
          }
...
/*<122>*/ 	printf("\x0E\x01\x0D\x02\x1906\x0E\x01\x08\x02\x1CD\x0E\x03\x01\x00Link!!!")
          }
