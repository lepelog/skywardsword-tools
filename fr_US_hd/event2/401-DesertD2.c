...
/*<102>*/ 			switch (scene_flags[61 /* 0x6 20 */]) {
          			  case 0:
          				goto flw_103
          			  case 1:
/*< 18>*/ 				printf("Dépêche\x2010toi de venir nous libérer. Bzzt!\nCommence par rétablir le <r<courant dans\nla salle des machines>>.")
          			}
          		}
          	  case 1:
...
/*<106>*/ 			switch (scene_flags[69 /* 0x9 20 */]) {
          			  case 0:
/*<107>*/ 				printf("\x0E\x01\x09\x04\x09\xC00Ouf! J'ai eu peur! Brrpt!\n\n\n\n\x0E\x01\x09\x04\x03\x900Tu es un humain, non? Brrpt?\nComment es\x2010tu arrivé jusqu'ici?")
          				flw_1:
/*<  1>*/ 				printf(".<pause05>.<pause05>.<pause05>\n\n\n\n\x0E\x01\x09\x04\x03\x900Tu es venu avec le <b<capitaine >>pour nous sauver?\nVrrip! Ça me fait trop plaisir!\n\n\n\x0E\x01\x09\x04\x03\x900Mais à cause de ces <r<barreaux électriques>>,\non peut pas sortir d'ici.")
/*< 31>*/ 				set_camera(5, 0)
...
/*< 33>*/ 				set_camera(1, 0)
/*< 30>*/ 				printf("\x0E\x01\x09\x04\x03\x900Tu y trouveras un couloir qui conduit\nde notre côté. Vrmm.")
/*< 34>*/ 				set_camera(-1, 0)
...
/*<120>*/ 							printf("\x0E\x01\x09\x04\x03\x900L'autre <r<générateur>> est là. Vrrrm.")
/*<119>*/ 							{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 118, 'param3': 34}
/*<118>*/ 							printf("\x0E\x01\x09\x04\x03\x900On compte sur toi! Bzrrr!")
          							goto flw_19
          						  case 1:
...
/*< 23>*/ 						printf("\x0E\x01\x09\x04\x03\x900Il y a des <r<générateurs >>à ces deux endroits. Zrrt.")
/*< 22>*/ 						{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 21, 'param3': 34}
/*< 21>*/ 						printf("\x0E\x01\x09\x04\x03\x900On compte sur toi! Bzrrr!")
          						goto flw_19
          					}
          				}
          			  case 1:
/*<108>*/ 				printf("\x0E\x01\x09\x04\x03\x900Comment un humain comme toi est arrivé\njusqu'ici? Vrrrpt?")
          		  ...
          		  case 1:
/*< 97>*/ 			printf("\x0E\x01\x09\x04\x09\xC00J'ai peur! Vrriit! Élimine ces monstres\net viens vite nous sauver! Zrrrpt!")
...
/*<128>*/ 		set_camera(-1, 0)
/*< 43>*/ 		printf("\x0E\x01\x09\x04\x03\x900Brrt. On peut accéder à la cabine du capitaine\nen passant par une porte à la poupe du bateau.")
...
/*<122>*/ 		switch (scene_flags[69 /* 0x9 20 */]) {
          		  case 0:
/*<123>*/ 			printf("\x0E\x01\x09\x04\x03\x900Il me semble qu'on se connaît, vrrrm?\n\x0E\x01\x09\x04\x03\x900Tu es l'humain sans c\x153ur qui a pas voulu\nnous sauver tout à l'heure!\n\n\x0E\x01\x09\x04\x03\x900Comment es\x2010tu arrivé jusqu'ici?")
          			flw_125:
/*<125>*/ 			printf("\x0E\x01\x09\x04\x03\x900.<pause05>.<pause05>.<pause05>\n\n\n\n\x0E\x01\x09\x04\x03\x900Tu es venu avec le <b<capitaine >>pour nous aider?\nMerci!")
          			goto flw_15
          		  case 1:
/*<124>*/ 			printf("\x0E\x01\x09\x04\x03\x900Tu es un humain... Vrrrm?\nComment es\x2010tu arrivé jusqu'ici?")
          			goto flw_125
          		}
          	}
          }
...
/*< 77>*/ 	printf("Ma mémoire indique que la <b<porte >>se trouve à\nl'endroit marqué d'une \x0E\x02\x04\x02\x19CD.")
...
/*< 95>*/ 	set_camera(9, 0)
/*< 93>*/ 	printf("Je ressens une présence maléfique derrière\ncette porte.")
/*< 96>*/ 	set_camera(-1, 0)
...
/*< 86>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, Fay au rapport.\nLa probabilité qu'il s'agisse d'un <r<<pling>chronolithe\n>>est de 90 %.\n\nJe vous conseille de trouver un moyen de le <g<frapper>>.\nIl est probable que cela provoque de grands\nchangements dans ce navire.")
...
/*<134>*/ 	set_camera(15, 0)
/*<131>*/ 	printf("Il semble très difficile de l'atteindre d'ici.\nJe vous recommande de retourner sur le pont.")
