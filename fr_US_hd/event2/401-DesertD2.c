...
/*<106>*/ 			switch (scene_flags[69 /* 0x9 20 */]) {
          			  case 0:
/*<107>*/ 				printf(/* textboxtype: 0, unk: 0, line: 11 */ "<0x10009:0x00090c00>Ouf! J'ai eu peur! Brrpt!\n\n\n\n<0x10009:0x00030900>Tu es un humain, non? Brrpt?\nComment es‐tu arrivé jusqu'ici?")
          				flw_1:
/*<  1>*/ 				printf(/* textboxtype: 0, unk: 1, line: 4 */ ".<pause 5>.<pause 5>.<pause 5>\n\n\n\n<0x10009:0x00030900>Tu es venu avec le <color blue<capitaine >coloroff>pour nous sauver?\nVrrip! Ça me fait trop plaisir!\n\n\n<0x10009:0x00030900>Mais à cause de ces <color red<barreaux électriques>coloroff>,\non peut pas sortir d'ici.")
/*< 31>*/ 				set_camera(5, 0)
/*< 61>*/ 				wait_frames(60)
/*< 32>*/ 				set_camera(-1, 0)
...
/*<110>*/ 					switch (scene_flags[61 /* 0x6 20 */]) {
          					  case 0:
/*<113>*/ 						printf(/* textboxtype: 0, unk: 1, line: 25 */ "<0x10009:0x00030900>Tiens<pause 5>.<pause 5>.<pause 5>.\nOn dirait que la salle des machines est\nà nouveau opérationnelle. Vrrrm.\n\n<0x10009:0x00030900>Tu as rétabli le <color red<courant>coloroff>? Bzzzt? <0x10009:0x00030900>Je vois.\nTu devrais donc pouvoir passer par la salle\ndes machines pour rejoindre cette cellule!\nVrrrm.\n<0x10009:0x00030900>On t'attend!")
...
/*<120>*/ 							printf(/* textboxtype: 0, unk: 0, line: 26 */ "<0x10009:0x00030900>L'autre <color red<générateur>coloroff> est là. Vrrrm.")
/*<119>*/ 							{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 118, 'param3': 34}
/*<118>*/ 							printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10009:0x00030900>On compte sur toi! Bzrrr!")
          							goto flw_19
          						  case 1:
...
/*< 23>*/ 						printf(/* textboxtype: 0, unk: 1, line: 7 */ "<0x10009:0x00030900>Il y a des <color red<générateurs >coloroff>à ces deux endroits. Zrrt.")
/*< 22>*/ 						{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 21, 'param3': 34}
/*< 21>*/ 						printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10009:0x00030900>On compte sur toi! Bzrrr!")
          						goto flw_19
          					}
          				}
          			  case 1:
/*<108>*/ 				printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00030900>Comment un humain comme toi est arrivé\njusqu'ici? Vrrrpt?")
          		  ...
          		  case 1:
/*< 97>*/ 			printf(/* textboxtype: 0, unk: 0, line: 8 */ "<0x10009:0x00090c00>J'ai peur! Vrriit! Élimine ces monstres\net viens vite nous sauver! Zrrrpt!")
...
/*<121>*/ 	switch (story_flags[259 /* us: 805A9AF6 0x20, jp: 805ACD76 0x20 */]) {
          	  case 0:
/*< 13>*/ 		printf(/* textboxtype: 0, unk: 0, line: 17 */ "<0x10009:0x00030900>Tu es vraiment venu nous aider?\nJe suis si content! Vrrrm!")
          		flw_15:
/*< 15>*/ 		printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10009:0x00030900>Je vois, tu es venu sur ce bateau pour trouver\nla <color red<flamme de Nayru>coloroff>. Zrrt?\n\n\n<0x10009:0x00030900>Pour ranimer la <color red<flamme de Nayru>coloroff>, brt,\nil faut d'abord reprendre le contrôle du navire.\n\n\n<0x10009:0x00030900>La salle de contrôle est à côté de cette cellule,\nmais elle est fermée par une grande porte\nqui nécessite une clé spéciale. Pzzt.\n\n<0x10009:0x00030900>Rends‐toi d'abord dans la <color blue<cabine du capitaine>coloroff>,\n<sound 4>tu devrais y trouver la clé de la salle\nde contrôle. Vrrm.")
/*<144>*/ 		set_camera(12, 0)
/*<145>*/ 		{'type': 'type3', 'subType': 2, 'param1': 0, 'param2': 356, 'next': 143, 'param3': 15}
/*<143>*/ 		printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10009:0x00030900>Pour te remercier de nous avoir libérés,\nje te donne cette <color yellow<clé>coloroff>. Vrrm!\n\n\n<0x10009:0x00030900>Avec cette <color red<clé>coloroff>, vrrrt, tu pourras entrer dans\nla <color blue<cabine du capitaine>coloroff>.")
...
/*<128>*/ 		set_camera(-1, 0)
/*< 43>*/ 		printf(/* textboxtype: 0, unk: 0, line: 23 */ "<0x10009:0x00030900>Brrt. On peut accéder à la cabine du capitaine\nen passant par une porte à la poupe du bateau.")
...
/*<130>*/ 		set_camera(12, 0)
/*< 28>*/ 		printf(/* textboxtype: 0, unk: 1, line: 19 */ "<0x10009:0x00030900>Bon, nous, on déguerpit! Brrzt!\n\n\n\n<0x10009:0x00030900>Désolé, mais il va falloir que tu te débrouilles\ntout seul pour la suite. Tu vas bien t'en tirer,\nbrrt!")
/*< 57>*/ 		set_camera(6, 0)
...
/*<125>*/ 			printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10009:0x00030900>.<pause 5>.<pause 5>.<pause 5>\n\n\n\n<0x10009:0x00030900>Tu es venu avec le <color blue<capitaine >coloroff>pour nous aider?\nMerci!")
          			goto flw_15
          		  case 1:
/*<124>*/ 			printf(/* textboxtype: 0, unk: 1, line: 28 */ "<0x10009:0x00030900>Tu es un humain... Vrrrm?\nComment es‐tu arrivé jusqu'ici?")
          			goto flw_125
          		}
          	}
          }
...
/*< 66>*/ 			switch (scene_flags[61 /* 0x6 20 */]) {
          			  case 0:
/*< 70>*/ 				printf(/* textboxtype: 0, unk: 1, line: 37 */ "<0x10012:0x00000001>Maître, la salle des machines est à présent\ncomplètement opérationnelle.\n\n\nJe vous conseille de rejoindre la cellule au plus vite\nen passant par la salle des machines pour aller\n<color green<libérer>coloroff> l'équipage.")
          			  case 1:
          				flw_69:
/*< 69>*/ 				printf(/* textboxtype: 1, unk: 0, line: 36 */ "<0x10012:0x00000001>Maître, comme l'avait dit le matelot, la salle\ndes machines est opérationnelle.\n\n\nMais enclencher un <color red<générateur>coloroff> ne suffit pas pour\nouvrir complètement le couloir qui mène à la cellule.\n\n\nJe vous conseille de vous rendre au second\n<color red<générateur >coloroff>au plus vite.")
          			}
          		  case 1:
...
/*< 77>*/ 	printf(/* textboxtype: 0, unk: 0, line: 41 */ "Ma mémoire indique que la <color blue<porte >coloroff>se trouve à\nl'endroit marqué d'une (X).")
...
/*< 95>*/ 	set_camera(9, 0)
/*< 93>*/ 	printf(/* textboxtype: 0, unk: 0, line: 47 */ "Je ressens une présence maléfique derrière\ncette porte.")
/*< 96>*/ 	set_camera(-1, 0)
...
/*< 86>*/ 	printf(/* textboxtype: 0, unk: 1, line: 49 */ "<0x10012:0x0000000b>Maître <heroname>, Fay au rapport.\nLa probabilité qu'il s'agisse d'un <color red<<sound 4>chronolithe\n>coloroff>est de 90 %.\n\nJe vous conseille de trouver un moyen de le <color green<frapper>coloroff>.\nIl est probable que cela provoque de grands\nchangements dans ce navire.")
...
/*<132>*/ 	printf(/* textboxtype: 0, unk: 2, line: 52 */ "<0x10012:0x0000000b>Maître, veuillez prendre connaissance de ces\ninformations pertinentes :\n\n\nConcernant le nouvel objet que vous avez obtenu,\nl'arc...\n\n\nLa tension de l'arc donne à vos flèches une grande\npuissance d'attaque et il vous permet d'<color green<atteindre\ndes cibles éloignées>coloroff>.\n\nSi vous voulez vérifier son mode de fonctionnement,\nappuyez sur <icon 19> après avoir sorti votre arc avec <icon 41>.<0x10011:0x0bcd><0x10011:0x0fcd>")
/*<164>*/ 	set_camera(19, 0)
...
/*<134>*/ 	set_camera(15, 0)
/*<131>*/ 	printf(/* textboxtype: 1, unk: 0, line: 51 */ "Il semble très difficile de l'atteindre d'ici.\nJe vous recommande de retourner sur le pont.")
