...
/*< 24>*/ 				switch (zone_temp_flags[1 /* 0x1 02 */]) {
          				  case 0:
/*< 32>*/ 					printf("Encore un tour? C'est 20 rubis!\n[1]C'est parti![2-]Non merci")
          					flw_2:
/*<  2>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_8:
...
/*< 14>*/ 											switch (story_flags[500 /* us: 805A9B12 0x04, jp: 805ACD92 0x04 */]) {
          											  case 0:
/*< 43>*/ 												printf("Pour l'instant, ton meilleur temps est\nde \x0E\x02\x03\x06\x00\x00\x2CD min <numeric arg1(2)> s <numeric arg2(2)>!")
          												goto flw_101
          											  case 1:
          												goto flw_101
          											}
...
/*< 59>*/ 								printf("En avant pour le parcours expert.\nEssaie de revenir avec tous tes morceaux!")
/*< 60>*/ 								story_flags[529 /* us: 805A9B14 0x40, jp: 805ACD94 0x40 */] = true;
          								goto flw_15
          							}
          						  case 1:
/*<103>*/ 							{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3333, 'next': 40, 'param3': 13}
/*< 40>*/ 							printf("T'as pas assez de rubis? Pas drôle, ça!\n\n\n\nVa donc te remplir les poches, et reviens\nme voir!")
          						}
          					  case 1:
/*<105>*/ 						{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3333, 'next': 34, 'param3': 13}
/*< 34>*/ 						printf("D'accord. À la prochaine!")
          					}
          				  case 1:
...
/*< 47>*/ 			printf("Tu as atteint l'arrivée!")
...
/*< 50>*/ 								printf("J'aurai toujours un wagonnet pour toi!")
...
/*< 52>*/ 							printf("Tu peux faire mieux, y a pas de doute.\nFais pencher ton wagonnet davantage!\n\n\nTiens, t'auras pas tout perdu!")
...
/*< 49>*/ 			printf("Tant pis. Tu reviendras une autre fois!")
...
/*< 28>*/ 			printf("J'aime bien les wagonnets. Ça serait bien\nde faire une course, un de ces jours!")
          		  case 1:
/*<116>*/ 			{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3330, 'next': 1, 'param3': 13}
/*<  1>*/ 			printf("Autrefois, ici, c'était la zone d'embarquement\ndes wagonnets de la mine. Et ils fonctionnent\ntoujours, c'est incroyable!\n\nSi tu grimpes là\x2010dedans, tu pourras faire le\ntour des îlots du coin! Il y a des instructions\nsur le mur qui te disent comment faire.\n\nMais attention, c'est un peu dangereux quand\nmême. Faut tout bien lire!")
...
/*< 91>*/ 		printf("Je suis ici tous les jours depuis si longtemps,\net il n'y a bien que toi pour venir me voir!\n\n\nSi tu pouvais en parler à d'autres gens, ça\nserait gentil... Je me sens un peu seul, ici.")
          		flw_98:
/*< 98>*/ 		story_flags[742 /* us: 805A9B26 0x40, jp: 805ACDA6 0x40 */] = true;
          	  case 1:
/*<120>*/ 		{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3334, 'next': 96, 'param3': 13}
/*< 96>*/ 		printf("Dis donc, c'est mon tabouret!\nLève tes fesses de là!")
          		goto flw_98
          	}
          }
