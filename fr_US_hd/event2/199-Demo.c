...
/*<  6>*/ 	start()
/*<  7>*/ 	printf("Mais qu'est-ce qui a bien pu lui arriver?\nIl s'est perdu dans les nuages?\nLe pauvre petit poulet...<pause1E>\n[1]Je vais\ngagner![2]Rends\x2010moi \nmon oiseau![3]Belle coupe!")
/*<  8>*/ 	{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': -1, 'param3': 37}
          }

          void entrypoint_199_02() {
/*<  3>*/ 	start()
/*<  4>*/ 	printf("Nous avons été témoins de quelque chose\nd'extraordinaire aujourd'hui. Mais, ce n'est\nque le début du périple. Mes espoirs reposent\nsur toi, Link!<pause1E>\n[1]Comptez\nsur moi![2]Pas\nquestion![3]C'est un lourd\nfardeau...")
...
/*<  9>*/ 	start()
/*< 10>*/ 	printf("\x0E\x01\x06\x02\xFECDTu...<pause0F> sais ce qui va se passer maintenant,\nn'est\x2010ce pas?<pause1E>\n[1]Non[2]J'ai peur...[3]Je crois")
