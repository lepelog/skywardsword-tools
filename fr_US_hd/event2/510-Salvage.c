...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x00000064>Mam'selle Fay! Tu m'attendais, bzzzt?\n\n\n\nOh, zrrrbt, c'est ça qu'il faut porter?")
          }

          void entrypoint_510_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "<0x10012:0x00000064>Bon, je l'emporte dans le ciel, venez vite me\nrejoindre! Vrrt!")
          }
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10012:0x00000064>Hé, le maître en vert, tu vois pas que t'es dans\nmes jambes? Tasse‐toi de là!")
          }
