          void entrypoint_451_01() {
          	start()
/*<  1>*/ 	printf("Cet objet pourrait être celui qu'a perdu l'homme\nde l'île fortune.\n\n\nJe peux appeler le robot de l'atelier de rénovation\npour qu'il vienne le récupérer.\nDois\x2010je appeler le robot?\n[1]S'il te plaît[2-]Non merci")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x05Très bien, Maître. J'appelle le robot par transmission\ntélépathique.")
          	  case 1:
/*<  4>*/ 		printf("\x0E\x01\x12\x04\x00\x05Très bien, Maître. Si vous voulez le récupérer,\nexaminez\x2010le à nouveau.")
          	}
          }

          void entrypoint_451_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf("\x0E\x01\x12\x04\x00dMam'selle Fay! zrrpt! Tu m'as appelé?\n\n\n\nC'est bizarre, zrrft... cet endroit me rend tout\nnostalgique... brrzrrt...\n\n\nBzzzt... Cette fois, c'est ça qu'il faut\ntransporter?")
          }

          void entrypoint_451_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf("\x0E\x01\x12\x04\x00dTrès bien, j'apporte ça dans le ciel.\nRejoignez\x2010moi vite! vrrt!!")
          }

          void entrypoint_451_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf("\x0E\x01\x12\x04\x00\x01Maître, je vous conseille de regagner le ciel pour\nremettre la roue de fortune à son propriétaire\nau plus vite.")
