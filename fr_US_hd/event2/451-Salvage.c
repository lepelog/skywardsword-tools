          void entrypoint_451_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0, line: 0 */ "Cet objet pourrait être celui qu'a perdu l'homme\nde l'île fortune.\n\n\nJe peux appeler le robot de l'atelier de rénovation\npour qu'il vienne le récupérer.\nDois‐je appeler le robot?\n[1-]S'il te plaît[2]Non merci")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  3>*/ 		printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x10012:0x00000005>Très bien, Maître. J'appelle le robot par transmission\ntélépathique.")
          	  case 1:
...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x00000064>Mam'selle Fay! zrrpt! Tu m'as appelé?\n\n\n\nC'est bizarre, zrrft... cet endroit me rend tout\nnostalgique... brrzrrt...\n\n\nBzzzt... Cette fois, c'est ça qu'il faut\ntransporter?")
          }
