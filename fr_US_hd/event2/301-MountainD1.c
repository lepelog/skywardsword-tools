...
/*<  1>*/ 	printf(/* textboxtype: 1, unk: 0, line: 0 */ "Wah! Y a des tonnes de monstres partout,\nj'peux même pas rejoindre mon ami!\nJ'aurais donc dû rester chez moi...")
...
/*<  3>*/ 	printf(/* textboxtype: 0, unk: 0, line: 2 */ "Dah! J'le trouve pas... J'ai dû le perdre en\nm'en venant ici.")
...
/*<102>*/ 	set_camera(16, 0)
/*<101>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "Je cherchais des trésors de l'autre côté de ces\nrochers, quand je suis tombé sur des monstres...<pause 15>\nJ'ai dû l'échapper <0x10009:0x0013100d>quand j'ai paniqué.")
/*<104>*/ 	set_camera(-1, 0)
/*<103>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10009:0x000908ff>Ce sac est super pratique! Il permet de ranger\ndes <color red<fleurs bombes >coloroff>et de les <color red<utiliser quand tu\nveux>coloroff>. Je ne peux pas m'en passer!\n\n<0x10009:0x00110dff>Veux-tu chercher mon <color yellow<sac de bombes>coloroff>?\nLes monstres ont dû le ramasser...<pause 10>\nTu vas aller me le chercher, hein?")
          }
...
/*< 34>*/ 	switch (choice(3)) {
          	  case 0:
/*< 35>*/ 		printf(/* textboxtype: 0, unk: 1, line: 10 */ "<0x10009:0x00131007>Sérieux? Pas moyen de se fier à personne\nde nos jours!\n\n\n<0x10009:0x00ff08ff>Bien, toi au moins tu t'es montré digne de\nconfiance. Tu as risqué ta vie pour te rendre\ndans ce guet‐apens...\n\n<0x10009:0x00141209>Tiens, je te le donne, mon sac!\nPrends‐le et fais‐en bon usage!")
          		flw_105:
...
/*< 10>*/ 	printf(/* textboxtype: 1, unk: 0, line: 14 */ "<0x10009:0x00110d12>Attends un peu! J'ai oublié de te dire...\n\n\n\n<0x10009:0x000908ff>Mon sac doit être vide. Laisse‐moi te donner\nun petit quelque chose.")
/*< 16>*/ 	give_item(40 0x28);
/*< 17>*/ 	printf(/* textboxtype: 1, unk: 0, line: 15 */ "Si tu commences à manquer de bombes, tu peux\nen ramasser d'autres et les ranger dans ton sac.\n\n\n<0x10009:0x0011080b>Pendant que tu portes une fleur bombe, tu peux\nla <color green<ranger dans ton sac >coloroff>en appuyant sur (B).\nNe l'oublie pas!<0x10011:0x01cd>\n\n<0x10009:0x000908ff>Ton sac peut contenir <color red<jusqu'à 10 bombes>coloroff>.\nRemplis‐le quand tu trouves des fleurs bombes!")
          }
...
/*<  8>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 0}) {
          	  case 0:
/*< 12>*/ 		printf(/* textboxtype: 0, unk: 1, line: 16 */ "<0x10009:0x00110d00>Rien à voir, mais... est‐ce que ça t'est déjà arrivé\nde prendre feu pendant que tu te battais avec\ndes monstres?\n\n<0x10009:0x000908ff>Si jamais ça t'arrive, faut penser à l'éteindre,\nhein! Et surtout, ne va pas sortir une <color yellow<bombe\n>coloroff>quand tu es en feu. Fais‐moi confiance\nlà‐dessus.")
          	  case 1:
/*< 99>*/ 		switch (scene_flags[1 /* 0x1 02 */]) {
          		  case 0:
/*<100>*/ 			printf(/* textboxtype: 0, unk: 0, line: 8 */ "<0x10009:0x00150809>Héhé, bien pensé! Tu as fait passer la <color yellow<fleur\nbombe >coloroff>en la faisant rouler... Tu te débrouilles\npas mal!\n\n<0x10009:0x00110800>T'es bien parti pour me retrouver mon <color yellow<sac\nde bombes>coloroff>! J'ai bon espoir.")
          		  case 1:
...
/*< 13>*/ 				printf(/* textboxtype: 0, unk: 1, line: 7 */ "Avec une bonne <color yellow<fleur bombe>coloroff>, tu devrais pouvoir\nréduire ces rochers en poussière! Regarde\nautour si tu peux en trouver.")
          			  case 1:
/*< 97>*/ 				printf(/* textboxtype: 1, unk: 1, line: 6 */ "Ah, oui, en fait... <pause 15>Tu peux pas creuser sous la\nterre, toi, hein? Donc tu peux pas retourner de\nl'autre côté. Hmm.\n\n<0x10009:0x0015120c>J'ai une idée. Tu devrais pouvoir faire sauter\nces rochers avec une <color yellow<fleur bombe>coloroff>.\n\n\n<0x10009:0x0009ff00>Regarde autour si tu peux en trouver!")
...
/*< 70>*/ 	wait_frames(10)
/*< 51>*/ 	set_camera(2, 0)
/*< 40>*/ 	printf(/* textboxtype: 0, unk: 1, line: 22 */ "<0x10009:0x0d0805ff>Tiens, tiens... Encore toi.")
/*< 79>*/ 	set_camera(10, 0)
/*< 78>*/ 	printf(/* textboxtype: 0, unk: 0, line: 23 */ "<0x10009:0x0d0005ff>Oh<pause 1>.<pause 1>.<pause 1>.<pause 1><pause 8> La mémoire me fait défaut...\n<pause 20>Ton nom m'est complètement sorti de la tête...\n\n\n<0x10009:0x0d0a05ff>À vrai dire, cela n'a aucune espèce\nd'importance. Je suis quelque peu... froissé,\nvois‐tu... Tu tombes bien.")
/*< 73>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3339, 'param2': 3327, 'next': 72, 'param3': 13}
/*< 72>*/ 	set_camera(6, 0)
/*< 58>*/ 	printf(/* textboxtype: 1, unk: 0, line: 24 */ "<0x10009:0x0d000900>Alors que mes acolytes viennent de mettre la\nmain sur la prêtresse, je me rends sur les lieux\nle cœur léger... Et qu'est‐ce que j'apprends?\n\n<0x10009:0x0d000cff>Que cette importune servante de la Déesse...")
...
/*< 63>*/ 	printf(/* textboxtype: 2, unk: 0, line: 27 */ "<0x10008:0x01cd>J'ai besoin de la prêtresse pour\nramener mon maître à la vie!\nIL ME LA FAUT!")
/*< 77>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3335, 'param2': 1535, 'next': 76, 'param3': 13}
/*< 76>*/ 	set_camera(9, 0)
/*< 64>*/ 	printf(/* textboxtype: 0, unk: 2, line: 28 */ "<pause 5>.<pause 5>.<pause 5>.<pause 5>\n<pause 10>Mais je m'emporte.\nJe te demande pardon.\n\n<0x10009:0x0d0805ff>Tu vois maintenant pourquoi je dois me\ndéfouler un peu avant de partir d'ici.")
/*< 67>*/ 	set_camera(3, 0)
/*< 61>*/ 	printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10009:0x0d0a05ff>En fait, tu vas pouvoir m'aider...<pause 20> Tu...<pause 20> vas...<pause 20>")
/*< 71>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3335, 'param2': 1535, 'next': 68, 'param3': 13}
/*< 68>*/ 	set_camera(4, 0)
/*< 62>*/ 	printf(/* textboxtype: 2, unk: 0, line: 30 */ "... subir mon excès de rage!")
...
/*< 41>*/ 	start()
/*< 42>*/ 	printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10012:0x0000000b>Maître, veuillez prendre connaissance de ces\ninformations pertinentes :\n\n\nL'aura de dame Zelda est dans les environs.")
/*< 44>*/ 	set_camera(1, 0)
