...
/*<  6>*/ 	start()
/*<  7>*/ 	printf("Selon nos expériences antérieures, la <y<clé >>dont il est\nfait mention ici est celle qui ouvre le mécanisme\ndevant nous.")
          }
...
/*< 19>*/ 	set_camera(3, 0)
/*< 16>*/ 	printf("J'ai besoin de temps pour trouver le moyen\nde rappeler mon maître à la vie.<pause05>.<pause05>.")
/*< 20>*/ 	set_camera(4, 0)
