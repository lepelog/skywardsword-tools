...
/*< 36>*/ 	set_camera(2, 0)
/*< 23>*/ 	printf(/* textboxtype: 0, unk: 7, line: 10 */ "Pour arriver jusqu'à cet emblème, je vous\nrecommande de franchir cette porte.")
/*< 54>*/ 	set_camera(-1, 0)
          }
...
/*< 33>*/ 	switch (scene_flags[122 /* 0xE 04 */]) {
          	  case 0:
/*< 21>*/ 		printf(/* textboxtype: 0, unk: 2, line: 19 */ "<0x10012:0x0000000b>Maître, veuillez prendre connaissance de ces\ninformations pertinentes :\n\n\nNous sommes revenus dans la salle où se trouve\nl'<color red<emblème de Din>coloroff>.")
          		flw_39:
/*< 39>*/ 		set_camera(6, 0)
/*< 34>*/ 		printf(/* textboxtype: 0, unk: 0, line: 20 */ "La probabilité que vous trouviez la force sacrée\nau bout de ce parcours de lave est de 60 %.")
/*< 41>*/ 		set_camera(-1, 0)
...
/*< 44>*/ 	start()
/*< 49>*/ 	set_camera(7, 0)
/*< 43>*/ 	printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10012:0x0000000b>Maître <heroname>, veuillez prendre\nconnaissance de ces informations pertinentes :\n\n\nVous êtes arrivé jusqu'à l'emblème. Plantez‐y votre\népée. Vous devriez alors être conduit vers la <color yellow white<Triforce>coloroff>.")
          }

          void entrypoint_125_12() {
/*< 46>*/ 	start()
/*< 50>*/ 	set_camera(8, 0)
/*< 45>*/ 	printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10012:0x0000000b>Maître <heroname>, veuillez prendre\nconnaissance de ces informations pertinentes :\n\n\nVous êtes arrivé jusqu'à l'emblème. Plantez‐y votre\népée. Vous devriez alors être conduit vers la <color yellow white<Triforce>coloroff>.")
          }

          void entrypoint_125_13() {
/*< 48>*/ 	start()
/*< 51>*/ 	set_camera(9, 0)
/*< 47>*/ 	printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10012:0x0000000b>Maître <heroname>, veuillez prendre\nconnaissance de ces informations pertinentes :\n\n\nVous êtes arrivé jusqu'à l'emblème. Plantez‐y votre\népée. Vous devriez alors être conduit vers la <color yellow white<Triforce>coloroff>.")
          }
...
/*<  3>*/ 		printf(/* textboxtype: 1, unk: 0, line: 3 */ "<0x10012:0x0000000b>Maître, veuillez prendre connaissance de ces\ninformations pertinentes :\n\n\nCes secousses semblent être la manifestation d'un\n<color red<<sound 4>changement de structure >coloroff>du bâtiment.")
/*<  4>*/ 		{'type': 'type3', 'subType': 4, 'param1': 0, 'param2': 0, 'next': 55, 'param3': 30}
/*< 55>*/ 		switch (scene_flags[13 /* 0x0 20 */]) {
          		  case 0:
/*< 10>*/ 			printf(/* textboxtype: 0, unk: 2, line: 4 */ "Le changement va vous permettre d'entrer dans la\nsalle voisine.")
          			flw_5:
