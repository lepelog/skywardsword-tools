...
/*< 22>*/ 		switch (choice(2)) {
          		  case 0:
/*< 24>*/ 			printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x10012:0x00000005>Très bien, Maître. Je l'appelle immédiatement par\ntransmission télépathique.")
          		  case 1:
/*< 23>*/ 			printf(/* textboxtype: 0, unk: 2, line: 1 */ "<0x10012:0x00000005>Très bien, Maître. Examinez‐le à nouveau si\nvous changez d'avis.")
          		}
          	  case 1:
/*< 15>*/ 		printf(/* textboxtype: 0, unk: 2, line: 7 */ "<0x10009:0x00000009>Oh, ça fait plaisir de te revoir!\nMerci pour l'autre fois!\n\n\nJ'recherche de nouveaux trésors depuis un\nmoment, mais j'trouve pas grand‐chose...\n\n\nEt j'commence à en avoir assez de traîner ici.\nOn crève!\n\n\n<0x10009:0x00000005>Faudrait que j'aille ailleurs... quelque part de\nplus frais. Je devrais joindre l'utile à l'agréable\ntout en mettant à profit mes atouts.\n\nOu que j'me trouve un travail plus pépère,\nfinalement!\n[1-]J'ai une idée![2-]Rêve\ntoujours!")
/*< 16>*/ 		switch (choice(2)) {
          		  case 0:
/*< 17>*/ 			printf(/* textboxtype: 0, unk: 0, line: 8 */ "<0x10009:0x00000004>Quoi? Tu veux dire qu'il y aurait une place\npour moi dans le ciel?\n\n\nLe travail idéal, qui me permettrait d'exploiter\nau maximum mes divers talents?\n\n\nOooh! J'y vais! J'mets les voiles!<pause 10>\nJe décolle!<pause 10> Emmène‐moi avec toi!")
          			goto flw_19
          		  case 1:
/*< 18>*/ 			printf(/* textboxtype: 1, unk: 0, line: 9 */ "<0x10009:0x00000008>Ouais...<pause 10> T'as peut‐être raison...\nJe devrais rester encore un peu ici...")
          		}
          	}
          }
...
/*< 25>*/ 	start()
/*< 26>*/ 	printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10012:0x00000001>Maître, retournons dans le ciel et emmenons\nle Mogma là où il est attendu.")
...
/*< 30>*/ 	start()
/*< 31>*/ 	printf(/* textboxtype: 0, unk: 1, line: 13 */ "<0x10012:0x00000064>T'as pas besoin de toujours me répéter\nla même chose! Brrrzt!")
          }

          void entrypoint_351_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0, line: 0 */ "Vous avez découvert un cristal très similaire à la\nboule de cristal du voyant, et qui pourrait être\nutilisé comme telle.\n\nDois‐je appeler le robot afin de le transporter?\n[1-]Oui[2]Non")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x10012:0x00000005>Très bien, Maître. Je l'appelle immédiatement par\ntransmission télépathique.")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 0, unk: 2, line: 1 */ "<0x10012:0x00000005>Très bien, Maître. Examinez‐le à nouveau si\nvous changez d'avis.")
          	}
          }

          void entrypoint_351_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x00000064>Mam'selle Fay! Je suis de retour, zrrpt!\n\n\n\nAh, c'est ça que je dois porter, bzzt?")
          }

          void entrypoint_351_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "Bon, je vous attends dans le ciel, alors ne\ntardez pas trop! Vrrrt!")
          }

          void entrypoint_351_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10012:0x00000001>Maître, retournons dans le ciel et rapportons la\nboule de cristal.")
