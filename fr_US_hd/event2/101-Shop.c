...
/*<110>*/ 				printf("\x0E\x01\x09\x04\x00\x01<r<Nouvel arrivage>> aujourd'hui! Rien que pour toi!\n\n\n\nL'accessoire indispensable de tout archer qui se\nrespecte, le <y<petit carquois>>!\n\n\nRegarde\x2010moi ça!")
...
/*<107>*/ 					printf("\x0E\x01\x09\x04\x00\x01<r<Nouvel arrivage>> aujourd'hui! Rien que pour toi!\n\n\n\nLe mystérieux, l'incomparable <y<bouclier sacré\n>>enfin sur le marché!\n\n\nContemple\x2010le, oh oui, contemple!")
...
/*<104>*/ 						printf("\x0E\x01\x09\x04\x00\x01<r<Nouvel arrivage>> aujourd'hui! Rien que pour toi!\n\n\n\nObserve bien la qualité de ce <y<petit sac de\nbombes>>, un pur joyau!")
...
/*< 73>*/ 		printf("\x0E\x01\x09\x04\x00\x02Voilà un <y<petit sac de graines>>! Avec cela, tu\npeux stocker 10 graines Mojo supplémentaires.\n\n\nL'accessoire indispensable à tous les adeptes\ndu lance\x2010pierre!\n\n\nIl coûte <r<100 rubis>>. Une bagatelle!\n[1]J'achète[2-]Non merci")
          		goto flw_33
          	  case 1:
/*< 82>*/ 		printf("Je regrette de constater que tu n'as pas de\nlance\x2010pierre. Je ne peux  donc pas te vendre\ncet article...\n\nMais tu trouveras ton bonheur parmi mes\nautres articles, j'en suis sûr! Encore désolé,\ntoutes mes excuses!")
          	}
          }
...
/*< 18>*/ 	printf("\x0E\x01\x09\x04\x00\x08Oh, là!\x0E\x01\x05\x04\n\x00")
/*< 60>*/ 	{'type': 'type3', 'subType': 4, 'param1': 6, 'param2': 512, 'next': 61, 'param3': 22}
/*< 61>*/ 	printf("Quel petit rigolo tu es, toi! Tu n'as pas assez de\nrubis pour acheter cet article, voyons! Haha!")
...
/*<133>*/ 						story_flags[809 /* us: 805A9B31 0x02, jp: 805ACDB1 0x02 */] = true;
          			  ...
          			  case 1:
/*< 89>*/ 				printf("Je me suis permis de placer cet objet dans ta\nsacoche. Pour ouvrir ta sacoche, maintiens\n\x0E\x02\x04\x02\x28CD enfoncé...\x0E\x01\x11\x02\xECD\n\n... et une fois l'objet sélectionné, <g<relâche >>\x0E\x02\x04\x02\x28CD\npour pouvoir l'utiliser.\x0E\x01\x11\x02\xECD C'est aussi simple que ça.\n\n\nEt ça vaut aussi pour les boucliers!")
...
/*<136>*/ 				zone_temp_flags[5 /* 0x1 20 */] = false;
          	  ...
          	  case 1:
/*< 42>*/ 		printf("\x0E\x01\x09\x04\x00\x07Aaah... C'est toujours un plaisir de faire affaire\navec toi!")
          		goto flw_144
          	}
          }
...
/*< 30>*/ 	printf("Aucun problème, aucun problème! J'ai de\nnombreux autres articles en rayon, prends\nton temps!")
