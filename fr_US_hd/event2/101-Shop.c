...
/*< 50>*/ 	printf(/* textboxtype: 1, unk: 0, line: 33 */ "<0x10009:0x00000002>Ah, je vois que ce <color yellow<bouclier de fer >coloroff>t'intéresse!\nIl est plus résistant que le bouclier de bois,\nc'est certain!\n\nDe plus, il résiste au feu! Par contre, il est\nsensible à l'électricité.\n\n\n<color red<100 rubis>coloroff> et il est à toi.\n[1-]J'achète[2]Non merci")
...
/*<140>*/ 				zone_temp_flags[1 /* 0x1 02 */] = true;
          		  ...
          		  case 1:
/*<  3>*/ 			printf(/* textboxtype: 0, unk: 1, line: 1 */ "<0x10009:0x00000007>Oh, je vois, tu es si intelligent! Tu connais ça,\ntoi! Même pas besoin de te renseigner!\n\n\nRegarde autour, alors. Prends tout ton temps et\nadmire tout ce que j'ai à ta disposition.")
...
/*<110>*/ 				printf(/* textboxtype: 1, unk: 0, line: 9 */ "<0x10009:0x00000001><color red<Nouvel arrivage>coloroff> aujourd'hui! Rien que pour toi!\n\n\n\nL'accessoire indispensable de tout archer qui se\nrespecte, le <color yellow<petit carquois>coloroff>!\n\n\nRegarde‐moi ça!")
...
/*<107>*/ 					printf(/* textboxtype: 0, unk: 0, line: 8 */ "<0x10009:0x00000001><color red<Nouvel arrivage>coloroff> aujourd'hui! Rien que pour toi!\n\n\n\nLe mystérieux, l'incomparable <color yellow<bouclier sacré\n>coloroff>enfin sur le marché!\n\n\nContemple‐le, oh oui, contemple!")
...
/*<104>*/ 						printf(/* textboxtype: 0, unk: 1, line: 7 */ "<0x10009:0x00000001><color red<Nouvel arrivage>coloroff> aujourd'hui! Rien que pour toi!\n\n\n\nObserve bien la qualité de ce <color yellow<petit sac de\nbombes>coloroff>, un pur joyau!")
...
/*< 84>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 22}) {
          	  case 0:
/*< 76>*/ 		printf(/* textboxtype: 0, unk: 0, line: 38 */ "<0x10009:0x00000002>Voilà un <color yellow<petit carquois>coloroff>! Tu peux y stocker\n5 flèches supplémentaires.\n\n\nL'accessoire indispensable à tous les archers qui\nsouhaitent pouvoir tirer sans retenue!\n\n\nIl coûte <color red<150 rubis>coloroff>. Presque rien, finalement!\n[1-]J'achète[2]Non merci")
          		goto flw_33
          	  case 1:
...
/*< 86>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 24}) {
          	  case 0:
/*< 79>*/ 		printf(/* textboxtype: 1, unk: 0, line: 39 */ "<0x10009:0x00000002>Voilà un <color yellow<petit sac de bombes>coloroff>! Tu peux y stocker\n5 bombes supplémentaires.\n\n\nL'accessoire indispensable pour satisfaire toutes\ntes pulsions destructrices!\n\n\nIl coûte <color red<150 rubis>coloroff>. Un investissement de choix!\n[1-]J'achète[2]Non merci")
          		goto flw_33
          	  case 1:
...
/*< 18>*/ 	printf(/* textboxtype: 0, unk: 0, line: 17 */ "<0x10009:0x00000008>Oh, là!<0x10005:0x000a0000>")
/*< 60>*/ 	{'type': 'type3', 'subType': 4, 'param1': 6, 'param2': 512, 'next': 61, 'param3': 22}
/*< 61>*/ 	printf(/* textboxtype: 1, unk: 0, line: 18 */ "Quel petit rigolo tu es, toi! Tu n'as pas assez de\nrubis pour acheter cet article, voyons! Haha!")
...
/*<132>*/ 				switch (story_flags[809 /* us: 805A9B31 0x02, jp: 805ACDB1 0x02 */]) {
          				  case 0:
          					flw_70:
/*< 70>*/ 					printf(/* textboxtype: 1, unk: 0, line: 21 */ "Je me suis permis de placer cet objet dans ta\nsacoche. Pour <color red<équiper>coloroff> un objet, appuie sur <color green<<icon 40>\n>coloroff>et sélectionne celui que tu veux.<0x10011:0x0ecd>")
          					flw_137:
/*<137>*/ 					zone_temp_flags[5 /* 0x1 20 */] = false;
          				  case 1:
/*<134>*/ 					switch (story_flags[87 /* us: 805A9AEC 0x02, jp: 805ACD6C 0x02 */]) {
          					  case 0:
/*<135>*/ 						printf(/* textboxtype: 0, unk: 0, line: 23 */ "Si <color red<ton bouclier est endommagé>coloroff>, je te conseille\nd'aller faire un tour chez Gondo, à l'<color red<atelier\nde rénovation>coloroff>.\n\nSi tu lui fournis des trésors, il pourra améliorer\nton bouclier et des tas d'autres objets.")
/*<133>*/ 						story_flags[809 /* us: 805A9B31 0x02, jp: 805ACDB1 0x02 */] = true;
          			  ...
          			  case 1:
/*< 89>*/ 				printf(/* textboxtype: 0, unk: 1, line: 22 */ "Je me suis permis de placer cet objet dans ta\nsacoche. Pour ouvrir ta sacoche, maintiens\n<icon 40> enfoncé...<0x10011:0x0ecd>\n\n... et une fois l'objet sélectionné, <color green<relâche >coloroff><icon 40>\npour pouvoir l'utiliser.<0x10011:0x0ecd> C'est aussi simple que ça.\n\n\nEt ça vaut aussi pour les boucliers!")
...
/*<136>*/ 				zone_temp_flags[5 /* 0x1 20 */] = false;
          	  ...
          	  case 1:
/*< 42>*/ 		printf(/* textboxtype: 0, unk: 0, line: 20 */ "<0x10009:0x00000007>Aaah... C'est toujours un plaisir de faire affaire\navec toi!")
          		goto flw_144
          	}
          }
...
/*< 30>*/ 	printf(/* textboxtype: 1, unk: 0, line: 24 */ "Aucun problème, aucun problème! J'ai de\nnombreux autres articles en rayon, prends\nton temps!")
