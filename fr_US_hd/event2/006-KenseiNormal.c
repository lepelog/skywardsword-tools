...
/*< 49>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, veuillez prendre\nconnaissance de ces informations pertinentes :\n\n\nJe confirme que l'entrée d'une épreuve\nse trouve dans les alentours.\n\n\nUne fois que vous aurez <r<détecté >>son emplacement,\nle <b<Courage de Farore >>que vous avez appris sur\nl'île aux chants vous guidera.")
