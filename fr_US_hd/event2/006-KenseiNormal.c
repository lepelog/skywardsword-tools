...
/*< 49>*/ 	printf(/* textboxtype: 2, unk: 0, line: 15 */ "<0x10012:0x0000000b>Maître <heroname>, veuillez prendre\nconnaissance de ces informations pertinentes :\n\n\nJe confirme que l'entrée d'une épreuve\nse trouve dans les alentours.\n\n\nUne fois que vous aurez <color red<détecté >coloroff>son emplacement,\nle <color blue<Courage de Farore >coloroff>que vous avez appris sur\nl'île aux chants vous guidera.")
