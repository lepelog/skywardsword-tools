...
/*<170>*/ 	switch (story_flags[84 /* us: 805A9AE8 0x01, jp: 805ACD68 0x01 */]) {
          	  case 0:
/*<171>*/ 		printf(/* textboxtype: 0, unk: 1, line: 16 */ "<0x10009:0x001b0a0d>Maaan... Why can't I just do one thing\nright?! What a lunkhead!")
          	  case 1:
/*< 87>*/ 		switch (zone_temp_flags[1 /* 0x1 02 */]) {
          		  case 0:
/*< 86>*/ 			printf(/* textboxtype: 0, unk: 0, line: 14 */ "<0x10009:0x001b0a0e>...Did you already figure out where\nthe treasure was from that map?")
          		  case 1:
...
/*< 70>*/ 	start()
/*< 71>*/ 	printf(/* textboxtype: 0, unk: 0, line: 56 */ "<0x10006:0xfdcd>...Enough of this foolishness...\nI am Ghirahim, Demon Lord!")
          }
...
/*< 81>*/ 		printf(/* textboxtype: 0, unk: 0, line: 23 */ "<0x10009:0x331b0502>Right, then—I'm outta here!\nSo long!")
          	  case 1:
/*< 15>*/ 		printf(/* textboxtype: 0, unk: 1, line: 22 */ "<0x10009:0x330b0208>Oh yaaah! I'm saved!\n\n\n\n<0x10009:0x00080aff>I don't know who ya are or where\nyou're from, but I owe ya big-time!\n\n\nAre ya here looking for treasure too?\n[1-]Yep![2-]Treasure?")
/*< 16>*/ 		switch (choice(2)) {
          		  case 0:
/*<119>*/ 			printf(/* textboxtype: 0, unk: 1, line: 25 */ "<0x10009:0x00080509>Ha ha! You were totally caught up in\nthat too, pal!")
          			flw_17:
...
/*< 29>*/ 			scene_flags[15 'Eldin: Fire Sanctuary'][101 /* 0xD 20 */] = true;
          		  case 1:
/*<120>*/ 			printf(/* textboxtype: 0, unk: 62, line: 26 */ "<0x10009:0x00080509>Well, well! No point trying to hide it!\nThere's only one reason you could have\nfor coming so far in here!")
          			goto flw_17
          		}
          	}
          }
...
/*<132>*/ 		switch (scene_flags[119 /* 0xF 80 */]) {
          		  case 0:
/*<133>*/ 			printf(/* textboxtype: 0, unk: 0, line: 35 */ "<0x10009:0x001b1a15>Wow, you just took down the wall!\nYou got some starch in your socks,\npal!")
          		  case 1:
...
/*< 39>*/ 	switch (scene_flags[105 /* 0xC 02 */]) {
          	  case 0:
/*<151>*/ 		set_camera(2, 0)
/*<149>*/ 		printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10009:0x00111213>Hey! Hey! Come on, pal! Please help\nme! Get me offa this chain!\n\n\n<0x10009:0x00161614>I got a hot tip just for you if you help\nme out! ")
...
/*<143>*/ 			switch (choice(2)) {
          			  case 0:
/*<147>*/ 				printf(/* textboxtype: 0, unk: 1, line: 10 */ "<0x10009:0x331b2200>All right, then! Go ahead and open\n'er up! But don't forget our deal!")
          				flw_123:
...
/*< 24>*/ 			zone_temp_flags[0 /* 0x1 01 */] = true;
          	  ...
          	  case 1:
/*< 19>*/ 		printf(/* textboxtype: 0, unk: 0, line: 38 */ "<0x10009:0x331a1a0b>Ahhh! So busy, so busy... Burning the\nmidnight oil again looking for loot!")
