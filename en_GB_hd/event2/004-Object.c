...
/*< 58>*/ 	switch (story_flags[19 /* us: 805A9ADB 0x08, jp: 805ACD5B 0x08 */]) {
          	  case 0:
/*< 56>*/ 		printf(/* textboxtype: 0, unk: 0, line: 17 */ "Deep underground, below this volcano,\nyou'll find treasure-loving <color blue<Mogmas>coloroff>.\n\n\nThese days, most of them are content\nwith staying down in their lair, where\nthey do nothing but relax all day.")
          	  case 1:
          		flw_59:
/*< 59>*/ 		printf(/* textboxtype: 0, unk: 1, line: 19 */ "A <color red<dragon>coloroff> is said to live at the <color red<peak >coloroff>of\nthis volcano. You're nowhere near the\npeak, though!")
/*< 60>*/ 		printf(/* textboxtype: 1, unk: 0, line: 18 */ "Do you want to hear that again?\n[1-]Yes.[2]No.")
/*< 62>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_59
          		  case 1:
/*< 61>*/ 			printf(/* textboxtype: 0, unk: 0, line: 20 */ "Rumor has it you're some kind of\ngenius that remembers things perfectly\nthe first time you hear them...")
          		}
          	}
          }
...
/*< 13>*/ 		switch (is_item_check_full()) {
          		  case 0:
/*< 11>*/ 			printf(/* textboxtype: 9, unk: 2, line: 9 */ "Your pouch is full, but so is your space at\nthe <color red<Item Check>coloroff>. The item has been put\nback in the treasure chest.")
          		  case 1:
/*< 10>*/ 			printf(/* textboxtype: 2, unk: 0, line: 8 */ "Your pouch is full, so the item was sent to\nthe <color red<Item Check>coloroff>!")
          		}
          	  case 1:
          	}
          }
...
/*< 30>*/ 		printf(/* textboxtype: 1, unk: 0, line: 21 */ "I hear the <color red<dragon>coloroff> that lives at the\ntop of the volcano is awfully chatty.\n\n\nSo chatty, they say, that he's even\nwilling to talk about matters outside\nhis own realm!")
          	  case 1:
          		flw_52:
/*< 52>*/ 		printf(/* textboxtype: 0, unk: 1, line: 22 */ "The word going around is that a <color red<dragon>coloroff>\nwrapped in flames lives atop this\nvolcano.\n\nThe thing is, it isn't so easy to visit.\nHe's made his lair <color red<somewhere so hot\n>coloroff>that normal folks can't bother him.")
/*< 53>*/ 		printf(/* textboxtype: 1, unk: 0, line: 18 */ "Do you want to hear that again?\n[1-]Yes.[2]No.")
/*< 55>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_52
          		  case 1:
/*< 54>*/ 			printf(/* textboxtype: 0, unk: 0, line: 20 */ "Rumor has it you're some kind of\ngenius that remembers things perfectly\nthe first time you hear them...")
          		}
          	}
          }
...
/*< 14>*/ 	start()
/*< 15>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "Hey! <0x30001:0x><heroname>! You're not\nthinking of running away, are you?\n\n\nHah! Surely you jest! A real man\nalways finishes what he starts!")
          }

          void entrypoint_004_109() {
/*< 33>*/ 	start()
/*< 32>*/ 	printf(/* textboxtype: 0, unk: 0, line: 23 */ "Word is you can earn a <color red<Piece of Heart>coloroff>\nif you set a great time on the <color blue<Rickety\nCoaster>coloroff>.")
          }

          void entrypoint_004_016() {
/*< 48>*/ 	start()
/*< 49>*/ 	printf(/* textboxtype: 0, unk: 1, line: 34 */ "<0x1000F:0x>How long do you want to sleep?\n[1-]Until morning.[2-]Until night.[3]Don't sleep.")
/*< 50>*/ 	switch (choice(3)) {
          	  case 0:
          	  case 1:
          	  case 2:
...
/*< 65>*/ 	start()
/*< 66>*/ 	printf(/* textboxtype: 0, unk: 0, line: 35 */ "Descend into this area?\n[1-]Yes.[2]No.")
/*< 67>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
...
/*<  1>*/ 	start()
/*<  3>*/ 	printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x1000F:0x>The sign is broken. It's not\npossible to read it.")
          }

          void entrypoint_004_113() {
/*< 41>*/ 	start()
/*< 40>*/ 	printf(/* textboxtype: 1, unk: 1, line: 27 */ "Apparently, if you draw a symbol of\nmoney on certain walls, you can make\nan easy fortune.")
          }
...
/*< 46>*/ 	start()
/*< 47>*/ 	printf(/* textboxtype: 0, unk: 9, line: 1 */ "<0x1000F:0x>The door is sealed shut.")
          }

          void entrypoint_004_116() {
/*< 63>*/ 	start()
/*< 64>*/ 	printf(/* textboxtype: 1, unk: 1, line: 30 */ "They say it's possible to summon\n<color yellow<Fairies>coloroff> by drawing three triangles\nupon certain walls.")
          }

          void entrypoint_004_117() {
/*< 75>*/ 	start()
/*< 76>*/ 	printf(/* textboxtype: 0, unk: 1, line: 31 */ "Rumor has it there's a <color yellow<Piece of Heart\n>coloroff>hidden somewhere nearby.")
/*< 77>*/ 	switch (scene_flags[104 /* 0xC 01 */]) {
          	  case 0:
/*< 78>*/ 		printf(/* textboxtype: 1, unk: 0, line: 33 */ "Oh, but since you've already picked it\nup, this obviously doesn't come as a\nbig surprise to you. Hmph.")
          	  case 1:
/*< 79>*/ 		printf(/* textboxtype: 0, unk: 0, line: 32 */ "The thing is, to get to it you need to be\nable to burrow like a <color blue<Mogma>coloroff>.")
          	}
          }
...
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 0, unk: 9, line: 4 */ "Do you want to leave this\nSilent Realm?\n[1-]Leave.[2]Stay.")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
...
/*< 27>*/ 	start()
/*< 42>*/ 	printf(/* textboxtype: 0, unk: 1, line: 28 */ "They say drawing a symbol of love upon\ncertain walls will heal your wounds.")
          }
