...
/*<350>*/ 		switch (zone_temp_flags[3 /* 0x1 08 */]) {
          		  case 0:
/*<351>*/ 			printf("\x0E\x01\x09\x04\x11\x1153Oh no. You've done it now!\nThere's no escaping this one!")
          		  case 1:
          			flw_493:
...
/*<292>*/ 	start()
/*<176>*/ 	printf("\x0E\x01\x09\x04\x07\x803I am so grateful that you brought \nthis lovely guy to help me!\n\n\nI'm going to ask him to help with all\nkinds of things! \x0E\x01\x09\x04\x13\x800Thank<pause05> you<pause05> very,<pause05> very,<pause05>\nvery <pause05>much!")
...
/*<107>*/ 	start()
/*<108>*/ 	printf("\x0E\x01\x09\x04\x00\x08Hooo yeah! I'm gonna show you how\nit's done!")
          }
...
/*<142>*/ 	printf("\x0E\x01\x09\x04\x07\x701Hey, so I guess he's going to be helping\nwith the pumpkin patch!")
/*<127>*/ 	{'type': 'type3', 'subType': 1, 'param1': 27, 'param2': 0, 'next': 122, 'param3': 16}
/*<122>*/ 	printf("\x0E\x01\x09\x04\x1B09\x702Seriously! I could plow the patch\nmuch faster than that mole guy out\nthere!")
...
/*<123>*/ 	printf("\x0E\x01\x09\x04\x00\x08What? Seriously? I'm so happy!")
...
/*<124>*/ 	printf("\x0E\x01\x09\x04\x1B07\x705Hahaha! For Kina, I'd do anything!\nWhether that's on a pumpkin patch\nor inside a burning house!")
...
/*<125>*/ 	printf("\x0E\x01\x09\x04\x1A00\x09Hehe! Well then I look forward to\ngetting your help out there!")
...
/*<144>*/ 	printf("You're all so sweet!\x0E\x01\x09\x04\x07\x703")
          }

          void entrypoint_117_08() {
/*<283>*/ 	start()
/*<165>*/ 	printf("\x0E\x01\x09\x04\x00\x09Yay! You found someone, didn't you?!")
/*<167>*/ 	printf("\x0E\x01\x09\x04\x01\x705Wait a second... This isn't a person...\n\n\n\n\x0E\x01\x09\x04\x07\x700Ah, so you're saying that this mole\nis going to plow the patch for me?")
          }
...
/*<200>*/ 			switch (zone_temp_flags[2 /* 0x1 04 */]) {
          			  case 0:
/*<201>*/ 				printf("\x0E\x01\x09\x04\x07\x703Great! Glad to have you. I know you're\nthe guy for the job!\n[1]Let's do it![2-]Never mind.")
/*<202>*/ 				switch (choice(2)) {
          				  case 0:
/*<515>*/ 					printf("\x0E\x01\x09\x04\x13\x809I knew you wouldn't let me down!\x0E\x01\x05\x04\x1E\x00")
          					flw_87:
/*< 87>*/ 					printf("\x0E\x01\x09\x04\x07\x700The trick to carrying several pumpkins\nat once is <r<to walk slowly>>!\n\n\nIf they start to lean right, move right. \nIf they start to lean left, move left. \nTake your time, and keep your balance!\n\n\x0E\x01\x09\x04\x01\x700But if you panic and start to rush,\nwell, you're going to drop them.\n<pause14>So... Good luck!")
...
/*<513>*/ 						switch (random(2)) {
          						  case 0:
/*<395>*/ 							printf("\x0E\x01\x09\x04\x01\x1606Really?! I thought for sure you'd be\nwilling to lend a hand.")
          						  case 1:
/*<514>*/ 							printf("\x0E\x01\x09\x04\x01\x1611Ugh... Are you always this boring?")
          						}
          					  case 1:
/*<  5>*/ 						printf("\x0E\x01\x09\x04\x01\x1606Really?! I'm telling Father about this!")
          					}
          				}
          			  case 1:
/*<499>*/ 				switch (temp_flags[16 /* 0x3 01 */]) {
          				  case 0:
/*<500>*/ 					printf("\x0E\x01\x09\x04\x07\x808I hope I can count on you when it comes\ntime to harvest the pumpkins again.\n\x0E\x01\x06\x02\xFBCDYou\x0E\x01\x06\x02Í strong\x0E\x01\x06\x02Í knight, you!")
          				  case 1:
/*<508>*/ 					switch (story_flags[472 /* us: 805A9B0E 0x10, jp: 805ACD8E 0x10 */]) {
          					  case 0:
/*<509>*/ 						printf("\x0E\x01\x09\x04\x01\x700Oh! Perfect timing! How do you\nfeel about breaking a sweat with some\nhonest work?\n\n\x0E\x01\x09\x04\x07\x700Think you can help carry pumpkins\nto the storage shed? I'll pay you.\n[1]Sure![2-]No, thanks.")
          						flw_3:
/*<  3>*/ 						switch (choice(2)) {
          						  case 0:
/*<  4>*/ 							printf("\x0E\x01\x09\x04\x07\x703OK, then! I'll show you where you\nneed to carry the pumpkins!")
/*< 88>*/ 							set_camera(1, 0)
...
/*<390>*/ 			printf("\x0E\x01\x09\x04\x13\x809I knew you would come through for me!\nSomehow you carried them all.\nYou're the one I can trust to get the\njob done!\n\x0E\x01\x09\x04\x07\x800Here's 50 Rupees for your hard work.")
/*<392>*/ 			rupees += 50;
/*<497>*/ 			printf("\x0E\x01\x09\x04\x07\x800Thank<pause0F> you<pause0F> very<pause0F> much! I hope you'll\nstop in again soon.")
...
/*< 74>*/ 		printf("\x0E\x01\x09\x04\x08\x1004I'm impressed that a young man like\nyourself can appreciate the refined\ntaste!\n\nJust <r<10 Rupees >>a bottle. Interested?\n[1]Fill 'er up![2-]No, thanks.")
/*<112>*/ 		switch (choice(2)) {
          		  case 0:
...
/*<551>*/ 					printf("The soup is meant to be enjoyed hot!\nJust so you know, it'll be cold in just\nfive minutes.")
          				  case 1:
/*<116>*/ 					printf("\x0E\x01\x09\x04\x00\x700You don't have an <item99>?!\n\n\n\nIt's mighty hard to drink soup when\nyou've got nothing to drink from!\nCome see me again when you've found\nan <item99>!")
          				}
          			  case 1:
/*<114>*/ 				printf("\x0E\x01\x09\x04\x0C\x700Looks like you don't have enough\nmoney. Maybe next time, then?")
          			}
          		  case 1:
          			flw_434:
...
/*<516>*/ 								switch (story_flags[737 /* us: 805A9B26 0x02, jp: 805ACDA6 0x02 */]) {
          								  case 0:
/*<267>*/ 									printf("\x0E\x01\x09\x04\x00\x01Hey! So you're saying that you'll \nplay one more time for Kina?\n[1]I'm in![2]Explain![3-]No way.")
/*<268>*/ 									switch (choice(3)) {
          									  case 0:
/*<270>*/ 										printf("\x0E\x01\x09\x04\x00\x0EGreat! I was hoping you'd say that.")
          										flw_383:
...
/*<261>*/ 										printf("\x0E\x01\x09\x04\x0D\x02All right then! Hey! Kina!")
/*<300>*/ 										set_camera(10, 0)
/*<298>*/ 										{'type': 'type3', 'subType': 1, 'param1': 26, 'param2': 0, 'next': 297, 'param3': 16}
/*<297>*/ 										printf("\x0E\x01\x09\x04\x1A00\x08Yes, Father! What is it?")
/*<301>*/ 										set_camera(11, 0)
...
/*<264>*/ 											printf("What's wrong? Did you not understand \nwhat I said? Listen up!")
          									  ...
          									  case 2:
/*<269>*/ 										printf("\x0E\x01\x09\x04\x00\x04Fair enough. Rest up and come back\nwhen you're ready to play!")
          									}
          								  case 1:
/*<519>*/ 									printf("\x0E\x01\x09\x04\x00\x01Hey, it's you! <pause1E>Oh, I know that look.\nYou're fixing to play that harp of\nyours, aren't you?\n\nSorry, but we have to prepare the stage\nduring the day.\n\n\nCome back after nightfall!")
          								}
          							  case 1:
...
/*< 48>*/ 											printf("\x0E\x01\x09\x04\x00\x11Why do I waste my time... Don't you\nfeel even a little bad about what\nyou did?")
          										}
          									  case 1:
...
/*<590>*/ 									switch (adventure_pouch_has(1 0x0001)) {
          									  case 0:
/*<593>*/ 										printf("\x0E\x01\x09\x04\x00\x01Oh, I see you brought an <item99>\nwith you like I asked. Great!")
          										flw_189:
...
/*<591>*/ 										printf("Hey! You haven't got an <item99>!\n\n\n\nYou need an <item99> if you want\nto carry soup! Go get yourself one and\ncome back here.")
          									}
          								  case 1:
...
/*< 44>*/ 													printf("Hey! You haven't got an <item99>!\n\n\n\nYou need an <item99> if you want\nto carry soup! Go get yourself one and\ncome back here.")
/*<588>*/ 													scene_flags[21 'The Sky'][48 /* 0x7 01 */] = true;
          												}
          											  case 1:
/*<275>*/ 												printf("\x0E\x01\x09\x04\x0D\xA0DHey! A man's word is his honor!\nI need you to deliver this soup to\nthe Knight Commander! Got it?\n[1]Got it![2-]Wait...")
          												goto flw_17
          											}
          										  case 1:
...
/*<426>*/ 	printf("\x0E\x01\x09\x04\x00\x02It's fine! I'll be a lot more reliable and\nhardworking than that shady-looking\nmole man you got here now!")
...
/*<146>*/ 	printf("\x0E\x01\x09\x04\x1A00\x09Hehe! Well then I look forward to\ngetting your help out there!")
...
/*<427>*/ 	printf("\x0E\x01\x09\x04\x09\x705Hah! I'm happy to do it. After all,\nI live to see that smile!")
          }
...
/*<470>*/ 					printf("\x0E\x01\x09\x04\x00\x900You wait right here! I'm getting\ninspired to fire up some soup like I've\nnever souped before!")
...
/*<219>*/ 					printf("\x0E\x01\x12\x04\x00\x01Master, I will signal for the robot.")
...
/*<342>*/ 					set_camera(5, 0)
/*<222>*/ 					printf("\x0E\x01\x09\x04\x00\x04The place where I offer soup to <b<Levias\n>>is inside the thunderhead cloud, on an\nisland with an everlasting <r<rainbow>>.<pling> \n\n\x0E\x01\x09\x04\x00\x700Oh, you'll know it when you see it.\nGood luck!")
...
/*<483>*/ 	switch (zone_temp_flags[3 /* 0x1 08 */]) {
          	  case 0:
/*<482>*/ 		printf("\x0E\x01\x09\x04\x1A00\x01Don't just sit there! I suggest you get\na move on and find my father, or else!\n\n\n\x0E\x01\x09\x04\x1A1A\x800You're going to be in big trouble!")
          		flw_480:
...
/*<481>*/ 		{'type': 'type3', 'subType': 2, 'param1': 5, 'param2': 26, 'next': -1, 'param3': 15}
          	  case 1:
/*<479>*/ 		printf("\x0E\x01\x09\x04\x1A00\x01Welcome! This is the <r<Lumpy Pumpkin>>,\nhome of the finest pumpkin\nsoup in the big, wide sky!\n\n\x0E\x01\x09\x04\x1A1A\x800There isn't much to do here but take\na load off, relax, and enjoy yourself!")
          		goto flw_480
          	}
          }
...
/*<353>*/ 		switch (zone_temp_flags[3 /* 0x1 08 */]) {
          		  case 0:
/*<354>*/ 			printf("\x0E\x01\x09\x04\x0B\x704What were you thinking? You scared\na year off my life!\n\n\n\x0E\x01\x09\x04\n\x700What did you want again? I lost my\ntrain of thought...")
          			flw_56:
...
/*<285>*/ 	start()
/*<173>*/ 	printf("\x0E\x01\x09\x04\x00\x08Well, good luck, Mr. <pause0A>Mole<pause0A> Man!")
          }
...
/*<503>*/ 	switch (story_flags[296 /* us: 805A9AFD 0x04, jp: 805ACD7D 0x04 */]) {
          	  case 0:
/*<504>*/ 		printf("\x0E\x01\x09\x04\x00\x04Yep! Kina's singing is the best I've\never heard! There's nothing like it.\nIt's the opposite of my wife's warbly\nvoice...")
          	  case 1:
/*<401>*/ 		switch (zone_temp_flags[3 /* 0x1 08 */]) {
          		  case 0:
/*<402>*/ 			printf("\x0E\x01\x09\x04\x0B\x704What were you thinking? You scared\na year off my life!\n\n\n\x0E\x01\x09\x04\n\x700What did you want again? I lost my\ntrain of thought...")
          		  case 1:
/*<495>*/ 			switch (story_flags[304 /* us: 805A9AFC 0x04, jp: 805ACD7C 0x04 */]) {
          			  case 0:
/*<496>*/ 				printf("\x0E\x01\x09\x04\x00\x04Kina's singing voice is beautiful!\n<pause0A>.<pause0A>.<pause0A>.But her music partner quit recently,\nand so I haven't heard her sing in a\nwhile.\nI really wish I could hear her voice\nagain.")
          			  case 1:
/*< 40>*/ 				printf("\x0E\x01\x09\x04\x00\x04You really shouldn't wander around \nSkyloft at night! If there's something\nyou want to talk to me about, do it\nduring the day.")
          			}
          		}
          	}
          }
...
/*<286>*/ 	start()
/*<174>*/ 	printf("\x0E\x01\x09\x04\x00\x05What?! But you... Well...I suppose...\nI guess I could at least give it a try.")
          }

          void entrypoint_117_15() {
/*<287>*/ 	start()
/*<169>*/ 	printf("\x0E\x01\x09\x04\x00\x09Hey! So what d'ya think?!")
          }
...
/*<109>*/ 	start()
/*<111>*/ 	printf("\x0E\x01\x09\x04\x00\x12\x0E\x01\x08\x02\x2CDWHY WOULD YOU DO\nTHAT?!\n\n\n\x0E\x01\x08\x02ÍGet down and come here this instant!")
...
/*<288>*/ 	start()
/*<170>*/ 	printf("\x0E\x01\x09\x04\x00\x09Wow! Look at that! That's amazing!")
          }
...
/*<289>*/ 	start()
/*<171>*/ 	printf("\x0E\x01\x09\x04\x00\x06Hah... Ya think? Well, it was nothin'\nreally.\n\n\nRootin' around in the dirt is child's\nplay for us Mogmas!")
          }
...
/*<234>*/ 								printf("\x0E\x01\x09\x04\x0B\xE0FI sure hope you can find someone to\nplow the patch soon...")
...
/*<573>*/ 								printf("\x0E\x01\x09\x04\x01\x70FIs there really someone who would\nhelp me out?\n\n\n\x0E\x01\x09\x04\x07\x700Well, I'll try to keep my hopes up and\njust wait here patiently until they\nshow up.")
          							  case 1:
/*<596>*/ 								printf("\x0E\x01\x12\x04\x00\x05Understood, Master. Should you wish\nto assign the person in question as a\ndowsing target, talk to this girl again.")
          								goto flw_572
          							}
          						  case 1:
/*<102>*/ 							printf("\x0E\x01\x09\x04\x01\x1611Oh, come on! Are you telling me you're\nOK with a cute girl like me working the\nfield all by herself?! Some chivalrous\nknight you are!")
          						}
          					}
          				  case 1:
          					flw_387:
...
/*<291>*/ 	start()
/*<175>*/ 	printf("\x0E\x01\x09\x04\x00\x0COh yeah! Here I go!")
          }
...
/*< 32>*/ 	switch (context_related2(0)) {
          	  case 0:
/*<  9>*/ 		printf("\x0E\x01\x09\x04\x13\x809I just knew you would come through.\nYou managed to carry them all!\n\n\n\x0E\x01\x09\x04\x01\x700I guess that means you're done carrying\npumpkins!\n\n\n\x0E\x01\x09\x04\x19\x800Thank<pause0F> you<pause0F> very<pause0F> much<pause0F>!")
          	  case 1:
/*< 33>*/ 		printf("\x0E\x01\x09\x04\x01\x1611Awww, you dropped them! You can't\nbe careless like that...\n\n\n\x0E\x01\x09\x04\x07\x700If you want to try again, come on\nover here.")
          	}
          }
...
/*<  7>*/ 	start()
/*< 10>*/ 	printf("\x0E\x01\x09\x04\x01\x1611Awww, you dropped them! You can't\nbe careless like that...\n\n\n\x0E\x01\x09\x04\x07\x700If you want to try again, come on\nover here.")
          }
...
/*<490>*/ 					switch (story_flags[364 /* us: 805A9B03 0x04, jp: 805ACD83 0x04 */]) {
          					  case 0:
/*<492>*/ 						printf("\x0E\x01\x09\x04\x1A\x1000What?! Something happened to\nLevias? \n\n\nYou know, Father used to deliver his\npumpkin soup to Levias every year.\nMaybe you should talk to him?")
          					  case 1:
          					}
          				}
          			  case 1:
/*<538>*/ 				printf("\x0E\x01\x09\x04\x10\x1604Don't even pretend that was an\naccident! I put signs up there to\nwarn people to be careful of the\nchandelier and everything!\n\x0E\x01\x09\x04\x1A\x1600Well I wash my hands of the whole\nthing! Don't be surprised if my dad\ngives you a royal chewing out!")
          				goto flw_491
          			}
          		}
          	  case 1:
