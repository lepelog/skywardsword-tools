...
/*< 68>*/ 	switch (zone_temp_flags[1 /* 0x1 02 */]) {
          	  case 0:
/*< 70>*/ 		printf(/* textboxtype: 0, unk: 25, line: 50 */ "<0x10009:0x00091901>Send my regards to the owner of\nthe Lumpy Pumpkin!")
          	  case 1:
...
/*< 59>*/ 					switch (choice(2)) {
          					  case 0:
/*< 61>*/ 						printf(/* textboxtype: 0, unk: 25, line: 47 */ "<0x10009:0x00171909>Oh! For me?! I mean, sorry for just\nassuming it was for me...\n\n\nWell, in that case, I'll help myself!")
...
/*<103>*/ 						printf(/* textboxtype: 0, unk: 25, line: 44 */ "Sooo good!<0x10005:0x001e0000>")
/*<104>*/ 						set_camera(11, 0)
/*< 63>*/ 						printf(/* textboxtype: 1, unk: 0, line: 48 */ "Yeah! That hits the spot!\n\n\n\n<0x10009:0x00171900>I tell you, morning, noon, or night,\nnothing satisfies like Pumm's yummy \npumpkin soup!")
...
/*<142>*/ 						printf(/* textboxtype: 25, unk: 1, line: 49 */ "<0x10009:0x00080200>Thank you, <heroname>! \nHere's a token of my appreciation.")
...
/*< 41>*/ 					switch (choice(2)) {
          					  case 0:
/*< 42>*/ 						printf(/* textboxtype: 0, unk: 25, line: 38 */ "<0x10009:0x00171909>YES! Give it to me!\n[1-]Here you go![2]Sorry...")
/*< 44>*/ 						switch (choice(2)) {
          						  case 0:
...
/*< 94>*/ 							printf(/* textboxtype: 0, unk: 25, line: 44 */ "Sooo good!<0x10005:0x001e0000>")
/*< 96>*/ 							set_camera(11, 0)
...
/*<140>*/ 							printf(/* textboxtype: 25, unk: 1, line: 43 */ "<0x10009:0x00081900>Well done! Say thanks to the owner\nfor me!")
...
/*< 39>*/ 						switch (choice(2)) {
          						  case 0:
/*< 43>*/ 							printf(/* textboxtype: 0, unk: 25, line: 38 */ "<0x10009:0x00171909>YES! Give it to me!\n[1-]Here you go![2]Sorry...")
/*< 45>*/ 							switch (choice(2)) {
          							  case 0:
...
/*<147>*/ 								set_camera(11, 0)
/*<146>*/ 								printf(/* textboxtype: 25, unk: 1, line: 40 */ "Ugh! This is disgusting...<pause 20> It's cold!")
...
/*< 50>*/ 								printf(/* textboxtype: 0, unk: 25, line: 41 */ "If there are two things I can't stand in\nthis world, it's cold soup and slackers.\nNow bring me another one—and make\nit hot!")
...
/*< 46>*/ 								printf(/* textboxtype: 1, unk: 0, line: 39 */ "<0x10009:0x00001d00>What?! Weren't you asked to bring\nthis to me? You think you can tease\nme like this? You DO NOT tease a man\nabout pumpkin soup!\n<0x10009:0x00081d00>If this soup isn't good anymore, you're\ngoing to have to go get me some more!\n\n\nAnd it had better be hot!")
          						  ...
          						  case 1:
/*< 38>*/ 							printf(/* textboxtype: 25, unk: 1, line: 37 */ "<0x10009:0x000e1d00>Huh... I told Pumm to bring some\nright away, so what is he doing?\n<0x10009:0x00081d00>You do not want to be around me when\nI don't get my daily pumpkin soup.")
          						}
          					  case 1:
...
/*< 25>*/ 	printf(/* textboxtype: 0, unk: 25, line: 5 */ "<0x10009:0x0b0d0002>Hey! <0x1000D:0x1900><0x30001:0x><heroname>!")
...
/*< 76>*/ 	start()
/*< 84>*/ 	printf(/* textboxtype: 25, unk: 1, line: 19 */ "<0x10009:0x00010201>That's a log for practicing your <color red<vertical\nslash>coloroff>. Hold your sword straight up, and\nthen swing it straight down to make a\nclean cut!")
          }

          void entrypoint_119_05() {
/*< 80>*/ 	start()
/*< 85>*/ 	printf(/* textboxtype: 1, unk: 25, line: 20 */ "<0x10009:0x00190203>That's a log for practicing your <color red<side slash>coloroff>.\nHold your sword horizontally, and then\nslash it to the side to make a clean cut!")
          }

          void entrypoint_119_06() {
/*< 81>*/ 	start()
/*< 86>*/ 	printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x001d0202>That log is set up for practicing your\n<color red<diagonal slash>coloroff>. Swing your sword\ndiagonally to cut right along the gash\nin the log.")
          }

          void entrypoint_119_07() {
/*< 82>*/ 	start()
/*< 87>*/ 	printf(/* textboxtype: 25, unk: 1, line: 22 */ "<0x10009:0x00080203>That's a log used for practicing your\n<color red<thrust>coloroff>. Move your sword sharply forward\nto thrust. If you need to know more\nabout that, check Help.")
          }
...
/*< 77>*/ 		switch (adventure_pouch_has(9 0x0009)) {
          		  case 0:
/*<162>*/ 			printf(/* textboxtype: 25, unk: 1, line: 25 */ "<0x10009:0x00191d02>That log is used to practice <color red<defense>coloroff>.\nYou don't have a <color red<shield>coloroff> equipped,\nthough, so don't mess with it, or it'll\nsend you flying!")
          		  case 1:
/*< 78>*/ 			printf(/* textboxtype: 0, unk: 25, line: 23 */ "<0x10009:0x00191d02>That log there is for practicing\n<color red<defense>coloroff>. You don't have a <color red<shield>coloroff> equipped,\nso don't mess with it, or it'll send you\nflying!")
          		}
          	}
          }
...
/*<109>*/ 	start()
/*<114>*/ 	printf(/* textboxtype: 0, unk: 25, line: 29 */ "<0x10009:0x000a0213>That's right, <heroname>!")
/*<116>*/ 	set_camera(3, 0)
/*<110>*/ 	printf(/* textboxtype: 0, unk: 25, line: 26 */ "<0x10009:0x00081908>You really are a strong swordsman. \nEasy to teach too. You make this\ninstructor proud!\n\n<0x10009:0x00090200>Are you ready to try a <color green<spin attack>coloroff>?\n[1-]OK![2]Not yet.")
          }
