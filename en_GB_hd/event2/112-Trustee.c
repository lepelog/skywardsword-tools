...
/*< 91>*/ 						switch (is_item_check_full()) {
          						  case 0:
/*< 93>*/ 							printf("\x0E\x01\x09\x04\x00\x15Listen, I'd love to take some things off\nyour hands, but this isn't a bottomless\npit. I don't have any more space here.\n\nCan't you just <r<trade >>some items or do\nsomething to make room?")
          							goto flw_5
          						  case 1:
/*< 92>*/ 							printf("\x0E\x01\x09\x04\x00\x15Wonderful. So what do you have?")
          							goto flw_5
          						}
          					  case 1:
/*< 27>*/ 						switch (is_item_check_full()) {
          						  case 0:
/*< 28>*/ 							printf("\x0E\x01\x09\x04\x00\x04Listen, I'd love to take some things off\nyour hands, but it looks like I'm all\nfull here.\n\nJust <r<trade >>some items or do something\nto make some room, OK?")
          							goto flw_5
          						  case 1:
/*<  2>*/ 							printf("\x0E\x01\x09\x04\x00\x03All right. Let's see it.")
          							goto flw_5
          						}
          					}
          				}
...
/*< 57>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_47:
/*< 47>*/ 						printf("\x0E\x01\x09\x04\x0E\x150CLook, hon, it's not humane to tease\nsomeone this bored. Knock it off, OK?")
          					  case 1:
/*< 58>*/ 						printf("\x0E\x01\x09\x04\x00\x13So you came all this way just for my\nsparkling personality, huh? I figured\nyou couldn't stop thinking about me.")
          					}
          				  case 1:
          					goto flw_47
          				}
...
/*< 49>*/ 				switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          				  case 0:
/*< 46>*/ 					printf("\x0E\x01\x09\x04\x00\x17What's your deal? Stop bothering me\nif you don't want anything. I'm busy\nwatching dust settle on my counter.")
          				  case 1:
/*< 48>*/ 					switch (story_flags[628 /* us: 805A9B1B 0x80, jp: 805ACD9B 0x80 */]) {
          					  case 0:
/*< 87>*/ 						printf("\x0E\x01\x09\x04\x00\x02What's with you? Leave me alone if\nyou don't want anything. Sheesh...\nI'm busy staring at a wall.")
          					  case 1:
/*<  3>*/ 						printf("\x0E\x01\x09\x04\x00\x02Oh, really? Great. Not like my time is\nworth anything...")
          					}
          				}
          			}
          		}
...
/*< 66>*/ 				switch (is_item_check_full()) {
          				  case 0:
/*< 67>*/ 					printf("\x0E\x01\x09\x04\x00\x07Oh wow. I don't have any more storage\nspace!\n\n\nWould you please<r< trade >>or throw out\nstuff you don't need? Help a girl out,\nwill you, hon?")
          				  case 1:
/*< 68>*/ 					printf("\x0E\x01\x09\x04\x0B\x1709See you next time! Tee hee!")
          				}
          			  case 1:
/*< 71>*/ 				switch (is_item_check_full()) {
          				  case 0:
/*< 72>*/ 					printf("\x0E\x01\x09\x04\x00\x04Great... I'm all out of storage space.\n\n\n\nHelp me out, will you? <r<Trade >>or get\nrid of any items you don't need.")
          				  case 1:
/*< 73>*/ 					printf("\x0E\x01\x09\x04\x00\x15Remember, you can come by anytime\nyou need to remind yourself about\nhow beautiful I am.")
          				}
          			}
          		  case 1:
          			goto flw_66
...
/*< 94>*/ 			switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          			  case 0:
/*< 95>*/ 				printf("\x0E\x01\x09\x04\x00\x15Hey. Your stuff is taking up all of my\nstorage space.\n\n\nWould you please get rid of stuff you\ndon't need and help me make some\nroom? You know, <r<trade >>some stuff.")
          			  case 1:
/*< 26>*/ 				printf("\x0E\x01\x09\x04\x00\x04Hey! All of my storage space is taken\nup with your junk!\n\n\nI can't hold anything else, so you better\nmake room by <r<trading >>or getting rid of\nstuff you don't need.")
          			}
          		  case 1:
/*< 88>*/ 			switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          			  case 0:
/*< 89>*/ 				printf("\x0E\x01\x09\x04\x00\x06Thank you. Come again.")
          			  case 1:
/*<  7>*/ 				printf("\x0E\x01\x09\x04\x00\x03OK. Thank you. Come again...")
          			}
          		}
          	}
          }
...
/*< 79>*/ 						printf("\x0E\x01\x09\x04\x00\x03Thanks. Anything else?")
          			  ...
          			  case 1:
/*< 10>*/ 				printf("\x0E\x01\x09\x04\x00\x03Thanks. Anything else?")
          				goto flw_53
          			}
          		  case 1:
...
/*< 75>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_38:
/*< 38>*/ 						printf("\x0E\x01\x09\x04\x00\x12Ooh, good call, sweetie! I knew you\nwere a smart one.")
          						goto flw_53
          					  case 1:
/*< 76>*/ 						printf("\x0E\x01\x09\x04\x00\x14No, thanks? You're going to pass on\nthis deal just like you passed on me.\nI get it.")
          						goto flw_53
          					}
          				  case 1:
          					goto flw_38
...
/*< 13>*/ 				printf("No, thanks? OK, fine. It's your call.")
          	  ...
          	  case 1:
/*<  9>*/ 		printf("Hmm... For that I'll give you\n<r<<numeric arg0> >><r<\x0E\x03\x04\x02\x1CD>>.\n\n\nWhat do you say?\n[1]OK![2-]Nah.")
          		goto flw_11
          	}
          }
...
/*< 82>*/ 				printf("\x0E\x01\x09\x04\x00\nListen, sweetie, you don't have\nanything to store.\n\n\nCome back and see me when your\nluck improves a bit. OK? Great.")
          			  case 1:
/*< 83>*/ 				printf("\x0E\x01\x09\x04\x00\x04You don't have anything to store.\n\n\n\nWhy don't you come back when you\nhave some stuff. Bye now.")
          			}
          		  case 1:
          			goto flw_82
          		}
          	  case 1:
/*< 15>*/ 		printf("\x0E\x01\x09\x04\x00\x04Hate to break this to you, but you don't\nhave anything to put into storage.\n\n\nCome back and see me when you\nactually get some stuff, OK?")
          	}
          }
