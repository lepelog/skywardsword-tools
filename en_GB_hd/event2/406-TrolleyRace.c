...
/*< 24>*/ 				switch (zone_temp_flags[1 /* 0x1 02 */]) {
          				  case 0:
/*< 32>*/ 					printf(/* textboxtype: 0, unk: 0, line: 2 */ "Up for another run on the Rickety\nCoaster? You never know what will\nhappen. Just 20 Rupees!\n[1-]Sure![2]Uh...no.")
          					flw_2:
/*<  2>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_8:
/*<  8>*/ 						switch (has_rupees(20)) {
          						  case 0:
/*<  9>*/ 							rupees += -20;
/*< 56>*/ 							printf(/* textboxtype: 0, unk: 0, line: 26 */ "So what track will it be?\n[1-]Scary![2-]Heart stopping!")
/*< 57>*/ 							switch (choice(2)) {
          							  case 0:
...
/*< 14>*/ 											switch (story_flags[500 /* us: 805A9B12 0x04, jp: 805ACD92 0x04 */]) {
          											  case 0:
/*< 43>*/ 												printf(/* textboxtype: 0, unk: 0, line: 8 */ "Your best time so far is:\n<numeric arg0 0>:<numeric arg1 2>:<numeric arg2 2>.")
          												goto flw_101
          											  case 1:
          												goto flw_101
          											}
...
/*< 36>*/ 						printf(/* textboxtype: 0, unk: 0, line: 14 */ "You could at least let me explain\nthe rules...")
/*< 20>*/ 						zone_temp_flags[0 /* 0x1 01 */] = true;
          					}
          				  case 1:
/*< 31>*/ 					printf(/* textboxtype: 0, unk: 0, line: 11 */ "Hey, you! What are you doing?\n\n\n\nWell, you are here now...so how about a\nlittle fun?\n[1-]Fun?[2]No way.")
/*< 45>*/ 					switch (choice(2)) {
          					  case 0:
/*< 35>*/ 						printf(/* textboxtype: 0, unk: 1, line: 13 */ "Got your attention, eh? Geheh.\nLet me explain...")
          						goto flw_110
          					  case 1:
...
/*< 48>*/ 						printf(/* textboxtype: 0, unk: 1, line: 19 */ "You set a new record!\nGreat work!")
          						flw_4:
...
/*< 50>*/ 								printf(/* textboxtype: 0, unk: 0, line: 20 */ "Hope you come by again soon!")
...
/*< 74>*/ 							switch (story_flags[529 /* us: 805A9B14 0x40, jp: 805ACD94 0x40 */]) {
          							  case 0:
/*< 53>*/ 								printf(/* textboxtype: 0, unk: 0, line: 23 */ "Not a bad time. Nope, not bad at all!\nHere is your prize!")
/*<  6>*/ 								give_item(63 0x3F);
          								goto flw_68
          							  case 1:
/*<131>*/ 								printf(/* textboxtype: 0, unk: 1, line: 34 */ "Not a bad time, but you are nowhere\nnear as fast as I am. Here are\n50 Rupees!")
...
/*< 78>*/ 								switch (story_flags[667 /* us: 805A9B1E 0x02, jp: 805ACD9E 0x02 */]) {
          								  case 0:
/*<122>*/ 									printf(/* textboxtype: 0, unk: 0, line: 32 */ "This is something I have been saving\njust for you.")
/*< 76>*/ 									give_item(64 0x40);
          									goto flw_68
          								  case 1:
/*<121>*/ 									printf(/* textboxtype: 0, unk: 1, line: 31 */ "Here you go! I found this treasure\nright here on this very island.")
...
/*< 49>*/ 			printf(/* textboxtype: 0, unk: 0, line: 17 */ "Well, come back anytime you want to\ngive it a try!")
...
/*< 28>*/ 			printf(/* textboxtype: 0, unk: 1, line: 1 */ "It is pretty fun to ride these mine carts.\nOne day, I would love to set up a race!")
          		  case 1:
...
/*< 92>*/ 		printf(/* textboxtype: 0, unk: 0, line: 35 */ "Hey, that is my seat! Nobody sits their\nrear end on my seat but me, got it?")
          		goto flw_97
          	}
          }
