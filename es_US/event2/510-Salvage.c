...
/*<  4>*/ 		printf(/* textboxtype: 2, unk: 0, line: 2 */ "<0x10012:0x00000005>Muy bien, amo. Avisaré al robot\ntelepáticamente.<sound 4>")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 2, unk: 0, line: 1 */ "<0x10012:0x00000005>Está bien, amo. Le recuerdo que basta\ncon examinar de nuevo el rotor en\ncaso de cambiar de opinión.")
          	}
          }

          void entrypoint_510_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0, line: 3 */ "<0x10012:0x00000064>¡Mi Fay querida!\n¡Lamento la tardanza!\n\n\nEs esto, ¿no? ¡Perfecto, yo me encargo\nde todo!")
          }

          void entrypoint_510_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 1, unk: 0, line: 4 */ "<0x10012:0x00000064>Muy bien, ¡me voy volando!\n¡Espero verte pronto, preciosa!")
          }
