...
/*< 29>*/ 	start()
/*< 28>*/ 	printf(/* textboxtype: 1, unk: 0, line: 16 */ "Si logras sacar todas las rupias en\nel juego <color blue<Agujeros y rupias >coloroff>de Nabucco,\nte puedes llevar un premio de lo\nmás inusual... O eso dicen.")
          }
...
/*< 58>*/ 	switch (story_flags[19 /* us: 805A9ADB 0x08, jp: 805ACD5B 0x08 */]) {
          	  case 0:
/*< 56>*/ 		printf(/* textboxtype: 1, unk: 1, line: 17 */ "En las entrañas de este volcán, bajo\nla misma tierra que pisas, viven los\n<color blue<mogmas>coloroff>, unos tipos obsesionados\ncon los tesoros.\nAunque, según dicen, últimamente\nse lo están tomando con mucha\nmás calma.")
          	  case 1:
          		flw_59:
/*< 59>*/ 		printf(/* textboxtype: 1, unk: 1, line: 19 */ "Según dicen, en la <color red<cima >coloroff>de este volcán\ntiene su morada un <color red<dragón>coloroff>.\n\n\nAunque me parece que no estamos\nprecisamente en la <color red<cima>coloroff>...")
/*< 60>*/ 		printf(/* textboxtype: 1, unk: 1, line: 18 */ "¿Quieres que te lo cuente otra vez?\n\n[1-]Sí[2]No")
/*< 62>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_59
          		  case 1:
/*< 61>*/ 			printf(/* textboxtype: 1, unk: 1, line: 20 */ "¿Ah, no?<pause 15> Bueno, tú sabrás...")
          		}
          	}
          }
...
/*< 13>*/ 		switch (is_item_check_full()) {
          		  case 0:
/*< 11>*/ 			printf(/* textboxtype: 5, unk: 1, line: 9 */ "En la alforja no te cabe nada más y\nla <color red<consigna >coloroff>también está llena.\n\n\nEl objeto tiene que quedarse en el cofre.")
          		  case 1:
/*< 10>*/ 			printf(/* textboxtype: 5, unk: 1, line: 8 */ "¡La alforja está llena, así que te guardarán\neste objeto en la <color red<consigna>coloroff>!")
          		}
          	  case 1:
          	}
          }
...
/*< 30>*/ 		printf(/* textboxtype: 1, unk: 0, line: 21 */ "El <color red<dragón>coloroff> que habita en la cima del\nvolcán habla hasta con las paredes.\n\n\nSe dice que puede pasarse horas\ncharlando de tierras lejanas y\nparajes exóticos.")
          	  case 1:
          		flw_52:
/*< 52>*/ 		printf(/* textboxtype: 1, unk: 0, line: 22 */ "Según dicen, en la cima de este volcán\nvive un <color red<dragón >coloroff>envuelto en llamas.\n\n\nY vive en un <color red<lugar tan abrasador\n>coloroff>que casi nadie puede acercarse.")
/*< 53>*/ 		printf(/* textboxtype: 1, unk: 1, line: 18 */ "¿Quieres que te lo cuente otra vez?\n\n[1-]Sí[2]No")
/*< 55>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_52
          		  case 1:
/*< 54>*/ 			printf(/* textboxtype: 1, unk: 1, line: 20 */ "¿Ah, no?<pause 15> Bueno, tú sabrás...")
          		}
          	}
          }
...
/*< 65>*/ 	start()
/*< 66>*/ 	printf(/* textboxtype: 2, unk: 1, line: 35 */ "¿Quiere mi <0x10012:0x00000001>amo aterrizar aquí?\n[1-]Sí[2]No")
/*< 67>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
...
/*<  1>*/ 	start()
/*<  3>*/ 	printf(/* textboxtype: 9, unk: 0, line: 2 */ "<0x1000F:0x>El letrero está hecho pedazos,\nes imposible leer lo que dice.")
          }

          void entrypoint_004_113() {
/*< 41>*/ 	start()
/*< 40>*/ 	printf(/* textboxtype: 1, unk: 0, line: 27 */ "Dicen que si dibujas dinero en los\nmuros misteriosos, puedes llevarte\nmuchas rupias fácilmente.")
          }
...
/*< 45>*/ 	start()
/*< 44>*/ 	printf(/* textboxtype: 1, unk: 0, line: 29 */ "Dicen que si dibujas un círculo en los\nmuros misteriosos, aparece algo\ncon forma circular.")
          }

          void entrypoint_004_004() {
/*< 46>*/ 	start()
/*< 47>*/ 	printf(/* textboxtype: 9, unk: 0, line: 1 */ "<0x1000F:0x>La puerta está cerrada\na cal y canto.")
          }

          void entrypoint_004_116() {
/*< 63>*/ 	start()
/*< 64>*/ 	printf(/* textboxtype: 1, unk: 0, line: 30 */ "Según dicen, si dibujas tres triángulos\nen los muros misteriosos, aparecerán\n<color yellow<hadas>coloroff>.")
          }

          void entrypoint_004_117() {
/*< 75>*/ 	start()
/*< 76>*/ 	printf(/* textboxtype: 1, unk: 1, line: 31 */ "Según dicen, hay una <color yellow<pieza de corazón>coloroff>\noculta en algún lugar por aquí cerca.")
/*< 77>*/ 	switch (scene_flags[104 /* 0xC 01 */]) {
          	  case 0:
/*< 78>*/ 		printf(/* textboxtype: 1, unk: 1, line: 33 */ "Aunque me parece que tú ya la tienes...")
          	  case 1:
/*< 79>*/ 		printf(/* textboxtype: 1, unk: 1, line: 32 */ "Pero parece ser que para llegar hasta\nese lugar hay que ser capaz de escarbar\ncomo un auténtico <color blue<mogma>coloroff>.")
          	}
          }

          void entrypoint_004_100() {
/*< 17>*/ 	start()
/*< 16>*/ 	printf(/* textboxtype: 1, unk: 0, line: 10 */ "¡Boooooing!")
          }

          void entrypoint_004_008() {
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 2, unk: 2, line: 4 */ "¿Quiere el <0x10012:0x00000001>amo salir de Hypnea?\n[1-]Sí[2]No")
/*<  8>*/ 	switch (choice(2)) {
          	  case 0:
          	  case 1:
          	}
