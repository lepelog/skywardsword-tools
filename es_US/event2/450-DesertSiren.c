...
/*<  9>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 10>*/ 		printf(/* textboxtype: 1, unk: 2, line: 26 */ "¡Todo listo, <heroname>!\n¡Ánimo, puedes hacerlo!")
/*< 12>*/ 		set_camera(10, 0)
...
/*< 19>*/ 			switch (temp_flags[1 /* 0x1 02 */]) {
          			  case 0:
/*< 31>*/ 				printf(/* textboxtype: 2, unk: 2, line: 17 */ "<0x10012:0x00000004>Amo <heroname>, la recolección\nde <color yellow<lágrimas >coloroff>ha fracasado.")
...
/*< 42>*/ 										temp_flags[7 /* 0x1 80 */] = true;
          								  ...
          								  case 1:
/*< 38>*/ 									printf(/* textboxtype: 2, unk: 2, line: 23 */ "Aconsejo <color red<reservar >coloroff>las <color yellow<lágrimas\n>coloroff>más sencillas de encontrar\npara los momentos en los que\nel <0x10012:0x00000001>amo haya sido descubierto.")
/*< 41>*/ 									temp_flags[6 /* 0x1 40 */] = true;
          									goto flw_32
          								}
          							  case 1:
/*< 37>*/ 								printf(/* textboxtype: 2, unk: 2, line: 22 */ "Calculo que la probabilidad de que\nel <0x10012:0x00000001>amo no sea el elegido de\nla Diosa ha aumentado.\n\nTras varios intentos fallidos,\nsu alma se ha desestabilizado.\nSe recomienda un largo descanso\npara recuperar la concentración.")
...
/*< 51>*/ 				switch (choice(4)) {
          				  case 0:
/*< 58>*/ 					printf(/* textboxtype: 2, unk: 2, line: 7 */ "<0x10012:0x00000005>Procedo con mi explicación, amo.\nRecomiendo prestar máxima atención.\n\n\nPara completar la <color yellow<orquídea del\nespíritu>coloroff>, es necesario encontrar\nlas <color yellow<lágrimas de Nayru >coloroff>que hay\nrepartidas por este mundo.")
/*< 52>*/ 					set_camera(2, 0)
/*< 53>*/ 					{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': 0, 'next': 55, 'param3': 40}
/*< 55>*/ 					printf(/* textboxtype: 2, unk: 2, line: 8 */ "<0x10012:0x00000002>Amo, aquel objeto brillante de allí...")
/*< 56>*/ 					set_camera(3, 0)
/*< 59>*/ 					printf(/* textboxtype: 2, unk: 0, line: 9 */ "Es una de las <color yellow<lágrimas de Nayru>coloroff>.\nEl <0x10012:0x00000001>amo deberá reunir las <color red<15\n>coloroff>para superar el juicio.")
/*< 54>*/ 					{'type': 'type3', 'subType': 1, 'param1': 31, 'param2': 1, 'next': 57, 'param3': 40}
/*< 57>*/ 					wait_frames(15)
          					flw_77:
/*< 77>*/ 					set_camera(1, 0)
/*< 78>*/ 					printf(/* textboxtype: 2, unk: 2, line: 4 */ "¿Alguna otra pregunta, <0x10012:0x00000001>amo?\n\n\n[1-]Orquídea\ndel espíritu[2-]Guardianes[3-]Fluido\nhypneo[4]No, gracias")
          					goto flw_51
          				  case 1:
/*< 60>*/ 					printf(/* textboxtype: 2, unk: 2, line: 10 */ "<0x10012:0x00000005>Muy bien, amo. He aquí la información\nsolicitada.")
/*< 61>*/ 					set_camera(6, 0)
/*< 64>*/ 					printf(/* textboxtype: 2, unk: 2, line: 11 */ "Nada más poner un pie fuera\nde este círculo, los llamados\n<color red<guardianes >coloroff>perseguirán al <0x10012:0x00000002>amo.")
/*< 62>*/ 					set_camera(4, 0)
...
/*< 63>*/ 					set_camera(5, 0)
/*< 66>*/ 					printf(/* textboxtype: 2, unk: 2, line: 14 */ "Para completar la <color yellow<orquídea\ndel espíritu>coloroff>, es necesario\nrecoger todas las <color yellow<lágrimas>coloroff>\nsin sufrir ningún daño.")
          					goto flw_77
          				  case 2:
/*< 67>*/ 					printf(/* textboxtype: 2, unk: 2, line: 10 */ "<0x10012:0x00000005>Muy bien, amo. He aquí la información\nsolicitada.")
/*< 68>*/ 					set_camera(11, 0)
/*< 69>*/ 					printf(/* textboxtype: 2, unk: 2, line: 13 */ "En este mundo existe una especie\nde líquido llamado <color red<fluido hypneo>coloroff>.\n\n\nSi el <0x10012:0x00000001>amo posa un pie sobre él, los\n<color red<guardianes detectarán de inmediato\nsu presencia>coloroff>.\n\nPor lo tanto, aconsejo caminar con los\nojos bien abiertos.")
          					goto flw_77
          				  case 3:
          					flw_70:
/*< 70>*/ 					printf(/* textboxtype: 2, unk: 2, line: 5 */ "<0x10012:0x00000005>De acuerdo, amo.")
/*< 71>*/ 					set_camera(10, 0)
/*< 72>*/ 					printf(/* textboxtype: 2, unk: 2, line: 6 */ "Esperaré el regreso del <0x10012:0x00000002>amo\nen el mundo exterior.")
