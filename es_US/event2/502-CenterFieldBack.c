...
/*< 46>*/ 						printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00000003>Un árbol imperecedero...\n¿Dónde podríamos encontrar\nla <color red<semilla >coloroff>de un árbol así?")
          					  case 1:
/*< 34>*/ 						printf(/* textboxtype: 1, unk: 0, line: 7 */ "<pause 15>.<pause 15>.<pause 15>.<0x10009:0x000f0803>Hmmm.\n\n\n\n[1-]¿Qué pasa?[2-]Adiós")
/*< 35>*/ 						switch (choice(2)) {
          						  case 0:
/*< 36>*/ 							printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x00000703>Oh, no tiene importancia...")
...
/*< 67>*/ 	start()
/*< 68>*/ 	printf(/* textboxtype: 3, unk: 0, line: 32 */ "<0x10005:0x002d0000><0x10008:0x02cd>¡Despreciable mocoso!")
          }
