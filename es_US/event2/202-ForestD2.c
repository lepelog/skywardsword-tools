...
/*< 15>*/ 	printf("Veo que eres muy persistente.<pause05>.<pause05>.")
/*< 19>*/ 	set_camera(3, 0)
/*< 16>*/ 	printf("Pero estoy bastante ocupado, ¿sabes?\nTengo que hallar el modo de resucitar\nal Señor del Mal.")
/*< 20>*/ 	set_camera(4, 0)
