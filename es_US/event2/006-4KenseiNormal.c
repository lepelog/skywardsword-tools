...
/*< 14>*/ 			switch (adventure_pouch_has(8 0x0008)) {
          			  ...
          			  case 1:
          				flw_11:
/*< 11>*/ 				printf(/* textboxtype: 2, unk: 0, line: 1 */ "Puesto que en el actual <color red<modo Héroe\n>coloroff>no aparecen corazones ni flores de\ncorazón, recomiendo un uso intensivo\nde las pociones.")
          			}
          		  case 1:
          			goto flw_11
          		}
