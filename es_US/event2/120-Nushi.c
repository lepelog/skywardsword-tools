...
/*< 19>*/ 	start()
/*< 20>*/ 	printf("Bien, yo ya he cumplido con mi parte.\n¡Adiós!\x0E\x01\x05\x04(\x00")
...
/*<  5>*/ 							printf("El Cantar del Héroe es la <r<llave\n>>que abre el camino de la Trifuerza.")
