...
/*<  8>*/ 		printf(/* textboxtype: 1, unk: 0, line: 8 */ "¿De verdad que aceptas?")
/*<118>*/ 		make_actor_do_something(6, 0)
/*<113>*/ 		printf(/* textboxtype: 1, unk: 0, line: 9 */ "He oído que la forma más sencilla\nde obtener <color yellow<gemas de gratitud >coloroff>es\nresolviendo los problemas de los\ndemás.")
/*< 84>*/ 		{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 2572, 'next': 83, 'param3': 13}
/*< 83>*/ 		printf(/* textboxtype: 1, unk: 0, line: 10 */ "También es posible que encuentres\nalgunas repartidas por lugares de las\nislas flotantes donde haya gente...\ncomo en Neburia, por ejemplo.\n¡Seguro que alguien tan generoso y\naltruista como tú no tendrá problemas\npara <color green<encontrar >coloroff>muchas <color yellow<gemas de\ngratitud>coloroff>!")
/*< 86>*/ 		{'type': 'type3', 'subType': 4, 'param1': 9, 'param2': 3079, 'next': 85, 'param3': 13}
/*< 85>*/ 		printf(/* textboxtype: 1, unk: 0, line: 11 */ "Ah, y ten en cuenta que te pagaré\npor cada una que encuentres.\n¡Gracias de antemano!")
...
/*<  6>*/ 		printf(/* textboxtype: 1, unk: 0, line: 7 */ "Por favor... No te estoy pidiendo tanto.\n\n[1-]Bueno[2]¡Que no!")
/*<  7>*/ 		switch (choice(2)) {
          		  case 0:
          			goto flw_82
          		  case 1:
...
/*< 17>*/ 					printf(/* textboxtype: 1, unk: 0, line: 37 */ "<0x10009:0x00000005>Y bien, ¿qué te parece?\nSeguro que ni siquiera me habías\nreconocido, ¿eh?")
/*< 96>*/ 					{'type': 'type3', 'subType': 4, 'param1': 9, 'param2': 3072, 'next': 97, 'param3': 13}
/*< 97>*/ 					printf(/* textboxtype: 1, unk: 0, line: 38 */ "Me... ¡Me siento como si estuviera\ndentro del cuerpo de otra persona!")
...
/*<141>*/ 										switch (context_related2(5)) {
          										  case 0:
/*<142>*/ 											printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00090d0b>¡Oh! ¡Tienes más! ¡Cuántas <color yellow<gemas\nde gratitud>coloroff>! ¡Es increíble!\n\n\n<0x10009:0x00070807>¡Toma, acepta esto como muestra\nde agradecimiento! ¡No te imaginas\nlo feliz que me haces!")
          											goto flw_127
          										  case 1:
/*<146>*/ 											scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          										}
          									  case 1:
/*< 54>*/ 										printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10009:0x00000005>Me gustaría tanto ser una persona\nnormal... Por favor, ¡tráeme\n<color yellow<gemas de gratitud>coloroff>! \n\n¿Crees que podrías conseguirme,\ndigamos... <color red<50>coloroff>? Quizá con esas ya\nsea suficiente, con un poco de suerte.\n¡Muchas gracias de antemano!")
          									}
          								}
          							  case 1:
/*< 32>*/ 								switch (context_related2(3)) {
          								  case 0:
/*< 50>*/ 									printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x00090d0b>¡Increíble! ¡Me has traído muchas\n<color yellow<gemas de gratitud>coloroff>!\n\n\n<0x10009:0x00070807>Por favor, acepta esto como muestra\nde mi agradecimiento.")
          									flw_164:
/*<164>*/ 									{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 49, 'param3': 12}
/*< 49>*/ 									give_item(33 0x21);
/*< 51>*/ 									printf(/* textboxtype: 1, unk: 0, line: 23 */ "Te agradezco que me hayas traído ya\ntodas estas <color yellow<gemas de gratitud>coloroff>.\n\n\nPero me temo que voy a necesitar\ntodavía unas cuantas más. Por favor,\ncuento contigo...")
/*< 53>*/ 									scene_flags[0 'Skyloft'][73 /* 0x8 02 */] = true;
/*<139>*/ 									switch (context_related2(4)) {
          									  case 0:
/*<140>*/ 										printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00090d0b>¡Oh! ¡Tienes más! ¡Cuántas <color yellow<gemas\nde gratitud>coloroff>! ¡Es increíble!\n\n\n<0x10009:0x00070807>¡Toma, acepta esto como muestra\nde agradecimiento! ¡No te imaginas\nlo feliz que me haces!")
          										goto flw_165
          									  case 1:
/*<145>*/ 										scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          									}
          								  case 1:
/*< 48>*/ 									printf(/* textboxtype: 1, unk: 0, line: 17 */ "<0x10009:0x00000005>Me gustaría tanto ser una persona\nnormal... Por favor, ¡tráeme\n<color yellow<gemas de gratitud>coloroff>! \n\n¿Crees que podrías conseguirme,\ndigamos... <color red<40>coloroff>? Quizá con esas ya\nsea suficiente, con un poco de suerte.\n¡Muchas gracias de antemano!")
          								}
          							}
          						  case 1:
/*< 31>*/ 							switch (context_related2(2)) {
          							  case 0:
/*< 25>*/ 								printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x00090d0b>¡Increíble! ¡Me has traído muchas\n<color yellow<gemas de gratitud>coloroff>!\n\n\n<0x10009:0x00070807>Por favor, acepta esto como muestra\nde mi agradecimiento.")
          								flw_24:
/*< 24>*/ 								give_item(109 0x6D);
/*< 26>*/ 								printf(/* textboxtype: 1, unk: 0, line: 23 */ "Te agradezco que me hayas traído ya\ntodas estas <color yellow<gemas de gratitud>coloroff>.\n\n\nPero me temo que voy a necesitar\ntodavía unas cuantas más. Por favor,\ncuento contigo...")
/*< 47>*/ 								scene_flags[0 'Skyloft'][72 /* 0x8 01 */] = true;
/*<137>*/ 								switch (context_related2(3)) {
          								  case 0:
/*<138>*/ 									printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00090d0b>¡Oh! ¡Tienes más! ¡Cuántas <color yellow<gemas\nde gratitud>coloroff>! ¡Es increíble!\n\n\n<0x10009:0x00070807>¡Toma, acepta esto como muestra\nde agradecimiento! ¡No te imaginas\nlo feliz que me haces!")
          									goto flw_164
          								  case 1:
/*< 99>*/ 									scene_flags[0 'Skyloft'][83 /* 0xB 08 */] = true;
          								}
          							  case 1:
/*< 64>*/ 								printf(/* textboxtype: 1, unk: 0, line: 16 */ "<0x10009:0x00000005>Me gustaría tanto ser una persona\nnormal... Por favor, ¡tráeme\n<color yellow<gemas de gratitud>coloroff>! \n\n¿Crees que podrías conseguirme,\ndigamos... <color red<30>coloroff>? Quizá con esas ya\nsea suficiente, con un poco de suerte.\n¡Muchas gracias de antemano!")
          							}
          						}
          					  case 1:
/*< 30>*/ 						switch (context_related2(1)) {
          						  case 0:
/*< 43>*/ 							printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x00090d0b>¡Increíble! ¡Me has traído muchas\n<color yellow<gemas de gratitud>coloroff>!\n\n\n<0x10009:0x00070807>Por favor, acepta esto como muestra\nde mi agradecimiento.")
          							flw_42:
/*< 42>*/ 							give_item(94 0x5E);
/*< 44>*/ 							printf(/* textboxtype: 1, unk: 0, line: 22 */ "Por lo visto, necesito más <color yellow<gemas\nde gratitud >coloroff>para convertirme en\nuna persona normal...\n\nTráeme más, por favor...\n¡Eres el único que puede ayudarme!...")
/*< 45>*/ 							scene_flags[0 'Skyloft'][71 /* 0x9 80 */] = true;
/*<135>*/ 							switch (context_related2(2)) {
          							  case 0:
/*<136>*/ 								printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00090d0b>¡Oh! ¡Tienes más! ¡Cuántas <color yellow<gemas\nde gratitud>coloroff>! ¡Es increíble!\n\n\n<0x10009:0x00070807>¡Toma, acepta esto como muestra\nde agradecimiento! ¡No te imaginas\nlo feliz que me haces!")
          								goto flw_24
          							  case 1:
          							}
          						  case 1:
/*< 40>*/ 							printf(/* textboxtype: 1, unk: 0, line: 15 */ "<0x10009:0x00000005>Me gustaría tanto ser una persona\nnormal... Por favor, ¡tráeme\n<color yellow<gemas de gratitud>coloroff>! \n\n¿Crees que podrías conseguirme,\ndigamos... <color red<10>coloroff>? Quizá con esas ya\nsea suficiente, con un poco de suerte.")
          						}
          					}
          				  case 1:
/*< 63>*/ 					switch (context_related2(0)) {
          					  case 0:
/*< 22>*/ 						printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x00090d0b>¡Increíble! ¡Me has traído muchas\n<color yellow<gemas de gratitud>coloroff>!\n\n\n<0x10009:0x00070807>Por favor, acepta esto como muestra\nde mi agradecimiento.")
/*< 21>*/ 						give_item(108 0x6C);
/*< 23>*/ 						printf(/* textboxtype: 1, unk: 0, line: 22 */ "Por lo visto, necesito más <color yellow<gemas\nde gratitud >coloroff>para convertirme en\nuna persona normal...\n\nTráeme más, por favor...\n¡Eres el único que puede ayudarme!...")
/*< 38>*/ 						scene_flags[0 'Skyloft'][70 /* 0x9 40 */] = true;
/*<133>*/ 						switch (context_related2(1)) {
          						  case 0:
/*<134>*/ 							printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00090d0b>¡Oh! ¡Tienes más! ¡Cuántas <color yellow<gemas\nde gratitud>coloroff>! ¡Es increíble!\n\n\n<0x10009:0x00070807>¡Toma, acepta esto como muestra\nde agradecimiento! ¡No te imaginas\nlo feliz que me haces!")
          							goto flw_42
          						  case 1:
          						}
          					  case 1:
...
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 1, line: 30 */ "<0x10009:0x0000000b>A ver... ¡Aaaargh!<0x10005:0x003c0000>")
/*< 67>*/ 	make_actor_do_something(0, 0)
/*<119>*/ 	wait_frames(40)
/*< 68>*/ 	printf(/* textboxtype: 1, unk: 1, line: 31 */ "<0x10009:0x00000004><0x10008:0x02cd>¡Uaaargh!<0x10005:0x001e0000>")
