...
/*< 28>*/ 		printf(/* textboxtype: 1, unk: 2, line: 26 */ "¡Todo listo, <heroname>!\n¡Ánimo, puedes hacerlo!")
/*< 31>*/ 		set_camera(10, 0)
...
/*<  3>*/ 			switch (temp_flags[1 /* 0x1 02 */]) {
          			  case 0:
/*< 39>*/ 				printf(/* textboxtype: 2, unk: 2, line: 17 */ "<0x10012:0x00000004>Amo <heroname>, la recolección\nde <color yellow<lágrimas >coloroff>ha fracasado.")
...
/*< 33>*/ 			printf(/* textboxtype: 2, unk: 2, line: 1 */ "Este es el último de los juicios\ndel espíritu: la <color blue<Hypnea de la Diosa>coloroff>.")
/*< 37>*/ 			set_camera(9, 0)
...
/*< 26>*/ 			printf(/* textboxtype: 2, unk: 2, line: 2 */ "Cuando se complete la última\n<color yellow<orquídea del espíritu>coloroff>, el <0x10012:0x00000002>amo\nserá reconocido como el héroe\nelegido por la Diosa.\nEntonces se revelará la puerta\nque lleva hasta la <color yellow white<Trifuerza>coloroff>.\nEs imprescindible superar con\néxito esta última prueba.\n¿Hay alguna cosa que el <0x10012:0x00000002>amo\ndesee preguntar?\n[1-]Sí[2]No")
/*< 14>*/ 			switch (choice(2)) {
          			  case 0:
...
/*< 18>*/ 					wait_frames(15)
          					flw_71:
/*< 71>*/ 					set_camera(1, 0)
/*< 60>*/ 					printf(/* textboxtype: 2, unk: 2, line: 4 */ "¿Alguna otra pregunta, <0x10012:0x00000001>amo?\n\n\n[1-]Orquídea\ndel espíritu[2-]Guardianes[3-]Fluido\nhypneo[4]No, gracias")
          					goto flw_59
          				  case 1:
/*< 61>*/ 					printf(/* textboxtype: 2, unk: 2, line: 10 */ "<0x10012:0x00000005>Muy bien, amo. He aquí la información\nsolicitada.")
/*< 65>*/ 					set_camera(6, 0)
/*< 67>*/ 					printf(/* textboxtype: 2, unk: 2, line: 11 */ "Nada más poner un pie fuera\nde este círculo, los llamados\n<color red<guardianes >coloroff>perseguirán al <0x10012:0x00000002>amo.")
/*< 64>*/ 					set_camera(4, 0)
...
/*< 69>*/ 					printf(/* textboxtype: 2, unk: 2, line: 14 */ "En este mundo existe una especie\nde líquido llamado <color red<fluido hypneo>coloroff>.\n\n\nSi el <0x10012:0x00000001>amo posa un pie sobre él,\nlos <color red<guardianes detectarán\nde inmediato su presencia>coloroff>.\n\nPor lo tanto, aconsejo caminar\ncon los ojos bien abiertos.")
          				  ...
          				  case 3:
          					flw_78:
/*< 78>*/ 					printf(/* textboxtype: 2, unk: 2, line: 5 */ "<0x10012:0x00000005>De acuerdo, amo.")
/*< 76>*/ 					set_camera(10, 0)
