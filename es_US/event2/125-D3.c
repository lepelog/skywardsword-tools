...
/*< 12>*/ 	start()
/*< 13>*/ 	printf(/* textboxtype: 7, unk: 0, line: 7 */ "Busca las <color red<piedras brillantes >coloroff>tras\ncada una de las estatuas. Si las\ngolpeas en orden desde abajo,\nabrirás la puerta sin trabajo.")
          }

          void entrypoint_125_05() {
/*< 14>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 2, unk: 0, line: 8 */ "Ruego a mi <0x10012:0x00000001>amo que observe\natentamente.")
/*< 24>*/ 	set_camera(1, 0)
/*< 22>*/ 	printf(/* textboxtype: 2, unk: 0, line: 9 */ "Ese emblema de ahí es el <color red<símbolo\nde Farore>coloroff>.\n\n\nPercibo cómo el poder sagrado de la\n<color yellow white<Trifuerza >coloroff>emana de él.")
/*< 36>*/ 	set_camera(2, 0)
/*< 23>*/ 	printf(/* textboxtype: 2, unk: 0, line: 10 */ "Recomiendo atravesar esa puerta para\nllegar hasta el símbolo.")
/*< 54>*/ 	set_camera(-1, 0)
          }

          void entrypoint_125_06() {
/*< 15>*/ 	start()
/*< 25>*/ 	printf(/* textboxtype: 2, unk: 0, line: 8 */ "Ruego a mi <0x10012:0x00000001>amo que observe\natentamente.")
/*< 26>*/ 	set_camera(3, 0)
/*< 19>*/ 	printf(/* textboxtype: 2, unk: 0, line: 14 */ "Ese emblema de ahí es el <color red<símbolo\nde Nayru>coloroff>.\n\n\nPercibo cómo el poder sagrado de la\n<color yellow white<Trifuerza >coloroff>emana de él.\n\n\nPero parece que el camino que\nlleva hasta allí está actualmente\nbloqueado.")
/*< 37>*/ 	set_camera(5, 0)
/*< 38>*/ 	printf(/* textboxtype: 2, unk: 0, line: 16 */ "Si el <0x10012:0x00000001>amo observa con atención, verá\nallí un <color yellow<orbe cronolítico>coloroff>.")
/*< 27>*/ 	set_camera(-1, 0)
...
/*< 16>*/ 	start()
/*< 30>*/ 	printf(/* textboxtype: 2, unk: 0, line: 8 */ "Ruego a mi <0x10012:0x00000001>amo que observe\natentamente.")
/*< 29>*/ 	set_camera(4, 0)
/*< 20>*/ 	printf(/* textboxtype: 2, unk: 0, line: 17 */ "Ese emblema de ahí es el <color red<símbolo de\nDin>coloroff>.\n\n\nPercibo cómo el poder sagrado de la\n<color yellow white<Trifuerza >coloroff>emana de él.")
/*< 31>*/ 	set_camera(-1, 0)
...
/*< 33>*/ 	switch (scene_flags[122 /* 0xE 04 */]) {
          	  case 0:
/*< 21>*/ 		printf(/* textboxtype: 2, unk: 0, line: 19 */ "Aviso para el <0x10012:0x0000000b>amo: ya hemos visitado\nesta sala. Se trata de la misma\nque albergaba el <color red<símbolo de Din>coloroff>.")
          		flw_39:
/*< 39>*/ 		set_camera(6, 0)
/*< 34>*/ 		printf(/* textboxtype: 2, unk: 0, line: 20 */ "Calculo un 60% de probabilidades\nde que la fuente de la que emana el\npoder sagrado se encuentre más allá\nde esta lava.")
/*< 41>*/ 		set_camera(-1, 0)
/*< 40>*/ 		printf(/* textboxtype: 2, unk: 0, line: 22 */ "Sugiero hacer acopio de valor y seguir\navanzando.")
          	  case 1:
...
/*< 44>*/ 	start()
/*< 49>*/ 	set_camera(7, 0)
/*< 43>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "Aviso importante: hemos llegado hasta\nel símbolo.\n\n\nRuego a mi <0x10012:0x0000000b>amo que consagre su\nespada para que le indique el camino\nhacia la <color yellow white<Trifuerza>coloroff>.")
          }

          void entrypoint_125_12() {
/*< 46>*/ 	start()
/*< 50>*/ 	set_camera(8, 0)
/*< 45>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "Aviso importante: hemos llegado hasta\nel símbolo.\n\n\nRuego a mi <0x10012:0x0000000b>amo que consagre su\nespada para que le indique el camino\nhacia la <color yellow white<Trifuerza>coloroff>.")
          }

          void entrypoint_125_13() {
/*< 48>*/ 	start()
/*< 51>*/ 	set_camera(9, 0)
/*< 47>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "Aviso importante: hemos llegado hasta\nel símbolo.\n\n\nRuego a mi <0x10012:0x0000000b>amo que consagre su\nespada para que le indique el camino\nhacia la <color yellow white<Trifuerza>coloroff>.")
          }
