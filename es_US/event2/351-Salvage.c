...
/*< 25>*/ 	start()
/*< 26>*/ 	printf("\x0E\x01\x12\x04\x00\x01Amo, sugiero que regresemos\nal cielo para llevar al mogma\na su lugar de destino.")
...
/*< 30>*/ 	start()
/*< 31>*/ 	printf("\x0E\x01\x12\x04\x00dOtra vez... ¡no hace falta que repitas\nsiempre lo mismo!")
          }

          void entrypoint_351_01() {
          	start()
/*<  1>*/ 	printf("Confirmo la similitud de este objeto\ncon la bola de cristal del adivino y la\nposibilidad de usarlo como sustitutivo.\n\nRecomiendo llamar al robot de\nla chatarrería para que venga\na recogerlo.\n[1]Adelante[2-]No")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf("\x0E\x01\x12\x04\x00\x05Sí, amo. Avisaré al robot\ntelepáticamente.")
          	  case 1:
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x05Está bien, amo. En caso de cambiar\nde opinión, sugiero volver a buscar\nel objetivo.")
          	}
          }

          void entrypoint_351_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf("\x0E\x01\x12\x04\x00d¡Hola, Fay, preciosidad!\n¡Aquí estoy otra vez!\n\n\n¿Quieres que me lleve esto?")
          }

          void entrypoint_351_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf("¡Muy bien, a volar! Te espero en\nel cielo. ¡Espero verte pronto!")
          }

          void entrypoint_351_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf("\x0E\x01\x12\x04\x00\x01Amo, sugiero regresar al cielo\nde inmediato para llevar el cristal\na su destino.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf("\x0E\x01\x12\x04\x00d¡Amo verdoso, no es justo! ¡A ti siempre\nte toca el trabajo más fácil!")
          }
