...
/*< 47>*/ 	switch (zone_temp_flags[1 /* 0x1 02 */]) {
          	  case 0:
/*< 48>*/ 		printf("\x0E\x01\x09\x04\x00\x0B¿Qué? ¿No te pide el cuerpo cortar\nun poco de bambú? ¡Solo son <r<10 rupias\n>>por intento!\n[1]Claro[2]¿Cómo se\njuega?[3-]Mejor no")
          		flw_3:
/*<  3>*/ 		switch (choice(3)) {
          		  case 0:
          			flw_16:
...
/*<  2>*/ 						printf("\x0E\x01\x09\x04\x10\x700Bueno, muchacho. ¡Si quieres dar\nunos cuantos cortes, no dudes en venir\na verme!")
