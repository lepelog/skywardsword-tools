...
/*<120>*/ 							printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00030900>The last <color red<power generator>coloroff> is here, vrrm.")
/*<119>*/ 							{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 118, 'param3': 34}
/*<118>*/ 							printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x00030900>You can do it, phoo-weep!")
          							goto flw_19
          						  case 1:
...
/*< 23>*/ 						printf(/* textboxtype: 1, unk: 0, line: 7 */ "<0x10009:0x00030900>You will need to activate the <color red<power\ngenerators >coloroff>in two different locations,\nzrrt.")
/*< 22>*/ 						{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 21, 'param3': 34}
/*< 21>*/ 						printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x00030900>You can do it, phoo-weep!")
          						goto flw_19
          					}
          				}
          			  case 1:
/*<108>*/ 				printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00030900>You're a human, aren't you, brrzrrt?\nSo how did you get in here, vweep?")
          		  ...
          		  case 1:
/*< 97>*/ 			printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x00090c00>I'm scared, brrzrrt... Please remove\nthose monsters and get us out of here,\nphoo-weep.")
...
/*<121>*/ 	switch (story_flags[259 /* us: 805A9AF6 0x20, jp: 805ACD76 0x20 */]) {
          	  case 0:
/*< 13>*/ 		printf(/* textboxtype: 1, unk: 0, line: 17 */ "<0x10009:0x00030900>You really came to save us, vweep!\nMy circuits are glowing with\nhappiness, vrrm!")
          		flw_15:
...
/*<128>*/ 		set_camera(-1, 0)
/*< 43>*/ 		printf(/* textboxtype: 1, unk: 0, line: 23 */ "<0x10009:0x00030900>You can get to the captain's cabin\nthrough a door on the deck in the\nback, vrrm.")
...
/*<125>*/ 			printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x00030900>.<pause 5>.<pause 5>.<pause 5>\n\n\n\n<0x10009:0x00030900>So you came with <color blue<Skipper>coloroff> to rescue us,\nvrrm?! You've made us so happy, zrrt!")
          			goto flw_15
          		  case 1:
/*<124>*/ 			printf(/* textboxtype: 1, unk: 0, line: 28 */ "<0x10009:0x00030900>You're a human, right, vrrm?\nHow did you get in here, zrrt?")
          			goto flw_125
          		}
          	}
          }
...
/*< 25>*/ 	start()
/*< 37>*/ 	set_camera(2, 0)
/*< 26>*/ 	printf(/* textboxtype: 1, unk: 0, line: 31 */ "<0x10009:0x00030900><0x30001:0x><heroname>! Good job, vweep!")
/*< 38>*/ 	set_camera(3, 0)
...
/*< 27>*/ 	printf(/* textboxtype: 1, unk: 0, line: 32 */ "<0x10009:0x00030900>It's still pretty dangerous here, so I'll\njust wait in the boat, zrrt.\n\n\n<0x10009:0x00030900>You can do it, vrrm!")
...
/*< 75>*/ 	start()
/*< 76>*/ 	printf(/* textboxtype: 2, unk: 0, line: 40 */ "<0x10012:0x00000001>Master, I conjecture that this is the\n<color red<key >coloroff>to the <sound 4>control room mentioned by\nthe crew.")
/*< 79>*/ 	{'type': 'type3', 'subType': 4, 'param1': 1278, 'param2': 0, 'next': 77, 'param3': 30}
/*< 77>*/ 	printf(/* textboxtype: 2, unk: 0, line: 41 */ "My memory indicates that the location\nof the <color blue<door to the control room >coloroff>is\nmarked with the (X) symbol.")
/*< 80>*/ 	{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 78, 'param3': 34}
/*< 78>*/ 	printf(/* textboxtype: 2, unk: 0, line: 42 */ "I suggest you quickly make your way to\nthe <color blue<control room>coloroff>.")
          }

          void entrypoint_401_12() {
/*< 81>*/ 	start()
/*< 82>*/ 	printf(/* textboxtype: 2, unk: 0, line: 43 */ "<0x10012:0x00000001>Master, please look.")
/*< 91>*/ 	set_camera(8, 0)
/*< 89>*/ 	printf(/* textboxtype: 2, unk: 0, line: 44 */ "This large door here is sealed shut.")
/*< 92>*/ 	set_camera(-1, 0)
/*< 90>*/ 	printf(/* textboxtype: 2, unk: 0, line: 45 */ "This door must lead to an important\nroom in the ship.")
          }

          void entrypoint_401_13() {
/*< 83>*/ 	start()
/*< 84>*/ 	printf(/* textboxtype: 2, unk: 0, line: 46 */ "Warning, <0x10012:0x00000001>Master.")
/*< 95>*/ 	set_camera(9, 0)
/*< 93>*/ 	printf(/* textboxtype: 2, unk: 0, line: 47 */ "I sense an evil presence on the other\nside of this door.")
/*< 96>*/ 	set_camera(-1, 0)
/*< 94>*/ 	printf(/* textboxtype: 2, unk: 0, line: 48 */ "There is a 90% chance it is the primary\nbody mass of the creature whose\ntentacles are destroying this ship.\n\nI suggest making all necessary\npreparations before exiting to\nthe outside of the ship.")
          }
