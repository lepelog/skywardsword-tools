...
/*< 26>*/ 				switch (story_flags[475 /* us: 805A9B0E 0x80, jp: 805ACD8E 0x80 */]) {
          				  case 0:
/*< 42>*/ 					printf(/* textboxtype: 1, unk: 0, line: 38 */ "<0x10009:0x00000004>Heh heh heh... You've come to take\nback the <color blue<Horned Colossus Beetle>coloroff>, eh?\n[1-]Of course![2]Nope.")
          					flw_50:
/*< 50>*/ 					switch (choice(2)) {
          					  case 0:
...
/*<117>*/ 									switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 66}) {
          									  case 0:
/*< 40>*/ 										rupees += -10;
/*< 41>*/ 										printf(/* textboxtype: 1, unk: 0, line: 37 */ "<0x10009:0x00040100>Well then, go get ten insects of my\nchoosing!\n\n\n<0x10009:0x00030100>I'll be timing you. You've got to get\nten insects <color red<within three minutes>coloroff>.\n\n\n<0x10009:0x00000100>If you somehow do it, I'll give the\n<color blue<Horned Colossus Beetle>coloroff> back.\n\n\nAll right then, get set!")
/*< 37>*/ 										make_actor_do_something(1, 0)
          									  case 1:
/*<119>*/ 										printf(/* textboxtype: 1, unk: 0, line: 14 */ "<0x10009:0x00130807>Hold on! Just hold it. You still don't\nhave a <color yellow<Bug Net>coloroff>! Why am I wasting my\ntime with you?\n\n<0x10009:0x00040100>Come back when you finally get around\nto buying one!")
          									}
          								  case 1:
/*<106>*/ 									printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10009:0x00120813>Think you can go bug catching with\nso few <color red<hearts>coloroff>? You're not taking this\nseriously. It's not looking good for you.\n\n<0x10009:0x00000100>Come back once you get some\nmore hearts.")
          								}
          							  case 1:
/*< 39>*/ 								printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x00120315>Looks like you don't have enough\nmoney. So what if we went to the\nKnight Academy together? I'm not\ncutting you any deals.")
          							}
          						  case 1:
          							flw_52:
...
/*< 17>*/ 		switch (choice(2)) {
          		  case 0:
/*< 14>*/ 			printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x00120500>So you really are quitting... I guess you\ndon't appreciate bugs like I do.")
/*< 18>*/ 			make_actor_do_something(3, 0)
          		  case 1:
/*< 16>*/ 			printf(/* textboxtype: 1, unk: 0, line: 11 */ "I know, right? Time flies when you're\ncatching bugs!")
          		}
          	  case 2:
...
/*< 45>*/ 				{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': -1, 'param3': 45}
          			  case 1:
/*< 21>*/ 				printf(/* textboxtype: 1, unk: 0, line: 20 */ "<0x10009:0x00120500>It's pretty sad that you can't see just\nhow fun catching bugs can be.\n\n\n<0x10009:0x00000100>But come back when you change\nyour mind!")
          			  case 2:
...
/*<126>*/ 				printf(/* textboxtype: 1, unk: 0, line: 28 */ "<0x10009:0x00ffff00>Take good care of them for me...")
          			  case 1:
...
/*<127>*/ 				printf(/* textboxtype: 1, unk: 0, line: 28 */ "<0x10009:0x00ffff00>Take good care of them for me...")
          			}
          		}
          	  case 1:
...
/*< 74>*/ 				printf(/* textboxtype: 1, unk: 0, line: 43 */ "<0x10009:0x00040500>Make sure to tell Beedle that, bug\nlover to bug lover, I feel sort of bad\nfor causing him so much stress.")
