...
/*<117>*/ 				switch (choice(2)) {
          				  case 0:
/*<121>*/ 					printf("\x0E\x01\x09\x04\x00\x03Ah! That's the answer I was\nlooking for.\nTake to the skies, Link!")
