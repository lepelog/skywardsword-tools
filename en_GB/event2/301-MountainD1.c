...
/*<  3>*/ 	printf(/* textboxtype: 1, unk: 0, line: 2 */ "Blast! I must have dropped it earlier...")
...
/*< 18>*/ 		printf(/* textboxtype: 1, unk: 0, line: 13 */ "Now you've got my <color yellow<Bomb Bag>coloroff>.\nGo find your friend!")
/*<106>*/ 		{'type': 'type3', 'subType': 1, 'param1': 3, 'param2': -1, 'next': -1, 'param3': 42}
          	  case 1:
/*< 36>*/ 		printf(/* textboxtype: 1, unk: 0, line: 11 */ "<0x10009:0x00001004>He's worried? About me?<pause 15> What kind\nof pal am I, putting him through that?\n\n\n<0x10009:0x00ff08ff>You must be worried too. Not knowing\nif your friend's dead or alive...\n\n\n<0x10009:0x00141209>I'm not letting you borrow my bag,\nthough. Nope. I'm GIVING it to you!\nJust don't blow yourself up...")
          		goto flw_105
          	  case 2:
...
/*< 14>*/ 	start()
/*< 15>*/ 	printf(/* textboxtype: 20, unk: 0, line: 31 */ "Earth Temple")
          }
...
/*< 70>*/ 	wait_frames(10)
/*< 51>*/ 	set_camera(2, 0)
/*< 40>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x0d0805ff>Oh, it's you.")
/*< 79>*/ 	set_camera(10, 0)
/*< 78>*/ 	printf(/* textboxtype: 1, unk: 0, line: 23 */ "<0x10009:0x0d0005ff>Let me see<pause 1>.<pause 1>.<pause 1>.<pause 1> <pause 8>No, that's not it.<pause 20> This is\nso very embarrassing, but I seem to be\nat a loss for your name.\n\n<0x10009:0x0d0a05ff>Not that it matters, really. To tell you\nthe truth, I'm feeling a bit frustrated,\nand right now I just need someone to\nvent to.")
...
/*< 41>*/ 	start()
/*< 42>*/ 	printf(/* textboxtype: 2, unk: 0, line: 18 */ "<0x10012:0x0000000b>Master, I detect Zelda's aura in the\nsurrounding area.")
/*< 44>*/ 	set_camera(1, 0)
/*< 43>*/ 	printf(/* textboxtype: 2, unk: 0, line: 19 */ "I detect an especially strong reaction\nfrom this chain. I calculate the\nprobability Zelda was bound by it\nrecently at 95%.")
/*< 45>*/ 	set_camera(-1, 0)
/*< 46>*/ 	printf(/* textboxtype: 2, unk: 0, line: 20 */ "I surmise Zelda was somehow able to\nescape and proceed along this path.\nI suggest we continue with all possible\nspeed.")
          }
