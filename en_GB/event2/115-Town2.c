...
/*<481>*/ 				switch (context_related2(1)) {
          				  case 0:
/*<489>*/ 					printf("\x0E\x01\x09\x04\x12\x600How about <numeric arg0> Rupees for each\n<y<<string arg0>>>?")
          					flw_656:
...
/*<482>*/ 				switch (context_related2(1)) {
          				  case 0:
/*<490>*/ 					printf("\x0E\x01\x09\x04\x12\x600How about <numeric arg1> Rupees for each\n<y<<string arg1>>>?")
          					goto flw_656
          				  case 1:
          					goto flw_494
          				}
...
/*<483>*/ 				switch (context_related2(1)) {
          				  case 0:
/*<491>*/ 					printf("\x0E\x01\x09\x04\x12\x600How about <numeric arg2> Rupees for each\n<y<<string arg2>>>?")
          					goto flw_656
          				  case 1:
          					goto flw_494
          				}
...
/*<484>*/ 				switch (context_related2(1)) {
          				  case 0:
/*<492>*/ 					printf("\x0E\x01\x09\x04\x12\x600How about <numeric arg3> Rupees for each\n<y<<string arg3>>>?")
          					goto flw_656
          				  case 1:
          					goto flw_494
          				}
...
/*<452>*/ 									switch (context_related2(0)) {
          									  case 0:
/*<456>*/ 										printf("\x0E\x01\x09\x04\x03\x14<numeric arg0> <y<<string arg0>>>, eh?\nI'll give you <numeric arg1> Rupees.\n[1]OK![2-]Never mind.")
/*<449>*/ 										switch (choice(2)) {
          										  case 0:
...
/*<178>*/ 			switch (choice(2)) {
          			  case 0:
/*<179>*/ 				printf("\x0E\x01\x09\x04\x00\x411Ahh, Link. You really\nwant to hear about all my troubles?\nThat's kind of you.")
          				flw_181:
