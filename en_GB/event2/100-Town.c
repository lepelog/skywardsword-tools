...
/*<120>*/ 	switch (zone_temp_flags[13 /* 0x0 20 */]) {
          	  case 0:
/*<126>*/ 		printf(/* textboxtype: 1, unk: 0, line: 11 */ "<0x10009:0x000c1252><0x10008:0x02cd>I've had it!<0x1000D:0x1906>\n\n\n\n<0x1000A:0x000f00cd>I'm going to have a word with\nthe headmaster about having you\nexpelled!")
          	  case 1:
