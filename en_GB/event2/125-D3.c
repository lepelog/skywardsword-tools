...
/*< 12>*/ 	start()
/*< 13>*/ 	printf(/* textboxtype: 7, unk: 0, line: 7 */ "Seek the <color red<gemstones>coloroff> that sleep\nbehind each statue. If you strike\nthem in order from lowest to\nhighest, the door will open.")
          }

          void entrypoint_125_05() {
/*< 14>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 2, unk: 0, line: 8 */ "<0x10012:0x00000001>Master, look over that way.")
/*< 24>*/ 	set_camera(1, 0)
/*< 22>*/ 	printf(/* textboxtype: 2, unk: 0, line: 9 */ "The design carved into the floor there\nis the <color red<mark of Farore>coloroff>.\n\n\nI detect the sacred power of the\n<color yellow white<Triforce>coloroff> emanating from its vicinity.")
/*< 36>*/ 	set_camera(2, 0)
/*< 23>*/ 	printf(/* textboxtype: 2, unk: 0, line: 10 */ "To reach the area where that mark is\nlocated, I propose you pass through the\ndoor in front of you.")
/*< 54>*/ 	set_camera(-1, 0)
          }

          void entrypoint_125_06() {
/*< 15>*/ 	start()
/*< 25>*/ 	printf(/* textboxtype: 2, unk: 0, line: 8 */ "<0x10012:0x00000001>Master, look over that way.")
/*< 26>*/ 	set_camera(3, 0)
/*< 19>*/ 	printf(/* textboxtype: 2, unk: 0, line: 14 */ "I have identified the design on the floor\nthere as the <color red<mark of Nayru>coloroff>.\n\n\nI detect the sacred power of the\n<color yellow white<Triforce>coloroff> radiating from it.\nUnfortunately, the way leading to\nthe mark is closed off.")
/*< 37>*/ 	set_camera(5, 0)
/*< 38>*/ 	printf(/* textboxtype: 2, unk: 0, line: 16 */ "There appears to be a <color yellow<Timeshift Orb>coloroff>\nover there.")
/*< 27>*/ 	set_camera(-1, 0)
...
/*< 16>*/ 	start()
/*< 30>*/ 	printf(/* textboxtype: 2, unk: 0, line: 8 */ "<0x10012:0x00000001>Master, look over that way.")
/*< 29>*/ 	set_camera(4, 0)
/*< 20>*/ 	printf(/* textboxtype: 2, unk: 0, line: 17 */ "The symbol visible on the floor here is\nthe <color red<mark of Din>coloroff>.\n\n\nI detect the sacred power of the\n<color yellow white<Triforce>coloroff> emanating from its vicinity.")
/*< 31>*/ 	set_camera(-1, 0)
...
/*< 33>*/ 	switch (scene_flags[122 /* 0xE 04 */]) {
          	  case 0:
/*< 21>*/ 		printf(/* textboxtype: 2, unk: 0, line: 19 */ "<0x10012:0x0000000b>Master, I have information for you.\nThe chamber you stand in now is the\nsame one where you previously spotted\nthe <color red<mark of Din>coloroff>.")
          		flw_39:
/*< 39>*/ 		set_camera(6, 0)
/*< 34>*/ 		printf(/* textboxtype: 2, unk: 0, line: 20 */ "If you can find a way through the river\nof magma, I calculate a 60% chance\nyou will arrive at one of the sources\nof sacred power.")
/*< 41>*/ 		set_camera(-1, 0)
/*< 40>*/ 		printf(/* textboxtype: 2, unk: 0, line: 22 */ "I recommend you press forward in\nsearch of the power present here.")
          	  case 1:
...
/*< 44>*/ 	start()
/*< 49>*/ 	set_camera(7, 0)
/*< 43>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "<0x10012:0x0000000b>Master <heroname>, you have\nreached the mark. Offer your sword\nto it.\n\nIf you do this, I calculate a high\nprobability that you will be shown\nthe way to a part of the <color yellow white<Triforce>coloroff>.")
          }

          void entrypoint_125_12() {
/*< 46>*/ 	start()
/*< 50>*/ 	set_camera(8, 0)
/*< 45>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "<0x10012:0x0000000b>Master <heroname>, you have\nreached the mark. Offer your sword\nto it.\n\nIf you do this, I calculate a high\nprobability that you will be shown\nthe way to a part of the <color yellow white<Triforce>coloroff>.")
          }

          void entrypoint_125_13() {
/*< 48>*/ 	start()
/*< 51>*/ 	set_camera(9, 0)
/*< 47>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "<0x10012:0x0000000b>Master <heroname>, you have\nreached the mark. Offer your sword\nto it.\n\nIf you do this, I calculate a high\nprobability that you will be shown\nthe way to a part of the <color yellow white<Triforce>coloroff>.")
          }
