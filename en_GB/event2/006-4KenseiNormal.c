...
/*< 14>*/ 			switch (adventure_pouch_has(8 0x0008)) {
          			  ...
          			  case 1:
          				flw_11:
/*< 11>*/ 				printf(/* textboxtype: 2, unk: 0, line: 1 */ "You have elected to engage\n<color red<Hero Mode>coloroff>, so hearts and heart\nflowers will not appear. I recommend\nutilizing potions.")
          			}
          		  case 1:
          			goto flw_11
          		}
