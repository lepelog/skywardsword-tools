...
/*<137>*/ 		set_camera(9, 0)
          	  case 1:
/*<299>*/ 		printf("\x0E\x01\x09\x04\x00\x0BHuh...? It's gone quiet.")
...
/*<430>*/ 		printf("\x0E\x01\x08\x02\x2CDKweeee!")
...
/*<163>*/ 			switch (story_flags[56 /* us: 805A9ADC 0x08, jp: 805ACD5C 0x08 */]) {
          			  case 0:
/*<164>*/ 				printf("\x0E\x01\x09\x04\x00\x07Good to hear the elder is safe, kwee.\nI'm going to stay here for a while,\nthough, and wait until all those\nmonsters are out of here.")
          			  case 1:
/*<162>*/ 				printf("\x0E\x01\x09\x04\x00\x04I'm going to stay here for a while.\nIf you see the elder, kwee, would you\ntell him where I am?")
          			}
          		  case 1:
...
/*<171>*/ 				switch (story_flags[56 /* us: 805A9ADC 0x08, jp: 805ACD5C 0x08 */]) {
          				  case 0:
/*<172>*/ 					printf("\x0E\x01\x09\x04\x00\x07It's a relief to hear the elder is safe.\n\n\n\n\x0E\x01\x09\x04\x00\x13My legs are still shaking, kwee, so I'm \ngoing to stay here for a while.")
          				  case 1:
/*<170>*/ 					printf("\x0E\x01\x09\x04\x00\x04I'm going to rest here awhile. If you\nsee the elder, let him know I'm here,\nkoo-weep!")
          				}
          			  case 1:
...
/*<489>*/ 					printf("\x0E\x01\x09\x04\x18\x170BI see you got yourself a sword there.\nWhat do you say we try and crack the\nmystery of this cube together?\n[1]Sure![2]Nah.")
/*<491>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_490:
/*<490>*/ 						printf("\x0E\x01\x09\x04\x17\x1908Hey! Thanks a billion, bud!")
          						flw_493:
/*<493>*/ 						set_camera(37, 0)
          						goto flw_479
          					  case 1:
/*<492>*/ 						printf("\x0E\x01\x09\x04\x18\x170CAww, come on, I am begging you here!\nHelp me out?\n[1]OK.[2]Nope.")
/*<495>*/ 						switch (choice(2)) {
          						  case 0:
          							goto flw_490
          						  case 1:
/*<496>*/ 							printf("\x0E\x01\x09\x04\x08\x07OK, I get the picture. I will make sure\nthis is worth your while.")
/*<498>*/ 							give_item(161 0xA1);
/*<497>*/ 							printf("\x0E\x01\x09\x04\x17\x1906You would have to be crazy to refuse\nme now! Unless you are... You are not\ncrazy, are you?")
          							goto flw_493
          						}
          					}
          				  case 1:
/*<484>*/ 					printf("\x0E\x01\x09\x04\x17\x1908I tell you, your timing could not have\nbeen better.\n\n\nLook here. I stumbled onto one of\nthese things just now, and it looks just\nlike something I have seen in those\nancient texts!")
          					goto flw_499
          				}
          			}
          		  case 1:
...
/*<177>*/ 			switch (story_flags[56 /* us: 805A9ADC 0x08, jp: 805ACD5C 0x08 */]) {
          			  case 0:
/*<178>*/ 				printf("\x0E\x01\x09\x04\x00\x07You found him already?! I don't know\nhow you do it, but you sure do have a\nknack for spotting hidden things, kwee!")
          			  case 1:
/*<176>*/ 				printf("\x0E\x01\x09\x04\x00\x14I'm impressed you found me, kwee,\nbut you still haven't found the elder,\nright?")
          			}
          		  case 1:
...
/*<590>*/ 							printf("\x0E\x01\x09\x04\x00\x08Zelda\x0E\x01\x06\x02\xFDCD...?<pause0F>\n\n\n\nAh, the girl creature with the blonde\nhair. She looked like one of your kind.\nYes, she was with me, kweeee.\n\n\x0E\x01\x09\x04\x00\x0CBut now is not the time for such talk...\nThe woods are full of monsters. I am\nworried about my missing tribe.\n\nKweeee... The shock and worry has\nmade my memories of the girl quite\nhazy...")
          							flw_593:
/*<593>*/ 							set_camera(29, 0)
/*<591>*/ 							printf("\x0E\x01\x09\x04\x00\x0EWhat? You say you've met some of\nmy people, kweee?")
...
/*<537>*/ 							printf("\x0E\x01\x09\x04\x00\x08Zelda\x0E\x01\x06\x02\xFDCD...?<pause0F>\n\n\n\nAh, the girl creature with the blonde\nhair. She looked like one of your kind.\nYes, she was with me, kweeee.\n\n\x0E\x01\x09\x04\x00\x0CBut now is not the time for such talk...\nThe woods are full of monsters. I am\nworried about my missing tribe.\n\nKweeee... The shock and worry has\nmade my memories of the girl quite\nhazy...")
          							flw_540:
/*<540>*/ 							set_camera(29, 0)
/*<538>*/ 							printf("\x0E\x01\x09\x04\x00\x0EWhat? You say you've met some of\nmy people, kweee?")
/*<536>*/ 							printf("\x0E\x01\x09\x04\x00\x03Hmm... So Machi, Oolo and Erla are\nsafe, are they? Oh, but there are still\nmonsters lurking in the forest, so I\ndare not leave this spot, kwee.")
/*<542>*/ 							set_camera(-1, 0)
/*<543>*/ 							switch (temp_flags[3 /* 0x1 08 */]) {
          							  case 0:
          								flw_412:
/*<412>*/ 								printf("\x0E\x01\x09\x04\x00\x08<r<One more >><r<Kikwi>> remains unaccounted\nfor, kweee. Would you mind searching\nfor him to see if he's OK?\n\n\x0E\x01\x09\x04\x00\x02He likes to climb trees, so I'd suggest\nyou search the treetops for him,\nkwee.\n\nBy the way, I haven't forgotten about\nthe girl you search for. Give me just a\nbit more time, and I'm sure I can recall\nsomething about where she was headed.")
          								goto flw_180
          							  case 1:
/*<544>*/ 								printf("\x0E\x01\x09\x04\x00\x08And you're looking for one of your\nlost people as well?\n\n\nHmmm... Yes. At one point during the\nmonster panic here, I did speak with a\nblonde girl of your kind, kweee.\n\n\x0E\x01\x09\x04\x00\x0CBut now is not the time for such talk.\nThe forest is full of monsters, and I am\nworried about my missing tribe.\n\nKweee... The shock and worry has\nmade my memories of the girl quite\nhazy...")
          								goto flw_412
          							}
          						  case 1:
          							goto flw_540
...
/*<336>*/ 	start()
/*<337>*/ 	printf("\x0E\x01\x05\x04K\x00\x0E\x01\x12\x04\x00\x01Master, you have entered <b<Faron Woods>>.")
...
/*<338>*/ 	start()
/*<339>*/ 	printf("\x0E\x01\x05\x04K\x00The plentiful water in this region\nclearly sustains a large diversity\nof flora, including this massive tree.")
          }

          void entrypoint_200_93() {
/*<445>*/ 	start()
/*<446>*/ 	printf("\x0E\x01\x09\x04\x00\x01Now, there is a face I know. Hey, bud!")
...
/*<340>*/ 	start()
/*<341>*/ 	printf("\x0E\x01\x05\x04K\x00It is logical that the lush plant life and\nwater resources have attracted animal\nspecies to the region.")
          }
...
/*<516>*/ 		switch (scene_flags[37 /* 0x5 20 */]) {
          		  case 0:
/*<515>*/ 			printf("\x0E\x01\x09\x04\x00\x02\x0E\x01\x08\x02\x2CDHey, do not run off!\n\n\n\nI need your help figuring out the secret\nof these Goddess Cubes.")
          			flw_465:
...
/*<142>*/ 	start()
/*<143>*/ 	printf("\x0E\x01\x09\x04\x00\x02With that slingshot, kwee, you should\nbe able to find a path into the deep\nwoods where that temple is.")
/*<380>*/ 	set_camera(21, 0)
...
/*<392>*/ 			printf("\x0E\x01\x09\x04\x00\x06Now go find that girl! I'll be rooting\nfor you. Kwee heh heh.")
/*<398>*/ 			set_camera(25, 0)
/*<399>*/ 			{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': -1, 'next': -1, 'param3': 42}
          		  case 1:
/*<395>*/ 			printf("\x0E\x01\x09\x04\x00\x06Now go find that girl! I'll be rooting\nfor you. Kwee heh heh.")
/*<396>*/ 			set_camera(24, 0)
/*<397>*/ 			{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': -1, 'next': -1, 'param3': 42}
          		}
          	  case 1:
/*<389>*/ 		printf("\x0E\x01\x09\x04\x00\x08To start, why not try shooting that\ncurled-up vine over there?")
          		goto flw_391
          	}
          }
...
/*<519>*/ 		switch (scene_flags[37 /* 0x5 20 */]) {
          		  case 0:
/*<518>*/ 			printf("\x0E\x01\x09\x04\x00\x02\x0E\x01\x08\x02\x2CDHey, do not run off!\n\n\n\nI need your help figuring out the secret\nof these Goddess Cubes.")
          			flw_474:
...
/*<512>*/ 			{'type': 'type3', 'subType': 1, 'param1': 4, 'param2': -1, 'next': -1, 'param3': 42}
          		  case 1:
/*<520>*/ 			printf("\x0E\x01\x09\x04\x00\x02\x0E\x01\x08\x02\x2CDHold up, bud!\n\n\n\nI need to ask you a favor.")
          			goto flw_474
          		}
          	  case 1:
/*<471>*/ 		scene_flags[1 'Faron Woods'][34 /* 0x5 04 */] = true;
/*<482>*/ 		scene_flags[1 'Faron Woods'][36 /* 0x5 10 */] = true;
/*<470>*/ 		printf("\x0E\x01\x09\x04\x00\x03\x0E\x01\x08\x02\x2CDHold it, bud!\n\n\n\n\x0E\x01\x09\x04\x17\x600Do not walk on by like you do not see \nme when I know you do.<pause0F> Are you mad\nat  me or something?\n[1]Sorry![2]I don't like you.")
/*<468>*/ 		switch (choice(2)) {
          		  case 0:
/*<467>*/ 			printf("\x0E\x01\x09\x04\x16\x1E07Oh, you are busy searching for your\nfriend. I get it. Sorry to get in your\nway, bud. Really, I am.\n\nBut this will not take long. Come help\nme out, will you?")
          			goto flw_474
          		  case 1:
/*<469>*/ 			printf("\x0E\x01\x09\x04\x16\x1E56Oh. Ouch. Is that so? I guess it is just\nhow it is for us explorer types. We are\nfated to be misunderstood.\n\nJust the same, could you take a few\nminutes to help me out?")
          			goto flw_474
          		}
          	}
          }
...
/*<369>*/ 						printf("\x0E\x01\x09\x04\x00\x14What WAS that just now, kwee? \nDon't scare me like that!")
...
/*<316>*/ 		printf("\x0E\x01\x09\x04\x00\x13Oh. That's too bad. But it sounds like\nyou at least know where you need to\nsearch next to find her, kwee.\nThat's...something, right?")
          		goto flw_319
          	}
          }
...
/*<296>*/ 						printf("\x0E\x01\x09\x04\x00\x0DI thought you were another monster.\nDon't scare me like that, koo-kwee!")
...
/*<614>*/ 						switch (story_flags[56 /* us: 805A9ADC 0x08, jp: 805ACD5C 0x08 */]) {
          						  case 0:
/*<250>*/ 							printf("I have marked<pling> the location of Lopsa\nthe Kikwi on your map. However,\ndowsing readings indicate there are\nstill Kikwis to search for.")
          							flw_307:
...
/*<252>*/ 							{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 295, 'param3': 36}
          							goto flw_295
          						  case 1:
/*<615>*/ 							printf("I have marked<pling> the location of Lopsa\nthe Kikwi on your map. Unfortunately,\nZelda is not with him.")
          							goto flw_307
          						}
          					}
          				  case 1:
...
/*<616>*/ 						switch (story_flags[56 /* us: 805A9ADC 0x08, jp: 805ACD5C 0x08 */]) {
          						  case 0:
/*<403>*/ 							printf("I have marked<pling> the location of Erla\nthe Kikwi on your map. However,\ndowsing readings indicate there are\nstill Kikwis to search for.")
          							goto flw_265
          						  case 1:
/*<617>*/ 							printf("I have marked<pling> the location of Erla\nthe Kikwi on your map. Unfortunately,\nZelda is not with him.")
          							goto flw_265
          						}
          					}
          				  case 1:
