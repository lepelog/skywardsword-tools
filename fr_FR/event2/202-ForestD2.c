...
/*< 44>*/ 	start()
/*< 45>*/ 	printf(/* textboxtype: 7, unk: 0, line: 5 */ "Frappe la gemme qui se\ncache au creux des yeux.\nLa bouche se fermera et\nle courant s'arrêtera.")
          }

          void entrypoint_202_05() {
/*< 46>*/ 	start()
/*< 47>*/ 	printf(/* textboxtype: 7, unk: 0, line: 2 */ "Les symboles gravés sur la\n<color red<grande statue de pierre\n>coloroff>dictent les <color red<règles >coloroff>de ce lieu.\n\nEn premier vient le <color red<dos>coloroff>,\npuis le <color red<séant>coloroff>, le <color red<dos de la\n>coloroff><color red<main droite >coloroff>et enfin le <color red<dos\nde la main gauche>coloroff>.")
/*< 48>*/ 	story_flags[1195 /* us: 805A9B61 0x02, jp: 805ACDE1 0x02 */] = true;
          }

          void entrypoint_202_11() {
/*<  6>*/ 	start()
/*<  7>*/ 	printf(/* textboxtype: 2, unk: 0, line: 9 */ "Si j'en crois nos expériences passées,\nla <color yellow<clé>coloroff> dont il est fait mention ici est\ncelle qui ouvre le mécanisme devant\nnous.")
          }
...
/*<  9>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 2, unk: 0, line: 11 */ "<0x10012:0x0000000b>Maître, Fay au rapport.\nJe détecte un grand coffre.\n\n\nLa probabilité qu'il contienne la <color yellow<clé\n>coloroff>qui ouvre la porte située en haut\nde la statue est de 85 %.")
          }
...
/*< 15>*/ 	printf(/* textboxtype: 1, unk: 0, line: 17 */ "Quelle obstination.<pause 5>.<pause 5>.")
/*< 19>*/ 	set_camera(3, 0)
/*< 16>*/ 	printf(/* textboxtype: 1, unk: 0, line: 18 */ "J'ai besoin de temps pour trouver\nle moyen de rappeler mon maître\nà la vie.<pause 5>.<pause 5>.")
/*< 20>*/ 	set_camera(4, 0)
/*< 30>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3334, 'param2': 512, 'next': 23, 'param3': 13}
/*< 23>*/ 	wait_frames(30)
/*< 22>*/ 	printf(/* textboxtype: 1, unk: 0, line: 19 */ "Pourquoi faut‐il toujours que des\ngêneurs comme toi viennent se\nmettre dans mes pattes ?")
...
/*< 13>*/ 	printf(/* textboxtype: 2, unk: 0, line: 12 */ "<0x10012:0x00000001>Maître, je détecte dans la partie\nsupérieure un mécanisme ressemblant\nà une porte avec serrure.")
/*< 43>*/ 	scene_flags[12 'Faron: Ancient Cistern'][107 /* 0xC 08 */] = true;
          }

          void entrypoint_202_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 7, unk: 0, line: 1 */ "Frappe les <color red<quatre pierres\n>coloroff>dans le bon ordre.\nLa voie s'ouvrira à celui qui\nsuivra les <color red<règles>coloroff> de ce lieu.")
          }
...
/*<  4>*/ 	start()
/*<  5>*/ 	printf(/* textboxtype: 7, unk: 0, line: 4 */ "Cherche la <color yellow<clé>coloroff> qui sommeille\nau fond de la terre.")
          }
