...
/*< 17>*/ 	start()
/*< 18>*/ 	printf(/* textboxtype: 1, unk: 0, line: 13 */ "Bon, je dépose la soupe ici.\n\n\n\nC'est pas très rassurant\ncomme endroit...")
          }

          void entrypoint_120_21() {
/*< 19>*/ 	start()
/*< 20>*/ 	printf(/* textboxtype: 1, unk: 0, line: 14 */ "Allez, je me sauve !<0x10005:0x00280000>")
...
/*< 32>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*< 34>*/ 		printf(/* textboxtype: 1, unk: 0, line: 11 */ "Hoho ! Tu as trouvé la Triforce !")
          		flw_35:
...
/*< 37>*/ 							story_flags[781 /* us: 805A9B2D 0x20, jp: 805ACDAD 0x20 */] = true;
          						  case 1:
/*<  3>*/ 							printf(/* textboxtype: 1, unk: 0, line: 2 */ "N'oublie pas à qui tu t'adresses...\n<pause 20>Mais passons.")
          							goto flw_4
          						}
          					}
          				}
