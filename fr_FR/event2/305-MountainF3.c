...
/*<  2>*/ 	printf("\x0E\x01\x09\x04\x00\x10TADAM !\nVoilà ton sauveur !")
...
/*<  4>*/ 	printf("\x0E\x01\x09\x04\x0D\xE0AT'es un sacré casse\x2010cou, frangin...\nQu'est\x2010ce que t'es venu faire par ici,\ncette fois ?\n[1]Eh bien...[2]Je cherche\ndes trésors")
/*<  6>*/ 	switch (choice(2)) {
          	  case 0:
...
/*< 19>*/ 			printf("\x0E\x01\x09\x04\x11\x110BBon, aujourd'hui, c'est mon jour de\nbonté, je vais te dire ce qu'il y a dans\nles coffres !\n\n... Et voilà !")
...
/*< 22>*/ 			printf("\x0E\x01\x09\x04\x0E\xE0BBien ! Moi, je retourne à la chasse\naux trésors !\n\n\nÀ plus !")
...
/*< 69>*/ 	switch (scene_flags[121 /* 0xE 02 */]) {
          	  case 0:
/*< 71>*/ 		printf("Hé ! J'ai de nouvelles visions !\nÇa t'intéresse ?[1]Oui[2-]Non merci")
          		flw_66:
/*< 66>*/ 		switch (choice(2)) {
          		  case 0:
/*< 68>*/ 			changeScene(2, 0) // 
...
/*< 67>*/ 			printf("Je vois... Dans ce cas, bon courage !")
          	  ...
          	  case 1:
/*< 65>*/ 		printf("Hé ! Je suis ici tout spécialement pour\nte montrer des visions ! Ça te dit ?\n[1]Oui[2-]Non merci")
...
/*< 79>*/ 		switch (story_flags[226 /* us: 805A9AF2 0x08, jp: 805ACD72 0x08 */]) {
          		  case 0:
/*< 81>*/ 			printf("Hé ! Je suis ici tout spécialement pour\nte montrer des visions ! Ça te dit ?\n[1]Oui[2-]Non merci")
          			flw_74:
/*< 74>*/ 			switch (choice(2)) {
          			  case 0:
/*< 76>*/ 				changeScene(2, 0) // 
...
/*< 75>*/ 				printf("Je vois... Dans ce cas, bon courage !")
          		  ...
          		  case 1:
/*< 80>*/ 			printf("Salut !<pause0A> J'ai rien de neuf en réserve\nmais je peux te montrer les anciennes\nvisions. Ça te dit ?\n[1]Oui[2-]Non merci")
          			goto flw_74
          		}
          	  case 1:
/*< 73>*/ 		printf("Hé ! Je suis ici tout spécialement pour\nte montrer des visions ! Ça te dit ?\n[1]Oui[2-]Non merci")
