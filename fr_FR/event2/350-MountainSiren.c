...
/*< 45>*/ 										temp_flags[7 /* 0x1 80 */] = false;
          										flw_32:
/*< 32>*/ 										printf("Rassemblez toutes les <y<larmes>>.\nJ'attendrai votre retour.")
          										flw_49:
