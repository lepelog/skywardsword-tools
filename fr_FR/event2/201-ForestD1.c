...
/*< 46>*/ 		printf(/* textboxtype: 1, unk: 0, line: 22 */ "Ah, la poisse ! C'était bien la peine que\nje m'embête à chaparder cette clé à\nces satanés monstres...")
...
/*< 45>*/ 			printf(/* textboxtype: 1, unk: 0, line: 24 */ "Enfin, moi, les clés, ça m'intéresse pas\ntant que ça. Ce que je veux, c'est des\ntrésors qui rapportent plus de blé !")
...
/*< 55>*/ 	printf(/* textboxtype: 1, unk: 0, line: 36 */ "On se connaît, non ?\nOuais, ça me revient, on s'est\ncroisés au volcan, c'est ça ?")
...
/*< 54>*/ 		printf(/* textboxtype: 1, unk: 0, line: 39 */ "On m'la fait pas à moi !\nTu empestes le trésor à des\nkilomètres.")
          		goto flw_61
          	}
          }
...
/*< 71>*/ 	printf(/* textboxtype: 1, unk: 0, line: 47 */ "Bon, moi, je vais rentrer.\nÀ la poche pleine !")
...
/*<117>*/ 		printf(/* textboxtype: 1, unk: 0, line: 48 */ "Hé là ! Tu crois quand même pas que\ntu vas prendre les trésors pour toi\ntout seul !")
/*<118>*/ 		{'type': 'type3', 'subType': 4, 'param1': 4373, 'param2': 3345, 'next': 119, 'param3': 13}
/*<119>*/ 		printf(/* textboxtype: 1, unk: 0, line: 49 */ "M'enfin...<pause 30> Y a un symbole bizarre\nqu'est apparu sur le mur, mais y a\npas l'air de se passer grand‐chose...")
/*<120>*/ 		{'type': 'type3', 'subType': 4, 'param1': 4372, 'param2': 2057, 'next': 121, 'param3': 13}
/*<121>*/ 		printf(/* textboxtype: 1, unk: 0, line: 50 */ "Je crois que le gros caillou s'est bien\npayé notre tête.")
...
/*<126>*/ 		printf(/* textboxtype: 1, unk: 0, line: 36 */ "On se connaît, non ?\nOuais, ça me revient, on s'est\ncroisés au volcan, c'est ça ?")
...
/*<153>*/ 			printf(/* textboxtype: 1, unk: 0, line: 40 */ "Toi aussi t'es venu parce que t'as\nentendu les histoires du type qui\nressemble à un gros caillou ?\n[1-]Le Goron ?[2-]Des histoires ?")
/*<134>*/ 			{'type': 'type3', 'subType': 4, 'param1': 4369, 'param2': 3339, 'next': 135, 'param3': 13}
/*<135>*/ 			printf(/* textboxtype: 1, unk: 0, line: 52 */ "C'est moi qui trouverai le\ntrésor en premier !")
...
/*<130>*/ 			printf(/* textboxtype: 1, unk: 0, line: 39 */ "On m'la fait pas à moi !\nTu empestes le trésor à des\nkilomètres.")
          			goto flw_152
          		}
          	}
          }
...
/*<178>*/ 			printf(/* textboxtype: 1, unk: 0, line: 34 */ "En fait quand j'y pense, nous autres\nMogmas, on a pas vraiment\nbesoin de clés.")
/*<183>*/ 			{'type': 'type3', 'subType': 4, 'param1': 4105, 'param2': 2050, 'next': 179, 'param3': 13}
/*<179>*/ 			printf(/* textboxtype: 1, unk: 0, line: 35 */ "Merci de m'avoir prévenu !\nJe retourne à la chasse\nau trésor !")
...
/*<176>*/ 			printf(/* textboxtype: 1, unk: 0, line: 32 */ "Ouais ! C'est cette clé !\nT'es allé la chercher\nexprès pour moi ?")
          			goto flw_182
          		}
          	  case 1:
...
/*<184>*/ 				printf(/* textboxtype: 1, unk: 0, line: 29 */ "Un type qui ressemble à un gros\ncaillou m'a dit qu'il y avait une\n<color yellow<sculpture dorée >coloroff>au fond de ce temple.\nElle ouvrirait une porte importante.")
/*<187>*/ 				{'type': 'type3', 'subType': 4, 'param1': 4117, 'param2': 3332, 'next': 186, 'param3': 13}
/*<186>*/ 				printf(/* textboxtype: 1, unk: 0, line: 31 */ "Dis donc...\nToi, t'as une tête à savoir\nquelque chose...")
          				goto flw_256
          			  case 2:
          			}
          		}
...
/*<235>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "Ah, la poisse ! C'était bien la peine que\nje m'embête à chaparder cette clé à\nces satanés monstres...")
...
/*< 39>*/ 	start()
/*< 40>*/ 	printf(/* textboxtype: 2, unk: 0, line: 10 */ "Les sbires de Ghirahim ont verrouillé\nla porte à nouveau. Il faut en retrouver\nla clé.")
