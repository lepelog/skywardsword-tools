...
/*< 44>*/ 	start()
/*< 49>*/ 	set_camera(7, 0)
/*< 43>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, Fay au\nrapport. Vous êtes arrivé jusqu'à\nl'emblème. Plantez\x2010y votre épée.\n\nVous devriez alors être conduit vers\nla <y+<Triforce>>.")
          }

          void entrypoint_125_12() {
/*< 46>*/ 	start()
/*< 50>*/ 	set_camera(8, 0)
/*< 45>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, Fay au\nrapport. Vous êtes arrivé jusqu'à\nl'emblème. Plantez\x2010y votre épée.\n\nVous devriez alors être conduit vers\nla <y+<Triforce>>.")
          }

          void entrypoint_125_13() {
/*< 48>*/ 	start()
/*< 51>*/ 	set_camera(9, 0)
/*< 47>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMaître Link, Fay au\nrapport. Vous êtes arrivé jusqu'à\nl'emblème. Plantez\x2010y votre épée.\n\nVous devriez alors être conduit vers\nla <y+<Triforce>>.")
          }
...
/*<  6>*/ 			story_flags[685 /* us: 805A9B21 0x04, jp: 805ACDA1 0x04 */] = true;
          		  case 1:
/*< 56>*/ 			printf("En exploitant ces changements,\nvous devriez pouvoir vous rendre dans\nles autres salles.")
          			goto flw_5
          		}
          	}
          }
