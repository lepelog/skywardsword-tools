...
/*< 40>*/ 		printf(/* textboxtype: 2, unk: 0, line: 22 */ "Je vous recommande d'avancer avec\ndétermination.")
          	  case 1:
/*< 35>*/ 		printf(/* textboxtype: 2, unk: 0, line: 21 */ "<0x10012:0x0000000b>Maître, Fay au rapport.\nJe détecte la présence d'une force\nsacrée dans cette salle.")
          		goto flw_39
          	}
          }
...
/*< 44>*/ 	start()
/*< 49>*/ 	set_camera(7, 0)
/*< 43>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "<0x10012:0x0000000b>Maître <heroname>, Fay au\nrapport. Vous êtes arrivé jusqu'à\nl'emblème. Plantez‐y votre épée.\n\nVous devriez alors être conduit vers\nla <color yellow white<Triforce>coloroff>.")
          }

          void entrypoint_125_12() {
/*< 46>*/ 	start()
/*< 50>*/ 	set_camera(8, 0)
/*< 45>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "<0x10012:0x0000000b>Maître <heroname>, Fay au\nrapport. Vous êtes arrivé jusqu'à\nl'emblème. Plantez‐y votre épée.\n\nVous devriez alors être conduit vers\nla <color yellow white<Triforce>coloroff>.")
          }

          void entrypoint_125_13() {
/*< 48>*/ 	start()
/*< 51>*/ 	set_camera(9, 0)
/*< 47>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "<0x10012:0x0000000b>Maître <heroname>, Fay au\nrapport. Vous êtes arrivé jusqu'à\nl'emblème. Plantez‐y votre épée.\n\nVous devriez alors être conduit vers\nla <color yellow white<Triforce>coloroff>.")
          }
...
/*<  3>*/ 		printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x0000000b>Maître, Fay au rapport.\nCes secousses semblent être la\nmanifestation d'un <color red<<sound 4>changement\nde structure >coloroff>du bâtiment.")
/*<  4>*/ 		{'type': 'type3', 'subType': 4, 'param1': 0, 'param2': 0, 'next': 55, 'param3': 30}
/*< 55>*/ 		switch (scene_flags[13 /* 0x0 20 */]) {
          		  case 0:
/*< 10>*/ 			printf(/* textboxtype: 2, unk: 2, line: 4 */ "Ce changement va vous permettre\nd'entrer dans la salle voisine.")
          			flw_5:
...
/*<  6>*/ 			story_flags[685 /* us: 805A9B21 0x04, jp: 805ACDA1 0x04 */] = true;
          		  case 1:
/*< 56>*/ 			printf(/* textboxtype: 2, unk: 2, line: 6 */ "En exploitant ces changements,\nvous devriez pouvoir vous rendre dans\nles autres salles.")
          			goto flw_5
          		}
          	}
          }
