...
/*< 42>*/ 									switch (temp_flags[7 /* 0x1 80 */]) {
          									  case 0:
/*< 46>*/ 										printf(/* textboxtype: 2, unk: 2, line: 26 */ "Les <color red<gardiens>coloroff> qui vous attaquent\net les <color red<veilleurs>coloroff> qui traquent les\nintrus peuvent être de deux\ntypes, <color red<terrestre ou céleste>coloroff>.\nChacun a un comportement\ndifférent, faites‐y très attention.")
...
/*< 11>*/ 			printf(/* textboxtype: 2, unk: 2, line: 6 */ "Vous voyez cet objet brillant\nen face de vous, <0x10012:0x00000002>Maître ?")
/*< 12>*/ 			set_camera(3, 0)
