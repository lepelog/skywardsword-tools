...
/*<509>*/ 			story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          		  case 1:
/*< 70>*/ 			printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ?\n<pause1E>Dans ce cas, je compte sur toi !")
          			goto flw_137
          		}
          	  case 1:
...
/*<507>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 58>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ?\n<pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_135
          	}
          }
...
/*< 72>*/ 	switch (scene_flags[65 /* 0x9 02 */]) {
          	  case 0:
/*< 74>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches,\nil faut que je voie des <y<flèches\n>>apparaître !\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que\ndisent les écrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		flw_73:
/*< 73>*/ 		switch (choice(2)) {
          		  case 0:
...
/*<510>*/ 			story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          		  case 1:
/*< 76>*/ 			printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ?\n<pause1E>Dans ce cas, je compte sur toi !")
          			goto flw_138
          		}
          	  case 1:
...
/*<508>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 64>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ?\n<pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_136
          	}
          }
...
/*<427>*/ 	switch (scene_flags[63 /* 0x6 80 */]) {
          	  case 0:
/*<429>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches,\nil faut que je voie une <y<fée>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que\ndisent les écrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		flw_428:
/*<428>*/ 		switch (choice(2)) {
          		  case 0:
...
/*<506>*/ 			story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          		  case 1:
/*<431>*/ 			printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ?\n<pause1E>Dans ce cas, je compte sur toi !")
          			goto flw_438
          		}
          	  case 1:
...
/*<511>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 82>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ?\n<pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_139
          	}
          }
...
/*<512>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 88>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ?\n<pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_140
          	}
          }
...
/*<513>*/ 		story_flags[427 /* us: 805A9B06 0x10, jp: 805ACD86 0x10 */] = true;
          	  case 1:
/*< 94>*/ 		printf("\x0E\x01\x09\x04\x08\x1E0ATu es sûr ?\n<pause1E>Dans ce cas, je compte sur toi !")
          		goto flw_141
          	}
          }
...
/*<452>*/ 							entrypoint_503_58();
          						  case 1:
/*<522>*/ 							printf("\x0E\x01\x09\x04\x00\x1B05On peut vraiment obtenir une grande\nfortune avec ces murs ?\n\n\n\x0E\x01\x09\x04\x08\xB00Veux\x2010tu que je te réexplique ce que\ndisent les écrits anciens ?\n\n\n[1]S'il te plaît ![2-]Ça ira")
          							goto flw_452
          						}
          					  case 1:
...
/*<628>*/ 								scene_flags[10 'Sealed Grounds'][69 /* 0x9 20 */] = true;
          				  ...
          				  case 1:
/*< 44>*/ 					printf("\x0E\x01\x09\x04\x08\xB07Allons, fais pas ton timide !\nÇa crève les yeux que tu meurs\nd'envie d'en savoir plus !\nJe vais te raconter !")
          					goto flw_53
          				}
          			}
          		  case 1:
...
/*<160>*/ 					entrypoint_503_62();
          				  case 1:
/*<529>*/ 					printf("\x0E\x01\x09\x04\x00\x1B05On peut vraiment obtenir une grande\nfortune avec ces murs ?\n\n\n\x0E\x01\x09\x04\x08\xB00Veux\x2010tu que je te réexplique ce que\ndisent les écrits anciens ?\n\n\n[1]S'il te plaît ![2-]Ça ira")
          					goto flw_160
          				}
          			  case 1:
...
/*< 78>*/ 	switch (scene_flags[61 /* 0x6 20 */]) {
          	  case 0:
/*< 80>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il\nfaut que je voie des <y<rubis>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que\ndisent les écrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_79
          	  case 1:
...
/*< 84>*/ 	switch (scene_flags[62 /* 0x6 40 */]) {
          	  case 0:
/*< 86>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il\nfaut que je voie des <y<c\x153urs>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que\ndisent les écrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_85
          	  case 1:
...
/*<503>*/ 					switch (choice(2)) {
          					  case 0:
/*<504>*/ 						printf("\x0E\x01\x09\x04%\x1B56Euh... ben... en fait...\nEn fait, pour l'instant, c'est tout ce que\nj'ai pu trouver !\n\n\x0E\x01\x09\x04\n\x1300Si j'en apprends plus, je te le dirai !")
          					  case 1:
...
/*<  6>*/ 			printf("\x0E\x01\x09\x04\x00\x01Tiens, comme on se retrouve !\nToujours débordé, à ce que je vois...\n\n\n\x0E\x01\x09\x04\x1B\x1300Moi aussi, depuis la dernière fois,\nj'ai passé mon temps à étudier\nles mystères de ce monde...\n\n\x0E\x01\x09\x04\x0E\x1300Tu veux que je te fasse part des\nconclusions de mes recherches ?\n[1]Oh oui ![2-]Euh, non\nmerci...")
/*< 14>*/ 			switch (choice(2)) {
          			  case 0:
/*< 15>*/ 				printf("\x0E\x01\x07\x04\x0E\x1908Tu vas pas être déçu !\nEn fait, au cours de mes recherches,\nj'ai découvert quelque chose.\n\nDans ce monde, \x0E\x01\x07\x04\x00\x1300il existe des <r<murs>> et\ndes <r<pierres>> qui réagissent aux <r<belles\nmélodies>> !\n\n\x0E\x01\x07\x04\x0E\x1300Tu veux en savoir plus ?\n[1]Bien sûr ![2-]Ça ira...")
/*< 17>*/ 				switch (choice(2)) {
          				  case 0:
...
/*< 19>*/ 					switch (choice(2)) {
          					  case 0:
/*< 20>*/ 						printf("Très bien, tu m'épargnes des\nexplications.")
          						goto flw_22
          					  case 1:
...
/*< 90>*/ 	switch (scene_flags[64 /* 0x9 01 */]) {
          	  case 0:
/*< 92>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches,\nil faut que je voie des <y<bombes>>\napparaître !\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que\ndisent les écrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_91
          	  case 1:
...
/*< 54>*/ 	switch (scene_flags[61 /* 0x6 20 */]) {
          	  case 0:
/*< 56>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il\nfaut que je voie des <y<rubis>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que\ndisent les écrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_55
          	  case 1:
...
/*< 60>*/ 	switch (scene_flags[62 /* 0x6 40 */]) {
          	  case 0:
/*< 62>*/ 		printf("\x0E\x01\x09\x04\x18\x1704Aujourd'hui, pour mes recherches, il\nfaut que je voie des <y<c\x153urs>> apparaître !\n\n\n<pause1E>... Veux\x2010tu que je te réexplique ce que\ndisent les écrits anciens ?\n[1]S'il te plaît ![2-]Pas la peine")
          		goto flw_61
          	  case 1:
...
/*<551>*/ 				printf("\x0E\x01\x09\x04\x13\xB04Tu sais quoi ? J'ai aperçu des <b<papillons\nazur >>pas loin d'ici !\n\n\n\x0E\x01\x09\x04\x16\x1E0BDommage que j'y connaisse rien\nen musique...\n\n\nSi seulement je savais jouer\nd'un instrument...")
          		  ...
          		  case 1:
/*<548>*/ 			printf("\x0E\x01\x09\x04\x13\x1953Voilà que ça recommence ! <pause1E>Mais\nqu'est\x2010ce qui peut bien se passer ?!\n\n\n\x0E\x01\x09\x04\x16\x1E00Peu importe ! Je dois poursuivre mes\nrecherches quoi qu'il arrive !")
          			goto flw_550
          		}
          	  case 1:
          		goto flw_550
