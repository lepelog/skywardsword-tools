...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0, line: 3 */ "<0x10012:0x00000064>Fay adorée !\nTu m'as appelé ?\n\n\nC'est bizarre, cet endroit me rend\ntout nostalgique...\n\n\nCette fois, c'est ça qu'il faut\ntransporter ?")
          }
...
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 2, unk: 0, line: 5 */ "<0x10012:0x00000001>Maître, je vous conseille de regagner\nle ciel pour remettre la roulette à son\npropriétaire au plus vite.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10012:0x00000064>Bon, toi, le maître en vert, reste\ntranquille. Laisse faire le pro !")
          }
