...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0, line: 3 */ "<0x10012:0x00000064>Dame Fay de mon cœur à moi !\nTu m'attendais, n'est‐ce pas ?\n\n\nOh, c'est ça qu'il faut porter ?")
          }

          void entrypoint_510_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 1, unk: 0, line: 4 */ "<0x10012:0x00000064>Bon, je l'emmène dans le ciel,\nvenez vite me rejoindre !")
          }
