...
/*< 65>*/ 	start()
/*< 69>*/ 	printf(/* textboxtype: 1, unk: 0, line: 33 */ "<0x10009:0x00070704>D'accord. T‐tu‐tu es sûr de vouloir\naméliorer cette potion ?\n[1-]Oui ![2]Non...")
/*< 70>*/ 	switch (choice(2)) {
          	  case 0:
/*<110>*/ 		make_actor_do_something(3, 0)
/*< 68>*/ 		printf(/* textboxtype: 1, unk: 0, line: 34 */ "<0x10009:0x00070700>Très bien. Un instant...")
/*< 99>*/ 		{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 0, 'next': 71, 'param3': 12}
/*< 71>*/ 		make_actor_do_something(1, 0)
/*< 72>*/ 		printf(/* textboxtype: 1, unk: 0, line: 35 */ "<0x10009:0x00070708>Et voilà ! C'est prêt !")
/*< 89>*/ 		zone_temp_flags[4 /* 0x1 10 */] = true;
          	  case 1:
/*< 73>*/ 		printf(/* textboxtype: 1, unk: 0, line: 36 */ "<0x10009:0x000a0a06>Ah, d'accord... Je peux faire autre\nchose pour toi ? Enfin, peut‐être ?")
...
/*< 90>*/ 	switch (zone_temp_flags[4 /* 0x1 10 */]) {
          	  case 0:
/*< 91>*/ 		printf(/* textboxtype: 1, unk: 0, line: 38 */ "<0x10009:0x00090908>Merci beaucoup !\nMerci, merci ! Reviens vite !")
          	  case 1:
/*< 75>*/ 		printf(/* textboxtype: 1, unk: 0, line: 37 */ "<0x10009:0x000a0a06>Pas de problème, c'est t‐t‐toi qui\ndécides. N'hésite pas à revenir. \nEnfin, si tu as envie...")
          	}
          }
...
/*< 96>*/ 				switch (scene_flags[89 /* 0xA 02 */]) {
          				  case 0:
/*< 43>*/ 					printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10009:0x000d070b>Les flacons vides sont rangés\ndans ta sacoche d'aventurier.\nAppuie sur (-) pour en choisir un.<0x10011:0x02cd>")
...
/*<134>*/ 	printf(/* textboxtype: 1, unk: 0, line: 44 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<criquets de Firone>coloroff>...\n\n\nSelon les écrits secrets, les <color yellow<criquets\nde Firone >coloroff>vivraient dans un endroit\noù la végétation est luxuriante. Enfin,\nje crois...")
          	flw_137:
...
/*<139>*/ 	printf(/* textboxtype: 1, unk: 0, line: 46 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<dynastes de Firone>coloroff>...\n\n\nSelon les écrits secrets, les <color yellow<dynastes\nde Firone >coloroff>vivent entre autres sur les\narbres d'une contrée à la végétation\nluxuriante. Enfin, je crois...")
          	goto flw_137
          }
...
/*<142>*/ 	printf(/* textboxtype: 1, unk: 0, line: 47 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<guêpes Mojo>coloroff>...\n\n\nD'après les écrits secrets, les\n<color yellow<guêpes Mojo>coloroff> font leur nid dans les\narbres d'une contrée à la végétation\nluxuriante. Enfin, je crois...")
          	goto flw_137
          }
...
/*<145>*/ 	printf(/* textboxtype: 1, unk: 0, line: 48 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<mantes célestes>coloroff>...\n\n\nLes <color yellow<mantes célestes>coloroff> sont assez\nnombreuses ici, à Célesbourg.\nEnfin, je crois...")
          	goto flw_137
          }
...
/*<148>*/ 	printf(/* textboxtype: 1, unk: 0, line: 49 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<pyroccinelles>coloroff>...\n\n\nSelon les écrits secrets, les\n<color yellow<pyroccinelles >coloroff>vivent sur une\nmontagne de feu. Enfin, je crois...")
          	flw_151:
...
/*< 31>*/ 	start()
/*< 35>*/ 	printf(/* textboxtype: 1, unk: 0, line: 14 */ "<0x10009:0x000c0b08>Ben alors ! Tu n'as pas assez\nd'argent. Tu es bien gentil mon\nbonhomme, mais je ne suis pas\nta mère !\n<0x10009:0x000a0a00>Reviens me voir quand\ntu auras de quoi payer.")
          }

          void entrypoint_106_75() {
/*<152>*/ 	start()
/*<154>*/ 	{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 0, 'next': 153, 'param3': 12}
/*<153>*/ 	printf(/* textboxtype: 1, unk: 0, line: 50 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<papillons azur>coloroff>...\n\n\nMême ici, à Célesbourg, on trouve\nbeaucoup de <color yellow<papillons azur>coloroff>.")
          	goto flw_151
          }
...
/*<156>*/ 	printf(/* textboxtype: 1, unk: 0, line: 51 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<fourmis de Lanelle>coloroff>...\n\n\nSelon les écrits secrets, les <color yellow<fourmis de\nLanelle >coloroff>vivent en colonies dans une\ncontrée sablonneuse. Enfin, je crois...")
          	goto flw_151
          }
...
/*<159>*/ 	printf(/* textboxtype: 1, unk: 0, line: 52 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<cigales des sables>coloroff>...\n\n\nSelon les écrits secrets, les <color yellow<cigales\ndes sables>coloroff> vivent dans une contrée\nsablonneuse. Enfin, je crois...")
          	goto flw_151
          }
...
/*<162>*/ 	printf(/* textboxtype: 1, unk: 0, line: 53 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<libellules Gerudo>coloroff>...\n\n\nSelon les écrits secrets, les <color yellow<libellules\nGerudo >coloroff>vivent dans les touffes d'herbe\nd'une contrée sablonneuse. Enfin,\nje crois...")
          	flw_165:
...
/*<167>*/ 	printf(/* textboxtype: 1, unk: 0, line: 54 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<bousiers d'Ordinn>coloroff>...\n\n\nD'après les écrits secrets, les <color yellow<bousiers\nd'Ordinn >coloroff>vivent sur une montagne de\nfeu. Enfin, je crois...")
          	goto flw_165
          }
...
/*<170>*/ 	printf(/* textboxtype: 1, unk: 0, line: 55 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<lucanes du bourg>coloroff>...\n\n\nLes <color yellow<lucanes du bourg >coloroff>sont les insectes\nles plus célèbres de Célesbourg...")
          	goto flw_165
          }
...
/*<173>*/ 	printf(/* textboxtype: 1, unk: 0, line: 56 */ "<0x10009:0x0000000a>Pour réaliser ce mélange, il ne te\nmanque que des <color yellow<lucielles>coloroff>...\n\n\nLes <color yellow<lucielles>coloroff> sont des insectes rares\nqu'on peut apercevoir la nuit ici,\nà Célesbourg.")
          	goto flw_165
          }
...
/*< 24>*/ 			printf(/* textboxtype: 1, unk: 0, line: 20 */ "<0x10009:0x00000004>Cette marmite contient de la <color yellow<potion\nd'oxygène>coloroff>. Si tu bois cette potion,\nta <color blue<jauge d'oxygène >coloroff>se videra moins\nvite pendant un certain temps.\nTu veux en acheter ?\nC'est <color red<20 rubis >coloroff>le flacon.\n[1-]Oui ![2]Non merci")
          			goto flw_11
          		  case 1:
/*<125>*/ 			printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x000c0b04>Cette potion est encore en cours de\npréparation, elle est pas prête. Ça\ndevrait plus prendre beaucoup de\ntemps, un peu de patience !\n<0x10009:0x00090700>On a plein d'autres potions en rayon,\nalors jettes‐y un œil !")
          		}
          	  case 1:
...
/*<119>*/ 			switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 44}) {
          			  case 0:
          				flw_62:
/*< 62>*/ 				printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00000001>Euh, bien le bonjour, mon enfant !\nBienvenue à la boutique de potions.\nNous vendons les meilleures du\nmarché ! Enfin, peut‐être...\nDans cette marmite, je peux améliorer\nles potions que tu as achetées à ma\nfemme. Enfin, si tu veux...\n\n<0x10009:0x00070700>Très bien... T‐tu veux que j'améliore...\neuh... oui, une potion ?\n[1-]Oui[2]Non")
/*< 63>*/ 				switch (choice(2)) {
          				  case 0:
/*< 94>*/ 					switch (context_related2(0)) {
          					  case 0:
/*< 66>*/ 						printf(/* textboxtype: 1, unk: 0, line: 27 */ "<0x10009:0x00000003>Très bien. Voyons ce que je peux faire\npour toi...")
...
/*<121>*/ 				switch (zone_temp_flags[6 /* 0x1 40 */]) {
          				  case 0:
/*<123>*/ 					printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10009:0x00000001>Si tu n'as pas encore de <color yellow<filet\nà papillons>coloroff>, tu peux en acheter\nun à la <color red<boutique de Terry>coloroff>.\n\nLa boutique de Terry plane\nau‐dessus du marché couvert.\n\n\nSi tu veux la trouver, regarde dans\nle ciel à l'aide de la <color green<vue subjective>coloroff>.\nEnfin, si ça ne te dérange pas trop...")
          				  case 1:
/*<117>*/ 					{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 120, 'param3': 31}
/*<120>*/ 					printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x00000001>B‐bienvenue à la boutique de potions.\n\n\n\nDans cette marmite, je peux améliorer\nles potions que tu as achetées à ma\nfemme. Enfin, je crois.\n\n<0x10009:0x00000007>Mais pour concocter mes mixtures,\nil me faut des... ah oui, des insectes.\n\n\nSi tu n'as pas encore de <color yellow<filet\nà papillons>coloroff>, tu peux en acheter\nun à la <color red<boutique de Terry>coloroff>.\n\n<0x10009:0x00070708>La boutique de Terry plane\nau‐dessus du marché couvert.\n\n\nSi tu veux la trouver, regarde dans\nle ciel à l'aide de la <color green<vue subjective>coloroff>.\nEnfin, je voudrais surtout pas te\nforcer...")
...
/*<179>*/ 					printf(/* textboxtype: 1, unk: 0, line: 31 */ "<0x10009:0x00000001>B‐bienvenue... Comment ?\nTu as quelque chose à me montrer ?\n\n\nAh, je suis vraiment désolé, mais j'ai\nbeaucoup de travail, là. Tu ne voudrais\npas revenir me voir la <color red<nuit>coloroff> chez moi,\nsi ça ne te dérange pas ?\nMerci bien.")
