...
/*< 13>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 12>*/ 		printf(/* textboxtype: 2, unk: 4, line: 26 */ "We zijn er, <heroname>! Laat maar\neens zien wat je kunt!")
/*< 15>*/ 		set_camera(10, 0)
...
/*< 20>*/ 				temp_flags[1 /* 0x1 02 */] = true;
          		  ...
          		  case 1:
/*<  3>*/ 			printf(/* textboxtype: 2, unk: 2, line: 0 */ "<0x10012:0x00000004>Meester <heroname>.")
/*<  4>*/ 			{'type': 'type3', 'subType': 1, 'param1': 31, 'param2': 1, 'next': 2, 'param3': 40}
/*<  2>*/ 			printf(/* textboxtype: 4, unk: 2, line: 1 */ "U staat in <color blue<Dins Rijk der Stilte>coloroff>, waar de\nderde beproeving op u wacht. Deze keer\nzal uw <color red<kracht>coloroff> op de proef gesteld worden.\n\nOm de laatste vlam te bereiken die uw\nzwaard zal stalen,<0x10012:0x00000002> moet u zich aan deze\nbeproeving onderwerpen en spirituele\ngroei doormaken.")
/*<  5>*/ 			set_camera(9, 0)
...
/*<  6>*/ 			printf(/* textboxtype: 2, unk: 4, line: 2 */ "Zodra uw <color yellow<spirituele bloem>coloroff> vol is, zal uw\nspirituele groei voltooid zijn en zal de\ngodin u zegenen met een <color red<nieuwe kracht>coloroff>.\n\nHeeft u nog vragen?\n[1-]Ja![2]Nee.")
/*< 10>*/ 			switch (choice(2)) {
          			  case 0:
...
/*< 51>*/ 				switch (choice(4)) {
          				  case 0:
/*< 52>*/ 					printf(/* textboxtype: 4, unk: 2, line: 7 */ "Ja, <0x10012:0x00000005>meester.\n\n\n\nOm de <color yellow<spirituelebloem>coloroff> te vullen moet u de\n<color yellow<tranen van Din>coloroff> vinden en verzamelen.\nZij zijn verspreid over dit Rijk der Stilte.")
/*< 59>*/ 					set_camera(2, 0)
/*< 58>*/ 					{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': 0, 'next': 56, 'param3': 40}
/*< 56>*/ 					printf(/* textboxtype: 2, unk: 4, line: 8 */ "<0x10012:0x00000002>Meester, ziet u het lichtgevende object\nvoor u?")
/*< 55>*/ 					set_camera(3, 0)
/*< 54>*/ 					printf(/* textboxtype: 2, unk: 2, line: 9 */ "Dat is een <color yellow<traan van Din>coloroff>. U dient er <color red<15>coloroff>\nte verzamelen.")
...
/*< 62>*/ 					set_camera(5, 0)
/*< 61>*/ 					printf(/* textboxtype: 4, unk: 2, line: 13 */ "U moet de <color yellow<tranen>coloroff> die verspreid zijn over\ndit gebied, vergaren en uw <color yellow<spirituele\nbloem>coloroff> vullen zonder geraakt te worden\ndoor een aanval.")
          					goto flw_77
          				  case 2:
...
/*< 69>*/ 					printf(/* textboxtype: 2, unk: 4, line: 14 */ "De bijzondere vloeibare substantie die u in\nhet gebied aantreft, staat bekend als\n<color red<ontwaakwater>coloroff>. Dit water heeft een aantal\nunieke eigenschappen.\nAls u ontwaakwater aanraakt, zullen de\n<color red<Hoeders direct van uw aanwezigheid op\nde hoogte zijn>coloroff>.\n\nOveral in het landschap bevinden zich\npoelen van dit ontwaakwater. Ik raad u\naan om goed te kijken waar u loopt.")
          				  ...
          				  case 3:
          					flw_70:
/*< 70>*/ 					printf(/* textboxtype: 2, unk: 4, line: 5 */ "Begrepen, <0x10012:0x00000005>meester.")
/*< 71>*/ 					set_camera(10, 0)
