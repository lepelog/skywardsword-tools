...
/*<241>*/ 	start()
/*<237>*/ 	printf("¡Tu tirachinas ahora es un <y<tirachinas\nmúltiple>>! El área de impacto ha\naumentado. ¡Mantén pulsado \x0E\x02\x04\x02\x29CD\npara disparar a lo grande!\x0E\x01\x11\x02\xFCD")
          }
...
/*< 10>*/ 	start()
          	printf("¡Has conseguido <y<invencibline 2000>>! Es una\npotente poción con la que serás invencible\ndurante <r<3 minutos>>.")
          }
...
/*<510>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 1, 'next': -1, 'param3': 34}
          	  case 1:
/*<513>*/ 		printf("También indica la ubicación de los cofres\nde tesoros, ¡así que no te olvides de\nutilizarlo a menudo!")
...
/*< 96>*/ 	start()
/*< 38>*/ 	printf("¡Has conseguido el <y<telescarabajo>>! Es un\nobjeto con forma de insecto que puede\nvolar libremente.\n\n¡Apunta con el cursor adonde quieras que\nvaya y luego pulsa \x0E\x02\x04\x02\x29CD para que eche a volar!\x0E\x01\x11\x02\xFCD")
...
/*<105>*/ 	start()
/*< 47>*/ 	printf("¡Has conseguido <y<10 bombas>>! Lánzalas o\nhazlas rodar con fines destructivos.\n¡Llévatelas en tu saco de bombas!")
          }
