...
/*<183>*/ 	start()
/*<184>*/ 	printf("Cuando vayas montado en pelícaro,\npuedes consultar los controles de\nvuelo siempre que quieras con solo\npulsar \x0E\x02\x04\x02\x13CD.\x0E\x01\x11\x02\xBCD\nAdemás, recuerda que puedes <r<acelerar\n>>y también <g<atacar >>o <r<frenar>>.\n¡Pruébalo tú mismo!")
...
/*<  3>*/ 	printf("Estaba segura de que te encontraría\naquí, Link...\n\n\n\x0E\x01\n\x04\x17ÍMe dijeron que habías ido hacia la\ngruta de la cascada, así que estaba\ntratando de localizarte desde arriba.\n\nBueno, dime, ¿has encontrado a tu\npelícaro?\n")
/*< 76>*/ 	printf("\x0E\x01\x09\x04\x100\x514Ya veo...\n\n\n\n\x0E\x01\x09\x04\x100\xC00¡Espera! Si no me equivoco, justo ahí\ndetrás hay un sitio al que Malton\nsuele ir mucho con sus amigotes.\n¡Vamos a echar un vistazo!")
/*<138>*/ 	set_camera(22, 0)
...
/*<  5>*/ 	printf("¡Mira! ¡Ahí está!")
/*< 21>*/ 	set_camera(2, 0)
/*< 14>*/ 	printf("\x0E\x01\x09\x04\x09\x500\x0E\x01\x08\x02\x1CD¡Es tu pelícaro, Link!")
...
/*< 23>*/ 	printf("\x0E\x01\x09\x04\x0C\xE09Tu pelícaro es un animal fuera de serie.\nCon lo mal que ha debido de pasarlo el\npobrecito y, míralo, está como si nada.\n\n\x0E\x01\x09\x04\x00\xC00Te veo luego, voy a darle la buena\nnoticia a mi padre.")
/*< 64>*/ 	set_camera(10, 0)
...
/*< 32>*/ 	printf("\x0E\x01\x09\x04\x419\x1715¡¡¡Uaaah!!!")
...
/*< 98>*/ 	set_camera(18, 0)
/*< 35>*/ 	printf("\x0E\x01\x09\x04\x505\x13\x0E\x01\x09\x04\x607\x00¡Jefe, espera! ¡Que ya vamos!\x0E\x01\x05\x04\x14\x00")
...
/*< 40>*/ 		printf("¡El torneo celeste va a comenzar!\n¡Que vengan aquí todos los alumnos\nparticipantes!")
/*< 59>*/ 		{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': 100, 'next': 41, 'param3': 16}
/*< 41>*/ 		printf("Te llaman, Link.\n¡Mucha suerte!")
/*< 70>*/ 		changeScene(18, 0) // 
          	  case 1:
/*< 38>*/ 		printf("\x0E\x01\x09\x04\x0C\x1500¿Cómo? Solo tienes que esforzarte\nun poco, hombre.\n¡Vamos, ten más confianza!")
          		goto flw_101
          	  case 2:
/*< 39>*/ 		printf("\x0E\x01\x09\x04\x10\xE04¡Pero bueno! \n¿Tú también, Link?\n¡Menudo momento para pensar en esas\ncosas!...")
          		goto flw_101
          	}
          }
...
/*<122>*/ 	printf("\x0E\x01\x0D\x02\x1906\x0E\x01\x08\x02\x1CD¡Link!")
          }
