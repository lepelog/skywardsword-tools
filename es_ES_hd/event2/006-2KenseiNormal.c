...
/*< 34>*/ 		printf("Sin embargo, un misterioso personaje\nla ha encontrado y se dirige con ella\nhacia otro lugar.\n\nSugiero obrar del mismo modo que\nen el <b<manantial de la contemplación\n>>y pedir consejo a la efigie de\nla Diosa del <b<manantial terrenal>>.<entrypoint_296>")
          	  case 1:
/*< 35>*/ 		printf("La probabilidad de hallar a Zelda sana\ny salva es cada vez menor. Resulta\nimperativo dar con ella cuanto antes.<entrypoint_296>")
          	}
          }
...
/*< 78>*/ 	switch (story_flags[269 /* us: 805A9AF9 0x80, jp: 805ACD79 0x80 */]) {
          	  case 0:
/*< 80>*/ 		printf("Recomiendo llevarle cuanto antes la\ncarta náutica al almirante.<entrypoint_296>")
          	  case 1:
/*< 79>*/ 		printf("Confirmo que antes de recuperar el\nbarco será necesario buscar la carta\nnáutica en la casa del <b<almirante>>.<entrypoint_296>")
          	}
          }
...
/*< 23>*/ 	switch (story_flags[130 /* us: 805A9AE4 0x01, jp: 805ACD64 0x01 */]) {
          	  case 0:
/*< 24>*/ 		printf("Sugiero seguir el consejo de la anciana\ndel <b<templo del presidio >>y dirigirnos\nal <b<bosque de Farone>>.<entrypoint_296>")
          	  case 1:
