...
/*< 82>*/ 		switch (zone_temp_flags[19 /* 0x3 08 */]) {
          		  case 0:
          			flw_84:
/*< 84>*/ 			printf("\x0E\x01\x09\x04\x00\x04Estoy convencido de que \nencontrarás a Zelda. Seguro que sí.\n\n\n¡Confío en ti, Link!")
