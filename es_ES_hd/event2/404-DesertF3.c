...
/*<112>*/ 						scene_flags[9 'Lanayru Gorge'][23 /* 0x3 80 */] = true;
          					  case 1:
/*<133>*/ 						printf(/* textboxtype: 0, unk: 1, line: 16 */ "<0x10009:0x00030900>¡Pues ya que estás aquí, podrías echarnos\nuna mano! Hay que encontrar una tierra\nfértil donde la semilla pueda germinar.\n\n<0x10009:0x00030900>Está visto que aquí en la <color red<región de\nLanayru >coloroff><sound 4><color red<el terreno no es propicio>coloroff>...\nPor favor, ¡cuento contigo!")
          						goto flw_72
          					}
          				}
          			  case 1:
/*<  4>*/ 				printf(/* textboxtype: 0, unk: 1, line: 13 */ "<0x10009:0x00030c00>La enfermedad del <color blue<dragón del trueno>coloroff>\nse agrava día tras día...<pause 15> Y encima este\nterreno no es idóneo<pause 30> para que crezca\nningún árbol. <0x10009:0x00010c00>Aaah...")
          			}
          		}
          	}
          }
...
/*<148>*/ 				scene_flags[9 'Lanayru Gorge'][35 /* 0x5 08 */] = true;
          				goto flw_154
          			  case 1:
/*<157>*/ 				printf(/* textboxtype: 0, unk: 1, line: 52 */ "<0x10009:0x2f080d02>Dime, <heroname>...\n\n\n\n¿Qué ha pasado con la famosa <color blue<llama\nsagrada>coloroff>?\n\n\n¡Me tienes en ascuas desde que me\nhablaste de ella!\n\n\n(<0x10009:0x2f080407>.<pause 20>.<pause 20>.<pause 20>)\nAsí que al final has conseguido\nencontrarla. ¡Fantástico!\n\nEres toda una inspiración para los\narqueólogos, <heroname>.")
/*<171>*/ 				printf(/* textboxtype: 0, unk: 0, line: 53 */ "<0x10009:0x2f080d0a>¿Sabes? Tengo novedades sobre la\nleyenda de los tres dragones.<pause 15>\n\n\nResulta que justo aquí delante había\nuna senda oculta de lo más misteriosa.\n\n\nSe trata de un<color red< estrecho pasadizo>coloroff><sound 4>\npor el que no quepo.\n\n\n<0x10009:0x2f000d00>Sospecho que lleva hasta la morada del\n<color red<dragón del trueno>coloroff>.\n\n\n<0x10009:0x2f000800>Seguro que los robots de por aquí\nguardan relación con todo el misterio.<pause 15>\n\n\n<0x10009:0x2f010807><0x10006:0xffcd>El <color red<dragón del trueno>coloroff>, robots,\ncronolitos<pause 20>.<pause 20>.<pause 20>.<pause 20>\n\n\n<0x10009:0x2f080708><0x10008:0x02cd><0x10008:0x02cd>¡Menuda aventura!")
          				goto flw_148
          			}
          		}
          	}
...
/*< 24>*/ 	switch (temp_flags[0 /* 0x1 01 */]) {
          	  case 0:
/*< 25>*/ 		printf(/* textboxtype: 0, unk: 1, line: 31 */ "¡Como no te des prisa al final vas a\nquedarte rezagado!")
          	  case 1:
/*< 71>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 12, 'param3': 31}
/*< 12>*/ 		printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10009:0x00030900>Aquí hay cronolitos a montones, y a cual\nmás grande.<pause 30> <0x10009:0x00000900>¿Tú también vienes enviado\npor el <color blue<dragón del trueno>coloroff>?\n\n<0x10009:0x00010900>Pues justo ahora iba a llevar este\ncronolito a su augusta presencia.")
/*< 18>*/ 		temp_flags[0 /* 0x1 01 */] = true;
/*< 87>*/ 		set_camera(1, 0)
/*< 86>*/ 		printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10005:0x00280000>El camino está infestado de bicharracos\nde lo más feos...<pause 15> <0x10009:0x00030c00>Ve con mucho cuidado.")
          	}
          }
...
/*<134>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 48>*/ 			printf(/* textboxtype: 0, unk: 1, line: 37 */ "¡El dragón del trueno está de un\nhumor excelente!")
          		  case 1:
...
/*< 57>*/ 		switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 28}) {
          		  case 0:
/*< 58>*/ 			printf(/* textboxtype: 0, unk: 0, line: 38 */ "¿Has encontrado el fruto?...<pause 45>\n¡Tienes que llevarle el fruto al <color blue<dragón\ndel trueno>coloroff>!")
          		  case 1:
...
/*< 81>*/ 	printf(/* textboxtype: 0, unk: 1, line: 61 */ "<0x10005:0x004b0000>He aquí el <color blue<desfiladero de Lanayru>coloroff>.\nSegún las antiguas leyendas, en esta\ntierra habita un dragón servidor de\nla Diosa.")
          }

          void entrypoint_404_32() {
/*< 82>*/ 	start()
/*< 83>*/ 	printf(/* textboxtype: 0, unk: 0, line: 62 */ "<0x10005:0x005a0000>En esta zona se extrae mineral cronolítico\nde gran calidad, no en vano los antiguos\nconstruyeron aquí una explotación\nminera.")
          }
...
/*< 77>*/ 	start()
/*< 78>*/ 	printf(/* textboxtype: 0, unk: 1, line: 67 */ "Aquí empiezan las minas de\nLanayru, ricas en mineral\ncronolítico.")
          }
