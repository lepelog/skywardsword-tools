...
/*< 43>*/ 	switch (story_flags[21 /* us: 805A9ADB 0x20, jp: 805ACD5B 0x20 */]) {
          	  case 0:
/*< 44>*/ 		printf("¡Menudas vistas hay desde aquí!")
          	  case 1:
...
/*< 24>*/ 	switch (temp_flags[0 /* 0x1 01 */]) {
          	  case 0:
/*< 25>*/ 		printf("¡Como no te des prisa al final vas a\nquedarte rezagado!")
          	  case 1:
/*< 71>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 12, 'param3': 31}
/*< 12>*/ 		printf("\x0E\x01\x09\x04\x03\x900Aquí hay cronolitos a montones, y a cual\nmás grande.<pause1E> \x0E\x01\x09\x04\x00\x900¿Tú también vienes enviado\npor el <b<dragón del trueno>>?\n\n\x0E\x01\x09\x04\x01\x900Pues justo ahora iba a llevar este\ncronolito a su augusta presencia.")
/*< 18>*/ 		temp_flags[0 /* 0x1 01 */] = true;
/*< 87>*/ 		set_camera(1, 0)
/*< 86>*/ 		printf("\x0E\x01\x05\x04(\x00El camino está infestado de bicharracos\nde lo más feos...<pause0F> \x0E\x01\x09\x04\x03\xC00Ve con mucho cuidado.")
          	}
          }
