...
/*<194>*/ 					printf(/* textboxtype: 0, unk: 1, line: 7 */ "Conque, como yo decía, el vidente\nestaba encerrado en su casa\nlloriqueando...\n\nEs posible que se anime a volver\nsi alguien le encuentra una nueva bola\nde cristal...")
          					flw_129:
/*<129>*/ 					story_flags[834 /* us: 805A9B32 0x04, jp: 805ACDB2 0x04 */] = true;
          				  case 1:
/*<131>*/ 					printf(/* textboxtype: 0, unk: 0, line: 5 */ "¿Me harías el favor de ir a ver qué tal \nse encuentra?\n\n\nCreo que su casa estaba tirando hacia\nel <color red<extremo este >coloroff>de Altárea.")
          					goto flw_129
          				}
          			}
          		  case 1:
...
/*< 66>*/ 	printf(/* textboxtype: 0, unk: 1, line: 64 */ "<0x10009:0x12090c18>Esto... igual es un poco pronto para\npresentaciones...")
...
/*< 19>*/ 	switch (choice(2)) {
          	  case 0:
/*< 20>*/ 		printf(/* textboxtype: 0, unk: 1, line: 22 */ "¡Pues claro! ¡El idiota de mi hijo,\nel que lleva la chatarrería! De quién\niba a estar hablando si no...")
          		goto flw_85
          	  case 1:
...
/*< 94>*/ 			printf(/* textboxtype: 0, unk: 0, line: 71 */ "<0x10009:0x00001101>¿No tendrías que estar buscando\na tu pelícaro?")
          		  case 1:
/*< 93>*/ 			printf(/* textboxtype: 0, unk: 1, line: 70 */ "<0x10009:0x00001104>Veo que por allí andaban discutiendo.\n¿Qué rayos habrá pasado?\nLa cosa parecía bastante peliaguda...")
          		}
          	  case 1:
...
/*< 35>*/ 				printf(/* textboxtype: 0, unk: 0, line: 38 */ "<0x10009:0x000f0d05>¿Que por qué no subo yo?...\n\n\n\n<0x10009:0x00000800>¿Estás loco? ¡Me dan pavor las alturas!")
          			}
          		}
          	}
          }
...
/*< 37>*/ 		printf(/* textboxtype: 0, unk: 1, line: 43 */ "<0x10009:0x25070707>Con este tiempo tan bueno y yo aquí, \ntan liada que no puedo ni disfrutarlo...")
...
/*<184>*/ 	set_camera(9, 0)
/*<181>*/ 	printf(/* textboxtype: 0, unk: 1, line: 76 */ "<0x10009:0x070a0c12>Mmm, esta mujer...\n<0x10008:0xfecd>(¿Dónde demonios se habrá metido?...)")
          }
...
/*<142>*/ 		switch (choice(2)) {
          		  case 0:
/*<144>*/ 			printf(/* textboxtype: 0, unk: 1, line: 52 */ "<0x10009:0x00010700>¡Así se habla! Hala, aquí tienes, \ntómatelo a mi salud.")
...
/*<157>*/ 					printf(/* textboxtype: 1, unk: 0, line: 57 */ "¿Quieres saber una cosa, rapaz?\n\n\n\nEn la tienda de pociones venden\nun brebaje que viene de fábula,\nse llama <color yellow<resistone 500>coloroff>.\n\n<0x10009:0x00010700>¡Deberías probarlo! Cuando se te agote\nel indicador de resistencia, un trago\nde resistone 500 y ¡zas! ¡Como nuevo!\n\nY no creas que solo sirve cuando tiene\nuno que correr, no...\n\n\n<0x10009:0x00070700>También viene bien para no cansarse\ncuando estás peleando contra enemigos\nfuertotes y abusas del ataque circular.\nAsí les das para el pelo en un pispás.")
          		  ...
          		  case 1:
/*<143>*/ 			printf(/* textboxtype: 1, unk: 0, line: 51 */ "Qué lástima, vaya juventud...\nNo sabes divertirte, rapaz.")
          		}
          	}
          }
