...
/*< 58>*/ 								printf("Marchando un circuito para principiantes.\n¡Suerte!")
...
/*< 21>*/ 				switch (zone_temp_flags[0 /* 0x1 01 */]) {
          				  case 0:
/*< 30>*/ 					printf("¿Entonces te ha picado el gusanillo?\n[1]Un poco[2-]Qué va")
          					flw_19:
/*< 19>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_110:
...
/*< 39>*/ 								printf("Pues nada, ¡hasta goron!")
          							}
          						}
          					  case 1:
