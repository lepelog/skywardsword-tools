...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x00000064>¿Cómo va eso, Fay? ¡Perdona que\nte haya hecho esperar!\n\n\n¿Es esto lo que quieres\nque me lleve?")
          }

          void entrypoint_251_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "¡Pues a volar! ¡Nos vemos, dulzura!")
          }
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10012:0x00000064>¡Venga, aparta, hombre!\n¡Siempre estamos igual!")
          }
...
/*<  4>*/ 		printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x10012:0x00000005>Sí, amo. Avisaré al robot telepáticamente.")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 0, unk: 2, line: 1 */ "<0x10012:0x00000005>Está bien, amo. En caso de cambiar de\nopinión, sugiero volver a examinarlo.")
          	}
          }
...
/*< 40>*/ 						story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */] = true;
          				  ...
          				  case 1:
/*< 18>*/ 					printf(/* textboxtype: 0, unk: 1, line: 10 */ "<0x10009:0x00090013>Y además, aquí hay enemigos para dar\ny regalar. ¡Esto es un hervidero\nde monstruos!\n\n<0x10009:0x00070004>Qué dura es la vida de los kyus...")
          					goto flw_19
          				}
          			  case 1:
/*< 17>*/ 				printf(/* textboxtype: 1, unk: 0, line: 9 */ "<0x10009:0x00070011>No te imaginas la fatiga que da pasarse\nla vida sentado, esperando a que el peligro\nse presente de improviso.")
          				goto flw_38
          			}
          		}
          	}
