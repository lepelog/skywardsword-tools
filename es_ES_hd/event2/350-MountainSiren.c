...
/*< 42>*/ 										temp_flags[7 /* 0x1 80 */] = true;
          								  ...
          								  case 1:
/*< 38>*/ 									printf("Aconsejo <r<reservar >>las <y<lágrimas\n>>más sencillas de encontrar para\nlos momentos en los que el \x0E\x01\x12\x04\x00\x01amo\nhaya sido descubierto.")
...
/*< 62>*/ 					set_camera(5, 0)
/*< 61>*/ 					printf("Para completar la <y<orquídea del espíritu>>,\nes necesario recoger todas las <y<lágrimas>>\nsin sufrir ningún daño.")
          					goto flw_77
          				  case 2:
