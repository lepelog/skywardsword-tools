...
/*< 62>*/ 				switch (choice(2)) {
          				  case 0:
/*< 64>*/ 					printf("\x0E\x01\x09\x04\x0D\xF0A¡No me mires así que me voy a poner\ncolorada, <r<guapetón>>!")
          					flw_66:
...
/*< 68>*/ 					switch (choice(2)) {
          					  case 0:
/*< 67>*/ 						printf("\x0E\x01\x09\x04\x0F\x120EVeo que hoy nos hemos levantado\nchistosillos, ¿eh? Ya te vale, guapetón.")
          						flw_70:
...
/*<360>*/ 	start()
/*<359>*/ 	printf("\x0E\x01\x09\x04\x1F0A\x309¡Me debes <r<20 rupias>>, que esto era muy,\nmuy valioso! ¡Y te aseguro que no te\nestoy intentando timar!")
/*<358>*/ 	switch (random(4)) {
          	  case 0:
...
/*<379>*/ 	start()
/*<361>*/ 	printf("\x0E\x01\x09\x04\x1F0A\x309Me debes <r<10 rupias>>, niño, ¡que esas piezas\neran muy caras! ¡Y no me vengas\ncon excusas!")
/*<362>*/ 	switch (random(4)) {
          	  case 0:
...
/*<126>*/ 										switch (choice(2)) {
          										  case 0:
/*<128>*/ 											printf("\x0E\x01\x09\x04\x01\xD07¡Estupendo! ¡Genial! Ya sabía yo que no\nme fallarías, Link.\n\n\n\x0E\x01\x09\x04\x01\xD00Intenta ponerte a ello cuanto antes,\n¿quieres? ¡Y gracias!")
...
/*<129>*/ 											zone_temp_flags[0 /* 0x1 01 */] = true;
          										  case 1:
/*<127>*/ 											printf("\x0E\x01\x09\x04\x01\x90AVaya, Link, ¡y yo que creía\nque me ibas a echar una mano!...")
...
/*<118>*/ 									story_flags[574 /* us: 805A9B18 0x20, jp: 805ACD98 0x20 */] = true;
          							  ...
          							  case 1:
/*< 13>*/ 								printf("\x0E\x01\x09\x04\x01\x90AVaya, Link, ¡y yo que creía\nque me ibas a echar una mano!...")
          								goto flw_122
          							}
          						  case 1:
...
/*< 25>*/ 	printf("Coocker, tranquilízate, por favor.\nTampoco hay que ponerse así...")
...
/*<424>*/ 			switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 188}) {
          			  case 0:
          				flw_425:
/*<425>*/ 				rupees += -18;
/*<234>*/ 				printf("\x0E\x01\x09\x04\x1F0A\x300¡Como esto se repita pienso tomar\nmedidas! ¡Estás avisado!")
          				flw_235:
