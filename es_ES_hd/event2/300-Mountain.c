...
/*<221>*/ 	switch (scene_flags[73 /* 0x8 02 */]) {
          	  case 0:
/*<223>*/ 		printf(/* textboxtype: 1, unk: 1, line: 96 */ "Seguro que tu amiguita te está esperando,\nchaval. ¡No te me vayas a rendir ahora!")
          	  case 1:
/*<224>*/ 		scene_flags[4 'Eldin Volcano'][73 /* 0x8 02 */] = true;
/*<222>*/ 		printf(/* textboxtype: 1, unk: 0, line: 93 */ "<0x10009:0x00000001>¡Hombre, chaval! ¡Ya tenía ganas de\nvolver a verte! Es que quería darte\nlas gracias por salvarme la última vez.\n\nPor cierto, ¿has encontrado ya\na tu amiguita?\n[1-]Así es[2-]Aún no...")
/*<225>*/ 		switch (choice(2)) {
          		  case 0:
/*<227>*/ 			printf(/* textboxtype: 0, unk: 1, line: 94 */ "<0x10009:0x00110808>¡¿En serio?! Pues me das un alegrón...<pause 20>\n¿Cómo? ¿Dices que todavía está\nen peligro?\n\n<0x10009:0x000908ff>Bah, no te preocupes. Todo saldrá bien,\nya lo verás. ¡Tú no te rindas, chaval!")
          		  case 1:
...
/*< 24>*/ 	printf(/* textboxtype: 0, unk: 0, line: 35 */ "Estoy seguro de que lo enterré por\naquí, pero no hay manera... no lo\nencuentro.")
...
/*<261>*/ 	wait_frames(30)
/*< 34>*/ 	printf(/* textboxtype: 0, unk: 1, line: 46 */ "Macho, pero qué listo eres...")
/*<257>*/ 	wait_frames(45)
...
/*< 48>*/ 					scene_flags[4 'Eldin Volcano'][55 /* 0x7 80 */] = true;
          				  case 1:
/*< 52>*/ 					printf(/* textboxtype: 0, unk: 0, line: 71 */ "¡Anda ya! ¡Pero si no tienes\nsuficientes rupias!\n\n\n<0x10009:0x00141209>Y no hay descuento que valga.\nO me traes las <color red<20 rupias>coloroff>, o este moguma\nno abre el pico.")
          				}
          			  case 1:
...
/*<349>*/ 		printf(/* textboxtype: 0, unk: 0, line: 77 */ "<0x10009:0x0014120c>Mmm...<pause 30> Me pareció que iba <color red<de negro>coloroff>,\npero poco más te puedo decir.")
...
/*<123>*/ 	printf(/* textboxtype: 0, unk: 2, line: 16 */ "¡Hala! ¡Y ahora un bicho verde!")
/*<182>*/ 	{'type': 'type3', 'subType': 4, 'param1': 255, 'param2': -256, 'next': 181, 'param3': 13}
/*<181>*/ 	printf(/* textboxtype: 0, unk: 0, line: 17 */ "Hace un segundo pasó por aquí\nescopetada una <color red<tipa de negro>coloroff>\nque parecía de tu misma especie.\n¿Es colega tuya?<sound 4>")
/*<125>*/ 	set_camera(13, 0)
/*<152>*/ 	{'type': 'type3', 'subType': 4, 'param1': 255, 'param2': -1, 'next': 126, 'param3': 13}
/*<126>*/ 	printf(/* textboxtype: 2, unk: 0, line: 18 */ "Parece un abismo insalvable, ¿verdad?\nPues la tipa esta pasó como si nada, de\nun brinco.")
/*<127>*/ 	set_camera(-1, 0)
/*<128>*/ 	printf(/* textboxtype: 0, unk: 2, line: 19 */ "En serio, el salto que dio fue alucinante...<pause 15>\n¡Vaya prodigio!")
          }
...
/*<108>*/ 	printf(/* textboxtype: 2, unk: 0, line: 21 */ "Qué rabia... Estos tipejos se creen\nque pueden invadir mi territorio y\nandar como Pedro por su casa.")
...
/*<141>*/ 	printf(/* textboxtype: 1, unk: 0, line: 27 */ "¡Por la madriguera de mi abuela,<pause 15>\nsi te los has ventilado a todos!...<pause 15>")
...
/*< 12>*/ 	start()
/*< 13>*/ 	printf(/* textboxtype: 1, unk: 2, line: 114 */ "<0x10009:0x00000002>El elegido de la Diosa...")
          }
