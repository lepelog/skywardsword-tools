...
/*<120>*/ 	switch (zone_temp_flags[4 /* 0x1 10 */]) {
          	  case 0:
/*<112>*/ 		printf(/* textboxtype: 1, unk: 0, line: 28 */ "<0x10009:0x00170209><0x10008:0x02cd>¡Espléndido, voto a tal!")
/*<124>*/ 		set_camera(3, 0)
/*<125>*/ 		printf(/* textboxtype: 1, unk: 0, line: 32 */ "<0x10009:0x00171a08>¡Hay que poner toda la carne en\nel asador para hacerlo bien!\n\n\n<0x10009:0x00090200>¿Quieres probar ahora\ncon el <color green<golpe de gracia>coloroff>?\n\n[1-]¡Claro![2]Mejor no")
          	  case 1:
/*<121>*/ 		printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10009:0x00091d04>¿Qué te pasa, <heroname>?\nNo pareces el mismo de siempre...")
/*<122>*/ 		set_camera(3, 0)
/*<123>*/ 		printf(/* textboxtype: 1, unk: 0, line: 31 */ "<0x10009:0x00081d01>Mantente en el centro respecto a\ntus enemigos. Si no mueves <color red<a la vez>coloroff> \nel mando y el Nunchuk <color red<en horizontal>coloroff>,\nno ejecutarás el ataque circular.\n<0x10009:0x00090200>¿Quieres volver a intentarlo?\n\n[1-]Sí, venga[2]Mejor no")
          	}
          }

          void entrypoint_119_11() {
/*<115>*/ 	start()
/*<111>*/ 	printf(/* textboxtype: 1, unk: 0, line: 27 */ "<0x10009:0x00080200>¡Magnífico! Se trata de cortar esos\ntroncos que te rodean sin moverte\ndel sitio, moviendo <color red<a la vez >coloroff>el mando\ny el Nunchuk<color red< >coloroff><color green<en sentido horizontal>coloroff>.\n<0x10009:0x00090200>¡Inténtalo, a ver cómo se te da!")
          }

          void entrypoint_119_12() {
/*<126>*/ 	start()
/*<127>*/ 	printf(/* textboxtype: 1, unk: 0, line: 33 */ "<0x10009:0x00081d03>¡Así! Con el enemigo en tierra, mantén\npulsado (Z) para <color red<fijarlo como objetivo>coloroff>\ny <color red<mueve el mando y el Nunchuk a la vez\n>coloroff>hacia abajo para <color green<rematarlo>coloroff>.<0x10011:0x07cd>\n<0x10009:0x00091d00>¡Pégale un tajo lateral a ese tronco\ny, cuando esté caído, prueba esta\ntécnica con él!")
          }

          void entrypoint_119_13() {
/*<128>*/ 	start()
/*<129>*/ 	printf(/* textboxtype: 1, unk: 0, line: 34 */ "<0x10009:0x00171a09><0x10008:0x01cd>¡Brillante, voto a tal!")
/*<130>*/ 	set_camera(3, 0)
/*<131>*/ 	printf(/* textboxtype: 1, unk: 0, line: 35 */ "<0x10009:0x00190200>El <color green<golpe de gracia>coloroff> es una técnica muy\nefectiva para acabar con los enemigos\nque derribes con <color red<ataques de >coloroff><color red<escudo >coloroff>o\ncon <color red<ataques circulares>coloroff>.\n<0x10009:0x001c0200>No obstante, tus rivales tratarán de\nincorporarse enseguida, ¡así que\ntendrás tan solo unos instantes para\nmover el mando y el Nunchuk!")
          }
...
/*< 68>*/ 	switch (zone_temp_flags[1 /* 0x1 02 */]) {
          	  case 0:
/*< 70>*/ 		printf(/* textboxtype: 1, unk: 0, line: 50 */ "<0x10009:0x00091901>¡Preséntale mis respetos al señor\nmesonero sin falta!")
          	  case 1:
...
/*< 57>*/ 					entrypoint_119_03();
          				  case 1:
/*< 58>*/ 					printf(/* textboxtype: 1, unk: 0, line: 45 */ "<0x10009:0x00000003>¡Voto a...! ¿Me has traído más sopa\nde calabaza caliente?...\nTiene una pinta exquisita...\n[1-]Sírvase[2-]Ejem...")
/*< 59>*/ 					switch (choice(2)) {
          					  case 0:
/*< 61>*/ 						printf(/* textboxtype: 1, unk: 0, line: 47 */ "<0x10009:0x00171909>¡¿Es para mí?! ¿Seguro?...\nDisculpa, he dado por hecho que era\npara mí.\n\nPero bueno, con la pinta que tiene...\n¡No le haré ascos, no!")
...
/*<103>*/ 						printf(/* textboxtype: 1, unk: 0, line: 44 */ "¡Qué cosa más sabrosa, pardiez!<0x10005:0x001e0000>")
/*<104>*/ 						set_camera(11, 0)
...
/*<142>*/ 						printf(/* textboxtype: 1, unk: 0, line: 49 */ "<0x10009:0x00080200>¡Gracias, <heroname>!\n¡Ahí te va una pequeña muestra\nde gratitud!")
...
/*< 34>*/ 				switch (adventure_pouch_has(2 0x0002)) {
          				  case 0:
/*< 37>*/ 					printf(/* textboxtype: 1, unk: 0, line: 36 */ "<0x10009:0x00081901>¡Muy buenas, <heroname>!\n¡¿Estás practicando con la espada\ncomo es debido?!\n\n<0x10009:0x00000200>¿Mmm?\n\n\n\n<0x10009:0x00001909>¡Voto a...! ¡¿Pues no es esa mi <color red<sopa\nde calabaza >coloroff>favorita?!\n\n\n<0x10009:0x00000200>Le había dejado encargado\nal mesonero que me la trajera...\n\n\n¡y resulta que te manda a ti cargado\ncon ella, pardiez! Porque esa sopa\nes para mí, ¿no?\n[1-]¡Pues sí![2]Pues... no")
/*< 41>*/ 					switch (choice(2)) {
          					  case 0:
/*< 42>*/ 						printf(/* textboxtype: 1, unk: 0, line: 38 */ "<0x10009:0x00171909>¡Hurra! ¡Mi ansiada sopa!...\n¡Rápido! ¡Tráela aquí! ¡VENGA!\n\n[1-]De mil\namores[2]Lo siento,\npero...")
/*< 44>*/ 						switch (choice(2)) {
          						  case 0:
...
/*< 94>*/ 							printf(/* textboxtype: 1, unk: 0, line: 44 */ "¡Qué cosa más sabrosa, pardiez!<0x10005:0x001e0000>")
/*< 96>*/ 							set_camera(11, 0)
/*< 52>*/ 							printf(/* textboxtype: 1, unk: 0, line: 42 */ "<0x10009:0x00000013>¡Ah, es una auténtica delicia!\n\n\n\n<0x10009:0x00171900>¡A fe mía que la sopa de calabaza\ncalentita es el mejor invento de la\nhistoria de los inventos!\n")
...
/*<140>*/ 							printf(/* textboxtype: 1, unk: 0, line: 43 */ "<0x10009:0x00081900>¡Buen trabajo, sí señor! ¡Preséntale mis\nrespetos al señor mesonero!")
...
/*<147>*/ 								set_camera(11, 0)
/*<146>*/ 								printf(/* textboxtype: 1, unk: 0, line: 40 */ "¡Puaj! Qué asco, voto a tal...<pause 20>\n¡Esta sopa está helada!")
...
/*< 50>*/ 								printf(/* textboxtype: 1, unk: 0, line: 41 */ "En esta vida hay dos cosas que no\nsoporto: ¡la sopa fría y las mujeres\naún más frías, pardiez!\n\n¡Tráeme más sopa, deprisa!\n¡Y esta vez que esté bien caliente,\ncomo es de ley!")
/*<137>*/ 								{'type': 'type3', 'subType': 1, 'param1': 3, 'param2': -1, 'next': -1, 'param3': 42}
          							  case 1:
/*< 46>*/ 								printf(/* textboxtype: 1, unk: 0, line: 39 */ "<0x10009:0x00001d00>¡¿Cómo?! ¡¡Voto a bríos!! \n¿Entonces no te ha mandado\nel mesonero que me la traigas? \n¿Acaso me tomas el pelo?\n<0x10009:0x00081d00>Pues si esta sopa no es para mí,\n¡ve a traerme la mía de inmediato!\n¡Ya estás tardando!\n\n¡Y más te vale que esté caliente!")
          							}
          						  case 1:
/*< 38>*/ 							printf(/* textboxtype: 1, unk: 0, line: 37 */ "<0x10009:0x000e1d00>Ya veo, ya...\n¡¿Qué pretende el mesonero ese?!\n¡Le dejé muy claro que quería\nmi sopa sin tardanza!\n<0x10009:0x00081d00>¡Sin mi ración diaria de sopa, me pongo\nque me subo por las paredes!...\n")
          						}
          					  case 1:
...
/*< 25>*/ 	printf(/* textboxtype: 1, unk: 0, line: 5 */ "<0x10009:0x0b0d0002>¡Voto a...! ¡Oye!<0x1000D:0x1900> ¡<heroname>!")
...
/*< 76>*/ 	start()
/*< 84>*/ 	printf(/* textboxtype: 1, unk: 0, line: 19 */ "<0x10009:0x00010201>En ese tronco puedes practicar el <color red<tajo\nvertical>coloroff>. Apunta con el mando hacia\narriba y haz un rápido movimiento\nhacia el frente para cortar el tronco.")
          }

          void entrypoint_119_05() {
/*< 80>*/ 	start()
/*< 85>*/ 	printf(/* textboxtype: 1, unk: 0, line: 20 */ "<0x10009:0x00190203>En ese tronco puedes practicar\nel <color red<tajo lateral>coloroff>. Sujeta el mando en\nposición horizontal y haz un rápido\nmovimiento de izquierda a derecha.")
          }

          void entrypoint_119_06() {
/*< 81>*/ 	start()
/*< 86>*/ 	printf(/* textboxtype: 1, unk: 0, line: 21 */ "<0x10009:0x001d0202>En ese tronco puedes practicar\nel <color red<tajo diagonal>coloroff>. Haz un rápido \nmovimiento en diagonal con\nel mando para cortar el tronco.")
          }

          void entrypoint_119_07() {
/*< 82>*/ 	start()
/*< 87>*/ 	printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x00080203>En ese tronco puedes practicar\nla <color red<estocada>coloroff>. Haz un rápido movimiento\ncon el mando extendiendo el brazo\nhacia delante y pincharás con la punta.")
          }
...
/*<109>*/ 	start()
/*<114>*/ 	printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x000a0213>¡Soberbio, <heroname>!")
/*<116>*/ 	set_camera(3, 0)
/*<110>*/ 	printf(/* textboxtype: 1, unk: 0, line: 26 */ "<0x10009:0x00081908>Eres un espadachín de primera,\n¡como maestro tuyo me siento asaz\norgulloso, pardiez!\n\n<0x10009:0x00090200>¿Te ves con arrestos para practicar\ntambién el <color green<ataque circular>coloroff>?\n\n[1-]¡Claro![2]Mejor no")
          }
