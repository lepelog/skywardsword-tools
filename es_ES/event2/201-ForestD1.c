...
/*<130>*/ 			printf("¡A mí no me la cuelas, listillo!\n¡Te falta colgarte un cartel del\ncuello que diga: «Cazador de\ntesoros profesional»!")
          			goto flw_152
          		}
          	}
          }
