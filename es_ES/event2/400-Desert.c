...
/*<  6>*/ 			switch (context_related2(0)) {
          			  case 0:
/*<277>*/ 				printf(/* textboxtype: 1, unk: 0, line: 22 */ "<0x10009:0x13030000>¡Me has salvado!")
...
/*<170>*/ 	start()
/*<172>*/ 	set_camera(-1, 0)
/*<171>*/ 	printf(/* textboxtype: 2, unk: 0, line: 87 */ "Enhorabuena, <0x10012:0x00000004>amo <heroname>.")
...
/*<150>*/ 		switch (scene_flags[73 /* 0x8 02 */]) {
          		  case 0:
/*<152>*/ 			printf(/* textboxtype: 1, unk: 0, line: 105 */ "<0x10009:0x00162007>¡Sabe Goron que me muero de ganas\npor echar un vistazo ahí dentro!...\nAy, ¿no habrá ningún otro camino\npor el que entrar?")
          		  case 1:
...
/*<105>*/ 			switch (story_flags[525 /* us: 805A9B14 0x04, jp: 805ACD94 0x04 */]) {
          			  case 0:
/*<275>*/ 				printf(/* textboxtype: 1, unk: 0, line: 96 */ "<0x10009:0x2f080d02>Vaya por Goron, ¡pero si es\n<heroname>!")
/*<276>*/ 				set_camera(5, 0)
...
/*<110>*/ 				scene_flags[7 'Lanayru Desert'][75 /* 0x8 08 */] = true;
          				goto flw_149
          			  case 1:
/*<273>*/ 				printf(/* textboxtype: 1, unk: 0, line: 96 */ "<0x10009:0x2f080d02>Vaya por Goron, ¡pero si es\n<heroname>!")
/*<274>*/ 				set_camera(5, 0)
/*<211>*/ 				printf(/* textboxtype: 1, unk: 0, line: 98 */ "Oye, ¿has encontrado ya la <color blue<llama\nsagrada>coloroff> de la que hablamos?\n\n\nLlevo sin quitármelo de la cabeza desde\nque lo mencionaste, ¡así que cuenta!\n\n\n<0x10009:0x2f080407>(.<pause 20>.<pause 20>.<pause 20>) ¡Vaya! Tras tantas aventuras,\n¡por fin has dado con ella!\n\n\nEstá claro que eres alguien\nespecial, <heroname>.")
/*<359>*/ 				printf(/* textboxtype: 1, unk: 0, line: 99 */ "<0x10009:0x2f080d0a>Bueno, va siendo hora de contarte lo\nque he descubierto sobre la leyenda de\nlos tres dragones.<pause 15>\n\n¡Hay muchos secretos escondidos bajo\nlas arenas de este desierto!\n\n\nComo por ejemplo ese <color red<pasadizo tan\nestrecho>coloroff><sound 4> por el que no quepo.\n\n\n<0x10009:0x2f000d00>Sospecho que lleva hasta el lugar donde\nmora el <color red<dragón del trueno>coloroff>.\n\n\n<0x10009:0x2f000800>Estoy seguro de que todo esto guarda\nrelación con esos robots que hay por\naquí.<pause 15>\n\n<0x10009:0x2f010807><0x10006:0xffcd>El <color red<dragón del trueno>coloroff>, robots,\ncronolitos<pause 20>.<pause 20>.<pause 20>.<pause 20>\n\n\n<0x10009:0x2f080708><0x10008:0x02cd><0x10008:0x02cd>¡Menuda aventura!")
          				goto flw_285
          			}
          		}
          	}
...
/*< 66>*/ 				printf(/* textboxtype: 1, unk: 0, line: 26 */ "No se cansa uno de mirar el Templo\ndel Tiempo... ¡Qué prodigio!")
          			  case 1:
/*<319>*/ 				printf(/* textboxtype: 1, unk: 0, line: 62 */ "¿Buscas a un dragón?\n\n\n\n<color blue<<0x10009:0x13030000>>coloroff>Si el que te interesa es el <color blue<dragón del\ntrueno>coloroff>, te diré que está al sur de las\n<color blue<cuevas de Lanayru>coloroff>. Es el único dragón\nque conozco.")
...
/*< 99>*/ 			wait_frames(30)
/*< 97>*/ 			printf(/* textboxtype: 1, unk: 0, line: 29 */ "¿Uh? Este mapa lo veo un poco raro...\nEspera, que te lo corrijo en un pispás.")
...
/*<102>*/ 	start()
/*<286>*/ 	printf(/* textboxtype: 2, unk: 0, line: 70 */ "<0x10012:0x00000001>Amo, aviso importante: ha dejado de\npercibirse la presencia de <color blue<Zelda>coloroff>.")
/*<287>*/ 	set_camera(7, 0)
/*<288>*/ 	printf(/* textboxtype: 2, unk: 0, line: 71 */ "Su rastro se ha perdido por completo al\ndestruirse el portal. Confirmo que en\nestos momentos <sound 4><color red<no es posible rastrear\nsu paradero>coloroff>.")
/*<289>*/ 	set_camera(-1, 0)
...
/*< 85>*/ 						scene_flags[7 'Lanayru Desert'][35 /* 0x5 08 */] = true;
          				  ...
          				  case 1:
/*<325>*/ 					printf(/* textboxtype: 1, unk: 0, line: 62 */ "¿Buscas a un dragón?\n\n\n\n<color blue<<0x10009:0x13030000>>coloroff>Si el que te interesa es el <color blue<dragón del\ntrueno>coloroff>, te diré que está al sur de las\n<color blue<cuevas de Lanayru>coloroff>. Es el único dragón\nque conozco.")
...
/*<187>*/ 				printf(/* textboxtype: 1, unk: 0, line: 39 */ "¿Has logrado introducir las claves?\nVaya, qué tío...")
          			  case 1:
/*<331>*/ 				printf(/* textboxtype: 1, unk: 0, line: 62 */ "¿Buscas a un dragón?\n\n\n\n<color blue<<0x10009:0x13030000>>coloroff>Si el que te interesa es el <color blue<dragón del\ntrueno>coloroff>, te diré que está al sur de las\n<color blue<cuevas de Lanayru>coloroff>. Es el único dragón\nque conozco.")
...
/*<295>*/ 	start()
/*<296>*/ 	printf(/* textboxtype: 2, unk: 0, line: 86 */ "Hemos llegado al <color blue<Templo del Tiempo>coloroff>.\n\n\n\nAhora es posible rastrear la ubicación\ndel umbral del juicio que conduce a la\nllama sagrada.")
...
/*<225>*/ 	switch (scene_flags[29 /* 0x2 20 */]) {
          	  case 0:
/*<226>*/ 		printf(/* textboxtype: 1, unk: 0, line: 10 */ "Ni se te ocurra tocar las rocas azuladas.\n¡Y hazte a un lado, que estamos\ntrabajando!\n")
          	  case 1:
...
/*<189>*/ 				printf(/* textboxtype: 1, unk: 0, line: 44 */ "¿Has descubierto las claves?\n¿De verdad? Me dejas de piedra...")
          			  case 1:
/*<337>*/ 				printf(/* textboxtype: 1, unk: 0, line: 62 */ "¿Buscas a un dragón?\n\n\n\n<color blue<<0x10009:0x13030000>>coloroff>Si el que te interesa es el <color blue<dragón del\ntrueno>coloroff>, te diré que está al sur de las\n<color blue<cuevas de Lanayru>coloroff>. Es el único dragón\nque conozco.")
...
/*<191>*/ 				printf(/* textboxtype: 1, unk: 0, line: 49 */ "¡¿Has descubierto las claves?!\nEsto sí que no me lo esperaba...")
          			  case 1:
/*<343>*/ 				printf(/* textboxtype: 1, unk: 0, line: 62 */ "¿Buscas a un dragón?\n\n\n\n<color blue<<0x10009:0x13030000>>coloroff>Si el que te interesa es el <color blue<dragón del\ntrueno>coloroff>, te diré que está al sur de las\n<color blue<cuevas de Lanayru>coloroff>. Es el único dragón\nque conozco.")
