...
/*<  8>*/ 	start()
/*<  9>*/ 	printf(/* textboxtype: 6, unk: 0, line: 4 */ "<icon 20> Gran plaza de Altárea")
          }
...
/*< 84>*/ 	switch (story_flags[712 /* us: 805A9B25 0x04, jp: 805ACDA5 0x04 */]) {
          	  case 0:
/*< 83>*/ 		printf(/* textboxtype: 22, unk: 0, line: 23 */ "<0x10008:0x00cd>Casa de Paula,\n<0x10008:0xffcd>la de la consigna")
          	  case 1:
          	}
          }
...
/*< 51>*/ 	start()
/*< 52>*/ 	printf(/* textboxtype: 8, unk: 0, line: 6 */ "¡Prohibido correr por\nlos pasillos!\n")
          }
...
/*<139>*/ 	start()
/*<147>*/ 	printf(/* textboxtype: 8, unk: 0, line: 42 */ "Altárea: ¡a solo unos pocos\naleteos hacia el noroeste!")
          }
...
/*< 89>*/ 	switch (story_flags[714 /* us: 805A9B25 0x10, jp: 805ACDA5 0x10 */]) {
          	  case 0:
/*< 90>*/ 		printf(/* textboxtype: 22, unk: 0, line: 25 */ "Casa de Cuqui")
          	  case 1:
          	}
          }
...
/*<113>*/ 	start()
/*<114>*/ 	printf(/* textboxtype: 8, unk: 0, line: 8 */ "En Altárea solo se puede subir\na los pelícaros desde los\nlugares designados para ello.")
          }

          void entrypoint_107_42() {
/*<140>*/ 	start()
/*<148>*/ 	printf(/* textboxtype: 8, unk: 0, line: 43 */ "Gracielle x Cor...")
          }
...
/*< 95>*/ 	switch (story_flags[716 /* us: 805A9B25 0x40, jp: 805ACDA5 0x40 */]) {
          	  case 0:
/*< 96>*/ 		printf(/* textboxtype: 22, unk: 0, line: 27 */ "<0x10008:0x00cd>Casa de Milo,\n<0x10008:0xffcd>el de los utensilios")
          	  case 1:
          	}
          }
...
/*< 98>*/ 	switch (story_flags[717 /* us: 805A9B25 0x80, jp: 805ACDA5 0x80 */]) {
          	  case 0:
/*< 99>*/ 		printf(/* textboxtype: 22, unk: 0, line: 28 */ "Casa de Coocker")
          	  case 1:
          	}
          }
...
/*<155>*/ 	start()
/*<157>*/ 	printf(/* textboxtype: 2, unk: 0, line: 80 */ "<0x10012:0x0000000b>Amo <heroname>, al sudoeste de\naquí detecto una tercera columna de\nluz que conecta con las tierras\ninferiores.\nDado que es posible acceder a un nuevo\nterritorio, recomiendo ultimar todos\nlos preparativos y partir hacia allí.")
          }
...
/*< 21>*/ 	start()
/*< 28>*/ 	printf(/* textboxtype: 22, unk: 0, line: 10 */ "Cuarto de Malton")
          }
...
/*<101>*/ 	switch (story_flags[718 /* us: 805A9B24 0x01, jp: 805ACDA4 0x01 */]) {
          	  case 0:
/*<102>*/ 		printf(/* textboxtype: 22, unk: 0, line: 29 */ "<0x10008:0x00cd>Casa de Gorronte,\n<0x10008:0xffcd>el vidente")
          	  case 1:
          	}
          }
...
/*<186>*/ 	start()
/*<187>*/ 	printf(/* textboxtype: 6, unk: 0, line: 48 */ "Ahora mismo el menda está\ncurrando. Si quieres verme,\npásate por la noche.\n<0x10006:0x05cd>                                      - Terry")
          }
...
/*< 24>*/ 	start()
/*< 31>*/ 	printf(/* textboxtype: 22, unk: 0, line: 13 */ "Director Gaépora")
          }
...
/*<104>*/ 	switch (story_flags[719 /* us: 805A9B24 0x02, jp: 805ACDA4 0x02 */]) {
          	  case 0:
/*<105>*/ 		printf(/* textboxtype: 22, unk: 0, line: 31 */ "<0x10008:0x00cd>Casa de Dorcon,\n<0x10008:0xffcd>el de la chatarrería")
          	  case 1:
          	}
          }
...
/*<107>*/ 	switch (story_flags[720 /* us: 805A9B24 0x04, jp: 805ACDA4 0x04 */]) {
          	  case 0:
/*<108>*/ 		printf(/* textboxtype: 22, unk: 0, line: 32 */ "<0x10008:0x00cd>Casa de Alfred,\n<0x10008:0xffcd>el de las pociones")
          	  case 1:
          	}
          }
...
/*< 27>*/ 	start()
/*< 34>*/ 	printf(/* textboxtype: 22, unk: 0, line: 16 */ "Cuarto de Gracielle")
          }

          void entrypoint_107_34() {
/*<122>*/ 	start()
/*<123>*/ 	printf(/* textboxtype: 8, unk: 0, line: 34 */ "    Altárea\n   N: Efigie de la Diosa\nO: Academia          E: Viviendas\n    S: Gran plaza")
          }
...
/*<149>*/ 	switch (story_flags[688 /* us: 805A9B21 0x20, jp: 805ACDA1 0x20 */]) {
          	  case 0:
/*<150>*/ 		printf(/* textboxtype: 8, unk: 0, line: 37 */ "Velada musical con Calabelle\n(fecha por determinar)")
          	  case 1:
/*<142>*/ 		printf(/* textboxtype: 8, unk: 0, line: 36 */ "La actuación de Calabelle se\nsuspende temporalmente por\nfalta de acompañante.\n¡Se buscan músicos!")
          	}
          }
...
/*<135>*/ 	start()
/*<143>*/ 	printf(/* textboxtype: 8, unk: 0, line: 38 */ "Para ver la lámpara de araña,\nemblema del Calabarza's,\nsuban a la segunda planta.")
          }
