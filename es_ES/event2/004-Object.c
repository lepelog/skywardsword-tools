...
/*< 11>*/ 			printf(/* textboxtype: 5, unk: 1, line: 9 */ "En la alforja no te cabe nada más y\nla <color red<consigna >coloroff>también está llena.\n\n\nEl objeto se queda en el cofre.")
          		  case 1:
/*< 10>*/ 			printf(/* textboxtype: 5, unk: 1, line: 8 */ "¡La alforja está llena, así que el objeto te\nlo guardan en la <color red<consigna>coloroff>!")
          		}
          	  case 1:
          	}
          }
...
/*< 41>*/ 	start()
/*< 40>*/ 	printf(/* textboxtype: 1, unk: 0, line: 27 */ "Dicen por ahí que si dibujas dinero en\nlos muros misteriosos, puedes llevarte\nun buen pellizco sin despeinarte.")
          }
