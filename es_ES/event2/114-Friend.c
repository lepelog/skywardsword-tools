...
/*<  7>*/ 				switch (scene_flags[40 /* 0x4 01 */]) {
          				  case 0:
/*<  6>*/ 					printf(/* textboxtype: 1, unk: 0, line: 10 */ "<0x10009:0x00000811>Vaya problema lo del pelícaro,\n¿no, <heroname>?<pause 25>\nOjalá lo encuentres pronto<0x10006:0xfbcd>...<0x10006:0x00cd>")
          				  case 1:
...
/*< 84>*/ 				switch (temp_flags[6 /* 0x1 40 */]) {
          				  case 0:
/*< 85>*/ 					printf(/* textboxtype: 1, unk: 1, line: 34 */ "<0x10009:0x00000002>Qué... ¿te ves con fuerzas para otra\nronda? ¡Son solo<color red< 20 rupias>coloroff>!\n[1-]¡Vale![2-]¿Cómo iba?[3]Mejor no")
          					flw_74:
/*< 74>*/ 					switch (choice(3)) {
          					  case 0:
          						flw_67:
/*< 67>*/ 						switch (has_rupees(20)) {
          						  case 0:
/*< 68>*/ 							rupees += -20;
/*< 70>*/ 							printf(/* textboxtype: 1, unk: 0, line: 32 */ "<0x10009:0x00070a0a>¡Pues vamos allá!\n¡Ánimo, <heroname>!")
/*< 71>*/ 							make_actor_do_something(0, 0)
          						  case 1:
          							flw_66:
/*< 66>*/ 							printf(/* textboxtype: 1, unk: 0, line: 31 */ "<0x10009:0x00010811>Andas corto de dinero... Se ve que tú\ntambién pasas tus estrecheces,\n¿eh, <heroname>?...")
          						}
          					  case 1:
          						flw_63:
...
/*< 37>*/ 	printf(/* textboxtype: 1, unk: 0, line: 19 */ "<0x10009:0x00010800><0x10008:0xffcd>Esto...<pause 20> Verás...\n\n\n\n<0x10009:0x00070800>Bueno, nada...<pause 20>\nDéjalo, no te preocupes.")
          }
