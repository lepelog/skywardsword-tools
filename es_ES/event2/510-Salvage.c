          void entrypoint_510_01() {
          	start()
/*<  1>*/ 	printf(/* textboxtype: 2, unk: 0, line: 0 */ "Confirmo que este es el <color red<rotor\ndel molino >coloroff>que buscábamos.\n\n\nEl robot ya está disponible para\nrecogerlo y transportarlo.\n\n\n¿Desea el <0x10012:0x00000001>amo que lo llame?\n[1-]Adelante[2]No")
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf(/* textboxtype: 2, unk: 0, line: 2 */ "<0x10012:0x00000005>Muy bien, amo. Avisaré al robot\ntelepáticamente.<sound 4>")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 2, unk: 0, line: 1 */ "<0x10012:0x00000005>Está bien, amo. Recuerdo que basta\ncon examinar de nuevo el rotor en\ncaso de cambiar de opinión.")
          	}
          }

          void entrypoint_510_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 1, unk: 0, line: 3 */ "<0x10012:0x00000064>¡Fay de mis amores!\n¡Lamento la tardanza!\n\n\nEs esto, ¿no? ¡Vale, yo me encargo!")
          }

          void entrypoint_510_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 1, unk: 0, line: 4 */ "<0x10012:0x00000064>Pues nada, ¡me voy volando!\n¡Espero verte pronto, monada!")
          }
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 1, unk: 0, line: 6 */ "<0x10012:0x00000064>¡Oye, amo verdoso! ¿Por qué no\nte echas a un lado para que pueda\npasar?")
          }
