...
/*< 79>*/ 	start()
/*< 86>*/ 	printf(/* textboxtype: 2, unk: 0, line: 29 */ "¿Está el <0x10012:0x00000004>amo listo ya para\nenfrentarse al combate final?\n[1-]¡Todo\na punto![2]Aún no")
/*< 87>*/ 	switch (choice(2)) {
          	  case 0:
/*< 88>*/ 		printf(/* textboxtype: 2, unk: 0, line: 30 */ "<0x10012:0x00000005>Muy bien, amo. Partiremos sin\nmás demora.")
/*< 90>*/ 		changeScene(11, 0) // 
          	  case 1:
/*< 89>*/ 		printf(/* textboxtype: 2, unk: 0, line: 31 */ "<0x10012:0x00000005>De acuerdo, amo. Hay tiempo para\nocuparse de los preparativos.")
          	}
          }

          void entrypoint_502_09() {
/*< 80>*/ 	start()
/*< 81>*/ 	printf(/* textboxtype: 2, unk: 0, line: 26 */ "¿Desea el <0x10012:0x00000004>amo regresar y prepararse\npara el combate final?\n[1-]¡Buena idea![2]Estoy listo")
/*< 82>*/ 	switch (choice(2)) {
          	  case 0:
/*< 83>*/ 		printf(/* textboxtype: 2, unk: 0, line: 27 */ "<0x10012:0x00000005>De acuerdo, amo. Hay tiempo para\nocuparse de los preparativos.")
/*< 85>*/ 		changeScene(10, 0) // 
          	  case 1:
/*< 84>*/ 		printf(/* textboxtype: 2, unk: 0, line: 28 */ "Muy bien... <0x10012:0x00000001>amo.")
          	}
          }
...
/*< 46>*/ 						printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00000003>Un árbol imperecedero...\n¿Dónde podríamos encontrar\nla <color red<semilla >coloroff>de un árbol así?")
          					  case 1:
/*< 34>*/ 						printf(/* textboxtype: 1, unk: 0, line: 7 */ "<pause 15>(.<pause 15>.<pause 15>.) <0x10009:0x000f0803>¿Mmm?\n\n\n\n[1-]¿Qué pasa?[2-]Adiós")
/*< 35>*/ 						switch (choice(2)) {
          						  case 0:
/*< 36>*/ 							printf(/* textboxtype: 1, unk: 0, line: 8 */ "<0x10009:0x00000703>Mmm... No tiene importancia...")
...
/*< 25>*/ 		printf(/* textboxtype: 1, unk: 0, line: 18 */ "<0x10009:0x00000012>Ese monstruo ha huido por <color red<aquella\npuerta>coloroff>... ¡Rápido! ¡Debes detener a\n<color blue<Grahim >coloroff>cuanto antes!")
          	  case 1:
/*< 22>*/ 		printf(/* textboxtype: 1, unk: 0, line: 16 */ "<0x10009:0x00000012>Agh... ¿Eres tú, <heroname>?\nGrahim me pilló por sorpresa y...\n\n\nPero no te preocupes por mí.\n¡Debes ir tras él, deprisa!")
/*< 20>*/ 		set_camera(4, 0)
/*< 23>*/ 		printf(/* textboxtype: 1, unk: 0, line: 17 */ "Ese monstruo ha huido por <color red<aquella\npuerta>coloroff>... ¡Date prisa! ¡Aún estás a\ntiempo!")
...
/*< 53>*/ 	switch (scene_flags[104 /* 0xC 01 */]) {
          	  case 0:
/*< 56>*/ 		printf(/* textboxtype: 1, unk: 0, line: 20 */ "<0x10009:0x00070c04>¡No te preocupes! <color blue<Zelda >coloroff>está a salvo.\nSe encuentra plácidamente dormida\nen la sala del fondo.\n\n<0x10009:0x00000706>Acaba con ese monstruo y salva\nnuestro mundo, <heroname>.")
          	  case 1:
/*< 54>*/ 		printf(/* textboxtype: 1, unk: 0, line: 19 */ "<0x10009:0x00070c0b>¡No te preocupes! <color blue<Zelda >coloroff>está a salvo.\nSe encuentra plácidamente dormida\nen la sala del fondo.\n\n<0x10009:0x000f0700>Jamás pensé que el Heraldo\nde la Muerte volvería a la vida...\n<pause 10>¡Eres nuestra última esperanza!\n<0x10009:0x00000706>¡Confiamos en ti, <heroname>!")
...
/*< 62>*/ 	start()
/*< 64>*/ 	printf(/* textboxtype: 2, unk: 1, line: 23 */ "Tengo información importante, <0x10012:0x0000000b>amo:\nLa probabilidad de que sea imposible\nabandonar el combate sin vencer al\nadversario antes es del 100%.\n¿Está preparado el <0x10012:0x00000001>amo?[1-]¡Adelante![2]Aún no...")
/*< 63>*/ 	switch (choice(2)) {
          	  case 0:
/*< 65>*/ 		printf(/* textboxtype: 2, unk: 0, line: 25 */ "<0x10012:0x00000005>Sí, amo <heroname>.<pause 15> Espero\nque el <0x10012:0x00000002>amo sepa que, pase lo que\npase, siempre estaré a su lado.\n<pause 30>Buena suerte, <0x10012:0x00000001>amo... ")
          	  case 1:
/*< 66>*/ 		printf(/* textboxtype: 2, unk: 0, line: 24 */ "<0x10012:0x00000005>Está bien, amo. Bastará con regresar\naquí cuando todo esté listo.")
          	}
          }

          void entrypoint_502_05() {
/*< 67>*/ 	start()
/*< 68>*/ 	printf(/* textboxtype: 3, unk: 0, line: 32 */ "<0x10005:0x002d0000><0x10008:0x02cd>¡Ma... maldito mocoso!")
          }
