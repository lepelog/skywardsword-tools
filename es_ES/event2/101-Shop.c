...
/*< 52>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 16}) {
          	  case 0:
/*< 55>*/ 		printf(/* textboxtype: 1, unk: 0, line: 35 */ "<0x10009:0x00000002>Conque le interesan esas\n<color red<10>coloroff> <color yellow<semillas deku>coloroff>, ¿eh, señor?\nSon el proyectil ideal para los maestros\ndel tirachinas.\n¡Nunca salga de aventuras sin\nunas cuantas en el bolsillo!\nSon <color red<20 rupias>coloroff>, ¿qué me dice?\n[1-]Me las llevo[2]Mejor no")
          		goto flw_33
          	  case 1:
