...
/*< 24>*/ 	switch (temp_flags[0 /* 0x1 01 */]) {
          	  case 0:
/*< 25>*/ 		printf(/* textboxtype: 1, unk: 0, line: 31 */ "¡Como no te des prisa al final vas a\nquedarte rezagado!")
          	  case 1:
/*< 71>*/ 		{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 12, 'param3': 31}
/*< 12>*/ 		printf(/* textboxtype: 1, unk: 0, line: 29 */ "<0x10009:0x00030900>Aquí hay cronolitos a montones, y a\ncual más grande.<pause 30>\n<0x10009:0x00000900>¿Tú también vienes enviado por el\n<color blue<dragón>coloroff><color blue< del trueno>coloroff>?\n<0x10009:0x00010900>Pues justo ahora iba a llevar este\ncronolito a su augusta presencia.")
/*< 18>*/ 		temp_flags[0 /* 0x1 01 */] = true;
/*< 87>*/ 		set_camera(1, 0)
/*< 86>*/ 		printf(/* textboxtype: 1, unk: 0, line: 30 */ "<0x10005:0x00280000>El camino está infestado de\nbicharracos de lo más feos...<pause 15>\n<0x10009:0x00030c00>Ve con mucho cuidado.")
          	}
          }
