...
/*<135>*/ 		switch (temp_flags[63 /* 0x6 80 */]) {
          		  case 0:
/*< 46>*/ 			printf("El dragón del trueno vuelve a estar\nsano y fuerte como un roble, ¡y todo\ngracias a ti!")
          		  case 1:
