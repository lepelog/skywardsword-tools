...
/*<165>*/ 				printf("Oh! Benvenuto!\n\n\n\nTi prego, aiutami!\nIl mio povero <b<rinocottero gigante>>!\n\n\nNon riesco a togliermelo dalla testa!\nMi manca così tanto!")
          			  case 1:
...
/*< 28>*/ 							printf("Benissimo. Allora per favore\nnon interrompermi.\n\n\nCon te a bordo il peso aumenta,\nquindi devo pedalare più\nvelocemente...")
...
/*<140>*/ 	switch (story_flags[478 /* us: 805A9B11 0x04, jp: 805ACD91 0x04 */]) {
          	  case 0:
          		flw_145:
/*<145>*/ 		printf("Con quella potrai portare un oggetto in più\nnella tua <y<borsa dell'avventuriero>>!\n\n\nÈ uno degli accessori più utili quando si parte\nall'avventura. Costa <r<600 rupie>>.\n\n\nCosa? Ho alzato il prezzo?\nCerto che no! Ti ricordi male!\nAllora, che ne dici? <r<600 rupie>>.\n[1]Lo compro[2-]No, grazie")
          		goto flw_13
          	  case 1:
/*<139>*/ 		switch (story_flags[477 /* us: 805A9B11 0x02, jp: 805ACD91 0x02 */]) {
          		  case 0:
/*<146>*/ 			printf("Con quella potrai portare un oggetto\nin più nella tua <y<borsa dell'avventuriero>>!\n\n\nÈ uno degli accessori più utili quando\nsi parte all'avventura. Costa <r<300 rupie>>.\n\n\nCosa? Ho alzato il prezzo?\nCerto che no! Ti ricordi male!\nAllora, che ne dici? <r<300 rupie>>.\n[1]Lo compro[2-]No, grazie")
          			goto flw_13
          		  case 1:
          			goto flw_145
          		}
...
/*<144>*/ 	switch (story_flags[478 /* us: 805A9B11 0x04, jp: 805ACD91 0x04 */]) {
          	  case 0:
          		flw_147:
/*<147>*/ 		printf("Con questa potrai espandere ulteriormente\nla tua <y<borsa dell'avventuriero>>.\nTemo che ti verrà a costare parecchio!\n\nSono <r<1200 rupie>>. Che ne dici? Pensaci bene\nperò, magari non ti serve davvero...\n[1]La compro[2-]No, grazie")
          		goto flw_13
          	  case 1:
/*<143>*/ 		switch (story_flags[477 /* us: 805A9B11 0x02, jp: 805ACD91 0x02 */]) {
          		  case 0:
/*<148>*/ 			printf("Con questa potrai espandere al massimo\nla tua <y<borsa dell'avventuriero>>.\nTemo che ti verrà a costare cara!\n\nDi solito la vendo a <r<1200 rupie>>, ma siccome sei\ntu, posso farti il prezzo di favore di <r<600 rupie>>.\n\n\nPensaci bene però, magari non ti serve\ndavvero...\n[1]La compro[2-]No, grazie")
          			goto flw_13
          		  case 1:
          			goto flw_147
          		}
...
/*<  7>*/ 	switch (random(2)) {
          	  case 0:
/*<  8>*/ 		printf("Oh! Grazie mille! Mi hai dato la carica\nper continuare a pedalare!")
          		flw_33:
...
/*<156>*/ 		entrypoint_105_11();
          	  case 1:
/*<  9>*/ 		printf("Oh! Vedrai che non te ne pentirai!")
          		goto flw_33
          	}
          }
...
/*<128>*/ 				set_camera(2, 0)
/*<118>*/ 				printf("\x0E\x01\x09\x04\x1A\x815Oh! Hai trovato il mio\n<b<rinocottero gigante>>?!")
...
/*<114>*/ 							printf("\x0E\x01\x09\x04\x00\x1ETi prego, ritrova il mio\n<b<rinocottero gigante>>.")
          						  case 1:
/*<203>*/ 							{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 112, 'param3': 31}
/*<112>*/ 							printf("\x0E\x01\x09\x04\x00\x1ETi sei messo a cercare il mio <b<rinocottero\ngigante>>? Se lo trovassi te ne sarei grato!\n[1]Ma certo![2-]Lascia\nperdere")
          							flw_57:
/*< 57>*/ 							switch (choice(2)) {
          							  case 0:
/*< 60>*/ 								printf("\x0E\x01\x09\x04\x11\x220Oh! Davvero?\nGuarda che ti prendo in parola!")
/*< 61>*/ 								printf("\x0E\x01\x09\x04\x1D\x200Il mio caro <b<rinocottero gigante>>...\n... ti prego, trovalo!\n\n\n\x0E\x01\x09\x04\x11\xB00Ti scongiuro!")
/*< 62>*/ 								story_flags[474 /* us: 805A9B0E 0x40, jp: 805ACD8E 0x40 */] = true;
/*<110>*/ 								zone_temp_flags[4 /* 0x1 10 */] = true;
          							  case 1:
/*< 59>*/ 								printf("\x0E\x01\x09\x04\x01!Sì, per te è facile parlare così, ma\nio non riesco a farmene una ragione!")
...
/*<126>*/ 							switch (story_flags[201 /* us: 805A9AEF 0x08, jp: 805ACD6F 0x08 */]) {
          							  case 0:
/*<125>*/ 								printf("\x0E\x01\x09\x04\x00\x1EQuando vuoi tornare a Oltrenuvola\nstenditi sul letto e dormi.")
          								flw_98:
