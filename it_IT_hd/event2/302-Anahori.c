...
/*< 16>*/ 		switch (story_flags[180 /* us: 805A9AE6 0x08, jp: 805ACD66 0x08 */]) {
          		  case 0:
/*< 14>*/ 			printf(/* textboxtype: 0, unk: 1, line: 4 */ "Benvenuto!")
...
/*< 54>*/ 				printf(/* textboxtype: 0, unk: 1, line: 7 */ "Mentre stani le rupie puoi incappare\nanche in delle bombe! Allora, ci stai?\n\n\n<0x10009:0x00141614>Sembri un po' stanco. Torna appena\navrai recuperato qualche cuore.")
/*<118>*/ 				set_camera(5, 0)
/*<119>*/ 				printf(/* textboxtype: 2, unk: 0, line: 8 */ "Se ti va, puoi usare quel sedile.")
          			  case 1:
...
/*< 59>*/ 						printf(/* textboxtype: 0, unk: 1, line: 10 */ "Costa <color red<30 rupie>coloroff> per turno.\nVuoi provare?\n[1-]Sì[2]No")
...
/*< 34>*/ 								printf(/* textboxtype: 0, unk: 1, line: 1 */ "Ti auguro di trovare un sacco di rupie!\nBuona fortuna.")
...
/*< 22>*/ 						printf(/* textboxtype: 1, unk: 0, line: 12 */ "Costa <color red<50 rupie >coloroff>per turno.\nVuoi provare?\n[1-]Sì[2]No")
...
/*< 27>*/ 								printf(/* textboxtype: 0, unk: 1, line: 1 */ "Ti auguro di trovare un sacco di rupie!\nBuona fortuna.")
...
/*< 32>*/ 							printf(/* textboxtype: 1, unk: 1, line: 15 */ "Che livello vuoi provare?\n[1-]Facile[2-]Normale[3-]Difficile[4]Nessuno")
          					  ...
          					  case 1:
/*< 63>*/ 						printf(/* textboxtype: 0, unk: 0, line: 11 */ "Nel livello normale ci sono più punti in\ncui scavare, ma occhio alle <color yellow<baba rupie>coloroff>!")
          						goto flw_76
          					}
          				  case 2:
...
/*< 23>*/ 						printf(/* textboxtype: 0, unk: 0, line: 14 */ "Costa <color red<7>coloroff><color red<0 rupie >coloroff>per turno.\nVuoi provare?\n[1-]Sì[2]No")
...
/*<  6>*/ 								printf(/* textboxtype: 0, unk: 1, line: 1 */ "Ti auguro di trovare un sacco di rupie!\nBuona fortuna.")
...
/*< 25>*/ 							printf(/* textboxtype: 1, unk: 1, line: 15 */ "Che livello vuoi provare?\n[1-]Facile[2-]Normale[3-]Difficile[4]Nessuno")
          					  ...
          					  case 1:
/*< 65>*/ 						printf(/* textboxtype: 0, unk: 1, line: 13 */ "Nel livello difficile ci sono più bombe,\nma anche rupie più preziose.\nDa diventare ricchi!")
          						goto flw_78
          					}
          				  case 3:
/*< 86>*/ 					{'type': 'type3', 'subType': 4, 'param1': 18, 'param2': 5379, 'next': 5, 'param3': 13}
/*<  5>*/ 					printf(/* textboxtype: 0, unk: 0, line: 2 */ "Torna presto!")
          				}
          			}
          		  case 1:
/*< 17>*/ 			printf(/* textboxtype: 0, unk: 0, line: 5 */ "Salve, che piacere vederti!\nÈ la prima volta che vieni qui, vero?\nSono onorato!")
/*<155>*/ 			{'type': 'type3', 'subType': 4, 'param1': 255, 'param2': -1, 'next': 154, 'param3': 13}
/*<154>*/ 			printf(/* textboxtype: 1, unk: 0, line: 6 */ "Piacere, mi chiamo <color blue<Raduncolo>coloroff> e sono\nresponsabile del meraviglioso\n<color red<Stana la rupia>coloroff>.")
...
/*< 20>*/ 		printf(/* textboxtype: 1, unk: 1, line: 24 */ "Il numero di <color red<rupie>coloroff> che hai stanato è <color red<<numeric arg0 0>>coloroff>.")
...
/*<  7>*/ 			switch (context_related3(3)) {
          			  case 0:
/*< 11>*/ 				printf(/* textboxtype: 0, unk: 0, line: 17 */ "Non hai stanato nemmeno una rupia?\nOh poverino...")
          				flw_103:
...
/*<107>*/ 				{'type': 'type3', 'subType': 0, 'param1': 0, 'param2': 0, 'next': 55, 'param3': 45}
          		  ...
          		  case 1:
/*<  9>*/ 			printf(/* textboxtype: 0, unk: 0, line: 20 */ "Pareggio. Nessuna perdita, nessun\nguadagno.")
          			goto flw_102
          		  case 2:
/*< 44>*/ 			switch (context_related2(4)) {
          			  case 0:
/*<100>*/ 				{'type': 'type3', 'subType': 4, 'param1': 15, 'param2': 4363, 'next': 10, 'param3': 13}
/*< 10>*/ 				printf(/* textboxtype: 1, unk: 1, line: 21 */ "Hai vinto qualcosina. Ben fatto.")
          				goto flw_102
          			  case 1:
/*<101>*/ 				{'type': 'type3', 'subType': 4, 'param1': 15, 'param2': 4364, 'next': 40, 'param3': 13}
/*< 40>*/ 				printf(/* textboxtype: 0, unk: 1, line: 22 */ "Hai vinto una fortuna! Complimenti!")
          				goto flw_102
          			}
          		}
          	  case 2:
...
/*<159>*/ 		printf(/* textboxtype: 0, unk: 1, line: 25 */ "Hai stanato...")
...
/*< 48>*/ 	start()
/*< 49>*/ 	printf(/* textboxtype: 1, unk: 0, line: 48 */ "Grazie mille per aver partecipato\na <color red<Stana la rupia>coloroff>. Ti do un consiglio\nutile.\n\nLe <color red<rupie meno preziose >coloroff>sono in\nmezzo a <color red<poche insidie>coloroff>, perciò\nnessun problema.\n\nPerò le <color red<rupie più preziose >coloroff>sono\ncircondate da<color red< più insidie>coloroff>. Quindi\nfai attenzione. Alla prossima!")
          }

          void entrypoint_302_03() {
/*< 66>*/ 	start()
/*< 67>*/ 	printf(/* textboxtype: 1, unk: 0, line: 30 */ "Cerca di finire al più presto, il tempo\nsta per scadere.")
          }

          void entrypoint_302_04() {
/*< 68>*/ 	start()
/*< 12>*/ 	printf(/* textboxtype: 0, unk: 0, line: 29 */ "Non puoi prendertela comoda.\nIl tempo è scaduto.")
          }

          void entrypoint_302_05() {
/*<114>*/ 	start()
/*<115>*/ 	printf(/* textboxtype: 0, unk: 1, line: 31 */ "<0x10009:0x00080a04>Oh, vuoi fare una pausa?\n\n\n\nAllora che ne dici di tenermi compagnia?\n[1-]OK[2]No")
/*<120>*/ 	switch (choice(2)) {
          	  case 0:
/*<122>*/ 		printf(/* textboxtype: 1, unk: 0, line: 33 */ "<0x10009:0x000f110c>Super! Hai qualcosa da chiedermi?\n<0x10009:0x00080aff>[1-]Chi sei?[2-]Leviti?[3-]Troppa luce?[4]Niente<0x10009:0x001316ff>")
          		flw_123:
/*<123>*/ 		switch (choice(4)) {
          		  case 0:
...
/*<131>*/ 				printf(/* textboxtype: 1, unk: 0, line: 44 */ "<0x10009:0x00080a05>No, non sto levitando. Mi reggo sulla\ncoda in modo che i clienti possano\nammirare le mie <color red<zampe>coloroff>.")
          			  ...
          			  case 1:
/*<151>*/ 				set_camera(1, 0)
/*<148>*/ 				printf(/* textboxtype: 0, unk: 0, line: 41 */ "<0x10009:0x00141605>No, non sto levitando. Mi reggo sulla coda.")
/*<152>*/ 				set_camera(2, 0)
...
/*<153>*/ 				set_camera(-1, 0)
/*<150>*/ 				printf(/* textboxtype: 0, unk: 1, line: 43 */ "<0x10009:0x00080aff>Non posso fare a meno di metterle\nin mostra. Per questo mi reggo sulla\ncoda, così che i clienti possano\nammirarle.")
...
/*<133>*/ 			switch (zone_temp_flags[2 /* 0x1 04 */]) {
          			  case 0:
/*<135>*/ 				printf(/* textboxtype: 0, unk: 1, line: 40 */ "<0x10009:0x00080a09>No, indosso gli occhiali per avere un\nlook più ricercato.")
          				goto flw_128
          			  case 1:
/*<145>*/ 				set_camera(3, 0)
/*<134>*/ 				printf(/* textboxtype: 0, unk: 1, line: 37 */ "<0x10009:0x0014160a>Alludi ai miei occhiali? Li indosso solo\nper avere un look diverso. La forma\ncircolare mi dona molto, non credi?")
/*<146>*/ 				set_camera(4, 0)
/*<143>*/ 				printf(/* textboxtype: 0, unk: 0, line: 38 */ "<0x10009:0x00140e0b>E che ne dici dei miei <color red<baffi? >coloroff>Non sono\nfantastici? Li curo ogni giorno!")
/*<147>*/ 				set_camera(-1, 0)
...
/*<140>*/ 						switch (scene_flags[39 /* 0x5 80 */]) {
          						  case 0:
          							flw_139:
/*<139>*/ 							printf(/* textboxtype: 0, unk: 1, line: 46 */ "<0x10009:0x00101319>No? Bene... Fai con comodo, puoi\npartecipare a <color blue<Stana la rupia >coloroff>quando vuoi.")
          						  case 1:
...
/*<142>*/ 							scene_flags[4 'Eldin Volcano'][39 /* 0x5 80 */] = true;
          	  ...
          	  case 1:
/*<121>*/ 		printf(/* textboxtype: 0, unk: 0, line: 32 */ "<0x10009:0x00101319>Oh... che peccato. Comunque, se ti senti\nriposato prova a giocare a <color blue<Stana la rupia>coloroff>.")
          	}
          }
