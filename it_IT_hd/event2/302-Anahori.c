...
/*<154>*/ 			printf("Piacere, mi chiamo <b<Raduncolo>> e sono\nresponsabile del meraviglioso\n<r<Stana la rupia>>.")
...
/*< 20>*/ 		printf("Il numero di <r<rupie>> che hai stanato è <r<<numeric arg0>>>.")
...
/*<120>*/ 	switch (choice(2)) {
          	  case 0:
/*<122>*/ 		printf("\x0E\x01\x09\x04\x0F\x110CSuper! Hai qualcosa da chiedermi?\n\x0E\x01\x09\x04\x08\xAFF[1]Chi sei?[2]Leviti?[3]Troppa luce?[4-]Niente\x0E\x01\x09\x04\x13\x16FF")
          		flw_123:
/*<123>*/ 		switch (choice(4)) {
          		  case 0:
...
/*<131>*/ 				printf("\x0E\x01\x09\x04\x08\xA05No, non sto levitando. Mi reggo sulla\ncoda in modo che i clienti possano\nammirare le mie <r<zampe>>.")
          			  ...
          			  case 1:
/*<151>*/ 				set_camera(1, 0)
/*<148>*/ 				printf("\x0E\x01\x09\x04\x14\x1605No, non sto levitando. Mi reggo sulla coda.")
/*<152>*/ 				set_camera(2, 0)
...
/*<142>*/ 							scene_flags[4 'Eldin Volcano'][39 /* 0x5 80 */] = true;
          	  ...
          	  case 1:
/*<121>*/ 		printf("\x0E\x01\x09\x04\x10\x1319Oh... che peccato. Comunque, se ti senti\nriposato prova a giocare a <b<Stana la rupia>>.")
          	}
          }
