...
/*< 26>*/ 	switch (story_flags[208 /* us: 805A9AF0 0x10, jp: 805ACD70 0x10 */]) {
          	  case 0:
/*< 27>*/ 		printf(/* textboxtype: 0, unk: 0, line: 77 */ "Grazie agli <color yellow<artigli>coloroff> potete recuperare\noggetti posti in luoghi distanti.")
          	  case 1:
          	}
          }
...
/*< 33>*/ 	switch (story_flags[304 /* us: 805A9AFC 0x04, jp: 805ACD7C 0x04 */]) {
          	  case 0:
/*< 35>*/ 		printf(/* textboxtype: 0, unk: 0, line: 29 */ "Probabilità che <color blue<Morsego>coloroff> viva nel\ncapanno vicino al cimitero: 95%.")
/*< 36>*/ 		switch (story_flags[360 /* us: 805A9B00 0x40, jp: 805ACD80 0x40 */]) {
          		  case 0:
/*< 54>*/ 			printf(/* textboxtype: 0, unk: 2, line: 31 */ "Morsego ha collezionato <color yellow<gemme di gratitudine >coloroff>per\ndiventare un umano. Probabilità che la diceria del\ndemone di Oltrenuvola scompaia: 60%.\n\nTuttavia, calcolo che tutti avranno paura del nuovo\nvolto umano di Morsego, quindi vi è il 40% di\nprobabilità che questa diceria resti.")
          		  case 1:
/*< 37>*/ 			printf(/* textboxtype: 2, unk: 0, line: 30 */ "Morsego colleziona <color yellow<gemme di\ngratitudine >coloroff>per diventare un umano.\n\n\n<0x10012:0x00000002>Probabilità che ne beneficiate anche\nvoi se decidete di aiutarlo: 85%.")
          		}
          	  case 1:
/*< 34>*/ 		printf(/* textboxtype: 0, unk: 2, line: 28 */ "Se volete saperne di più, consiglierei\ndi recarvi in un luogo dove circolano\nparecchie voci, per esempio la <color blue<taverna\ndelle zucche>coloroff>.")
          	}
          }
...
/*<  1>*/ 	switch (story_flags[194 /* us: 805A9AEC 0x10, jp: 805ACD6C 0x10 */]) {
          	  case 0:
/*<  3>*/ 		printf(/* textboxtype: 0, unk: 2, line: 4 */ "L'apprendista cavaliere <color blue<Dacio >coloroff>perlustra\nil cielo alla ricerca di quest'isola...\n\n\nSembra che egli abbia scoperto un'isola\nadatta agli insetti all'<color blue<interno di\nCumulonembo>coloroff>.")
          	  case 1:
...
/*<  9>*/ 			printf(/* textboxtype: 2, unk: 0, line: 9 */ "Si tratta di un luogo dove potete\nvincere rupie di grande valore.\n\n\nDalla mia analisi risulta che si\ndebba pagare per partecipare.")
          	  ...
          	  case 1:
/*<  6>*/ 		printf(/* textboxtype: 0, unk: 2, line: 7 */ "Dicono che diventerà un parco giochi\ndove sarà possibile vincere rupie di\nnotevole valore.")
          	}
          }
...
/*< 31>*/ 		printf(/* textboxtype: 2, unk: 0, line: 15 */ "Il fatto che durante la notte il negozio\nnon si trovi a <color blue<Oltrenuvola>coloroff>, mi induce\na pensare che si sposti altrove.\n\n<color red<Se riusciste a rimanere nella bottega\nvolante fino al calare della notte>coloroff>,\npotreste scoprire dove si dirige.")
          	  case 1:
/*< 30>*/ 		printf(/* textboxtype: 0, unk: 0, line: 14 */ "<0x10012:0x00000002>Dalla mia analisi risulta che non\npossedete ancora il necessario per far\nsuonare la campana. Vi occorre\n<color red<qualcosa>coloroff> da lanciare a distanza.")
          	}
          }
...
/*< 13>*/ 			switch (choice(2)) {
          			  case 0:
/*< 15>*/ 				printf(/* textboxtype: 0, unk: 2, line: 64 */ "Il guerriero si avvicinò a un covo\ndi boblin con un grande <color blue<scudo di legno>coloroff>.\n\n\nSi riparò dietro lo scudo mentre i suoi\nnemici gli scagliavano contro una pioggia\ndi frecce. Poi si ritirò.\n\n<color red<Conficcate nel suo scudo di legno\n>coloroff>c'erano innumerevoli frecce che\navrebbe potuto utilizzare.")
          				flw_14:
/*< 14>*/ 				printf(/* textboxtype: 0, unk: 0, line: 65 */ "Suppongo che utilizzando uno scudo di legno\npossiate conseguire lo stesso effetto, <0x10012:0x00000002>mio signore.\n\n\nTuttavia, in questo modo lo scudo\nverrà danneggiato. <color red<Fate attenzione\nalla resistenza.>coloroff>")
          			  case 1:
          				goto flw_14
          			}
          		  case 1:
          		  ...
          		  case 2:
          			flw_46:
/*< 46>*/ 			printf(/* textboxtype: 0, unk: 0, line: 62 */ "Le <color blue<piume d'uccello >coloroff>sono un materiale\nmolto versatile.\n\n\nProbabilità che vi occorra un certo\nstrumento per catturare degli uccelli\nper le piume: 90%.")
          		}
          	  case 1:
          		goto flw_46
          	}
...
/*< 39>*/ 	switch (story_flags[368 /* us: 805A9B03 0x40, jp: 805ACD83 0x40 */]) {
          	  case 0:
/*< 41>*/ 		printf(/* textboxtype: 0, unk: 0, line: 44 */ "Se un solcanubi gli si avvicina troppo,\nNarisha potrebbe attaccarlo, perciò\nè molto pericoloso.")
          	  case 1:
/*< 40>*/ 		printf(/* textboxtype: 0, unk: 2, line: 43 */ "Ha continuato a crescere a dismisura\nfino a raggiungere le dimensioni di\nun'isola. Tuttavia, nessuno lo ha\nvisto di recente.")
          	}
          }
