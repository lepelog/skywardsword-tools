...
/*< 17>*/ 			printf(/* textboxtype: 2, unk: 0, line: 0 */ "La vostra energia è diminuita.\nRecuperatela al più presto.<entrypoint_6_402>")
          		  case 1:
/*<  3>*/ 			printf(/* textboxtype: 0, unk: 0, line: 5 */ "La vostra vitalità è diminuita.\nRecuperatela al più presto.\n\n\nPer agevolarvi, ho impostato i <sound 4><color yellow<cuori>coloroff>\ntra gli obiettivi del <color green<rilevatore>coloroff>.")
/*<  6>*/ 			story_flags[108 /* us: 805A9AE1 0x02, jp: 805ACD61 0x02 */] = true;
/*<  7>*/ 			open_dowsing_wheel(11)
/*<  8>*/ 			printf(/* textboxtype: 2, unk: 0, line: 6 */ "Premendo <icon 34> e selezionando il <color yellow<cuore\n>coloroff>dal cerchio potrete scegliere l'obiettivo\ndel rilevatore.<0x10011:0x08cd> Fatene buon uso.")
/*< 12>*/ 			switch (story_flags[226 /* us: 805A9AF2 0x08, jp: 805ACD72 0x08 */]) {
          			  case 0:
/*< 13>*/ 				printf(/* textboxtype: 0, unk: 2, line: 7 */ "Poiché ora vi trovate nella <color red<modalità\neroica >coloroff>non appariranno cuori e tulicuori.\n\n\nTuttavia, se siete in possesso di un\n<color yellow<amuleto del cuore>coloroff>, <color red<avrete la possibilità\n>coloroff>che <sound 4>cuori e tulicuori appaiano.")
          			  case 1:
          			}
          		}
          	  case 1:
