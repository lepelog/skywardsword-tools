...
/*< 17>*/ 	start()
/*< 18>*/ 	printf("La zuppa di zucca la lascio qui. Bzzz...\n\n\n\nCerto il luogo non è dei più tranquilli...")
          }

          void entrypoint_120_21() {
/*< 19>*/ 	start()
/*< 20>*/ 	printf("Allora addio! Bzzz...\x0E\x01\x05\x04(\x00")
...
/*< 32>*/ 	switch (story_flags[17 /* us: 805A9ADB 0x04, jp: 805ACD5B 0x04 */]) {
          	  case 0:
/*< 34>*/ 		printf("Ohohoh... Sei finalmente riuscito\na ottenere la Triforza!")
          		flw_35:
/*< 35>*/ 		printf("Bene, ormai sai da solo cosa devi\nfare, ragazzino, no?\n\n\nAdesso va', e segui il cammino\nin cui credi senza esitazione!")
          		flw_36:
...
/*< 37>*/ 							story_flags[781 /* us: 805A9B2D 0x20, jp: 805ACDAD 0x20 */] = true;
          						  case 1:
/*<  3>*/ 							printf("Come sarebbe \x201Ccome lo sai\"?\nMa che modi sono?\nTi pare il modo di rivolgerti a me?!\n<pause14>Lasciamo perdere...")
          							goto flw_4
          						}
          					}
          				}
