...
/*< 91>*/ 						switch (is_item_check_full()) {
          						  case 0:
/*< 93>*/ 							printf("\x0E\x01\x09\x04\x00\x15Guarda, non mi pesa custodire le tue cose,\nperò qui è pieno di roba tua!\n\n\nPer favore, <r<getta via >>quello che non ti\nserve più...")
          							goto flw_5
          						  case 1:
/*< 92>*/ 							printf("\x0E\x01\x09\x04\x00\x15Fai come preferisci...")
          							goto flw_5
          						}
          					  case 1:
/*< 27>*/ 						switch (is_item_check_full()) {
          						  case 0:
/*< 28>*/ 							printf("\x0E\x01\x09\x04\x00\x04Guarda, non mi pesa custodire le tue cose,\nperò qui è pieno di roba tua!\n\n\nPer favore, <r<getta via >>quello che non ti\nserve più...")
          							goto flw_5
          						  case 1:
/*<  2>*/ 							printf("\x0E\x01\x09\x04\x00\x03Prego!")
          							goto flw_5
          						}
          					}
          				}
...
/*< 57>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_47:
/*< 47>*/ 						printf("\x0E\x01\x09\x04\x0E\x150CEhi! Basta! Mi stai prendendo in giro!")
          					  case 1:
/*< 58>*/ 						printf("\x0E\x01\x09\x04\x00\x13Allora sei venuto solo per farmi visita?\nMi vedi più bella ogni giorno che passa,\nvero? E non riesci a non pensare a me,\nè così?!")
          					}
          				  case 1:
          					goto flw_47
          				}
...
/*< 49>*/ 				switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          				  case 0:
/*< 46>*/ 					printf("\x0E\x01\x09\x04\x00\x17Ehi, ma che problema hai! Se non vuoi\nniente, smettila di importunarmi!")
          				  case 1:
/*< 48>*/ 					switch (story_flags[628 /* us: 805A9B1B 0x80, jp: 805ACD9B 0x80 */]) {
          					  case 0:
/*< 87>*/ 						printf("\x0E\x01\x09\x04\x00\x02Ehi, ma che problema hai? Se non vuoi\nniente, smettila di importunarmi!")
          					  case 1:
/*<  3>*/ 						printf("\x0E\x01\x09\x04\x00\x02Va bene, questa volta ti perdono\nper avermi fatto perdere del tempo.")
          					}
          				}
          			}
          		}
...
/*< 66>*/ 				switch (is_item_check_full()) {
          				  case 0:
/*< 67>*/ 					printf("\x0E\x01\x09\x04\x00\x07Ho già troppe cose tue!\n\n\n\nNon posso prenderne altre in deposito.\nCaro, ti prego, <r<getta via >>quello che non\nti serve.")
          				  case 1:
/*< 68>*/ 					printf("\x0E\x01\x09\x04\x0B\x1709Spero di rivederti presto!")
          				}
          			  case 1:
/*< 71>*/ 				switch (is_item_check_full()) {
          				  case 0:
/*< 72>*/ 					printf("\x0E\x01\x09\x04\x00\x04Accidenti, non ho più\nneanche lo spazio per respirare!\n\n\nNon posso prendere altro in\ndeposito. Per favore, <r<getta via\n>>le cose che non ti servono.")
          				  case 1:
/*< 73>*/ 					printf("\x0E\x01\x09\x04\x00\x15Dovresti tornare ogni giorno\nper vedere quanto sono bella!")
          				}
          			}
          		  case 1:
          			goto flw_66
...
/*< 94>*/ 			switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          			  case 0:
/*< 95>*/ 				printf("\x0E\x01\x09\x04\x00\x15Hai troppa roba in deposito!\n\n\n\nNon so più dove metterla. Per favore,\n<r<getta via >>le cose che non ti servono.")
          			  case 1:
/*< 26>*/ 				printf("\x0E\x01\x09\x04\x00\x04Tutto il deposito è pieno di roba tua!\n\n\n\nNon c'è più spazio... per favore, <r<getta via\n>>quello che non ti serve più, te ne prego.")
          			}
          		  case 1:
/*< 88>*/ 			switch (story_flags[629 /* us: 805A9B1A 0x01, jp: 805ACD9A 0x01 */]) {
          			  case 0:
/*< 89>*/ 				printf("\x0E\x01\x09\x04\x00\x06Grazie tante...")
          			  case 1:
/*<  7>*/ 				printf("\x0E\x01\x09\x04\x00\x03Grazie tante...")
          			}
          		}
          	}
          }
...
/*< 36>*/ 	switch (story_flags[630 /* us: 805A9B1A 0x02, jp: 805ACD9A 0x02 */]) {
          	  case 0:
/*< 35>*/ 		printf("Fanno <r<<numeric arg0> rupie >>per il deposito.\n\n\n\nSei sicuro?\n[1]Sì[2-]No")
          		flw_11:
/*< 11>*/ 		switch (choice(2)) {
          		  case 0:
...
/*< 79>*/ 						printf("\x0E\x01\x09\x04\x00\x03Grazie!\nC'è qualcos'altro?")
          			  ...
          			  case 1:
/*< 10>*/ 				printf("\x0E\x01\x09\x04\x00\x03Grazie.\nPosso fare qualcos'altro per te?")
          				goto flw_53
          			}
          		  case 1:
...
/*< 75>*/ 					switch (story_flags[636 /* us: 805A9B1A 0x40, jp: 805ACD9A 0x40 */]) {
          					  case 0:
          						flw_38:
/*< 38>*/ 						printf("\x0E\x01\x09\x04\x00\x12Oh! Non vuoi?\nMa certo! Non ne vale la pena.\nChe furbo che sei, caro mio!")
          						goto flw_53
          					  case 1:
/*< 76>*/ 						printf("\x0E\x01\x09\x04\x00\x14Eh? Cambiato idea? Beh, cambiare idea\nè normale. Proprio come hai cambiato\nidea anche su di me...")
          						goto flw_53
          					}
          				  case 1:
          					goto flw_38
          			  ...
          			  case 1:
/*< 13>*/ 				printf("Oh? Hai cambiato idea?\nChe peccato.")
          				goto flw_53
          			}
          		}
          	  case 1:
/*<  9>*/ 		printf("Mmmh... sono disposta a pagare\n<r<<r<<numeric arg0><r< rupie>>.\n\n\nChe mi dici, affare fatto?\n[1]Sì[2-]No")
          		goto flw_11
          	}
          }
...
/*< 82>*/ 				printf("\x0E\x01\x09\x04\x00\nOh, caro, non hai niente con te.\n\n\n\nNon ti preoccupare, sono sicura che presto\navrai tante belle cose da depositare.")
          			  case 1:
/*< 83>*/ 				printf("\x0E\x01\x09\x04\x00\x04Oh. Non hai niente!\n\n\n\nTorna a trovarmi quando avrai qualcosa\nda depositare.")
          			}
          		  case 1:
          			goto flw_82
          		}
          	  case 1:
/*< 15>*/ 		printf("\x0E\x01\x09\x04\x00\x04Oh! Ma non hai niente...\n\n\n\nTorna da me quando avrai davvero\nqualcosa da depositare.")
          	}
          }
