...
/*<  9>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 10>*/ 		printf(/* textboxtype: 2, unk: 4, line: 26 */ "<heroname>!\nImpegnati al massimo!")
/*< 12>*/ 		set_camera(10, 0)
...
/*< 51>*/ 				switch (choice(4)) {
          				  case 0:
/*< 58>*/ 					printf(/* textboxtype: 4, unk: 2, line: 7 */ "Sì, <0x10012:0x00000005>mio signore, vi rispondo\nimmediatamente.\n\n\nPer riempire il <color yellow<ricettacolo dello spirito>coloroff>\nè necessario raccogliere le <color yellow<lacrime di\nNayru>coloroff> sparse in questo mondo.")
/*< 52>*/ 					set_camera(2, 0)
/*< 53>*/ 					{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': 0, 'next': 55, 'param3': 40}
/*< 55>*/ 					printf(/* textboxtype: 2, unk: 4, line: 8 */ "Dunque, <0x10012:0x00000002>mio signore, vedete quell'oggetto\nche brilla dinanzi a voi?")
/*< 56>*/ 					set_camera(3, 0)
/*< 59>*/ 					printf(/* textboxtype: 2, unk: 2, line: 9 */ "Si tratta di una <color yellow<lacrima di Nayru>coloroff>.\nDovete raccoglierne <color red<15>coloroff>.")
/*< 54>*/ 					{'type': 'type3', 'subType': 1, 'param1': 31, 'param2': 1, 'next': 57, 'param3': 40}
/*< 57>*/ 					wait_frames(15)
          					flw_77:
/*< 77>*/ 					set_camera(1, 0)
/*< 78>*/ 					printf(/* textboxtype: 4, unk: 2, line: 4 */ "Avete ulteriori domande?\n[1-]Ricettacolo\ndello spirito[2-]Guardiani[3-]Prova[4]Niente")
          					goto flw_51
          				  case 1:
/*< 60>*/ 					printf(/* textboxtype: 4, unk: 2, line: 10 */ "<0x10012:0x00000005>Sì, mio signore, vi rispondo\nimmediatamente.")
/*< 61>*/ 					set_camera(6, 0)
/*< 64>*/ 					printf(/* textboxtype: 2, unk: 4, line: 11 */ "Se fate un solo passo fuori da quell'area,\ndegli esseri chiamati <color red<guardiani >coloroff>vi\ninseguiranno.")
/*< 62>*/ 					set_camera(4, 0)
...
/*< 63>*/ 					set_camera(5, 0)
/*< 66>*/ 					printf(/* textboxtype: 0, unk: 4, line: 14 */ "Evitate di subire attacchi e raccogliete\nle <color yellow<lacrime>coloroff> per riempire il <color yellow<ricettacolo\ndello spirito>coloroff>.")
          					goto flw_77
          				  case 2:
/*< 67>*/ 					printf(/* textboxtype: 4, unk: 2, line: 10 */ "<0x10012:0x00000005>Sì, mio signore, vi rispondo\nimmediatamente.")
/*< 68>*/ 					set_camera(11, 0)
/*< 69>*/ 					printf(/* textboxtype: 4, unk: 2, line: 13 */ "In questo mondo si trovano delle zone\nliquide, chiamate <color red<delatori>coloroff>. Se le\ncalpestate, i<color red< guardiani lo scopriranno\nimmediatamente>coloroff>.\nFate sempre molta attenzione\ned evitate di calpestarle.")
          					goto flw_77
          				  case 3:
          					flw_70:
/*< 70>*/ 					printf(/* textboxtype: 2, unk: 4, line: 5 */ "<0x10012:0x00000005>Certamente, mio signore.")
/*< 71>*/ 					set_camera(10, 0)
/*< 72>*/ 					printf(/* textboxtype: 2, unk: 2, line: 6 */ "La vostra servitrice Faih attende il vostro\nritorno al mondo esterno, <0x10012:0x00000002>mio signore.")
