...
/*< 15>*/ 	printf(/* textboxtype: 0, unk: 0, line: 17 */ "Che insistenza.<pause 5>.<pause 5>.")
/*< 19>*/ 	set_camera(3, 0)
/*< 16>*/ 	printf(/* textboxtype: 2, unk: 0, line: 18 */ "Mi occorre del tempo per trovare il modo\ndi aiutare il mio oscuro signore.<pause 5>.<pause 5>.")
/*< 20>*/ 	set_camera(4, 0)
/*< 30>*/ 	{'type': 'type3', 'subType': 4, 'param1': 3334, 'param2': 512, 'next': 23, 'param3': 13}
/*< 23>*/ 	wait_frames(30)
/*< 22>*/ 	printf(/* textboxtype: 0, unk: 2, line: 19 */ "Inoltre... il tuo continuo scorrazzare\nmi urta oltremodo i nervi.")
...
/*<  4>*/ 	start()
/*<  5>*/ 	printf(/* textboxtype: 0, unk: 7, line: 4 */ "Cerca la <color yellow<chiave >coloroff>che giace\nnelle profondità della terra.")
          }
