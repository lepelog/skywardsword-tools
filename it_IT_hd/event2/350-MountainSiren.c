...
/*< 13>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 12>*/ 		printf(/* textboxtype: 2, unk: 4, line: 26 */ "<heroname>!\nImpegnati al massimo!")
/*< 15>*/ 		set_camera(10, 0)
...
/*< 51>*/ 				switch (choice(4)) {
          				  case 0:
/*< 52>*/ 					printf(/* textboxtype: 4, unk: 2, line: 7 */ "Bene,<0x10012:0x00000005> mio signore. Eccovi la risposta.\n\n\n\nPer riempire il <color yellow<ricettacolo dello spirito>coloroff>,\ndovete raccogliere le <color yellow<lacrime di Din\n>coloroff>sparse per questo mondo.")
/*< 59>*/ 					set_camera(2, 0)
/*< 58>*/ 					{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': 0, 'next': 56, 'param3': 40}
/*< 56>*/ 					printf(/* textboxtype: 2, unk: 4, line: 8 */ "Quella che vedete splendere lì...")
/*< 55>*/ 					set_camera(3, 0)
...
/*< 53>*/ 					wait_frames(15)
          					flw_77:
/*< 77>*/ 					set_camera(1, 0)
/*< 78>*/ 					printf(/* textboxtype: 4, unk: 2, line: 4 */ "Cos'altro volete approfondire?\n\n[1-]Il ricettacolo\ndello spirito[2-]I guardiani[3-]Il delatore[4]Niente")
          					goto flw_51
          				  case 1:
/*< 60>*/ 					printf(/* textboxtype: 4, unk: 2, line: 10 */ "Bene,<0x10012:0x00000005> mio signore. Eccovi la risposta.")
/*< 64>*/ 					set_camera(6, 0)
/*< 66>*/ 					printf(/* textboxtype: 2, unk: 4, line: 11 */ "Appena farete un passo fuori da quella\nzona, verrete inseguito <0x10012:0x00000002>dai <color red<guardiani>coloroff>.")
/*< 63>*/ 					set_camera(4, 0)
...
/*< 62>*/ 					set_camera(5, 0)
/*< 61>*/ 					printf(/* textboxtype: 4, unk: 2, line: 13 */ "Raccogliete le <color yellow<lacrime >coloroff>e riempite\nil <color yellow<ricettacolo dello spirito >coloroff>senza farvi\ncolpire.")
          					goto flw_77
          				  case 2:
/*< 68>*/ 					printf(/* textboxtype: 4, unk: 2, line: 10 */ "Bene,<0x10012:0x00000005> mio signore. Eccovi la risposta.")
/*< 67>*/ 					set_camera(11, 0)
/*< 69>*/ 					printf(/* textboxtype: 2, unk: 4, line: 14 */ "Il liquido davanti a voi viene\nchiamato <color red<delatore>coloroff>.\n\n\nÈ una zona particolare. Anche solo\nsfiorandola, i guardiani vi\n<color red<scopriranno all'istante>coloroff>.\n\nIncontrerete spesso queste aree, fate\nattenzione a dove camminate!")
          					goto flw_77
          				  case 3:
          					flw_70:
/*< 70>*/ 					printf(/* textboxtype: 2, unk: 4, line: 5 */ "Bene, <0x10012:0x00000005>mio signore.")
/*< 71>*/ 					set_camera(10, 0)
/*< 72>*/ 					printf(/* textboxtype: 2, unk: 2, line: 6 */ "Attenderò il vostro ritorno al mondo\nnormale, <0x10012:0x00000002>mio signore.")
