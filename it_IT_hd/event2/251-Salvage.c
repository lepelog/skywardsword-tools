...
/*<  5>*/ 	start()
/*<  6>*/ 	printf("\x0E\x01\x12\x04\x00dAdorata Faih!\nAccorro! Eccomi! Bzzz!\n\n\nVuoi che trasporti qualcosa?\nCerto! Bzzz!")
          }

          void entrypoint_251_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf("Ecco qui! Ti aspetto in volo, nel cielo,\nraggiungimi presto!!! Bzzz!!!")
          }

          void entrypoint_251_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf("\x0E\x01\x12\x04\x00\x01Signore, suggerirei di tornare nel\nCielo e portare subito il Kyuri nella\nterra designata.")
...
/*< 40>*/ 						story_flags[1094 /* us: 805A9B52 0x10, jp: 805ACDD2 0x10 */] = true;
          				  ...
          				  case 1:
/*< 18>*/ 					printf("\x0E\x01\x09\x04\x09\x13Ma ci sono ancora un sacco di cattivi\nin giro...\n\n\n\x0E\x01\x09\x04\x07\x04Noi Kyuri saremo condannati a passare\nla nostra vita così?!")
          					goto flw_19
          				}
          			  case 1:
/*< 17>*/ 				printf("\x0E\x01\x09\x04\x07\x11È dura la vita a stare fermi\ncome una natura morta aspettando\ndi scampare il pericolo, credimi!")
          				goto flw_38
          			}
          		}
          	}
