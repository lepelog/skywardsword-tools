...
/*< 80>*/ 	switch ({'type': 'switch', 'subType': 6, 'param2': 0, 'param3': 7, 'param4': 2, 'param5': 20}) {
          	  case 0:
/*< 73>*/ 		printf("\x0E\x01\x09\x04\x00\x02Questo è un <y<sacco per semi piccolo>>!\nLe basta alloggiarlo all'interno della sua borsa\nper poter trasportare 10 semi in più.\n\nÈ un accessorio fondamentale per tutti gli\namanti della fionda! Costa <r<100 rupie>>.\n\n\nChe ne dice, signore?\n[1]Lo compro[2-]Non\nlo compro")
          		goto flw_33
          	  case 1:
/*< 82>*/ 		printf("Signore... a quanto pare lei non è in\npossesso di una fionda. Non posso certo\nvenderle questo prodotto se lei non\nha ancora una fionda...\nPerché non dà uno sguardo\nal resto della merce?")
          	}
          }
...
/*< 18>*/ 	printf("\x0E\x01\x09\x04\x00\x08Ehm...\x0E\x01\x05\x04\n\x00")
...
/*< 43>*/ 	switch (random(2)) {
          	  case 0:
/*< 20>*/ 		printf("\x0E\x01\x09\x04\x00\x07Aaah, la ringrazio.\nLei qui è sempre il benvenuto!")
          		flw_144:
...
/*<133>*/ 						story_flags[809 /* us: 805A9B31 0x02, jp: 805ACDB1 0x02 */] = true;
          			  ...
          			  case 1:
/*< 89>*/ 				printf("Signore, se non le dispiace mi prendo\nla libertà di riporre l'acquisto nella\nsua borsa.\nPer aprire la borsa tenga premuto \x0E\x02\x04\x02\x28CD.\x0E\x01\x11\x02\xECD\nQuando avrà scelto l'oggetto che intende\nutilizzare, <g<rilasci >>\x0E\x02\x04\x02\x28CD per equipaggiarlo.\nIn questo modo, le sarà possibile usare\noggetti quali gli scudi senza difficoltà!\x0E\x01\x11\x02\xECD")
...
/*<136>*/ 				zone_temp_flags[5 /* 0x1 20 */] = false;
          	  ...
          	  case 1:
/*< 42>*/ 		printf("\x0E\x01\x09\x04\x00\x07Aaah. Il cliente ha sempre ragione!")
          		goto flw_144
          	}
          }
