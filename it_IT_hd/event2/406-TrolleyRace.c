...
/*< 24>*/ 				switch (zone_temp_flags[1 /* 0x1 02 */]) {
          				  case 0:
/*< 32>*/ 					printf(/* textboxtype: 0, unk: 0, line: 2 */ "Vuoi riprovare l'ebbrezza delle Montagne\nrusse? Un giro costa 20 rupie!\n[1-]Sì[2]No")
          					flw_2:
/*<  2>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_8:
...
/*< 14>*/ 											switch (story_flags[500 /* us: 805A9B12 0x04, jp: 805ACD92 0x04 */]) {
          											  case 0:
/*< 43>*/ 												printf(/* textboxtype: 0, unk: 0, line: 8 */ "Il tuo miglior tempo finora è\n<numeric arg0 2>:<numeric arg1 2>.<numeric arg2 2>!")
          												goto flw_101
          											  case 1:
          												goto flw_101
          											}
...
/*< 59>*/ 								printf(/* textboxtype: 0, unk: 1, line: 28 */ "E difficile sia. Buona fortuna!")
/*< 60>*/ 								story_flags[529 /* us: 805A9B14 0x40, jp: 805ACD94 0x40 */] = true;
          								goto flw_15
          							}
          						  case 1:
/*<103>*/ 							{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3333, 'next': 40, 'param3': 13}
/*< 40>*/ 							printf(/* textboxtype: 0, unk: 0, line: 5 */ "Non hai abbastanza soldi? Che peccato!\n\n\n\nTorna qui appena ne avrai racimolati\nun po'.")
          						}
          					  case 1:
/*<105>*/ 						{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3333, 'next': 34, 'param3': 13}
/*< 34>*/ 						printf(/* textboxtype: 0, unk: 1, line: 4 */ "OK. Ci vediamo!")
          					}
          				  case 1:
/*< 33>*/ 					printf(/* textboxtype: 1, unk: 0, line: 3 */ "Ehi roccia! Sei tornato!\n\n\n\nVuoi salire sulle Montagne russe?\nSono 20 rupie!\n[1-]Sì[2]No")
          					goto flw_2
          				}
          			  case 1:
/*< 21>*/ 				switch (zone_temp_flags[0 /* 0x1 01 */]) {
          				  case 0:
/*< 30>*/ 					printf(/* textboxtype: 0, unk: 1, line: 10 */ "Dunque ho la tua attenzione, roccia?\n[1-]Sì[2]No")
          					flw_19:
/*< 19>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_110:
/*<110>*/ 						{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3332, 'next': 38, 'param3': 13}
/*< 38>*/ 						printf(/* textboxtype: 0, unk: 1, line: 7 */ "Lo scopo è arrivare alla fine del percorso\nnel minor tempo possibile.\n\n\nSpostati per inclinare il carrello. Se riesci\na inclinarti dell'angolo giusto durante\nuna curva, andrai più veloce.\n\nAttento però: la minima distrazione e\nderaglierai! Se succede, perderai la corsa.")
/*< 11>*/ 						story_flags[274 /* us: 805A9AF8 0x10, jp: 805ACD78 0x10 */] = true;
/*< 71>*/ 						{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 55, 'param3': 12}
/*< 55>*/ 						printf(/* textboxtype: 0, unk: 1, line: 25 */ "Che ne dici di un giro sulle Montagne\nrusse? Costa 20 rupie.\n[1-]OK[2]No")
/*< 22>*/ 						switch (choice(2)) {
          						  case 0:
          							goto flw_8
          						  case 1:
/*<104>*/ 							{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3333, 'next': 37, 'param3': 13}
/*< 37>*/ 							printf(/* textboxtype: 0, unk: 1, line: 16 */ "Che peccato. Ci sono persino dei premi\nin palio...\n\n\nLa tua decisione è solida come la roccia?\n[1-]Partecipo[2]Rinuncio")
/*< 23>*/ 							switch (choice(2)) {
          							  case 0:
          								goto flw_8
          							  case 1:
/*<102>*/ 								{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3330, 'next': 39, 'param3': 13}
/*< 39>*/ 								printf(/* textboxtype: 1, unk: 0, line: 15 */ "OK. Ci si vede!")
          							}
          						}
          					  case 1:
/*<109>*/ 						{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3333, 'next': 36, 'param3': 13}
/*< 36>*/ 						printf(/* textboxtype: 0, unk: 0, line: 14 */ "Lasciarmi spiegare le regole non\nti costerà nulla...")
/*< 20>*/ 						zone_temp_flags[0 /* 0x1 01 */] = true;
          					}
          				  case 1:
/*< 31>*/ 					printf(/* textboxtype: 0, unk: 0, line: 11 */ "Ehi roccia. Che ci fai qui?\n\n\n\nChe ne dici di un po' di divertimento?\n[1-]Che?[2]Non ora")
/*< 45>*/ 					switch (choice(2)) {
          					  case 0:
/*< 35>*/ 						printf(/* textboxtype: 0, unk: 1, line: 13 */ "Sapevo che avrei attirato la tua\nattenzione. Lascia che ti spieghi.")
          						goto flw_110
          					  case 1:
/*< 46>*/ 						printf(/* textboxtype: 1, unk: 0, line: 12 */ "Che noia, roccia. Almeno ascoltami!\n[1-]OK[2]No")
          						goto flw_19
          					}
          				}
          			}
...
/*< 47>*/ 			printf(/* textboxtype: 1, unk: 0, line: 18 */ "Hai completato il percorso.")
...
/*< 48>*/ 						printf(/* textboxtype: 0, unk: 1, line: 19 */ "Un nuovo record. Sei grande, roccia!")
          						flw_4:
/*<  4>*/ 						switch (context_related4(0)) {
          						  case 0:
/*< 65>*/ 							{'type': 'type3', 'subType': 4, 'param1': 10, 'param2': 3590, 'next': 51, 'param3': 13}
/*< 51>*/ 							printf(/* textboxtype: 1, unk: 0, line: 21 */ "Stai scherzando, eri troppo lento!\n\n\n\nNon c'è un premio per un simile tempo.")
          							flw_68:
...
/*< 50>*/ 								printf(/* textboxtype: 0, unk: 0, line: 20 */ "Torna pure quando vuoi!")
...
/*< 52>*/ 							printf(/* textboxtype: 0, unk: 1, line: 22 */ "Puoi fare di meglio, devi solo piegarti\ndi più col carrello. Comunque, ecco\nla tua vincita!")
...
/*< 74>*/ 							switch (story_flags[529 /* us: 805A9B14 0x40, jp: 805ACD94 0x40 */]) {
          							  case 0:
/*< 53>*/ 								printf(/* textboxtype: 0, unk: 0, line: 23 */ "Non male, ma non sei certo veloce\ncome me! Ecco a te!")
/*<  6>*/ 								give_item(63 0x3F);
          								goto flw_68
          							  case 1:
/*<131>*/ 								printf(/* textboxtype: 0, unk: 1, line: 34 */ "Risultato apprezzabile, ma non puoi\ncompetere con me! Eccoti 50 rupie.")
...
/*< 54>*/ 							printf(/* textboxtype: 1, unk: 0, line: 24 */ "Wow! Una prestazione superba!\nHai superato persino me!")
/*< 75>*/ 							switch (story_flags[529 /* us: 805A9B14 0x40, jp: 805ACD94 0x40 */]) {
          							  case 0:
/*< 78>*/ 								switch (story_flags[667 /* us: 805A9B1E 0x02, jp: 805ACD9E 0x02 */]) {
          								  case 0:
/*<122>*/ 									printf(/* textboxtype: 0, unk: 0, line: 32 */ "Ti meriti un premio davvero speciale!")
/*< 76>*/ 									give_item(64 0x40);
          									goto flw_68
          								  case 1:
/*<121>*/ 									printf(/* textboxtype: 0, unk: 1, line: 31 */ "Per te ho un tesoro che ho trovato\nproprio su quest'isola!")
/*< 77>*/ 									give_item(94 0x5E);
/*< 79>*/ 									story_flags[667 /* us: 805A9B1E 0x02, jp: 805ACD9E 0x02 */] = true;
          									goto flw_68
          								}
          							  case 1:
/*<123>*/ 								printf(/* textboxtype: 1, unk: 0, line: 33 */ "Eccoti una rupia che custodivo con cura!")
...
/*< 49>*/ 			printf(/* textboxtype: 0, unk: 0, line: 17 */ "Accidenti! Non è andata bene! Puoi\nsempre tornare e riprovare quando vuoi!")
...
/*< 99>*/ 			printf(/* textboxtype: 1, unk: 0, line: 30 */ "Tempo scaduto!\nRiprova la prossima volta!")
...
/*< 93>*/ 		printf(/* textboxtype: 1, unk: 0, line: 36 */ "Sono qui da parecchi anni ormai. Vado sui\ncarrelli ogni giorno, non mi basta mai.")
          		flw_97:
/*< 97>*/ 		story_flags[741 /* us: 805A9B26 0x20, jp: 805ACDA6 0x20 */] = true;
          	  case 1:
/*<119>*/ 		{'type': 'type3', 'subType': 4, 'param1': 8, 'param2': 3334, 'next': 92, 'param3': 13}
/*< 92>*/ 		printf(/* textboxtype: 0, unk: 0, line: 35 */ "Quello è il mio sedile, per tutti i porfidi!")
          		goto flw_97
          	}
          }
