...
/*< 12>*/ 	start()
/*< 13>*/ 	printf("Per aprire la porta, trova le\n<r<pietre brillanti>> dietro ogni\nstatua e colpiscile nel giusto\nordine a partire dal basso.")
          }

          void entrypoint_125_05() {
/*< 14>*/ 	start()
/*< 18>*/ 	printf("\x0E\x01\x12\x04\x00\x01Mio signore...\nGuardate!")
/*< 24>*/ 	set_camera(1, 0)
/*< 22>*/ 	printf("Quel simbolo sul pavimento è l'<r<emblema\ndi Farore>>.\n\n\nPercepisco la forza sacra della <y+<Triforza\n>>provenire da lì.")
/*< 36>*/ 	set_camera(2, 0)
/*< 23>*/ 	printf("Per raggiungere l'emblema, suggerisco\ndi avanzare oltre la porta.")
/*< 54>*/ 	set_camera(-1, 0)
          }

          void entrypoint_125_06() {
/*< 15>*/ 	start()
/*< 25>*/ 	printf("\x0E\x01\x12\x04\x00\x01Mio signore...\nGuardate!")
/*< 26>*/ 	set_camera(3, 0)
/*< 19>*/ 	printf("Quel simbolo sul pavimento è l'<r<emblema\ndi Nayru>>.\n\n\nPercepisco la forza sacra della <y+<Triforza\n>>provenire da lì.\n\n\nMa la strada che conduce lì sembra\nchiusa...")
/*< 37>*/ 	set_camera(5, 0)
/*< 38>*/ 	printf("Guardate là, mio signore.\nÈ una <y<sfera del tempo>>!")
/*< 27>*/ 	set_camera(-1, 0)
/*< 28>*/ 	printf("Suggerisco di agire sulla <y<sfera del tempo\n>>per aprirvi la strada verso l'<r<emblema>>.")
          }

          void entrypoint_125_07() {
/*< 16>*/ 	start()
/*< 30>*/ 	printf("\x0E\x01\x12\x04\x00\x01Mio signore...\nGuardate!")
/*< 29>*/ 	set_camera(4, 0)
/*< 20>*/ 	printf("Quello sul pavimento è l'<r<emblema di Din>>.\n\n\n\nPercepisco la forza sacra della <y+<Triforza\n>>provenire da lì.")
/*< 31>*/ 	set_camera(-1, 0)
/*< 32>*/ 	printf("Ma sembra impossibile raggiungere\nl'emblema.\n\n\nSuggerisco di trovare una diversa via\ndi accesso alla stanza.")
...
/*< 33>*/ 	switch (scene_flags[122 /* 0xE 04 */]) {
          	  case 0:
/*< 21>*/ 		printf("\x0E\x01\x12\x04\x00\x0BMio signore, Faih a rapporto.\nQuesta è la stanza dell'<r<emblema di\nDin>>, dove eravamo prima.")
          		flw_39:
/*< 39>*/ 		set_camera(6, 0)
/*< 34>*/ 		printf("Probabilità di raggiungere la forza sacra\nsuperando quella lava: 60%.")
/*< 41>*/ 		set_camera(-1, 0)
/*< 40>*/ 		printf("Suggerisco di procedere\ncon determinazione.")
          	  case 1:
/*< 35>*/ 		printf("\x0E\x01\x12\x04\x00\x0BMio signore, Faih a rapporto.\nConfermo che la forza sacra si trova\nin questa stanza.")
          		goto flw_39
          	}
          }
...
/*< 44>*/ 	start()
/*< 49>*/ 	set_camera(7, 0)
/*< 43>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMio signore Link,\nFaih a rapporto.\nAvete raggiunto l'emblema.\n\nOffrite la spada e vi verrà indicata\nla strada verso la <y+<Triforza>>.")
          }

          void entrypoint_125_12() {
/*< 46>*/ 	start()
/*< 50>*/ 	set_camera(8, 0)
/*< 45>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMio signore Link,\nFaih a rapporto.\nAvete raggiunto l'emblema.\n\nOffrite la spada e vi verrà indicata\nla strada verso la <y+<Triforza>>.")
          }

          void entrypoint_125_13() {
/*< 48>*/ 	start()
/*< 51>*/ 	set_camera(9, 0)
/*< 47>*/ 	printf("\x0E\x01\x12\x04\x00\x0BMio signore Link,\nFaih a rapporto.\nAvete raggiunto l'emblema.\n\nOffrite la spada e vi verrà indicata\nla strada verso la <y+<Triforza>>.")
          }
