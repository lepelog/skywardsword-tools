...
/*< 35>*/ 	start()
/*< 36>*/ 	printf(/* textboxtype: 0, unk: 1, line: 16 */ "Levati dai piedi! Bzzz! Sta per passare\nil carrello! Bzzz!")
/*< 71>*/ 	scene_flags[7 'Lanayru Desert'][4 /* 0x1 10 */] = true;
          }

          void entrypoint_400_66() {
/*<164>*/ 	start()
/*<165>*/ 	printf(/* textboxtype: 0, unk: 1, line: 85 */ "Siamo arrivati al <color blue<deserto di Ranel>coloroff>.\n\n\n\nÈ possibile individuare con il rilevatore\nil portale della prova, necessario per\nottenere la fiamma sacra.")
...
/*<167>*/ 	start()
/*<168>*/ 	printf(/* textboxtype: 0, unk: 0, line: 86 */ "Siamo arrivati al <color blue<Santuario del Tempo>coloroff>.\n\n\n\nÈ possibile individuare con il rilevatore\nil portale della prova, necessario per\nottenere la fiamma sacra.")
/*<169>*/ 	scene_flags[7 'Lanayru Desert'][74 /* 0x8 04 */] = true;
          }

          void entrypoint_400_32() {
/*<238>*/ 	start()
/*<239>*/ 	printf(/* textboxtype: 0, unk: 0, line: 53 */ "Ultimamente siamo spesso attaccati da\nstrani esseri. Noi non abbiamo armi...\nogni attacco può essere letale... Bzzz!")
...
/*< 12>*/ 				printf(/* textboxtype: 1, unk: 0, line: 21 */ "Ma sei ancora qui?! Bzzz!\nProcedi con cautela! Bzzz!")
          			  case 1:
/*<310>*/ 				printf(/* textboxtype: 0, unk: 0, line: 62 */ "Stai cercando un drago? Bzzz? Se si\ntratta del <color blue<<0x10009:0x13030000>drago del fulmine>coloroff>, potresti\ntrovarlo a sud delle <color blue<grotte di Ranel>coloroff>.\n\nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*<  5>*/ 		switch (story_flags[90 /* us: 805A9AEF 0x80, jp: 805ACD6F 0x80 */]) {
          		  case 0:
          			flw_10:
/*< 10>*/ 			printf(/* textboxtype: 0, unk: 0, line: 20 */ "Ora è in grado di <color red<afferrare le cose\ncon le pinze>coloroff>! Fai attenzione! Bzzz!")
...
/*<  6>*/ 			switch (context_related2(0)) {
          			  case 0:
/*<274>*/ 				printf(/* textboxtype: 0, unk: 1, line: 22 */ "<0x10009:0x13030000>Grazie! Bzzz!")
...
/*<209>*/ 	start()
/*<210>*/ 	printf(/* textboxtype: 0, unk: 2, line: 109 */ "Obiettivo del mese:\n150 contenitori\n           Il Direttore")
          }
...
/*<359>*/ 				story_flags[823 /* us: 805A9B30 0x80, jp: 805ACDB0 0x80 */] = true;
          				goto flw_149
          			  case 1:
/*<270>*/ 				printf(/* textboxtype: 2, unk: 0, line: 96 */ "<0x10009:0x2f080d02>Ehi, <heroname>!")
/*<271>*/ 				set_camera(5, 0)
/*<211>*/ 				printf(/* textboxtype: 0, unk: 0, line: 98 */ "E invece la <color blue<fiamma sacra >coloroff>di cui\nmi parlavi... Come è andata a finire?\nL'hai trovata?\n\nDa quando me lo hai detto non ho\nfatto che pensarci...\nRacconta!\n\n<0x10009:0x2f080407>.<pause 20>.<pause 20>.<pause 20> Ah... dopo una serie di avventure\nsei riuscito a trovarla!\n\n\nSei davvero una roccia,\n<heroname>!")
/*<356>*/ 				printf(/* textboxtype: 2, unk: 0, line: 99 */ "<0x10009:0x2f080d0a>Anch'io ho scoperto qualcosa sulla\nleggenda dei tre draghi.<pause 15>\n\n\nSì, è vero, nel deserto esiste\nun luogo nascosto!\n\n\nHo trovato un<color red< piccolo passaggio>coloroff><sound 4>,\ncosì piccolo che non ci entro!\n\n\n<0x10009:0x2f000d00>Secondo me conduce alla terra\ndove viveva il <color red<drago del fulmine>coloroff>,\nuno dei tre draghi della leggenda.\n\n<0x10009:0x2f000800>Scommetto che anche\ni robot c'entrano qualcosa...<pause 15>\n\n\n<color red<<0x10009:0x2f010807><0x10006:0xffcd>>coloroff><color red<Drago del fulmine>coloroff>, robot e\npietre del tempo<pause 20>.<pause 20>.<pause 20>.<pause 20>\n\n\n<0x10009:0x2f080708><0x10008:0x02cd><0x10008:0x02cd>Un vero e proprio\nromanzo di avventure!")
          				goto flw_282
          			}
          		}
          	}
...
/*<315>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_66:
/*< 66>*/ 				printf(/* textboxtype: 0, unk: 0, line: 26 */ "Il Santuario del Tempo è sempre\npiù bello! Bzzz!")
          			  case 1:
/*<316>*/ 				printf(/* textboxtype: 0, unk: 0, line: 62 */ "Stai cercando un drago? Bzzz? Se si\ntratta del <color blue<<0x10009:0x13030000>drago del fulmine>coloroff>, potresti\ntrovarlo a sud delle <color blue<grotte di Ranel>coloroff>.\n\nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*< 99>*/ 			wait_frames(30)
/*< 97>*/ 			printf(/* textboxtype: 0, unk: 0, line: 29 */ "Eh? Questa mappa... ha qualcosa\ndi strano. La correggerò... Bzzz!")
...
/*< 65>*/ 			printf(/* textboxtype: 0, unk: 1, line: 25 */ "<0x10009:0x00030900>L'opificio di Ranel è più avanti!\nFai attenzione! Bzzz!")
...
/*<221>*/ 	start()
/*<222>*/ 	printf(/* textboxtype: 0, unk: 0, line: 110 */ "Turni mensili per la pulizia\ndel Santuario del Tempo.\n　　　　Il Direttore")
          }

          void entrypoint_400_38() {
/*<253>*/ 	start()
/*<254>*/ 	printf(/* textboxtype: 0, unk: 0, line: 59 */ "Strano vedere uomini da queste parti!\nBzzz! Ti interessano le pietre del tempo?")
...
/*<223>*/ 	start()
/*<224>*/ 	printf(/* textboxtype: 2, unk: 0, line: 111 */ "Contro la desertificazione,\nimpegniamoci per una\nterra più verde!\n　　　　Il Direttore")
          }
...
/*< 81>*/ 					switch (scene_flags[8 /* 0x0 01 */]) {
          					  case 0:
/*< 83>*/ 						printf(/* textboxtype: 0, unk: 1, line: 34 */ "Questo è l'<color blue<opificio di Ranel>coloroff>! Qui si\nproducono le pietre del tempo. Bzzz!\n\n\n<0x10009:0x13030000>Non sono meravigliose? Bzzz!")
          					  case 1:
...
/*< 85>*/ 						scene_flags[7 'Lanayru Desert'][35 /* 0x5 08 */] = true;
          				  ...
          				  case 1:
/*<322>*/ 					printf(/* textboxtype: 0, unk: 0, line: 62 */ "Stai cercando un drago? Bzzz? Se si\ntratta del <color blue<<0x10009:0x13030000>drago del fulmine>coloroff>, potresti\ntrovarlo a sud delle <color blue<grotte di Ranel>coloroff>.\n\nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*<130>*/ 	start()
/*<131>*/ 	printf(/* textboxtype: 0, unk: 1, line: 64 */ "<0x10005:0x005a0000>Da centinaia di anni, il deserto avanza\nin questa zona. È un'area molto arida.")
          }
...
/*<230>*/ 	switch (scene_flags[11 /* 0x0 08 */]) {
          	  case 0:
          	  case 1:
/*< 62>*/ 		printf(/* textboxtype: 1, unk: 0, line: 66 */ "Si suppone che questa unità sia\ndanneggiata e obsoleta.\nNon comprendo quello che dice.")
...
/*<132>*/ 	start()
/*<133>*/ 	printf(/* textboxtype: 0, unk: 0, line: 65 */ "<0x10005:0x005a0000>Si presume che <color blue<Zelda >coloroff>si sia diretta\npiù avanti.")
...
/*<257>*/ 	start()
/*<258>*/ 	printf(/* textboxtype: 0, unk: 1, line: 61 */ "Qualche tempo fa uno dei miei compagni\nè stato rapito... Pare gli abbiano anche\nstaccato la spina. Bzzz!")
...
/*<187>*/ 				printf(/* textboxtype: 1, unk: 0, line: 39 */ "Hai scoperto la combinazione? Bzzz!\nSei in gamba! Bzzz!")
          			  case 1:
/*<328>*/ 				printf(/* textboxtype: 0, unk: 0, line: 62 */ "Stai cercando un drago? Bzzz? Se si\ntratta del <color blue<<0x10009:0x13030000>drago del fulmine>coloroff>, potresti\ntrovarlo a sud delle <color blue<grotte di Ranel>coloroff>.\n\nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*<135>*/ 	printf(/* textboxtype: 0, unk: 1, line: 73 */ "<0x10005:0x005a0000>Siamo giunti nel <color blue<deserto di Ranel>coloroff>.\nLa conformazione dell'area ha subito\nvarie mutazioni a causa della\ndesertificazione.")
          }

          void entrypoint_400_76() {
/*<292>*/ 	start()
/*<293>*/ 	printf(/* textboxtype: 0, unk: 0, line: 86 */ "Siamo arrivati al <color blue<Santuario del Tempo>coloroff>.\n\n\n\nÈ possibile individuare con il rilevatore\nil portale della prova, necessario per\nottenere la fiamma sacra.")
...
/*<225>*/ 	switch (scene_flags[29 /* 0x2 20 */]) {
          	  case 0:
/*<226>*/ 		printf(/* textboxtype: 0, unk: 1, line: 10 */ "Quelle pietre azzurre sono pericolose per\ngli umani. Non le toccare! Vattene! Bzzz!")
          	  case 1:
...
/*<333>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_189:
/*<189>*/ 				printf(/* textboxtype: 0, unk: 0, line: 44 */ "Hai scoperto la combinazione? Bzzz!\nSei in gamba! Bzzz!")
          			  case 1:
/*<334>*/ 				printf(/* textboxtype: 0, unk: 0, line: 62 */ "Stai cercando un drago? Bzzz? Se si\ntratta del <color blue<<0x10009:0x13030000>drago del fulmine>coloroff>, potresti\ntrovarlo a sud delle <color blue<grotte di Ranel>coloroff>.\n\nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*<182>*/ 			switch (scene_flags[34 /* 0x5 04 */]) {
          			  case 0:
/*< 57>*/ 				printf(/* textboxtype: 0, unk: 0, line: 41 */ "Stai cercando i tre simboli per entrare\nnell'opificio di Ranel?\n\n\n<0x10009:0x13030000>Che strano tipo che sei! Bzzz!\nNon insegno la combinazione a\ntipi sospetti. Bzzz!\n\n<0x10009:0x13030000>Se ti pesco ad armeggiare\ncon il generatore, saranno guai!\nBzzz bzzz!")
          				goto flw_153
          			  case 1:
/*<183>*/ 				printf(/* textboxtype: 0, unk: 1, line: 43 */ "Sei proprio un tipo strano!\nPiù che strano, sospetto! Bzzz!\n\n\n<0x10009:0x13030000>Se ti pesco ad armeggiare\ncon il generatore, saranno guai!\nBzzz bzzz!")
          				goto flw_153
          			}
          		}
          	}
...
/*<136>*/ 	start()
/*<137>*/ 	printf(/* textboxtype: 0, unk: 0, line: 74 */ "<0x10005:0x005a0000>Confermo la presenza di <color red<sabbie mobili>coloroff>.\nProbabilità di venire inghiottiti: 30%")
          }

          void entrypoint_400_78() {
/*<300>*/ 	start()
/*<301>*/ 	printf(/* textboxtype: 0, unk: 2, line: 94 */ "<0x10012:0x0000000b><heroname>, mio signore,\nFaih a rapporto.\n\n\nRitengo che per azionare il <color red<generatore>coloroff>\nsia necessario provvedere alla sua\nalimentazione tramite una fonte di\nelettricità.")
          }
...
/*<339>*/ 			switch (story_flags[526 /* us: 805A9B14 0x08, jp: 805ACD94 0x08 */]) {
          			  case 0:
          				flw_191:
/*<191>*/ 				printf(/* textboxtype: 0, unk: 1, line: 49 */ "Hai scoperto la combinazione? Bzzz!\nSei in gamba! Bzzz!")
          			  case 1:
/*<340>*/ 				printf(/* textboxtype: 0, unk: 0, line: 62 */ "Stai cercando un drago? Bzzz? Se si\ntratta del <color blue<<0x10009:0x13030000>drago del fulmine>coloroff>, potresti\ntrovarlo a sud delle <color blue<grotte di Ranel>coloroff>.\n\nSe invece è un altro drago, non\nne ho la più pallida idea... Bzzz...")
...
/*<184>*/ 			switch (scene_flags[34 /* 0x5 04 */]) {
          			  case 0:
/*<122>*/ 				printf(/* textboxtype: 0, unk: 1, line: 46 */ "Stai cercando i tre simboli per entrare\nnell'opificio di Ranel?\n\n\n<0x10009:0x13030000>Che strano tipo che sei! Bzzz!\nNon insegno la combinazione a\ntipi sospetti. Bzzz!\n\n<0x10009:0x13030000>Se ti pesco ad armeggiare\ncon il generatore, saranno guai!\nBzzz bzzz!")
          				goto flw_154
          			  case 1:
