...
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf(/* textboxtype: 0, unk: 0, line: 2 */ "<0x10012:0x00000005>Bene, mio signore.\nInvio al robot le onde psichiche.<sound 4>")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 0, unk: 2, line: 1 */ "<0x10012:0x00000005>Bene, mio signore. Esaminate\nnuovamente l'oggetto se volete\ntrasportarlo.")
          	}
          }

          void entrypoint_510_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x00000064>Ooh! Faih adorata! Bzzz!\nEccomi qui per te!\n\n\nOh, vuoi che trasporti questo, eh?! Bzzz!")
          }

          void entrypoint_510_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "<0x10012:0x00000064>Bene, vi aspetto nel cielo!\nBzzz! Venite presto!!!")
          }

          void entrypoint_510_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10012:0x00000001>Mio signore, suggerisco di dirigerci\nanche noi alla volta del cielo e portare\nl'elica a destinazione.")
