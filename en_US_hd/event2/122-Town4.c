...
/*<114>*/ 	set_camera(7, 0)
/*<113>*/ 	printf("\x0E\x01\x09\x04\x2200\x02That IS what you were thinking,\nright, Link?")
          }
...
/*<137>*/ 			switch (story_flags[5 /* us: 805A9AD9 0x40, jp: 805ACD59 0x40 */]) {
          			  case 0:
/*<138>*/ 				printf("Hi there! I hope you're pressing \x0E\x02\x04\x02\x13CD\nwhenever you need help.\x0E\x01\x11\x02\xBCD")
          			  case 1:
/*<  5>*/ 				printf("So you're on your way to becoming\na knight now, right? Congratulations!\n\n\nBut I'm sure there's still plenty you\ndon't know. Don't forget to press \x0E\x02\x04\x02\x13CD\nif you need a pointer or two.\x0E\x01\x11\x02\xBCD")
          			}
          		}
          	  case 1:
          		goto flw_137
...
/*< 14>*/ 	start()
/*< 16>*/ 	printf("\x0E\x01\x09\x04\x00VGood grief! Will you talk to that boy\nof mine for me?")
          	flw_85:
...
/*< 95>*/ 		switch (scene_flags[45 /* 0x4 20 */]) {
          		  case 0:
/*< 94>*/ 			printf("\x0E\x01\x09\x04\x00\x1101Hey! Shouldn't you rush off and look\nfor your bird? I think you should.")
          		  case 1:
/*< 93>*/ 			printf("\x0E\x01\x09\x04\x00\x1104I wonder what they're talking about\nover there. It looks pretty serious.")
          		}
          	  case 1:
/*< 91>*/ 		printf("\x0E\x01\x09\x04\x00\x05Man, it feels good to just sit here and\nrelax.\n\n\nI like to kick back here and spend time\nthinking about that girl.\n\n\n\x0E\x01\x09\x04\n\xC00Yep, <b<Kina >>is the best thing about the\nold pumpkin bar. She's adorable!")
          	}
          }
...
/*< 25>*/ 	start()
/*< 26>*/ 	printf("\x0E\x01\x09\x04\x00\x01Hi, Link! This house\nbelongs to Kukiel. Pssst\x2014by the way,\nthat's ME.\n\nI'm gonna go play with my special\nfriend today! It's going to be so much\nfun!")
          }

          void entrypoint_122_28() {
/*<103>*/ 	start()
/*<104>*/ 	printf("\x0E\x01\x09\x04\x09\x30AHEY!\n\n\n\n\x0E\x01\x09\x04ÿ\xFF04Oh... <pause14>I guess it's OK as long as you're\ngoing to just sit.\n\n\n\x0E\x01\x09\x04ÿ\x3FFBut listen up! THAT is an expensive\nchair, and if you get it dirty... Well, I\ncan't be held responsible for what\nhappens.")
          }

          void entrypoint_122_11() {
/*< 27>*/ 	start()
/*< 28>*/ 	printf("\x0E\x01\x09\x04\x00\x11Zzz...let's play...zzz...\nUncle Bats!")
          }
...
/*< 60>*/ 		printf("\x0E\x01\x09\x04\x00\x12I still can't find Kukiel!\n\n\n\nWould you please help me find her?\nJust...hurry!")
          	  case 1:
/*< 32>*/ 		printf("\x0E\x01\x09\x04\x00\x01Oh, good evening. It's awfully late,\nbut is there something I can do for\nyou?")
          	}
          }
...
/*<123>*/ 	start()
/*<124>*/ 	printf("\x0E\x01\x12\x04\x00dZrrrt! This is the entrance to the\nvolcano! <pause1E>I better get there before\nMaster Shortpants!")
          }
...
/*<184>*/ 	set_camera(9, 0)
/*<181>*/ 	printf("\x0E\x01\x09\x04\x70A\xC12Uh... \x0E\x01\x08\x02\xFECDI wonder where she's gone...")
          }
...
/*<142>*/ 		switch (choice(2)) {
          		  case 0:
/*<144>*/ 			printf("\x0E\x01\x09\x04\x01\x700There's a good lad. Cheers!")
...
/*<145>*/ 			printf("\x0E\x01\x09\x04\x07\x700That's the stuff! There we go!")
/*<146>*/ 			set_camera(-1, 0)
/*<154>*/ 			switch (random(4)) {
          			  case 0:
