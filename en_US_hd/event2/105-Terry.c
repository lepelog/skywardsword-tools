...
/*<187>*/ 									printf("\x0E\x01\x09\x04\x00\xB00Oh<pause0A>.<pause0A>.<pause0A>.<pause0A> Valued customer...<pause14> You're back<pause0A>.<pause0A>.<pause0A>.<pause0A>\n\n\n\nWhat?<pause14> I don't seem like my usual self?\n\n\n\nI can't hide anything from you, can I?\n\n\n\nWell, I can't talk about it right now\nbecause I'm busy pedaling.\nWhy don't you lie down on the bed over\nthere and rest? We can talk tonight.")
...
/*<128>*/ 				set_camera(2, 0)
/*<118>*/ 				printf("\x0E\x01\x09\x04\x1A\x815Ohh! You really did find my precious\n<b<Horned Colossus Beetle>>?!")
...
/*<126>*/ 							switch (story_flags[201 /* us: 805A9AEF 0x08, jp: 805ACD6F 0x08 */]) {
          							  case 0:
/*<125>*/ 								printf("\x0E\x01\x09\x04\x00\x1EIf you wish to go back to Skyloft,\nsimply sleep in the bed until morning.")
          								flw_98:
