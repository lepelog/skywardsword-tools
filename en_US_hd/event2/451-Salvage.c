...
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  3>*/ 		printf("\x0E\x01\x12\x04\x00\x05Master, I will send word to the robot\nusing telepathic transmission.")
          	  case 1:
/*<  4>*/ 		printf("Yes, \x0E\x01\x12\x04\x00\x05Master. If you change your mind\nand decide to retrieve it, please\nexamine it again.")
          	}
          }

          void entrypoint_451_02() {
/*<  5>*/ 	start()
/*<  6>*/ 	printf("\x0E\x01\x12\x04\x00dMistress Fi, zrrpt! You called?\n\n\n\nWhoa, zrrft... This place seems\nstrangely familiar, brrzrrt...\n\n\nBzzzt, so you want me to carry this\nthing?")
          }
...
/*<  9>*/ 	start()
/*< 10>*/ 	printf("\x0E\x01\x12\x04\x00\x01Master, I suggest that we head back to\nthe sky and return this party wheel to\nits owner as soon as possible.")
...
/*< 11>*/ 	start()
/*< 12>*/ 	printf("\x0E\x01\x12\x04\x00dOK, OK, zrrft... You just sit tight\nthere and stay out of my way,\nMaster Shortpants, bzzzt!")
          }
