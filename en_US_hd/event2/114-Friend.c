...
/*< 48>*/ 	switch (story_flags[202 /* us: 805A9AEF 0x10, jp: 805ACD6F 0x10 */]) {
          	  case 0:
/*< 49>*/ 		printf(/* textboxtype: 0, unk: 0, line: 20 */ "<0x10009:0x00070002>Hey, <heroname>! Did you find\nany clues about Zelda? I know you\ncan find her. Don't give up!")
          	  case 1:
...
/*<  7>*/ 				switch (scene_flags[40 /* 0x4 01 */]) {
          				  case 0:
/*<  6>*/ 					printf(/* textboxtype: 0, unk: 1, line: 10 */ "<0x10009:0x00000811>That's pretty serious,\n<heroname>.<pause 25> Hope you find\nyour bird soon<0x10006:0xfbcd>...<0x10006:0x00cd>")
          				  case 1:
...
/*< 84>*/ 				switch (temp_flags[6 /* 0x1 40 */]) {
          				  case 0:
/*< 85>*/ 					printf(/* textboxtype: 0, unk: 1, line: 34 */ "<0x10009:0x00000002>Want to try again? It'll cost you\nanother <color red<20 Rupees>coloroff>.\n[1-]Yep! [2-]Rules?[3]Nah.")
          					flw_74:
/*< 74>*/ 					switch (choice(3)) {
          					  case 0:
          						flw_67:
/*< 67>*/ 						switch (has_rupees(20)) {
          						  case 0:
/*< 68>*/ 							rupees += -20;
/*< 70>*/ 							printf(/* textboxtype: 0, unk: 0, line: 32 */ "<0x10009:0x00070a0a>All right! Let's get started. Show me\nhow it's done, <heroname>!")
/*< 71>*/ 							make_actor_do_something(0, 0)
          						  case 1:
          							flw_66:
/*< 66>*/ 							printf(/* textboxtype: 0, unk: 1, line: 31 */ "<0x10009:0x00010811>Can't afford it, huh? Must be rough\nnot having enough Rupees to play\na little game, huh, <heroname>?")
          						}
          					  case 1:
          						flw_63:
/*< 63>*/ 						printf(/* textboxtype: 0, unk: 0, line: 29 */ "<0x10009:0x00070200>I'll toss pumpkins for <color red<90 seconds>coloroff>!\nYou get 10 points for every pumpkin\nyou hit.\n\n<0x10009:0x00000a00>The more pumpkins you hit in a row,\nthe more points you get. Don't miss!")
...
/*< 61>*/ 					switch (choice(2)) {
          					  case 0:
          						goto flw_63
          					  case 1:
/*< 62>*/ 						printf(/* textboxtype: 0, unk: 1, line: 28 */ "<0x10009:0x00070811>OK, <heroname>. I know how\nbusy you are.\n\n\nYou've got the whole “save Zelda\"\nmission going on and stuff. <pause 10>\nSorry for bugging you.")
          					}
          				  case 1:
/*< 60>*/ 					printf(/* textboxtype: 0, unk: 0, line: 26 */ "<0x10009:0x00000a09>Why are you blushing? You know\nit's true!")
          					goto flw_59
          				}
          			}
          		  case 1:
...
/*<115>*/ 			printf(/* textboxtype: 0, unk: 0, line: 38 */ "<0x10009:0x00070a00>It would be great to see you hit <color red<600\npoints>coloroff> and set a record next time.\nGive it your best shot!")
          			goto flw_91
          		  case 3:
...
/*< 97>*/ 			switch (story_flags[359 /* us: 805A9B00 0x20, jp: 805ACD80 0x20 */]) {
          			  case 0:
/*< 82>*/ 				printf(/* textboxtype: 0, unk: 1, line: 40 */ "<0x10009:0x0000000b>You got <numeric arg0 0> <0x30004:0x02cd>! That's beyond\namazing, <heroname>!\n\n\n<0x10009:0x00070a00>The pride of the Knight Academy is\ntruly riding on your shoulders,\n<heroname>! Here, take this!")
...
/*< 37>*/ 	printf(/* textboxtype: 0, unk: 1, line: 19 */ "<0x10009:0x00010800><0x10008:0xffcd>Hey,<pause 20> umm... I should probably tell you...\n\n\n\n<0x10009:0x00070800>Ah, forget it. Never mind.<pause 20>\nSorry...")
          }
...
/*< 41>*/ 	switch (scene_flags[22 /* 0x3 40 */]) {
          	  case 0:
/*< 42>*/ 		printf(/* textboxtype: 0, unk: 1, line: 13 */ "<0x10009:0x00070a0b>Thanks! That was a huge help,\n<heroname>!\n\n\n<0x10009:0x00000209>I know it's not much, but here's half of\nthe pay the old lady offered me to\ndo that.")
/*< 43>*/ 		give_item(4 0x04);
/*<116>*/ 		{'type': 'type3', 'subType': 6, 'param1': 0, 'param2': 1, 'next': 44, 'param3': 12}
/*< 44>*/ 		printf(/* textboxtype: 0, unk: 0, line: 14 */ "<0x10009:0x00000009>I have to hang back and watch the\nacademy today. Good luck with the\n<color red<ceremony>coloroff>, <heroname>!")
/*< 45>*/ 		scene_flags[0 'Skyloft'][23 /* 0x3 80 */] = true;
          	  case 1:
/*< 40>*/ 		switch (zone_temp_flags[11 /* 0x0 08 */]) {
          		  case 0:
/*< 46>*/ 			printf(/* textboxtype: 0, unk: 0, line: 11 */ "<0x10009:0x00000003>Ah, <heroname>... You're here to\nhelp me?\n\n\nYou've always been so kind. I'm happy\nto take you up on the offer!\n\n\n<0x10009:0x00070203>I need you to carry one of these <color red<barrels>coloroff>\nover to the old lady who works in the\nkitchen.\n\nPress (A) to pick up a barrel, then press\n(A) again to <color green<put it down >coloroff>at your feet.\n\n\n<0x10009:0x00010200>When you hold something up above your\nhead, you can <color green<throw>coloroff> it. You can also <color green<roll\n>coloroff>little things like pots.\n\n<0x10009:0x0c070200>But we'll get in huge trouble if any of\nthese barrels break, so don't even think\nabout throwing or rolling them.")
/*<114>*/ 			printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00010200>If you forget any of this, just <color green<press <icon 19>>coloroff>.<0x10011:0x0bcd>\n\n\n\nThat'll bring up an explanation of\nactions available to you at that moment\nin time. Pretty handy, huh?")
          		  case 1:
/*< 33>*/ 			printf(/* textboxtype: 1, unk: 0, line: 6 */ "")
/*< 34>*/ 			switch (choice(2)) {
          			  case 0:
/*< 35>*/ 				printf(/* textboxtype: 0, unk: 1, line: 7 */ "")
/*<  9>*/ 				printf(/* textboxtype: 0, unk: 0, line: 11 */ "<0x10009:0x00000003>Ah, <heroname>... You're here to\nhelp me?\n\n\nYou've always been so kind. I'm happy\nto take you up on the offer!\n\n\n<0x10009:0x00070203>I need you to carry one of these <color red<barrels>coloroff>\nover to the old lady who works in the\nkitchen.\n\nPress (A) to pick up a barrel, then press\n(A) again to <color green<put it down >coloroff>at your feet.\n\n\n<0x10009:0x00010200>When you hold something up above your\nhead, you can <color green<throw>coloroff> it. You can also <color green<roll\n>coloroff>little things like pots.\n\n<0x10009:0x0c070200>But we'll get in huge trouble if any of\nthese barrels break, so don't even think\nabout throwing or rolling them.")
/*<113>*/ 				printf(/* textboxtype: 1, unk: 0, line: 12 */ "<0x10009:0x00010200>If you forget any of this, just <color green<press <icon 19>>coloroff>.<0x10011:0x0bcd>\n\n\n\nThat'll bring up an explanation of\nactions available to you at that moment\nin time. Pretty handy, huh?")
...
/*< 24>*/ 	set_camera(2, 0)
/*< 21>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "<0x30001:0x><heroname>! <0x10009:0x00010c00>I just know you'll\nfind Zelda for us.")
