...
/*<  5>*/ 	start()
/*<  6>*/ 	printf(/* textboxtype: 2, unk: 0, line: 3 */ "<0x10012:0x00000064>Mistress Fi! I hope you weren't\nwaiting long, bzzzzat! So you want me\nto carry this, zrrbt?")
          }

          void entrypoint_251_03() {
/*<  7>*/ 	start()
/*<  8>*/ 	printf(/* textboxtype: 0, unk: 1, line: 4 */ "I'll be waiting for you up in the sky,\nso don't take too long, vrrrt!")
          }

          void entrypoint_251_04() {
/*<  9>*/ 	start()
/*< 10>*/ 	printf(/* textboxtype: 0, unk: 0, line: 5 */ "<0x10012:0x00000001>Master, I suggest we also return to\nthe sky and carry the Kikwi to its\ndestination quickly.")
...
/*<  2>*/ 	switch (choice(2)) {
          	  case 0:
/*<  4>*/ 		printf(/* textboxtype: 0, unk: 0, line: 2 */ "Yes, <0x10012:0x00000005>Master. I will signal the robot\nwith a telepathic transmission.")
          	  case 1:
/*<  3>*/ 		printf(/* textboxtype: 0, unk: 2, line: 1 */ "Yes, <0x10012:0x00000005>Master. Simply inspect\nthe specimen again if you change your\nmind and wish to take it to Skyloft.")
          	}
          }
...
/*< 20>*/ 					switch (choice(2)) {
          					  case 0:
          						flw_21:
/*< 21>*/ 						printf(/* textboxtype: 0, unk: 1, line: 13 */ "<0x10009:0x00060007>Oh! That's fantastic news, koo-karoo!\nI want you to take me there as soon as\nyou can!")
