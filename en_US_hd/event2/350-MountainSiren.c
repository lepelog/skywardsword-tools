...
/*< 13>*/ 	switch (story_flags[531 /* us: 805A9B17 0x01, jp: 805ACD97 0x01 */]) {
          	  case 0:
/*< 12>*/ 		printf(/* textboxtype: 2, unk: 4, line: 26 */ "We're here, <heroname>!\nShow me what you've got!")
/*< 15>*/ 		set_camera(10, 0)
...
/*< 51>*/ 				switch (choice(4)) {
          				  case 0:
/*< 52>*/ 					printf(/* textboxtype: 4, unk: 2, line: 7 */ "Yes, <0x10012:0x00000005>Master.\n\n\n\nTo fill the <color yellow<<item 17>>coloroff>, you need to\nlocate and collect every <color yellow<<item 44> \n>coloroff>scattered across this Silent Realm.")
/*< 59>*/ 					set_camera(2, 0)
/*< 58>*/ 					{'type': 'type3', 'subType': 1, 'param1': 1, 'param2': 0, 'next': 56, 'param3': 40}
/*< 56>*/ 					printf(/* textboxtype: 2, unk: 4, line: 8 */ "<0x10012:0x00000002>Master, do you see the glowing\nobject a ways in front of you?")
/*< 55>*/ 					set_camera(3, 0)
...
/*< 62>*/ 					set_camera(5, 0)
/*< 61>*/ 					printf(/* textboxtype: 4, unk: 2, line: 13 */ "You must collect the <color yellow<tears>coloroff> scattered\nthroughout this area and fill the\n<color yellow<<item 17> >coloroff>without\nbeing hit by an attack.")
          					goto flw_77
          				  case 2:
...
/*< 69>*/ 					printf(/* textboxtype: 2, unk: 4, line: 14 */ "The unusual liquid substance that\ncovers that area is known as <color red<Waking\nWater>coloroff>, and it has certain unique\nproperties.\nIf you make contact with Waking\nWater, the <color red<Guardians will be\nimmediately alerted to your presence>coloroff>.\n\nPools of Waking Water are located all\nthroughout the area. I suggest you\nwatch where you step...")
          				  ...
          				  case 3:
          					flw_70:
/*< 70>*/ 					printf(/* textboxtype: 2, unk: 4, line: 5 */ "Understood, <0x10012:0x00000005>Master.")
/*< 71>*/ 					set_camera(10, 0)
