...
/*<183>*/ 	start()
/*<184>*/ 	printf("While riding your Loftwing, you\ncan press \x0E\x02\x04\x02\x13CD at any time to go over\nthe basic controls again.\x0E\x01\x11\x02\xBCD\n\nYou can also <g<charge>>, which is an attack\nthat also gives you a <r<burst of speed>> as\nwell as <r<slow down>> when you need to. Try\nall these moves and see how they feel!")
...
/*<  5>*/ 	printf("Look! There he is!")
/*< 21>*/ 	set_camera(2, 0)
/*< 14>*/ 	printf("\x0E\x01\x09\x04\x09\x500\x0E\x01\x08\x02\x1CDNo doubt about it. That's your\nLoftwing, Link!")
...
/*< 67>*/ 	set_camera(18, 0)
/*< 30>*/ 	printf("Groose! Pssst, Groose!\n<pause1E>Behind you!<pause1E> Right behind you!")
...
/*< 32>*/ 	printf("\x0E\x01\x09\x04\x419\x1715GAH!")
...
/*< 98>*/ 	set_camera(18, 0)
/*< 35>*/ 	printf("\x0E\x01\x09\x04\x505\x13\x0E\x01\x09\x04\x607\x00Hey, Groose!\x0E\x01\x05\x04\x14\x00 Wait up!")
...
/*< 40>*/ 		printf("The Wing Ceremony will now begin!\nParticipating students, please\nassemble!")
/*< 59>*/ 		{'type': 'type3', 'subType': 1, 'param1': 0, 'param2': 100, 'next': 41, 'param3': 16}
/*< 41>*/ 		printf("Looks like it's race time. Good luck,\nLink!")
/*< 70>*/ 		changeScene(18, 0) // 
          	  case 1:
/*< 38>*/ 		printf("\x0E\x01\x09\x04\x0C\x1500Aww, don't be nervous. You can do this!")
          		goto flw_101
          	  case 2:
/*< 39>*/ 		printf("\x0E\x01\x09\x04\x10\xE04Come on, Link! Try to \nfocus for once.")
          		goto flw_101
          	}
          }
...
/*< 82>*/ 	start()
/*< 83>*/ 	printf("\x0E\x03\x01\x00Link, let's run your bird\nthrough the basics just to\nmake sure he's not hurt.")
/*< 84>*/ 	printf("You can fly your bird in any direction.\nWhen it's headed upward, it'll slowly\nlose speed.\n\nWhen you want to <r<speed up>>, direct your\nbird upward to gain <r<altitude>>, then drop\ninto a fast dive!\n\nSo, again, gain some altitude, then dive\nto speed up! Those are the basics of\ngetting your bird up to top speed.")
/*< 85>*/ 	printf("So how's he handling? Do you think\nhe's flying all right?")
